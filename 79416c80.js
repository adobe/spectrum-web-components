import{e as t,R as e,T as i,x as r,y as o,_ as a}from"./62b05a9e.js";import{e as s,a as n,t as c,b as l,c as d,l as u,i as p}from"./60899823.js";import"./08bec287.js";import{r as m}from"./e50c5e8d.js";import"./b86f55ac.js";import"./c24d2ae8.js";const{H:v}=e,h=t=>void 0===t.strings,x=()=>document.createComment(""),f=(t,e,i)=>{var r;const o=t._$AA.parentNode,a=void 0===e?t._$AB:e._$AA;if(void 0===i){const e=o.insertBefore(x(),a),r=o.insertBefore(x(),a);i=new v(e,r,t,t.options)}else{const e=i._$AB.nextSibling,s=i._$AM,n=s!==t;if(n){let e;null===(r=i._$AQ)||void 0===r||r.call(i,t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==s._$AU&&i._$AP(e)}if(e!==a||n){let t=i._$AA;for(;t!==e;){const e=t.nextSibling;o.insertBefore(t,a),t=e}}}return i},b=(t,e,i=t)=>(t._$AI(e,i),t),g={},w=(t,e=g)=>t._$AH=e,y=t=>t._$AH,q=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let i=t._$AA;const r=t._$AB.nextSibling;for(;i!==r;){const t=i.nextSibling;i.remove(),i=t}},k=s(class extends n{constructor(t){if(super(t),t.type!==c.PROPERTY&&t.type!==c.ATTRIBUTE&&t.type!==c.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!h(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===i||e===r)return e;const o=t.element,a=t.name;if(t.type===c.PROPERTY){if(e===o[a])return i}else if(t.type===c.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(a))return i}else if(t.type===c.ATTRIBUTE&&o.getAttribute(a)===e+"")return i;return w(t),e}});var z=m`:host{--spectrum-textfield-texticon-padding-left:var(
...
)}:host([dir=ltr][quiet][invalid]) .icon{right:var(
--spectrum-textfield-icon-inline-end-override,0
)}:host([dir=rtl][quiet][invalid]) .icon{left:var(
--spectrum-textfield-icon-inline-end-override,0
)}:host([dir=ltr][valid]) .icon{right:var(
...
)}:host([dir=ltr][quiet][valid]) .icon{right:var(
--spectrum-textfield-icon-inline-end-override,0
)}:host([dir=rtl][quiet][valid]) .icon{left:var(
--spectrum-textfield-icon-inline-end-override,0
...
)}:host([focused]):after{box-shadow:0 0 0 var(
...
)}:host([focused][quiet]) .input{box-shadow:none}:host([focused][quiet]):after{border-bottom:2px solid var(
--spectrum-textfield-m-textonly-focus-ring-border-color-key-focus,var(--spectrum-alias-focus-ring-color)
...
)}:host([focused][invalid]) .input,:host([invalid]) .input:focus{border-color:var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const B=t=>t.stopPropagation();class S extends _{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,A]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}render(){return o`<form action="${this.action}" id="form" method="${u(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.render()} ${this.value?o`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${B}"></sp-clear-button>`:o``}</form>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}updated(t){super.updated(t),this.multiline=!1}}a([t()],S.prototype,"action",void 0),a([t()],S.prototype,"label",void 0),a([t()],S.prototype,"method",void 0),a([t()],S.prototype,"placeholder",void 0),a([p("#form")],S.prototype,"form",void 0),customElements.define("sp-search",S);export{E as T,y as a,_ as b,b as c,q as m,h as r,w as s,f as u};
//# sourceMappingURL=79416c80.js.map
