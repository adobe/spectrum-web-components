import{f as e,S as t}from"./7d701b0a.js";import{i as r}from"./112b2095.js";import"./2465ac4c.js";import{S as o}from"./f14b85e2.js";import{T as i,A as c,x as a,n as s,d as l}from"./83ab71e7.js";import"./2ab79dcb.js";import{c as n,t as d}from"./8f04a507.js";import{l as u,F as p,i as m}from"./2f4b5165.js";import"./9d72e6d1.js";import"./7d97cb09.js";import{S as h}from"./9ddc847e.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./c2d947e7.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,R=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?U(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&R(t,r,c),c};const A=e=>e.stopPropagation();class P extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,O]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}_([s()],P.prototype,"action",2),_([s()],P.prototype,"label",2),_([s()],P.prototype,"method",2),_([s()],P.prototype,"placeholder",2),_([m("#form")],P.prototype,"form",2),l("sp-search",P);export{I as M,L as T,F as a};
//# sourceMappingURL=912413f1.js.map
