import{S as t,I as e,c as o,u as r}from"./fe7541c2.js";import{i}from"./d230bd74.js";import"./be36498e.js";import{e as l,c,d as a,S as n,l as s,a as u,i as d}from"./f4a2163c.js";import{e as p,x as m,b as v,y as h}from"./95f60e39.js";import"./5a13eab1.js";import"./2722a9f7.js";import{e as f,s as b}from"./b6459f98.js";function x(t){return p({...t,state:!0})}const g=l(class extends c{constructor(t){if(super(t),t.type!==a.PROPERTY&&t.type!==a.ATTRIBUTE&&t.type!==a.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!f(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===m||e===v)return e;const o=t.element,r=t.name;if(t.type===a.PROPERTY){if(e===o[r])return m}else if(t.type===a.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(r))return m}else if(t.type===a.ATTRIBUTE&&o.getAttribute(r)===e+"")return m;return b(t),e}});var w=i`
...
`,k=Object.defineProperty,y=Object.getOwnPropertyDescriptor;const q={s:()=>h`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>h`
        ...
        ></sp-icon-cross300>
    `};class z extends(n(t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,w,e]}get buttonContent(){return[q[this.size]()]}render(){return h`
            <div class="fill">${super.render()}</div>
        `}}((t,e,o,r)=>{for(var i,l=r>1?void 0:r?y(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);r&&l&&k(e,o,l)})([p({reflect:!0})],z.prototype,"variant",2);const $=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return h`
...
`,I=Object.defineProperty,H=Object.getOwnPropertyDescriptor,j=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?H(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&I(e,o,l),l};const S=["text","url","tel","email","password"];class L extends(B(u)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[E,r]}get type(){var t;return null!=(t=S.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?h`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t),t}}j([p({attribute:"allowed-keys"})],L.prototype,"allowedKeys",2),j([p({type:Boolean,reflect:!0})],L.prototype,"focused",2),j([d(".input")],L.prototype,"inputElement",2),j([p({type:Boolean,reflect:!0})],L.prototype,"invalid",2),j([p()],L.prototype,"label",2),j([p()],L.prototype,"placeholder",2),j([p({attribute:"type",reflect:!0})],L.prototype,"_type",2),j([x()],L.prototype,"type",1),j([p()],L.prototype,"pattern",2),j([p({type:Boolean,reflect:!0})],L.prototype,"grows",2),j([p({type:Number})],L.prototype,"maxlength",2),j([p({type:Number})],L.prototype,"minlength",2),j([p({type:Boolean,reflect:!0})],L.prototype,"multiline",2),j([p({type:Boolean,reflect:!0})],L.prototype,"readonly",2),j([p({type:Boolean,reflect:!0})],L.prototype,"valid",2),j([p({type:String})],L.prototype,"value",1),j([p({type:Boolean,reflect:!0})],L.prototype,"quiet",2),j([p({type:Boolean,reflect:!0})],L.prototype,"required",2),j([p({type:String,reflect:!0})],L.prototype,"autocomplete",2);class F extends L{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}j([p({type:String})],F.prototype,"value",1),customElements.define("sp-clear-button",z);var C=i`
...
`,O=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&O(e,o,l),l};const R=t=>t.stopPropagation();class A extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,C]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return h`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}_([p()],A.prototype,"action",2),_([p()],A.prototype,"label",2),_([p()],A.prototype,"method",2),_([p()],A.prototype,"placeholder",2),_([d("#form")],A.prototype,"form",2),customElements.define("sp-search",A);export{B as M,L as T,F as a,x as t};
//# sourceMappingURL=faa28b75.js.map
