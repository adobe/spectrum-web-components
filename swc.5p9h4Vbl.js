import{t as a,s as e}from"./swc.CJygKO7k.js";import{I as l}from"./swc.1z5IcdxS.js";import{x as i}from"./swc.BVYjKV9n.js";import{d as t}from"./swc.JlveB6nj.js";t("sp-icon-info",class extends l{render(){return e(i),(({width:e=24,height:l=24,hidden:i=!1,title:t="Info"}={})=>a`<svg
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});t("sp-icon-checkmark-circle",class extends l{render(){return e(i),(({width:e=24,height:l=24,hidden:i=!1,title:t="Checkmark Circle"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${e}
    height=${l}
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});t("sp-icon-settings",class extends l{render(){return e(i),(({width:e=24,height:l=24,hidden:i=!1,title:t="Settings"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${l}
    viewBox="0 0 36 36"
    width=${e}
...
//# sourceMappingURL=swc.DsEns_GQ.js.map
