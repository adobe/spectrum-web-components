...
--spectrum-alias-focus-ring-gap,
var(--spectrum-global-dimension-static-size-25)
)*-1);position:absolute;right:0;top:0}::slotted(:not(img)){display:none}`;class Hr extends(f(s,{validSizes:["xxs","xs","s","m","l"],defaultSize:"s"})){constructor(){super(...arguments),this.cover=!1}static get styles(){return[Dr]}render(){return r`${this.background?r`<div class="background" style="background:${this.background}"></div>`:r``}<slot></slot>`}}o([i({type:String,reflect:!0})],Hr.prototype,"background",void 0),o([i({type:Boolean,reflect:!0})],Hr.prototype,"cover",void 0),customElements.define("sp-thumbnail",Hr);var Fr=n`:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
//# sourceMappingURL=46c83166.js.map
