import{i as e}from"./1ab7ceed.js";import{t,i as o,l as r}from"./0fd5475c.js";import{T as c,S as a,x as s,n as l,d as i,A as n,D as h}from"./637c92da.js";import{l as d,S as b}from"./41af188d.js";import"./97b32ec4.js";import"./3b101b71.js";import{E as u}from"./1bc378e4.js";import{e as m,i as p,t as v}from"./16ab2288.js";import{m as g,f as k,c as x,p as f,a as w,e as _}from"./be246949.js";const y=(e,t,o)=>{const r=new Map;for(let c=t;c<=o;c++)r.set(e[c],c);return r},z=m(class extends p{constructor(e){if(super(e),e.type!==v.CHILD)throw Error("repeat() can only be used in text expressions")}ct(e,t,o){let r;void 0===o?o=t:void 0!==t&&(r=t);const c=[],a=[];let s=0;for(const t of e)c[s]=r?r(t,s):s,a[s]=o(t,s),s++;return{values:a,keys:c}}render(e,t,o){return this.ct(e,t,o).values}update(e,[t,o,r]){var a;const s=g(e),{values:l,keys:i}=this.ct(t,o,r);if(!Array.isArray(s))return this.ut=i,l;const n=null!==(a=this.ut)&&void 0!==a?a:this.ut=[],h=[];let d,b,u=0,m=s.length-1,p=0,v=l.length-1;for(;u<=m&&p<=v;)if(null===s[u])u++;else if(null===s[m])m--;else if(n[u]===i[p])h[p]=k(s[u],l[p]),u++,p++;else if(n[m]===i[v])h[v]=k(s[m],l[v]),m--,v--;else if(n[u]===i[v])h[v]=k(s[u],l[v]),x(e,h[v+1],s[u]),u++,v--;else if(n[m]===i[p])h[p]=k(s[m],l[p]),x(e,s[u],s[m]),m--,p++;else if(void 0===d&&(d=y(i,p,v),b=y(n,u,m)),d.has(n[u]))if(d.has(n[m])){const t=b.get(i[p]),o=void 0!==t?s[t]:null;if(null===o){const t=x(e,s[u]);k(t,l[p]),h[p]=t}else h[p]=k(o,l[p]),x(e,s[u],o),s[t]=null;p++}else f(s[m]),m--;else f(s[u]),u++;for(;p<=v;){const t=x(e,h[v+1]);k(t,l[p]),h[p++]=t}for(;u<=m;){const e=s[u++];null!==e&&f(e)}return this.ut=i,w(e,h),c}}),C=(e,t)=>{var o,r;const c=e._$AN;if(void 0===c)return!1;for(const e of c)null===(r=(o=e)._$AO)||void 0===r||r.call(o,t,!1),C(e,t);return!0},I=e=>{let t,o;do{if(void 0===(t=e._$AM))break;o=t._$AN,o.delete(e),e=t}while(0===(null==o?void 0:o.size))},S=e=>{for(let t;t=e._$AM;e=t){let o=t._$AN;if(void 0===o)t._$AN=o=new Set;else if(o.has(e))break;o.add(e),A(t)}};function E(e){void 0!==this._$AN?(I(this),this._$AM=e,S(this)):this._$AM=e}function T(e,t=!1,o=0){const r=this._$AH,c=this._$AN;if(void 0!==c&&0!==c.size)if(t)if(Array.isArray(r))for(let e=o;e<r.length;e++)C(r[e],!1),I(r[e]);else null!=r&&(C(r,!1),I(r));else C(this,e)}const A=e=>{var t,o,r,c;e.type==v.CHILD&&(null!==(t=(r=e)._$AP)&&void 0!==t||(r._$AP=T),null!==(o=(c=e)._$AQ)&&void 0!==o||(c._$AQ=E))};let U=class extends p{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,o){super._$AT(e,t,o),S(this),this.isConnected=e._$AU}_$AO(e,t=!0){var o,r;e!==this.isConnected&&(this.isConnected=e,e?null===(o=this.reconnected)||void 0===o||o.call(this):null===(r=this.disconnected)||void 0===r||r.call(this)),t&&(C(this,e),I(this))}setValue(e){if(_(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};var L=e`
...
`,O=Object.defineProperty,H=Object.getOwnPropertyDescriptor;class $ extends a{constructor(){super(),this.role="rowgroup",new t(this,{config:{childList:!0,subtree:!0},callback:()=>{requestAnimationFrame((()=>{this.shouldHaveTabIndex()}))}})}static get styles(){return[L]}shouldHaveTabIndex(){this.offsetHeight<this.scrollHeight?this.tabIndex=0:this.removeAttribute("tabindex")}render(){return s`
            <slot></slot>
        `}}((e,t,o,r)=>{for(var c,a=r>1?void 0:r?H(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);r&&a&&O(t,o,a)})([l({reflect:!0})],$.prototype,"role",2),i("sp-table-body",$);var D=e`
...
`,R=Object.defineProperty,V=Object.getOwnPropertyDescriptor,j=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?V(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&R(t,o,a),a};class B extends a{constructor(){super(...arguments),this.role="row",this.selectable=!1,this.selected=!1,this.value=""}static get styles(){return[D]}async handleChange(e){e.target.checkbox&&(this.selected=e.target.checkbox.checked,await 0,e.defaultPrevented&&(this.selected=!this.selected))}handleSlotchange({target:e}){const t=e.assignedElements();this.selectable=!!t.find((e=>"sp-table-checkbox-cell"===e.localName))}async manageSelected(){await this.updateComplete,this.selectable?this.setAttribute("aria-selected",this.selected?"true":"false"):this.removeAttribute("aria-selected");const[e]=this.checkboxCells;e&&(e.checked=this.selected)}handleClick(e){if(e.composedPath().find((e=>"sp-table-checkbox-cell"===e.localName)))return;const[t]=this.checkboxCells;t&&t.click()}render(){return s`
            <slot
                @change=${this.handleChange}
                @slotchange=${this.handleSlotchange}
            ></slot>
        `}willUpdate(e){e.has("selected")&&this.manageSelected(),e.has("selectable")&&(this.selectable?this.addEventListener("click",this.handleClick):this.removeEventListener("click",this.handleClick))}}j([d({selector:"sp-table-checkbox-cell",flatten:!0})],B.prototype,"checkboxCells",2),j([l({reflect:!0})],B.prototype,"role",2),j([l({type:Boolean})],B.prototype,"selectable",2),j([l({type:Boolean,reflect:!0})],B.prototype,"selected",2),j([l({type:String})],B.prototype,"value",2),i("sp-table-row",B);var M=Object.defineProperty,P=Object.getOwnPropertyDescriptor,N=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?P(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&M(t,o,a),a};function F(e){class t extends e{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const e=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(e)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return s`
                <input
                    id="input"
                    ...
                    @change=${this.handleChange}
                />
            `}}return N([l({type:Boolean,reflect:!0})],t.prototype,"checked",2),N([l({type:String,reflect:!0})],t.prototype,"name",2),N([l({type:Boolean,reflect:!0})],t.prototype,"readonly",2),N([o("#input")],t.prototype,"inputElement",2),t}var q=e`
...
`,K=Object.defineProperty,G=Object.getOwnPropertyDescriptor,Q=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?G(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&K(t,o,a),a};const J={s:()=>s`
            <sp-icon-checkmark75
                id="checkmark"
        ...
        `,xl:()=>s`
            ...
            ></sp-icon-dash300>
        `};class Y extends(b(F(a),{noDefaultSize:!0})){constructor(){super(...arguments),this.disabled=!1,this.indeterminate=!1,this.invalid=!1,this.emphasized=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.hasAttribute("autofocus")&&this.updateComplete.then((()=>{this.focus()}))}static get styles(){return[q,u,W]}click(){var e;this.disabled||null==(e=this.inputElement)||e.click()}handleChange(){this.indeterminate=!1,super.handleChange()}render(){return s`
            ${super.render()}
            <span id="box">
                ${this.checked?J[this.size]():s``}
                ${this.indeterminate?X[this.size]():s``}
            </span>
            <label id="label" for="input"><slot></slot></label>
        `}updated(e){super.updated(e),e.has("disabled")&&(void 0!==e.get("disabled")||this.disabled)&&(this.disabled?(this.inputElement.tabIndex=this.tabIndex,this.tabIndex=-1):(this.tabIndex=this.inputElement.tabIndex,this.inputElement.removeAttribute("tabindex")),this.inputElement.disabled=this.disabled),e.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate),e.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid"))}}Y.shadowRootOptions={...a.shadowRootOptions,delegatesFocus:!0},Q([l({type:Boolean,reflect:!0})],Y.prototype,"disabled",2),Q([l({type:Boolean,reflect:!0})],Y.prototype,"indeterminate",2),Q([l({type:Boolean,reflect:!0})],Y.prototype,"invalid",2),Q([l({type:Boolean,reflect:!0})],Y.prototype,"emphasized",2),Q([l({reflect:!0,type:Number,attribute:"tabindex"})],Y.prototype,"tabIndex",2),i("sp-checkbox",Y);var Z=e`
...
`,ee=Object.defineProperty,te=Object.getOwnPropertyDescriptor,oe=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?te(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&ee(t,o,a),a};class re extends a{constructor(){super(...arguments),this.headCell=!1,this.role="gridcell",this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.selectsSingle=!1,this.emphasized=!1}static get styles(){return[Z]}click(){this.checkbox.click()}render(){return s`
            <sp-checkbox
                ?checked=${this.checked}
                ...
                class="checkbox"
            ></sp-checkbox>
        `}}oe([l({type:Boolean,reflect:!0,attribute:"head-cell"})],re.prototype,"headCell",2),oe([l({reflect:!0})],re.prototype,"role",2),oe([o(".checkbox")],re.prototype,"checkbox",2),oe([l({type:Boolean})],re.prototype,"indeterminate",2),oe([l({type:Boolean})],re.prototype,"checked",2),oe([l({type:Boolean})],re.prototype,"disabled",2),oe([l({type:Boolean,reflect:!0,attribute:"selects-single"})],re.prototype,"selectsSingle",2),oe([l({type:Boolean,reflect:!0})],re.prototype,"emphasized",2),i("sp-table-checkbox-cell",re);var ce=e`
...
`,Ie=Object.defineProperty,Se=Object.getOwnPropertyDescriptor;class Ee extends a{constructor(){super(...arguments),this.role="gridcell"}static get styles(){return[Ce]}render(){return s`
            <slot></slot>
        `}}((e,t,o,r)=>{for(var c,a=r>1?void 0:r?Se(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);r&&a&&Ie(t,o,a)})([l({reflect:!0})],Ee.prototype,"role",2),i("sp-table-cell",Ee);var Te=e`
:host{display:table-header-group}:host .spectrum-Table-scroller{position:sticky;top:0;z-index:2}:host{display:flex}
`,Ae=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,Le=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?Ue(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&Ae(t,o,a),a};class Oe extends a{constructor(){super(...arguments),this.role="row"}static get styles(){return[Te]}handleSorted({target:e}){[...this.children].forEach((t=>{t!==e&&(t.sortDirection=void 0)}))}handleChange({target:e}){this.selected=e.checkbox.checked||e.checkbox.indeterminate}render(){return s`
            <slot
                @sorted=${this.handleSorted}
                @change=${this.handleChange}
            ></slot>
        `}}Le([l({reflect:!0})],Oe.prototype,"role",2),Le([l({type:Boolean,reflect:!0})],Oe.prototype,"selected",2),i("sp-table-head",Oe);var He=e`
...
`,De=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,Ve=(e,t,o,r)=>{for(var c,a=r>1?void 0:r?Re(t,o):t,s=e.length-1;s>=0;s--)(c=e[s])&&(a=(r?c(t,o,a):c(a))||a);return r&&a&&De(t,o,a),a};class je extends a{constructor(){super(...arguments),this.role="columnheader",this.sortable=!1,this.sortKey=""}static get styles(){return[He,$e]}handleClick(){this.sortable&&(this.sortDirection?this.sortDirection="asc"===this.sortDirection?"desc":"asc":this.sortDirection="asc",this.dispatchEvent(new CustomEvent("sorted",{bubbles:!0,detail:{sortDirection:this.sortDirection,sortKey:this.sortKey}})))}render(){const e=this.sortable&&!!this.sortDirection;return s`
            ${e?s`
                      <sp-icon-arrow100
                  ...
                  `:n}
            <slot></slot>
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}update(e){e.has("sortDirection")&&this.setAttribute("aria-sort",(e=>({asc:"ascending",desc:"descending"}[e]||"none"))(this.sortDirection)),e.has("sortable")&&(this.tabIndex=this.sortable?0:-1),super.update(e)}}Ve([l({reflect:!0})],je.prototype,"role",2),Ve([l({type:Boolean,reflect:!0})],je.prototype,"sortable",2),Ve([l({reflect:!0,attribute:"sort-direction"})],je.prototype,"sortDirection",2),Ve([l({attribute:"sort-key"})],je.prototype,"sortKey",2),i("sp-table-head-cell",je);export{F as C,ge as a,de as b,U as c,ke as d,z as e,W as f,xe as v};
//# sourceMappingURL=4dd6175d.js.map
