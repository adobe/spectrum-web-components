import{r as e,c as t}from"./swc.BSE6YbTY.js";import{x as i}from"./swc.BY-CAm7w.js";import{l as s}from"./swc.Cy5h3EZW.js";class h{constructor(t,{mode:i}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=t,this.id=`sp-help-text-${e()}`,this.mode=i}get isInternal(){return"internal"===this.mode}render(t){return i`
...
//# sourceMappingURL=swc.Ds3SbL0t.js.map
