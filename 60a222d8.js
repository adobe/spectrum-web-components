import{i as e}from"./67a87733.js";import{M as r,I as o,o as t,b as i}from"./e0dfa4eb.js";import{i as c,l as a,a as s}from"./2b513fe4.js";import{r as n}from"./1175a784.js";import"./b41a9942.js";import"./5223f72b.js";import"./e9f66d85.js";import"./8bbb6ded.js";import{f as l}from"./045d5864.js";import{S as p,x as u,e as d,d as m,B as h,A as v}from"./395924ad.js";import{S as k}from"./549963e9.js";import{o as b}from"./19c8b84e.js";import{t as f}from"./a010124b.js";var g=e`
...
`,w=Object.defineProperty,z=Object.getOwnPropertyDescriptor,q=(e,r,o,t)=>{for(var i,c=t>1?void 0:t?z(r,o):r,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(t?i(r,o,c):i(c))||c);return t&&c&&w(r,o,c),c};class I extends p{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new r(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[y,x]}focus(){const e=l(this);e?e.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(e){e.has("open")&&void 0!==e.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise((e=>{this.resolveTransitionPromise=()=>{this.animating=!1,e()}}))),super.update(e)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}get buttonContent(){const e={"visually-hidden":"only"===this.icons&&!!this.value,placeholder:!this.value},r=this.appliedLabel||this.label;return[u`
                ...
                ${this.value&&this.selectedItem?u`
                              <span
                                  aria-hidden="true"
        ...
        `}update(e){this.selects&&(this.selects="single"),e.has("disabled")&&this.disabled&&(this.open=!1),e.has("open")&&(this.open||void 0!==e.get("open"))&&(this.menuStatePromise=new Promise((e=>this.menuStateResolver=e)),this.open?this.openMenu():this.closeMenu()),e.has("value")&&!e.has("selectedItem")&&this.updateMenuItems(),super.update(e)}get dismissHelper(){return u`
