import{t as e,s as a}from"./ef0b9850.js";import{I as l,y as t}from"./d036ac45.js";customElements.define("sp-icon-info",class extends l{render(){return a(t),(({width:a=24,height:l=24,hidden:t=!1,title:i="Info"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});customElements.define("sp-icon-checkmark-circle",class extends l{render(){return a(t),(({width:a=24,height:l=24,hidden:t=!1,title:i="Checkmark Circle"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${a}
    height=${l}
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});customElements.define("sp-icon-settings",class extends l{render(){return a(t),(({width:a=24,height:l=24,hidden:t=!1,title:i="Settings"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${l}
    viewBox="0 0 36 36"
    width=${a}
...
//# sourceMappingURL=c558c2ce.js.map
