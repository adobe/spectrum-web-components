...
applyTo: CONTRIBUTOR-DOCS/**/*.md,1st-gen/packages/*/README.md,gen2/packages/swc/components/**/*.mdx,gen2/packages/swc/patterns/**/*.mdx,gen2/packages/core/controllers/**/*.mdx
---

<!-- GENERATED by .ai/scripts/sync.js from .ai/rules/markdown-accessibility.md. Do not edit. Edit the source and run `yarn ai:sync`. -->
