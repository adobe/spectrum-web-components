...
)}`;class $t extends e{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[St]}render(){return r`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}o([i({reflect:!0,type:String})],$t.prototype,"type",void 0),o([i({reflect:!0,type:Boolean})],$t.prototype,"corner",void 0),customElements.define("sp-banner",$t);var Et=n`:host{--spectrum-buttongroup-button-gap-reset:0}:host{display:flex}::slotted(*){flex-shrink:0}:host([dir=ltr]) ::slotted(:not(:first-of-type)){margin-left:var(
...
)}:host{height:calc(100vh - var(--swc-body-margins-block,0 * 1px));width:calc(100vw - var(--swc-body-margins-inline,0 * 1px))}`;class $e extends(w(e)){constructor(){super(...arguments),this.error=!1,this.cancelLabel="",this.confirmLabel="",this.dismissable=!1,this.footer="",this.hero="",this.heroLabel="",this.noDivider=!1,this.open=!1,this.secondaryLabel="",this.headline="",this.responsive=!1,this.underlay=!1}static get styles(){return[Se]}focus(){if(this.shadowRoot){const t=R(this.shadowRoot);t?(t.updateComplete?t.updateComplete.then((()=>t.focus())):t.focus(),this.removeAttribute("tabindex")):this.dialog.focus()}else super.focus()}dismiss(){this.dismissable&&this.close()}clickSecondary(){this.dispatchEvent(new Event("secondary",{bubbles:!0}))}clickCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}clickConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}close(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0}))}render(){return r`${this.underlay?r`<sp-underlay ?open="${this.open}" @click="${this.dismiss}"></sp-underlay>`:r``}<div class="modal ${this.mode}"><sp-dialog ?dismissable="${this.dismissable}" ?no-divider="${this.noDivider}" ?error="${this.error}" mode="${v(this.mode?this.mode:void 0)}" size="${v(this.size?this.size:void 0)}" @close="${this.close}">${this.hero?r`<img src="${this.hero}" slot="hero" aria-hidden="${v(this.heroLabel?void 0:"true")}" alt="${v(this.heroLabel?this.heroLabel:void 0)}">`:r``} ${this.headline?r`<h2 slot="heading">${this.headline}</h2>`:r``}<slot></slot>${this.footer?r`<div slot="footer">${this.footer}</div>`:r``} ${this.secondaryLabel?r`<sp-button variant="primary" slot="button" @click="${this.clickSecondary}">${this.secondaryLabel}</sp-button>`:r``} ${this.cancelLabel?r`<sp-button variant="secondary" slot="button" @click="${this.clickCancel}">${this.cancelLabel}</sp-button>`:r``} ${this.confirmLabel?r`<sp-button variant="cta" slot="button" @click="${this.clickConfirm}">${this.confirmLabel}</sp-button>`:r``}</sp-dialog></div>`}updated(t){t.has("open")&&this.open&&this.dialog.updateComplete.then((()=>{this.dialog.shouldManageTabOrderForScrolling()}))}}o([i({type:Boolean,reflect:!0})],$e.prototype,"error",void 0),o([i({attribute:"cancel-label"})],$e.prototype,"cancelLabel",void 0),o([i({attribute:"confirm-label"})],$e.prototype,"confirmLabel",void 0),o([i({type:Boolean,reflect:!0})],$e.prototype,"dismissable",void 0),o([i()],$e.prototype,"footer",void 0),o([i()],$e.prototype,"hero",void 0),o([i({attribute:"hero-label"})],$e.prototype,"heroLabel",void 0),o([i({type:Boolean,reflect:!0,attribute:"no-divider"})],$e.prototype,"noDivider",void 0),o([i({type:Boolean,reflect:!0})],$e.prototype,"open",void 0),o([i({type:String,reflect:!0})],$e.prototype,"mode",void 0),o([i({type:String,reflect:!0})],$e.prototype,"size",void 0),o([i({attribute:"secondary-label"})],$e.prototype,"secondaryLabel",void 0),o([i()],$e.prototype,"headline",void 0),o([i({type:Boolean})],$e.prototype,"responsive",void 0),o([i({type:Boolean})],$e.prototype,"underlay",void 0),o([g("sp-dialog")],$e.prototype,"dialog",void 0),customElements.define("sp-dialog-wrapper",$e);var Ee=n`:host{border-radius:var(
...
)}`;class Ar extends(f(e)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Cr]}render(){return r`<slot></slot>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}o([i({type:Boolean,reflect:!0})],Ar.prototype,"disabled",void 0),o([i({reflect:!0})],Ar.prototype,"variant",void 0),customElements.define("sp-status-light",Ar);var Sr=n`:host{--spectrum-switch-handle-size:var(
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var $r=n`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class Er extends qt{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[Sr,$r]:[Sr]}render(){return r`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("role","switch")}updated(t){t.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}o([i({type:Boolean,reflect:!0})],Er.prototype,"emphasized",void 0),customElements.define("sp-switch",Er);var Lr=n`:host{box-sizing:border-box;cursor:pointer;height:var(--spectrum-tabs-item-height);line-height:var(--spectrum-tabs-item-height);outline:0;position:relative;text-decoration:none;transition:color var(--spectrum-global-animation-duration-100,.13s) ease-out;white-space:nowrap;z-index:1}:host([disabled]){cursor:default}:host([disabled]) #item-label{cursor:default}:host(:not([vertical])) ::slotted([slot=icon]){height:var(
...
--spectrum-alias-focus-ring-gap,
var(--spectrum-global-dimension-static-size-25)
)*-1);position:absolute;right:0;top:0}::slotted(:not(img)){display:none}`;class Ur extends(f(e,{validSizes:["xxs","xs","s","m","l"],defaultSize:"s"})){constructor(){super(...arguments),this.cover=!1}static get styles(){return[Or]}render(){return r`${this.background?r`<div class="background" style="background:${this.background}"></div>`:r``}<slot></slot>`}}o([i({type:String,reflect:!0})],Ur.prototype,"background",void 0),o([i({type:Boolean,reflect:!0})],Ur.prototype,"cover",void 0),customElements.define("sp-thumbnail",Ur);var Nr=n`:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
