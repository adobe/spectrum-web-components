...
`,we=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,Te=(t,e,r,o)=>{for(var s,i=o>1?void 0:o?ze(e,r):e,a=t.length-1;a>=0;a--)(s=t[a])&&(i=(o?s(e,r,i):s(i))||i);return o&&i&&we(e,r,i),i};const Ce={s:i`
    ...
    `,xl:i`
        ...
        ></sp-icon-dash300>
    `};class Be extends(m(ye)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[ke,j,xe]}render(){return i`
            ${super.render()}
            <span id="box">
                ${Ce[this.size]}
                ${Pe[this.size]}
...
`,uo=Object.defineProperty,po=Object.getOwnPropertyDescriptor,ho=(t,e,r,o)=>{for(var s,i=o>1?void 0:o?po(e,r):e,a=t.length-1;a>=0;a--)(s=t[a])&&(i=(o?s(e,r,i):s(i))||i);return o&&i&&uo(e,r,i),i};class mo extends($(s,{mode:"external"})){constructor(){super(...arguments),this.horizontal=!1,this.invalid=!1,this.label="",this.vertical=!1}static get styles(){return[no]}handleSlotchange(){}render(){return i`
...
//# sourceMappingURL=cb01b57f.js.map
