import{f as e,S as t}from"./6b792af6.js";import{i as r}from"./112b2095.js";import"./241fbae4.js";import"./33de4cbe.js";import{S as o}from"./492935df.js";import{T as i,A as c,x as a}from"./032a7dfd.js";import{n as l}from"./cb80e8ab.js";import{d as s}from"./25a3ae37.js";import"./1c4bacfd.js";import{M as n}from"./bd309138.js";import{a as d}from"./e636094a.js";import"./236b0f6c.js";import"./b16bf061.js";import{S as u}from"./db23c3d9.js";import{e as p,i as m,t as h}from"./16ab2288.js";import{e as v,a as f}from"./00399ab6.js";import{l as b}from"./9beeb9da.js";import{t as x}from"./f93453f4.js";import{i as g}from"./17348440.js";const k=p(class extends m{constructor(e){if(super(e),e.type!==h.PROPERTY&&e.type!==h.ATTRIBUTE&&e.type!==h.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!v(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===h.PROPERTY){if(t===r[o])return i}else if(e.type===h.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===h.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return f(e),t}});var y=r`
...
`,L=Object.defineProperty,O=Object.getOwnPropertyDescriptor,U=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?O(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&L(t,r,c),c};const R=e=>e.stopPropagation();class F extends S{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,_]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
...
//# sourceMappingURL=040bb5cd.js.map
