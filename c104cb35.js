import{e as t,R as e,b as o,a as r,$ as i,_ as l,w as c}from"./972cd366.js";import{e as a,a as n,t as s,S as u,d,f as p,l as m,b as v,c as h,i as f}from"./ae5033a4.js";import{r as b}from"./e50c5e8d.js";import"./a488e108.js";import"./8c4cb5d7.js";import"./32b6c782.js";function x(e){return t({...e,state:!0})}const{H:g}=e,w=t=>void 0===t.strings,k=()=>document.createComment(""),y=(t,e,o)=>{var r;const i=t._$AA.parentNode,l=void 0===e?t._$AB:e._$AA;if(void 0===o){const e=i.insertBefore(k(),l),r=i.insertBefore(k(),l);o=new g(e,r,t,t.options)}else{const e=o._$AB.nextSibling,c=o._$AM,a=c!==t;if(a){let e;null===(r=o._$AQ)||void 0===r||r.call(o,t),o._$AM=t,void 0!==o._$AP&&(e=t._$AU)!==c._$AU&&o._$AP(e)}if(e!==l||a){let t=o._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,l),t=e}}}return o},q=(t,e,o=t)=>(t._$AI(e,o),t),z={},$=(t,e=z)=>t._$AH=e,T=t=>t._$AH,B=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let o=t._$AA;const r=t._$AB.nextSibling;for(;o!==r;){const t=o.nextSibling;o.remove(),o=t}},E=a(class extends n{constructor(t){if(super(t),t.type!==s.PROPERTY&&t.type!==s.ATTRIBUTE&&t.type!==s.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!w(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===o||e===r)return e;const i=t.element,l=t.name;if(t.type===s.PROPERTY){if(e===i[l])return o}else if(t.type===s.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(l))return o}else if(t.type===s.ATTRIBUTE&&i.getAttribute(l)===e+"")return o;return $(t),e}});var A=b`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
--spectrum-textfield-m-textonly-focus-ring-border-color-key-focus,var(--spectrum-alias-focus-ring-color)
)!important}:host([multiline]:not([quiet])) #textfield:after{box-shadow:none}`;const C=["text","url","tel","email","password"];class U extends(L(v)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[F,h]}get type(){var t;return null!==(t=C.find((t=>t===this._type)))&&void 0!==t?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?i`<sp-icon-alert id="invalid" class="icon"></sp-icon-alert>`:this.valid?i`<sp-icon-checkmark100 id="valid" class="icon spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`:c}get displayValue(){return this.value.toString()}get renderMultiline(){return i`${this.grows&&!this.quiet?i`<div id="sizer">${this.value}​</div>`:c} <textarea aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${m(this.invalid||void 0)}" class="input" maxlength="${m(this.maxlength>-1?this.maxlength:void 0)}" minlength="${m(this.minlength>-1?this.minlength:void 0)}" pattern="${m(this.pattern)}" placeholder="${this.placeholder}" .value="${this.displayValue}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${m(this.autocomplete)}"></textarea>`}get renderInput(){return i`<input type="${this.type}" aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${m(this.invalid||void 0)}" class="input" maxlength="${m(this.maxlength>-1?this.maxlength:void 0)}" minlength="${m(this.minlength>-1?this.minlength:void 0)}" pattern="${m(this.pattern)}" placeholder="${this.placeholder}" .value="${E(this.displayValue)}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${m(this.autocomplete)}">`}renderField(){return i`${this.renderStateIcons()} ${this.multiline?this.renderMultiline:this.renderInput}`}render(){return i`<div id="textfield">${this.renderField()}</div>${this.renderHelpText(this.invalid)}`}updated(t){(t.has("value")||t.has("required")&&this.required)&&this.checkValidity()}checkValidity(){let t=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t}return t}}l([t({attribute:"allowed-keys"})],U.prototype,"allowedKeys",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"focused",void 0),l([f(".input")],U.prototype,"inputElement",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"invalid",void 0),l([t()],U.prototype,"label",void 0),l([t()],U.prototype,"placeholder",void 0),l([t({attribute:"type",reflect:!0})],U.prototype,"_type",void 0),l([x()],U.prototype,"type",null),l([t()],U.prototype,"pattern",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"grows",void 0),l([t({type:Number})],U.prototype,"maxlength",void 0),l([t({type:Number})],U.prototype,"minlength",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"multiline",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"readonly",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"valid",void 0),l([t({type:String})],U.prototype,"value",null),l([t({type:Boolean,reflect:!0})],U.prototype,"quiet",void 0),l([t({type:Boolean,reflect:!0})],U.prototype,"required",void 0),l([t({type:String,reflect:!0})],U.prototype,"autocomplete",void 0);class j extends U{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}l([t({type:String})],j.prototype,"value",null);var R=b`:host{--spectrum-search-quiet-button-offset:calc(var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const G=t=>t.stopPropagation();class M extends j{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,R]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return i`<form action="${this.action}" id="form" method="${m(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?i`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${G}"></sp-clear-button>`:i``}</form>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}updated(t){super.updated(t),this.multiline=!1}}l([t()],M.prototype,"action",void 0),l([t()],M.prototype,"label",void 0),l([t()],M.prototype,"method",void 0),l([t()],M.prototype,"placeholder",void 0),l([f("#form")],M.prototype,"form",void 0),customElements.define("sp-search",M);export{L as M,U as T,T as a,H as b,q as c,j as d,B as m,w as r,$ as s,x as t,y as u};
//# sourceMappingURL=c104cb35.js.map
