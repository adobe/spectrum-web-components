...
)}`;const f=Symbol("slotElementObserver"),k=Symbol("startObserving"),y=Symbol("slotContentIsPresent");function x(e,t){var i;const s=Array.isArray(t)?t:[t];class r extends e{constructor(){super(...arguments),this[i]=new Map,this.managePresenceObservedSlot=()=>{s.forEach((e=>{this[y].set(e,!!this.querySelector(e))})),this.requestUpdate()}}get slotContentIsPresent(){if(1===s.length)return this[y].get(s[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(e){if(this[y].has(e))return this[y].get(e)||!1;throw new Error("The provided selector `` is not being observed.")}[(i=y,k)](){this[f]||(this[f]=new MutationObserver(this.managePresenceObservedSlot)),this[f].observe(this,{childList:!0,subtree:!0}),this.managePresenceObservedSlot()}connectedCallback(){super.connectedCallback(),this[k]()}disconnectedCallback(){this[f].disconnect(),super.disconnectedCallback()}}return r}const w=Symbol("slotElementObserver"),z=Symbol("assignedNodes"),E=Symbol("startObserving");function C(e,s){var r;class o extends e{constructor(){super(...arguments),this.slotHasContent=!1}manageTextObservedSlot(){if(!this[z])return;const e=[...this[z]].filter((e=>!!e.tagName||!!e.textContent&&e.textContent.trim()));this.slotHasContent=e.length>0}firstUpdated(e){super.firstUpdated(e),this.manageTextObservedSlot()}[(r=z,E)](){if(!this[w]){const e=e=>{for(const t of e)"characterData"===t.type&&this.manageTextObservedSlot()};this[w]=new MutationObserver(e)}this[w].observe(this,{characterData:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this[E]()}disconnectedCallback(){this[w]&&this[w].disconnect(),super.disconnectedCallback()}}return t([i({type:Boolean,attribute:!1})],o.prototype,"slotHasContent",void 0),t([n(s,!0)],o.prototype,r,void 0),o}class A extends(v(C(x(b,'[slot="icon"]')))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const e=[a`<div id="label" ?hidden="${!this.hasLabel}"><slot id="slot" @slotchange="${this.manageTextObservedSlot}"></slot></div>`];return this.hasIcon&&e.unshift(a`<slot name="icon" ?icon-only="${!this.hasLabel}"></slot>`),e}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(e){if(this.disabled)return e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let e=!1;if(this.anchorElement)this.anchorElement.click(),e=!0;else if("button"!==this.type){const t=document.createElement("button");t.type=this.type,this.insertAdjacentElement("afterend",t),t.click(),t.remove(),e=!0}return e}renderAnchor(){return a`${this.buttonContent} ${super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"})}`}renderButton(){return a`${this.buttonContent}`}render(){return this.href&&this.href.length>0?this.renderAnchor():this.renderButton()}handleKeydown(e){const{code:t}=e;switch(t){case"Space":e.preventDefault(),void 0===this.href&&(this.addEventListener("keyup",this.handleKeyup),this.active=!0)}}handleKeypress(e){const{code:t}=e;switch(t){case"Enter":case"NumpadEnter":this.click()}}handleKeyup(e){const{code:t}=e;switch(t){case"Space":this.removeEventListener("keyup",this.handleKeyup),this.active=!1,this.click()}}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}manageAnchor(){this.href&&this.href.length>0?("button"===this.getAttribute("role")&&this.setAttribute("role","link"),this.removeEventListener("click",this.shouldProxyClick)):(this.hasAttribute("role")&&"link"!==this.getAttribute("role")||this.setAttribute("role","button"),this.addEventListener("click",this.shouldProxyClick))}firstUpdated(e){super.firstUpdated(e),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAnchor(),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.addEventListener("pointerdown",this.handlePointerdown)}updated(e){super.updated(e),e.has("href")&&this.manageAnchor(),e.has("label")&&this.setAttribute("aria-label",this.label||""),e.has("active")&&(this.active?(this.addEventListener("focusout",this.handleRemoveActive),this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("focusout",this.handleRemoveActive),this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1)}}t([i({type:Boolean,reflect:!0})],A.prototype,"active",void 0),t([i({type:String})],A.prototype,"type",void 0),t([c(".anchor")],A.prototype,"anchorElement",void 0);var I=e`:host{display:inline-flex;vertical-align:top}:host([dir]){-webkit-appearance:none}:host([disabled]){cursor:auto;pointer-events:none}#button{bottom:0;left:0;position:absolute;right:0;top:0}:host:after{pointer-events:none}slot[name=icon]::slotted(img),slot[name=icon]::slotted(svg){fill:currentColor;stroke:currentColor;height:var(
--spectrum-alias-workflow-icon-size-m,var(--spectrum-global-dimension-size-225)
);width:var(
--spectrum-alias-workflow-icon-size-m,var(--spectrum-global-dimension-size-225)
)}`;class L extends A{static get styles(){return[I]}}var q=e`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
)}`;var U=e`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Cross75{height:var(--spectrum-alias-ui-icon-cross-size-75);width:var(
...
)}`;class T extends L{constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,q,U]}get buttonContent(){return[a`<sp-icon-cross75 slot="icon" class="icon spectrum-UIIcon-Cross75"></sp-icon-cross75>`]}}t([i({reflect:!0})],T.prototype,"variant",void 0);var S=e`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Asterisk75{height:var(--spectrum-alias-ui-icon-asterisk-size-300);width:var(
...
)}`;var N=e`:host([size=s]){--spectrum-fieldlabel-padding-top:var(
...
)}:host([side-aligned=start]) .required-icon{margin-top:0}`;class F extends(l(o)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[N,S]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),r=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():r&&r.forceFocusVisible&&r.forceFocusVisible()}async manageFor(){if(!this.for)return;const e=this.getRootNode(),t=e.querySelector(`#${this.for}`);if(t){if(t.localName.search("-")>0&&await customElements.whenDefined(t.localName),void 0!==t.updateComplete&&await t.updateComplete,this.target=t.focusElement||t,this.target){this.target.getRootNode()===e?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",this.labelText)}return Promise.resolve()}}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});if(!e.length)return"";return e.map((e=>(e.textContent||"").trim())).join(" ")}render(){return a`<label><slot @slotchange="${this.manageFor}"></slot>${this.required?a`<sp-icon-asterisk100 class="required-icon spectrum-UIIcon-Asterisk100"></sp-icon-asterisk100>`:a``}</label>`}firstUpdated(e){super.firstUpdated(e),this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${F.instanceCount++}`),this.addEventListener("click",this.handleClick)}updated(e){super.updated(e),(e.has("for")||e.has("id"))&&this.manageFor()}}F.instanceCount=0,t([i({type:Boolean,reflect:!0})],F.prototype,"disabled",void 0),t([i({type:String})],F.prototype,"id",void 0),t([i({type:String})],F.prototype,"for",void 0),t([i({type:Boolean,reflect:!0})],F.prototype,"required",void 0),t([c("slot")],F.prototype,"slotEl",void 0),t([i({type:String,reflect:!0,attribute:"side-aligned"})],F.prototype,"sideAligned",void 0),customElements.define("sp-field-label",F),customElements.define("sp-clear-button",T);export{A as B,h as F,v as L,C as O,l as S,b as a,L as b,g as c,x as d,U as e,u as i};
//# sourceMappingURL=394c1523.js.map
