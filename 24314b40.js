import{R as e}from"./39665332.js";import{i as t}from"./112b2095.js";import{n as s,S as n}from"./cb80e8ab.js";import{x as a,A as r}from"./032a7dfd.js";import{L as i,a as o}from"./e636094a.js";import{l as c}from"./9beeb9da.js";import{d}from"./25a3ae37.js";var l=t`
...
`,u=Object.defineProperty,m=Object.getOwnPropertyDescriptor,p=(e,t,s,n)=>{for(var a,r=n>1?void 0:n?m(t,s):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(n?a(t,s,r):a(r))||r);return n&&r&&u(t,s,r),r};const h=class e extends(i(o)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[v]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,s=this.parentElement;for(;s instanceof e;)t++,s=s.parentElement;return t}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||null!=e&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`
            <a
                href=${this.href||"#"}
...
`,b=Object.defineProperty,k=Object.getOwnPropertyDescriptor;class y extends n{constructor(){super(...arguments),this.label=""}static get styles(){return[v,f]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`
            <h2 id="heading">${this.label}</h2>
            <div id="list" aria-labelledby="heading" role="list">
                <slot name="descendant"></slot>
            </div>
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","listitem")}}((e,t,s,n)=>{for(var a,r=n>1?void 0:n?k(t,s):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(n?a(t,s,r):a(r))||r);n&&r&&b(t,s,r)})([s({reflect:!0})],y.prototype,"label",2);var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,z=(e,t,s,n)=>{for(var a,r=n>1?void 0:n?x(t,s):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(n?a(t,s,r):a(r))||r);return n&&r&&w(t,s,r),r};class j extends o{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new e(this,{focusInIndex:e=>{let t,s=e.findIndex((e=>(e.value===this.value&&this.isDisabledChild(e)&&(t=e.closest("sp-sidenav-item:not([expanded])")),this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e))));return-1===s&&t&&(s=e.findIndex((e=>e===t))),s},direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)}),this.manageTabIndex=!1,this.value=void 0,this.variant=void 0,this.label=void 0}static get styles(){return[l]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache()}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof y||!t.disabled&&t instanceof g&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return a`
            <nav
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}z([s({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],j.prototype,"manageTabIndex",2),z([s({reflect:!0})],j.prototype,"value",2),z([s({reflect:!0})],j.prototype,"variant",2),z([s({reflect:!0})],j.prototype,"label",2),d("sp-sidenav",j),d("sp-sidenav-item",g);export{y as S};
//# sourceMappingURL=24314b40.js.map
