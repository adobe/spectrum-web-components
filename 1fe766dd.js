import{r as t}from"./e50c5e8d.js";var e=t`.spectrum{color:var(--spectrum-body-m-text-color,var(--spectrum-alias-text-color));font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
);font-size:var(
--spectrum-alias-font-size-default,var(--spectrum-global-dimension-font-size-100)
)}`;var a=t`.spectrum:lang(ar){font-family:var(
...
)}`;var r=[e,a,t`.spectrum-Body--sizeXXXL{font-size:var(
...
--spectrum-body-m-text-color,var(--spectrum-alias-text-color)
)}`];export{r as a,e as b,a as l};
//# sourceMappingURL=1fe766dd.js.map
