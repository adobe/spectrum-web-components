import{I as e,S as t}from"./9698837f.js";import{i as r}from"./67a87733.js";import"./ff67cab2.js";import{S as o}from"./c316f8fa.js";import{T as i,A as c,x as a,e as l,d as s}from"./cd228091.js";import"./dc4d7e95.js";import{c as n}from"./bdc657fb.js";import{l as d,$ as u,i as p,a as m}from"./6b1a3173.js";import"./9cdb9ada.js";import"./6e6d47c3.js";import{e as f,i as v,t as h}from"./16ab2288.js";import{e as b,s as x}from"./7dca79b5.js";import{t as g}from"./0d9e6cef.js";const k=f(class extends v{constructor(e){if(super(e),e.type!==h.PROPERTY&&e.type!==h.ATTRIBUTE&&e.type!==h.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!b(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===h.PROPERTY){if(t===r[o])return i}else if(e.type===h.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===h.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return x(e),t}});var y=r`
...
`,w=Object.defineProperty,z=Object.getOwnPropertyDescriptor;const q={s:()=>a`
    ...
    `};class T extends(o(t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,y,e]}get buttonContent(){return[q[this.size]()]}render(){return a`
        ...
        `}}((e,t,r,o)=>{for(var i,c=o>1?void 0:o?z(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);o&&c&&w(t,r,c)})([l({reflect:!0})],T.prototype,"variant",2);const $=class{constructor(e,{mode:t}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=e,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=t}get isInternal(){return"internal"===this.mode}render(e){return a`
            <div id=${d(this.isInternal?this.id:void 0)}>
                <slot
...
`,L=Object.defineProperty,C=Object.getOwnPropertyDescriptor,S=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?C(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&L(t,r,c),c};const j=["text","url","tel","email","password"];class F extends(E(m)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[I,u]}get type(){var e;return null!=(e=j.find((e=>e===this._type)))?e:"text"}set type(e){const t=this._type;this._type=e,this.requestUpdate("type",t)}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,t,r="none"){this.inputElement.setSelectionRange(e,t,r)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const e=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(e,e)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?a`
        ...
        `}update(e){(e.has("value")||e.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(e)}checkValidity(){let e=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(e=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(e=e&&this.value.toString().length>=this.minlength),this.valid=e,this.invalid=!e),e}}S([l({attribute:"allowed-keys"})],F.prototype,"allowedKeys",2),S([l({type:Boolean,reflect:!0})],F.prototype,"focused",2),S([p(".input")],F.prototype,"inputElement",2),S([l({type:Boolean,reflect:!0})],F.prototype,"invalid",2),S([l()],F.prototype,"label",2),S([l()],F.prototype,"placeholder",2),S([l({attribute:"type",reflect:!0})],F.prototype,"_type",2),S([g()],F.prototype,"type",1),S([l()],F.prototype,"pattern",2),S([l({type:Boolean,reflect:!0})],F.prototype,"grows",2),S([l({type:Number})],F.prototype,"maxlength",2),S([l({type:Number})],F.prototype,"minlength",2),S([l({type:Boolean,reflect:!0})],F.prototype,"multiline",2),S([l({type:Boolean,reflect:!0})],F.prototype,"readonly",2),S([l({type:Boolean,reflect:!0})],F.prototype,"valid",2),S([l({type:String})],F.prototype,"value",1),S([l({type:Boolean,reflect:!0})],F.prototype,"quiet",2),S([l({type:Boolean,reflect:!0})],F.prototype,"required",2),S([l({type:String,reflect:!0})],F.prototype,"autocomplete",2);class H extends F{constructor(){super(...arguments),this._value=""}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}}S([l({type:String})],H.prototype,"value",1),s("sp-clear-button",T);var _=r`
...
`,O=Object.defineProperty,R=Object.getOwnPropertyDescriptor,U=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?R(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&O(t,r,c),c};const A=e=>e.stopPropagation();class G extends H{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,_]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
                method=${d(this.method)}
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}U([l()],G.prototype,"action",2),U([l()],G.prototype,"label",2),U([l()],G.prototype,"method",2),U([l()],G.prototype,"placeholder",2),U([p("#form")],G.prototype,"form",2),s("sp-search",G);export{E as M,F as T,H as a};
//# sourceMappingURL=075ffda9.js.map
