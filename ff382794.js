import"./3b101b71.js";import{L as e,O as o,t,i as r,F as n}from"./0fd5475c.js";import"./6b778735.js";import{i as c}from"./1ab7ceed.js";import{E as i}from"./1bc378e4.js";import{O as a}from"./b92db46c.js";import{x as s,A as l,n as m,d as u}from"./637c92da.js";var h=c`
...
`,v=Object.defineProperty,p=Object.getOwnPropertyDescriptor,b=(e,o,t,r)=>{for(var n,c=r>1?void 0:r?p(o,t):o,i=e.length-1;i>=0;i--)(n=e[i])&&(c=(r?n(o,t,c):n(c))||c);return r&&c&&v(o,t,c),c};class f extends Event{constructor(e){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0}),this.menuCascade=new WeakMap,this.clear(e)}clear(e){this._item=e,this.currentAncestorWithSelects=void 0,e.menuData={cleanupSteps:[],focusRoot:void 0,selectionRoot:void 0,parentMenu:void 0},this.menuCascade=new WeakMap}get item(){return this._item}}class k extends(e(o(a(n,'[slot="icon"]')))){constructor(){super(),this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.hasSubmenu=!1,this.noWrap=!1,this.open=!1,this.proxyFocus=()=>{this.focus()},this.handleBeforetoggle=e=>{"closed"===e.newState&&(this.open=!0,this.overlayElement.manuallyKeepOpen(),this.overlayElement.removeEventListener("beforetoggle",this.handleBeforetoggle))},this.recentlyLeftChild=!1,this.willDispatchUpdate=!1,this.menuData={focusRoot:void 0,parentMenu:void 0,selectionRoot:void 0,cleanupSteps:[]},this.addEventListener("click",this.handleClickCapture,{capture:!0}),new t(this,{config:{characterData:!0,childList:!0,subtree:!0},callback:()=>{this.breakItemChildrenCache()}})}static get styles(){return[d,i,h]}get value(){return this._value||this.itemText}set value(e){e!==this._value&&(this._value=e||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return this.itemChildren.content.reduce(((e,o)=>e+(o.textContent||"").trim()),"")}get focusElement(){return this}get hasIcon(){return this.slotContentIsPresent}get itemChildren(){if(!this.iconSlot||!this.contentSlot)return{icon:[],content:[]};if(this._itemChildren)return this._itemChildren;const e=this.iconSlot.assignedElements().map((e=>{const o=e.cloneNode(!0);return o.removeAttribute("slot"),o.classList.toggle("icon"),o})),o=this.contentSlot.assignedNodes().map((e=>e.cloneNode(!0)));return this._itemChildren={icon:e,content:o},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(e){if(this.disabled)return e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),!1}shouldProxyClick(){let e=!1;return this.anchorElement&&(this.anchorElement.click(),e=!0),e}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}renderSubmenu(){const e=s`
            <slot
                name="submenu"
            ...
            ></slot>
        `;return this.hasSubmenu?(import("./141fd338.js").then((function(e){return e.s})),import("./ea59e929.js"),s`
            <sp-overlay
                .triggerElement=${this}
        ...
        `):e}render(){return s`
            ...
            ${this.renderSubmenu()}
        `}manageSubmenu(e){const o=e.target.assignedElements({flatten:!0});this.hasSubmenu=!!o.length,this.hasSubmenu&&this.setAttribute("aria-haspopup","true")}handleRemoveActive(){this.open||(this.active=!1)}handlePointerdown(e){this.active=!0,e.target===this&&this.hasSubmenu&&this.open&&(this.addEventListener("focus",this.handleSubmenuFocus,{once:!0}),this.overlayElement.addEventListener("beforetoggle",this.handleBeforetoggle))}firstUpdated(e){super.firstUpdated(e),this.setAttribute("tabindex","-1"),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("pointerenter",this.closeOverlaysForRoot),this.hasAttribute("id")||(this.id=`sp-menu-item-${crypto.randomUUID().slice(0,8)}`)}closeOverlaysForRoot(){var e;this.open||null==(e=this.menuData.parentMenu)||e.closeDescendentOverlays()}handleSubmenuClick(e){e.composedPath().includes(this.overlayElement)||this.openOverlay()}handleSubmenuFocus(){requestAnimationFrame((()=>{this.overlayElement.open=this.open}))}handlePointerenter(){if(this.leaveTimeout)return clearTimeout(this.leaveTimeout),void delete this.leaveTimeout;this.openOverlay()}handlePointerleave(){this.open&&!this.recentlyLeftChild&&(this.leaveTimeout=setTimeout((()=>{delete this.leaveTimeout,this.open=!1}),100))}handleSubmenuChange(e){var o;e.stopPropagation(),null==(o=this.menuData.selectionRoot)||o.selectOrToggleItem(this)}handleSubmenuPointerenter(){this.recentlyLeftChild=!0}async handleSubmenuPointerleave(){requestAnimationFrame((()=>{this.recentlyLeftChild=!1}))}handleSubmenuOpen(e){this.focused=!1;const o=e.composedPath().find((e=>e!==this.overlayElement&&"sp-overlay"===e.localName));this.overlayElement.parentOverlayToForceClose=o}cleanup(){this.open=!1,this.active=!1}async openOverlay(){!this.hasSubmenu||this.open||this.disabled||(this.open=!0,this.active=!0,this.setAttribute("aria-expanded","true"),this.addEventListener("sp-closed",this.cleanup,{once:!0}))}updateAriaSelected(){const e=this.getAttribute("role");"option"===e?this.setAttribute("aria-selected",this.selected?"true":"false"):("menuitemcheckbox"===e||"menuitemradio"===e)&&this.setAttribute("aria-checked",this.selected?"true":"false")}setRole(e){this.setAttribute("role",e),this.updateAriaSelected()}updated(e){var o,t,r;if(super.updated(e),e.has("label")&&(this.label||void 0!==e.get("label"))&&this.setAttribute("aria-label",this.label||""),e.has("active")&&(this.active||void 0!==e.get("active")))if(this.active){null==(o=this.menuData.selectionRoot)||o.closeDescendentOverlays(),this.abortControllerPointer=new AbortController;const e={signal:this.abortControllerPointer.signal};this.addEventListener("pointerup",this.handleRemoveActive,e),this.addEventListener("pointerleave",this.handleRemoveActive,e),this.addEventListener("pointercancel",this.handleRemoveActive,e)}else null==(t=this.abortControllerPointer)||t.abort();if(this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1),e.has("selected")&&this.updateAriaSelected(),e.has("hasSubmenu")&&(this.hasSubmenu||void 0!==e.get("hasSubmenu")))if(this.hasSubmenu){this.abortControllerSubmenu=new AbortController;const e={signal:this.abortControllerSubmenu.signal};this.addEventListener("click",this.handleSubmenuClick,e),this.addEventListener("pointerenter",this.handlePointerenter,e),this.addEventListener("pointerleave",this.handlePointerleave,e),this.addEventListener("sp-opened",this.handleSubmenuOpen,e)}else null==(r=this.abortControllerSubmenu)||r.abort()}connectedCallback(){super.connectedCallback(),this.triggerUpdate()}disconnectedCallback(){this.menuData.cleanupSteps.forEach((e=>e(this))),super.disconnectedCallback()}async triggerUpdate(){this.willDispatchUpdate||(this.willDispatchUpdate=!0,await new Promise((e=>requestAnimationFrame(e))),this.dispatchUpdate())}dispatchUpdate(){this.dispatchEvent(new f(this)),this.willDispatchUpdate=!1}}b([m({type:Boolean,reflect:!0})],k.prototype,"active",2),b([m({type:Boolean,reflect:!0})],k.prototype,"focused",2),b([m({type:Boolean,reflect:!0})],k.prototype,"selected",2),b([m({type:String})],k.prototype,"value",1),b([m({type:Boolean,reflect:!0,attribute:"has-submenu"})],k.prototype,"hasSubmenu",2),b([r("slot:not([name])")],k.prototype,"contentSlot",2),b([r('slot[name="icon"]')],k.prototype,"iconSlot",2),b([m({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],k.prototype,"noWrap",2),b([r(".anchor")],k.prototype,"anchorElement",2),b([r("sp-overlay")],k.prototype,"overlayElement",2),b([m({type:Boolean,reflect:!0})],k.prototype,"open",2),u("sp-menu-item",k);var g=c`
...
)}:host([quiet]) a{-webkit-text-decoration:none;text-decoration:none}:host([static=white]) a{color:var(
--highcontrast-link-text-color-white,var(--mod-link-text-color-white,var(--spectrum-link-text-color-white))
)}:host([static=white]) a:active,:host([static=white]) a:focus{color:var(
--highcontrast-link-text-color-white,var(--mod-link-text-color-white,var(--spectrum-link-text-color-white))
...
)}:host([static=black]) a:active,:host([static=black]) a:focus{color:var(
--highcontrast-link-text-color-black,var(--mod-link-text-color-black,var(--spectrum-link-text-color-black))
...
`,x=Object.defineProperty,y=Object.getOwnPropertyDescriptor,w=(e,o,t,r)=>{for(var n,c=r>1?void 0:r?y(o,t):o,i=e.length-1;i>=0;i--)(n=e[i])&&(c=(r?n(o,t,c):n(c))||c);return r&&c&&x(o,t,c),c};class I extends(e(n)){constructor(){super(...arguments),this.quiet=!1}static get styles(){return[g]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}w([r("#anchor")],I.prototype,"anchorElement",2),w([m({type:String,reflect:!0})],I.prototype,"variant",2),w([m({type:String,reflect:!0})],I.prototype,"static",2),w([m({type:Boolean,reflect:!0,attribute:"quiet"})],I.prototype,"quiet",2),u("sp-link",I);const C="(prefers-color-scheme: dark)",U="(max-width: 700px) and (hover: none) and (pointer: coarse), (max-height: 700px) and (hover: none) and (pointer: coarse)";class A{constructor(e,o){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(o),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;null==(e=this.media)||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;null==(e=this.media)||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}}export{C as D,U as I,A as M,h as b};
//# sourceMappingURL=ff382794.js.map
