import{T as t}from"./d25506d7.js";import{b as e,$ as o,_ as r,e as i,S as a,w as c,x as n}from"./5fa01386.js";import{r as s}from"./e50c5e8d.js";import{e as l,a as u,t as d,L as m,b as p,c as b,i as v,S as h,d as g,f as x,B as f}from"./5caa06c0.js";import"./b1b180c7.js";import"./b150c0bd.js";import"./ad8a2b08.js";import"./4d553a04.js";customElements.define("sp-theme",t);const y=l(class extends u{constructor(t){var e;if(super(t),t.type!==d.ATTRIBUTE||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[o]){var r,i;if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.et=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in o)o[t]&&!(null===(r=this.et)||void 0===r?void 0:r.has(t))&&this.st.add(t);return this.render(o)}const a=t.element.classList;this.st.forEach((t=>{t in o||(a.remove(t),this.st.delete(t))}));for(const t in o){const e=!!o[t];e===this.st.has(t)||(null===(i=this.et)||void 0===i?void 0:i.has(t))||(e?(a.add(t),this.st.add(t)):(a.remove(t),this.st.delete(t)))}return e}});var k=s`#button{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-appearance:button;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
