import"./swc.DnPOj-Ed.js";import"./swc.C7vjBqkA.js";import"./swc.DRg5zi_5.js";import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.x8WofHoL.js";import{i as s}from"./swc.DpYYvrpg.js";import{S as n,n as a}from"./swc.BvXu6tu0.js";import{x as l,j as i}from"./swc.DAPqj1CM.js";import{o as r}from"./swc.BljSg25L.js";const p=s`
...
`;var c=Object.defineProperty,h=(t,e,o,s)=>{for(var n,a=void 0,l=t.length-1;l>=0;l--)(n=t[l])&&(a=n(e,o,a)||a);return a&&c(e,o,a),a};class u extends n{constructor(){super(...arguments),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(import("./swc.7dNqXy5Q.js").then((function(t){return t.s})),import("./swc.BgZvfBT_.js").then((function(t){return t.s})),l`
            ...
            `):(import("./swc.BYOHP1LX.js").then((function(t){return t.s})),l`
            ...
            `)}handleSlottableRequest(e){if(e.stopPropagation(),e.data===t)return this.open=!1,void i(void 0,e.target);this.open=!0;const o=this.renderOverlayContent();i(o,e.target)}render(){const t=this.isMobile.matches?void 0:this.placement;return l`
            <sp-action-button
                quiet
                size="s"
                id="trigger"
...
//# sourceMappingURL=swc.D4OiOPhi.js.map
