import{a as e}from"./dbe3b25d.js";import{i as t}from"./d230bd74.js";import{S as s,y as i,e as o,b as r}from"./05d6b8f8.js";import{i as a}from"./cda676e5.js";var n=t`
...
`,u=Object.defineProperty,v=Object.getOwnPropertyDescriptor,g=(e,t,s,i)=>{for(var o,r=i>1?void 0:i?v(t,s):t,a=e.length-1;a>=0;a--)(o=e[a])&&(r=(i?o(t,s,r):o(r))||r);return i&&r&&u(t,s,r),r};class f extends s{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[h]}renderTip(){return i`
            <div id="tip">
                <svg
        ...
        `}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(e){if(!e.target||e.target!==this)return;const t=this.shadowRoot.querySelector("#tip");t&&(e.detail.overlayContentTipElement=t)}render(){return i`
            <slot></slot>
            ${this.tip?this.renderTip():r}
        `}}g([o({type:Boolean,reflect:!0})],f.prototype,"dialog",2),g([o({type:Boolean,reflect:!0})],f.prototype,"open",2),g([o({reflect:!0})],f.prototype,"placement",2),g([o({type:Boolean,reflect:!0})],f.prototype,"tip",2),customElements.define("sp-popover",f);export{p as M};
//# sourceMappingURL=d0466158.js.map
