...
export const SelectMultipleIcon = ({
    width = 24,
    height = 24,
    hidden = false,
    ...
    return html`
        ...
        >
            ...
            />
            <path
                d="m12.75,7.5h-.25v-.25c0-1.24023-1.00977-2.25-2.25-2.25h-3c-1.24023,0-2.25,1.00977-2.25,2.25v3c0,1.24023,1.00977,2.25,2.25,2.25h.25v.25c0,1.24023,1.00977,2.25,2.25,2.25h3c1.24023,0,2.25-1.00977,2.25-2.25v-3c0-1.24023-1.00977-2.25-2.25-2.25Zm-5.5,3.5c-.41309,0-.75-.33691-.75-.75v-3c0-.41309.33691-.75.75-.75h3c.41309,0,.75.33691.75.75v.25h-1.25c-1.24023,0-2.25,1.00977-2.25,2.25v1.25h-.25Zm6.25,1.75c0,.41309-.33691.75-.75.75h-3c-.41309,0-.75-.33691-.75-.75v-3c0-.41309.33691-.75.75-.75h3c.41309,0,.75.33691.75.75v3Z"
                fill="currentColor"
            />
        </svg>
    `;
