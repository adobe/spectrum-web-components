...
export const AppsInYourPlanIcon = ({
    width = 24,
    height = 24,
    hidden = false,
    title = 'Apps In Your Plan',
    ...
    return html`
        ...
        >
            ...
            />
            <path
                d="m15.75,9h-2.5c-1.24023,0-2.25-1.00977-2.25-2.25v-2.5c0-1.24023,1.00977-2.25,2.25-2.25h2.5c1.24023,0,2.25,1.00977,2.25,2.25v2.5c0,1.24023-1.00977,2.25-2.25,2.25Z"
                fill="currentColor"
            />
        </svg>
    `;
