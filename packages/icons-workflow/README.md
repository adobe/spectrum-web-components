...
[![See it on NPM!](https://img.shields.io/npm/v/@future-ui/icons-workflow?style=for-the-badge)](https://www.npmjs.com/package/@future-ui/icons-workflow)
[![How big is this package in your project?](https://img.shields.io/bundlephobia/minzip/@future-ui/icons-workflow?style=for-the-badge)](https://bundlephobia.com/result?p=@future-ui/icons-workflow)

```
yarn add @future-ui/icons-workflow
```
...
import { CircleIcon } from '@future-ui/icons-workflow';
...
```js
import { CircleIcon } from '@future-ui/icons-workflow/src/icons.js';
...
} from '@future-ui/icons-workflow/src/icons.js';
import htm from 'htm';
...
In this way the icons exported by `@future-ui/icons-workflow` can be leveraged in projects powered by the the likes of hyperHTML, lighterhtml, lit-html, Preact, React, Vanilla JS, Vue.js, and more!
