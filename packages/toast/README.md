...
[![See it on NPM!](https://img.shields.io/npm/v/@future-ui/toast?style=for-the-badge)](https://www.npmjs.com/package/@future-ui/toast)
[![How big is this package in your project?](https://img.shields.io/bundlephobia/minzip/@future-ui/toast?style=for-the-badge)](https://bundlephobia.com/result?p=@future-ui/toast)
...
```
import { Toast } from '@future-ui/toast';
```
