 ...
 * @template T
 *
 * @description A mixin to add popover functionality to an overlay.
 *
 * @param constructor - The constructor of the AbstractOverlay class
 * @returns A class that extends the AbstractOverlay class with popover functionality.
 *
 * @public
 */
