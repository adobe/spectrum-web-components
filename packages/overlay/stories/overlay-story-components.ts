...
class OverlayDrag extends LitElement {
  ...
  private onSlotChange(event: Event & { target: HTMLSlotElement }): void {
    ...
    this.targetElement.addEventListener('pointerdown', (event: PointerEvent) =>
  ...
  public override render(): TemplateResult {
    return html`
      ...
      <overlay-trigger placement="${this.placement}" type="modal">
        ...
        <sp-popover slot="click-content" direction="${this.placement}" tip>
...
export default class TransientHover extends LitElement {
  ...
  protected override render(): TemplateResult {
    return html`
      <sp-button variant="primary" id="triggerButton">Button popover</sp-button>
      <sp-overlay
        type="auto"
