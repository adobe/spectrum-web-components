...
export const RegisterClickOutside = (): TemplateResult => {
    const handleClickOutside = (): void => {
        ...
        const handleLinkClick = (event: Event): void => {
            ...
            console.log('Registered click outside the overlay');
        };
    ...
    return html`
        <sp-theme system="spectrum" scale="medium" color="light" dir="ltr">
            <sp-button id="download-trigger">Open Overlay</sp-button>
            <sp-overlay
                trigger="download-trigger@click"
                type="modal"
                placement="bottom"
            >
                <sp-popover style="padding: 10px">
                    ...
                    <sp-button @click=${handleClickOutside}>
