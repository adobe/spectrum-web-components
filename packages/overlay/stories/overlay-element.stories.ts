...
import { DialogNotAgain } from '../../dialog/stories/dialog-base.stories.js';
...
export const OverlayWithSlider = {
...
export const OverlayReceivesFocus = {
    render: ({
        interaction,
        open,
        placement,
...
export const all = {
    render: ({ delayed }: Properties): TemplateResult => html`
...
export const actionGroup = {
    render: ({ delayed }: Properties): TemplateResult => {
...
export const actionGroupWithFilters = {
    render: ({ delayed }: Properties): TemplateResult => {
        ...
        return html`
            ...
            <p>
                This story outlines some CSS usage that is not yet covered by
                the placement calculations within the Overlay API.
            </p>
            <sp-popover open class="root">
                <sp-action-group vertical quiet emphasized selects="single">
                    <sp-action-button id="trigger-1" hold-affordance>
