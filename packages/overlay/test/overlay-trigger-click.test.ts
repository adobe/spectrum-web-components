        ...
        it(`closes "${interaction}" overlay on scroll`, async function () {
          const el = await fixture<OverlayTrigger>(html`
            <overlay-trigger
              ...
              content="click"
            >
              <sp-action-button slot="trigger" style="margin: 50vh 0 100vh;">
                <sp-icon-magnify slot="icon"></sp-icon-magnify>
              </sp-action-button>
              <sp-popover slot="click-content" tip>Content</sp-popover>
            </overlay-trigger>
          `);
  ...
  it('opens with a delay on click', async () => {
    const el = await fixture<OverlayTrigger>(html`
      <overlay-trigger placement="right-start">
        ...
        <sp-tooltip slot="click-content" id="content" delayed></sp-tooltip>
      </overlay-trigger>
    `);
