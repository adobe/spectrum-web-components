...
measureFixtureCreation(html`
  <sp-sidenav manage-tab-index>
    ...
    <sp-sidenav-item selected expanded value="Section 2" label="Section 2">
      <sp-sidenav-item value="Section 2a" label="Section 2a"></sp-sidenav-item>
      <sp-sidenav-item value="Section 2b" label="Section 2b"></sp-sidenav-item>
      <sp-sidenav-item value="Section 2c" label="Section 2c"></sp-sidenav-item>
    </sp-sidenav-item>
