...
measureFixtureCreation(html`
    <sp-icon name="ui:Add50"></sp-icon>
    <sp-icon name="ui:Add75"></sp-icon>
    <sp-icon name="ui:Add100"></sp-icon>
    <sp-icon name="ui:Add200"></sp-icon>
    <sp-icon name="ui:Add300"></sp-icon>
    ...
    <sp-icon name="ui:Chevron50"></sp-icon>
    ...
    <sp-icon name="ui:DragHandle75"></sp-icon>
    <sp-icon name="ui:DragHandle100"></sp-icon>
    <sp-icon name="ui:DragHandle200"></sp-icon>
    <sp-icon name="ui:DragHandle300"></sp-icon>
    <sp-icon name="ui:Gripper100"></sp-icon>
    <sp-icon name="ui:LinkOut100"></sp-icon>
    <sp-icon name="ui:LinkOut200"></sp-icon>
    <sp-icon name="ui:LinkOut300"></sp-icon>
    <sp-icon name="ui:LinkOut400"></sp-icon>
`);
