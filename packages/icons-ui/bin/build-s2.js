...
if (!fs.existsSync(`${rootDir}packages/icons-ui/src/elements-s2`)) {
    fs.mkdirSync(`${rootDir}packages/icons-ui/src/elements-s2`);
}
if (!fs.existsSync(`${rootDir}packages/icons-ui/icons-s2`)) {
    fs.mkdirSync(`${rootDir}packages/icons-ui/icons-s2`);
}
fs.writeFileSync(
...
icons.forEach((i) => {
    ...
    const location = path.join(
        rootDir,
        'packages/icons-ui/src/icons-s2',
        fileName
    );
...
`;
    ...
    const exportString = `export {${ComponentName}Icon} from './icons-s2/${id}.js';\r\n`;
    fs.appendFileSync(
        path.join(rootDir, 'packages', 'icons-ui', 'src', 'icons-s2.ts'),
        exportString,
        'utf-8'
    ...
    const importStatement = `\r\nimport '@spectrum-web-components/icons-ui/icons-s2/${iconElementName}.js';`;
