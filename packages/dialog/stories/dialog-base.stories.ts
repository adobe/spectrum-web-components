...
export const disabledButton = {
    render: (): TemplateResult => {
        return html`
            <sp-dialog-base
                ...
                @click=${(event: Event) => {
                    if (
                        (event.target as HTMLElement).localName === 'sp-button'
                    ) {
                        (event.target as HTMLElement).dispatchEvent(
                            new Event('close', {
                                bubbles: true,
    ...
    decorators: [disabledButtonWithOverlayDecorator],
};

export const DialogNotAgain = {
    render: (): TemplateResult => html`
        <sp-dialog-base
            underlay
            @click=${(event: Event) => {
    ...
    render: (): TemplateResult => html`
        ...
        >
            <div id="fully-custom-dialog">
                ...
                <p>
                    The click events for the "Done" button are bound to the
                    story not to the components in specific.
                </p>
                <p>
        ...
        const template = (): TemplateResult => html`
            ...
            >
                <sp-dialog size="m">
                    ...
                    <p>
                        The click on the "OK" button should close the overlay
                        with the correct animation (duration).
                    </p>
                    <sp-button
                        variant="secondary"
                        treatment="fill"
