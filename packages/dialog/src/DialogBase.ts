...
import modalWrapperStyles from '@spectrum-web-components/modal/src/modal-wrapper.css' with { type: 'css' };
import modalStyles from '@spectrum-web-components/modal/src/modal.css' with { type: 'css' };
