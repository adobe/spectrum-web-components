  ...
  it('created the expected accessibility tree', async () => {
    ...
    expect(
      findAccessibilityNode<NamedRoledAndCheckedNode>(
        snapshot,
        (node) =>
          node.role === 'radio' && node.checked && node.name === 'Option 2'
      ),
...
describe('Radio Group', () => {
  ...
  it('respects clicking on disabled attribute causing nothing to happen', async () => {
    ...
    const checkedRadio = radioGroup.querySelector('sp-radio[checked]') as Radio;
  ...
  it('de-checks all but first checked radio if multiple checked', () => {
    ...
    const radio1 = radioGroup.querySelector('sp-radio[value=first]') as Radio;
    const radio2 = radioGroup.querySelector('sp-radio[value=second]') as Radio;
  ...
  it('ensures setting selection updates checked radio', async () => {
    ...
    const radio1 = radioGroup.querySelector('sp-radio[value=first]') as Radio;
    const radio2 = radioGroup.querySelector('sp-radio[value=second]') as Radio;
    const radio3 = radioGroup.querySelector('sp-radio[value=third]') as Radio;
