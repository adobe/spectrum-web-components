...
[![See it on NPM!](https://img.shields.io/npm/v/@iliad-ui/action-menu?style=for-the-badge)](https://www.npmjs.com/package/@iliad-ui/action-menu)
[![How big is this package in your project?](https://img.shields.io/bundlephobia/minzip/@iliad-ui/action-menu?style=for-the-badge)](https://bundlephobia.com/result?p=@iliad-ui/action-menu)
...
The default of `<sp-action-menu>` will load dependencies in `@iliad-ui/overlay` asynchronously via a dynamic import. In the case that you would like to import those tranverse dependencies statically, import the side effectful registration of `<sp-action-menu>` as follows:
