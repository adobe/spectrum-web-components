...
describe("Menu group", () => {
  ...
  it("handles selects for nested menu groups", async () => {
    ...
    const multiGroup = el.querySelector("sp-menu-group#mg-multi") as MenuGroup;
    ...
    const noneGroup = el.querySelector("sp-menu-group#mg-none") as MenuGroup;
  ...
  it("manages complex slotted menu items", async function () {
    ...
    const group = el.renderRoot.querySelector("#group") as ComplexSlottedGroup;
