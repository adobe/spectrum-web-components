...
describe('Menu', () => {
    ...
    // it('only focuses on selected items when they exist, otherwise no item receives focus', async () => {
    //     const el = await fixture<Menu>(html`
    //         <sp-menu>
    ...
    //     // Test 1: When no items are selected, focus should not be set on any item
    //     el.focus();
    //     await elementUpdated(el);

    //     expect(document.activeElement).to.not.equal(firstItem);
    //     expect(document.activeElement).to.not.equal(secondItem);
    //     expect(document.activeElement).to.not.equal(thirdItem);
    //     expect(firstItem.focused).to.be.false;
    //     expect(secondItem.focused).to.be.false;
    //     expect(thirdItem.focused).to.be.false;

    //     // Test 2: When an item is selected, focus should be set on that item
    ...
    //     expect(document.activeElement).to.equal(secondItem);
    //     expect(secondItem.focused).to.be.true;
    //     expect(firstItem.focused).to.be.false;
    //     expect(thirdItem.focused).to.be.false;

    //     // Test 3: When the selected item is deselected, focus should be removed
    ...
    //     // Test 4: When multiple items are selected, focus should be on the first selected item
