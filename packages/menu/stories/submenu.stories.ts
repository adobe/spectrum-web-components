...
class SubmenuReady extends HTMLElement {
	...
	handleSubmenuOpened = async (event: Event): Promise<void> => {
		...
		this.submenuChild = document.querySelector("#submenu-item-2") as MenuItem;
...
export const submenu = (): TemplateResult => {
	...
	return html`
		...
		>
			...
			<sp-menu-group @change=${() => console.log("group change")} role="none">
				...
				<sp-menu-item disabled>
					...
					<sp-menu slot="submenu">
						<sp-menu-item> You shouldn't be able to see this! </sp-menu-item>
