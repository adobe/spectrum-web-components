...
export const mixed = (): TemplateResult => {
  ...
  const update = (event: Event): void => {
    ...
    (document.querySelector('#output') as HTMLElement).textContent = styleRules(
      {
        style,
        weight,
        color,
  ...
  return html`
    ...
    <sp-popover open>
      <sp-menu label="Style/Color" @change="${update}">
        ...
        <sp-menu-divider></sp-menu-divider>
        <sp-menu-group label="Text Decoration" selects="single" id="decoration">
          <sp-menu-item value="none">None</sp-menu-item>
          <sp-menu-item value="overline" selected>Overline</sp-menu-item>
          <sp-menu-item value="line-through">Line-through</sp-menu-item>
