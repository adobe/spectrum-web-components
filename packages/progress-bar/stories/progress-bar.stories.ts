...
export const sideLabel = (): TemplateResult => {
  return html`
    <sp-progress-bar side-label label="Loading" progress="50"></sp-progress-bar>
  `;
};

export const sideIndeterminate = (): TemplateResult => {
  return html`
    <sp-progress-bar side-label label="Loading" indeterminate></sp-progress-bar>
  `;
};
...
export const staticWhite = (): TemplateResult => {
  return makeOverBackground("white")(
    () => html`
      <sp-progress-bar progress="50" static-color="white"></sp-progress-bar>
    `,
  );
};
