...
import tabsSizes from '@spectrum-web-components/tabs/src/tabs-sizes.css' with { type: 'css' };
import tabStyles from '@spectrum-web-components/tabs/src/tabs.css' with { type: 'css' };
