...
export const Default = (): TemplateResult => {
  return html` <sp-checkbox>Checkbox</sp-checkbox> `;
};

export const readonly = (): TemplateResult => {
  return html` <sp-checkbox checked readonly>Checkbox</sp-checkbox> `;
};
...
export const Checked = (): TemplateResult => {
  return html` <sp-checkbox checked>Checkbox</sp-checkbox> `;
};

export const emphasized = (): TemplateResult => {
  return html` <sp-checkbox emphasized>Checkbox</sp-checkbox> `;
};

export const emphasizedIndeterminate = (): TemplateResult => {
  return html` <sp-checkbox emphasized indeterminate>Checkbox</sp-checkbox> `;
};

export const emphasizedChecked = (): TemplateResult => {
  return html` <sp-checkbox emphasized checked>Checkbox</sp-checkbox> `;
};

export const emphasizedInvalid = (): TemplateResult => {
  return html` <sp-checkbox emphasized invalid>Checkbox</sp-checkbox> `;
};
...
export const emphasizedInvalidChecked = (): TemplateResult => {
  return html` <sp-checkbox emphasized invalid checked>Checkbox</sp-checkbox> `;
};

export const Invalid = (): TemplateResult => {
  return html` <sp-checkbox invalid>Checkbox</sp-checkbox> `;
};

export const invalidIndeterminate = (): TemplateResult => {
  return html` <sp-checkbox invalid indeterminate>Checkbox</sp-checkbox> `;
};

export const invalidChecked = (): TemplateResult => {
  return html` <sp-checkbox invalid checked>Checkbox</sp-checkbox> `;
};

export const Autofocus = (): TemplateResult => {
  return html` <sp-checkbox autofocus>Checkbox</sp-checkbox> `;
};

export const Disabled = (): TemplateResult => {
  return html` <sp-checkbox disabled>Checkbox</sp-checkbox> `;
};

export const disabledChecked = (): TemplateResult => {
  return html` <sp-checkbox disabled checked>Checkbox</sp-checkbox> `;
};

export const disabledIndeterminate = (): TemplateResult => {
  return html` <sp-checkbox disabled indeterminate>Checkbox</sp-checkbox> `;
};

export const emphasizedDisabled = (): TemplateResult => {
  return html` <sp-checkbox emphasized disabled>Checkbox</sp-checkbox> `;
};
