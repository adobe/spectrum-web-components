...
export const readonly = (): TemplateResult => {
  return html` <sp-switch checked readonly>Switch</sp-switch> `;
};

export const emphasized = (): TemplateResult => {
  return html` <sp-switch emphasized>Switch</sp-switch> `;
};

export const emphasizedChecked = (): TemplateResult => {
  return html` <sp-switch emphasized checked>Switch</sp-switch> `;
};

export const Autofocus = (): TemplateResult => {
  return html` <sp-switch autofocus>Switch</sp-switch> `;
};

export const Disabled = (): TemplateResult => {
  return html` <sp-switch disabled>Switch</sp-switch> `;
};

export const disabledChecked = (): TemplateResult => {
  return html` <sp-switch disabled checked>Switch</sp-switch> `;
};
