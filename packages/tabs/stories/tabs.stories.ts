        ...
        return html`
            <style>
                ...
                sp-tab-panel {
                    grid-area: 2/1/2/1;
                    transition:
                        opacity var(--spectrum-animation-duration-300)
                            ease-in-out,
                        transform var(--spectrum-animation-duration-300)
                            ease-in-out;
                }
...
export const verticalEmphasizedQuiet = {
    render: (args: Properties): TemplateResult => {
        return html`
            <sp-tabs
                selected="1"
...
export const verticalQuietCompact = {
    render: (args: Properties): TemplateResult => {
        return html`
            <sp-tabs
                selected="1"
...
export const Icons = {
    render: ({ direction, verticalTab, auto }: Properties): TemplateResult => {
        return html`
...
export const Quiet = {
    render: ({ direction, auto }: Properties): TemplateResult => {
        return html`
            <style>
                sp-tabs {
                    display: grid;
