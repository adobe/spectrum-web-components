                ...
                <sp-action-menu label="More Actions" id="action-menu">
                    ...
                    <sp-menu-item id="fourth-menu-item">
                        ...
                        <sp-menu slot="submenu" selects="multiple">
                            <sp-menu-item id="first-sub-menu-item">
                                A
                            </sp-menu-item>
                            <sp-menu-item selected id="second-sub-menu-item">
                                B
                            </sp-menu-item>
                            <sp-menu-item id="third-sub-menu-item">
                                C
                            </sp-menu-item>
                        </sp-menu>
                    </sp-menu-item>
...
export const selectsMultipleControlled = {
    render: (args: Properties): TemplateResult => {
        requestAnimationFrame(displaySelectionState);
        return html`
            <sp-action-group
            ...
            >
                <sp-action-button value="lavacakes">
                    Lava Cakes
                </sp-action-button>
                <sp-action-button value="donuts">Donuts</sp-action-button>
                <sp-action-button value="crepecakes">
                    Crepe Cake
                </sp-action-button>
                <sp-action-button value="fruittarts">
                    Fruit Tarts
                </sp-action-button>
            </sp-action-group>
            <div>Selected:</div>
...
export const iconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
};

export const quietIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const compactQuietIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const verticalIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const verticalQuietIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const compactVerticalIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const justifiedIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
...
export const compactJustifiedIconsOnly = {
    render: (args: Properties): TemplateResult => renderIconButtons(args),
