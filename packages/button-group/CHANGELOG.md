...
## [0.6.12](https://github.com/adobe/spectrum-web-components/compare/@spectrum-web-components/button-group@0.6.10...@spectrum-web-components/button-group@0.6.12) (2021-10-14)

**Note:** Version bump only for package @spectrum-web-components/button-group

## [0.6.11](https://github.com/adobe/spectrum-web-components/compare/@spectrum-web-components/button-group@0.6.10...@spectrum-web-components/button-group@0.6.11) (2021-10-14)
