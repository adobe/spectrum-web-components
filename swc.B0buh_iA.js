import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.fxAipLbG.js";import"./swc.Cs3lJB1q.js";import"./swc.viideGBW.js";import"./swc.D-3SEJzl.js";import{i as s}from"./swc.CZZTz5mk.js";import{S as i,x as n,B as a}from"./swc.DRY409cl.js";import{o as r}from"./swc.x89XYkyy.js";import{n as l}from"./swc.DGMRmT0Y.js";const p=s`
...
`;var c=Object.defineProperty,h=(t,e,o,s)=>{for(var i,n=void 0,a=t.length-1;a>=0;a--)(i=t[a])&&(n=i(e,o,n)||n);return n&&c(e,o,n),n};const d="Help",m="Information",u=class s extends i{constructor(){super(),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1;const t=s.instanceCount++;this.popoverId=`contextual-help-popover-${t}`,this.contentId=`contextual-help-content-${t}`}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?d:m}renderOverlayContent(){return this.isMobile.matches?(import("./swc.DIG_4JC_.js").then(function(t){return t.s}),import("./swc.Bm1mLgEe.js").then(function(t){return t.s}),n`
      ...
      `):(import("./swc.ESeGI9Zl.js").then(function(t){return t.s}),n`
        <sp-popover
          class="popover"
          id=${this.popoverId}
          role="region"
