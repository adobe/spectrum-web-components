import"./7b3008bb.js";import{i as t}from"./67a87733.js";import{l as e,i as o,S as r}from"./0c1af6fc.js";import{I as c,x as n,e as s,A as l,S as a,d as p}from"./cd228091.js";class i{constructor(){this.iconsetMap=new Map}static getInstance(){return i.instance||(i.instance=new i),i.instance}addIconset(t,e){this.iconsetMap.set(t,e);const o=new CustomEvent("sp-iconset-added",{bubbles:!0,composed:!0,detail:{name:t,iconset:e}});setTimeout((()=>window.dispatchEvent(o)),0)}removeIconset(t){this.iconsetMap.delete(t);const e=new CustomEvent("sp-iconset-removed",{bubbles:!0,composed:!0,detail:{name:t}});setTimeout((()=>window.dispatchEvent(e)),0)}getIconset(t){return this.iconsetMap.get(t)}}var h=Object.defineProperty,u=Object.getOwnPropertyDescriptor,m=(t,e,o,r)=>{for(var c,n=r>1?void 0:r?u(e,o):e,s=t.length-1;s>=0;s--)(c=t[s])&&(n=(r?c(e,o,n):c(n))||n);return r&&n&&h(e,o,n),n};class d extends c{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}announceIconImageSrcError(){this.dispatchEvent(new Event("error",{cancelable:!1,bubbles:!1,composed:!1}))}render(){return this.name?n`
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,g=(t,e,o,r)=>{for(var c,n=r>1?void 0:r?f(e,o):e,s=t.length-1;s>=0;s--)(c=t[s])&&(n=(r?c(e,o,n):c(n))||n);return r&&n&&v(e,o,n),n};class w extends(r(a)){constructor(){super(...arguments),this.icon=!1,this.variant="neutral"}static get styles(){return[x]}render(){return n`
            ${"negative"===this.variant&&this.icon?n`
                      <sp-icon-alert class="icon"></sp-icon-alert>
                  `:l}
            <div class="text"><slot></slot></div>
        `}}g([s({type:Boolean,reflect:!0})],w.prototype,"icon",2),g([s({reflect:!0})],w.prototype,"variant",2),p("sp-help-text",w),p("sp-icon",d);export{i as I};
//# sourceMappingURL=4e40646b.js.map
