import{i as e}from"./d230bd74.js";import{x as t,S as r,y as o,l as s,e as c,Z as i}from"./05d6b8f8.js";import{a,i as l,S as n,$ as h,l as d,t as u}from"./cda676e5.js";import"./05c69ada.js";import"./65a68590.js";import{e as p,i as m,t as b}from"./89c02dc9.js";import{m as v,u as g,r as f,p as x,s as k,e as _}from"./e2915a8f.js";const z=(e,t,r)=>{const o=new Map;for(let s=t;s<=r;s++)o.set(e[s],s);return o},w=p(class extends m{constructor(e){if(super(e),e.type!==b.CHILD)throw Error("repeat() can only be used in text expressions")}ht(e,t,r){let o;void 0===r?r=t:void 0!==t&&(o=t);const s=[],c=[];let i=0;for(const t of e)s[i]=o?o(t,i):i,c[i]=r(t,i),i++;return{values:c,keys:s}}render(e,t,r){return this.ht(e,t,r).values}update(e,[r,o,s]){var c;const i=v(e),{values:a,keys:l}=this.ht(r,o,s);if(!Array.isArray(i))return this.ut=l,a;const n=null!==(c=this.ut)&&void 0!==c?c:this.ut=[],h=[];let d,u,p=0,m=i.length-1,b=0,_=a.length-1;for(;p<=m&&b<=_;)if(null===i[p])p++;else if(null===i[m])m--;else if(n[p]===l[b])h[b]=g(i[p],a[b]),p++,b++;else if(n[m]===l[_])h[_]=g(i[m],a[_]),m--,_--;else if(n[p]===l[_])h[_]=g(i[p],a[_]),f(e,h[_+1],i[p]),p++,_--;else if(n[m]===l[b])h[b]=g(i[m],a[b]),f(e,i[p],i[m]),m--,b++;else if(void 0===d&&(d=z(l,b,_),u=z(n,p,m)),d.has(n[p]))if(d.has(n[m])){const t=u.get(l[b]),r=void 0!==t?i[t]:null;if(null===r){const t=f(e,i[p]);g(t,a[b]),h[b]=t}else h[b]=g(r,a[b]),f(e,i[p],r),i[t]=null;b++}else x(i[m]),m--;else x(i[p]),p++;for(;b<=_;){const t=f(e,h[_+1]);g(t,a[b]),h[b++]=t}for(;p<=m;){const e=i[p++];null!==e&&x(e)}return this.ut=l,k(e,h),t}}),y=(e,t)=>{var r,o;const s=e._$AN;if(void 0===s)return!1;for(const e of s)null===(o=(r=e)._$AO)||void 0===o||o.call(r,t,!1),y(e,t);return!0},C=e=>{let t,r;do{if(void 0===(t=e._$AM))break;r=t._$AN,r.delete(e),e=t}while(0===(null==r?void 0:r.size))},I=e=>{for(let t;t=e._$AM;e=t){let r=t._$AN;if(void 0===r)t._$AN=r=new Set;else if(r.has(e))break;r.add(e),A(t)}};function E(e){void 0!==this._$AN?(C(this),this._$AM=e,I(this)):this._$AM=e}function S(e,t=!1,r=0){const o=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(t)if(Array.isArray(o))for(let e=r;e<o.length;e++)y(o[e],!1),C(o[e]);else null!=o&&(y(o,!1),C(o));else y(this,e)}const A=e=>{var t,r,o,s;e.type==b.CHILD&&(null!==(t=(o=e)._$AP)&&void 0!==t||(o._$AP=S),null!==(r=(s=e)._$AQ)&&void 0!==r||(s._$AQ=E))};class L extends m{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,r){super._$AT(e,t,r),I(this),this.isConnected=e._$AU}_$AO(e,t=!0){var r,o;e!==this.isConnected&&(this.isConnected=e,e?null===(r=this.reconnected)||void 0===r||r.call(this):null===(o=this.disconnected)||void 0===o||o.call(this)),t&&(y(this,e),C(this))}setValue(e){if(_(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}var U=e`
...
`,O=Object.defineProperty,T=Object.getOwnPropertyDescriptor,D=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?T(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&O(t,r,c),c};class $ extends r{constructor(){super(...arguments),this.role="row",this.selectable=!1,this.selected=!1,this.value=""}static get styles(){return[U]}async handleChange(e){e.target.checkbox&&(this.selected=e.target.checkbox.checked,await 0,e.defaultPrevented&&(this.selected=!this.selected))}handleSlotchange({target:e}){const t=e.assignedElements();this.selectable=!!t.find((e=>"sp-table-checkbox-cell"===e.localName))}async manageSelected(){await this.updateComplete;const[e]=this.checkboxCells;e&&(e.checked=this.selected)}handleClick(e){if(e.composedPath().find((e=>"sp-table-checkbox-cell"===e.localName)))return;const[t]=this.checkboxCells;t&&t.click()}render(){return o`
            <slot
                @change=${this.handleChange}
                @slotchange=${this.handleSlotchange}
            ></slot>
        `}willUpdate(e){e.has("selected")&&this.manageSelected(),e.has("selectable")&&(this.selectable?this.addEventListener("click",this.handleClick):this.removeEventListener("click",this.handleClick))}}D([s({selector:"sp-table-checkbox-cell",flatten:!0})],$.prototype,"checkboxCells",2),D([c({reflect:!0})],$.prototype,"role",2),D([c({type:Boolean})],$.prototype,"selectable",2),D([c({type:Boolean,reflect:!0})],$.prototype,"selected",2),D([c({type:String})],$.prototype,"value",2),customElements.define("sp-table-row",$);var R=Object.defineProperty,j=Object.getOwnPropertyDescriptor,V=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?j(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&R(t,r,c),c};class H extends a{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const e=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(e)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return o`
            <input
                id="input"
                ...
                @change=${this.handleChange}
            />
        `}}V([c({type:Boolean,reflect:!0})],H.prototype,"checked",2),V([c({type:Boolean,reflect:!0})],H.prototype,"readonly",2),V([l("#input")],H.prototype,"inputElement",2);var M=e`
...
`,P=Object.defineProperty,N=Object.getOwnPropertyDescriptor,q=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?N(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&P(t,r,c),c};const F={s:o`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:o`
        ...
        ></sp-icon-dash300>
    `};class K extends(n(H)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[M,h,B]}render(){return o`
            ${super.render()}
            <span id="box">
                ${F[this.size]}
                ${W[this.size]}
        ...
        `}updated(e){super.updated(e),e.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),e.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}q([c({type:Boolean,reflect:!0})],K.prototype,"indeterminate",2),q([c({type:Boolean,reflect:!0})],K.prototype,"invalid",2),q([c({type:Boolean,reflect:!0})],K.prototype,"emphasized",2),customElements.define("sp-checkbox",K);var G=e`
...
`,X=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,Z=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?Y(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&X(t,r,c),c};class ee extends r{constructor(){super(...arguments),this.role="gridcell",this.indeterminate=!1,this.checked=!1,this.disabled=!1,this.selectsSingle=!1}static get styles(){return[G,Q,J]}click(){this.checkbox.click()}render(){return o`
            <sp-checkbox
                ?checked=${this.checked}
                ...
                class="checkbox"
            ></sp-checkbox>
        `}}Z([c({reflect:!0})],ee.prototype,"role",2),Z([l(".checkbox")],ee.prototype,"checkbox",2),Z([c({type:Boolean})],ee.prototype,"indeterminate",2),Z([c({type:Boolean})],ee.prototype,"checked",2),Z([c({type:Boolean})],ee.prototype,"disabled",2),Z([c({type:Boolean,reflect:!0,attribute:"selects-single"})],ee.prototype,"selectsSingle",2),customElements.define("sp-table-checkbox-cell",ee);var te=e`
...
`,re=Object.defineProperty,oe=Object.getOwnPropertyDescriptor;class se extends r{constructor(){super(),this.role="rowgroup",new u(this,{config:{childList:!0,subtree:!0},callback:()=>{requestAnimationFrame((()=>{this.shouldHaveTabIndex()}))}})}static get styles(){return[te]}shouldHaveTabIndex(){this.offsetHeight<this.scrollHeight?this.tabIndex=0:this.removeAttribute("tabindex")}render(){return o`
            <slot></slot>
        `}}((e,t,r,o)=>{for(var s,c=o>1?void 0:o?oe(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);o&&c&&re(t,r,c)})([c({reflect:!0})],se.prototype,"role",2),customElements.define("sp-table-body",se);var ce=e`
...
`,He=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,Be=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?Me(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&He(t,r,c),c};class Pe extends r{constructor(){super(...arguments),this.role="columnheader",this.sortable=!1,this.sortKey=""}static get styles(){return[Q,Ve]}handleClick(){this.sortable&&(this.sortDirection?this.sortDirection="asc"===this.sortDirection?"desc":"asc":this.sortDirection="asc",this.dispatchEvent(new CustomEvent("sorted",{bubbles:!0,detail:{sortDirection:this.sortDirection,sortKey:this.sortKey}})))}render(){const e=this.sortable&&!!this.sortDirection;return o`
            <slot></slot>
            ${e?o`
                      <sp-icon-arrow100
                      ...
                      ></sp-icon-arrow100>
                  `:o``}
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}update(e){e.has("sortDirection")&&this.setAttribute("aria-sort",(e=>({asc:"ascending",desc:"descending"}[e]||"none"))(this.sortDirection)),e.has("sortable")&&(this.tabIndex=this.sortable?0:-1),super.update(e)}}Be([c({reflect:!0})],Pe.prototype,"role",2),Be([c({type:Boolean,reflect:!0})],Pe.prototype,"sortable",2),Be([c({reflect:!0,attribute:"sort-direction"})],Pe.prototype,"sortDirection",2),Be([c({attribute:"sort-key"})],Pe.prototype,"sortKey",2),customElements.define("sp-table-head-cell",Pe);export{H as C,w as a,ke as b,L as c,_e as d,ze as e,me as f,B as v};
//# sourceMappingURL=78d35d05.js.map
