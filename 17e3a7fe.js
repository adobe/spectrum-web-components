import{i as r}from"./d230bd74.js";import{M as e,I as o,o as t,b as i}from"./42d93c80.js";import{i as c,S as a,a as s}from"./b2e4ef96.js";import{r as n}from"./de819e8a.js";import"./4cdade93.js";import"./ef0b9850.js";import"./1075f713.js";import"./12cbb3ff.js";import{f as l}from"./bd23b6e3.js";import{S as p,y as u,e as d,Z as m,b as h}from"./d036ac45.js";import{o as v}from"./49f5bb7b.js";var k=r`
...
`,g=Object.defineProperty,y=Object.getOwnPropertyDescriptor,x=(r,e,o,t)=>{for(var i,c=t>1?void 0:t?y(e,o):e,a=r.length-1;a>=0;a--)(i=r[a])&&(c=(t?i(e,o,c):i(c))||c);return t&&c&&g(e,o,c),c};class w extends p{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new e(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[b,f]}focus(){const r=l(this);r?r.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(r){r.has("open")&&void 0!==r.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise((r=>{this.resolveTransitionPromise=()=>{this.animating=!1,r()}}))),super.update(r)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const r=await super.getUpdateComplete();return await this.transitionPromise,r}}x([d({type:Boolean,reflect:!0})],w.prototype,"open",2),x([c(".tray")],w.prototype,"tray",2),customElements.define("sp-tray",w);var z=Object.defineProperty,q=Object.getOwnPropertyDescriptor,I=(r,e,o,t)=>{for(var i,c=t>1?void 0:t?q(e,o):e,a=r.length-1;a>=0;a--)(i=r[a])&&(c=(t?i(e,o,c):i(c))||c);return t&&c&&z(e,o,c),c};const C={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class P extends(a(s)){constructor(){super(),this.isMobile=new e(this,o),this.disabled=!1,this.focused=!1,this.invalid=!1,this.open=!1,this.readonly=!1,this.selects="single",this.menuItems=[],this.placement="bottom-start",this.quiet=!1,this.value="",this.listRole="listbox",this.itemRole="option",this.onKeydown=r=>{this.focused=!0,("ArrowDown"===r.code||"ArrowUp"===r.code)&&(r.preventDefault(),this.toggle(!0))},this.overlayOpenCallback=async()=>{this.updateMenuItems(),await this.itemsUpdated,await this.optionsMenu.updateComplete,requestAnimationFrame((()=>this.menuStateResolver()))},this.overlayCloseCallback=async()=>{this.restoreChildren&&(this.restoreChildren(),this.restoreChildren=void 0),this.close(),requestAnimationFrame((()=>this.menuStateResolver()))},this._willUpdateItems=!1,this.itemsUpdated=Promise.resolve(),this.menuStatePromise=Promise.resolve(),this.selectionPromise=Promise.resolve(),this.onKeydown=this.onKeydown.bind(this)}get target(){return this.button}get focusElement(){return this.open?this.optionsMenu:this.button}forceFocusVisible(){this.focused=!0}onButtonBlur(){this.focused=!1,this.target.removeEventListener("keydown",this.onKeydown)}onButtonClick(){this.toggle()}focus(r){super.focus(r),!this.disabled&&this.focusElement&&(this.focused=this.hasVisibleFocusInTree())}onHelperFocus(){this.focused=!0,this.button.focus()}onButtonFocus(){this.target.addEventListener("keydown",this.onKeydown)}handleChange(r){const e=r.target,[o]=e.selectedItems;r.cancelable?(r.stopPropagation(),this.setValueFromItem(o,r)):this.open=!1}async setValueFromItem(r,e){const o=this.selectedItem,t=this.value;if(this.selectedItem=r,this.value=r.value,this.open=!1,await this.updateComplete,!this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0})))return e&&e.preventDefault(),this.setMenuItemSelected(this.selectedItem,!1),o&&this.setMenuItemSelected(o,!0),this.selectedItem=o,this.value=t,void(this.open=!0);o&&this.setMenuItemSelected(o,!1),this.setMenuItemSelected(r,!!this.selects)}setMenuItemSelected(r,e){null!=this.selects&&(r.selected=e)}toggle(r){this.readonly||(this.open=void 0!==r?r:!this.open)}close(){this.readonly||(this.open=!1)}async generatePopover(){this.popoverFragment||(this.popoverFragment=document.createDocumentFragment()),m(this.renderPopover,this.popoverFragment,{host:this}),this.popoverEl=this.popoverFragment.children[0],this.optionsMenu=this.popoverEl.children[1]}async openMenu(){let r=[];const e=this.querySelector(":scope > sp-menu");await this.generatePopover(),r=e?Array.from(e.children):Array.from(this.children).filter((r=>!r.hasAttribute("slot"))),0!==r.length?(this.restoreChildren=n(r,this.optionsMenu,{position:"beforeend",prepareCallback:r=>(this.value===r.value&&this.setMenuItemSelected(r,!0),r=>{void 0!==r.focused&&(r.focused=!1)})}),this.sizePopover(this.popoverEl),this.closeOverlay=M.openOverlay(this,"modal",this.popoverEl,{placement:this.isMobile.matches?"none":this.placement,receivesFocus:"auto"})):this.menuStateResolver()}sizePopover(r){this.isMobile.matches&&r.style.setProperty("--swc-menu-width","100%")}async closeMenu(){if(this.closeOverlay){const r=this.closeOverlay;delete this.closeOverlay,(await r)()}}get selectedItemContent(){return this.selectedItem?this.selectedItem.itemChildren:{icon:[],content:[]}}renderLabelContent(r){return this.value&&this.selectedItem?r:u`
            <slot name="label">${this.label}</slot>
        `}get buttonContent(){const r={"visually-hidden":"only"===this.icons&&!!this.value,placeholder:!this.value};return[u`
                <span id="icon" ?hidden=${"none"===this.icons}>
                    ${this.selectedItemContent.icon}
                </span>
                <span id="label" class=${v(r)}>
        ...
        `}update(r){this.selects&&(this.selects="single"),r.has("disabled")&&this.disabled&&(this.open=!1),r.has("open")&&(this.open||void 0!==r.get("open"))&&(this.menuStatePromise=new Promise((r=>this.menuStateResolver=r)),this.open?this.openMenu():this.closeMenu()),r.has("value")&&!r.has("selectedItem")&&this.updateMenuItems(),super.update(r)}get dismissHelper(){return u`
        ...
        `}updateMenuItems(r){if(this.open&&"sp-menu-item-removed"===(null==r?void 0:r.type)||this._willUpdateItems)return;this._willUpdateItems=!0,(null==r?void 0:r.item)===this.selectedItem&&this.requestUpdate();let e=()=>{};this.itemsUpdated=new Promise((r=>e=r)),window.requestAnimationFrame((async()=>{this.open?(await this.optionsMenu.updateComplete,this.menuItems=this.optionsMenu.childItems):this.menuItems=[...this.querySelectorAll('sp-menu-item:not([slot="submenu"] *)')],this.manageSelection(),e(),this._willUpdateItems=!1}))}async manageSelection(){if(null==this.selects)return;let r;await this.menuStatePromise,this.selectionPromise=new Promise((r=>this.selectionResolver=r)),this.menuItems.forEach((e=>{this.value!==e.value||e.disabled?e.selected=!1:r=e})),r?(r.selected=!!this.selects,this.selectedItem=r):(this.value="",this.selectedItem=void 0),this.open&&(await this.optionsMenu.updateComplete,this.optionsMenu.updateSelectedItemIndex()),this.selectionResolver()}async getUpdateComplete(){const r=await super.getUpdateComplete();return await this.menuStatePromise,await this.itemsUpdated,await this.selectionPromise,r}connectedCallback(){this.updateMenuItems(),this.addEventListener("sp-menu-item-added-or-updated",this.updateMenuItems),this.addEventListener("sp-menu-item-removed",this.updateMenuItems),super.connectedCallback()}disconnectedCallback(){this.close(),super.disconnectedCallback()}}P.openOverlay=async(r,e,o,i)=>await t(r,e,o,i),I([c("#button")],P.prototype,"button",2),I([d({type:Boolean,reflect:!0})],P.prototype,"disabled",2),I([d({type:Boolean,reflect:!0})],P.prototype,"focused",2),I([d({type:String,reflect:!0})],P.prototype,"icons",2),I([d({type:Boolean,reflect:!0})],P.prototype,"invalid",2),I([d()],P.prototype,"label",2),I([d({type:Boolean,reflect:!0})],P.prototype,"open",2),I([d({type:Boolean,reflect:!0})],P.prototype,"readonly",2),I([d()],P.prototype,"placement",2),I([d({type:Boolean,reflect:!0})],P.prototype,"quiet",2),I([d({type:String})],P.prototype,"value",2),I([d({attribute:!1})],P.prototype,"selectedItem",2);class M extends P{constructor(){super(...arguments),this.onKeydown=r=>{const{code:e}=r;if(this.focused=!0,!e.startsWith("Arrow")||this.readonly)return;if(r.preventDefault(),"ArrowUp"===e||"ArrowDown"===e)return void this.toggle(!0);const o=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,t=this.value&&"ArrowRight"!==e?-1:1;let i=o+t;for(;this.menuItems[i]&&this.menuItems[i].disabled;)i+=t;!this.menuItems[i]||this.menuItems[i].disabled||(!this.value||i!==o)&&this.setValueFromItem(this.menuItems[i])}}static get styles(){return[k,i]}sizePopover(r){super.sizePopover(r),!this.quiet&&r.style.setProperty("min-width",`${this.offsetWidth}px`)}}customElements.define("sp-picker",M);export{P,b as h};
//# sourceMappingURL=17e3a7fe.js.map
