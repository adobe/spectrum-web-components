...
)}:host,:root{font-family:var(--spectrum-alias-body-text-font-family);font-size:var(--spectrum-alias-font-size-default)}:host:lang(ar),:root:lang(ar){font-family:var(--spectrum-alias-font-family-ar)}:host:lang(he),:root:lang(he){font-family:var(--spectrum-alias-font-family-he)}:host:lang(zh-Hans),:root:lang(zh-Hans){font-family:var(--spectrum-alias-font-family-zhhans)}:host:lang(zh-Hant),:root:lang(zh-Hant){font-family:var(--spectrum-alias-font-family-zh)}:host:lang(zh),:root:lang(zh){font-family:var(--spectrum-alias-font-family-zh)}:host:lang(ko),:root:lang(ko){font-family:var(--spectrum-alias-font-family-ko)}:host:lang(ja),:root:lang(ja){font-family:var(--spectrum-alias-font-family-ja)}:host{display:block}#scale,#theme{height:100%;width:100%}`;const l=["medium","large"],c=["light","lightest","dark","darkest"];class i extends HTMLElement{constructor(){super(),this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const e=document.importNode(i.template.content,!0);this.shadowRoot.appendChild(e),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","lang"]}attributeChangedCallback(e,a,o){a!==o&&("color"===e?this.color=o:"scale"===e?this.scale=o:"lang"===e&&o&&(this.lang=o,this._provideContext()))}requestUpdate(){void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?this.shouldAdoptStyles():window.ShadyCSS.styleElement(this)}get color(){const e=i.themeFragmentsByKind.get("color"),{name:a}=e&&e.get("default")||{};return this._color||a||""}set color(e){if(e===this._color)return;const a=e&&c.includes(e)?e:this.color;a!==this._color&&(this._color=a,this.requestUpdate()),a?this.setAttribute("color",a):this.removeAttribute("color")}get scale(){const e=i.themeFragmentsByKind.get("scale"),{name:a}=e&&e.get("default")||{};return this._scale||a||""}set scale(e){if(e===this._scale)return;const a=e&&l.includes(e)?e:this.scale;a!==this._scale&&(this._scale=a,this.requestUpdate()),a?this.setAttribute("scale",a):this.removeAttribute("scale")}get styles(){return[...[...i.themeFragmentsByKind.keys()].reduce(((e,a)=>{const o=i.themeFragmentsByKind.get(a),t=(a,t)=>{const r=o.get(a);!r||t&&!this.hasAttribute(t)||e.push(r.styles)};if("app"===a||"core"===a)t(a);else{const{[a]:e}=this;t(e,a)}return e}),[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise((e=>{this.__resolve=e}))}onQueryTheme(e){if(e.defaultPrevented)return;e.preventDefault();const{detail:a}=e;a.color=this.color||void 0,a.scale=this.scale||void 0,a.lang=this.lang||document.documentElement.lang||navigator.language}connectedCallback(){this.shouldAdoptStyles(),void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this),i.instances.add(this);const e=()=>{const{dir:e}=this;this.trackedChildren.forEach((a=>{a.setAttribute("dir","rtl"===e?e:"ltr")}))};if(this.observer||(this.observer=new MutationObserver(e)),this.observer.observe(this,{attributes:!0,attributeFilter:["dir"]}),!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!(e instanceof i);)e=e.assignedSlot||e.parentNode||e.host;this.dir="rtl"===e.dir?e.dir:"ltr"}requestAnimationFrame((()=>e()))}disconnectedCallback(){i.instances.delete(this),this.observer.disconnect()}startManagingContentDirection(e){this.trackedChildren.add(e)}stopManagingContentDirection(e){this.trackedChildren.delete(e)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const a=this.styles;if(void 0!==window.ShadyCSS&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const e=[];for(const[a,o]of i.themeFragmentsByKind)for(const[t,{styles:r}]of o){if("default"===t)continue;let o=r.cssText;i.defaultFragments.has(t)||(o=o.replace(":host",`:host([${a}='${t}'])`)),e.push(o)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e,this.localName),window.ShadyCSS.prepareTemplate(i.template,this.localName)}else if(e){const e=[];for(const o of a)e.push(o.styleSheet);this.shadowRoot.adoptedStyleSheets=e}else{this.shadowRoot.querySelectorAll("style").forEach((e=>e.remove())),a.forEach((e=>{const a=document.createElement("style");a.textContent=e.cssText,this.shadowRoot.appendChild(a)}))}}static registerThemeFragment(e,a,o){const t=i.themeFragmentsByKind.get(a)||new Map;0===t.size&&(i.themeFragmentsByKind.set(a,t),t.set("default",{name:e,styles:o}),i.defaultFragments.add(e)),t.set(e,{name:e,styles:o}),i.instances.forEach((e=>e.shouldAdoptStyles()))}_provideContext(){this._contextConsumers.forEach((e=>e(this.lang)))}_handleContextPresence(e){const a=e.composedPath()[0];if(this._contextConsumers.has(a))this._contextConsumers.delete(a);else{this._contextConsumers.set(a,e.detail.callback);const o=this._contextConsumers.get(a);o&&o(this.lang||document.documentElement.lang||navigator.language)}}}i.themeFragmentsByKind=new Map,i.defaultFragments=new Set(["core"]),i.instances=new Set,i.registerThemeFragment("core","core",s);export{i as T,r as c,e as s,t as u};
//# sourceMappingURL=590b58a0.js.map
