import{i as t}from"./112b2095.js";import{n as e,S as o,x as s,d as i,A as r}from"./f800a65a.js";import{F as a,O as c,l,i as n,a as d,L as m}from"./a253d781.js";import{O as h}from"./c272a099.js";import{R as b}from"./aabe1d5e.js";import{o as u}from"./32ac7d45.js";import{S as p}from"./7c269327.js";import"./2a07ae07.js";import"./9d46765f.js";import"./2d3f7811.js";import"./88df766d.js";import"./0c2722e8.js";import"./c8f23411.js";import"./16ab2288.js";import"./4a4b0658.js";import"./49c97b80.js";import"./d6d0b127.js";import"./91e12b9c.js";import"./7c327fb6.js";import"./e62cd3d3.js";var v=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,g=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?f(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&g(e,o,r),r};const x=class t extends o{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return s`
            <slot
...
`,$=Object.defineProperty,T=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?T(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&$(e,o,r),r};const L={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`,R=Object.defineProperty,_=Object.getOwnPropertyDescriptor,X=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?_(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&R(e,o,r),r};class M extends(m(d)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[k,H]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${l(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}X([n("a")],M.prototype,"anchor",2),X([e({type:Boolean,reflect:!0})],M.prototype,"selected",2),i("sp-top-nav-item",M),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:o}=e,{pathname:s}=location,i=s.search("api")>-1;switch(o){case"api":{if(i)return;const t=(s+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!i)return;const t=s.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./fd9d7aed.js"),import("./b31f4007.js")})):requestAnimationFrame((()=>{import("./fd9d7aed.js"),import("./b31f4007.js")}));var Y=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",Y),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{j as g,A as s};
//# sourceMappingURL=b7baa9c9.js.map
