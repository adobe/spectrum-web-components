import{i as t}from"./67a87733.js";import{e,S as o,x as s,d as i}from"./395924ad.js";import{F as r,O as a,l as c,i as l,a as n,L as d}from"./2b513fe4.js";import{O as m}from"./1175a784.js";import{R as b}from"./0e68698d.js";import{o as h}from"./19c8b84e.js";import{S as u}from"./549963e9.js";import"./ddac9c34.js";import"./c28c6d6c.js";import"./9676adf6.js";import"./27047015.js";import"./5223f72b.js";import"./c879772d.js";import{Overlay as p}from"./f3a1d0a5.js";import"./16ab2288.js";import"./4a4b0658.js";import"./ef341916.js";import"./8b2965c7.js";import"./3a81fc81.js";import"./045d5864.js";var v=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,g=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?f(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&g(e,o,r),r};const x=class t extends o{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return s`
            <slot></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+t.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};x.styles=[v],x.instanceCount=0,y([e({type:Boolean,reflect:!0})],x.prototype,"selected",2),y([e({type:String,reflect:!0})],x.prototype,"value",2),i("sp-tab-panel",x);var k=t`
...
`,z=Object.defineProperty,w=Object.getOwnPropertyDescriptor,S=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?w(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&z(e,o,r),r};const C=class t extends(r(a(m(o,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[k]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`
            ${this.hasIcon?s`
                      <slot name="icon"></slot>
                  `:s``}
...
`,$=Object.defineProperty,T=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?T(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&$(e,o,r),r};const O={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`,H=Object.defineProperty,X=Object.getOwnPropertyDescriptor,F=(t,e,o,s)=>{for(var i,r=s>1?void 0:s?X(e,o):e,a=t.length-1;a>=0;a--)(i=t[a])&&(r=(s?i(e,o,r):i(r))||r);return s&&r&&H(e,o,r),r};class Y extends(d(n)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[k,D]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${c(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}F([l("a")],Y.prototype,"anchor",2),F([e({type:Boolean,reflect:!0})],Y.prototype,"selected",2),i("sp-top-nav-item",Y),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:o}=e,{pathname:s}=location,i=s.search("api")>-1;switch(o){case"api":{if(i)return;const t=(s+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!i)return;const t=s.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./e209d324.js"),import("./132a5381.js")})):requestAnimationFrame((()=>{import("./e209d324.js"),import("./132a5381.js")})),window.Overlay=p;var M=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",M),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{j as g,A as s};
//# sourceMappingURL=a5602452.js.map
