import{I as e,y as t}from"./99636b0a.js";let r;const l=function(e,...t){return r?r(e,...t):t.reduce(((t,r,l)=>t+r+e[l+1]),e[0])},i=e=>{r=e};customElements.define("sp-icon-checkmark100",class extends e{render(){return i(t),(({width:e=24,height:t=24,title:r="Checkmark100"}={})=>l`<svg
  ...
  >
    ...
    />
  </svg>`)()}});customElements.define("sp-icon-asterisk100",class extends e{render(){return i(t),(({width:e=24,height:t=24,title:r="Asterisk100"}={})=>l`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}});export{i as s,l as t};
//# sourceMappingURL=a3268a6a.js.map
