...
measureFixtureCreation(html`
    ...
    <sp-icon-accessibility></sp-icon-accessibility>
    <sp-icon-add-circle></sp-icon-add-circle>
    <sp-icon-add-content></sp-icon-add-content>
    <sp-icon-add></sp-icon-add>
    <sp-icon-alert-diamond></sp-icon-alert-diamond>
    <sp-icon-alert-triangle></sp-icon-alert-triangle>
    <sp-icon-align-bottom></sp-icon-align-bottom>
    <sp-icon-align-middle></sp-icon-align-middle>
    ...
    <sp-icon-animation-no></sp-icon-animation-no>
    <sp-icon-animation></sp-icon-animation>
    <sp-icon-app></sp-icon-app>
    <sp-icon-apps-all></sp-icon-apps-all>
    <sp-icon-apps></sp-icon-apps>
    <sp-icon-archive></sp-icon-archive>
    <sp-icon-arrow-head-tool></sp-icon-arrow-head-tool>
    <sp-icon-artboard></sp-icon-artboard>
    <sp-icon-aspect-ratio></sp-icon-aspect-ratio>
    <sp-icon-asset></sp-icon-asset>
    <sp-icon-attach></sp-icon-attach>
    <sp-icon-audio-wave></sp-icon-audio-wave>
    <sp-icon-auto-select-subject></sp-icon-auto-select-subject>
`);
