...
import coreStyles from '@spectrum-web-components/theme/src/theme.css' with { type: 'css' };
import darkStyles from '@spectrum-web-components/theme/src/theme-dark.css' with { type: 'css' };
import largeStyles from '@spectrum-web-components/theme/src/scale-large.css' with { type: 'css' };
