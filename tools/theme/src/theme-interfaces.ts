...
export type FragmentType = 'color' | 'scale' | 'core' | 'app';
export type SettableFragmentTypes = 'color' | 'scale';
...
export const SCALE_VALUES = ['medium', 'large'] as const;

export const COLOR_VALUES = ['light', 'dark'] as const;

export type Scale = (typeof SCALE_VALUES)[number];
export type Color = (typeof COLOR_VALUES)[number];

export type FragmentName = Color | Scale | 'core' | 'app';
