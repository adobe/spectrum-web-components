import"./swc.DnPOj-Ed.js";import"./swc.-IgBPcp2.js";import"./swc.DRg5zi_5.js";import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.x8WofHoL.js";import{i as s}from"./swc.DpYYvrpg.js";import{S as n,n as a}from"./swc.BvXu6tu0.js";import{x as i,j as l}from"./swc.DAPqj1CM.js";import{o as r}from"./swc.BljSg25L.js";const p=s`
...
`;var c=Object.defineProperty,h=(t,e,o,s)=>{for(var n,a=void 0,i=t.length-1;i>=0;i--)(n=t[i])&&(a=n(e,o,a)||a);return a&&c(e,o,a),a};class u extends n{constructor(){super(...arguments),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(import("./swc.rcNtHNGp.js").then((function(t){return t.s})),import("./swc.CXrO5j08.js").then((function(t){return t.s})),i`
            ...
            `):(import("./swc.BYOHP1LX.js").then((function(t){return t.s})),i`
            ...
            `)}handleSlottableRequest(e){if(e.stopPropagation(),e.data===t)return this.open=!1,void l(void 0,e.target);this.open=!0;const o=this.renderOverlayContent();l(o,e.target)}render(){const t=this.isMobile.matches?void 0:this.placement;return i`
            <sp-action-button
                quiet
                size="s"
                id="trigger"
            ...
            <sp-overlay
                ...
                ?open=${this.open}
            ></sp-overlay>
        `}}h([a()],u.prototype,"label"),h([a()],u.prototype,"variant"),h([a({reflect:!0})],u.prototype,"placement"),h([a({type:Number})],u.prototype,"offset"),h([a({type:Boolean})],u.prototype,"open"),customElements.define("sp-contextual-help",u);
//# sourceMappingURL=swc._-NkNu79.js.map
