import{i as t}from"./1ab7ceed.js";import{n as e,S as o,x as s,d as i,A as a}from"./637c92da.js";import{a as r,O as c,l,i as n,F as d,L as m}from"./0fd5475c.js";import{O as b}from"./b92db46c.js";import{s as h}from"./ff8e484a.js";import{R as u}from"./a37f886d.js";import{o as p}from"./ac53cfbc.js";import{S as v}from"./41af188d.js";import"./08ed1e9f.js";import"./9eece4f7.js";import"./ac63bf03.js";import"./d06ee9cd.js";import"./a974e940.js";import"./4dd6175d.js";import"./16ab2288.js";import"./4a4b0658.js";import"./97b32ec4.js";import"./d6d0b127.js";import"./3b101b71.js";import"./1bc378e4.js";import"./be246949.js";var g=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,f=Object.defineProperty,y=Object.getOwnPropertyDescriptor,x=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?y(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&f(e,o,a),a};const k=class t extends o{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return s`
            <slot
...
`,w=Object.defineProperty,S=Object.getOwnPropertyDescriptor,C=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?S(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&w(e,o,a),a};const A=class t extends(r(c(b(o,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[z]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`
            ${this.hasIcon?s`
                      <slot name="icon"></slot>
                  `:a}
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+t.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};A.instanceCount=0,C([e({type:Boolean,reflect:!0})],A.prototype,"disabled",2),C([e({reflect:!0})],A.prototype,"label",2),C([e({type:Boolean,reflect:!0})],A.prototype,"selected",2),C([e({type:Boolean,reflect:!0})],A.prototype,"vertical",2),C([e({type:String,reflect:!0})],A.prototype,"value",2),i("sp-tab",A);var I=t`
...
`,j=Object.defineProperty,$=Object.getOwnPropertyDescriptor,T=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?$(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&j(e,o,a),a};const L={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`,H=Object.defineProperty,R=Object.getOwnPropertyDescriptor,X=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?R(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&H(e,o,a),a};class _ extends(m(d)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[z,F]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${l(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}X([n("a")],_.prototype,"anchor",2),X([e({type:Boolean,reflect:!0})],_.prototype,"selected",2),i("sp-top-nav-item",_),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:o}=e,{pathname:s}=location,i=s.search("api")>-1;switch(o){case"api":{if(i)return;const t=(s+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!i)return;const t=s.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./3184b199.js"),import("./c3f633df.js")})):requestAnimationFrame((()=>{import("./3184b199.js"),import("./c3f633df.js")}));var M=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",M),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{E as g};
//# sourceMappingURL=cc333fe6.js.map
