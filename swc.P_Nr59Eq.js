import"./swc.C43pT3Ny.js";import"./swc.CQfAh0i5.js";import"./swc.BImjNMgU.js";import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.Dofmtdop.js";import{i as s}from"./swc.CRBjbaNr.js";import{C as i}from"./swc.CedePp-f.js";import{x as n,B as r}from"./swc.DWYvVEd1.js";import{o as a}from"./swc.Chxt1mTH.js";import{n as l}from"./swc.WWX4rCzN.js";const p=s`
...
`;var c=Object.defineProperty,m=(t,e,o,s)=>{for(var i,n=void 0,r=t.length-1;r>=0;r--)(i=t[r])&&(n=i(e,o,n)||n);return n&&c(e,o,n),n};const h="Help",u="Information";class d extends i{constructor(){super(...arguments),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?h:u}renderOverlayContent(){return this.isMobile.matches?(import("./swc.PJUwOihm.js").then(function(t){return t.s}),import("./swc.BbuHuKL9.js").then(function(t){return t.s}),n`
            ...
            `):(import("./swc.CNjPBuqD.js").then(function(t){return t.s}),n`
...
//# sourceMappingURL=swc.DBm4K5JC.js.map
