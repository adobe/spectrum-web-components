import{f as e,S as t}from"./75b21873.js";import{i as r}from"./112b2095.js";import"./54ff42c4.js";import{S as o}from"./cd538c17.js";import{T as i,A as c,x as a,n as s,d as l}from"./dd8018c7.js";import"./e580ab3f.js";import{c as n,t as d}from"./9cbfa52b.js";import{l as u,F as p,i as m}from"./41f420ad.js";import"./93b7e594.js";import"./a6c69bec.js";import{S as h}from"./9ddc847e.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./cd496c6f.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,j=Object.defineProperty,B=Object.getOwnPropertyDescriptor,S=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?B(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&j(t,r,c),c};const H=["text","url","tel","email","password"];class L extends(I(o(p,{noDefaultSize:!0}))){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.rows=-1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[C,h]}get type(){var e;return null!=(e=H.find((e=>e===this._type)))?e:"text"}set type(e){const t=this._type;this._type=e,this.requestUpdate("type",t)}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,t,r="none"){this.inputElement.setSelectionRange(e,t,r)}select(){this.inputElement.select()}handleInput(e){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const e=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(e,e)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?a`
        ...
        `}update(e){(e.has("value")||e.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(e)}checkValidity(){let e=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(e=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(e=e&&this.value.toString().length>=this.minlength),this.valid=e,this.invalid=!e),e}}S([d()],L.prototype,"appliedLabel",2),S([s({attribute:"allowed-keys"})],L.prototype,"allowedKeys",2),S([s({type:Boolean,reflect:!0})],L.prototype,"focused",2),S([m(".input:not(#sizer)")],L.prototype,"inputElement",2),S([s({type:Boolean,reflect:!0})],L.prototype,"invalid",2),S([s()],L.prototype,"label",2),S([s({type:String,reflect:!0})],L.prototype,"name",2),S([s()],L.prototype,"placeholder",2),S([s({attribute:"type",reflect:!0})],L.prototype,"_type",2),S([d()],L.prototype,"type",1),S([s()],L.prototype,"pattern",2),S([s({type:Boolean,reflect:!0})],L.prototype,"grows",2),S([s({type:Number})],L.prototype,"maxlength",2),S([s({type:Number})],L.prototype,"minlength",2),S([s({type:Boolean,reflect:!0})],L.prototype,"multiline",2),S([s({type:Boolean,reflect:!0})],L.prototype,"readonly",2),S([s({type:Number})],L.prototype,"rows",2),S([s({type:Boolean,reflect:!0})],L.prototype,"valid",2),S([s({type:String})],L.prototype,"value",1),S([s({type:Boolean,reflect:!0})],L.prototype,"quiet",2),S([s({type:Boolean,reflect:!0})],L.prototype,"required",2),S([s({type:String,reflect:!0})],L.prototype,"autocomplete",2);class O extends L{constructor(){super(...arguments),this._value=""}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}}S([s({type:String})],O.prototype,"value",1),l("sp-clear-button",T);var U=r`
...
//# sourceMappingURL=d6891308.js.map
