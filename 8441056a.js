import{t as e,s as i}from"./d30b4cb2.js";import{I as t,y as a}from"./95f60e39.js";customElements.define("sp-icon-info",class extends t{render(){return i(a),(({width:i=24,height:t=24,hidden:a=!1,title:l="Info"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});customElements.define("sp-icon-checkmark-circle",class extends t{render(){return i(a),(({width:i=24,height:t=24,hidden:a=!1,title:l="Checkmark Circle"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${i}
    height=${t}
    viewBox="0 0 36 36"
...
//# sourceMappingURL=8441056a.js.map
