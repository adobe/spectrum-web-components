import{T as t}from"./5ede2e50.js";import{T as o,y as e,_ as r,e as c,S as i,x as s}from"./62b05a9e.js";import{r as a}from"./e50c5e8d.js";import{e as n,a as l,t as u,L as d,b as m,c as p,i as b,S as h,d as v,B as g}from"./60899823.js";import"./4e3d38a5.js";import"./c24d2ae8.js";import"./b86f55ac.js";import"./4acefc0c.js";customElements.define("sp-theme",t);const x=n(class extends l{constructor(t){var o;if(super(t),t.type!==u.ATTRIBUTE||"class"!==t.name||(null===(o=t.strings)||void 0===o?void 0:o.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((o=>t[o])).join(" ")+" "}update(t,[e]){var r,c;if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.et=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(r=this.et)||void 0===r?void 0:r.has(t))&&this.st.add(t);return this.render(e)}const i=t.element.classList;this.st.forEach((t=>{t in e||(i.remove(t),this.st.delete(t))}));for(const t in e){const o=!!e[t];o===this.st.has(t)||(null===(c=this.et)||void 0===c?void 0:c.has(t))||(o?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return o}});var y=a`#button{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-appearance:button;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
)}`;const f=(t,o,e)=>{const r=[],c=[];for(let i=0;i<t.length;++i){const s=t[i];e&&c.push(e(s)||(()=>{}));const a=document.createComment("placeholder for reparented element");r.push(a);const n=s.parentElement||s.getRootNode();n&&n!==s&&n.replaceChild(a,s),o.append(s)}return function(){return function(t,o,e=[]){for(let r=0;r<o.length;++r){const c=o[r],i=t[r],s=i.parentElement||i.getRootNode();e[r]&&e[r](c),s&&s!==i&&s.replaceChild(c,i),delete t[r]}return o}(r,t,c)}};var w=a`.checkmark{align-self:flex-start;display:none;opacity:1;transform:scale(1)}:host([dir=ltr]) .checkmark{padding-left:var(
...
);cursor:default}#label{flex:1 1 auto;-webkit-hyphens:auto;hyphens:auto;line-height:var(--spectrum-listitem-texticon-label-line-height);overflow-wrap:break-word;width:calc(100% - var(--spectrum-listitem-texticon-ui-icon-width) - var(--spectrum-listitem-texticon-icon-gap))}.spectrum-Menu-itemLabel--wrapping{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}:host([hidden]){display:none}#button{bottom:0;left:0;position:absolute;right:0;top:0}::slotted([slot=value]){align-self:start}:host([dir=ltr]) ::slotted([slot=value]){margin-left:var(--spectrum-listitem-texticon-icon-gap)}:host([dir=rtl]) ::slotted([slot=value]){margin-right:var(--spectrum-listitem-texticon-icon-gap)}:host([dir=ltr]) [icon-only]::slotted(:last-of-type){margin-right:auto}:host([dir=rtl]) [icon-only]::slotted(:last-of-type){margin-left:auto}:host([dir=ltr]) ::slotted([slot=icon]){margin-right:var(--spectrum-listitem-texticon-icon-gap)}:host([dir=rtl]) ::slotted([slot=icon]){margin-left:var(--spectrum-listitem-texticon-icon-gap)}:host([dir=rtl]) slot[name=icon]+#label{margin-right:0}:host([dir=ltr]) slot[name=icon]+#label{margin-left:0}`;class z extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0}),this.focused=!1}get item(){return this._item}reset(t){this._item=t}}class q extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=t,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const B=new q,I=new z;class A extends(d(m)){constructor(){super(),this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.noWrap=!1,this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[w,p]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}get focusElement(){return this}get itemChildren(){if(this._itemChildren)return this._itemChildren;const t=this.shadowRoot.querySelector('slot[name="icon"]'),o=t?t.assignedElements().map((t=>{const o=t.cloneNode(!0);return o.removeAttribute("slot"),o.classList.toggle("icon"),o})):[],e=this.shadowRoot.querySelector("slot:not([name])"),r=e?e.assignedNodes().map((t=>t.cloneNode(!0))):[];return this._itemChildren={icon:o,content:r},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(t){if(this.disabled)return t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let t=!1;return this.anchorElement&&(this.anchorElement.click(),t=!0),t}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}render(){return e`<slot name="icon" @slotchange="${this.breakItemChildrenCache}"></slot><div id="label"><slot id="slot" @slotchange="${this.breakItemChildrenCache}"></slot></div><slot name="value"></slot>${this.selected?e`<sp-icon-checkmark100 id="selected" class="spectrum-UIIcon-Checkmark100 icon checkmark"></sp-icon-checkmark100>`:e``} ${this.href&&this.href.length>0?super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"}):e``}`}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}firstUpdated(t){super.firstUpdated(t),this.setAttribute("tabindex","-1"),this.addEventListener("pointerdown",this.handlePointerdown),this.hasAttribute("id")||(this.id="sp-menu-item-"+A.instanceCount++)}updateAriaSelected(){const t=this.getAttribute("role");"option"===t?this.setAttribute("aria-selected",this.selected?"true":"false"):"menuitemcheckbox"!==t&&"menuitemradio"!==t||this.setAttribute("aria-checked",this.selected?"true":"false")}setRole(t){this.setAttribute("role",t),this.updateAriaSelected()}updated(t){super.updated(t),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1),t.has("selected")&&this.updateAriaSelected()}connectedCallback(){super.connectedCallback(),B.reset(this),this.dispatchEvent(B),this._parentElement=this.parentElement}disconnectedCallback(){var t;I.reset(this),null===(t=this._parentElement)||void 0===t||t.dispatchEvent(I),super.disconnectedCallback()}async triggerUpdate(){await new Promise((t=>requestAnimationFrame(t))),B.reset(this),this.dispatchEvent(B)}}A.instanceCount=0,r([c({type:Boolean,reflect:!0})],A.prototype,"active",void 0),r([c({type:Boolean,reflect:!0})],A.prototype,"focused",void 0),r([c({type:Boolean,reflect:!0})],A.prototype,"selected",void 0),r([c({type:String})],A.prototype,"value",null),r([c({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],A.prototype,"noWrap",void 0),r([b(".anchor")],A.prototype,"anchorElement",void 0);var C=a`:host{--spectrum-menu-margin-x:var(
...
--spectrum-popover-border-color,var(--spectrum-alias-border-color-dark)
)}:host{--sp-popover-tip-size:24px}:host([placement*=bottom]),:host([placement*=top]){max-height:calc(100% - var(--spectrum-overlay-animation-distance))}:host([placement*=left]),:host([placement*=right]){max-width:calc(100% - var(--spectrum-overlay-animation-distance))}::slotted(*){overscroll-behavior:contain}.tip{height:calc(var(--sp-popover-tip-size)/2);left:0;position:absolute;width:var(--sp-popover-tip-size)}:host([placement*=right]) #tip{transform:none}:host([placement*=bottom]) #tip{transform:none}:host([placement*=top]) .tip{top:100%}:host([placement*=bottom]) .tip{bottom:100%;transform:scaleY(-1)}:host([placement*=left]) .tip{transform:rotate(-90deg) translateY(-200%);transform-origin:100% 0}:host([placement*=right]) .tip{transform:rotate(90deg);transform-origin:0 0}::slotted(.visually-hidden){clip:rect(0,0,0,0);border:0;-webkit-clip-path:inset(50%);clip-path:inset(50%);height:1px;margin:0 -1px -1px 0;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`;class E extends i{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[U]}renderTip(){return e`<div id="tip"><svg xmlns="http://www.w3.org/svg/2000" class="tip" viewBox="0 0 24 12"><path class="triangle" d="M 0.7071067811865476 0 L 11.414213562373096 10.707106781186548 L 22.121320343559645 0"></path></svg></div>`}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(t){if(!t.target)return;if(t.target!==this)return;const o=this.shadowRoot.querySelector("#tip");o&&(t.detail.overlayContentTipElement=o)}render(){return e`<slot></slot>${this.tip?this.renderTip():s}`}}r([c({type:Boolean,reflect:!0})],E.prototype,"dialog",void 0),r([c({type:Boolean,reflect:!0})],E.prototype,"open",void 0),r([c({reflect:!0})],E.prototype,"placement",void 0),r([c({type:Boolean,reflect:!0})],E.prototype,"tip",void 0),customElements.define("sp-popover",E);const W=async(t,o,e,r)=>{const{Overlay:c}=await import("./e90fe6f8.js").then((function(t){return t.o}));return c.open(t,o,e,r)},S={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class H extends(h(m)){constructor(){super(),this.disabled=!1,this.focused=!1,this.invalid=!1,this.open=!1,this.readonly=!1,this.selects="single",this.menuItems=[],this.placement="bottom-start",this.quiet=!1,this.value="",this.listRole="listbox",this.itemRole="option",this.onKeydown=t=>{this.focused=!0,"ArrowDown"!==t.code&&"ArrowUp"!==t.code||(t.preventDefault(),this.toggle(!0))},this.overlayCloseCallback=()=>{this.open=!1},this._willUpdateItems=!1,this.itemsUpdated=Promise.resolve(),this.menuStatePromise=Promise.resolve(),this.onKeydown=this.onKeydown.bind(this)}get target(){return this.button}get focusElement(){return this.open?this.optionsMenu:this.button}forceFocusVisible(){this.focused=!0}onButtonBlur(){this.focused=!1,this.target.removeEventListener("keydown",this.onKeydown)}onButtonClick(){this.toggle()}focus(t){super.focus(t),!this.disabled&&this.focusElement&&(this.focused=this.hasVisibleFocusInTree())}onHelperFocus(){this.focused=!0,this.button.focus()}onButtonFocus(){this.target.addEventListener("keydown",this.onKeydown)}handleChange(t){t.stopPropagation();const o=t.target,[e]=o.selectedItems;this.setValueFromItem(e,t)}async setValueFromItem(t,o){const e=this.selectedItem,r=this.value;this.selectedItem=t,this.value=t.value,this.open=!1,await this.updateComplete;if(!this.dispatchEvent(new Event("change",{cancelable:!0})))return o&&o.preventDefault(),this.selectedItem.selected=!1,e&&(e.selected=!0),this.selectedItem=e,this.value=r,void(this.open=!0);e&&(e.selected=!1),t.selected=!!this.selects}toggle(t){this.readonly||(this.open=void 0!==t?t:!this.open)}close(){this.readonly||(this.open=!1)}onOverlayClosed(){this.close(),this.restoreChildren&&(this.restoreChildren(),this.restoreChildren=void 0),this.menuStateResolver()}async openMenu(){let t=[];const o=this.querySelector("sp-menu");if(t=o?Array.from(o.children):Array.from(this.children).filter((t=>!t.hasAttribute("slot"))),0===t.length)return void this.menuStateResolver();this.restoreChildren=f(t,this.optionsMenu,(()=>t=>{void 0!==t.focused&&(t.focused=!1)})),this.sizePopover(this.popover);const{popover:e}=this;this.addEventListener("sp-opened",(async()=>{this.updateMenuItems(),await Promise.all([this.itemsUpdated,this.optionsMenu.updateComplete]),this.menuStateResolver()}),{once:!0}),this.closeOverlay=await R.openOverlay(this,"modal",e,{placement:this.placement,receivesFocus:"auto"})}sizePopover(t){const o=!this.quiet&&`${this.offsetWidth}px`;o&&t.style.setProperty("min-width",o)}closeMenu(){this.closeOverlay&&(this.closeOverlay(),delete this.closeOverlay)}get selectedItemContent(){return this.selectedItem?this.selectedItem.itemChildren:{icon:[],content:[]}}renderLabelContent(t){return this.value&&this.selectedItem?t:e`<slot name="label">${this.label}</slot>`}get buttonContent(){const t={"visually-hidden":"only"===this.icons&&!!this.value,placeholder:!this.value};return[e`<span id="icon" ?hidden="${"none"===this.icons}">${this.selectedItemContent.icon} </span><span id="label" class="${x(t)}">${this.renderLabelContent(this.selectedItemContent.content)} </span>${this.invalid?e`<sp-icon-alert class="validation-icon"></sp-icon-alert>`:s}<sp-icon-chevron100 class="picker ${S[this.size]}"></sp-icon-chevron100>`]}get renderButton(){return e`<span id="focus-helper" tabindex="${this.focused?"-1":"0"}" @focus="${this.onHelperFocus}"></span> <button aria-haspopup="true" aria-expanded="${this.open?"true":"false"}" aria-labelledby="button icon label" id="button" class="button" @blur="${this.onButtonBlur}" @click="${this.onButtonClick}" @focus="${this.onButtonFocus}" ?disabled="${this.disabled}" tabindex="-1">${this.buttonContent}</button>`}update(t){this.selects&&(this.selects="single"),super.update(t)}render(){return e`${this.renderButton} ${this.renderPopover}`}get dismissHelper(){return e`<div class="visually-hidden"><button tabindex="-1" arial-label="Dismiss" @click="${this.close}"></button></div>`}get renderPopover(){return e`<sp-popover id="popover" role="dialog" @sp-menu-item-added-or-updated="${this.updateMenuItems}" @sp-overlay-closed="${this.onOverlayClosed}" .overlayCloseCallback="${this.overlayCloseCallback}">${this.dismissHelper}<sp-menu id="menu" role="${this.listRole}" @change="${this.handleChange}" .selects="${this.selects}"></sp-menu>${this.dismissHelper}</sp-popover>`}updateMenuItems(t){if(this._willUpdateItems)return;this._willUpdateItems=!0,(null==t?void 0:t.item)===this.selectedItem&&this.requestUpdate();let o=()=>{};this.itemsUpdated=new Promise((t=>o=t)),window.requestAnimationFrame((async()=>{this.open?(await this.optionsMenu.updateComplete,this.menuItems=this.optionsMenu.childItems):this.menuItems=[...this.querySelectorAll("sp-menu-item")],this.manageSelection(),o(),this._willUpdateItems=!1}))}firstUpdated(t){super.firstUpdated(t),this.optionsMenu=this.shadowRoot.querySelector("sp-menu");this.querySelector("sp-menu")&&console.warn(`Deprecation Notice: You no longer need to provide an sp-menu child to ${this.tagName.toLowerCase()}. Any styling or attributes on the sp-menu will be ignored.`)}updated(t){super.updated(t),t.has("value")&&!t.has("selectedItem")&&this.updateMenuItems(),t.has("disabled")&&this.disabled&&(this.open=!1),t.has("open")&&(this.open||void 0!==t.get("open"))&&(this.menuStatePromise=new Promise((t=>this.menuStateResolver=t)),this.open?this.openMenu():this.closeMenu())}manageSelection(){let t;this.menuItems.forEach((o=>{this.value!==o.value||o.disabled?o.selected=!1:t=o})),t?(t.selected=!!this.selects,this.selectedItem=t):(this.value="",this.selectedItem=void 0),this.open&&this.optionsMenu.updateComplete.then((()=>{this.optionsMenu.updateSelectedItemIndex()}))}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.menuStatePromise,await this.itemsUpdated,t}connectedCallback(){this.updateMenuItems(),this.addEventListener("sp-menu-item-added-or-updated",this.updateMenuItems),this.addEventListener("sp-menu-item-removed",this.updateMenuItems),super.connectedCallback()}disconnectedCallback(){this.open=!1,super.disconnectedCallback()}}H.openOverlay=async(t,o,e,r)=>await W(t,o,e,r),r([b("#button")],H.prototype,"button",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"disabled",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"focused",void 0),r([c({type:String,reflect:!0})],H.prototype,"icons",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"invalid",void 0),r([c()],H.prototype,"label",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"open",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"readonly",void 0),r([c()],H.prototype,"placement",void 0),r([c({type:Boolean,reflect:!0})],H.prototype,"quiet",void 0),r([c({type:String})],H.prototype,"value",void 0),r([c({attribute:!1})],H.prototype,"selectedItem",void 0),r([b("sp-popover")],H.prototype,"popover",void 0);class R extends H{constructor(){super(...arguments),this.onKeydown=t=>{const{code:o}=t;if(this.focused=!0,!o.startsWith("Arrow")||this.readonly)return;if(t.preventDefault(),"ArrowUp"===o||"ArrowDown"===o)return void this.toggle(!0);const e=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,r=this.value&&"ArrowRight"!==o?-1:1;let c=e+r;for(;this.menuItems[c]&&this.menuItems[c].disabled;)c+=r;this.menuItems[c]&&!this.menuItems[c].disabled&&(this.value&&c===e||this.setValueFromItem(this.menuItems[c]))}}static get styles(){return[y,k]}}customElements.define("sp-picker",R);var L=a`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;class j extends(h(v)){constructor(){super(...arguments),this.variant="cta",this.warning=!1,this.quiet=!1}static get styles(){return[...super.styles,L]}}r([c({reflect:!0})],j.prototype,"variant",void 0),r([c({type:Boolean,reflect:!0})],j.prototype,"warning",void 0),r([c({type:Boolean,reflect:!0})],j.prototype,"quiet",void 0),customElements.define("sp-button",j);var D=a`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
);justify-content:center;line-height:var(
--spectrum-alias-component-text-line-height,var(--spectrum-global-font-line-height-small)
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;var _=a`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-CornerTriangle75{height:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;const M={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let P;class $ extends(h(g)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[D,_]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),P=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(P),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(e`<sp-icon-corner-triangle300 id="hold-affordance" class="${M[this.size]}"></sp-icon-corner-triangle300>`),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}r([c({type:Boolean,reflect:!0})],$.prototype,"emphasized",void 0),r([c({type:Boolean,reflect:!0,attribute:"hold-affordance"})],$.prototype,"holdAffordance",void 0),r([c({type:Boolean,reflect:!0})],$.prototype,"quiet",void 0),r([c({reflect:!0})],$.prototype,"role",void 0),r([c({type:Boolean,reflect:!0})],$.prototype,"selected",void 0),r([c({type:Boolean,reflect:!0})],$.prototype,"toggles",void 0),r([c({type:String})],$.prototype,"value",null),customElements.define("sp-action-button",$),customElements.define("sp-menu-item",A);var G=a`:host([size=s]){--spectrum-link-primary-text-size:var(
...
)}@media (forced-colors:active){:host([variant=secondary]) a{color:linktext}:host([variant=secondary]) a:hover{color:linktext}:host([variant=secondary]) a:active{color:linktext}:host([variant=secondary]) a:focus{color:linktext}}:host{display:inline}:host(:focus){outline:0}:host([href]) a.focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}:host([href]) a:focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}`;class O extends(h(d(m),{noDefaultSize:!0})){static get styles(){return[G]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}r([b("#anchor")],O.prototype,"anchorElement",void 0),r([c({type:String,reflect:!0})],O.prototype,"variant",void 0),customElements.define("sp-link",O);var K=a`:host([size=s]){--spectrum-divider-height:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class N extends(h(i,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return e``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}N.styles=[K],r([c({type:Boolean,reflect:!0})],N.prototype,"vertical",void 0),customElements.define("sp-divider",N);var V=a`:host{--spectrum-toast-icon-padding-y:var(
--spectrum-global-dimension-size-85
...
--spectrum-toast-positive-background-color,var(--spectrum-semantic-positive-background-color)
)}.content{line-height:1.5}:host(:not([open])){display:none}`;const Y=["negative","positive","info","error","warning"];class Q extends i{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.open=!1,this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[V]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;Y.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return e`<sp-icon-info label="Information" class="type"></sp-icon-info>`;case"negative":case"error":case"warning":return e`<sp-icon-alert label="Error" class="type"></sp-icon-alert>`;case"positive":case"success":return e`<sp-icon-checkmark-circle label="Success" class="type"></sp-icon-checkmark-circle>`;default:return e``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}close(){this.open=!1}render(){return e`${this.renderIcon(this.variant)}<div class="body" role="alert"><div class="content"><slot></slot></div><slot name="action"></slot></div><div class="buttons"><sp-clear-button label="Close" variant="overBackground" @click="${this.close}"></sp-clear-button></div>`}updated(t){if(super.updated(t),t.has("open"))if(this.open)this.timeout&&this.startCountdown();else{this.timeout&&this.stopCountdown();this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))||(this.open=!0)}t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}r([c({type:Boolean,reflect:!0})],Q.prototype,"open",void 0),r([c({type:Number})],Q.prototype,"timeout",null),r([c({type:String})],Q.prototype,"variant",null),customElements.define("sp-toast",Q);export{F as M,H as P,x as a,k as c,W as o,f as r};
//# sourceMappingURL=92b56109.js.map
