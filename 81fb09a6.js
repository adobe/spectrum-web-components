import{T as t}from"./c14ac009.js";import{i as o}from"./112b2095.js";import"./a66fd221.js";import{B as e}from"./75b21873.js";import{S as r}from"./cd538c17.js";import{x as c,n,d as a,S as s}from"./dd8018c7.js";import"./7aca7b02.js";import"./a6c69bec.js";import"./7c165e09.js";import{a as i}from"./41f420ad.js";customElements.define("sp-theme",t);var u=o`
...
`,f=Object.defineProperty,k=Object.getOwnPropertyDescriptor,w=(t,o,e,r)=>{for(var c,n=r>1?void 0:r?k(o,e):o,a=t.length-1;a>=0;a--)(c=t[a])&&(n=(r?c(o,e,n):c(n))||n);return r&&n&&f(o,e,n),n};const y=["negative","positive","info","error","warning"];class x extends(i(s)){constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[g]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;y.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return c`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
...
//# sourceMappingURL=81fb09a6.js.map
