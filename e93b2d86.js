import{t,s as h}from"./5a045148.js";import{I as r,y as e}from"./05d6b8f8.js";customElements.define("sp-icon-show-menu",class extends r{render(){return h(e),(({width:h=24,height:r=24,hidden:e=!1,title:i="Show Menu"}={})=>t`<svg
  ...
  </svg>`)({hidden:!this.label,title:this.label})}});customElements.define("sp-icon-copy",class extends r{render(){return h(e),(({width:h=24,height:r=24,hidden:e=!1,title:i="Copy"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${r}
    viewBox="0 0 36 36"
    width=${h}
...
//# sourceMappingURL=e93b2d86.js.map
