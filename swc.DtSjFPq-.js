import"./swc.DBlJt4TD.js";import"./swc.xkGkgKJM.js";import"./swc.DNJt4h1A.js";import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.Dofmtdop.js";import{i as s}from"./swc.Cl2X6-fK.js";import{S as i}from"./swc.CCdsirGn.js";import{x as n,j as r}from"./swc.BkWj9Vim.js";import{o as a}from"./swc.CF8fRO5N.js";import{n as l}from"./swc.Cbbf2bfB.js";const p=s`
...
`;var c=Object.defineProperty,m=(t,e,o,s)=>{for(var i,n=void 0,r=t.length-1;r>=0;r--)(i=t[r])&&(n=i(e,o,n)||n);return n&&c(e,o,n),n};class h extends i{constructor(){super(...arguments),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(import("./swc.CCP6RdnU.js").then((function(t){return t.s})),import("./swc.B9dZzSkF.js").then((function(t){return t.s})),n`
            ...
            `):(import("./swc.CJew_-Xg.js").then((function(t){return t.s})),n`
...
//# sourceMappingURL=swc.CIgX7ODM.js.map
