(window.webpackJsonp=window.webpackJsonp||[]).push([[10],{208:function(e,t,r){"use strict";r.r(t),r.d(t,"DarkCode",(function(){return L})),r.d(t,"LightCode",(function(){return z})),r.d(t,"CodeExample",(function(){return E}));var o=r(2),i=r(6),a=r(106),c=r(26),d=r(107),n=r(108);let s;var l=Object(i.b)(s||(s=(e=>e)`
...
`)),h=r(181),g=r(44),u=(r(25),r(189)),p=r(4);let x,m=e=>e;class b extends u.a{render(){return Object(p.a)(i.d),(({width:e=24,height:t=24,hidden:r=!1,title:o="Copy"}={})=>Object(p.b)(x||(x=m`<svg
  ...
  </svg>`),t,e,r?"true":"false",o))({hidden:!this.label,title:this.label})}}function y(e){if("clipboard"in navigator)return navigator.clipboard.writeText(e.textContent||"");const t=getSelection();if(null==t)return Promise.reject(new Error);t.removeAllRanges();const r=document.createRange();return r.selectNodeContents(e),t.addRange(r),document.execCommand("copy"),t.removeAllRanges(),Promise.resolve()}customElements.define("sp-icon-copy",b);let w,v,O,j,f,k,C,$=e=>e;class T extends i.a{constructor(){super(...arguments),this.code=""}get highlightedCode(){return Object(c.a)(this.code)}render(){return Object(i.d)(w||(w=$` <pre><code>${0}</code></pre> `),this.highlightedCode)}}Object(o.a)([Object(i.e)()],T.prototype,"code",void 0);let L=class extends T{static get styles(){return[d.a]}};L=Object(o.a)([Object(i.c)("dark-code")],L);let z=class extends T{static get styles(){return[n.a,Object(i.b)(v||(v=$`.token.attr-name,.token.builtin,.token.char,.token.inserted,.token.selector,.token.string{color:#567f01}.token.punctuation{color:#737373}.language-css .token.function{color:inherit}`))]}};z=Object(o.a)([Object(i.c)("light-code")],z);let E=class extends(Object(g.a)(i.a)){constructor(){super(...arguments),this.codeTheme="dark",this.shouldManageTabOrderForScrolling=()=>{[this.markup,this.demo].map(e=>{if(!e)return;const{offsetWidth:t,scrollWidth:r}=e;t<r?e.tabIndex=0:e.removeAttribute("tabindex")})}}static get styles(){return[l]}get code(){return Object(h.a)(O||(O=$`${0}`),this.textContent)||""}get language(){return this.classList.contains("language-javascript")?"javascript":"markup"}get showDemo(){return this.classList.contains("language-html")||this.classList.contains("language-html-live")}get highlightedCode(){const e=a.highlight(this.code,a.languages[this.language],this.language);return"dark"===this.codeTheme?Object(i.d)(j||(j=$` <dark-code .code="${0}"></dark-code> `),e):Object(i.d)(f||(f=$` <light-code .code="${0}"></light-code> `),e)}get renderedCode(){if(this.classList.contains("language-html-live")){const e=document.createElement("div");e.slot="demo",e.innerHTML=this.code,this.append(e)}return Object(c.a)(this.code)}render(){const{highlightedCode:e,renderedCode:t}=this;return Object(i.d)(k||(k=$` ${0} <bdo id="markup" dir="ltr"> ${0} <sp-action-button class="copy" @click="${0}" quiet> <sp-icon-copy slot="icon"></sp-icon-copy> Copy to Clipboard </sp-action-button> </bdo> `),this.showDemo?Object(i.d)(C||(C=$` <div class="demo-example"> <slot name="demo">${0}</slot> </div> `),t):void 0,e,this.copyToClipboard)}copyToClipboard(){y(this)}updated(){requestAnimationFrame(()=>{this.shouldManageTabOrderForScrolling()})}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.shouldManageTabOrderForScrolling)}disconnectedCallback(){window.removeEventListener("resize",this.shouldManageTabOrderForScrolling),super.disconnectedCallback()}};Object(o.a)([Object(i.f)("#markup")],E.prototype,"markup",void 0),Object(o.a)([Object(i.f)(".demo-example")],E.prototype,"demo",void 0),Object(o.a)([Object(i.e)()],E.prototype,"codeTheme",void 0),E=Object(o.a)([Object(i.c)("code-example")],E)},26:function(e,t,r){"use strict";r.d(t,"a",(function(){return i}));var o=r(6);function i(e){const t=[""+e];return t.raw=[""+e],Object(o.d)(t)}}}]);
//# sourceMappingURL=10.454b353265b67e63dc10.js.map