import{i as t}from"./67a87733.js";import{e,S as i,x as s,d as o}from"./cd228091.js";import{O as a}from"./50d2afed.js";import{t as r,F as c,S as l,l as n,i as d,a as m,L as b}from"./7dd6c208.js";import{R as u}from"./46782a8f.js";import{o as p}from"./e81a6d1a.js";import"./b36cb35c.js";import"./b6dda3ba.js";import"./291abe7d.js";import"./83e2d6f3.js";import"./7b3008bb.js";import"./6da812dd.js";import{Overlay as h}from"./a9770f3d.js";import"./16ab2288.js";import"./9f12f255.js";import"./9cdb9ada.js";import"./7dca79b5.js";import"./590196c7.js";import"./045d5864.js";const v=Symbol("slotContentIsPresent");function x(t,e){var i;const s=Array.isArray(e)?e:[e];return i=v,class extends t{constructor(...t){super(t),this[i]=new Map,this.managePresenceObservedSlot=()=>{let t=!1;s.forEach((e=>{const i=!!this.querySelector(e),s=this[v].get(e)||!1;t=t||s!==i,this[v].set(e,!!this.querySelector(e))})),t&&this.updateComplete.then((()=>{this.requestUpdate()}))},new r(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(1===s.length)return this[v].get(s[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(t){if(this[v].has(t))return this[v].get(t)||!1;throw new Error(`The provided selector \`${t}\` is not being observed.`)}}}var g=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,y=Object.defineProperty,f=Object.getOwnPropertyDescriptor,z=(t,e,i,s)=>{for(var o,a=s>1?void 0:s?f(e,i):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&y(e,i,a),a};const k=class extends i{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return s`
            <slot></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+k.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};let q=k;q.styles=[g],q.instanceCount=0,z([e({type:Boolean,reflect:!0})],q.prototype,"selected",2),z([e({type:String,reflect:!0})],q.prototype,"value",2),o("sp-tab-panel",q);var w=t`
...
`,S=Object.defineProperty,C=Object.getOwnPropertyDescriptor,I=(t,e,i,s)=>{for(var o,a=s>1?void 0:s?C(e,i):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&S(e,i,a),a};const A=class extends(c(a(x(i,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[w]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`
            ${this.hasIcon?s`
                      <slot name="icon"></slot>
                  `:s``}
...
`,O=Object.defineProperty,L=Object.getOwnPropertyDescriptor,H=(t,e,i,s)=>{for(var o,a=s>1?void 0:s?L(e,i):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&O(e,i,a),a};const B={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
        ...
        `}};class U extends(l(m)){constructor(){super(),this.auto=!1,this.compact=!1,this.direction="horizontal",this.emphasized=!1,this.label="",this.enableTabsScroll=!1,this.quiet=!1,this.selectionIndicatorStyle=B.noSelectionStyle,this.shouldAnimate=!1,this.selected="",this._tabs=[],this.resizeController=new j(this,{callback:()=>{this.updateSelectionIndicator()}}),this.rovingTabindexController=new u(this,{focusInIndex:t=>{let e=0;return t.find(((t,i)=>{const s=this.selected?!t.disabled&&t.value===this.selected:!t.disabled;return e=i,s}))?e:-1},direction:()=>"horizontal"===this.direction?"horizontal":"vertical",elementEnterAction:t=>{this.auto&&(this.shouldAnimate=!0,this.selectTarget(t))},elements:()=>this.tabs,isFocusableElement:t=>!t.disabled,listenerScope:()=>this.tabList}),this.onTabsScroll=()=>{this.dispatchEvent(new Event("sp-tabs-scroll",{bubbles:!0,composed:!0}))},this.onClick=t=>{if(this.disabled)return;const e=t.composedPath().find((t=>t.parentElement===this));!e||e.disabled||(this.shouldAnimate=!0,this.selectTarget(e))},this.onKeyDown=t=>{if("Enter"===t.code||"Space"===t.code){t.preventDefault();const e=t.target;e&&this.selectTarget(e)}},this.updateCheckedState=()=>{if(this.tabs.forEach((t=>{t.removeAttribute("selected")})),this.selected){const t=this.tabs.find((t=>t.value===this.selected));t?t.selected=!0:this.selected=""}else{const t=this.tabs[0];t&&t.setAttribute("tabindex","0")}this.updateSelectionIndicator()},this.updateSelectionIndicator=async()=>{const t=this.tabs.find((t=>t.selected));if(!t)return void(this.selectionIndicatorStyle=B.noSelectionStyle);await Promise.all([t.updateComplete,document.fonts?document.fonts.ready:Promise.resolve()]);const{width:e,height:i}=t.getBoundingClientRect();this.selectionIndicatorStyle="horizontal"===this.direction?B.transformX(t.offsetLeft,e):B.transformY(t.offsetTop,i)},new T(this,{config:{root:null,rootMargin:"0px",threshold:[0,1]},callback:()=>{this.updateSelectionIndicator()}})}static get styles(){return[P,$,B.baseStyles()]}set tabs(t){t!==this.tabs&&(this._tabs.forEach((t=>{this.resizeController.unobserve(t)})),t.forEach((t=>{this.resizeController.observe(t)})),this._tabs=t,this.rovingTabindexController.clearElementCache())}get tabs(){return this._tabs}get focusElement(){return this.rovingTabindexController.focusInElement||this}scrollTabs(t,e="smooth"){var i;null==(i=this.tabList)||i.scrollBy({left:t,top:0,behavior:e})}get scrollState(){if(this.tabList){const{scrollLeft:t,clientWidth:e,scrollWidth:i}=this.tabList,s=Math.abs(t)>0,o=Math.ceil(Math.abs(t))<i-e;return{canScrollLeft:"ltr"===this.dir?s:o,canScrollRight:"ltr"===this.dir?o:s}}return{}}manageAutoFocus(){const t=[...this.children].map((t=>void 0!==t.updateComplete?t.updateComplete:Promise.resolve(!0)));Promise.all(t).then((()=>super.manageAutoFocus()))}managePanels({target:t}){t.assignedElements().map((t=>{const{value:e,id:i}=t,s=this.querySelector(`[role="tab"][value="${e}"]`);s&&(s.setAttribute("aria-controls",i),t.setAttribute("aria-labelledby",s.id)),t.selected=e===this.selected}))}render(){return s`
            <div
...
`,Y=Object.defineProperty,K=Object.getOwnPropertyDescriptor,N=(t,e,i,s)=>{for(var o,a=s>1?void 0:s?K(e,i):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Y(e,i,a),a};class G extends(b(m)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[w,M]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${n(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}N([d("a")],G.prototype,"anchor",2),N([e({type:Boolean,reflect:!0})],G.prototype,"selected",2),o("sp-top-nav-item",G),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:i}=e,{pathname:s}=location,o=s.search("api")>-1;switch(i){case"api":{if(o)return;const t=(s+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!o)return;const t=s.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./52410f3d.js"),import("./d2c9b2fd.js")})):requestAnimationFrame((()=>{import("./52410f3d.js"),import("./d2c9b2fd.js")})),window.Overlay=h;var W=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",W),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{x as O,P as g,j as s};
//# sourceMappingURL=3b14a3a7.js.map
