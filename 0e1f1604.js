import{T as t}from"./21d18191.js";import{B as o,I as r,S as c}from"./1d5c2eae.js";import{i as e}from"./67a87733.js";import{S as n}from"./0c1af6fc.js";import{e as s,d as a,x as u,S as i}from"./cd228091.js";import"./47e17955.js";import"./ff67cab2.js";import"./7b3008bb.js";import"./291abe7d.js";customElements.define("sp-theme",t);var l=e`
...
`,g=Object.defineProperty,f=Object.getOwnPropertyDescriptor;const k={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class y extends(n(c)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,h,r]}get buttonContent(){return[k[this.size]()]}}((t,o,r,c)=>{for(var e,n=c>1?void 0:c?f(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&g(o,r,n)})([s({reflect:!0})],y.prototype,"variant",2);var w=e`
...
`,z=Object.defineProperty,q=Object.getOwnPropertyDescriptor,C=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?q(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&z(o,r,n),n};const T={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let j;class B extends(n(o,{validSizes:["xs","s","m","l","xl"]})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,w,x]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){0===t.button&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),j=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}onPointerup(){clearTimeout(j),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${T[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}C([s({type:Boolean,reflect:!0})],B.prototype,"emphasized",2),C([s({type:Boolean,reflect:!0,attribute:"hold-affordance"})],B.prototype,"holdAffordance",2),C([s({type:Boolean,reflect:!0})],B.prototype,"quiet",2),C([s({reflect:!0})],B.prototype,"role",2),C([s({type:Boolean,reflect:!0})],B.prototype,"selected",2),C([s({type:Boolean,reflect:!0})],B.prototype,"toggles",2),C([s({reflect:!0})],B.prototype,"variant",2),C([s({type:String})],B.prototype,"value",1),a("sp-action-button",B);var I=e`
...
`,A=Object.defineProperty,H=Object.getOwnPropertyDescriptor;class P extends(n(i,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}P.styles=[I],((t,o,r,c)=>{for(var e,n=c>1?void 0:c?H(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&A(o,r,n)})([s({type:Boolean,reflect:!0})],P.prototype,"vertical",2),a("sp-divider",P),a("sp-close-button",y);var U=e`
...
`,E=Object.defineProperty,S=Object.getOwnPropertyDescriptor,O=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?S(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&E(o,r,n),n};const _=["negative","positive","info","error","warning"];class L extends i{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[U]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,r=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;_.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}O([s({type:Boolean,reflect:!0})],L.prototype,"open",2),O([s({type:Number})],L.prototype,"timeout",1),O([s({type:String})],L.prototype,"variant",1),a("sp-toast",L);export{I as s};
//# sourceMappingURL=0e1f1604.js.map
