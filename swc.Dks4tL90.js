import{t,s as e}from"./swc.Chuw36y7.js";import{I as a}from"./swc.Bea_DqvJ.js";import{x as i}from"./swc.DWYvVEd1.js";import{d as s}from"./swc.JlveB6nj.js";s("sp-icon-share",class extends a{render(){return e(i),2===this.spectrumVersion?(({width:e=24,height:a=24,hidden:i=!1,title:s="Share"}={})=>t`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:e=24,height:a=24,hidden:i=!1,title:s="Share"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${a}"
    viewBox="0 0 36 36"
    width="${e}"
