import{f as e,S as t}from"./f370b7d9.js";import{i as r}from"./112b2095.js";import"./54cb6f26.js";import{S as o}from"./a33432c3.js";import{T as i,A as c,x as a,n as s,d as l}from"./a542812c.js";import"./4d1b1c8f.js";import{c as n,t as d}from"./fc785bd0.js";import{l as u,F as p,i as h}from"./1740174f.js";import"./aa3e8a01.js";import"./0844aff5.js";import{E as m}from"./7c327fb6.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./3c523adf.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
//# sourceMappingURL=8096d3e7.js.map
