...
--spectrum-alias-single-line-width,var(--spectrum-global-dimension-size-2400)
)}:host([multiline]){resize:both}#textfield{width:100%}#textfield,textarea{resize:inherit}:host([grows]) .input{height:100%;left:0;overflow:hidden;position:absolute;resize:none;top:0}:host([grows]) #sizer{-webkit-appearance:none;-moz-appearance:textfield;border:var(--spectrum-textfield-texticon-border-size) solid;border-radius:var(--spectrum-textfield-texticon-border-radius);box-sizing:border-box;font-family:var(--spectrum-textfield-texticon-text-font-family);font-size:var(--spectrum-textfield-texticon-text-size);line-height:var(--spectrum-textfield-texticon-text-line-height);margin:0;outline:0;overflow:visible;overflow-wrap:break-word;padding:var(--spectrum-textarea-padding-top) var(--spectrum-textarea-padding-right) var(--spectrum-textarea-padding-bottom) calc(var(--spectrum-textarea-padding-left) - 1px);text-indent:0;text-overflow:ellipsis;transition:border-color var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out;vertical-align:top;width:100%}:host([grows][quiet]) #sizer{border-bottom-width:var(--spectrum-textfield-quiet-texticon-border-size);border-left-width:0;border-radius:var(--spectrum-textfield-quiet-texticon-border-radius);border-right-width:0;border-top-width:0;overflow-y:hidden;resize:none}.icon,.icon-workflow{pointer-events:none}`;const F=["text","url","tel","email","password"];class N extends(C(d)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[L,c]}get type(){var e;return null!==(e=F.find((e=>e===this._type)))&&void 0!==e?e:"text"}set type(e){const t=this._type;this._type=e,this.requestUpdate("type",t)}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,t,i="none"){this.inputElement.setSelectionRange(e,t,i)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const e=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(e,e)}}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!0}onBlur(){this.focused=!1}renderStateIcons(){return this.invalid?a`<sp-icon-alert id="invalid" class="icon"></sp-icon-alert>`:this.valid?a`<sp-icon-checkmark100 id="valid" class="icon spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`:n}get displayValue(){return this.value.toString()}get renderMultiline(){return a`${this.grows&&!this.quiet?a`<div id="sizer">${this.value}</div>`:n} <textarea aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${l(this.invalid||void 0)}" class="input" maxlength="${l(this.maxlength>-1?this.maxlength:void 0)}" minlength="${l(this.minlength>-1?this.minlength:void 0)}" pattern="${l(this.pattern)}" placeholder="${this.placeholder}" .value="${this.displayValue}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${l(this.autocomplete)}"></textarea>`}get renderInput(){return a`<input type="${this.type}" aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${l(this.invalid||void 0)}" class="input" maxlength="${l(this.maxlength>-1?this.maxlength:void 0)}" minlength="${l(this.minlength>-1?this.minlength:void 0)}" pattern="${l(this.pattern)}" placeholder="${this.placeholder}" .value="${T(this.displayValue)}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${l(this.autocomplete)}">`}renderField(){return a`${this.renderStateIcons()} ${this.multiline?this.renderMultiline:this.renderInput}`}render(){return a`<div id="textfield">${this.renderField()}</div>${this.renderHelpText(this.invalid)}`}updated(e){(e.has("value")||e.has("required")&&this.required)&&this.checkValidity()}checkValidity(){let e=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){e=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(e=e&&this.value.toString().length>this.minlength),this.valid=e,this.invalid=!e}return e}}u([e({attribute:"allowed-keys"})],N.prototype,"allowedKeys",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"focused",void 0),u([p(".input")],N.prototype,"inputElement",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"invalid",void 0),u([e()],N.prototype,"label",void 0),u([e()],N.prototype,"placeholder",void 0),u([e({attribute:"type",reflect:!0})],N.prototype,"_type",void 0),u([b()],N.prototype,"type",null),u([e()],N.prototype,"pattern",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"grows",void 0),u([e({type:Number})],N.prototype,"maxlength",void 0),u([e({type:Number})],N.prototype,"minlength",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"multiline",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"readonly",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"valid",void 0),u([e({type:String})],N.prototype,"value",null),u([e({type:Boolean,reflect:!0})],N.prototype,"quiet",void 0),u([e({type:Boolean,reflect:!0})],N.prototype,"required",void 0),u([e({type:String,reflect:!0})],N.prototype,"autocomplete",void 0);class B extends N{constructor(){super(...arguments),this._value=""}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}}u([e({type:String})],B.prototype,"value",null);customElements.define("sp-icon-magnify",class extends h{render(){return v(a),(({width:e=24,height:t=24,hidden:i=!1,title:r="Magnify"}={})=>m`<svg xmlns="http://www.w3.org/2000/svg" height="${t}" viewBox="0 0 36 36" width="${e}" aria-hidden="${i?"true":"false"}" role="img" fill="currentColor" aria-label="${r}"><path d="M33.173 30.215L25.4 22.443a12.826 12.826 0 10-2.957 2.957l7.772 7.772a2.1 2.1 0 002.958-2.958zM6 15a9 9 0 119 9 9 9 0 01-9-9z"/></svg>`)({hidden:!this.label,title:this.label})}});var U=g`:host{--spectrum-search-quiet-button-offset:calc(var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const R=e=>e.stopPropagation();class P extends B{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,U]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;this.value&&"Escape"===t&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`<form action="${this.action}" id="form" method="${l(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?a`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${R}"></sp-clear-button>`:a``}</form>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}updated(e){super.updated(e),this.multiline=!1}}u([e()],P.prototype,"action",void 0),u([e()],P.prototype,"label",void 0),u([e()],P.prototype,"method",void 0),u([e()],P.prototype,"placeholder",void 0),u([p("#form")],P.prototype,"form",void 0),customElements.define("sp-search",P);var D=g`:host{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}`;var H=g`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}#item-link{font-weight:var(--spectrum-web-component-sidenav-font-weight);justify-content:start}:host([dir=ltr]) #item-link[data-level="1"]{padding-left:calc(var(--spectrum-sidenav-multilevel-item-indentation-level1,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=ltr]) #item-link[data-level="2"]{padding-left:calc(var(--spectrum-sidenav-multilevel-item-indentation-level2,var(--spectrum-global-dimension-size-300)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=rtl]) #item-link[data-level="1"]{padding-right:calc(var(--spectrum-sidenav-multilevel-item-indentation-level1,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=rtl]) #item-link[data-level="2"]{padding-right:calc(var(--spectrum-sidenav-multilevel-item-indentation-level2,var(--spectrum-global-dimension-size-300)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}a ::slotted(sp-sidenav-item){display:none}`;class M extends(x(d)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[H]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let e=0,t=this.parentElement;for(;t instanceof M;)e++,t=t.parentElement;return e}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),this.disabled||(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`<a href="${this.href||"#"}" target="${l(this.target)}" download="${l(this.download)}" rel="${l(this.rel)}" data-level="${this.depth}" @click="${this.handleClick}" id="item-link" aria-current="${l(this.selected&&this.href?"page":void 0)}"><slot name="icon"></slot>${this.label}<slot></slot></a>${this.expanded?a`<slot name="descendant"></slot>`:a``}`}updated(e){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(e)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const e=this.parentSideNav;e&&(await e.updateComplete,e.startTrackingSelectionForItem(this),this.selected=null!=this.value&&this.value===e.value)}stopTrackingSelection(){const e=this.parentSideNav;e&&e.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}}u([e()],M.prototype,"value",void 0),u([e({type:Boolean,reflect:!0})],M.prototype,"selected",void 0),u([e({type:Boolean,reflect:!0})],M.prototype,"expanded",void 0);var j=g`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}:host{display:block}`;class K extends f{constructor(){super(...arguments),this.label=""}static get styles(){return[H,j]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`<h2 id="heading">${this.label}</h2><div id="list" aria-labelledby="heading"><slot name="descendant"></slot></div>`}}u([e({reflect:!0})],K.prototype,"label",void 0);class O extends d{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new A(this,{focusInIndex:e=>e.findIndex((e=>this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e))),direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)}),this.manageTabIndex=!1,this.value=void 0}static get styles(){return[D]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache()}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof K||!t.disabled&&t instanceof M&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return a`<nav @sidenav-select="${this.handleSelect}"><slot name="descendant" @slotchange="${this.handleSlotchange}"></slot></nav>`}firstUpdated(e){super.firstUpdated(e);const t=this.querySelector("[selected]");t&&(this.value=t.value)}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}u([e({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],O.prototype,"manageTabIndex",void 0),u([e({reflect:!0})],O.prototype,"value",void 0),customElements.define("sp-sidenav",O),customElements.define("sp-sidenav-item",M);export{C as M,A as R,K as S,N as T,$ as a,B as b,q as c,S as m,y as r,I as s,b as t,z as u};
//# sourceMappingURL=3d8d9f11.js.map
