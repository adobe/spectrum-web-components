...
)}`;class qt extends s{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Lt]}render(){return r`<slot></slot>`}}o([i({type:Boolean,reflect:!0})],qt.prototype,"opened",void 0),o([i({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],qt.prototype,"textOnly",void 0),customElements.define("sp-quick-actions",qt);var _t=n`:host([size=s]){--spectrum-card-quiet-body-header-margin-top:var(
...
--spectrum-alias-focus-ring-gap,
var(--spectrum-global-dimension-static-size-25)
)*-1);position:absolute;right:0;top:0}::slotted(:not(img)){display:none}:host([cover]) ::slotted(img){height:100%;object-fit:cover;width:100%}`;class Dr extends(f(s,{validSizes:["xxs","xs","s","m","l"],defaultSize:"s"})){static get styles(){return[Ir]}render(){return r`${this.background?r`<div class="background" style="background:${this.background}"></div>`:r``}<slot></slot>`}}o([i({type:String,reflect:!0})],Dr.prototype,"background",void 0),customElements.define("sp-thumbnail",Dr);var Hr=n`:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
--spectrum-tooltip-neutral-target-offset
)}:host([placement*=bottom]) #tip{bottom:100%;transform:rotate(-180deg)}:host([placement*=bottom]) #tip,:host([placement*=top]) #tip{left:50%;margin-left:calc(-1*var(--spectrum-tooltip-neutral-tip-width,var(--spectrum-global-dimension-size-100)))}:host([dir=ltr]) ::slotted([slot=icon]){margin-left:calc(var(--spectrum-tooltip-neutral-icon-margin-x,var(--spectrum-global-dimension-size-85)) - var(--spectrum-tooltip-neutral-padding-x,var(--spectrum-global-dimension-size-85)))}:host([dir=rtl]) ::slotted([slot=icon]){margin-right:calc(var(--spectrum-tooltip-neutral-icon-margin-x,var(--spectrum-global-dimension-size-85)) - var(--spectrum-tooltip-neutral-padding-x,var(--spectrum-global-dimension-size-85)))}:host([dir=ltr]) ::slotted([slot=icon]){margin-right:var(
