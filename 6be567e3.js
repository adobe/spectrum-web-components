import{i as e}from"./d230bd74.js";import{o as t,t as r,b as a}from"./26d112e5.js";import{S as i,y as s,e as n}from"./05d6b8f8.js";import{M as o}from"./d0466158.js";import{o as g}from"./3e119a64.js";import{t as l}from"./0d0f1026.js";var m=[t,r,e`
...
`,p=Object.defineProperty,h=Object.getOwnPropertyDescriptor,d=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?h(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&p(t,r,s),s};class u extends i{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[m,a,c]}render(){return s`
        ...
        `}}u.is="sp-illustrated-message",d([n()],u.prototype,"heading",2),d([n()],u.prototype,"description",2),customElements.define("sp-illustrated-message",u);var x=e`
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?f(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&v(t,r,s),s};const z=class extends o{constructor(){super(),z.instances+=1,this.headerId=`sp-menu-group-label-${z.instances}`}static get styles(){return[...super.styles,x]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return s`
            <span
                class="header"
                aria-hidden="true"
        ...
        `}};let b=z;b.instances=0,y([g("header",!0)],b.prototype,"headerElements",2),y([l()],b.prototype,"headerElement",2),customElements.define("sp-menu-group",b);export{m as h};
//# sourceMappingURL=6be567e3.js.map
