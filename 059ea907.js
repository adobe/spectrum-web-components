import{e as t,R as e,b as o,w as r,$ as i,_ as l}from"./31a32b8d.js";import{e as c,i as a,t as n,S as s,a as u,c as d}from"./09353748.js";import{r as p}from"./e50c5e8d.js";import"./78f07ab8.js";import{S as m,l as v,a as h,i as f}from"./36b2618c.js";import"./21d6199b.js";import"./def45cc3.js";function b(e){return t({...e,state:!0})}const{H:x}=e,g=t=>void 0===t.strings,w=()=>document.createComment(""),k=(t,e,o)=>{var r;const i=t._$AA.parentNode,l=void 0===e?t._$AB:e._$AA;if(void 0===o){const e=i.insertBefore(w(),l),r=i.insertBefore(w(),l);o=new x(e,r,t,t.options)}else{const e=o._$AB.nextSibling,c=o._$AM,a=c!==t;if(a){let e;null===(r=o._$AQ)||void 0===r||r.call(o,t),o._$AM=t,void 0!==o._$AP&&(e=t._$AU)!==c._$AU&&o._$AP(e)}if(e!==l||a){let t=o._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,l),t=e}}}return o},y=(t,e,o=t)=>(t._$AI(e,o),t),q={},z=(t,e=q)=>t._$AH=e,$=t=>t._$AH,T=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let o=t._$AA;const r=t._$AB.nextSibling;for(;o!==r;){const t=o.nextSibling;o.remove(),o=t}},B=c(class extends a{constructor(t){if(super(t),t.type!==n.PROPERTY&&t.type!==n.ATTRIBUTE&&t.type!==n.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!g(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===o||e===r)return e;const i=t.element,l=t.name;if(t.type===n.PROPERTY){if(e===i[l])return o}else if(t.type===n.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(l))return o}else if(t.type===n.ATTRIBUTE&&i.getAttribute(l)===e+"")return o;return z(t),e}});var E=p`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
--spectrum-textfield-m-textonly-focus-ring-border-color-key-focus,var(--spectrum-alias-focus-ring-color)
)!important}:host([multiline]:not([quiet])) #textfield:after{box-shadow:none}`;const j=["text","url","tel","email","password"];class C extends(S(h)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[L,d]}get type(){var t;return null!==(t=j.find((t=>t===this._type)))&&void 0!==t?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?i`<sp-icon-alert id="invalid" class="icon"></sp-icon-alert>`:this.valid?i`<sp-icon-checkmark100 id="valid" class="icon spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`:r}get displayValue(){return this.value.toString()}get renderMultiline(){return i`${this.grows&&!this.quiet?i`<div id="sizer">${this.value}​</div>`:r} <textarea aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${v(this.invalid||void 0)}" class="input" maxlength="${v(this.maxlength>-1?this.maxlength:void 0)}" minlength="${v(this.minlength>-1?this.minlength:void 0)}" pattern="${v(this.pattern)}" placeholder="${this.placeholder}" .value="${this.displayValue}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${v(this.autocomplete)}"></textarea>`}get renderInput(){return i`<input type="${this.type}" aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${v(this.invalid||void 0)}" class="input" maxlength="${v(this.maxlength>-1?this.maxlength:void 0)}" minlength="${v(this.minlength>-1?this.minlength:void 0)}" pattern="${v(this.pattern)}" placeholder="${this.placeholder}" .value="${B(this.displayValue)}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${v(this.autocomplete)}">`}renderField(){return i`${this.renderStateIcons()} ${this.multiline?this.renderMultiline:this.renderInput}`}render(){return i`<div id="textfield">${this.renderField()}</div>${this.renderHelpText(this.invalid)}`}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t}return t}}l([t({attribute:"allowed-keys"})],C.prototype,"allowedKeys",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"focused",void 0),l([f(".input")],C.prototype,"inputElement",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"invalid",void 0),l([t()],C.prototype,"label",void 0),l([t()],C.prototype,"placeholder",void 0),l([t({attribute:"type",reflect:!0})],C.prototype,"_type",void 0),l([b()],C.prototype,"type",null),l([t()],C.prototype,"pattern",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"grows",void 0),l([t({type:Number})],C.prototype,"maxlength",void 0),l([t({type:Number})],C.prototype,"minlength",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"multiline",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"readonly",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"valid",void 0),l([t({type:String})],C.prototype,"value",null),l([t({type:Boolean,reflect:!0})],C.prototype,"quiet",void 0),l([t({type:Boolean,reflect:!0})],C.prototype,"required",void 0),l([t({type:String,reflect:!0})],C.prototype,"autocomplete",void 0);class F extends C{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}l([t({type:String})],F.prototype,"value",null),customElements.define("sp-clear-button",I);var U=p`:host{--spectrum-search-quiet-button-offset:calc(var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const R=t=>t.stopPropagation();class G extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,U]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return i`<form action="${this.action}" id="form" method="${v(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?i`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${R}"></sp-clear-button>`:i``}</form>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}l([t()],G.prototype,"action",void 0),l([t()],G.prototype,"label",void 0),l([t()],G.prototype,"method",void 0),l([t()],G.prototype,"placeholder",void 0),l([f("#form")],G.prototype,"form",void 0),customElements.define("sp-search",G);export{S as M,C as T,$ as a,_ as b,y as c,F as d,T as m,g as r,z as s,b as t,k as u};
//# sourceMappingURL=059ea907.js.map
