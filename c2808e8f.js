import{I as e,S as t}from"./5452e561.js";import{i as r}from"./67a87733.js";import"./ff67cab2.js";import{S as o}from"./c316f8fa.js";import{T as i,A as c,x as a,e as l,d as s}from"./cd228091.js";import"./dc4d7e95.js";import{c as n,t as d}from"./9015aa90.js";import{l as u,S as p,a as m,i as h}from"./fb482940.js";import"./9cdb9ada.js";import"./6e6d47c3.js";import{e as f,i as v,t as b}from"./16ab2288.js";import{e as x,s as g}from"./7dca79b5.js";const k=f(class extends v{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var w=r`
...
`,y=Object.defineProperty,z=Object.getOwnPropertyDescriptor;const q={s:()=>a`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>a`
        ...
        ></sp-icon-cross300>
    `};class T extends(o(t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,w,e]}get buttonContent(){return[q[this.size]()]}render(){return a`
            <div class="fill">${super.render()}</div>
        `}}((e,t,r,o)=>{for(var i,c=o>1?void 0:o?z(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);o&&c&&y(t,r,c)})([l({reflect:!0})],T.prototype,"variant",2);const $=class{constructor(e,{mode:t}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=e,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=t}get isInternal(){return"internal"===this.mode}render(e){return a`
...
`,C=Object.defineProperty,L=Object.getOwnPropertyDescriptor,j=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?L(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&C(t,r,c),c};const S=["text","url","tel","email","password"];class F extends(E(o(m,{noDefaultSize:!0}))){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.rows=-1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[I,p]}get type(){var e;return null!=(e=S.find((e=>e===this._type)))?e:"text"}set type(e){const t=this._type;this._type=e,this.requestUpdate("type",t)}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,t,r="none"){this.inputElement.setSelectionRange(e,t,r)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const e=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(e,e)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?a`
            ...
            ${this.grows&&!this.quiet&&-1===this.rows?a`
...
`,O=Object.defineProperty,R=Object.getOwnPropertyDescriptor,U=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?R(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&O(t,r,c),c};const A=e=>e.stopPropagation();class G extends H{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,_]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}U([l()],G.prototype,"action",2),U([l()],G.prototype,"label",2),U([l()],G.prototype,"method",2),U([l()],G.prototype,"placeholder",2),U([h("#form")],G.prototype,"form",2),s("sp-search",G);export{E as M,F as T,H as a};
//# sourceMappingURL=c2808e8f.js.map
