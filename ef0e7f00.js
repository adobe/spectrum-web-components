import{d as t,E as e,N as i,B as o,P as r,A as a,h as s,n,_ as c,p as l,q as d,i as u}from"./6c9c59d8.js";import{a as p,c as m,i as h}from"./764d2e55.js";import"./3bedb457.js";import{c as v}from"./406723e1.js";import"./2484387d.js";import"./f4f0015b.js";const x=t((t=>s=>{let n;if(s instanceof e||s instanceof i)throw new Error("The `live` directive is not allowed on text or event bindings");if(s instanceof o)f(s.strings),n=s.element.hasAttribute(s.name),s.value=n;else{const{element:e,name:i,strings:o}=s.committer;if(f(o),s instanceof r){if(n=e[i],n===t)return}else s instanceof a&&(n=e.getAttribute(i));if(n===String(t))return}s.setValue(t)})),f=t=>{if(2!==t.length||""!==t[0]||""!==t[1])throw new Error("`live` bindings can only contain a single expression")};var b=v`:host{--spectrum-textfield-texticon-padding-left:var(
...
//# sourceMappingURL=ef0e7f00.js.map
