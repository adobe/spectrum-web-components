import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.fxAipLbG.js";import"./swc.Sl1-fAws.js";import"./swc.BQQCwNjp.js";import"./swc.X7HAG0wN.js";import{i as s}from"./swc.yLUsv-6A.js";import{S as i,x as n,B as a}from"./swc.BmV4RgD7.js";import{o as r}from"./swc.DpTu5qdu.js";import{n as l}from"./swc.DOoBlTr0.js";const p=s`
...
`;var c=Object.defineProperty,h=(t,e,o,s)=>{for(var i,n=void 0,a=t.length-1;a>=0;a--)(i=t[a])&&(n=i(e,o,n)||n);return n&&c(e,o,n),n};const d="Help",m="Information",u=class s extends i{constructor(){super(),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1;const t=s.instanceCount++;this.popoverId=`contextual-help-popover-${t}`,this.contentId=`contextual-help-content-${t}`}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?d:m}renderOverlayContent(){return this.isMobile.matches?(import("./swc.Cjb8U3vV.js").then(function(t){return t.s}),import("./swc.mEpS84Zk.js").then(function(t){return t.s}),n`
      ...
      `):(import("./swc.tGwGl_Xo.js").then(function(t){return t.s}),n`
        <sp-popover
          class="popover"
          id=${this.popoverId}
          role="region"
