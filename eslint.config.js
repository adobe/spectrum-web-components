...
export default defineConfig([
  // Global ignores
  {
    ignores: [
      ...
      '**/*.d.ts',
      'gen1/packages/icons/src/icons-*.svg.ts',
      // Build outputs
      'gen1/packages/**/!(src)/**/*.js',
      'gen1/tools/**/!(src)/**/*.js',
      'gen1/projects/**/!(src)/**/*.js',
      'gen1/test/*.js',
      'gen1/test/plugins/*.js',
      'gen1/test/visual/*.js',
      '2nd-gen/packages/**/dist/**',
      // Icons
      'gen1/packages/icons/**',
      'gen1/packages/iconset/**',
      'gen1/packages/icons-ui/**',
      'gen1/packages/icons-workflow/**',
      // Generated files
      '**/*.css.ts',
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    files: [
      ...
      'gen1/test/visual/**/*.js',
      'gen1/test/plugins/**/*.js',
      'gen1/test/testing-helpers.js',
      'gen1/test/benchmark/cli.ts',
      'gen1/web-test-runner*.js',
      'gen1/storybook/**/*.js',
      'CONTRIBUTOR-DOCS/**/*.js',
      '2nd-gen/packages/tools/**/*.ts',
      '2nd-gen/packages/tools/**/*.js',
      'gen1/packages/icons-workflow/bin/**/*.js',
      'gen1/packages/icons-ui/bin/**/*.js',
    ],
    languageOptions: {
