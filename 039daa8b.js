...
`,K=Object.defineProperty,G=Object.getOwnPropertyDescriptor,Q=(e,t,r,o)=>{for(var s,c=o>1?void 0:o?G(t,r):t,i=e.length-1;i>=0;i--)(s=e[i])&&(c=(o?s(t,r,c):s(c))||c);return o&&c&&K(t,r,c),c};const J={s:l`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:l`
        ...
        ></sp-icon-dash300>
    `};class Y extends(p(q)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[F,s,W]}handleChange(){this.indeterminate=!1,super.handleChange()}render(){return l`
            ${super.render()}
            <span id="box">
                ${J[this.size]}
                ${X[this.size]}
        ...
        `}updated(e){super.updated(e),e.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),e.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate)}}Q([n({type:Boolean,reflect:!0})],Y.prototype,"indeterminate",2),Q([n({type:Boolean,reflect:!0})],Y.prototype,"invalid",2),Q([n({type:Boolean,reflect:!0})],Y.prototype,"emphasized",2),h("sp-checkbox",Y);var Z=e`
...
//# sourceMappingURL=039daa8b.js.map
