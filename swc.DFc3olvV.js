import{t,s as e}from"./swc.Chuw36y7.js";import{I as l}from"./swc.CdEeIaOZ.js";import{x as r}from"./swc.DRY409cl.js";import{d as i}from"./swc.JlveB6nj.js";const s=({width:e=24,height:l=24,hidden:r=!1,title:i="Alert"}={})=>t`<svg
  ...
  >
    ...
    />
  </svg>`,a=({width:e=24,height:l=24,hidden:r=!1,title:i="Alert Triangle"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${l}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;i("sp-icon-alert",class extends l{render(){return e(r),1===this.spectrumVersion?s({hidden:!this.label,title:this.label}):a({hidden:!this.label,title:this.label})}});export{a as A,s as a};
