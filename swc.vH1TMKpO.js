import{t as e,s as l}from"./swc.Chuw36y7.js";import{I as i}from"./swc.Bea_DqvJ.js";import{x as t}from"./swc.DWYvVEd1.js";import{d as h}from"./swc.JlveB6nj.js";h("sp-icon-folder-open",class extends i{render(){return l(t),2===this.spectrumVersion?(({width:l=24,height:i=24,hidden:t=!1,title:h="Folder Open"}={})=>e`<svg
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:l=24,height:i=24,hidden:t=!1,title:h="Folder Open"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${i}"
    viewBox="0 0 36 36"
    width="${l}"
...
//# sourceMappingURL=swc.tyiMbalt.js.map
