import{r as t}from"./e50c5e8d.js";import{S as e,$ as i,e as o}from"./03cd2f8f.js";import{F as s,O as a,b as r,S as c,a as l,l as n,i as d,L as m}from"./5a184a55.js";import{R as b}from"./464e15ff.js";import"./63e809bc.js";import"./f447cac7.js";import"./fa806c4a.js";import"./77d4c924.js";import{Overlay as u}from"./93526eee.js";import"./79272576.js";document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:i}=e,{pathname:o}=location,s=o.search("api")>-1;switch(i){case"api":{if(s)return;const t=(o+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!s)return;const t=o.split("/api")[0]+"/";history.pushState({},document.title,t);break}}}));var p=t`
...
`,D=Object.defineProperty,F=Object.getOwnPropertyDescriptor,X=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?F(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&D(e,i,a),a};class _ extends(m(l)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[f,R]}handleContentChange(){this.dispatchEvent(new Event("sp-top-nav-item-contentchange",{bubbles:!0,composed:!0}))}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return i`
            <a
                id="item-label"
                href=${n(this.href)}
