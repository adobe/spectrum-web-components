...
)}`;const z=(t,o,e)=>{const r=[],i=[];for(let a=0;a<t.length;++a){const c=t[a];e&&i.push(e(c)||(()=>{}));const n=document.createComment("placeholder for reparented element");r.push(n);const s=c.parentElement||c.getRootNode();s&&s!==c&&s.replaceChild(n,c),o.append(c)}return function(){return function(t,o,e=[]){for(let r=0;r<o.length;++r){const i=o[r],a=t[r],c=a.parentElement||a.getRootNode();e[r]&&e[r](i),c&&c!==a&&c.replaceChild(i,a),delete t[r]}return o}(r,t,i)}},I=async(t,o,e,r)=>{const{Overlay:i}=await import("./b1244d84.js");return i.open(t,o,e,r)};var q=s`.checkmark{align-self:flex-start;display:none;opacity:1;transform:scale(1)}:host([dir=ltr]) .checkmark{padding-left:var(
...
)}.icon{margin:0}`;const X={s:()=>e`<sp-icon-cross75 slot="icon" class="icon spectrum-UIIcon-Cross75"></sp-icon-cross75>`,m:()=>e`<sp-icon-cross100 slot="icon" class="icon spectrum-UIIcon-Cross100"></sp-icon-cross100>`,l:()=>e`<sp-icon-cross200 slot="icon" class="icon spectrum-UIIcon-Cross200"></sp-icon-cross200>`,xl:()=>e`<sp-icon-cross300 slot="icon" class="icon spectrum-UIIcon-Cross300"></sp-icon-cross300>`};class J extends(h(g)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,Q,f]}get buttonContent(){return[X[this.size]()]}}r([i({reflect:!0})],J.prototype,"variant",void 0);var Z=s`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
);justify-content:center;line-height:var(
--spectrum-alias-component-text-line-height,var(--spectrum-global-font-line-height-small)
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;const ot={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let et;class rt extends(h(x)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[Z,tt]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),et=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(et),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(e`<sp-icon-corner-triangle300 class="hold-affordance ${ot[this.size]}"></sp-icon-corner-triangle300>`),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}r([i({type:Boolean,reflect:!0})],rt.prototype,"emphasized",void 0),r([i({type:Boolean,reflect:!0,attribute:"hold-affordance"})],rt.prototype,"holdAffordance",void 0),r([i({type:Boolean,reflect:!0})],rt.prototype,"quiet",void 0),r([i({reflect:!0})],rt.prototype,"role",void 0),r([i({type:Boolean,reflect:!0})],rt.prototype,"selected",void 0),r([i({type:Boolean,reflect:!0})],rt.prototype,"toggles",void 0),r([i({reflect:!0})],rt.prototype,"variant",void 0),r([i({type:String})],rt.prototype,"value",null),customElements.define("sp-action-button",rt),customElements.define("sp-menu-item",U);var it=s`:host([size=s]){--spectrum-link-primary-text-size:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class nt extends(h(a,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return e``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}nt.styles=[ct],r([i({type:Boolean,reflect:!0})],nt.prototype,"vertical",void 0),customElements.define("sp-divider",nt),customElements.define("sp-close-button",J);var st=s`:host{--spectrum-toast-icon-padding-y:var(
--spectrum-global-dimension-size-85
