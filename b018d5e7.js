...
)}`;class Ht extends e{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[Mt]}render(){return r`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}o([s({reflect:!0,type:String})],Ht.prototype,"type",void 0),o([s({reflect:!0,type:Boolean})],Ht.prototype,"corner",void 0),customElements.define("sp-banner",Ht);var Pt=u`:host{--spectrum-buttongroup-button-gap-reset:0}:host{display:flex}::slotted(*){flex-shrink:0}:host([dir=ltr]) ::slotted(:not(:first-of-type)){margin-left:var(
...
//# sourceMappingURL=b018d5e7.js.map
