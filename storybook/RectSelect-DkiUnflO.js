...
const AnchorSelectIcon=({width:e=24,height:t=24,hidden:a=!1,title:l="Anchor Select"}={})=>tag`<svg
...
const PolygonSelectIcon=({width:a=24,height:e=24,hidden:l=!1,title:t="Polygon Select"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${a}"
...
const RectSelectIcon=({width:e=24,height:h=24,hidden:t=!1,title:v="Rect Select"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${h}"
    viewBox="0 0 36 36"
    width="${e}"
...
export { AnchorSelectIcon as A, PolygonSelectIcon as P, RectSelectIcon as R };
