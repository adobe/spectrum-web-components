...
var a=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var t=(l,r,i,o)=>{for(var e=o>1?void 0:o?p(r,i):r,n=l.length-1,c;n>=0;n--)(c=l[n])&&(e=(o?c(r,i,e):c(e))||e);return o&&e&&a(r,i,e),e};class Link extends LikeAnchor(Focusable){constructor(){super(...arguments);this.quiet=!1;}static get styles(){return [f]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}t([i$1("#anchor")],Link.prototype,"anchorElement",2),t([n({type:String,reflect:!0})],Link.prototype,"variant",2),t([n({type:String,reflect:!0})],Link.prototype,"static",2),t([n({type:Boolean,reflect:!0,attribute:"quiet"})],Link.prototype,"quiet",2);
