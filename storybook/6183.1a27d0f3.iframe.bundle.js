"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[6183],{"./packages/icon/src/spectrum-icon-dash.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const c=__webpack_require__("./tools/base/src/index.dev.js").AH`
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const dashIcon={xs:()=>index_dev.qy`
  ...
  `,l:()=>index_dev.qy`
    ...
    ></sp-icon-dash300>
  `};class Swatch extends((0,index_dev.ZG)(focusable_dev.z,{validSizes:["xs","s","m","l"],noDefaultSize:!0})){constructor(){super(...arguments),this.color="",this.label="",this.mixedValue=!1,this.nothing=!1,this.role="button",this.selected=!1,this.renderDisabled=()=>index_dev.qy`
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="disabledIcon"
        viewBox="0 0 20 20"
    ...
    `,this.renderMixedValue=()=>dashIcon[this.size]()}static get styles(){return[opacity_checkerboard_css.A,swatch_css,spectrum_icon_dash_css.A]}get value(){return this._value||this.color||this.label}set value(value){if(value===this._value)return;const oldValue=this.value;this._value=value,this.requestUpdate("value",oldValue)}get focusElement(){return this}toggle(force){this.selected=null!=force?force:!this.selected}handleClick(){if(this.disabled||this.mixedValue)return;this.toggle();this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0}))||this.toggle()}handleKeydown(event){const{code:code}=event;if("Space"===code)event.preventDefault(),this.addEventListener("keyup",this.handleKeyup)}handleKeypress(event){const{code:code}=event;switch(code){case"Enter":case"NumpadEnter":this.click()}}handleKeyup(event){const{code:code}=event;if("Space"===code)this.removeEventListener("keyup",this.handleKeyup),this.click()}render(){return index_dev.qy`
      <div
        class="opacity-checkerboard fill"
        style=${(0,directives_dev.JR)(this.color?`--spectrum-picked-color: ${this.color}`:void 0)}
      >
        <slot name="image"></slot>
        ${(0,directives_dev.z7)(this.disabled,this.renderDisabled)}
        ${(0,directives_dev.z7)(this.mixedValue,this.renderMixedValue)}
      </div>
    `}willUpdate(changes){var _a;if(this.getAttribute("role")||this.setAttribute("role","button"),changes.has("selected")||changes.has("role")){const selectedAttribute="button"===this.role?"aria-pressed":"aria-checked",removedSelectedAttribute="button"===this.role?"aria-checked":"aria-pressed";changes.has("role")&&this.removeAttribute(removedSelectedAttribute),this.setAttribute(selectedAttribute,this.selected?"true":"false")}(changes.has("label")||changes.has("color")||changes.has("mixedValue"))&&(this.label!==this.color&&(null==(_a=this.label)?void 0:_a.length)?this.setAttribute("aria-label",this.label):this.color?this.setAttribute("aria-label",this.color):this.mixedValue?this.setAttribute("aria-label","Mixed"):this.removeAttribute("aria-label"))}firstUpdated(changes){super.firstUpdated(changes),this.addEventListener("click",this.handleClick),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0")}}__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],Swatch.prototype,"border",2),__decorateClass([(0,decorators_dev.MZ)()],Swatch.prototype,"color",2),__decorateClass([(0,decorators_dev.MZ)()],Swatch.prototype,"label",2),__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0,attribute:"mixed-value"})],Swatch.prototype,"mixedValue",2),__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],Swatch.prototype,"nothing",2),__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],Swatch.prototype,"role",2),__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],Swatch.prototype,"rounding",2),__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],Swatch.prototype,"selected",2),__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],Swatch.prototype,"shape",2),__decorateClass([(0,decorators_dev.MZ)()],Swatch.prototype,"value",1),(0,define_element_dev.e)("sp-swatch",Swatch)},"./tools/opacity-checkerboard/src/opacity-checkerboard.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const c=__webpack_require__("./tools/base/src/index.dev.js").AH`
...
//# sourceMappingURL=6183.1a27d0f3.iframe.bundle.js.map