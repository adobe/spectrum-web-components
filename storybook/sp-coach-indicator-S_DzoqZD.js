...
var d=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var a=(s,r,e,i)=>{for(var t=i>1?void 0:i?u(r,e):r,l=s.length-1,o;l>=0;l--)(o=s[l])&&(t=(i?o(r,e,t):o(t))||t);return i&&t&&d(r,e,t),t};class CoachIndicator extends SpectrumElement{constructor(){super(...arguments);this.quiet=!1;}static get styles(){return [v]}render(){return x`
            <div class="ring"></div>
            <div class="ring"></div>
            <div class="ring"></div>
        `}updated(e){super.updated(e),e.has("variant")&&(this.variant||typeof e.get("variant"))&&(this.static=this.variant);}}a([n({type:Boolean,reflect:!0})],CoachIndicator.prototype,"quiet",2),a([n({reflect:!0})],CoachIndicator.prototype,"static",2),a([n({reflect:!0})],CoachIndicator.prototype,"variant",2);
