"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[6130],{"./packages/button/sp-button.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _src_Button_dev_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./packages/button/src/Button.dev.js");(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-button",_src_Button_dev_js__WEBPACK_IMPORTED_MODULE_0__.$n)},"./packages/button/sp-close-button.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _src_CloseButton_dev_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./packages/button/src/CloseButton.dev.js");(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-close-button",_src_CloseButton_dev_js__WEBPACK_IMPORTED_MODULE_0__.J)},"./packages/icons-workflow/icons/sp-icon-checkmark-circle.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),src_index_dev=__webpack_require__("./packages/icon/src/index.dev.js"),custom_tag=__webpack_require__("./packages/icons-workflow/src/custom-tag.js");var CheckmarkCircle=__webpack_require__("./packages/icons-workflow/src/icons/CheckmarkCircle.js");class IconCheckmarkCircle extends src_index_dev.z{render(){return(0,custom_tag.L)(index_dev.qy),2===this.spectrumVersion?(({width:e=24,height:l=24,hidden:r=!1,title:t="Checkmark Circle"}={})=>custom_tag.T`<svg
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const toastVariants=["negative","positive","info","error","warning"];class Toast extends((0,focus_visible_dev.p)(index_dev.wG)){constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=time=>{this.countdownStart||(this.countdownStart=performance.now()),time-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[toast_css]}set timeout(timeout){const newTimeout=null!==typeof timeout&&timeout>0?Math.max(6e3,timeout):null,oldValue=this.timeout;newTimeout&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=newTimeout,this.requestUpdate("timeout",oldValue)}get timeout(){return this._timeout}set variant(variant){if(variant===this.variant)return;const oldValue=this.variant;toastVariants.includes(variant)?(this.setAttribute("variant",variant),this._variant=variant):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",oldValue)}get variant(){return this._variant}renderIcon(variant,iconLabel){switch(variant){case"info":return index_dev.qy`
        ...
        `}updated(changes){super.updated(changes),changes.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),changes.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],Toast.prototype,"open",2),__decorateClass([(0,decorators_dev.MZ)({type:Number})],Toast.prototype,"timeout",1),__decorateClass([(0,decorators_dev.MZ)({type:String})],Toast.prototype,"variant",1),__decorateClass([(0,decorators_dev.MZ)({type:String,attribute:"icon-label"})],Toast.prototype,"iconLabel",2),(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-toast",Toast);__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/overlay/sp-overlay.dev.js"),__webpack_require__("./packages/overlay/overlay-trigger.dev.js");var directives_dev=__webpack_require__("./tools/base/src/directives.dev.js");const toast=({variant:variant="",open:open=!0,content:content="",timeout:timeout=0,iconLabel:iconLabel=""})=>index_dev.qy`
    <sp-toast
        variant=${variant}
        ?open=${open}
        ...
        ${[["bottom",""],["left","negative"],["right","positive"],["top","info"]].map(([placement,variant])=>index_dev.qy`
                ...
                >
                    <sp-button label="${placement} test" slot="trigger">
                        Click for ${variant||"toast"} on the
                        ${placement}
                    </sp-button>
...
//# sourceMappingURL=toast-stories-toast-stories.d808139d.iframe.bundle.js.map