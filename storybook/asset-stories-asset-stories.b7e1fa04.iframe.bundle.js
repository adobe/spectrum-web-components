...
`;(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-asset",class Asset extends i{static get styles(){return[asset_css]}render(){return"file"===this.variant?(label=this.label,index_dev.qy`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
//# sourceMappingURL=asset-stories-asset-stories.b7e1fa04.iframe.bundle.js.map