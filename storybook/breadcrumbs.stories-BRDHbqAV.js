...
import { e as e$3, c } from './icon-chevron-overrides.css-Bz8Nk10Z.js';
...
import { n as n$1, S as SpectrumElement } from './define-element-BcIuQqj7.js';
...
import { e as e$4 } from './query-DQF6X5qW.js';
...
var u=Object.defineProperty;var a=(s,i,e,r)=>{for(var t=void 0,o=s.length-1,l;o>=0;o--)(l=s[o])&&(t=(l(i,e,t))||t);return t&&u(i,e,t),t};class BreadcrumbItem extends LikeAnchor(Focusable){constructor(){super(...arguments);this.value=void 0;this.isLastOfType=!1;}static get styles(){return [e,e$3,c]}get focusElement(){return this.shadowRoot.querySelector("#item-link")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","listitem");}announceSelected(e){const r={value:e},t=new CustomEvent("breadcrumb-select",{bubbles:!0,composed:!0,detail:r});this.dispatchEvent(t);}handleClick(e){!this.href&&e&&e.preventDefault(),(!this.href||e!=null&&e.defaultPrevented)&&this.value&&!this.isLastOfType&&this.announceSelected(this.value);}handleKeyDown(e){(e.key==="Enter"||e.keyCode===13)&&this.handleClick(e);}renderLink(){return x`
            <a
                id="item-link"
