...
import { n as n$1 } from './define-element-C4UuMSqY.js';

const o=i`
    :host{position:relative}
`;

var u=Object.defineProperty;var n=(o,l,r,t)=>{for(var e=void 0,i=o.length-1,s;i>=0;i--)(s=o[i])&&(e=(s(l,r,e))||e);return e&&u(l,r,e),e};class ColorField extends TextfieldBase{constructor(){super();this.viewColor=!1;this._value="";this.colorController=new ColorController(this);}static get styles(){return [...super.styles,o]}set value(r){if(r===this.value)return;const t=this._value;this._value=r,this.requestUpdate("value",t);}get value(){return this._value}renderColorHandle(){return this.viewColor&&this.valid?x`
                  <sp-color-handle
                      size="m"
                      color="${this.colorController.getColor("srgb").toString()}"
                  ></sp-color-handle>
              `:x``}getColorValue(){return this.valid?this.colorController.getColor("srgb").toString():""}render(){return this.viewColor&&import('./sp-color-handle-D8bHCOGy.js'),x`
