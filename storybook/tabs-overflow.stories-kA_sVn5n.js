import { r as renderTabsOverflowExample } from './index-oBhMQc3P.js';
import './sp-tab-panel-0BMxBVTM.js';
...
const __namedExportsOrder = ['compact', 'autoscroll'];

export { __namedExportsOrder, autoscroll, compact, tabsOverflow_stories as default };
