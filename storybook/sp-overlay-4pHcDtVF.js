import { n as n$1, d as defineElement } from './define-element-UHExAFdK.js';
import { b as isIOS, a as isAndroid } from './platform-c1C9ET3y.js';
import { E as ElementResolutionController, e as elementResolverUpdatedSymbol } from './ElementResolution-TTOqkMM7.js';
...
import { g as guaranteedAllTransitionend, B as BeforetoggleOpenEvent, a as BeforetoggleClosedEvent, O as OverlayStateEvent, V as VirtualTrigger, o as overlayTimer, n as nextFrame, f as forcePaint, b as noop, A as AbstractOverlay } from './VirtualTrigger-Sqzey4Y2.js';
import { f as firstFocusableIn, a as firstFocusableSlottedIn } from './first-focusable-in-LZ7hcu4z.js';
import { u as userFocusableSelector } from './focusable-selectors-VCrFWGqo.js';
import { i } from './lit-element-xBOPiTek.js';
import { l } from './sizedMixin-6sBuja8e.js';
...
function OverlayDialog(c){class h extends c{async manageDialogOpen(){const e=this.open;if(await this.managePosition(),this.open!==e)return;const i=await this.dialogMakeTransition(e);this.open===e&&await this.dialogApplyFocus(e,i);}async dialogMakeTransition(e){let i=null;const p=(t,o)=>async()=>{if(t.open=e,!e){const n=()=>{t.removeEventListener("close",n);};t.addEventListener("close",n);}if(o>0)return;const s=e?BeforetoggleOpenEvent:BeforetoggleClosedEvent;this.dispatchEvent(new s),e&&(t.matches(userFocusableSelector)&&(i=t),i=i||firstFocusableIn(t),i||t.querySelectorAll("slot").forEach(r=>{i||(i=firstFocusableSlottedIn(r));}),!(!this.isConnected||this.dialogEl.open)&&this.dialogEl.showModal());},a=(t,o)=>()=>{if(this.open!==e)return;const s=e?"sp-opened":"sp-closed";if(o>0){t.dispatchEvent(new OverlayStateEvent(s,this,{interaction:this.type,publish:!1}));return}if(!this.isConnected||e!==this.open)return;const n=()=>{const r=this.triggerElement instanceof VirtualTrigger;this.dispatchEvent(new OverlayStateEvent(s,this,{interaction:this.type,publish:r})),t.dispatchEvent(new OverlayStateEvent(s,this,{interaction:this.type,publish:!1})),this.triggerElement&&!r&&this.triggerElement.dispatchEvent(new OverlayStateEvent(s,this,{interaction:this.type,publish:!0})),this.state=e?"opened":"closed";};!e&&this.dialogEl.open?(this.dialogEl.addEventListener("close",()=>{n();},{once:!0}),this.dialogEl.close()):n();};return this.elements.forEach((t,o)=>{guaranteedAllTransitionend(t,p(t,o),a(t,o));}),i}async dialogApplyFocus(e,i){this.applyFocus(e,i);}}return h}

function v(l){let a=!1;try{a=l.matches(":popover-open");}catch(e){}let h=!1;try{h=l.matches(":open");}catch(e){}return a||h}function OverlayPopover(l){class a extends l{async manageDelay(e){if(e===!1||e!==this.open){overlayTimer.close(this);return}this.delayed&&await overlayTimer.openTimer(this)&&(this.open=!e);}async shouldHidePopover(e){if(e&&this.open!==e)return;const o=async({newState:i}={})=>{i!=="open"&&await this.placementController.resetOverlayPosition();};if(!v(this.dialogEl)){o();return}this.dialogEl.addEventListener("toggle",o,{once:!0});}async shouldShowPopover(e){let o=!1;try{o=this.dialogEl.matches(":popover-open");}catch(p){}let i=!1;try{i=this.dialogEl.matches(":open");}catch(p){}e&&this.open===e&&!o&&!i&&this.isConnected&&(this.dialogEl.showPopover(),await this.managePosition());}async ensureOnDOM(e){await nextFrame(),await this.shouldHidePopover(e),await this.shouldShowPopover(e),await nextFrame();}async makeTransition(e){if(this.open!==e)return null;let o=null;const i=(t,r)=>()=>{if(t.open=e,r===0){const s=e?BeforetoggleOpenEvent:BeforetoggleClosedEvent;this.dispatchEvent(new s);}if(!e||(t.matches(userFocusableSelector)&&(o=t),o=o||firstFocusableIn(t),o))return;t.querySelectorAll("slot").forEach(s=>{o||(o=firstFocusableSlottedIn(s));});},p=(t,r)=>async()=>{if(this.open!==e)return;const n=e?"sp-opened":"sp-closed";if(r>0){t.dispatchEvent(new OverlayStateEvent(n,this,{interaction:this.type,publish:!1}));return}const s=async()=>{if(this.open!==e)return;await nextFrame();const m=this.triggerElement instanceof VirtualTrigger;this.dispatchEvent(new OverlayStateEvent(n,this,{interaction:this.type,publish:m})),t.dispatchEvent(new OverlayStateEvent(n,this,{interaction:this.type,publish:!1})),this.triggerElement&&!m&&this.triggerElement.dispatchEvent(new OverlayStateEvent(n,this,{interaction:this.type,publish:!0})),this.state=e?"opened":"closed";};if(this.open!==e)return;const f=v(this.dialogEl);e!==!0&&f&&this.isConnected?(this.dialogEl.addEventListener("beforetoggle",()=>{s();},{once:!0}),this.dialogEl.hidePopover()):s();};return this.elements.forEach((t,r)=>{guaranteedAllTransitionend(t,i(t,r),p(t,r));}),o}}return a}

function OverlayNoPopover(c){class a extends c{async managePopoverOpen(){await this.managePosition();}async manageDelay(e){if(e===!1||e!==this.open){overlayTimer.close(this);return}this.delayed&&await overlayTimer.openTimer(this)&&(this.open=!e);}async ensureOnDOM(e){forcePaint();}async makeTransition(e){if(this.open!==e)return null;let o=null;const m=(t,r)=>()=>{if(e!==this.open)return;if(t.open=e,r===0){const n=e?BeforetoggleOpenEvent:BeforetoggleClosedEvent;this.dispatchEvent(new n);}if(e!==!0||(t.matches(userFocusableSelector)&&(o=t),o=o||firstFocusableIn(t),o))return;t.querySelectorAll("slot").forEach(n=>{o||(o=firstFocusableSlottedIn(n));});},p=(t,r)=>()=>{if(this.open!==e)return;const i=e?"sp-opened":"sp-closed";if(t.dispatchEvent(new OverlayStateEvent(i,this,{interaction:this.type})),r>0)return;const n=this.triggerElement instanceof VirtualTrigger;this.dispatchEvent(new OverlayStateEvent(i,this,{interaction:this.type,publish:n})),this.triggerElement&&!n&&this.triggerElement.dispatchEvent(new OverlayStateEvent(i,this,{interaction:this.type,publish:!0})),this.state=e?"opened":"closed";};return this.elements.forEach((t,r)=>{guaranteedAllTransitionend(t,m(t,r),p(t,r));}),o}}return a}

const h="showPopover"in document.createElement("div");let c$2 = class c{constructor(){this.root=document.body;this.stack=[];this.handlePointerdown=t=>{this.pointerdownPath=t.composedPath(),this.lastOverlay=this.stack.at(-1);};this.handlePointerup=()=>{var r;if(!this.stack.length||!((r=this.pointerdownPath)!=null&&r.length))return;const t=this.pointerdownPath;this.pointerdownPath=void 0;const e=this.stack.length-1,i=this.stack.filter((n,s)=>!t.find(o=>o===n||o===(n==null?void 0:n.triggerElement)&&(n==null?void 0:n.type)==="hint"||s===e&&n!==this.lastOverlay&&n.triggerInteraction==="longpress")&&!n.shouldPreventClose()&&n.type!=="manual");i.reverse(),i.forEach(n=>{this.closeOverlay(n);let s=n.parentOverlayToForceClose;for(;s;)this.closeOverlay(s),s=s.parentOverlayToForceClose;});};this.handleBeforetoggle=t=>{const{target:e,newState:i}=t;i!=="open"&&this.closeOverlay(e);};this.handleKeydown=t=>{if(t.code!=="Escape"||!this.stack.length)return;const e=this.stack.at(-1);if((e==null?void 0:e.type)==="page"){t.preventDefault();return}h||e&&this.closeOverlay(e);};this.bindEvents();}get document(){return this.root.ownerDocument||document}bindEvents(){this.document.addEventListener("pointerdown",this.handlePointerdown),this.document.addEventListener("pointerup",this.handlePointerup),this.document.addEventListener("keydown",this.handleKeydown);}closeOverlay(t){const e=this.stack.indexOf(t);e>-1&&this.stack.splice(e,1),t.open=!1;}overlaysByTriggerElement(t){return this.stack.filter(e=>e.triggerElement===t)}add(t){if(this.stack.includes(t)){const e=this.stack.indexOf(t);e>-1&&(this.stack.splice(e,1),this.stack.push(t));return}if(t.type==="auto"||t.type==="modal"||t.type==="page"){const e="sp-overlay-query-path",i=new Event(e,{composed:!0,bubbles:!0});t.addEventListener(e,r=>{const n=r.composedPath();this.stack.forEach(s=>{!n.find(o=>o===s)&&s.type!=="manual"&&this.closeOverlay(s);});},{once:!0}),t.dispatchEvent(i);}else t.type==="hint"&&this.stack.forEach(e=>{e.type==="hint"&&this.closeOverlay(e);});requestAnimationFrame(()=>{this.stack.push(t),t.addEventListener("beforetoggle",this.handleBeforetoggle,{once:!0});});}remove(t){this.closeOverlay(t);}};const overlayStack=new c$2;
