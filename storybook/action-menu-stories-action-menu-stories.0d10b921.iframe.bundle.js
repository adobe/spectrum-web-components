...
`;groups.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_12__.Z];const groupsWithSelects=({onChange:onChange})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
        <sp-action-menu
            @change=${({target:{value:value}})=>onChange(value)}
...
//# sourceMappingURL=action-menu-stories-action-menu-stories.0d10b921.iframe.bundle.js.map