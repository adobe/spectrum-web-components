"use strict";(self.webpackChunk_adobe_spectrum_web_components=self.webpackChunk_adobe_spectrum_web_components||[]).push([[6098],{"./packages/badge/stories/badge.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:function(){return Default},Fixed:function(){return Fixed},Icons:function(){return Icons},Inline:function(){return Inline},NonSemantic:function(){return NonSemantic},Semantic:function(){return Semantic},Sizes:function(){return Sizes},__namedExportsOrder:function(){return __namedExportsOrder},default:function(){return badge_stories}});var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js"),observe_slot_text_dev=__webpack_require__("./tools/shared/src/observe-slot-text.dev.js"),observe_slot_presence_dev=__webpack_require__("./tools/shared/src/observe-slot-presence.dev.js");var badge_css=index_dev.AH`
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const BADGE_VARIANTS=["accent","neutral","informative","positive","negative","notice","fuchsia","indigo","magenta","purple","seafoam","yellow","gray","red","orange","chartreuse","celery","green","cyan","blue"];class Badge extends((0,index_dev.ZG)((0,observe_slot_text_dev.O)((0,observe_slot_presence_dev.e)(index_dev.wG,'[slot="icon"]'),""),{noDefaultSize:!0})){constructor(){super(...arguments),this.variant="informative"}static get styles(){return[badge_css]}get fixed(){return this._fixed}set fixed(fixed){if(fixed===this.fixed)return;const oldValue=this.fixed;this._fixed=fixed,fixed?this.setAttribute("fixed",fixed):this.removeAttribute("fixed"),this.requestUpdate("fixed",oldValue)}get hasIcon(){return this.slotContentIsPresent}render(){return BADGE_VARIANTS.includes(this.variant)||window.__swc.warn(this,`<${this.localName}> element expect the "variant" attribute to be one of the following:`,"https://opensource.adobe.com/spectrum-web-components/components/badge/#variants",{issues:[...BADGE_VARIANTS]}),index_dev.qy`
        ...
        `}}__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],Badge.prototype,"fixed",1),__decorateClass([(0,decorators_dev.MZ)({type:String,reflect:!0})],Badge.prototype,"variant",2),(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-badge",Badge);__webpack_require__("./packages/icons-workflow/icons/sp-icon-checkmark-circle.js");var badge_stories={title:"Badge",component:"sp-badge"};const Default=()=>index_dev.qy`
...
//# sourceMappingURL=badge-stories-badge-stories.f67cd284.iframe.bundle.js.map