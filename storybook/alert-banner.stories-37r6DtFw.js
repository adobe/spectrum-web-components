...
import { S as SpectrumElement, n, d as defineElement } from './define-element-BcIuQqj7.js';
...
var c=Object.defineProperty;var d=Object.getOwnPropertyDescriptor;var o=(a,r,e,s)=>{for(var t=s>1?void 0:s?d(r,e):r,n=a.length-1,l;n>=0;n--)(l=a[n])&&(t=(s?l(r,e,t):l(t))||t);return s&&t&&c(r,e,t),t};const v=["neutral","info","negative"];class AlertBanner extends SpectrumElement{constructor(){super(...arguments);this.open=!1;this.dismissible=!1;this._variant="";}static get styles(){return [r]}set variant(e){if(e===this.variant)return;const s=this.variant;this.isValidVariant(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",s);}get variant(){return this._variant}isValidVariant(e){return v.includes(e)}renderIcon(e){switch(e){case"info":return x`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
                ...
                `;default:return x``}}shouldClose(){this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))&&this.close();}close(){this.open=!1;}handleKeydown(e){e.code==="Escape"&&this.dismissible&&this.shouldClose();}render(){return x`
        ...
        `}updated(e){super.updated(e),e.has("open")&&(this.open?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown));}}o([n({type:Boolean,reflect:!0})],AlertBanner.prototype,"open",2),o([n({type:Boolean,reflect:!0})],AlertBanner.prototype,"dismissible",2),o([n({type:String})],AlertBanner.prototype,"variant",1);
...
const Default = (args) => AlertBannerMarkup(args);
const Info = (args) => AlertBannerMarkup({
  ...args,
  variant: "info",
  text: "Your trial will expire in 3 days"
});
const Negative = (args) => AlertBannerMarkup({
  ...args,
  variant: "negative",
  text: "Connection interrupted. Check your network to continue"
});
const TextWrapping = (args) => x`
...
`;
const __namedExportsOrder = ['Default', 'Info', 'Negative', 'TextWrapping', 'Multilanguage'];

export { Default, Info, Multilanguage, Negative, TextWrapping, __namedExportsOrder, alertBanner_stories as default };
