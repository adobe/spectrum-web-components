import { C as CheckboxBase } from './CheckboxBase-694e006f.js';
import './sp-icon-checkmark300-36db3994.js';
import { E } from './spectrum-icon-checkmark.css-c19acd0f.js';
import './sp-icon-dash300-58f80cc7.js';
import { i as i$1 } from './lit-element-9354aa77.js';
import { f as f$1 } from './spectrum-icon-dash.css-7fdeaf11.js';
...
var l=Object.defineProperty;var n=Object.getOwnPropertyDescriptor;var i=(a,s,t,c)=>{for(var r=c>1?void 0:c?n(s,t):s,o=a.length-1,p;o>=0;o--)(p=a[o])&&(r=(c?p(s,t,r):p(r))||r);return c&&r&&l(s,t,r),r};const f={s:x`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:x`
        ...
        ></sp-icon-dash300>
    `};class Checkbox extends SizedMixin(CheckboxBase,{noDefaultSize:!0}){constructor(){super(...arguments);this.indeterminate=!1;this.invalid=!1;this.emphasized=!1;}static get styles(){return [u,E,f$1]}handleChange(){this.indeterminate=!1,super.handleChange();}render(){return x`
            ${super.render()}
            <span id="box">
                ${f[this.size]}
                ${S[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate);}}i([n$1({type:Boolean,reflect:!0})],Checkbox.prototype,"indeterminate",2),i([n$1({type:Boolean,reflect:!0})],Checkbox.prototype,"invalid",2),i([n$1({type:Boolean,reflect:!0})],Checkbox.prototype,"emphasized",2);
