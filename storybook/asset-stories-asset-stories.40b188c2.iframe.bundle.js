"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[3902],{"../2nd-gen/packages/core/dist/element/index.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{wG:function(){return _spectrum_element_js__WEBPACK_IMPORTED_MODULE_0__.w}});var _spectrum_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("../2nd-gen/packages/core/dist/element/spectrum-element.js")},"./packages/asset/sp-asset.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators=__webpack_require__("../node_modules/lit/decorators.js"),dist_element=__webpack_require__("../2nd-gen/packages/core/dist/element/index.js");var d=Object.defineProperty,c=(o,r,e,s)=>{for(var a,t=void 0,n=o.length-1;n>=0;n--)(a=o[n])&&(t=a(r,e,t)||t);return t&&d(r,e,t),t};class i extends dist_element.wG{constructor(){super(...arguments),this.label=""}updated(r){var e;if(super.updated(r),null!=(e=window.__swc)&&e.DEBUG){const s=this.constructor;void 0!==this.variant&&!s.VARIANTS.includes(this.variant)&&window.__swc.warn(this,`<${this.localName}> element expects the "variant" attribute to be one of the following:`,"https://opensource.adobe.com/spectrum-web-components/components/asset/",{issues:[...s.VARIANTS]})}}}i.VARIANTS=["file","folder"],c([(0,decorators.MZ)({type:String,reflect:!0})],i.prototype,"variant"),c([(0,decorators.MZ)()],i.prototype,"label");var asset_css=index_dev.AH`
...
`;(0,define_element_dev.e)("sp-asset",class Asset extends i{static get styles(){return[asset_css]}render(){return"file"===this.variant?(label=this.label,index_dev.qy`
  <svg
    class="file"
    role="img"
    viewBox="0 0 128 128"
...
//# sourceMappingURL=asset-stories-asset-stories.40b188c2.iframe.bundle.js.map