...
`;__webpack_exports__.default={title:"Overlay",argTypes:{offset:{control:"number"},placement:{control:{type:"inline-radio",options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end","auto","auto-start","auto-end","none"]}},type:{control:{type:"inline-radio",options:["modal","replace","inline"]}},colorStop:{control:{type:"inline-radio",options:["light","dark"]}}},args:{placement:"bottom",offset:0,colorStop:"light"}};const template=({placement:placement,offset:offset,open:open,type:type})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${storyStyles}
    <overlay-trigger
      ...
      placement=${placement}
      offset=${offset}
      open=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(open)}
      type=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(type)}
    >
        ...
        <sp-dialog no-divider>
          ...
          >
            ...
            <sp-popover slot="click-content" placement="bottom" tip>
              <sp-dialog size="s" no-divider>Another Popover</sp-dialog>
            </sp-popover>
  ...
  `,extraText=_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
...
`;function nextFrame(){return new Promise(res=>requestAnimationFrame(()=>res()))}const Default=args=>template(args),accordion=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger type="modal" placement="top-start" triggered-by="click">
      <style>
        sp-button {
          margin-top: 70vh;
        }
  ...
  `;accordion.swc_vrt={skip:!0},accordion.parameters={chromatic:{disableSnapshot:!0}};const clickAndHoverTarget=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `;clickAndHoverTarget.swc_vrt={skip:!0},clickAndHoverTarget.parameters={chromatic:{disableSnapshot:!0}};const clickAndHoverTargets=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <div>
      ${storyStyles}
      <style>
        .friendly-target {
      ...
      <overlay-trigger placement="right" triggered-by="click">
        <div class="friendly-target" slot="trigger" tabindex="0">Click me</div>
...
`;clickContentClosedOnScroll.decorators=[story=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `];class ComplexModalReady extends HTMLElement{constructor(){super(),this.handleTriggerOpened=async()=>{await nextFrame();const picker=document.querySelector("#test-picker");picker.addEventListener("sp-opened",this.handlePickerOpen),picker.open=!0},this.handlePickerOpen=async()=>{const picker=document.querySelector("#test-picker"),actions=[nextFrame,picker.updateComplete];picker.focus(),await Promise.all(actions),this.ready(!0)},this.readyPromise=Promise.resolve(!1),this.readyPromise=new Promise(res=>{this.ready=res,this.setup()})}async setup(){await nextFrame();document.querySelector("overlay-trigger").addEventListener("sp-opened",this.handleTriggerOpened)}get updateComplete(){return this.readyPromise}}customElements.define("complex-modal-ready",ComplexModalReady);const complexModal=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    <overlay-trigger type="modal" open="click" triggered-by="click">
      ...
      >
        <sp-field-label for="test-picker">Selection type:</sp-field-label>
  ...
  `;complexModal.decorators=[story=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${story()}
    <complex-modal-ready></complex-modal-ready>
  `];const customizedClickContent=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  <style>
    sp-popover {
...
`,deep=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  <overlay-trigger triggered-by="click">
    ...
    <sp-popover slot="click-content" placement="bottom" tip>
      <sp-dialog size="s" no-divider>
        <sp-action-button>
          <sp-tooltip self-managed placement="bottom">My Tooltip 1</sp-tooltip>
          A
        </sp-action-button>
        <sp-action-button>
          <sp-tooltip self-managed placement="bottom">My Tooltip 1</sp-tooltip>
...
`;deep.swc_vrt={skip:!0},deep.parameters={chromatic:{disableSnapshot:!0}};const deepChildTooltip=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  <overlay-trigger triggered-by="click">
      ...
      <sp-dialog no-divider>
        ...
        <overlay-trigger triggered-by="click">
          ...
          <sp-popover slot="click-content" placement="bottom" tip>
            <sp-dialog no-divider>
              <p>
                Render an action button with tooltips. Clicking the action
                button shouldn't close everything
              </p>
              <sp-action-button>
...
`,deepNesting=()=>{const color=window.__swc_hack_knobs__.defaultColor,outer="light"===color?"dark":"light";return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${storyStyles}
    <sp-theme
      color=${outer}
  ...
  `];const detachedElement=()=>{let overlay;const openDetachedOverlayContent=async({target:target})=>{if(overlay)return overlay.open=!1,void(overlay=void 0);const div=document.createElement("div");div.open=!1,div.textContent="This div is overlaid",div.setAttribute("style","\n            background-color: var(--spectrum-gray-50);\n            color: var(--spectrum-gray-800);\n            border: 1px solid;\n            padding: 2em;\n        "),overlay=await _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.hJ.open(div,{type:"auto",trigger:target,receivesFocus:"auto",placement:"bottom",offset:0}),overlay.addEventListener("sp-closed",()=>{overlay=void 0}),target.insertAdjacentElement("afterend",overlay)};return requestAnimationFrame(()=>{openDetachedOverlayContent({target:document.querySelector("#detached-content-trigger")})}),_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    >
      <sp-icon-open-in slot="icon" label="Open in overlay"></sp-icon-open-in>
    </sp-action-button>
  `},edges=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <style>
      .demo {
        position: absolute;
      }
  ...
  `,inline=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger
      type=${"inline"}
      triggered-by="click"
    >
    ...
    ${extraText}
  `},longpress=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `,modalLoose=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger type="modal" triggered-by="click">
      ...
      >
        ...
        <p>
          The
          <code>sp-dialog</code>
          element is not "meant" to be a modal alone. In that way it does not
          manage its own
          <code>open</code>
          attribute or outline when it should have
          <code>pointer-events: auto</code>
          . It's a part of this test suite to prove that content in this way can
          be used in an
    ...
    ${extraText}
  `},modalNoFocus=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger type="modal" receives-focus="false" triggered-by="click">
      <sp-button slot="trigger">Open</sp-button>
      <sp-dialog-wrapper
        underlay
        slot="click-content"
      ...
      >
        <p>
          ...
          <code>overlay-trigger</code>
          element by it's combination of modal, underlay, etc. styles and
          features.
        </p>
  ...
  `},modalManaged=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger type="modal" triggered-by="click">
      <sp-button slot="trigger">Open</sp-button>
      <sp-dialog-wrapper
        underlay
    ...
    ${extraText}
  `},modalWithinNonModal=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger
      type=${"inline"}
      triggered-by="click"
    >
      ...
      <sp-popover slot="click-content">
        <sp-dialog size="s" no-divider>
          <overlay-trigger type="modal" triggered-by="click">
            ...
            <sp-popover slot="click-content">
              <sp-dialog size="s" no-divider>Modal overlay</sp-dialog>
            </sp-popover>
          </overlay-trigger>
        </sp-dialog>
      </sp-popover>
    </overlay-trigger>
  `,noCloseOnResize=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  <style>
    sp-button:hover {
      border: 10px solid;
      width: 100px;
...
`;noCloseOnResize.swc_vrt={skip:!0},noCloseOnResize.parameters={chromatic:{disableSnapshot:!0}};const openClickContent=args=>template({...args,open:"click"}),openHoverContent=args=>template({...args,open:"hover"}),replace=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    ${extraText}
  `},sideHoverDraggable=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${storyStyles}
    <style>
      sp-tooltip {
        transition: none;
    ...
    <overlay-drag>
      <overlay-trigger placement="right" triggered-by="hover">
        ...
        <sp-tooltip slot="hover-content" delayed tip="right">
          ...
          egestas sed enim sed condimentum. Nunc facilisis scelerisque massa sed
          luctus. Orci varius natoque penatibus et magnis dis parturient montes,
          nascetur ridiculus mus. Suspendisse sagittis sodales purus vitae
          ultricies. Integer at dui sem. Sed quam tortor, ornare in nisi et,
          rhoncus lacinia mauris. Sed vel rutrum mauris, ac pellentesque nibh.
          Sed feugiat semper libero, sit amet vehicula orci fermentum id.
          Vivamus imperdiet egestas luctus. Mauris tincidunt malesuada ante,
          faucibus viverra nunc blandit a. Fusce et nisl nisi. Aenean dictum
          quam id mollis faucibus. Nulla a ultricies dui. In hac habitasse
          platea dictumst. Curabitur gravida lobortis vestibulum.
        </sp-tooltip>
      </overlay-trigger>
    </overlay-drag>
  `,superComplexModal=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger type="modal" triggered-by="click">
              ...
              <sp-dialog size="s" no-divider>
                <overlay-trigger type="modal" triggered-by="click">
                  ...
                  <sp-popover slot="click-content">
                    <sp-dialog size="s" no-divider>
                      <p>
                        When you get this deep, this ActiveOverlay should be the
                        only one in [slot="open"].
                      </p>
                      <p>
                        All of the rest of the ActiveOverlay elements should
                        have had their [slot] attribute removed.
                      </p>
                      <p>Closing this ActiveOverlay should replace them...</p>
                    </sp-dialog>
                  </sp-popover>
                </overlay-trigger>
              </sp-dialog>
  ...
  `,updated=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${storyStyles}
    <style>
      sp-tooltip {
        transition: none;
  ...
  `,updating=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <overlay-trigger triggered-by="click">
      <sp-button variant="primary" slot="trigger">
        Open inline overlay
      </sp-button>
  ...
  `;updating.swc_vrt={skip:!0},updating.parameters={chromatic:{disableSnapshot:!0}};class StartEndContextmenu extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n            <style>\n                :host {\n                    display: flex;\n                    align-items: stretch;\n                }\n                div {\n                    width: 50%;\n                    height: 100%;\n                }\n            </style>\n            <div id="start"></div>\n            <div id="end"></div>\n        '}}customElements.define("start-end-contextmenu",StartEndContextmenu);const virtualElementV1=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    <start-end-contextmenu
      class="app-root"
      @contextmenu=${{capture:!0,handleEvent:async event=>{event.preventDefault(),event.stopPropagation();const source=event.composedPath()[0],{id:id}=source,trigger=event.target,virtualTrigger=new _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.ec(event.clientX,event.clientY),fragment=document.createDocumentFragment();(0,lit__WEBPACK_IMPORTED_MODULE_0__.XX)(((kind="")=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <sp-popover
      style="width:300px;"
  ...
  `)(id),fragment);const popover=fragment.querySelector("sp-popover");(0,_spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.F9)(trigger,"click",popover,{placement:args.placement,receivesFocus:"auto",virtualTrigger:virtualTrigger,offset:0,notImmediatelyClosable:!0})}}}
    ></start-end-contextmenu>
  `;virtualElementV1.args={placement:"right-start"};const virtualElement=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <style>
      .app-root {
        position: absolute;
        inset: 0;
  ...
  `)(id),fragment);const popover=fragment.querySelector("sp-popover"),overlay=await(0,_spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.F9)(popover,{trigger:virtualTrigger,placement:args.placement,offset:0,notImmediatelyClosable:!0,type:"auto"});trigger.insertAdjacentElement("afterend",overlay)}}}
    ></start-end-contextmenu>
  `;virtualElement.args={placement:"right-start"};const virtualElementDeclaratively=args=>{const overlay=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <sp-overlay
      offset="0"
      type="auto"
      placement=${args.placement}
      .triggerElement=${new _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.ec(0,0)}
    >
      <sp-popover
        style="width:300px;"
  ...
  `;return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    <div
      class="app-root"
      @contextmenu=${{capture:!0,handleEvent:async event=>{event.preventDefault(),event.stopPropagation();const overlay2=document.querySelector("sp-overlay:not([open])");overlay2.triggerElement instanceof _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.ec&&overlay2.triggerElement.updateBoundingClientRect(event.clientX,event.clientY),overlay2.willPreventClose=!0,overlay2.open=!0}}}
    >
      ${overlay()} ${overlay()}
    </div>
  `};virtualElementDeclaratively.args={placement:"right-start"},virtualElementDeclaratively.swc_vrt={skip:!0},virtualElementDeclaratively.parameters={chromatic:{disableSnapshot:!0}};const triggeredByOptimization=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    <p>
      ...
      Inspect the DOM to verify that only the respective overlay elements are
      being rendered into the DOM based on the
      <code>triggered-by</code>
      value.
    </p>
    <p>
      Unused interaction types aren't rendered. This improves performance,
      reduces the number of unecessary DOM nodes and avoids race conditions in
      slot reparenting.
    </p>
  ...
  `,hoverWithInteractiveContent=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <div
    ...
    >
      ...
      <overlay-trigger triggered-by="hover" placement="right">
        <sp-button slot="trigger">Hover for interactive buttons</sp-button>
      ...
      <!-- Hover with links -->
      <overlay-trigger triggered-by="hover" placement="right">
        <sp-button slot="trigger">Hover for interactive links</sp-button>
        <sp-popover slot="hover-content" tip>
          <sp-dialog size="s" no-divider>
            <h3 style="margin-top: 0;">Quick links</h3>
            <ul>
              <li>
                <sp-link href="#example1">Example link 1</sp-link>
              </li>
              <li>
                <sp-link href="#example2">Example link 2</sp-link>
              </li>
              <li>
                <sp-link href="#example3">Example link 3</sp-link>
              </li>
            </ul>
          </sp-dialog>
        </sp-popover>
  ...
  `;hoverWithInteractiveContent.swc_vrt={skip:!0};const pickerInDialog=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class MenuGroup extends Menu_dev.W{constructor(){super(...arguments),this.headerId=""}static get styles(){return[...super.styles,menu_group_css]}get ownRole(){return"group"}get controlsRovingTabindex(){return!1}updateLabel(){const headerElement=this.headerElements.length?this.headerElements[0]:void 0;if(headerElement!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),headerElement){this.headerId=this.headerId||`sp-menu-group-label-${(0,random_id_dev.l)()}`;const headerId=headerElement.id||this.headerId;headerElement.id||(headerElement.id=headerId),this.setAttribute("aria-labelledby",headerId)}else this.removeAttribute("aria-labelledby");this.headerElement=headerElement}render(){return index_dev.qy`
    ...
    `}}__decorateClass([(0,decorators_dev.gZ)({slot:"header",flatten:!0})],MenuGroup.prototype,"headerElements",2),__decorateClass([(0,decorators_dev.wk)()],MenuGroup.prototype,"headerElement",2),(0,define_element_dev.e)("sp-menu-group",MenuGroup)}}]);
//# sourceMappingURL=overlay-stories-overlay-stories.aa836425.iframe.bundle.js.map