...
import { x, T } from './lit-html-126adc72.js';
import { e, t } from './directive-2bb7789e.js';
...
class Virtualizer {
    ...
    async _initLayout(layoutConfig) {
        ...
        if (Ctor === undefined) {
            ...
            DefaultLayoutConstructor = Ctor = (await import('./flow-2bf072d0.js'))
                .FlowLayout;
        }
...
class VirtualizeDirective extends c$1 {
    constructor(part) {
        super(part);
