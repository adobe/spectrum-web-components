...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class ColorLoupe extends index_dev.wG{constructor(){super(...arguments),this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[opacity_checkerboard_css.A,color_loupe_css]}render(){return index_dev.qy`
    ...
    `}}__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],ColorLoupe.prototype,"open",2),__decorateClass([(0,decorators_dev.MZ)({type:String})],ColorLoupe.prototype,"color",2),(0,define_element_dev.e)("sp-color-loupe",ColorLoupe)},"./packages/color-loupe/stories/color-loupe.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:function(){return __namedExportsOrder},open:function(){return open}});var _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/index.dev.js");__webpack_require__("./packages/color-loupe/sp-color-loupe.dev.js");__webpack_exports__.default={title:"Color/Loupe",component:"sp-color-loupe"};const open=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
...
//# sourceMappingURL=color-loupe-stories-color-loupe-stories.04b00d8d.iframe.bundle.js.map