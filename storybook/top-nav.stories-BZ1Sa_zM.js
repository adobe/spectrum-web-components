import './sp-top-nav-item-tNq5wKd8.js';
...
const __namedExportsOrder = ['Default', 'Selected', 'autofocus', 'Modes'];

export { Default, Modes, Selected, __namedExportsOrder, autofocus, topNav_stories as default };
