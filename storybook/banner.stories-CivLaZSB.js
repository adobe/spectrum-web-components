...
var a=Object.defineProperty;var d=Object.getOwnPropertyDescriptor;var s=(i,t,r,o)=>{for(var e=o>1?void 0:o?d(t,r):t,n=i.length-1,l;n>=0;n--)(l=i[n])&&(e=(o?l(t,r,e):l(e))||e);return o&&e&&a(t,r,e),e};class Banner extends SpectrumElement{constructor(){super(...arguments);this.type="info";this.corner=!1;}static get styles(){return [m]}update(r){super.update(r);}render(){return x`
            <div id="header"><slot name="header"></slot></div>
            <div id="content"><slot name="content"></slot></div>
        `}}s([n({reflect:!0,type:String})],Banner.prototype,"type",2),s([n({reflect:!0,type:Boolean})],Banner.prototype,"corner",2);
