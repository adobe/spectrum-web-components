...
var u=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var i=(l,r,t,o)=>{for(var e=o>1?void 0:o?c(r,t):r,s=l.length-1,p;s>=0;s--)(p=l[s])&&(e=(o?p(r,t,e):p(e))||e);return o&&e&&u(r,t,e),e};class ColorLoupe extends SpectrumElement{constructor(){super(...arguments);this.open=!1;this.color="rgba(255, 0, 0, 0.5)";}static get styles(){return [b,n]}render(){return x`
        ...
        `}}i([n$1({type:Boolean,reflect:!0})],ColorLoupe.prototype,"open",2),i([n$1({type:String})],ColorLoupe.prototype,"color",2);
