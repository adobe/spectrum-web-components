...
`,u=Object.defineProperty,c=Object.getOwnPropertyDescriptor,i=(n,s,e,o)=>{for(var p,t=o>1?void 0:o?c(s,e):s,a=n.length-1;a>=0;a--)(p=n[a])&&(t=(o?p(s,e,t):p(t))||t);return o&&t&&u(s,e,t),t};class ContextualHelp extends index_dev.wG{constructor(){super(...arguments),this.isMobile=new MatchMedia_dev._9(this,MatchMedia_dev.yS),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[contextual_help_css]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(Promise.all([__webpack_require__.e(8614),__webpack_require__.e(1335)]).then(__webpack_require__.bind(__webpack_require__,"./packages/dialog/sp-dialog-base.dev.js")),__webpack_require__.e(8614).then(__webpack_require__.bind(__webpack_require__,"./packages/dialog/sp-dialog.dev.js")),index_dev.qy`
            ...
            `)}handleSlottableRequest(e){if(e.stopPropagation(),e.data===slottable_request_event_dev.g)return this.open=!1,void(0,index_dev.XX)(void 0,e.target);this.open=!0;const o=this.renderOverlayContent();(0,index_dev.XX)(o,e.target)}render(){const e=this.isMobile.matches?void 0:this.placement;return index_dev.qy`
            <sp-action-button
                quiet
                size="s"
                id="trigger"
            ...
            <sp-overlay
                ...
                ?open=${this.open}
            ></sp-overlay>
        `}}i([(0,decorators_dev.MZ)()],ContextualHelp.prototype,"label",2),i([(0,decorators_dev.MZ)()],ContextualHelp.prototype,"variant",2),i([(0,decorators_dev.MZ)({reflect:!0})],ContextualHelp.prototype,"placement",2),i([(0,decorators_dev.MZ)({type:Number})],ContextualHelp.prototype,"offset",2),i([(0,decorators_dev.MZ)({type:Boolean})],ContextualHelp.prototype,"open",2),customElements.define("sp-contextual-help",ContextualHelp);const Template=(args={})=>index_dev.qy`
        <sp-contextual-help
...
//# sourceMappingURL=contextual-help-stories-contextual-help-stories.7aed569f.iframe.bundle.js.map