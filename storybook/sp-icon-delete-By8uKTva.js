...
import { C as CopyIcon$1, D as DeleteIcon$1 } from './Delete-BJAZbED4.js';
import { I as IconBase } from './IconBase-Z2IxLljH.js';
import { x } from './lit-html-COgVUehj.js';
import { d as defineElement } from './define-element-CbLZvyrL.js';

const CopyIcon=({width:r=24,height:l=24,hidden:t=!1,title:c="Copy"}={})=>tag`<svg
...
class IconCopy extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===2?CopyIcon({hidden:!this.label,title:this.label}):CopyIcon$1({hidden:!this.label,title:this.label})}}

defineElement("sp-icon-copy",IconCopy);

const DeleteIcon=({width:l=24,height:e=24,hidden:t=!1,title:r="Delete"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${l}"
    height="${e}"
    viewBox="0 0 20 20"
...
class IconDelete extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===2?DeleteIcon({hidden:!this.label,title:this.label}):DeleteIcon$1({hidden:!this.label,title:this.label})}}
