...
import { a as argTypes, h as handleChange, T as Template } from './template-dP6WmIwb.js';
...
const quiet = (args) => {
  return x`
        <sp-field-label for="picker-quiet" size=${l(args.size)}>
            Where do you live?
        </sp-field-label>
        <sp-picker
            ${spreadProps(args)}
...
const Open = (args) => {
  return x`
        ...
        <fieldset class="backdrop-filter-test">
            <sp-field-label for="picker-open" size=${l(args.size)}>
                Where do you live?
            </sp-field-label>
            <sp-picker
                id="picker-open"
        ...
        <fieldset>
            <sp-field-label for="picker-closed" size=${l(args.size)}>
                Where do you live?
            </sp-field-label>
            <sp-picker
                id="picker-closed"
...
const initialValue = (args) => {
  return x`
        <sp-field-label for="picker-initial" size=${l(args.size)}>
            Where do you live?
        </sp-field-label>
        <sp-picker
            id="picker-initial"
...
const custom = (args) => {
  ...
  return x`
        <sp-field-label for="picker-state" size=${l(args.size)}>
