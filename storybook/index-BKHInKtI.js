...
import { e, c } from './icon-chevron-overrides.css-Bz8Nk10Z.js';
import { s as s$1 } from './tab.css-C2ng0cRP.js';
...
var p=Object.defineProperty;var l=(c,i,t,o)=>{for(var e=void 0,r=c.length-1,s;r>=0;r--)(s=c[r])&&(e=(s(i,t,e))||e);return e&&p(i,t,e),e};class TabsOverflow extends SizedMixin(SpectrumElement){constructor(){super();this.compact=!1;this.labelPrevious="Scroll to previous tabs";this.labelNext="Scroll to next tabs";this.overflowState={canScrollLeft:!1,canScrollRight:!1};this.scrollFactor=.5;this.resizeController=new s(this,{target:this,callback:()=>{this._updateScrollState();}});}static get styles(){return [o,s$1,e,c]}firstUpdated(t){super.firstUpdated(t);const[o]=this.scrollContent;o&&(o.enableTabsScroll=!0),this.resizeController.observe(this.overflowContainer);}async _handleSlotChange(){const[t]=this.scrollContent;await(t==null?void 0:t.updateComplete),this._updateScrollState();}_updateScrollState(){const{scrollContent:t,overflowState:o}=this;if(t){const[e]=this.scrollContent,{canScrollLeft:r,canScrollRight:s}=(e==null?void 0:e.scrollState)||{canScrollLeft:!1,canScrollRight:!1};this.overflowState={...o,canScrollLeft:r,canScrollRight:s};}}_handleScrollClick(t){const o=t.currentTarget,[e]=this.scrollContent,r=e.clientWidth*this.scrollFactor,s=o.classList.contains("left-scroll")?-r:r;e.scrollTabs(s,"smooth");}updated(t){super.updated(t),t.has("dir")&&this._updateScrollState();}render(){const{canScrollRight:t,canScrollLeft:o}=this.overflowState,e=this.labelPrevious,r=this.labelNext;return x`
            <div
                class=${e$1({"tabs-overflow-container":!0,"left-shadow":o,"right-shadow":t})}
            >
                <sp-action-button
                    class=${e$1({"left-scroll":!0,show:o})}
                    aria-label=${e}
                    quiet
                    dir="rtl"
                    tabindex="-1"
                ...
                <sp-action-button
                    class=${e$1({"right-scroll":!0,show:t})}
                    aria-label=${r}
                    quiet
                    tabindex="-1"
                    @click=${this._handleScrollClick}
        ...
        `}}l([n({type:Boolean,reflect:!0})],TabsOverflow.prototype,"compact"),l([n({type:String,attribute:"label-previous"})],TabsOverflow.prototype,"labelPrevious"),l([n({type:String,attribute:"label-next"})],TabsOverflow.prototype,"labelNext"),l([n({reflect:!0})],TabsOverflow.prototype,"dir"),l([r()],TabsOverflow.prototype,"overflowState"),l([o$1({selector:"sp-tabs",flatten:!0})],TabsOverflow.prototype,"scrollContent"),l([e$2(".tabs-overflow-container")],TabsOverflow.prototype,"overflowContainer");
