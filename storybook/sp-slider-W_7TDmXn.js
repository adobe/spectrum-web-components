...
import { $ as $488c6ddbf4ef74c2$export$cc77c4ff7e8673c5 } from './import-1J07yXlD.js';
import { n, d as defineElement } from './define-element-IUrhCXKn.js';
...
var m=Object.defineProperty;var v=Object.getOwnPropertyDescriptor;var r=(d,o,e,t)=>{for(var i=t>1?void 0:t?v(o,e):o,l=d.length-1,s;l>=0;l--)(s=d[l])&&(i=(t?s(o,e,i):s(i))||i);return t&&i&&m(o,e,i),i};const variants=["filled","ramp","range","tick"];class Slider extends SizedMixin(ObserveSlotText(SliderHandle,""),{noDefaultSize:!0,validSizes:["s","m","l","xl"]}){constructor(){super(...arguments);this.handleController=new HandleController(this);this._editable=!1;this.hideStepper=!1;this.type="";this._variant="";this.getAriaValueText=e=>{const t=[...e.values()];return t.length===2?`${t[0]} - ${t[1]}`:t.join(", ")};this.min=0;this.max=100;this.step=1;this.tickStep=0;this.tickLabels=!1;this.disabled=!1;this.quiet=!1;this.indeterminate=!1;this._numberFieldInput=Promise.resolve();}static get styles(){return [k]}get editable(){return this._editable}set editable(e){if(e===this.editable)return;const t=this.editable;this._editable=this.handleController.size<2?e:!1,this.editable&&(this._numberFieldInput=import('./sp-number-field-J-Oaj0wb.js')),t!==this.editable&&this.requestUpdate("editable",t);}set variant(e){const t=this.variant;e!==this.variant&&(variants.includes(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",t));}get variant(){return this._variant}get values(){return this.handleController.values}get handleName(){return "value"}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.handleController.formattedValues):`${this.value}${this._forcedUnit}`}get numberFormat(){return this.getNumberFormat()}get focusElement(){return this.handleController.focusElement}handleLabelClick(e){this.editable&&(e.preventDefault(),this.focus());}render(){return x`
        ...
        `}renderTrackSegment(e,t){return this.variant==="ramp"?x``:x`
            <div
                ...
                role="presentation"
            ></div>
        `}renderTrack(){const e=this.handleController.trackSegments(),t=[{id:"handles",html:this.handleController.render()}],i=[{id:"track0",html:this.renderTrackSegment(...e[0])},{id:"ramp",html:this.renderRamp()},...e.slice(1).map(([l,s],u)=>({id:`track${u+1}`,html:this.renderTrackSegment(l,s)}))];return x`
            <div
                id="track"
