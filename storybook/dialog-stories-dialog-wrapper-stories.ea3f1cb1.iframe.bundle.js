"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[6314],{"./packages/dialog/stories/dialog-wrapper.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:function(){return __namedExportsOrder},form:function(){return form},lazyHero:function(){return lazyHero},longContent:function(){return longContent},longHeading:function(){return longHeading},receivesFocusComparison:function(){return receivesFocusComparison},tooltips:function(){return tooltips},wrapperButtons:function(){return wrapperButtons},wrapperButtonsUnderlay:function(){return wrapperButtonsUnderlay},wrapperDismissable:function(){return wrapperDismissable},wrapperDismissableUnderlay:function(){return wrapperDismissableUnderlay},wrapperDismissableUnderlayError:function(){return wrapperDismissableUnderlayError},wrapperFullscreen:function(){return wrapperFullscreen},wrapperHeadlineVisibilityNone:function(){return wrapperHeadlineVisibilityNone},wrapperLabeledHero:function(){return wrapperLabeledHero},wrapperWithHeadline:function(){return wrapperWithHeadline},wrapperWithHeadlineNoDivider:function(){return wrapperWithHeadlineNoDivider}});var _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/index.dev.js"),_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./tools/base/src/directives.dev.js"),_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_9__=(__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/field-label/sp-field-label.dev.js"),__webpack_require__("./packages/help-text/sp-help-text.dev.js"),__webpack_require__("./packages/textfield/sp-textfield.dev.js"),__webpack_require__("./packages/tooltip/sp-tooltip.dev.js"),__webpack_require__("./packages/overlay/overlay-trigger.dev.js"),__webpack_require__("./packages/dialog/sp-dialog-wrapper.dev.js"),__webpack_require__("./packages/overlay/stories/index.js")),_images_js__WEBPACK_IMPORTED_MODULE_10__=__webpack_require__("./packages/dialog/stories/images.js");__webpack_exports__.default={title:"Dialog Wrapper",component:"sp-dialog-wrapper",argTypes:{onClose:{action:"close"},onConfirm:{action:"confirm"},onSecondary:{action:"secondary"},onCancel:{action:"cancel"}}};const handleClose=({onClose:onClose})=>event=>{onClose&&onClose(event)},handleConfirm=({onConfirm:onConfirm})=>event=>{onConfirm&&onConfirm(event)},handleSecondary=({onSecondary:onSecondary})=>event=>{onSecondary&&onSecondary(event)},handleCancel=({onCancel:onCancel})=>event=>{onCancel&&onCancel(event)},wrapperLabeledHero=(args={},context={})=>{const open="docs"!==context.viewMode;return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    ...
    <sp-dialog-wrapper
      ?open=${open}
      hero=${_images_js__WEBPACK_IMPORTED_MODULE_10__.e}
  ...
  `};form.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_9__.Z];const longContent=(args={},context={})=>{const open="docs"===context.viewMode?void 0:"click";return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <overlay-trigger
      type="modal"
      @close=${handleClose(args)}
      open=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_1__.JR)(open)}
    ...
    >
      ...
      >
        <p>
          ...
          consequatur? Sed ac dolor sit amet purus malesuada congue. Nam libero
          tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo
          minus id quod maxime placeat facere possimus, omnis voluptas assumenda
          est, omnis dolor repellendus. Nullam sit amet magna in magna gravida
          vehicula. Itaque earum rerum hic tenetur a sapiente delectus, ut aut
          reiciendis voluptatibus maiores alias consequatur aut perferendis
          doloribus asperiores repellat. Neque porro quisquam est, qui dolorem
          ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non
          numquam eius modi tempora incidunt ut labore et dolore magnam aliquam
          quaerat voluptatem. Phasellus faucibus molestie nisl. Vestibulum
          fermentum tortor id mi. Integer rutrum, orci vestibulum ullamcorper
          ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet
          enim. Maecenas sollicitudin. Nullam rhoncus aliquam metus.
        </p>
        <p>
          ...
          repellendus. Nulla accumsan, elit sit amet varius semper, nulla mauris
          mollis quam, tempor suscipit diam nulla vel leo. Pellentesque sapien.
        </p>
        <p>
          ...
          hymenaeos. Integer in sapien. Nullam dapibus fermentum ipsum.
        </p>
        <p>
          ...
          Suspendisse sagittis ultrices augue. Nullam justo enim, consectetuer
          nec, ullamcorper ac, vestibulum in, elit. Praesent vitae arcu tempor
          neque lacinia pretium. Nullam faucibus mi quis velit. Maecenas aliquet
          accumsan leo. Morbi scelerisque luctus velit. Aliquam ornare wisi eu
          metus.
        </p>
        <p>
          ...
          tincidunt ac pede. Integer lacinia. Excepteur sint occaecat cupidatat
          non proident, sunt in culpa qui officia deserunt mollit anim id est
          laborum. Mauris tincidunt sem sed arcu. Praesent in mauris eu tortor
          porttitor accumsan. Aenean id metus id velit ullamcorper pulvinar.
          Donec iaculis gravida nulla. Duis bibendum, lectus ut viverra rhoncus,
          dolor nunc faucibus libero, eget facilisis enim ipsum id lacus. Nulla
          quis diam. Quisque porta. Integer rutrum, orci vestibulum ullamcorper
          ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet
          enim. Nam sed tellus id magna elementum tincidunt. In enim a arcu
          imperdiet malesuada.
        </p>
      </sp-dialog-wrapper>
    </overlay-trigger>
  `};longContent.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_9__.Z];const scrollableDialogBody=_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  <p>
...
`,receivesFocusComparison=(args={})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `;receivesFocusComparison.swc_vrt={skip:!0};const longHeading=(args={},context={})=>{const open="docs"===context.viewMode?void 0:"click";return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <overlay-trigger
      type="modal"
      @close=${handleClose(args)}
      open=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_1__.JR)(open)}
  ...
  `};longHeading.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_9__.Z];const wrapperDismissableUnderlayError=(args={},context={})=>{const open="docs"!==context.viewMode;return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div>
      <sp-dialog-wrapper
        ?open=${open}
        hero=${_images_js__WEBPACK_IMPORTED_MODULE_10__.e}
    ...
    >
      ...
      >
        ${[1,2,3,4].map(index=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
            <overlay-trigger>
              <sp-button slot="trigger">Button with Tooltip ${index}</sp-button>
              <sp-tooltip slot="hover-content">Tooltip ${index}</sp-tooltip>
            </overlay-trigger>
          `)}
      </sp-dialog-wrapper>
    </overlay-trigger>
  `};tooltips.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_9__.Z];const lazyHero=({src:src})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <overlay-trigger content="click" @sp-opened=${()=>{document.querySelector("sp-dialog-wrapper").hero=src}}>
      ...
      >
        ...
        <ol>
          <li>
            Select the following checkbox to have the dialog close when clicking
            one of its buttons.
          </li>
          <li>
            Select the following checkbox to have the dialog close when clicking
  ...
  `;lazyHero.args={src:"https://dummyimage.com/800x400/000/fff"},lazyHero.swc_vrt={skip:!0},lazyHero.parameters={chromatic:{disableSnapshot:!0}};const __namedExportsOrder=["wrapperLabeledHero","wrapperDismissable","wrapperDismissableUnderlay","form","longContent","receivesFocusComparison","longHeading","wrapperDismissableUnderlayError","wrapperButtons","wrapperButtonsUnderlay","wrapperFullscreen","wrapperWithHeadline","wrapperWithHeadlineNoDivider","wrapperHeadlineVisibilityNone","tooltips","lazyHero"];wrapperLabeledHero.parameters={...wrapperLabeledHero.parameters,docs:{...wrapperLabeledHero.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <style>\n      sp-story-decorator {\n        inset: 0;\n        position: absolute;\n        overflow: hidden;\n      }\n    </style>\n    <sp-dialog-wrapper\n      ?open=${open}\n      hero=${landscape}\n      hero-label="Hero Image Alt Text"\n      dismissable\n      headline="Wrapped Dialog w/ Hero Image"\n      @close=${handleClose(args)}\n      size="s"\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n    <sp-button\n      onClick="\n                this.previousElementSibling.open = !this.previousElementSibling.open;\n                if (this.previousElementSibling.open) {\n                    this.previousElementSibling.focus();\n                }\n            "\n      variant="primary"\n    >\n      Toggle Dialog\n    </sp-button>\n  `;\n}',...wrapperLabeledHero.parameters?.docs?.source}}},wrapperDismissable.parameters={...wrapperDismissable.parameters,docs:{...wrapperDismissable.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      .hero=${landscape}\n      dismissable\n      headline="Wrapped Dialog w/ Hero Image"\n      @close=${handleClose(args)}\n      size="s"\n      tabindex="0"\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n    <sp-button\n      onClick="\n                this.previousElementSibling.open = !this.previousElementSibling.open;\n                if (this.previousElementSibling.open) {\n                    this.previousElementSibling.focus();\n                }\n            "\n      variant="primary"\n    >\n      Toggle Dialog\n    </sp-button>\n  `;\n}',...wrapperDismissable.parameters?.docs?.source}}},wrapperDismissableUnderlay.parameters={...wrapperDismissableUnderlay.parameters,docs:{...wrapperDismissableUnderlay.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      hero=${landscape}\n      dismissable\n      headline="Wrapped Dialog w/ Hero Image"\n      underlay\n      @close=${handleClose(args)}\n      size="s"\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n    <sp-button\n      onClick="\n                this.previousElementSibling.open = !this.previousElementSibling.open;\n                if (this.previousElementSibling.open) {\n                    this.previousElementSibling.focus();\n                }\n            "\n      variant="primary"\n    >\n      Toggle Dialog\n    </sp-button>\n  `;\n}',...wrapperDismissableUnderlay.parameters?.docs?.source}}},form.parameters={...form.parameters,docs:{...form.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? void 0 : "click";\n  return html`\n    <overlay-trigger\n      type="modal"\n      @close=${handleClose(args)}\n      open=${ifDefined(open)}\n    >\n      <sp-button slot="trigger" variant="primary">Toggle Dialog</sp-button>\n      <sp-dialog-wrapper\n        id="form-fields"\n        slot="click-content"\n        headline="Add Delivery Address"\n        underlay\n        size="m"\n        confirm-label="Verify Address"\n        secondary-label="Add"\n        cancel-label="Cancel"\n        @close=${handleClose(args)}\n        @confirm=${({\n    target\n  }) => {\n    target.dispatchEvent(new Event("close", {\n      bubbles: true,\n      composed: true\n    }));\n    handleConfirm(args);\n  }}\n        @secondary=${({\n    target\n  }) => {\n    target.dispatchEvent(new Event("close", {\n      bubbles: true,\n      composed: true\n    }));\n    handleSecondary(args);\n  }}\n        @cancel=${({\n    target\n  }) => {\n    target.dispatchEvent(new Event("close", {\n      bubbles: true,\n      composed: true\n    }));\n    handleCancel(args);\n  }}\n      >\n        <style>\n          #form-fields div {\n            display: grid;\n            row-gap: calc(var(--swc-scale-factor) * 12px);\n            grid-template-columns: auto auto;\n          }\n        </style>\n        <div>\n          <sp-field-label side-aligned="end" for="street">\n            Street:\n          </sp-field-label>\n          <sp-textfield id="street" autofocus></sp-textfield>\n          <sp-field-label side-aligned="end" for="city">City:</sp-field-label>\n          <sp-textfield id="city"></sp-textfield>\n          <sp-field-label side-aligned="end" for="state">State:</sp-field-label>\n          <sp-textfield id="state"></sp-textfield>\n          <sp-field-label side-aligned="end" for="zip">Zip:</sp-field-label>\n          <sp-textfield id="zip"></sp-textfield>\n          <sp-field-label side-aligned="end" for="instructions">\n            Special instructions:\n          </sp-field-label>\n          <sp-textfield id="instructions" multiline>\n            <sp-help-text slot="help-text">\n              For example, gate code or other information to help the driver\n              find you\n            </sp-help-text>\n          </sp-textfield>\n        </div>\n      </sp-dialog-wrapper>\n    </overlay-trigger>\n  `;\n}',...form.parameters?.docs?.source}}},longContent.parameters={...longContent.parameters,docs:{...longContent.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? void 0 : "click";\n  return html`\n    <overlay-trigger\n      type="modal"\n      @close=${handleClose(args)}\n      open=${ifDefined(open)}\n      triggered-by="click hover"\n    >\n      <sp-button slot="trigger" variant="primary">Toggle Dialog</sp-button>\n      <sp-dialog-wrapper\n        slot="click-content"\n        headline="Dialog title"\n        dismissable\n        underlay\n        size="s"\n      >\n        <p>\n          Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed ac dolor\n          sit amet purus malesuada congue. Donec quis nibh at felis congue\n          commodo. Ut enim ad minima veniam, quis nostrum exercitationem ullam\n          corporis suscipit laboriosam, nisi ut aliquid ex ea commodi\n          consequatur? Sed ac dolor sit amet purus malesuada congue. Nam libero\n          tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo\n          minus id quod maxime placeat facere possimus, omnis voluptas assumenda\n          est, omnis dolor repellendus. Nullam sit amet magna in magna gravida\n          vehicula. Itaque earum rerum hic tenetur a sapiente delectus, ut aut\n          reiciendis voluptatibus maiores alias consequatur aut perferendis\n          doloribus asperiores repellat. Neque porro quisquam est, qui dolorem\n          ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non\n          numquam eius modi tempora incidunt ut labore et dolore magnam aliquam\n          quaerat voluptatem. Phasellus faucibus molestie nisl. Vestibulum\n          fermentum tortor id mi. Integer rutrum, orci vestibulum ullamcorper\n          ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet\n          enim. Maecenas sollicitudin. Nullam rhoncus aliquam metus.\n        </p>\n        <p>\n          Curabitur ligula sapien, pulvinar a vestibulum quis, facilisis vel\n          sapien. Fusce nibh. Proin pede metus, vulputate nec, fermentum\n          fringilla, vehicula vitae, justo. Aenean placerat. Aliquam erat\n          volutpat. Et harum quidem rerum facilis est et expedita distinctio.\n          Fusce nibh. Temporibus autem quibusdam et aut officiis debitis aut\n          rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint\n          et molestiae non recusandae. Vestibulum erat nulla, ullamcorper nec,\n          rutrum non, nonummy ac, erat. Etiam posuere lacus quis dolor. Mauris\n          elementum mauris vitae tortor. Nulla turpis magna, cursus sit amet,\n          suscipit a, interdum id, felis. Nam libero tempore, cum soluta nobis\n          est eligendi optio cumque nihil impedit quo minus id quod maxime\n          placeat facere possimus, omnis voluptas assumenda est, omnis dolor\n          repellendus. Nulla accumsan, elit sit amet varius semper, nulla mauris\n          mollis quam, tempor suscipit diam nulla vel leo. Pellentesque sapien.\n        </p>\n        <p>\n          Curabitur vitae diam non enim vestibulum interdum. Sed elit dui,\n          pellentesque a, faucibus vel, interdum nec, diam. Praesent vitae arcu\n          tempor neque lacinia pretium. Ut tempus purus at lorem. Phasellus\n          rhoncus. Temporibus autem quibusdam et aut officiis debitis aut rerum\n          necessitatibus saepe eveniet ut et voluptates repudiandae sint et\n          molestiae non recusandae. Duis ante orci, molestie vitae vehicula\n          venenatis, tincidunt ac pede. Integer vulputate sem a nibh rutrum\n          consequat. Aenean placerat. Cum sociis natoque penatibus et magnis dis\n          parturient montes, nascetur ridiculus mus. Sed vel lectus. Donec odio\n          tempus molestie, porttitor ut, iaculis quis, sem. Class aptent taciti\n          sociosqu ad litora torquent per conubia nostra, per inceptos\n          hymenaeos. Integer in sapien. Nullam dapibus fermentum ipsum.\n        </p>\n        <p>\n          Integer vulputate sem a nibh rutrum consequat. Class aptent taciti\n          sociosqu ad litora torquent per conubia nostra, per inceptos\n          hymenaeos. Duis bibendum, lectus ut viverra rhoncus, dolor nunc\n          faucibus libero, eget facilisis enim ipsum id lacus. Aliquam erat\n          volutpat. Aenean id metus id velit ullamcorper pulvinar. Morbi\n          scelerisque luctus velit. Aliquam erat volutpat. Temporibus autem\n          quibusdam et aut officiis debitis aut rerum necessitatibus saepe\n          eveniet ut et voluptates repudiandae sint et molestiae non recusandae.\n          Fusce dui leo, imperdiet in, aliquam sit amet, feugiat eu, orci.\n          Suspendisse sagittis ultrices augue. Nullam justo enim, consectetuer\n          nec, ullamcorper ac, vestibulum in, elit. Praesent vitae arcu tempor\n          neque lacinia pretium. Nullam faucibus mi quis velit. Maecenas aliquet\n          accumsan leo. Morbi scelerisque luctus velit. Aliquam ornare wisi eu\n          metus.\n        </p>\n        <p>\n          Sed elit dui, pellentesque a, faucibus vel, interdum nec, diam.\n          Praesent vitae arcu tempor neque lacinia pretium. Etiam dictum\n          tincidunt diam. Et harum quidem rerum facilis est et expedita\n          distinctio. Duis ante orci, molestie vitae vehicula venenatis,\n          tincidunt ac pede. Integer lacinia. Excepteur sint occaecat cupidatat\n          non proident, sunt in culpa qui officia deserunt mollit anim id est\n          laborum. Mauris tincidunt sem sed arcu. Praesent in mauris eu tortor\n          porttitor accumsan. Aenean id metus id velit ullamcorper pulvinar.\n          Donec iaculis gravida nulla. Duis bibendum, lectus ut viverra rhoncus,\n          dolor nunc faucibus libero, eget facilisis enim ipsum id lacus. Nulla\n          quis diam. Quisque porta. Integer rutrum, orci vestibulum ullamcorper\n          ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet\n          enim. Nam sed tellus id magna elementum tincidunt. In enim a arcu\n          imperdiet malesuada.\n        </p>\n      </sp-dialog-wrapper>\n    </overlay-trigger>\n  `;\n}',...longContent.parameters?.docs?.source}}},receivesFocusComparison.parameters={...receivesFocusComparison.parameters,docs:{...receivesFocusComparison.parameters?.docs,source:{originalSource:'(args = {}) => {\n  return html`\n    <div style="display: flex; gap: 16px; flex-wrap: wrap;">\n      <overlay-trigger\n        type="modal"\n        @close=${handleClose(args)}\n        triggered-by="click"\n        .receivesFocus=${"false"}\n      >\n        <sp-button slot="trigger" variant="primary">\n          Open with receives-focus="false"\n        </sp-button>\n        <sp-dialog-wrapper\n          slot="click-content"\n          headline="receives-focus is false"\n          dismissable\n          underlay\n          size="s"\n        >\n          <p>\n            The dialog opens scrolled to the top. Focus stays on the trigger\n            button — the inline link further down is NOT auto-focused, so the\n            dialog body does not auto-scroll to reveal it.\n          </p>\n          ${scrollableDialogBody}\n        </sp-dialog-wrapper>\n      </overlay-trigger>\n      <overlay-trigger\n        type="modal"\n        @close=${handleClose(args)}\n        triggered-by="click"\n        .receivesFocus=${"true"}\n      >\n        <sp-button slot="trigger" variant="primary">\n          Open with receives-focus="true"\n        </sp-button>\n        <sp-dialog-wrapper\n          slot="click-content"\n          headline="receives-focus is true"\n          dismissable\n          underlay\n          size="s"\n        >\n          <p>\n            When this dialog opens, focus moves to the first focusable element —\n            the link further down — so the body scrolls to reveal it. This is\n            the default auto-focus behavior.\n          </p>\n          ${scrollableDialogBody}\n        </sp-dialog-wrapper>\n      </overlay-trigger>\n    </div>\n  `;\n}',...receivesFocusComparison.parameters?.docs?.source}}},longHeading.parameters={...longHeading.parameters,docs:{...longHeading.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? void 0 : "click";\n  return html`\n    <overlay-trigger\n      type="modal"\n      @close=${handleClose(args)}\n      open=${ifDefined(open)}\n    >\n      <sp-dialog-wrapper\n        slot="click-content"\n        underlay\n        headline="Dialog long long long long long long long long long long long long title"\n        confirm-label="Keep Both"\n        secondary-label="Replace"\n        cancel-label="Cancel"\n        footer="Content for footer"\n        size="m"\n      >\n        Content of the dialog\n      </sp-dialog-wrapper>\n      <sp-button slot="trigger" variant="primary">Toggle Dialog</sp-button>\n    </overlay-trigger>\n  `;\n}',...longHeading.parameters?.docs?.source}}},wrapperDismissableUnderlayError.parameters={...wrapperDismissableUnderlayError.parameters,docs:{...wrapperDismissableUnderlayError.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <div>\n      <sp-dialog-wrapper\n        ?open=${open}\n        hero=${landscape}\n        dismissable\n        error\n        headline="Wrapped Dialog w/ Hero Image"\n        underlay\n        @close=${handleClose(args)}\n        size="s"\n      >\n        Content of the dialog\n      </sp-dialog-wrapper>\n      <sp-button\n        onClick="\n                    this.previousElementSibling.open = !this.previousElementSibling.open;\n                    if (this.previousElementSibling.open) {\n                        this.previousElementSibling.focus();\n                    }\n                "\n        variant="primary"\n      >\n        Toggle Dialog\n      </sp-button>\n    </div>\n  `;\n}',...wrapperDismissableUnderlayError.parameters?.docs?.source}}},wrapperButtons.parameters={...wrapperButtons.parameters,docs:{...wrapperButtons.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      size="l"\n      headline="Wrapped Dialog w/ Buttons"\n      confirm-label="Keep Both"\n      secondary-label="Replace"\n      cancel-label="Cancel"\n      footer="Content for footer"\n      @close=${handleClose(args)}\n      @confirm=${handleConfirm(args)}\n      @secondary=${handleSecondary(args)}\n      @cancel=${handleCancel(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperButtons.parameters?.docs?.source}}},wrapperButtonsUnderlay.parameters={...wrapperButtonsUnderlay.parameters,docs:{...wrapperButtonsUnderlay.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      underlay\n      size="l"\n      headline="Wrapped Dialog w/ Buttons"\n      confirm-label="Keep Both"\n      secondary-label="Replace"\n      cancel-label="Cancel"\n      footer="Content for footer"\n      @close=${handleClose(args)}\n      @confirm=${handleConfirm(args)}\n      @secondary=${handleSecondary(args)}\n      @cancel=${handleCancel(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperButtonsUnderlay.parameters?.docs?.source}}},wrapperFullscreen.parameters={...wrapperFullscreen.parameters,docs:{...wrapperFullscreen.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      headline="Wrapped Dialog - Fullscreen"\n      mode="fullscreen"\n      confirm-label="Keep Both"\n      secondary-label="Replace"\n      cancel-label="Cancel"\n      @close=${handleClose(args)}\n      @confirm=${handleConfirm(args)}\n      @secondary=${handleSecondary(args)}\n      @cancel=${handleCancel(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperFullscreen.parameters?.docs?.source}}},wrapperWithHeadline.parameters={...wrapperWithHeadline.parameters,docs:{...wrapperWithHeadline.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      headline="Headline for dialog"\n      @close=${handleClose(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperWithHeadline.parameters?.docs?.source}}},wrapperWithHeadlineNoDivider.parameters={...wrapperWithHeadlineNoDivider.parameters,docs:{...wrapperWithHeadlineNoDivider.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      ?open=${open}\n      headline="Headline for dialog"\n      no-divider\n      @close=${handleClose(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperWithHeadlineNoDivider.parameters?.docs?.source}}},wrapperHeadlineVisibilityNone.parameters={...wrapperHeadlineVisibilityNone.parameters,docs:{...wrapperHeadlineVisibilityNone.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? false : true;\n  return html`\n    <sp-dialog-wrapper\n      headline="Accessible headline"\n      .headlineVisibility=${"none"}\n      ?open=${open}\n      @close=${handleClose(args)}\n    >\n      Content of the dialog\n    </sp-dialog-wrapper>\n  `;\n}',...wrapperHeadlineVisibilityNone.parameters?.docs?.source}}},tooltips.parameters={...tooltips.parameters,docs:{...tooltips.parameters?.docs,source:{originalSource:'(args = {}, context = {}) => {\n  const open = context.viewMode === "docs" ? void 0 : "click";\n  return html`\n    <overlay-trigger\n      type="modal"\n      @close=${handleClose(args)}\n      open=${ifDefined(open)}\n    >\n      <sp-button slot="trigger" variant="primary">Toggle Dialog</sp-button>\n      <sp-dialog-wrapper\n        slot="click-content"\n        headline="Dialog title"\n        dismissable\n        underlay\n        size="s"\n      >\n        ${[1, 2, 3, 4].map(index => html`\n            <overlay-trigger>\n              <sp-button slot="trigger">Button with Tooltip ${index}</sp-button>\n              <sp-tooltip slot="hover-content">Tooltip ${index}</sp-tooltip>\n            </overlay-trigger>\n          `)}\n      </sp-dialog-wrapper>\n    </overlay-trigger>\n  `;\n}',...tooltips.parameters?.docs?.source}}},lazyHero.parameters={...lazyHero.parameters,docs:{...lazyHero.parameters?.docs,source:{originalSource:'({\n  src\n}) => {\n  const handleOpened = () => {\n    document.querySelector("sp-dialog-wrapper").hero = src;\n  };\n  return html`\n    <overlay-trigger content="click" @sp-opened=${handleOpened}>\n      <sp-button slot="trigger">Toggle Dialog</sp-button>\n      <sp-dialog-wrapper\n        slot="click-content"\n        headline="Dialog title"\n        confirm-label="Primary"\n      >\n        <p>Content of the dialog</p>\n        <ol>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n          <li>\n            Select the following checkbox to have the dialog close when clicking\n            one of its buttons.\n          </li>\n        </ol>\n      </sp-dialog-wrapper>\n    </overlay-trigger>\n  `;\n}',...lazyHero.parameters?.docs?.source}}}},"./packages/dialog/sp-dialog-wrapper.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js"),directives_dev=__webpack_require__("./tools/base/src/directives.dev.js"),DialogBase_dev=(__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/underlay/sp-underlay.dev.js"),__webpack_require__("./packages/dialog/sp-dialog.dev.js"),__webpack_require__("./packages/dialog/src/DialogBase.dev.js")),__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class DialogWrapper extends DialogBase_dev.u{constructor(){super(...arguments),this.error=!1,this.cancelLabel="",this.confirmLabel="",this.dismissLabel="Close",this.footer="",this.hero="",this.heroLabel="",this.noDivider=!1,this.secondaryLabel="",this.headline=""}static get styles(){return[...super.styles]}get dialog(){return this.shadowRoot.querySelector("sp-dialog")}clickSecondary(){this.dispatchEvent(new Event("secondary",{bubbles:!0}))}clickCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}clickConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}renderDialog(){const hideDivider=this.noDivider||!this.headline||"none"===this.headlineVisibility;return this.headline||window.__swc.warn(this,`<${this.localName}> elements will not be accessible to screen readers without a "headline" attribute or property.`,"https://opensource.adobe.com/spectrum-web-components/components/dialog-wrapper/#accessibility",{type:"accessibility"}),index_dev.qy`
      ...
      >
        ...
        ${this.headline?index_dev.qy`
              <h2 slot="heading" ?hidden=${"none"===this.headlineVisibility}>
                ${this.headline}
              </h2>
            `:index_dev.s6}
        <slot></slot>
    ...
    `}}__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],DialogWrapper.prototype,"error",2),__decorateClass([(0,decorators_dev.MZ)({attribute:"cancel-label"})],DialogWrapper.prototype,"cancelLabel",2),__decorateClass([(0,decorators_dev.MZ)({attribute:"confirm-label"})],DialogWrapper.prototype,"confirmLabel",2),__decorateClass([(0,decorators_dev.MZ)({attribute:"dismiss-label"})],DialogWrapper.prototype,"dismissLabel",2),__decorateClass([(0,decorators_dev.MZ)()],DialogWrapper.prototype,"footer",2),__decorateClass([(0,decorators_dev.MZ)()],DialogWrapper.prototype,"hero",2),__decorateClass([(0,decorators_dev.MZ)({attribute:"hero-label"})],DialogWrapper.prototype,"heroLabel",2),__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0,attribute:"no-divider"})],DialogWrapper.prototype,"noDivider",2),__decorateClass([(0,decorators_dev.MZ)({type:String,reflect:!0})],DialogWrapper.prototype,"size",2),__decorateClass([(0,decorators_dev.MZ)({attribute:"secondary-label"})],DialogWrapper.prototype,"secondaryLabel",2),__decorateClass([(0,decorators_dev.MZ)()],DialogWrapper.prototype,"headline",2),__decorateClass([(0,decorators_dev.MZ)({type:String,attribute:"headline-visibility"})],DialogWrapper.prototype,"headlineVisibility",2),(0,define_element_dev.e)("sp-dialog-wrapper",DialogWrapper)},"./packages/help-text/sp-help-text.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js");__webpack_require__("./packages/icons-workflow/icons/sp-icon-alert.js");var help_text_css=index_dev.AH`
    @media (forced-colors:active){:host{--highcontrast-helptext-content-color-default:CanvasText;--highcontrast-helptext-icon-color-default:CanvasText}:host,.text,.icon{forced-color-adjust:none}}:host{--spectrum-helptext-content-color-default:var(--spectrum-neutral-subdued-content-color-default);--spectrum-helptext-icon-color-default:var(--spectrum-neutral-subdued-content-color-default);min-block-size:var(--mod-helptext-min-height,var(--spectrum-helptext-min-height));font-size:var(--mod-helptext-font-size,var(--spectrum-helptext-font-size));color:var(--highcontrast-helptext-content-color-default,var(--mod-helptext-content-color-default,var(--spectrum-helptext-content-color-default)));display:flex}:host([size=s]){--spectrum-helptext-min-height:var(--spectrum-component-height-75);--spectrum-helptext-icon-size:var(--spectrum-workflow-icon-size-75);--spectrum-helptext-font-size:var(--spectrum-font-size-75);--spectrum-helptext-text-to-visual:var(--spectrum-text-to-visual-75);--spectrum-helptext-top-to-workflow-icon:var(--spectrum-help-text-top-to-workflow-icon-small);--spectrum-helptext-bottom-to-workflow-icon:var(--spectrum-helptext-top-to-workflow-icon)}:host,:host{--spectrum-helptext-min-height:var(--spectrum-component-height-75);--spectrum-helptext-icon-size:var(--spectrum-workflow-icon-size-100);--spectrum-helptext-font-size:var(--spectrum-font-size-75);--spectrum-helptext-text-to-visual:var(--spectrum-text-to-visual-75);--spectrum-helptext-top-to-workflow-icon:var(--spectrum-help-text-top-to-workflow-icon-medium);--spectrum-helptext-bottom-to-workflow-icon:var(--spectrum-helptext-top-to-workflow-icon)}:host([size=l]){--spectrum-helptext-min-height:var(--spectrum-component-height-100);--spectrum-helptext-icon-size:var(--spectrum-workflow-icon-size-200);--spectrum-helptext-font-size:var(--spectrum-font-size-100);--spectrum-helptext-text-to-visual:var(--spectrum-text-to-visual-100);--spectrum-helptext-top-to-workflow-icon:var(--spectrum-help-text-top-to-workflow-icon-large);--spectrum-helptext-bottom-to-workflow-icon:var(--spectrum-helptext-top-to-workflow-icon)}:host([size=xl]){--spectrum-helptext-min-height:var(--spectrum-component-height-200);--spectrum-helptext-icon-size:var(--spectrum-workflow-icon-size-300);--spectrum-helptext-font-size:var(--spectrum-font-size-200);--spectrum-helptext-text-to-visual:var(--spectrum-text-to-visual-200);--spectrum-helptext-top-to-workflow-icon:var(--spectrum-help-text-top-to-workflow-icon-extra-large);--spectrum-helptext-bottom-to-workflow-icon:var(--spectrum-helptext-top-to-workflow-icon)}:host([variant=neutral]){--spectrum-helptext-content-color-default:var(--spectrum-neutral-subdued-content-color-default);--spectrum-helptext-icon-color-default:var(--spectrum-neutral-subdued-content-color-default)}:host([variant=negative]){--spectrum-helptext-content-color-default:var(--spectrum-negative-color-900);--spectrum-helptext-icon-color-default:var(--spectrum-negative-color-900)}:host([disabled]){--spectrum-helptext-content-color-default:var(--spectrum-disabled-content-color);--spectrum-helptext-icon-color-default:var(--spectrum-disabled-content-color)}:host(:lang(ja)),:host(:lang(ko)),:host(:lang(zh)){--mod-helptext-line-height:var(--mod-helptext-line-height-cjk,var(--spectrum-cjk-line-height-100))}.icon{inline-size:var(--mod-helptext-icon-size,var(--spectrum-helptext-icon-size));block-size:var(--mod-helptext-icon-size,var(--spectrum-helptext-icon-size));flex-shrink:0;margin-inline-end:var(--mod-helptext-text-to-visual,var(--spectrum-helptext-text-to-visual));padding-block-start:var(--mod-helptext-top-to-workflow-icon,var(--spectrum-helptext-top-to-workflow-icon));padding-block-end:var(--mod-helptext-bottom-to-workflow-icon,var(--spectrum-helptext-bottom-to-workflow-icon))}.text{line-height:var(--mod-helptext-line-height,var(--spectrum-line-height-100));padding-block-start:var(--mod-helptext-top-to-text,var(--spectrum-helptext-top-to-text));padding-block-end:var(--mod-helptext-bottom-to-text,var(--spectrum-helptext-bottom-to-text))}:host([variant=neutral]) .text{color:var(--highcontrast-helptext-content-color-default,var(--mod-helptext-content-color-default,var(--spectrum-helptext-content-color-default)))}:host([variant=neutral]) .icon{color:var(--highcontrast-helptext-icon-color-default,var(--mod-helptext-icon-color-default,var(--spectrum-helptext-icon-color-default)))}:host([variant=negative]) .text{color:var(--highcontrast-helptext-content-color-default,var(--mod-helptext-content-color-default,var(--spectrum-helptext-content-color-default)))}:host([variant=negative]) .icon{color:var(--highcontrast-helptext-icon-color-default,var(--mod-helptext-icon-color-default,var(--spectrum-helptext-icon-color-default)))}:host([disabled]) .text{color:var(--highcontrast-helptext-content-color-default,var(--mod-helptext-content-color-default,var(--spectrum-helptext-content-color-default)))}:host([disabled]) .icon{color:var(--highcontrast-helptext-icon-color-default,var(--mod-helptext-icon-color-default,var(--spectrum-helptext-icon-color-default)))}:host{--spectrum-helptext-top-to-text:var(--system-helptext-top-to-text);--spectrum-helptext-bottom-to-text:var(--system-helptext-bottom-to-text)}:host([size=s]){--spectrum-helptext-top-to-text:var(--system-helptext-top-to-text-small);--spectrum-helptext-bottom-to-text:var(--system-helptext-bottom-to-text-small)}:host([size=l]){--spectrum-helptext-top-to-text:var(--system-helptext-top-to-text-large);--spectrum-helptext-bottom-to-text:var(--system-helptext-bottom-to-text-large)}:host([size=xl]){--spectrum-helptext-top-to-text:var(--system-helptext-top-to-text-extra-large);--spectrum-helptext-bottom-to-text:var(--system-helptext-bottom-to-text-extra-large)}
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const _OverlayTrigger=class _OverlayTrigger extends index_dev.wG{constructor(){super(...arguments),this.offset=6,this.disabled=!1,this.receivesFocus="auto",this.clickContent=[],this.longpressContent=[],this.hoverContent=[],this.targetContent=[],this.ariaManagedElements=new WeakSet}static get styles(){return[overlay_trigger_css]}getAssignedElementsFromSlot(slot){return slot.assignedElements({flatten:!0})}handleTriggerContent(event){this.targetContent=this.getAssignedElementsFromSlot(event.target)}handleSlotContent(event){switch(event.target.name){case"click-content":this.clickContent=this.getAssignedElementsFromSlot(event.target);break;case"longpress-content":this.longpressContent=this.getAssignedElementsFromSlot(event.target);break;case"hover-content":this.hoverContent=this.getAssignedElementsFromSlot(event.target)}}handleBeforetoggle(event){const{target:target}=event;let type;if(target===this.clickOverlayElement)type="click";else if(target===this.longpressOverlayElement)type="longpress";else{if(target!==this.hoverOverlayElement)return;type="hover"}"open"===event.newState?this.open=type:this.open===type&&(this.open=void 0)}resolveHaspopupValue(){const content=this.clickContent[0]||this.longpressContent[0];if(!content)return"dialog";const role=content.getAttribute("role");if(role&&_OverlayTrigger.VALID_HASPOPUP_ROLES.has(role))return role;const firstChild=content.querySelector("[role]");return firstChild&&_OverlayTrigger.VALID_HASPOPUP_ROLES.has(firstChild.getAttribute("role"))?firstChild.getAttribute("role"):"dialog"}removeAriaFromTrigger(element){this.ariaManagedElements.has(element)&&(element.removeAttribute("aria-expanded"),element.removeAttribute("aria-controls"),element.removeAttribute("aria-haspopup"),this.ariaManagedElements.delete(element))}manageAriaOnTrigger(){const triggerElement=this.targetContent[0];if(this.previousTriggerElement&&this.previousTriggerElement!==triggerElement&&this.removeAriaFromTrigger(this.previousTriggerElement),this.previousTriggerElement=triggerElement,!triggerElement)return;const hasClickContent=this.clickContent.length>0,hasLongpressContent=this.longpressContent.length>0;if(!hasClickContent&&!hasLongpressContent)return void this.removeAriaFromTrigger(triggerElement);const isExpanded="click"===this.open||"longpress"===this.open;triggerElement.setAttribute("aria-expanded",String(isExpanded)),!this.ariaManagedElements.has(triggerElement)&&triggerElement.hasAttribute("aria-haspopup")||triggerElement.setAttribute("aria-haspopup",this.resolveHaspopupValue()),this.ariaManagedElements.add(triggerElement);const content="longpress"===this.open?this.longpressContent[0]:"click"===this.open?this.clickContent[0]:this.clickContent[0]||this.longpressContent[0];content?(content.id||(content.id=`sp-overlay-content-${(0,random_id_dev.l)()}`),triggerElement.setAttribute("aria-controls",content.id)):triggerElement.removeAttribute("aria-controls")}disconnectedCallback(){this.previousTriggerElement&&(this.removeAriaFromTrigger(this.previousTriggerElement),this.previousTriggerElement=void 0),super.disconnectedCallback()}update(changes){var _a,_b,_c,_d,_e,_f;changes.has("clickContent")&&(this.clickPlacement=(null==(_a=this.clickContent[0])?void 0:_a.getAttribute("placement"))||(null==(_b=this.clickContent[0])?void 0:_b.getAttribute("direction"))||void 0),changes.has("hoverContent")&&(this.hoverPlacement=(null==(_c=this.hoverContent[0])?void 0:_c.getAttribute("placement"))||(null==(_d=this.hoverContent[0])?void 0:_d.getAttribute("direction"))||void 0),changes.has("longpressContent")&&(this.longpressPlacement=(null==(_e=this.longpressContent[0])?void 0:_e.getAttribute("placement"))||(null==(_f=this.longpressContent[0])?void 0:_f.getAttribute("direction"))||void 0),super.update(changes)}renderSlot(name){return index_dev.qy`
  ...
  `},"./packages/textfield/sp-textfield.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_Textfield_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/textfield/src/Textfield.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-textfield",_src_Textfield_dev_js__WEBPACK_IMPORTED_MODULE_1__.qT)}}]);
//# sourceMappingURL=dialog-stories-dialog-wrapper-stories.ea3f1cb1.iframe.bundle.js.map