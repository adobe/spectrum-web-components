...
var u=Object.defineProperty;var o=(r,n,e,i)=>{for(var t=void 0,a=r.length-1,l;a>=0;a--)(l=r[a])&&(t=(l(n,e,t))||t);return t&&u(n,e,t),t};const y={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class SplitButton extends SizedMixin(PickerBase){constructor(){super(...arguments);this.left=!1;this.variant="accent";this.type="field";this.listRole="menu";this.itemRole="menuitem";}static get styles(){return [r,r$1]}get focusElement(){return this.open?this.optionsMenu:this.left?this.trigger:this.button}passClick(){const e=this.type==="more"?this.menuItems[0]:this.selectedItem||this.menuItems[0];e&&e.click();}get buttonContent(){var e;return [x`
            ...
            `]}update(e){e.has("type")&&(this.type==="more"?this.selects=void 0:this.selects="single"),super.update(e);}render(){var t;const e=["cta","accent"].includes(this.variant)?"fill":"outline",i=[x`
                <sp-button
                    aria-label=${o$1(this.label||((t=this.selectedItem)==null?void 0:t.itemText)||void 0)}
                    id="button"
            ...
            ${i} ${this.renderMenu}
        `}bindButtonKeydownListener(){this.trigger.addEventListener("keydown",this.handleKeydown);}async manageSelection(){await this.manageSplitButtonItems(),await super.manageSelection();}async manageSplitButtonItems(){!this.menuItems.length&&(await this.optionsMenu.updateComplete,!this.menuItems.length)||(this.type==="more"?(this.menuItems[0].hidden=!0,this.menuItems.forEach(e=>e.selected=!1),this.selectedItem=this.menuItems[0]):this.selectedItem=this.selectedItem||this.menuItems[0],this.value=this.selectedItem.value);}}o([n({type:Boolean,reflect:!0})],SplitButton.prototype,"left"),o([n({reflect:!0})],SplitButton.prototype,"variant"),o([n({type:String})],SplitButton.prototype,"type"),o([e(".trigger")],SplitButton.prototype,"trigger");
