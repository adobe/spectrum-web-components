...
import { b } from './opacity-checkerboard.css-aog0hna8.js';
...
var u=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var i=(d,a,e,t)=>{for(var r=t>1?void 0:t?p(a,e):a,o=d.length-1,c;o>=0;o--)(c=d[o])&&(r=(t?c(a,e,r):c(r))||r);return t&&r&&u(a,e,r),r};const y={xs:()=>x`
        <sp-icon-dash75
            slot="icon"
    ...
    `,l:()=>x`
        ...
        ></sp-icon-dash300>
    `};class Swatch extends SizedMixin(Focusable,{validSizes:["xs","s","m","l"],noDefaultSize:!0}){constructor(){super(...arguments);this.color="";this.label="";this.mixedValue=!1;this.nothing=!1;this.role="button";this.selected=!1;this.renderDisabled=()=>x`
            <svg
        ...
        `;this.renderMixedValue=()=>y[this.size]();}static get styles(){return [b,v,f]}get value(){return this._value||this.color||this.label}set value(e){if(e===this._value)return;const t=this.value;this._value=e,this.requestUpdate("value",t);}get focusElement(){return this}toggle(e){this.selected=e!=null?e:!this.selected;}handleClick(){if(this.disabled||this.mixedValue)return;this.toggle(),this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0}))||this.toggle();}handleKeydown(e){const{code:t}=e;switch(t){case"Space":e.preventDefault(),this.addEventListener("keyup",this.handleKeyup);break;}}handleKeypress(e){const{code:t}=e;switch(t){case"Enter":case"NumpadEnter":this.click();break;}}handleKeyup(e){const{code:t}=e;switch(t){case"Space":this.removeEventListener("keyup",this.handleKeyup),this.click();break;}}render(){return x`
            <div
