...
`;noCloseOnResize.swc_vrt={skip:!0},noCloseOnResize.parameters={chromatic:{disableSnapshot:!0}};const openClickContent=args=>template({...args,open:"click"}),openHoverContent=args=>template({...args,open:"hover"}),replace=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
    ...
    `;updating.swc_vrt={skip:!0},updating.parameters={chromatic:{disableSnapshot:!0}};class StartEndContextmenu extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n            <style>\n                :host {\n                    display: flex;\n                    align-items: stretch;\n                }\n                div {\n                    width: 50%;\n                    height: 100%;\n                }\n            </style>\n            <div id="start"></div>\n            <div id="end"></div>\n        '}}customElements.define("start-end-contextmenu",StartEndContextmenu);const virtualElementV1=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
        ...
        <start-end-contextmenu
            class="app-root"
            @contextmenu=${{capture:!0,handleEvent:async event=>{event.preventDefault(),event.stopPropagation();const source=event.composedPath()[0],{id:id}=source,trigger=event.target,virtualTrigger=new _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_10__.ec(event.clientX,event.clientY),fragment=document.createDocumentFragment();(0,lit_html__WEBPACK_IMPORTED_MODULE_28__.XX)(((kind="")=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
        <sp-popover
            style="width:300px;"
    ...
    `)(id),fragment);const popover=fragment.querySelector("sp-popover");(0,_spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_10__.F9)(trigger,"click",popover,{placement:args.placement,receivesFocus:"auto",virtualTrigger:virtualTrigger,offset:0,notImmediatelyClosable:!0})}}}
        ></start-end-contextmenu>
    ...
    `)(id),fragment);const popover=fragment.querySelector("sp-popover"),overlay=await(0,_spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_10__.F9)(popover,{trigger:virtualTrigger,placement:args.placement,offset:0,notImmediatelyClosable:!0,type:"auto"});trigger.insertAdjacentElement("afterend",overlay)}}}
        ></start-end-contextmenu>
    `;virtualElement.args={placement:"right-start"};const virtualElementDeclaratively=args=>{const overlay=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
        <sp-overlay
            ...
            .triggerElement=${new _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_10__.ec(0,0)}
        >
            <sp-popover
                style="width:300px;"
    ...
    `;return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
        ...
        <div
            class="app-root"
            @contextmenu=${{capture:!0,handleEvent:async event=>{event.preventDefault(),event.stopPropagation();const overlay2=document.querySelector("sp-overlay:not([open])");overlay2.triggerElement instanceof _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_10__.ec&&overlay2.triggerElement.updateBoundingClientRect(event.clientX,event.clientY),overlay2.willPreventClose=!0,overlay2.open=!0}}}
        >
            ${overlay()} ${overlay()}
        </div>
    ...
    `,pickerInDialog=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_2__.qy`
