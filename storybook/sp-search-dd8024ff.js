...
import { T as Textfield } from './Textfield-a0f64496.js';
...
var d=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var r=(o,s,e,t)=>{for(var i=t>1?void 0:t?c(s,e):s,n=o.length-1,p;n>=0;n--)(p=o[n])&&(i=(t?p(s,e,i):p(i))||i);return t&&i&&d(s,e,i),i};const v=o=>o.stopPropagation();class Search extends Textfield{constructor(){super(...arguments);this.action="";this.label="Search";this.placeholder="Search";}static get styles(){return [...super.styles,f]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault();}handleKeydown(e){const{code:t}=e;!this.value||t!=="Escape"||this.reset();}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}));}renderField(){return x`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search");}willUpdate(){this.multiline=!1;}}r([n()],Search.prototype,"action",2),r([n()],Search.prototype,"label",2),r([n()],Search.prototype,"method",2),r([n()],Search.prototype,"placeholder",2),r([i$1("#form")],Search.prototype,"form",2);
