...
import { S as ScaledIndicator, g, b, v } from './tab.css-2694ea48.js';
...
var u=Object.defineProperty;var m=Object.getOwnPropertyDescriptor;var s=(n,o,e,t)=>{for(var i=t>1?void 0:t?m(o,e):o,d=n.length-1,l;d>=0;d--)(l=n[d])&&(i=(t?l(o,e,i):l(i))||i);return t&&i&&u(o,e,i),i};const c$2="transform: translateX(0px) scaleX(0) scaleY(0)";class TopNav extends SizedMixin(SpectrumElement){constructor(){super(...arguments);this.selectionIndicatorStyle=c$2;this.shouldAnimate=!1;this.quiet=!1;this.onClick=e=>{const t=e.target;this.shouldAnimate=!0,this.selectTarget(t);};this._items=[];this.resizeController=new s$1(this,{callback:()=>{this.updateSelectionIndicator();}});this.updateSelectionIndicator=async()=>{const e=this.items.find(i=>i.value===this.selected||i.value===window.location.href);if(!e){this.selectionIndicatorStyle=c$2;return}await Promise.all([e.updateComplete,document.fonts?document.fonts.ready:Promise.resolve()]);const{width:t}=e.getBoundingClientRect();this.selectionIndicatorStyle=ScaledIndicator.transformX(e.offsetLeft,t);};}static get styles(){return [g,b,ScaledIndicator.baseStyles()]}set selected(e){const t=this.selected;e!==t&&(this.updateCheckedState(e),this._selected=e,this.requestUpdate("selected",t));}get selected(){return this._selected}get items(){return this._items}set items(e){e!==this.items&&(this._items.forEach(t=>{this.resizeController.unobserve(t);}),e.forEach(t=>{this.resizeController.observe(t);}),this._items=e);}manageItems(){this.items=this.slotEl.assignedElements({flatten:!0}).filter(t=>t.localName==="sp-top-nav-item");const e=this.items.find(t=>t.value===window.location.href);e&&this.selectTarget(e);}render(){return x`
