import { C as CheckboxBase } from './CheckboxBase-0ccf48c8.js';
import './sp-icon-checkmark300-36d623be.js';
import { S as S$1 } from './spectrum-icon-checkmark.css-a8f99d4c.js';
...
var l=Object.defineProperty;var n=Object.getOwnPropertyDescriptor;var i=(a,s,t,c)=>{for(var r=c>1?void 0:c?n(s,t):s,o=a.length-1,p;o>=0;o--)(p=a[o])&&(r=(c?p(s,t,r):p(r))||r);return c&&r&&l(s,t,r),r};const f={s:x`
    ...
    `,xl:x`
        ...
        ></sp-icon-dash300>
    `};class Checkbox extends SizedMixin(CheckboxBase,{noDefaultSize:!0}){constructor(){super(...arguments);this.indeterminate=!1;this.invalid=!1;this.emphasized=!1;}static get styles(){return [u,S$1,f$1]}handleChange(){this.indeterminate=!1,super.handleChange();}render(){return x`
            ${super.render()}
            <span id="box">
                ${f[this.size]}
                ${S[this.size]}
