...
const CopyIcon=({width:t=24,height:r=24,hidden:h=!1,title:e="Copy"}={})=>tag`<svg
...
const DeleteIcon=({width:a=24,height:e=24,hidden:t=!1,title:l="Delete"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${a}"
...
export { CopyIcon as C, DeleteIcon as D };
