...
var a=Object.defineProperty;var o$1=(s,r,e,i)=>{for(var t=void 0,l=s.length-1,d;l>=0;l--)(d=s[l])&&(t=(d(r,e,t))||t);return t&&a(r,e,t),t};class SideNavHeading extends SpectrumElement{constructor(){super(...arguments);this.label="";}static get styles(){return [t$1,t]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e);}render(){return x`
