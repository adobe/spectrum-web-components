...
import { n as n$1, S as SpectrumElement } from './define-element-CuLWp0nJ.js';
...
import { r as r$2 } from './state-BIupEmlh.js';
...
var u=Object.defineProperty;var a=(s,i,e,r)=>{for(var t=void 0,l=s.length-1,o;l>=0;l--)(o=s[l])&&(t=(o(i,e,t))||t);return t&&u(i,e,t),t};class BreadcrumbItem extends LikeAnchor(Focusable){constructor(){super(...arguments);this.value=void 0;this.isLastOfType=!1;}static get styles(){return [e,r$1]}get focusElement(){return this.shadowRoot.querySelector("#item-link")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","listitem");}announceSelected(e){const r={value:e},t=new CustomEvent("breadcrumb-select",{bubbles:!0,composed:!0,detail:r});this.dispatchEvent(t);}handleClick(e){!this.href&&e&&e.preventDefault(),(!this.href||e!=null&&e.defaultPrevented)&&this.value&&!this.isLastOfType&&this.announceSelected(this.value);}renderLink(){return x`
            <a
                id="item-link"
