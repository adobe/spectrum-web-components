/*! For license information please see overlay-stories-overlay-directive-stories.15fdcb2d.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[2042],{"./packages/overlay/stories/overlay-directive.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:function(){return Default},__namedExportsOrder:function(){return __namedExportsOrder},configured:function(){return configured},default:function(){return overlay_directive_stories},insertionOptions:function(){return insertionOptions},managedOverlayTrigger:function(){return managedOverlayTrigger}});var lit_html=__webpack_require__("../node_modules/lit-html/development/lit-html.js"),directive=__webpack_require__("../node_modules/lit-html/development/directive.js"),directive_helpers=__webpack_require__("../node_modules/lit-html/development/directive-helpers.js");const getStringsFromTemplateResult=result=>(0,directive_helpers.ps)(result)?result._$litType$.h:result.strings;class CacheDirective extends directive.WL{constructor(partInfo){super(partInfo),this._templateCache=new WeakMap}render(v){return[v]}update(containerPart,[v]){const _valueKey=(0,directive_helpers.qb)(this._value)?getStringsFromTemplateResult(this._value):null,vKey=(0,directive_helpers.qb)(v)?getStringsFromTemplateResult(v):null;if(null!==_valueKey&&(null===vKey||_valueKey!==vKey)){const childPart=(0,directive_helpers.cN)(containerPart).pop();let cachedContainerPart=this._templateCache.get(_valueKey);if(void 0===cachedContainerPart){const fragment=document.createDocumentFragment();cachedContainerPart=(0,lit_html.XX)(lit_html.s6,fragment),cachedContainerPart.setConnected(!1),this._templateCache.set(_valueKey,cachedContainerPart)}(0,directive_helpers.mY)(cachedContainerPart,[childPart]),(0,directive_helpers.Dx)(cachedContainerPart,void 0,childPart)}if(null!==vKey){if(null===_valueKey||_valueKey!==vKey){const cachedContainerPart=this._templateCache.get(vKey);if(void 0!==cachedContainerPart){const cachedPart=(0,directive_helpers.cN)(cachedContainerPart).pop();(0,directive_helpers.Jz)(containerPart),(0,directive_helpers.Dx)(containerPart,void 0,cachedPart),(0,directive_helpers.mY)(containerPart,[cachedPart])}}this._value=v}else this._value=void 0;return this.render(v)}}const cache=(0,directive.u$)(CacheDirective);var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js"),directives_dev=__webpack_require__("./tools/base/src/directives.dev.js"),overlay_trigger_directive_dev=__webpack_require__("./packages/overlay/src/overlay-trigger-directive.dev.js"),tooltip_directive_dev=__webpack_require__("./packages/tooltip/src/tooltip-directive.dev.js"),__defProp=(__webpack_require__("./packages/action-button/sp-action-button.dev.js"),__webpack_require__("./packages/action-group/sp-action-group.dev.js"),__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/dialog/sp-dialog-wrapper.dev.js"),__webpack_require__("./packages/field-label/sp-field-label.dev.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-magnify.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-open-in.js"),__webpack_require__("./packages/overlay/overlay-trigger.dev.js"),__webpack_require__("./packages/dialog/sp-dialog.dev.js"),__webpack_require__("./packages/picker/sp-picker.dev.js"),__webpack_require__("./packages/menu/sp-menu.dev.js"),__webpack_require__("./packages/menu/sp-menu-item.dev.js"),__webpack_require__("./packages/menu/sp-menu-divider.dev.js"),__webpack_require__("./packages/popover/sp-popover.dev.js"),__webpack_require__("./packages/slider/sp-slider.dev.js"),__webpack_require__("./packages/switch/sp-switch.dev.js"),__webpack_require__("./packages/radio/sp-radio.dev.js"),__webpack_require__("./packages/radio/sp-radio-group.dev.js"),__webpack_require__("./packages/tooltip/sp-tooltip.dev.js"),__webpack_require__("./tools/theme/sp-theme.dev.js"),__webpack_require__("./tools/theme/src/themes.dev.js"),__webpack_require__("./packages/accordion/sp-accordion.dev.js"),__webpack_require__("./packages/accordion/sp-accordion-item.dev.js"),__webpack_require__("./packages/overlay/stories/overlay-story-components.js"),Object.defineProperty),__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const storyStyles=index_dev.qy`
  <style>
    html,
    body,
    #root,
            ...
            ${(0,overlay_trigger_directive_dev.h)(()=>index_dev.qy`
                <sp-popover placement="bottom" tip open>
                  <sp-dialog size="s" no-divider>
                    <div class="options-popover-content">Another Popover</div>
                  </sp-dialog>
                </sp-popover>
...
`;insertionOptions.args={insertionOptions:{el:()=>document.querySelector("#other-element"),where:"afterbegin"}},insertionOptions.swc_vrt={skip:!0},insertionOptions.parameters={chromatic:{disableSnapshot:!0}};class ManagedOverlayTrigger extends index_dev.WF{constructor(){super(...arguments),this.quickActionsEnabled=!1,this.isMenuOpen=!1}render(){return index_dev.qy`
      ...
      >
        ...
        >
          ...
          <code>cache()</code>
          directive, which preserves the DOM and component state when toggled
          off instead of destroying it. This tests that the overlay trigger
          properly handles reconnection without errors.
        </p>
...
//# sourceMappingURL=overlay-stories-overlay-directive-stories.15fdcb2d.iframe.bundle.js.map