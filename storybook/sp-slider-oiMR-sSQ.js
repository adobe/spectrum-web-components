import { F as Focusable } from './focusable-mx5LgJ38.js';
...
import { O as ObserveSlotText } from './observe-slot-text-eZT7feU8.js';
...
var v=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var r=(d,o,e,t)=>{for(var i=t>1?void 0:t?f(o,e):o,l=d.length-1,n;l>=0;l--)(n=d[l])&&(i=(t?n(o,e,i):n(i))||i);return t&&i&&v(o,e,i),i};const variants=["filled","ramp","range","tick"];class Slider extends SizedMixin(ObserveSlotText(SliderHandle,""),{noDefaultSize:!0,validSizes:["s","m","l","xl"]}){constructor(){super(...arguments);this.handleController=new HandleController(this);this._editable=!1;this.hideStepper=!1;this.type="";this._variant="";this.getAriaValueText=e=>{const t=[...e.values()];return t.length===2?`${t[0]} - ${t[1]}`:t.join(", ")};this.min=0;this.max=100;this.step=1;this.tickStep=0;this.tickLabels=!1;this.disabled=!1;this.quiet=!1;this.indeterminate=!1;this._numberFieldInput=Promise.resolve();}static get styles(){return [$]}get editable(){return this._editable}set editable(e){if(e===this.editable)return;const t=this.editable;this._editable=this.handleController.size<2?e:!1,this.editable&&(this._numberFieldInput=import('./sp-number-field-5-PFYxCz.js')),t!==this.editable&&this.requestUpdate("editable",t);}set variant(e){const t=this.variant;e!==this.variant&&(variants.includes(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",t));}get variant(){return this._variant}get values(){return this.handleController.values}get handleName(){return "value"}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.handleController.formattedValues):`${this.value}${this._forcedUnit}`}get numberFormat(){return this.getNumberFormat()}get focusElement(){return this.handleController.focusElement}handleLabelClick(e){this.editable&&(e.preventDefault(),this.focus());}render(){return x`
        ...
        `}renderTicks(){if(this.variant!=="tick")return x``;const e=this.tickStep||this.step,t=(this.max-this.min)/e,i=t%1!==0,l$1=new Array(Math.floor(t+1));return l$1.fill(0,0,t+1),x`
            <div
        ...
        `}renderTrackSegment(e,t){return this.variant==="ramp"?x``:x`
            <div
                ...
                role="presentation"
            ></div>
        `}getOffsetWidth(e,t){return Math.abs(t-e)/(this.max-this.min)*100}getOffsetPosition(e){return (e-this.min)/(this.max-this.min)*100}fillStyles(e){const t=this.dir==="rtl"?"right":"left",i=this.value>e?this.getOffsetPosition(e):this.getOffsetPosition(this.value),l=this.getOffsetWidth(e,this.value);return {[t]:`${i}%`,width:`${l}%`}}renderFillOffset(){return !this._cachedValue||!this.centerPoint?x``:x`
            <div
                class=${o$1({fill:!0,offset:this.value>this.centerPoint})}
                style=${o$2(this.fillStyles(this.centerPoint))}
            ></div>
        `}renderTrack(){const e=this.handleController.trackSegments(),t=[{id:"handles",html:this.handleController.render()}],i=[{id:"track0",html:this.renderTrackSegment(...e[0])},{id:"ramp",html:this.renderRamp()},...e.slice(1).map(([l,n],u)=>({id:`track${u+1}`,html:this.renderTrackSegment(l,n)})),{id:"fill",html:this.renderFillOffset()}];return x`
            <div
                id="track"
        ...
        `}handlePointerdown(e){this.handleController.handlePointerdown(e);}handlePointermove(e){this.handleController.handlePointermove(e);}handlePointerup(e){this.handleController.handlePointerup(e);}handleNumberInput(e){var i;const{value:t}=e.target;if((i=e.target)!=null&&i.managedInput&&!isNaN(t)){this.value=t;return}e.stopPropagation();}handleNumberChange(e){var i;const{value:t}=e.target;isNaN(t)?(e.target.value=this.value,e.stopPropagation()):(this.value=t,(i=e.target)!=null&&i.managedInput||this.dispatchInputEvent()),this.indeterminate=!1;}trackSegmentStyles(e,t){const i=t-e;return {width:`${i*100}%`,...this.handleController.size>1&&{"--spectrum-slider-track-background-size":`${1/i*100}%`,"--spectrum-slider-track-segment-position":`${e*100}%`}}}async getUpdateComplete(){const e=await super.getUpdateComplete();return this.editable&&(await this._numberFieldInput,await this.numberField.updateComplete),await this.handleController.handleUpdatesComplete(),e}willUpdate(e){e.has("value")&&e.has("fillStart")&&(this._cachedValue=Number(this.value),this.fillStart?this.centerPoint=Number(this.fillStart):this.centerPoint=(Number(this.max)-Number(this.min))/2+Number(this.min));}}r([n({type:Boolean,reflect:!0})],Slider.prototype,"editable",1),r([n({type:Boolean,reflect:!0,attribute:"hide-stepper"})],Slider.prototype,"hideStepper",2),r([n()],Slider.prototype,"type",2),r([n({reflect:!0})],Slider.prototype,"dir",2),r([n({type:String})],Slider.prototype,"variant",1),r([n({attribute:!1})],Slider.prototype,"getAriaValueText",2),r([n({type:String,reflect:!0,attribute:"label-visibility"})],Slider.prototype,"labelVisibility",2),r([n({type:Number,reflect:!0})],Slider.prototype,"min",2),r([n({type:Number,reflect:!0})],Slider.prototype,"max",2),r([n({type:Number})],Slider.prototype,"step",2),r([n({type:Number,attribute:"tick-step"})],Slider.prototype,"tickStep",2),r([n({type:Boolean,attribute:"tick-labels"})],Slider.prototype,"tickLabels",2),r([n({type:Boolean,reflect:!0})],Slider.prototype,"disabled",2),r([n({type:Number,reflect:!0,attribute:"fill-start"})],Slider.prototype,"fillStart",2),r([n({type:Boolean})],Slider.prototype,"quiet",2),r([n({type:Boolean})],Slider.prototype,"indeterminate",2),r([i$1("#label")],Slider.prototype,"labelEl",2),r([i$1("#number-field")],Slider.prototype,"numberField",2),r([i$1("#track")],Slider.prototype,"track",2);
