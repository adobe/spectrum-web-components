"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[6526],{"./packages/button/sp-clear-button.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_ClearButton_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/button/src/ClearButton.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-clear-button",_src_ClearButton_dev_js__WEBPACK_IMPORTED_MODULE_1__.k)},"./packages/divider/src/divider.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const i=__webpack_require__("./tools/base/src/index.dev.js").AH`
...
`;headersAndIcons.storyName="Headers and Icons";const Selected=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,selectedOffPage=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <p style="height: 100vh; padding-bottom: 50px;">
      In this example the \`&lt;sp-menu-item selected&gt;\` element is off the
      visible page by default, but does not alter the page scroll on load.
    </p>
    <sp-menu>
  ...
  `;headersAndIcons.storyName="Dynamic MenuItems";const dynamicRemoval=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <sp-menu id="casey" selects="single">
      <sp-menu-item>Deselect</sp-menu-item>
      <sp-menu-item>Select Inverse</sp-menu-item>
      <sp-menu-item id="nikkimk" @focus=${async function(event){var _a,_b;await(null==(_a=event.target)?void 0:_a.updateComplete),null==(_b=event.target)||_b.remove()}}>Feather...</sp-menu-item>
      <sp-menu-item selected>Select and Mask...</sp-menu-item>
      <sp-menu-item>Save Selection</sp-menu-item>
      <sp-menu-item disabled>Make Work Path</sp-menu-item>
    </sp-menu>
  `,InputsWithMenu=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div style="padding: 20px; max-width: 600px;">
      ...
      <p>
        Try typing in any input field below, then hover over the menu items. The
        input should maintain focus and not be interrupted. This demonstrates
        the fix for focus stealing from all supported input types.
      </p>
