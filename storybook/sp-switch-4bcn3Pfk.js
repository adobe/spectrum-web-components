...
import { C as CheckboxMixin } from './CheckboxMixin-y5AyDPUX.js';
...
class CheckboxBase extends CheckboxMixin(Focusable){get focusElement(){return this.inputElement}}
...
var d=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var p=(s,r,e,i)=>{for(var t=i>1?void 0:i?u(r,e):r,o=s.length-1,l;o>=0;o--)(l=s[o])&&(t=(i?l(r,e,t):l(t))||t);return i&&t&&d(r,e,t),t};class Switch extends SizedMixin(CheckboxBase){constructor(){super(...arguments);this.emphasized=!1;}static get styles(){return window.hasOwnProperty("ShadyDOM")?[a,f]:[a]}render(){return x`
            ${super.render()}
            <span id="switch"></span>
            <label id="label" for="input"><slot></slot></label>
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("role","switch");}updated(e){e.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false");}}p([n({type:Boolean,reflect:!0})],Switch.prototype,"emphasized",2);
