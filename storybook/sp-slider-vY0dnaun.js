...
var v=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var r=(d,o,e,t)=>{for(var i=t>1?void 0:t?f(o,e):o,l=d.length-1,n;l>=0;l--)(n=d[l])&&(i=(t?n(o,e,i):n(i))||i);return t&&i&&v(o,e,i),i};const variants=["filled","ramp","range","tick"];class Slider extends SizedMixin(ObserveSlotText(SliderHandle,""),{noDefaultSize:!0,validSizes:["s","m","l","xl"]}){constructor(){super(...arguments);this.handleController=new HandleController(this);this._editable=!1;this.hideStepper=!1;this.type="";this._variant="";this.getAriaValueText=e=>{const t=[...e.values()];return t.length===2?`${t[0]} - ${t[1]}`:t.join(", ")};this.min=0;this.max=100;this.step=1;this.tickStep=0;this.tickLabels=!1;this.disabled=!1;this.quiet=!1;this.indeterminate=!1;this._numberFieldInput=Promise.resolve();}static get styles(){return [$]}get editable(){return this._editable}set editable(e){if(e===this.editable)return;const t=this.editable;this._editable=this.handleController.size<2?e:!1,this.editable&&(this._numberFieldInput=import('./sp-number-field-e2zYkBm4.js')),t!==this.editable&&this.requestUpdate("editable",t);}set variant(e){const t=this.variant;e!==this.variant&&(variants.includes(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",t));}get variant(){return this._variant}get values(){return this.handleController.values}get handleName(){return "value"}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.handleController.formattedValues):`${this.value}${this._forcedUnit}`}get numberFormat(){return this.getNumberFormat()}get focusElement(){return this.handleController.focusElement}handleLabelClick(e){this.editable&&(e.preventDefault(),this.focus());}render(){return x`
        ...
        `}getOffsetWidth(e,t){return Math.abs(t-e)/(this.max-this.min)*100}getOffsetPosition(e){return (e-this.min)/(this.max-this.min)*100}fillStyles(e){const t=this.dir==="rtl"?"right":"left",i=this.value>e?this.getOffsetPosition(e):this.getOffsetPosition(this.value),l=this.getOffsetWidth(e,this.value);return {[t]:`${i}%`,width:`${l}%`}}renderFillOffset(){return !this._cachedValue||!this.centerPoint?x``:x`
            ...
            ></div>
        `}renderTrack(){const e=this.handleController.trackSegments(),t=[{id:"handles",html:this.handleController.render()}],i=[{id:"track0",html:this.renderTrackSegment(...e[0])},{id:"fill",html:this.renderFillOffset()},{id:"ramp",html:this.renderRamp()},...e.slice(1).map(([l,n],u)=>({id:`track${u+1}`,html:this.renderTrackSegment(l,n)}))];return x`
            <div
                id="track"
