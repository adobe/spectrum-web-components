...
import { O as ObserveSlotText } from './observe-slot-text-DjQnHXP-.js';
...
var u=Object.defineProperty;var h=Object.getOwnPropertyDescriptor;var i=(s,o,e,l)=>{for(var t=l>1?void 0:l?h(o,e):o,n=s.length-1,a;n>=0;n--)(a=s[n])&&(t=(l?a(o,e,t):a(t))||t);return l&&t&&u(o,e,t),t};class ActionMenu extends ObserveSlotPresence(ObserveSlotText(PickerBase,"label"),'[slot="label-only"]'){constructor(){super(...arguments);this.selects=void 0;this.static=void 0;this.listRole="menu";this.itemRole="menuitem";this.handleSlottableRequest=e=>{this.dispatchEvent(new SlottableRequestEvent(e.name,e.data));};}static get styles(){return [o]}get hasLabel(){return this.slotHasContent}get labelOnly(){return this.slotContentIsPresent}get buttonContent(){return [x`
        ...
        `}update(e){e.has("invalid")&&(this.invalid=!1),super.update(e);}}i([n({type:String})],ActionMenu.prototype,"selects",2),i([n({type:String,reflect:!0})],ActionMenu.prototype,"static",2),i([n({reflect:!0,attribute:"static-color"})],ActionMenu.prototype,"staticColor",2),i([r()],ActionMenu.prototype,"labelOnly",1);
