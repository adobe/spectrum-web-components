...
import { x, A as A$1 } from './lit-html-GmIhAbMP.js';
import { d as defineElement, S as SpectrumElement, n } from './define-element-tO8-r1bu.js';
import { i } from './lit-element-xBOPiTek.js';
import { c as conditionAttributeWithId, a as conditionAttributeWithoutId } from './condition-attribute-with-id-nb2zon-s.js';
...
const Asterisk100Icon=({width:t=24,height:l=24,title:e="Asterisk100"}={})=>tag`<svg
...
class IconAsterisk100 extends IconBase{render(){return setCustomTemplateLiteralTag(x),Asterisk100Icon()}}
...
var c=Object.defineProperty;var d=Object.getOwnPropertyDescriptor;var o=(n,l,e,i)=>{for(var t=i>1?void 0:i?d(l,e):l,s=n.length-1,r;s>=0;s--)(r=n[s])&&(t=(i?r(l,e,t):r(t))||t);return i&&t&&c(l,e,t),t};class FieldLabel extends SizedMixin(SpectrumElement,{noDefaultSize:!0}){constructor(){super(...arguments);this.disabled=!1;this.id="";this.for="";this.required=!1;this.resolvedElement=new ElementResolutionController(this);}static get styles(){return [A,g]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const i=this.getRootNode(),t=this.target,s=t.getRootNode(),r=s.host;s===i&&t.forceFocusVisible?t.forceFocusVisible():r&&r.forceFocusVisible&&r.forceFocusVisible();}applyTargetLabel(e){if(this.target=e||this.target,this.target){const i=this.target.applyFocusElementLabel,t=this.target.focusElement||this.target,s=t.getRootNode();typeof i!="undefined"?i(this.labelText,this):s===this.getRootNode()?(e?conditionAttributeWithId:conditionAttributeWithoutId)(t,"aria-labelledby",[this.id]):e?t.setAttribute("aria-label",this.labelText):t.removeAttribute("aria-label");}}async manageTarget(){this.applyTargetLabel();const e=this.resolvedElement.element;if(!e){this.target=e;return}e.localName.search("-")>0&&await customElements.whenDefined(e.localName),typeof e.updateComplete!="undefined"&&await e.updateComplete,this.applyTargetLabel(e);}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});return e.length?e.map(t=>(t.textContent||"").trim()).join(" "):""}render(){return x`
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick);}willUpdate(e){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${randomID()}`),e.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(e.has("id")||e.has(elementResolverUpdatedSymbol))&&this.manageTarget();}}o([n({type:Boolean,reflect:!0})],FieldLabel.prototype,"disabled",2),o([n({type:String})],FieldLabel.prototype,"id",2),o([n({type:String})],FieldLabel.prototype,"for",2),o([n({type:Boolean,reflect:!0})],FieldLabel.prototype,"required",2),o([i$1("slot")],FieldLabel.prototype,"slotEl",2),o([n({type:String,reflect:!0,attribute:"side-aligned"})],FieldLabel.prototype,"sideAligned",2);
