...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class ButtonBase extends((0,observe_slot_text_dev.O)((0,like_anchor_dev.$)(focusable_dev.z),"",["sp-overlay,sp-tooltip"])){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[button_base_css]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[index_dev.qy`
            ...
            `]}handleClickCapture(event){if(this.disabled)return event.preventDefault(),event.stopImmediatePropagation(),event.stopPropagation(),!1;this.shouldProxyClick(event)}proxyFocus(){this.focus()}shouldProxyClick(event){let handled=!1;if(this.href&&this.href.length>0)return!1;if(event&&(event.metaKey||event.ctrlKey||event.shiftKey||event.altKey))return!1;if(this.anchorElement)this.anchorElement.click(),handled=!0;else if("button"!==this.type){const proxy=document.createElement("button");proxy.type=this.type,this.insertAdjacentElement("afterend",proxy),proxy.click(),proxy.remove(),handled=!0}return handled}renderAnchor(){return index_dev.qy`
            ${this.buttonContent}
...
`,spectrum_icon_cross_css=(__webpack_require__("./packages/icons-ui/icons/sp-icon-cross75.js"),__webpack_require__("./packages/icons-ui/icons/sp-icon-cross100.js"),__webpack_require__("./packages/icons-ui/icons/sp-icon-cross200.js"),__webpack_require__("./packages/icons-ui/icons/sp-icon-cross300.js"),__webpack_require__("./packages/icon/src/spectrum-icon-cross.css.js")),__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const crossIcon={s:()=>index_dev.qy`
    ...
    `,xl:()=>index_dev.qy`
        ...
        ></sp-icon-cross300>
    `};class ClearButton extends((0,index_dev.ZG)(StyledButton_dev.O,{noDefaultSize:!0})){constructor(){super(...arguments),this.quiet=!1}static get styles(){return[...super.styles,clear_button_css,spectrum_icon_cross_css.A]}set variant(variant){const oldValue=this._variant,oldStaticColor=this.staticColor;if("overBackground"!==variant)return this.removeAttribute("variant"),this._variant=void 0,void(this.staticColor=void 0);this.setAttribute("variant",variant),this._variant=variant,this.staticColor="white",window.__swc.warn(this,'The overBackground variant is deprecated. Please use `static-color="white"` instead.',"https://opensource.adobe.com/spectrum-web-components/components/clear-button/",{level:"deprecation"}),this.requestUpdate("variant",oldValue),this.requestUpdate("staticColor",oldStaticColor)}get variant(){return this._variant}get buttonContent(){return[crossIcon[this.size]()]}render(){return index_dev.qy`
            <div class="fill">${super.render()}</div>
        `}}__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],ClearButton.prototype,"quiet",2),__decorateClass([(0,decorators_dev.MZ)({reflect:!0})],ClearButton.prototype,"variant",1),__decorateClass([(0,decorators_dev.MZ)({reflect:!0,attribute:"static-color"})],ClearButton.prototype,"staticColor",2)},"./packages/button/src/StyledButton.dev.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{O:function(){return StyledButton}});var _ButtonBase_dev_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./packages/button/src/ButtonBase.dev.js");class StyledButton extends _ButtonBase_dev_js__WEBPACK_IMPORTED_MODULE_0__.u{}},"./packages/icon/src/spectrum-icon-cross.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const c=__webpack_require__("./tools/base/src/index.dev.js").AH`
...
//# sourceMappingURL=7994.946c40c4.iframe.bundle.js.map