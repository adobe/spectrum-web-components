"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[1335,9685],{"./packages/dialog/stories/dialog-base.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:function(){return __namedExportsOrder},default:function(){return dialog_base_stories},disabledButton:function(){return disabledButton},fullyCustom:function(){return fullyCustom},lazyLoaded:function(){return lazyLoaded},moreCustom:function(){return moreCustom},notAgain:function(){return notAgain},slotted:function(){return slotted}});var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),src_index_dev=__webpack_require__("./packages/overlay/src/index.dev.js"),dialog_stories=(__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/checkbox/sp-checkbox.dev.js"),__webpack_require__("./packages/dialog/sp-dialog-base.dev.js"),__webpack_require__("./packages/dialog/sp-dialog.dev.js"),__webpack_require__("./packages/dialog/stories/dialog.stories.js")),stories_images=__webpack_require__("./packages/dialog/stories/images.js");__webpack_require__("./packages/overlay/sp-overlay.dev.js");class CountdownWatcher extends HTMLElement{constructor(){super(...arguments),this.readyPromise=Promise.resolve(!1)}connectedCallback(){this.previousElementSibling.addEventListener("countdown-complete",()=>{this.ready(!0)}),this.readyPromise=new Promise(res=>{this.ready=res})}get updateComplete(){return this.readyPromise}}customElements.define("countdown-complete-watcher",CountdownWatcher);const withOverlayDecorator=story=>index_dev.qy`
...
`;slotted.decorators=[withOverlayDecorator];const disabledButton=()=>index_dev.qy`
    ...
    >
      <sp-dialog size="s">
        ...
        <sp-button disabled slot="button" id="changing-button">Ok</sp-button>
      </sp-dialog>
    </sp-dialog-base>
  ...
  >
    <div style="display: flex;">
      ...
      <sp-dialog size="s">
        ...
        <p>
          Its position has been customized beyond the language of Spectrum. Be
          careful with all this power. There's no "mobile" default for
          delivering content like this.
        </p>
...
`;moreCustom.decorators=[withOverlayDecorator];const fullyCustom=()=>index_dev.qy`
  ...
  >
    <div id="fully-custom-dialog">
      ...
      <p>
        The click events for the "Done" button are bound to the story not to the
        components in specific.
      </p>
      <p>
        This is a demonstration of what is possible with &lt;sp-dialog-base&gt;,
        only, and should not be seen as an endorsement for fully custom dialog
        UIs.
      </p>
...
`;fullyCustom.decorators=[withOverlayDecorator];const lazyLoaded=()=>index_dev.qy`
    ...
    >
      <sp-dialog size="m">
        ...
        <p>
          The click on the "OK" button should close the overlay with the correct
          animation (duration).
        </p>
        <sp-button variant="secondary" treatment="fill" slot="button">
          Ok
...
`;nestedModalOverlays.swc_vrt={skip:!0},nestedModalOverlays.parameters={chromatic:{disableSnapshot:!0}};const modalClickBlocking=()=>index_dev.qy`
  <div style="padding: 20px;">
...
`;modalClickBlocking.swc_vrt={skip:!0},modalClickBlocking.parameters={tags:["!dev"],chromatic:{disableSnapshot:!0}};const focusableAncestorWrapper=()=>index_dev.qy`
  <div
  ...
  >
    ...
    >
      ...
      >
        <sp-popover style="padding: 10px">
          <button
            @pointerdown=${()=>{var _a;return null==(_a=document.getElementById("focusable-ancestor-outside-input-4"))?void 0:_a.focus()}}
          >
...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class MenuGroup extends Menu_dev.W{constructor(){super(...arguments),this.headerId=""}static get styles(){return[...super.styles,menu_group_css]}get ownRole(){return"group"}get controlsRovingTabindex(){return!1}updateLabel(){const headerElement=this.headerElements.length?this.headerElements[0]:void 0;if(headerElement!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),headerElement){this.headerId=this.headerId||`sp-menu-group-label-${(0,random_id_dev.l)()}`;const headerId=headerElement.id||this.headerId;headerElement.id||(headerElement.id=headerId),this.setAttribute("aria-labelledby",headerId)}else this.removeAttribute("aria-labelledby");this.headerElement=headerElement}render(){return index_dev.qy`
    ...
    `}}__decorateClass([(0,decorators_dev.gZ)({slot:"header",flatten:!0})],MenuGroup.prototype,"headerElements",2),__decorateClass([(0,decorators_dev.wk)()],MenuGroup.prototype,"headerElement",2),(0,define_element_dev.e)("sp-menu-group",MenuGroup)},"./packages/textfield/sp-textfield.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_Textfield_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/textfield/src/Textfield.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-textfield",_src_Textfield_dev_js__WEBPACK_IMPORTED_MODULE_1__.qT)}}]);
//# sourceMappingURL=overlay-stories-overlay-element-stories.127f365a.iframe.bundle.js.map