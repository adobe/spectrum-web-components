...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};const validSizes=[50,75,100,200,300,400,500,600,700],defaultSize=validSizes[2];class Avatar extends((0,like_anchor_dev.$)(focusable_dev.z)){constructor(){super(...arguments),this.src="",this.isDecorative=!1,this._size=defaultSize}static get styles(){return[avatar_css]}get focusElement(){return this.anchorElement||this}get size(){return this._size}set size(value){const size=value,validSize=validSizes.includes(size)?size:defaultSize;if(validSize&&this.setAttribute("size",`${validSize}`),this._size===validSize)return;const oldSize=this._size;this._size=validSize,this.requestUpdate("size",oldSize)}render(){let ariaHidden,altValue="";this.label?(altValue=this.label,ariaHidden=void 0):this.isDecorative?(altValue="",ariaHidden=this.href?void 0:"true"):(altValue="",ariaHidden=void 0);const avatar=index_dev.qy`
            <img
                class="image"
                alt=${altValue}
                aria-hidden=${(0,directives_dev.JR)(ariaHidden)}
                src=${this.src}
            />
        `;return this.href?this.renderAnchor({id:"link",className:"link",anchorContent:avatar}):avatar}firstUpdated(changes){super.firstUpdated(changes),this.hasAttribute("size")||this.setAttribute("size",`${this.size}`),this.warnMissingAlt()}updated(changes){super.updated(changes),(changes.has("label")||changes.has("isDecorative")||changes.has("href"))&&this.warnMissingAlt()}warnMissingAlt(){this.label||this.isDecorative?this.isDecorative&&this.href&&!this.label&&window.__swc.warn(this,`<${this.localName}> with \`is-decorative\` and \`href\` requires a \`label\` attribute for the link to be accessible.`,"https://opensource.adobe.com/spectrum-web-components/components/avatar/#accessibility",{type:"accessibility",issues:["Provide a `label` attribute to give the link an accessible name.","Decorative avatars should typically not be interactive links."]}):window.__swc.warn(this,`<${this.localName}> needs either a \`label\` attribute or \`is-decorative\` attribute to be accessible.`,"https://opensource.adobe.com/spectrum-web-components/components/avatar/#accessibility",{type:"accessibility",issues:["Provide a `label` attribute with meaningful alternative text for the avatar image, or","Set `is-decorative` attribute to mark the avatar as decorative (hidden from screen readers)."]})}}__decorateClass([(0,decorators_dev.P)("#link")],Avatar.prototype,"anchorElement",2),__decorateClass([(0,decorators_dev.MZ)()],Avatar.prototype,"src",2),__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0,attribute:"is-decorative"})],Avatar.prototype,"isDecorative",2),__decorateClass([(0,decorators_dev.MZ)({type:Number,reflect:!0})],Avatar.prototype,"size",1),(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-avatar",Avatar)},"./packages/divider/src/divider.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const i=__webpack_require__("./tools/base/src/index.dev.js").AH`
...
//# sourceMappingURL=top-nav-stories-top-nav-stories.b54e90d9.iframe.bundle.js.map