import { g as getLabelFromSlot } from './get-label-from-slot-948d250c.js';
...
var p=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var i=(o,s,e,r)=>{for(var t=r>1?void 0:r?c(s,e):s,l=o.length-1,n;l>=0;l--)(n=o[l])&&(t=(r?n(s,e,t):n(t))||t);return r&&t&&p(s,e,t),t};class ProgressCircle extends SizedMixin(SpectrumElement,{validSizes:["s","m","l"]}){constructor(){super(...arguments);this.indeterminate=!1;this.label="";this.overBackground=!1;this.progress=0;}static get styles(){return [f]}makeRotation(e){return this.indeterminate?void 0:`transform: rotate(${e}deg);`}willUpdate(e){e.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0);}render(){const e=[this.makeRotation(-180+3.6*Math.min(this.progress,50)),this.makeRotation(-180+3.6*Math.max(this.progress-50,0))],r=["Mask1","Mask2"];return x`
        ...
        `}handleSlotchange(){const e=getLabelFromSlot(this.label,this.slotEl);e&&(this.label=e);}firstUpdated(e){super.firstUpdated(e),this.hasAttribute("role")||this.setAttribute("role","progressbar");}updated(e){super.updated(e),!this.indeterminate&&e.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),e.has("label")&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"));}}i([n({type:Boolean,reflect:!0})],ProgressCircle.prototype,"indeterminate",2),i([n({type:String})],ProgressCircle.prototype,"label",2),i([n({type:Boolean,reflect:!0,attribute:"over-background"})],ProgressCircle.prototype,"overBackground",2),i([n({reflect:!0})],ProgressCircle.prototype,"static",2),i([n({type:Number})],ProgressCircle.prototype,"progress",2),i([i$2("slot")],ProgressCircle.prototype,"slotEl",2);
