...
const PropertiesIcon=({width:a=24,height:e=24,hidden:t=!1,title:r="Properties"}={})=>tag`<svg
...
const ViewAllTagsIcon=({width:t=24,height:e=24,hidden:r=!1,title:h="View All Tags"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
...
export { PropertiesIcon as P, ViewAllTagsIcon as V };
