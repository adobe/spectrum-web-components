 ...
 */
var e=new WeakMap,t=t=>"function"==typeof t&&e.has(t),n=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(e,t,n=null,i=null)=>{for(;t!==n;){var s=t.nextSibling;e.insertBefore(t,i),t=s}},s=(e,t,n=null)=>{for(;t!==n;){var i=t.nextSibling;e.removeChild(t),t=i}},r={},a={},o=`{{lit-${String(Math.random()).slice(2)}}}`,l=`\x3c!--${o}--\x3e`,d=new RegExp(`${o}|${l}`),h="$lit$";class u{constructor(e,t){this.parts=[],this.element=t;for(var n=[],i=[],s=document.createTreeWalker(t.content,133,null,!1),r=0,a=-1,l=0,{strings:u,values:{length:v}}=e;l<v;){var g=s.nextNode();if(null!==g){if(a++,1===g.nodeType){if(g.hasAttributes()){for(var f=g.attributes,{length:_}=f,x=0,y=0;y<_;y++)p(f[y].name,h)&&x++;for(;x-- >0;){var w=u[l],N=m.exec(w)[2],S=N.toLowerCase()+h,T=g.getAttribute(S);g.removeAttribute(S);var b=T.split(d);this.parts.push({type:"attribute",index:a,name:N,strings:b}),l+=b.length-1}}"TEMPLATE"===g.tagName&&(i.push(g),s.currentNode=g.content)}else if(3===g.nodeType){var E=g.data;if(E.indexOf(o)>=0){for(var V=g.parentNode,C=E.split(d),A=C.length-1,k=0;k<A;k++){var M=void 0,L=C[k];if(""===L)M=c();else{var $=m.exec(L);null!==$&&p($[2],h)&&(L=L.slice(0,$.index)+$[1]+$[2].slice(0,-h.length)+$[3]),M=document.createTextNode(L)}V.insertBefore(M,g),this.parts.push({type:"node",index:++a})}""===C[A]?(V.insertBefore(c(),g),n.push(g)):g.data=C[A],l+=A}}else if(8===g.nodeType)if(g.data===o){var B=g.parentNode;null!==g.previousSibling&&a!==r||(a++,B.insertBefore(c(),g)),r=a,this.parts.push({type:"node",index:a}),null===g.nextSibling?g.data="":(n.push(g),a--),l++}else for(var H=-1;-1!==(H=g.data.indexOf(o,H+1));)this.parts.push({type:"node",index:-1}),l++}else s.currentNode=i.pop()}for(var P of n)P.parentNode.removeChild(P)}}var p=(e,t)=>{var n=e.length-t.length;return n>=0&&e.slice(n)===t},v=e=>-1!==e.index,c=()=>document.createComment(""),m=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var L=new class{handleAttributeExpressions(e,t,n,i){var s=t[0];return"."===s?new E(e,t.slice(1),n).parts:"@"===s?[new k(e,t.slice(1),i.eventContext)]:"?"===s?[new b(e,t.slice(1),n)]:new N(e,t,n).parts}handleTextExpression(e){return new T(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");var W=(e,...t)=>new _(e,t,"html",L),F=(e,...t)=>new x(e,t,"svg",L),I=133;function j(e,t){for(var{element:{content:n},parts:i}=e,s=document.createTreeWalker(n,I,null,!1),r=q(i),a=i[r],o=-1,l=0,d=[],h=null;s.nextNode();){o++;var u=s.currentNode;for(u.previousSibling===h&&(h=null),t.has(u)&&(d.push(u),null===h&&(h=u)),null!==h&&l++;void 0!==a&&a.index===o;)a.index=null!==h?-1:a.index-l,a=i[r=q(i,r)]}d.forEach(e=>e.parentNode.removeChild(e))}var O=e=>{for(var t=11===e.nodeType?0:1,n=document.createTreeWalker(e,I,null,!1);n.nextNode();)t++;return t},q=(e,t=-1)=>{for(var n=t+1;n<e.length;n++){var i=e[n];if(v(i))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var D=(e,t)=>`${e}--${t}`,R=!0;void 0===window.ShadyCSS?R=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),R=!1);var z,G=e=>t=>{var n=D(t.type,e),i=B.get(n);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},B.set(n,i));var s=i.stringsArray.get(t.strings);if(void 0!==s)return s;var r=t.strings.join(o);if(void 0===(s=i.keyString.get(r))){var a=t.getTemplateElement();R&&window.ShadyCSS.prepareTemplateDom(a,e),s=new u(t,a),i.keyString.set(r,s)}return i.stringsArray.set(t.strings,s),s},J=["html","svg"],K=new Set,Q=(e,t,n)=>{K.add(e);var i=n?n.element:document.createElement("template"),s=t.querySelectorAll("style"),{length:r}=s;if(0!==r){for(var a=document.createElement("style"),o=0;o<r;o++){var l=s[o];l.parentNode.removeChild(l),a.textContent+=l.textContent}(e=>{J.forEach(t=>{var n=B.get(D(t,e));void 0!==n&&n.keyString.forEach(e=>{var{element:{content:t}}=e,n=new Set;Array.from(t.querySelectorAll("style")).forEach(e=>{n.add(e)}),j(e,n)})})})(e);var d=i.content;n?function(e,t,n=null){var{element:{content:i},parts:s}=e;if(null!=n)for(var r=document.createTreeWalker(i,I,null,!1),a=q(s),o=0,l=-1;r.nextNode();){for(l++,r.currentNode===n&&(o=O(t),n.parentNode.insertBefore(t,n));-1!==a&&s[a].index===l;){if(o>0){for(;-1!==a;)s[a].index+=o,a=q(s,a);return}a=q(s,a)}}else i.appendChild(t)}(n,a,d.firstChild):d.insertBefore(a,d.firstChild),window.ShadyCSS.prepareTemplateStyles(i,e);var h=d.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==h)t.insertBefore(h.cloneNode(!0),t.firstChild);else if(n){d.insertBefore(a,d.firstChild);var u=new Set;u.add(a),j(n,u)}}else window.ShadyCSS.prepareTemplateStyles(i,e)},U=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");var i=n.scopeName,r=H.has(t),a=R&&11===t.nodeType&&!!t.host,o=a&&!K.has(i),l=o?document.createDocumentFragment():t;if(P(e,l,Object.assign({templateFactory:G(i)},n)),o){var d=H.get(l);H.delete(l);var h=d.value instanceof g?d.value.template:void 0;Q(i,l,h),s(t,t.firstChild),t.appendChild(l),H.set(t,d)}!r&&a&&window.ShadyCSS.styleElement(t.host)},X=(z=e=>t=>{if(void 0===e&&t instanceof S){if(e!==t.value){var n=t.committer.name;t.committer.element.removeAttribute(n)}}else t.setValue(e)},(...t)=>{var n=z(...t);return e.set(n,!0),n});export{_ as T,P as a,W as h,X as i,a as n,U as r,F as s};
//# sourceMappingURL=lit-html-4f143448.js.map
