...
import { a as PickerBase, D as DESCRIPTION_ID } from './Picker-_l2TKksC.js';
...
var u=Object.defineProperty;var h=Object.getOwnPropertyDescriptor;var l=(r,i,e,o)=>{for(var t=o>1?void 0:o?h(i,e):i,n=r.length-1,a;n>=0;n--)(a=r[n])&&(t=(o?a(i,e,t):a(t))||t);return o&&t&&u(i,e,t),t};class ActionMenu extends ObserveSlotPresence(ObserveSlotText(PickerBase,"label"),'[slot="label-only"]'){constructor(){super(...arguments);this.selects=void 0;this.static=void 0;this.listRole="menu";this.itemRole="menuitem";this.handleSlottableRequest=e=>{this.dispatchEvent(new SlottableRequestEvent(e.name,e.data));};}static get styles(){return [$]}get hasLabel(){return this.slotHasContent}get labelOnly(){return this.slotContentIsPresent}get buttonContent(){return [x`
        ...
        `}update(e){e.has("invalid")&&(this.invalid=!1),super.update(e);}updated(e){super.updated(e),this.hasRenderedOverlay&&this.overlayElement.addEventListener("slottable-request",this.handleSlottableRequest);}}l([n({type:String})],ActionMenu.prototype,"selects",2),l([n({type:String,reflect:!0})],ActionMenu.prototype,"static",2),l([t()],ActionMenu.prototype,"labelOnly",1);
