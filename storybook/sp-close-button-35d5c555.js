import { S as StyledButton, d as S } from './spectrum-icon-cross.css-a270fccc.js';
...
var m=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var p=(c,t,e,o)=>{for(var s=o>1?void 0:o?u(t,e):t,i=c.length-1,n;i>=0;i--)(n=c[i])&&(s=(o?n(t,e,s):n(s))||s);return o&&s&&m(t,e,s),s};const y={s:()=>x`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>x`
        ...
        ></sp-icon-cross300>
    `};class CloseButton extends SizedMixin(StyledButton,{noDefaultSize:!0}){constructor(){super(...arguments);this.variant="";}static get styles(){return [...super.styles,d,S]}get buttonContent(){return [y[this.size]()]}}p([n({reflect:!0})],CloseButton.prototype,"variant",2),p([n({type:String,reflect:!0})],CloseButton.prototype,"static",2);
