import { n as n$1, d as defineElement } from './define-element-IUrhCXKn.js';
...
import { g as guaranteedAllTransitionend, B as BeforetoggleOpenEvent, a as BeforetoggleClosedEvent, O as OverlayStateEvent, V as VirtualTrigger, o as overlayTimer, n as nextFrame, f as forcePaint, b as noop, A as AbstractOverlay } from './VirtualTrigger-X67nVnKd.js';
...
import { l } from './sizedMixin-qrvMoaCA.js';
...
const topLayerOverTransforms=()=>({name:"topLayer",async fn(g){const{x:l,y:s,elements:{reference:c,floating:o}}=g;let t=!1,f=!1,d=!1;const a={x:0,y:0};try{t=t||o.matches(":popover-open");}catch(r){}try{t=t||o.matches(":open");}catch(r){}try{t=t||o.matches(":modal");}catch(r){}f=t;const p=new Event("floating-ui-dialog-test",{composed:!0,bubbles:!0});o.addEventListener("floating-ui-dialog-test",r=>{r.composedPath().forEach(n=>{if(d=d||n===c,!(n===o||n.localName!=="dialog"))try{t=t||n.matches(":modal");}catch(e){}});},{once:!0}),o.dispatchEvent(p);let m=!1;if(!(c instanceof VirtualTrigger)){const r=d?c:o,n=isContainingBlock(r)?r:getContainingBlock(r);let e={};if(n!==null&&getWindow(n)!==n&&(e=getComputedStyle(n),m=e.transform!=="none"||e.translate!=="none"||(e.containerType?e.containerType!=="normal":!1)||(e.backdropFilter?e.backdropFilter!=="none":!1)||(e.filter?e.filter!=="none":!1)||e.willChange.search("transform")>-1||e.willChange.search("translate")>-1||["paint","layout","strict","content"].some(i=>(e.contain||"").includes(i))),t&&m&&n){const i=n.getBoundingClientRect(),{marginInlineStart:y="0",marginBlockStart:u="0"}=e;a.x=i.x+parseFloat(y),a.y=i.y+parseFloat(u);}}return t&&f?{x:l+a.x,y:s+a.y,data:a}:t?{x:l,y:s,data:a}:{x:l-a.x,y:s-a.y,data:a}}});

function p(o){if(typeof o=="undefined")return 0;const t=window.devicePixelRatio||1;return Math.round(o*t)/t}const c$1=8,C=100,L=o=>{var e;return (e={left:["right","bottom","top"],"left-start":["right-start","bottom","top"],"left-end":["right-end","bottom","top"],right:["left","bottom","top"],"right-start":["left-start","bottom","top"],"right-end":["left-end","bottom","top"],top:["bottom","left","right"],"top-start":["bottom-start","left","right"],"top-end":["bottom-end","left","right"],bottom:["top","left","right"],"bottom-start":["top-start","left","right"],"bottom-end":["top-end","left","right"]}[o])!=null?e:[o]};class PlacementController{constructor(t){this.originalPlacements=new WeakMap;this.allowPlacementUpdate=!1;this.closeForAncestorUpdate=()=>{!this.allowPlacementUpdate&&this.options.type!=="modal"&&this.cleanup&&this.target.dispatchEvent(new Event("close",{bubbles:!0})),this.allowPlacementUpdate=!1;};this.updatePlacement=()=>{this.computePlacement();};this.resetOverlayPosition=()=>{!this.target||!this.options||(this.target.style.removeProperty("max-height"),this.target.style.removeProperty("height"),this.initialHeight=void 0,this.isConstrained=!1,this.host.offsetHeight,this.computePlacement());};this.host=t,this.host.addController(this);}async placeOverlay(t=this.target,e=this.options){if(this.target=t,this.options=e,!t||!e)return;const m=autoUpdate(e.trigger,t,this.closeForAncestorUpdate,{ancestorResize:!1,elementResize:!1,layoutShift:!1}),h=autoUpdate(e.trigger,t,this.updatePlacement,{ancestorScroll:!1});this.cleanup=()=>{var n;(n=this.host.elements)==null||n.forEach(a=>{a.addEventListener("sp-closed",()=>{const r=this.originalPlacements.get(a);r&&a.setAttribute("placement",r),this.originalPlacements.delete(a);},{once:!0});}),m(),h();};}async computePlacement(){var g,u;const{options:t,target:e}=this;await(document.fonts?document.fonts.ready:Promise.resolve());const m=t.trigger instanceof HTMLElement?flip():flip({padding:c$1,fallbackPlacements:L(t.placement)}),[h=0,n=0]=Array.isArray(t==null?void 0:t.offset)?t.offset:[t.offset,0],a=(g=this.host.elements.find(i=>i.tipElement))==null?void 0:g.tipElement,r=[offset({mainAxis:h,crossAxis:n}),shift({padding:c$1}),m,size({padding:c$1,apply:({availableWidth:i,availableHeight:d,rects:{floating:x}})=>{const b=Math.max(C,Math.floor(d)),l=x.height;this.initialHeight=this.isConstrained&&this.initialHeight||l,this.isConstrained=l<this.initialHeight||b<=l;const O=this.isConstrained?`${b}px`:"";Object.assign(e.style,{maxWidth:`${Math.floor(i)}px`,maxHeight:O});}}),...a?[arrow({element:a,padding:t.tipPadding||c$1})]:[],topLayerOverTransforms()],{x:P,y:E,placement:s,middlewareData:f}=await computePosition(t.trigger,e,{placement:t.placement,middleware:r,strategy:"fixed"});if(Object.assign(e.style,{top:"0px",left:"0px",translate:`${p(P)}px ${p(E)}px`}),e.setAttribute("actual-placement",s),(u=this.host.elements)==null||u.forEach(i=>{this.originalPlacements.has(i)||this.originalPlacements.set(i,i.getAttribute("placement")),i.setAttribute("placement",s);}),a&&f.arrow){const{x:i,y:d}=f.arrow;Object.assign(a.style,{top:s.startsWith("right")||s.startsWith("left")?"0px":"",left:s.startsWith("bottom")||s.startsWith("top")?"0px":"",translate:`${p(i)}px ${p(d)}px`});}}hostConnected(){document.addEventListener("sp-update-overlays",this.resetOverlayPosition);}hostUpdated(){var t;this.host.open||((t=this.cleanup)==null||t.call(this),this.cleanup=void 0);}hostDisconnected(){var t;(t=this.cleanup)==null||t.call(this),this.cleanup=void 0,document.removeEventListener("sp-update-overlays",this.resetOverlayPosition);}}
