...
`,submenuMobileView=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  <div style="padding: 40px">
...
`;submenuMobileView.swc_vrt={skip:!0},submenuMobileView.parameters={chromatic:{disableSnapshot:!0}};const labelOnly=({align:align="start",changeHandler:changeHandler=()=>{},disabled:disabled=!1,open:open=!1,size:size="m",selects:selects2="",selected:selected=!1}={})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  <sp-action-menu
    ?disabled=${disabled}
    ?open=${open}
    size=${size}
...
//# sourceMappingURL=action-menu-stories-action-menu-stories.cf23d620.iframe.bundle.js.map