...
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class Tray extends index_dev.wG{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new MatchMedia_dev._9(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.resolveTransitionPromise=()=>{},this.animating=!1}static get styles(){return[modal_css.A,tray_css]}focus(){const firstFocusable=(0,first_focusable_in_dev.I)(this);firstFocusable?firstFocusable.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(changes){changes.has("open")&&void 0!==changes.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(res=>{this.resolveTransitionPromise=()=>{this.animating=!1,res()}})),super.update(changes)}render(){return index_dev.qy`
            <sp-underlay
                ?open=${this.open}
                @close=${this.close}
        ...
        `}async getUpdateComplete(){const complete=await super.getUpdateComplete();return await this.transitionPromise,complete}}__decorateClass([(0,decorators_dev.MZ)({type:Boolean,reflect:!0})],Tray.prototype,"open",2),__decorateClass([(0,decorators_dev.P)(".tray")],Tray.prototype,"tray",2),(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-tray",Tray)},"./packages/underlay/sp-underlay.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js");var underlay_css=index_dev.AH`
...
//# sourceMappingURL=slider-stories-slider-stories.2cf6c3d0.iframe.bundle.js.map