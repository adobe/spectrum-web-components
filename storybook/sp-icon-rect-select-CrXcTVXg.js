...
import { A as AnchorSelectIcon, P as PolygonSelectIcon, R as RectSelectIcon } from './RectSelect-DkiUnflO.js';
...
const DirectSelectIcon=({width:l=24,height:e=24,hidden:t=!1,title:r="Direct Select"}={})=>tag`<svg
...
class IconAnchorSelect extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===1?AnchorSelectIcon({hidden:!this.label,title:this.label}):DirectSelectIcon({hidden:!this.label,title:this.label})}}

defineElement("sp-icon-anchor-select",IconAnchorSelect);

class IconPolygonSelect extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===1?PolygonSelectIcon({hidden:!this.label,title:this.label}):DefaultIcon({hidden:!this.label,title:this.label})}}

defineElement("sp-icon-polygon-select",IconPolygonSelect);

const SelectRectangleIcon=({width:l=24,height:r=24,hidden:t=!1,title:c="Select Rectangle"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${l}"
    height="${r}"
    viewBox="0 0 20 20"
...
class IconRectSelect extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===1?RectSelectIcon({hidden:!this.label,title:this.label}):SelectRectangleIcon({hidden:!this.label,title:this.label})}}

defineElement("sp-icon-rect-select",IconRectSelect);

export { DirectSelectIcon as D, SelectRectangleIcon as S };
