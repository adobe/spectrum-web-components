import { B as ButtonBase } from './ButtonBase-ixFv8y71.js';
...
const Cross200Icon$1=({width:t=24,height:e=24,hidden:a=!1,title:r="Cross200"}={})=>tag`<svg
...
const Cross200Icon=({width:t=24,height:e=24,hidden:a=!1,title:r="Cross200"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${a?"true":"false"}
    role="img"
...
class IconCross200 extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===2?Cross200Icon$1({hidden:!this.label,title:this.label}):Cross200Icon({hidden:!this.label,title:this.label})}}

defineElement("sp-icon-cross200",IconCross200);

const Cross300Icon$1=({width:t=24,height:e=24,hidden:a=!1,title:r="Cross300"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${a?"true":"false"}
    role="img"
...
const Cross300Icon=({width:t=24,height:e=24,hidden:a=!1,title:r="Cross300"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${a?"true":"false"}
    role="img"
...
class IconCross300 extends IconBase{render(){return setCustomTemplateLiteralTag(x),this.spectrumVersion===2?Cross300Icon$1({hidden:!this.label,title:this.label}):Cross300Icon({hidden:!this.label,title:this.label})}}
...
export { Cross200Icon as C, StyledButton as S, Cross300Icon as a, c, t };
