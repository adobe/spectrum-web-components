...
`,deepNesting=()=>{const color=window.__swc_hack_knobs__.defaultColor,outter="light"===color?"dark":"light";return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${storyStyles}
    <sp-theme
      color=${outter}
...
`;noCloseOnResize.swc_vrt={skip:!0},noCloseOnResize.parameters={chromatic:{disableSnapshot:!0}};const openClickContent=args=>template({...args,open:"click"}),openHoverContent=args=>template({...args,open:"hover"}),replace=()=>{const closeEvent=new Event("close",{bubbles:!0,composed:!0});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  ...
  `;updating.swc_vrt={skip:!0},updating.parameters={chromatic:{disableSnapshot:!0}};class StartEndContextmenu extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='\n            <style>\n                :host {\n                    display: flex;\n                    align-items: stretch;\n                }\n                div {\n                    width: 50%;\n                    height: 100%;\n                }\n            </style>\n            <div id="start"></div>\n            <div id="end"></div>\n        '}}customElements.define("start-end-contextmenu",StartEndContextmenu);const virtualElementV1=args=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ...
    <start-end-contextmenu
      class="app-root"
      @contextmenu=${{capture:!0,handleEvent:async event=>{event.preventDefault(),event.stopPropagation();const source=event.composedPath()[0],{id:id}=source,trigger=event.target,virtualTrigger=new _spectrum_web_components_overlay__WEBPACK_IMPORTED_MODULE_3__.ec(event.clientX,event.clientY),fragment=document.createDocumentFragment();(0,lit_html__WEBPACK_IMPORTED_MODULE_0__.XX)(((kind="")=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <sp-popover
      style="width:300px;"
...
//# sourceMappingURL=overlay-stories-overlay-stories.84ad333a.iframe.bundle.js.map