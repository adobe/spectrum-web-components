...
import { s as s$1 } from './tab.css-CtM4I2UU.js';
...
var p=Object.defineProperty;var l=(c,a,t,o)=>{for(var e=void 0,r=c.length-1,s;r>=0;r--)(s=c[r])&&(e=(s(a,t,e))||e);return e&&p(a,t,e),e};class TabsOverflow extends SizedMixin(SpectrumElement){constructor(){super();this.compact=!1;this.labelPrevious="Scroll to previous tabs";this.labelNext="Scroll to next tabs";this.overflowState={canScrollLeft:!1,canScrollRight:!1};this.scrollFactor=.5;this.resizeController=new s(this,{target:this,callback:()=>{this._updateScrollState();}});}static get styles(){return [o,s$1,r]}get scrollContent(){return this.tabs}firstUpdated(t){super.firstUpdated(t);const[o]=this.scrollContent;o&&(o.enableTabsScroll=!0),this.resizeController.observe(this.overflowContainer);}async _handleSlotChange(){const[t]=this.scrollContent;await(t==null?void 0:t.updateComplete),this._updateScrollState();}_updateScrollState(){const{scrollContent:t,overflowState:o}=this;if(t){const[e]=this.scrollContent,{canScrollLeft:r,canScrollRight:s}=(e==null?void 0:e.scrollState)||{canScrollLeft:!1,canScrollRight:!1};this.overflowState={...o,canScrollLeft:r,canScrollRight:s};}}_handleScrollClick(t){const o=t.currentTarget,[e]=this.scrollContent,r=e.clientWidth*this.scrollFactor,s=o.classList.contains("left-scroll")?-r:r;e.scrollTabs(s,"smooth");}updated(t){super.updated(t),t.has("dir")&&this._updateScrollState();}render(){const{canScrollRight:t,canScrollLeft:o}=this.overflowState,e$1=this.labelPrevious,r=this.labelNext;return x`
        ...
        `}}l([n({type:Boolean,reflect:!0})],TabsOverflow.prototype,"compact"),l([n({type:String,attribute:"label-previous"})],TabsOverflow.prototype,"labelPrevious"),l([n({type:String,attribute:"label-next"})],TabsOverflow.prototype,"labelNext"),l([n({reflect:!0})],TabsOverflow.prototype,"dir"),l([r$1()],TabsOverflow.prototype,"overflowState"),l([o$1({selector:"sp-tabs",flatten:!0})],TabsOverflow.prototype,"tabs"),l([e$1(".tabs-overflow-container")],TabsOverflow.prototype,"overflowContainer");
