...
import { i, s } from './lit-element-xBOPiTek.js';
import { e } from './custom-element-4W0aDW2j.js';
...
let Typography = class extends s {
  render() {
    if (!this.story)
      return x``;
    return x`
...
const __namedExportsOrder = ['large', 'medium', 'small', 'verticalSmall', 'verticalMedium', 'verticalLarge'];

export { __namedExportsOrder, divider_stories as default, large, medium, small, verticalLarge, verticalMedium, verticalSmall };
