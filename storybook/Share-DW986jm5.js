...
const ExportIcon=({width:a=24,height:t=24,hidden:e=!1,title:r="Export"}={})=>tag`<svg
...
const FolderOpenIcon=({width:e=24,height:t=24,hidden:l=!1,title:a="Folder Open"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${e}
...
const ShareIcon=({width:a=24,height:e=24,hidden:t=!1,title:r="Share"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${e}
    viewBox="0 0 36 36"
    width=${a}
...
export { ExportIcon as E, FolderOpenIcon as F, ShareIcon as S };
