...
import './sp-icon-show-menu-DyffFD5i.js';
...
const __namedExportsOrder = ['submenu', 'contextMenu', 'customRootSubmenu'];

export { __namedExportsOrder, contextMenu, customRootSubmenu, submenu_stories as default, submenu };
