...
`;groups.decorators=[_overlay_stories_index_js__WEBPACK_IMPORTED_MODULE_11__.Z];const groupsWithSelects=({onChange:onChange})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <sp-action-menu
      @change=${({target:{value:value}})=>onChange(value)}
  ...
  `;return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <sp-action-menu ${(0,_spectrum_web_components_overlay_src_slottable_request_directive_js__WEBPACK_IMPORTED_MODULE_2__.i)(()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <sp-menu-item>Deselect</sp-menu-item>
    <sp-menu-item>Select Inverse</sp-menu-item>
    <sp-menu-item>
      Feather...
      <sp-menu slot="submenu" ${(0,_spectrum_web_components_overlay_src_slottable_request_directive_js__WEBPACK_IMPORTED_MODULE_2__.i)(renderSubmenu)}></sp-menu>
    </sp-menu-item>
    <sp-menu-item>Select and Mask...</sp-menu-item>
    <sp-menu-divider></sp-menu-divider>
    <sp-menu-item>Save Selection</sp-menu-item>
  ...
  <sp-action-menu size="m">
    ...
    <sp-menu-item @click=${()=>alert("Feather...")}>Feather...</sp-menu-item>
...
`,__namedExportsOrder=["Default","staticWhite","staticBlack","quiet","forcePopoverOnMobile","labelOnly","selects","iconOnly","tooltipDescriptionAndPlacement","customIcon","submenu","controlled","groups","groupsWithSelects","directive","withScrollEvent","MenuItemAlerts"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...Default.parameters?.docs?.source}}},staticWhite.parameters={...staticWhite.parameters,docs:{...staticWhite.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...staticWhite.parameters?.docs?.source}}},staticBlack.parameters={...staticBlack.parameters,docs:{...staticBlack.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...staticBlack.parameters?.docs?.source}}},quiet.parameters={...quiet.parameters,docs:{...quiet.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...quiet.parameters?.docs?.source}}},forcePopoverOnMobile.parameters={...forcePopoverOnMobile.parameters,docs:{...forcePopoverOnMobile.parameters?.docs,source:{originalSource:'() => html`\n  <div style="padding: 40px">\n    <h1>Force Popover on Mobile</h1>\n    <p>\n      The force-popover attribute overrides the mobile device functionality of\n      rendering a tray so that a popover will always render no matter the\n      device.\n    </p>\n    <ol>\n      <li>Open Chrome DevTools (or equivalent).</li>\n      <li>Toggle the Device Toolbar (the phone/tablet icon).</li>\n      <li>Select a device preset (e.g. iPhone 12).</li>\n      <li>\n        Chrome will set user-agent strings, simulate touch, and adjust DPI.\n      </li>\n      <li>Reload the page</li>\n      <li>Click the Action Menu and see a popover</li>\n    </ol>\n    <sp-action-menu force-popover>\n      <span slot="icon">\n        <sp-icon-settings></sp-icon-settings>\n      </span>\n      <sp-menu-item>Deselect</sp-menu-item>\n      <sp-menu-item>Select Inverse</sp-menu-item>\n      <sp-menu-item>Feather...</sp-menu-item>\n      <sp-menu-item>Select and Mask...</sp-menu-item>\n      <sp-menu-divider></sp-menu-divider>\n      <sp-menu-item>Save Selection</sp-menu-item>\n      <sp-menu-item disabled>Make Work Path</sp-menu-item>\n    </sp-action-menu>\n  </div>\n`',...forcePopoverOnMobile.parameters?.docs?.source}}},labelOnly.parameters={...labelOnly.parameters,docs:{...labelOnly.parameters?.docs,source:{originalSource:'({\n  align = "start",\n  changeHandler = () => void 0,\n  disabled = false,\n  open = false,\n  size = "m",\n  selects: selects2 = "",\n  selected = false\n} = {}) => html`\n  <sp-action-menu\n    ?disabled=${disabled}\n    ?open=${open}\n    size=${size}\n    @change=${event => {\n  navigator.clipboard.writeText(event.target.value);\n  changeHandler(event);\n}}\n    .selects=${selects2 ? selects2 : void 0}\n    value=${selected ? "Select Inverse" : ""}\n    style=${ifDefined(align === "end" ? "float: inline-end;" : void 0)}\n  >\n    <span slot="label-only">Label Only</span>\n    <sp-menu-item>Deselect</sp-menu-item>\n    <sp-menu-item ?selected=${selected}>Select Inverse</sp-menu-item>\n    <sp-menu-item>Feather...</sp-menu-item>\n    <sp-menu-item>Select and Mask...</sp-menu-item>\n    <sp-menu-divider></sp-menu-divider>\n    <sp-menu-item>Save Selection</sp-menu-item>\n    <sp-menu-item disabled>Make Work Path</sp-menu-item>\n  </sp-action-menu>\n`',...labelOnly.parameters?.docs?.source}}},selects.parameters={...selects.parameters,docs:{...selects.parameters?.docs,source:{originalSource:'(args = {}) => Template({\n  ...args,\n  selects: "single",\n  selected: true\n})',...selects.parameters?.docs?.source}}},iconOnly.parameters={...iconOnly.parameters,docs:{...iconOnly.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...iconOnly.parameters?.docs?.source}}},tooltipDescriptionAndPlacement.parameters={...tooltipDescriptionAndPlacement.parameters,docs:{...tooltipDescriptionAndPlacement.parameters?.docs,source:{originalSource:"(args = {}) => Template(args)",...tooltipDescriptionAndPlacement.parameters?.docs?.source}}},customIcon.parameters={...customIcon.parameters,docs:{...customIcon.parameters?.docs,source:{originalSource:"args => Template(args)",...customIcon.parameters?.docs?.source}}},submenu.parameters={...submenu.parameters,docs:{...submenu.parameters?.docs,source:{originalSource:'({\n  align = "start"\n} = {}) => {\n  return html`\n    <sp-action-menu\n      label="More Actions"\n      style=${ifDefined(align === "end" ? "float: inline-end;" : void 0)}\n    >\n      <sp-menu-item>One</sp-menu-item>\n      <sp-menu-item>Two</sp-menu-item>\n      <sp-menu-item>\n        Select some items\n        <sp-menu slot="submenu" selects="multiple">\n          <sp-menu-item>A</sp-menu-item>\n          <sp-menu-item selected>B</sp-menu-item>\n          <sp-menu-item>C</sp-menu-item>\n        </sp-menu>\n      </sp-menu-item>\n    </sp-action-menu>\n  `;\n}',...submenu.parameters?.docs?.source}}},controlled.parameters={...controlled.parameters,docs:{...controlled.parameters?.docs,source:{originalSource:'({\n  align = "start"\n} = {}) => {\n  const state = {\n    snap: true,\n    grid: false,\n    guides: true,\n    latestChange: ""\n  };\n  function toggle(prop) {\n    return event => {\n      const item = event.target;\n      state[prop] = !state[prop];\n      item.selected = state[prop];\n    };\n  }\n  function onChange(event) {\n    state.latestChange = event.target.value;\n    logState();\n  }\n  function logState() {\n    document.getElementById("state-json").textContent = `application state: ${JSON.stringify(state)}`;\n  }\n  return html`\n    <sp-action-menu\n      label="View"\n      @change=${onChange}\n      style=${ifDefined(align === "end" ? "float: inline-end;" : void 0)}\n    >\n      <sp-menu-item value="action" @click=${() => alert("action")}>\n        Non-selectable action\n      </sp-menu-item>\n      <sp-menu-item\n        value="snap"\n        ?selected=${state.snap}\n        @click=${toggle("snap")}\n      >\n        Snap\n      </sp-menu-item>\n      <sp-menu-item>\n        Show\n        <sp-menu\n          slot="submenu"\n          selects="multiple"\n          @change=${event => event.preventDefault()}\n        >\n          <sp-menu-item\n            value="grid"\n            ?selected=${state.grid}\n            @click=${toggle("grid")}\n          >\n            Grid\n          </sp-menu-item>\n          <sp-menu-item\n            value="guides"\n            ?selected=${state.guides}\n            @click=${toggle("guides")}\n          >\n            Guides\n          </sp-menu-item>\n        </sp-menu>\n      </sp-menu-item>\n    </sp-action-menu>\n    <span id="state-json"></span>\n  `;\n}',...controlled.parameters?.docs?.source}}},groups.parameters={...groups.parameters,docs:{...groups.parameters?.docs,source:{originalSource:'({\n  align = "start",\n  onChange\n}) => html`\n  <sp-action-menu\n    id="groups"\n    @change=${({\n  target: {\n    value\n  }\n}) => onChange(value)}\n    open\n    style=${ifDefined(align === "end" ? "float: inline-end;" : void 0)}\n  >\n    <sp-menu-group id="cms">\n      <span slot="header">cms</span>\n      <sp-menu-item value="updateAllSiteContent">\n        Update All Content\n      </sp-menu-item>\n      <sp-menu-item value="refreshAllXDs">Refresh All XDs</sp-menu-item>\n    </sp-menu-group>\n    <sp-menu-group id="ssg">\n      <span slot="header">ssg</span>\n      <sp-menu-item value="clearCache">Clear Cache</sp-menu-item>\n    </sp-menu-group>\n    <sp-menu-group id="vrt">\n      <span slot="header">vrt</span>\n      <sp-menu-item value="vrt-contributions">Contributions</sp-menu-item>\n      <sp-menu-item value="vrt-internal">Internal</sp-menu-item>\n      <sp-menu-item value="vrt-public">Public</sp-menu-item>\n      <sp-menu-item value="vrt-patterns">Patterns</sp-menu-item>\n      <sp-menu-item value="vrt">All</sp-menu-item>\n    </sp-menu-group>\n    <sp-menu-divider></sp-menu-divider>\n    <sp-menu-group id="misc">\n      <sp-menu-item value="logout">Logout</sp-menu-item>\n    </sp-menu-group>\n  </sp-action-menu>\n`',...groups.parameters?.docs?.source}}},groupsWithSelects.parameters={...groupsWithSelects.parameters,docs:{...groupsWithSelects.parameters?.docs,source:{originalSource:'({\n  onChange\n}) => {\n  return html`\n    <sp-action-menu\n      @change=${({\n    target: {\n      value\n    }\n  }) => onChange(value)}\n      label="Filter or Sort"\n    >\n      <sp-menu-group selects="single">\n        <span slot="header">Sort By</span>\n        <sp-menu-item>Name</sp-menu-item>\n        <sp-menu-item>Created</sp-menu-item>\n        <sp-menu-item>Modified</sp-menu-item>\n      </sp-menu-group>\n      <sp-menu-divider></sp-menu-divider>\n      <sp-menu-group selects="multiple">\n        <sp-menu-item>Reverse Order</sp-menu-item>\n      </sp-menu-group>\n    </sp-action-menu>\n  `;\n}',...groupsWithSelects.parameters?.docs?.source}}},directive.parameters={...directive.parameters,docs:{...directive.parameters?.docs,source:{originalSource:'() => {\n  const renderSubmenu = () => html`\n    <sp-menu-item>Submenu Item 1</sp-menu-item>\n    <sp-menu-item>Submenu Item 2</sp-menu-item>\n    <sp-menu-item>Submenu Item 3</sp-menu-item>\n    <sp-menu-item>Submenu Item 4</sp-menu-item>\n  `;\n  const renderOptions = () => html`\n    <sp-menu-item>Deselect</sp-menu-item>\n    <sp-menu-item>Select Inverse</sp-menu-item>\n    <sp-menu-item>\n      Feather...\n      <sp-menu slot="submenu" ${slottableRequest(renderSubmenu)}></sp-menu>\n    </sp-menu-item>\n    <sp-menu-item>Select and Mask...</sp-menu-item>\n    <sp-menu-divider></sp-menu-divider>\n    <sp-menu-item>Save Selection</sp-menu-item>\n    <sp-menu-item disabled>Make Work Path</sp-menu-item>\n  `;\n  return html`\n    <sp-action-menu ${slottableRequest(renderOptions)}>\n      <span slot="label">\n        Select a Country with a very long label, too long in fact\n      </span>\n    </sp-action-menu>\n  `;\n}',...directive.parameters?.docs?.source}}},withScrollEvent.parameters={...withScrollEvent.parameters,docs:{...withScrollEvent.parameters?.docs,source:{originalSource:'() => {\n  function handleActionMenuScroll() {\n    console.log("attached action menu scroll listener");\n  }\n  function renderMenuItems() {\n    return Array.from({\n      length: 30\n    }, (_, i) => html`\n        <sp-menu-item style="width: 100%;">\n          This is an Action Menu Item ${i + 1}\n        </sp-menu-item>\n      `);\n  }\n  return html`\n    <sp-action-menu @scroll=${handleActionMenuScroll} open>\n      <span slot="label">This is an Action Menu</span>\n      ${renderMenuItems()}\n    </sp-action-menu>\n  `;\n}',...withScrollEvent.parameters?.docs?.source}}},MenuItemAlerts.parameters={...MenuItemAlerts.parameters,docs:{...MenuItemAlerts.parameters?.docs,source:{originalSource:'() => html`\n  <sp-action-menu size="m">\n    <span slot="label">More Actions</span>\n    <sp-menu-item @click=${() => alert("Deselect")}>Deselect</sp-menu-item>\n    <sp-menu-item @click=${() => alert("Select inverse")}>\n      Select inverse\n    </sp-menu-item>\n    <sp-menu-item @click=${() => alert("Feather...")}>Feather...</sp-menu-item>\n    <sp-menu-item @click=${() => alert("Select and mask...")}>\n      Select and mask...\n    </sp-menu-item>\n    <sp-menu-divider></sp-menu-divider>\n    <sp-menu-item @click=${() => alert("Save selection")}>\n      Save selection\n    </sp-menu-item>\n    <sp-menu-item disabled>Make work path</sp-menu-item>\n  </sp-action-menu>\n`',...MenuItemAlerts.parameters?.docs?.source}}}},"../node_modules/lit/async-directive.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Kq:function(){return lit_html_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.Kq},u$:function(){return lit_html_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.u$}});var lit_html_async_directive_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("../node_modules/lit-html/development/async-directive.js")},"./packages/action-menu/stories/index.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{q:function(){return ActionMenuMarkup}});var _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/index.dev.js"),_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./tools/base/src/directives.dev.js");__webpack_require__("./packages/action-menu/sp-action-menu.dev.js"),__webpack_require__("./packages/icon/sp-icon.dev.js"),__webpack_require__("./packages/menu/sp-menu-divider.dev.js"),__webpack_require__("./packages/menu/sp-menu-item.dev.js"),__webpack_require__("./packages/tooltip/sp-tooltip.dev.js");const ActionMenuMarkup=({align:align="start",ariaLabel:ariaLabel="More Actions",onChange:onChange=()=>{},changeHandler:changeHandler=()=>{},disabled:disabled=!1,forcePopover:forcePopover=!1,open:open=!1,quiet:quiet=!1,staticValue:staticValue="",visibleLabel:visibleLabel="",customIcon:customIcon="",size:size="m",selects:selects="",selected:selected=!1,tooltipDescription:tooltipDescription="",tooltipPlacement:tooltipPlacement="bottom"}={})=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `},"./packages/button/sp-button.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_Button_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/button/src/Button.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-button",_src_Button_dev_js__WEBPACK_IMPORTED_MODULE_1__.$n)},"./packages/button/stories/index.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{BK:function(){return renderLink},Uv:function(){return argTypes},a2:function(){return args},aR:function(){return renderWithIconOnly},c5:function(){return renderLinkWithTarget},dg:function(){return makeOverBackground},jM:function(){return renderButtonSet},oX:function(){return renderWithIcon},pG:function(){return renderMinWidthButton},vb:function(){return renderButton}});var lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("../node_modules/lit/directives/class-map.js"),_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./tools/base/src/index.dev.js"),_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./tools/base/src/directives.dev.js");__webpack_require__("./packages/button/sp-button.dev.js"),__webpack_require__("./packages/icon/sp-icon.dev.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-help.js");const args={disabled:!1,variant:"cta",pending:!1},argTypes={disabled:{name:"disabled",type:{name:"boolean",required:!1},description:"Disable this control. It will not receive focus or events.",table:{type:{summary:"boolean"},defaultValue:{summary:!1}},control:{type:"boolean"}},variant:{name:"variant",type:{name:"string",required:!1},description:"The visual variant to apply to the button.",table:{type:{summary:"string"},defaultValue:{summary:"cta"}},control:{type:"inline-radio",options:["cta","accent","primary","secondary","negative","overBackground","black","white"]}},treatment:{name:"treatment",type:{name:"string",required:!1},description:"The visual treatment to apply to the button.",table:{type:{summary:"string"},defaultValue:{summary:"fill"}},control:{type:"inline-radio",options:["fill","outline"]}},pending:{name:"pending",type:{name:"boolean",required:!1},description:"Shows the pending state of the button.",table:{type:{summary:"boolean"},defaultValue:{summary:!1}},control:{type:"boolean"}},label:{name:"label",type:{name:"string",required:!1},description:"The label to apply to the aria-label of the button.",table:{type:{summary:"string"}},control:{type:"text"}},href:{name:"href",type:{name:"string",required:!1},description:"**Deprecated.** Use a native HTML anchor (`<a>`) with the `spectrum-Button` class and import `@spectrum-web-components/styles/global-elements.css` instead.",table:{type:{summary:"string"}},control:{type:"text"}}},makeOverBackground=staticColor=>story=>{const color="black"===staticColor?"var(--spectrum-docs-static-black-background-color)":"var(--spectrum-docs-static-white-background-color)";return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
      <div
        style="
    ...
    `};function renderButton(properties){var _a;const minWidth=properties.minWidth?`min-inline-size: ${properties.minWidth}`:void 0;if(properties.href){if(properties.disabled||properties.noWrap||properties.pending)return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy``;const variant=properties.variant&&"cta"===properties.variant?"accent":properties.variant,staticColor=properties.staticColor&&properties.staticColor.charAt(0).toUpperCase()+properties.staticColor.slice(1);return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
      <a
        class=${(0,lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_0__.H)({"spectrum-Button":!0,[`spectrum-Button--size${null==(_a=properties.size)?void 0:_a.toUpperCase()}`]:void 0!==properties.size,[`spectrum-Button--${variant}`]:void 0!==properties.variant,[`spectrum-Button--${properties.treatment}`]:void 0!==properties.treatment,[`spectrum-Button--static${staticColor}`]:void 0!==properties.staticColor,"spectrum-Button--iconOnly":void 0!==properties.iconOnly})}
        href=${properties.href}
        target=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.target)}
        style=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(minWidth)}
      >
        ${properties.content||"Link as Button"}
      </a>
    `}return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <sp-button
      ?disabled=${!!properties.disabled}
      href=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.href)}
      ?icon-only=${properties.iconOnly}
      ?pending=${!!properties.pending}
      ?quiet=${!!properties.quiet}
      ?no-wrap=${!!properties.noWrap}
      size=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.size)}
      target=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.target)}
      treatment=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.treatment)}
      variant=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.variant)}
      static-color=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.staticColor)}
      label=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(properties.label)}
      style=${(0,_spectrum_web_components_base_src_directives_js__WEBPACK_IMPORTED_MODULE_2__.JR)(minWidth)}
    >
      ${properties.content||"Click Me"}
    </sp-button>
  `}function renderButtonSet(properties){const disabled=Object.assign({},properties,{disabled:!0}),icon=Object.assign({},properties,{content:_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
      <sp-icon-help slot="icon"></sp-icon-help>
      Click Me
    `});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${renderButton(properties)} ${renderButton(disabled)} ${renderButton(icon)}
  `}const bellIcon=_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
  <svg slot="icon" viewBox="0 0 36 36" focusable="false" aria-hidden="true">
    <path
      d="M16 36a4.407 4.407 0 0 0 4-4h-8a4.407 4.407 0 0 0 4 4zm9.143-24.615c0-3.437-3.206-4.891-7.143-5.268V3a1.079 1.079 0 0 0-1.143-1h-1.714A1.079 1.079 0 0 0 14 3v3.117c-3.937.377-7.143 1.831-7.143 5.268C6.857 26.8 2 26.111 2 28.154V30h28v-1.846C30 26 25.143 26.8 25.143 11.385z"
    ></path>
  </svg>
`,renderWithIcon=props=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    <style>
      .row {
        padding: 10px;
      }
    ...
    <div class="row">
      ${renderButtonSet({...props,content:_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
          <sp-icon-help slot="icon"></sp-icon-help>
          Help
        `})}
    </div>
  ...
  `,renderWithIconOnly=props=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${function renderIconButtonSet(properties){const disabled=Object.assign({},properties,{iconOnly:!0,disabled:!0}),iconOnly=Object.assign({},properties,{iconOnly:!0,content:_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
      <sp-icon-help slot="icon"></sp-icon-help>
    `});return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${renderButton(iconOnly)} ${renderButton(disabled)}
  `}({...props,content:_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
        <sp-icon-help slot="icon"></sp-icon-help>
      `})}
  `,renderMinWidthButton=props=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_1__.qy`
    ${renderButtonSet({...props,minWidth:"300px"})}
  `,href="https://github.com/adobe/spectrum-web-components",renderLink=props=>renderButtonSet({...props,href:href}),renderLinkWithTarget=props=>renderButtonSet({...props,href:href,target:"_blank"})},"./packages/divider/src/divider.css.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){const i=__webpack_require__("./tools/base/src/index.dev.js").AH`
    @media (forced-colors:active){:host{--highcontrast-divider-background-color:CanvasText}}:host{--spectrum-divider-thickness:var(--spectrum-divider-thickness-medium)}:host([size=s]){--spectrum-divider-thickness:var(--spectrum-divider-thickness-small)}:host([size=l]){--spectrum-divider-thickness:var(--spectrum-divider-thickness-large);--spectrum-divider-background-color:var(--spectrum-gray-800)}:host([static-color=white]){--mod-divider-background-color:var(--mod-divider-background-color-medium-static-white,var(--spectrum-divider-background-color-static-white))}:host([static-color=white][size=s]){--mod-divider-background-color:var(--mod-divider-background-color-small-static-white,var(--spectrum-divider-background-color-static-white))}:host([static-color=white][size=l]){--mod-divider-background-color:var(--mod-divider-background-color-large-static-white,var(--spectrum-transparent-white-800))}:host([static-color=black]){--mod-divider-background-color:var(--mod-divider-background-color-medium-static-black,var(--spectrum-divider-background-color-static-black))}:host([static-color=black][size=s]){--mod-divider-background-color:var(--mod-divider-background-color-small-static-black,var(--spectrum-divider-background-color-static-black))}:host([static-color=black][size=l]){--mod-divider-background-color:var(--mod-divider-background-color-large-static-black,var(--spectrum-transparent-black-800))}:host{inline-size:100%;block-size:var(--mod-divider-thickness,var(--spectrum-divider-thickness));background-color:var(--highcontrast-divider-background-color,var(--mod-divider-background-color,var(--spectrum-divider-background-color)));border:none;border-width:var(--mod-divider-thickness,var(--spectrum-divider-thickness));border-radius:var(--mod-divider-thickness,var(--spectrum-divider-thickness));overflow:visible}:host([vertical]){align-self:var(--mod-divider-vertical-align);inline-size:var(--mod-divider-thickness,var(--spectrum-divider-thickness));block-size:100%;block-size:var(--mod-divider-vertical-height,100%);margin-block:var(--mod-divider-vertical-margin)}:host{--spectrum-divider-background-color:var(--system-divider-background-color);--spectrum-divider-background-color-static-white:var(--system-divider-background-color-static-white);--spectrum-divider-background-color-static-black:var(--system-divider-background-color-static-black)}:host{display:block}hr{border:none;margin:0}
`;__webpack_exports__.A=i},"./packages/icon/sp-icon.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_Icon_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/icon/src/Icon.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-icon",_src_Icon_dev_js__WEBPACK_IMPORTED_MODULE_1__.I)},"./packages/icons-workflow/icons/sp-icon-help.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),src_index_dev=__webpack_require__("./packages/icon/src/index.dev.js"),custom_tag=__webpack_require__("./packages/icons-workflow/src/custom-tag.js"),Help=__webpack_require__("./packages/icons-workflow/src/icons/Help.js"),HelpCircle=__webpack_require__("./packages/icons-workflow/src/icons-s2/HelpCircle.js");class IconHelp extends src_index_dev.z{render(){return(0,custom_tag.L)(index_dev.qy),1===this.spectrumVersion?(0,Help.N)({hidden:!this.label,title:this.label}):(0,HelpCircle.V)({hidden:!this.label,title:this.label})}}(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-icon-help",IconHelp)},"./packages/icons-workflow/icons/sp-icon-settings.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),src_index_dev=__webpack_require__("./packages/icon/src/index.dev.js"),custom_tag=__webpack_require__("./packages/icons-workflow/src/custom-tag.js");var Settings=__webpack_require__("./packages/icons-workflow/src/icons/Settings.js");class IconSettings extends src_index_dev.z{render(){return(0,custom_tag.L)(index_dev.qy),2===this.spectrumVersion?(({width:l=24,height:c=24,hidden:t=!1,title:e="Settings"}={})=>custom_tag.T`<svg
  ...
  >
    ...
    />
  </svg>`},"./packages/menu/sp-menu-divider.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),divider_css=__webpack_require__("./packages/divider/src/divider.css.js");var menu_divider_css=index_dev.AH`
    :host{--spectrum-menu-divider-thickness:var(--spectrum-divider-thickness-medium);inline-size:auto;margin-block:var(--mod-menu-section-divider-margin-block,max(0px,(var(--spectrum-menu-item-section-divider-height) - var(--spectrum-menu-divider-thickness))/2));margin-inline:var(--mod-menu-item-label-inline-edge-to-content,var(--spectrum-menu-item-label-inline-edge-to-content));overflow:visible}.spectrum-Menu-back:focus-visible{border-radius:var(--spectrum-menu-item-corner-radius);box-shadow:var(--spectrum-menu-item-focus-indicator-shadow)var(--spectrum-menu-item-focus-indicator-border-width)0 0 0 var(--spectrum-menu-item-focus-indicator-color-default);outline:var(--spectrum-menu-item-focus-indicator-width)var(--spectrum-menu-item-focus-indicator-outline-style)var(--spectrum-menu-item-focus-indicator-color-default);outline-offset:var(--spectrum-menu-item-focus-indicator-offset)}.spectrum-Menu-back{padding-block:var(--mod-menu-back-padding-block-start,0)var(--mod-menu-back-padding-block-end,0);padding-inline:var(--mod-menu-back-padding-inline-start,0)var(--mod-menu-back-padding-inline-end,var(--spectrum-menu-item-label-inline-edge-to-content));flex-flow:wrap;align-items:center;display:flex}.spectrum-Menu-backButton{cursor:pointer;background:0 0;border:0;margin:0;padding:0;display:inline-flex}.spectrum-Menu-backButton:focus-visible{outline:var(--spectrum-focus-indicator-thickness)solid var(--spectrum-focus-indicator-color);outline-offset:calc((var(--spectrum-focus-indicator-thickness) + 1px)*-1)}.spectrum-Menu-backHeading{font-size:var(--mod-menu-section-header-font-size,var(--spectrum-menu-section-header-font-size));font-weight:var(--mod-menu-section-header-font-weight,var(--spectrum-menu-section-header-font-weight));line-height:var(--mod-menu-section-header-line-height,var(--spectrum-menu-section-header-line-height));color:var(--highcontrast-menu-item-color-default,var(--mod-menu-back-heading-color,var(--spectrum-menu-section-header-color)));display:block}:host{flex-shrink:0;display:block}
`;class MenuDivider extends((0,index_dev.ZG)(index_dev.wG,{validSizes:["s","m","l"]})){static get styles(){return[divider_css.A,menu_divider_css]}firstUpdated(changed){super.firstUpdated(changed),this.setAttribute("role","separator")}}(0,define_element_dev.e)("sp-menu-divider",MenuDivider)},"./packages/menu/sp-menu-group.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js"),random_id_dev=__webpack_require__("./tools/shared/src/random-id.dev.js"),Menu_dev=(__webpack_require__("./packages/menu/sp-menu.dev.js"),__webpack_require__("./packages/menu/src/Menu.dev.js"));var menu_group_css=index_dev.AH`
    .spectrum-Menu-back:focus-visible{border-radius:var(--spectrum-menu-item-corner-radius);box-shadow:var(--spectrum-menu-item-focus-indicator-shadow)var(--spectrum-menu-item-focus-indicator-border-width)0 0 0 var(--spectrum-menu-item-focus-indicator-color-default);outline:var(--spectrum-menu-item-focus-indicator-width)var(--spectrum-menu-item-focus-indicator-outline-style)var(--spectrum-menu-item-focus-indicator-color-default);outline-offset:var(--spectrum-menu-item-focus-indicator-offset)}.header{min-inline-size:var(--mod-menu-section-header-min-width,var(--spectrum-menu-section-header-min-width));padding-block-start:var(--mod-menu-section-header-top-edge-to-text,var(--mod-menu-item-top-edge-to-text,var(--spectrum-menu-item-top-edge-to-text)));padding-block-end:var(--mod-menu-section-header-bottom-edge-to-text,var(--mod-menu-item-bottom-edge-to-text,var(--spectrum-menu-item-bottom-edge-to-text)));padding-inline:var(--mod-menu-item-label-inline-edge-to-content,var(--spectrum-menu-item-label-inline-edge-to-content));font-size:var(--mod-menu-section-header-font-size,var(--spectrum-menu-section-header-font-size));font-weight:var(--mod-menu-section-header-font-weight,var(--spectrum-menu-section-header-font-weight));line-height:var(--mod-menu-section-header-line-height,var(--spectrum-menu-section-header-line-height));color:var(--highcontrast-menu-item-color-default,var(--mod-menu-section-header-color,var(--spectrum-menu-section-header-color)));grid-area:sectionHeadingArea/1/sectionHeadingArea/-1;display:block}.spectrum-Menu-back{padding-block:var(--mod-menu-back-padding-block-start,0)var(--mod-menu-back-padding-block-end,0);padding-inline:var(--mod-menu-back-padding-inline-start,0)var(--mod-menu-back-padding-inline-end,var(--spectrum-menu-item-label-inline-edge-to-content));flex-flow:wrap;align-items:center;display:flex}.spectrum-Menu-back .header{padding:0}.spectrum-Menu-backButton{cursor:pointer;background:0 0;border:0;margin:0;padding:0;display:inline-flex}.spectrum-Menu-backButton:focus-visible{outline:var(--spectrum-focus-indicator-thickness)solid var(--spectrum-focus-indicator-color);outline-offset:calc((var(--spectrum-focus-indicator-thickness) + 1px)*-1)}.spectrum-Menu-backHeading{font-size:var(--mod-menu-section-header-font-size,var(--spectrum-menu-section-header-font-size));font-weight:var(--mod-menu-section-header-font-weight,var(--spectrum-menu-section-header-font-weight));line-height:var(--mod-menu-section-header-line-height,var(--spectrum-menu-section-header-line-height));color:var(--highcontrast-menu-item-color-default,var(--mod-menu-back-heading-color,var(--spectrum-menu-section-header-color)));display:block}:host{flex-direction:column;margin:0;display:flex;overflow:visible}[hidden]{display:none!important}
`,__defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class MenuGroup extends Menu_dev.W{constructor(){super(...arguments),this.headerId=""}static get styles(){return[...super.styles,menu_group_css]}get ownRole(){return"group"}get controlsRovingTabindex(){return!1}updateLabel(){const headerElement=this.headerElements.length?this.headerElements[0]:void 0;if(headerElement!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),headerElement){this.headerId=this.headerId||`sp-menu-group-label-${(0,random_id_dev.l)()}`;const headerId=headerElement.id||this.headerId;headerElement.id||(headerElement.id=headerId),this.setAttribute("aria-labelledby",headerId)}else this.removeAttribute("aria-labelledby");this.headerElement=headerElement}render(){return index_dev.qy`
  ...
  `},"./tools/base/src/async-directive.dev.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{Kq:function(){return lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.Kq},u$:function(){return lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__.u$}});var lit_async_directive_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("../node_modules/lit/async-directive.js")}}]);
//# sourceMappingURL=action-menu-stories-action-menu-stories.1a72d0a3.iframe.bundle.js.map