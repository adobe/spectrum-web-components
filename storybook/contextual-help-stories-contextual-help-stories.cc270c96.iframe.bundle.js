"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[1082,4222,8701],{"./packages/contextual-help/stories/contextual-help.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{CustomPlacement:function(){return CustomPlacement},Default:function(){return Default},Help:function(){return Help},__namedExportsOrder:function(){return __namedExportsOrder},customMaxWidth:function(){return customMaxWidth},default:function(){return contextual_help_stories}});var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),lit_helpers=__webpack_require__("./test/lit-helpers.js");var directives_dev=__webpack_require__("./tools/base/src/directives.dev.js"),decorators_dev=(__webpack_require__("./packages/link/sp-link.dev.js"),__webpack_require__("./tools/base/src/decorators.dev.js")),slottable_request_event_dev=__webpack_require__("./packages/overlay/src/slottable-request-event.dev.js"),MatchMedia_dev=__webpack_require__("./tools/reactive-controllers/src/MatchMedia.dev.js");__webpack_require__("./packages/action-button/sp-action-button.dev.js"),__webpack_require__("./packages/overlay/sp-overlay.dev.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-help-outline.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-info-outline.js");var contextual_help_css=index_dev.AH`
    .popover{min-inline-size:var(--mod-spectrum-contextual-help-minimum-width,var(--spectrum-contextual-help-minimum-width));max-inline-size:var(--mod-spectrum-contextual-help-popover-maximum-width);padding-block:var(--mod-spectrum-contextual-help-padding,var(--spectrum-spacing-400));padding-inline:var(--mod-spectrum-contextual-help-padding,var(--spectrum-spacing-400));font-size:var(--mod-spectrum-contextual-help-body-size,var(--spectrum-contextual-help-body-size));color:var(--highcontrast-contextual-help-body-color,var(--mod-contextual-help-body-color,var(--spectrum-body-color)));position:relative}.popover .body,.popover ::slotted([slot=heading]){margin:0}.popover ::slotted([slot=heading]){font-size:var(--mod-spectrum-contextual-help-heading-size,var(--spectrum-contextual-help-title-size));color:var(--highcontrast-contextual-help-heading-color,var(--mod-contextual-help-heading-color,var(--spectrum-heading-color)));margin-block-end:var(--mod-spectrum-contextual-help-content-spacing,var(--spectrum-contextual-help-content-spacing))}::slotted([slot=link]){margin-block-start:var(--mod-spectrum-contextual-help-link-spacing,var(--spectrum-spacing-300))}@media (forced-colors:active){:host{--highcontrast-contextual-help-heading-color:CanvasText;--highcontrast-contextual-help-body-color:CanvasText}}:host{display:inline-block}::slotted([slot=link]){display:block}
