"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[886],{"./packages/action-button/stories/action-button.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{__namedExportsOrder:function(){return __namedExportsOrder},href:function(){return href},hrefWithTarget:function(){return hrefWithTarget},toggles:function(){return toggles}});var _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/index.dev.js"),_index_js__WEBPACK_IMPORTED_MODULE_4__=(__webpack_require__("./packages/action-group/sp-action-group.dev.js"),__webpack_require__("./packages/icons-workflow/icons/sp-icon-edit.js"),__webpack_require__("./packages/action-button/sp-action-button.dev.js"),__webpack_require__("./packages/action-button/stories/index.js"));function renderButtonsSelected(args){return _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
    <sp-action-group ?emphasized=${!!args.emphasized} ?quiet=${!!args.quiet}>
      ${(0,_index_js__WEBPACK_IMPORTED_MODULE_4__.v)(args)} ${(0,_index_js__WEBPACK_IMPORTED_MODULE_4__.v)({...args,selected:!0})}
      ${(0,_index_js__WEBPACK_IMPORTED_MODULE_4__.v)({...args,disabled:!0})}
    </sp-action-group>
  `}__webpack_exports__.default={component:"sp-action-button",title:"Action Button"};const toggles=args=>renderButtonsSelected(args);toggles.args={toggles:!0,icon:'<sp-icon-edit hidden slot="icon"></sp-icon-edit>'};const href=args=>renderButtonsSelected(args);href.args={href:"https://github.com/adobe/spectrum-web-components",icon:'<sp-icon-edit hidden slot="icon"></sp-icon-edit>'};const hrefWithTarget=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  <sp-action-button
...
//# sourceMappingURL=action-button-stories-action-button-stories.99d9c8e5.iframe.bundle.js.map