            ...
            >
                ...
                >
                    <sp-menu
                        ...
                        size=${this.size}
                    >
                        ${c(this.availableOptions,t=>t.value,t=>{var i,s;return x`
                                    <sp-menu-item
                                        id="${t.value}"
