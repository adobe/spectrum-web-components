...
import { S as SpectrumElement, n as n$3, d as defineElement } from './define-element-e64f5ea4.js';
import { x, A, D } from './lit-html-126adc72.js';
import { l as l$1, S as SizedMixin } from './sizedMixin-43fe982f.js';
...
var h$1=Object.defineProperty;var n$2=Object.getOwnPropertyDescriptor;var c$1=(i,s,e,l)=>{for(var t=l>1?void 0:l?n$2(s,e):s,a=i.length-1,o;a>=0;a--)(o=i[a])&&(t=(l?o(s,e,t):o(t))||t);return l&&t&&h$1(s,e,t),t};class TableRow extends SpectrumElement{constructor(){super(...arguments);this.role="row";this.selectable=!1;this.selected=!1;this.value="";}static get styles(){return [u$2]}async handleChange(e){e.target.checkbox&&(this.selected=e.target.checkbox.checked,await 0,e.defaultPrevented&&(this.selected=!this.selected));}handleSlotchange({target:e}){const l=e.assignedElements();this.selectable=!!l.find(t=>t.localName==="sp-table-checkbox-cell");}async manageSelected(){await this.updateComplete;const[e]=this.checkboxCells;e&&(e.checked=this.selected);}handleClick(e){if(e.composedPath().find(t=>t.localName==="sp-table-checkbox-cell"))return;const[l]=this.checkboxCells;l&&l.click();}render(){return x`
            <slot
                @change=${this.handleChange}
                @slotchange=${this.handleSlotchange}
            ></slot>
        `}willUpdate(e){e.has("selected")&&this.manageSelected(),e.has("selectable")&&(this.selectable?this.addEventListener("click",this.handleClick):this.removeEventListener("click",this.handleClick));}}c$1([l$1({selector:"sp-table-checkbox-cell",flatten:!0})],TableRow.prototype,"checkboxCells",2),c$1([n$3({reflect:!0})],TableRow.prototype,"role",2),c$1([n$3({type:Boolean})],TableRow.prototype,"selectable",2),c$1([n$3({type:Boolean,reflect:!0})],TableRow.prototype,"selected",2),c$1([n$3({type:String})],TableRow.prototype,"value",2);
