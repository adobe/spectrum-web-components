...
import { o as o$2 } from './class-map-Q7DIFm9x.js';
...
var h=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var l=(n,a,e,t)=>{for(var i=t>1?void 0:t?p(a,e):a,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(t?r(a,e,i):r(i))||i);return t&&i&&h(a,e,i),i};const ScaledIndicator={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(n,a){const e=a/this.baseSize;return `transform: translateX(${n}px) scaleX(${e});`},transformY(n,a){const e=a/this.baseSize;return `transform: translateY(${n}px) scaleY(${e});`},baseStyles(){return i`
