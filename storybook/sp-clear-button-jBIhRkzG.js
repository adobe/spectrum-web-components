import { S as StyledButton, b as S } from './spectrum-icon-cross.css-jF12fKiX.js';
...
class IconCross75 extends IconBase{render(){return setCustomTemplateLiteralTag(x),Cross75Icon()}}

defineElement("sp-icon-cross75",IconCross75);

const Cross100Icon=({width:t=24,height:e=24,title:r="Cross100"}={})=>tag`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    role="img"
...
class IconCross100 extends IconBase{render(){return setCustomTemplateLiteralTag(x),Cross100Icon()}}

defineElement("sp-icon-cross100",IconCross100);

var p=Object.defineProperty;var m=Object.getOwnPropertyDescriptor;var l=(e,o,c,t)=>{for(var s=t>1?void 0:t?m(o,c):o,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(t?n(o,c,s):n(s))||s);return t&&s&&p(o,c,s),s};const f={s:()=>x`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>x`
        ...
        ></sp-icon-cross300>
    `};class ClearButton extends SizedMixin(StyledButton,{noDefaultSize:!0}){constructor(){super(...arguments);this.variant="";}static get styles(){return [...super.styles,I,S]}get buttonContent(){return [f[this.size]()]}render(){return x`
            <div class="fill">${super.render()}</div>
        `}}l([n({reflect:!0})],ClearButton.prototype,"variant",2);
