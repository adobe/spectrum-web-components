...
import { M as MatchMediaController } from './MatchMedia-pSNe9kbs.js';
import { i as i$1 } from './modal.css-Dkp8hmGu.js';
...
var l=Object.defineProperty;var a=(o,r,e,i)=>{for(var t=void 0,s=o.length-1,n;s>=0;s--)(n=o[s])&&(t=(n(r,e,t))||t);return t&&l(r,e,t),t};class Tray extends SpectrumElement{constructor(){super(...arguments);this.open=!1;this.prefersMotion=new MatchMediaController(this,"(prefers-reduced-motion: no-preference)");this.transitionPromise=Promise.resolve();this.animating=!1;}static get styles(){return [i$1,r]}focus(){const e=firstFocusableIn(this);e?e.focus():this.children.length===1?this.tray.focus():super.focus();}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed();}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}));}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed());}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise();}update(e){e.has("open")&&e.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(i=>{this.resolveTransitionPromise=()=>{this.animating=!1,i();};})),super.update(e);}render(){return x`
            <sp-underlay
                ?open=${this.open}
                @close=${this.close}
