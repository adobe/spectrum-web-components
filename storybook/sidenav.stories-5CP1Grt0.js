...
import { L as LikeAnchor } from './like-anchor-Gwp5ooDH.js';
import { F as Focusable } from './focusable-mx5LgJ38.js';
import { x, A } from './lit-html-GmIhAbMP.js';
import { l } from './if-defined-pV6JZKXB.js';
import { n as n$1, S as SpectrumElement, d as defineElement } from './define-element-s04w2teA.js';
...
--spectrum-cjk-line-height-100
)}#list:lang(ja),#list:lang(ko),#list:lang(zh){--spectrum-sidenav-header-line-height:var(--spectrum-cjk-line-height-100)}#list{display:flex;flex-direction:column;list-style-type:none;margin:0;padding:0}:host{list-style-type:none;margin-inline:0}:host([disabled]) #item-link{background-color:var(
...
var h$1=Object.defineProperty;var u$1=Object.getOwnPropertyDescriptor;var n=(c,a,e,t)=>{for(var i=t>1?void 0:t?u$1(a,e):a,d=c.length-1,l;d>=0;d--)(l=c[d])&&(i=(t?l(a,e,i):l(i))||i);return t&&i&&h$1(a,e,i),i};const r$1=class r extends LikeAnchor(Focusable){constructor(){super(...arguments);this.value=void 0;this.selected=!1;this.expanded=!1;}static get styles(){return [c]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return !!this.querySelector("sp-sidenav-item")}get depth(){let e=0,t=this.parentElement;for(;t instanceof r;)e++,t=t.parentElement;return e}handleSideNavSelect(e){this.selected=e.target===this;}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||e!=null&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value));}announceSelected(e){const t={value:e},i=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:t});this.dispatchEvent(i);}click(){this.handleClick();}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e);}render(){return x`
            <a
                href=${this.href||"#"}
                ...
                aria-expanded=${l(this.hasChildren?this.expanded:void 0)}
                aria-controls=${l(this.hasChildren&&this.expanded?"list":void 0)}
            >
                <slot name="icon"></slot>
                <span id="link-text">
                    ${this.label}
...
var o=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var r=(d,l,e,t)=>{for(var a=t>1?void 0:t?u(l,e):l,i=d.length-1,s;i>=0;i--)(s=d[i])&&(a=(t?s(l,e,a):s(a))||a);return t&&a&&o(l,e,a),a};class SideNav extends Focusable{constructor(){super(...arguments);this.items=new Set;this.rovingTabindexController=new RovingTabindexController(this,{focusInIndex:e=>{let t,a=e.findIndex(i=>(i.value===this.value&&this.isDisabledChild(i)&&(t=i.closest("sp-sidenav-item:not([expanded])")),this.value?!i.disabled&&!this.isDisabledChild(i)&&i.value===this.value:!i.disabled&&!this.isDisabledChild(i)));return a===-1&&t&&(a=e.findIndex(i=>i===t)),a},direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)});this.manageTabIndex=!1;this.value=void 0;this.variant=void 0;this.label=void 0;}static get styles(){return [m]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache();}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache();}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach(i=>i.handleSideNavSelect(e)):(this.value=t,e.target.selected=!1,e.preventDefault());}focus(){this.rovingTabindexController.focus();}blur(){this.focusElement!==this&&super.blur();}click(){this.focusElement!==this&&super.click();}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return !0;let t=e.parentElement;for(;t instanceof SideNavHeading||!t.disabled&&t instanceof SideNavItem&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage();}render(){return x`
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value);}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage());}}r([n$1({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],SideNav.prototype,"manageTabIndex",2),r([n$1({reflect:!0})],SideNav.prototype,"value",2),r([n$1({reflect:!0})],SideNav.prototype,"variant",2),r([n$1({reflect:!0})],SideNav.prototype,"label",2);
