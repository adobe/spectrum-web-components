import { S as StyledButton, t, c } from './icon-cross-overrides.css-B1b1jEW8.js';
...
import { d as defineElement, n } from './define-element-BacrH-dd.js';
...
var l=Object.defineProperty;var p=(e,o,c,t)=>{for(var s=void 0,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(n(o,c,s))||s);return s&&l(o,c,s),s};const v={s:()=>x`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>x`
        ...
        ></sp-icon-cross300>
    `};class ClearButton extends SizedMixin(StyledButton,{noDefaultSize:!0}){constructor(){super(...arguments);this.variant="";}static get styles(){return [...super.styles,r,t,c]}get buttonContent(){return [v[this.size]()]}render(){return x`
            <div class="fill">${super.render()}</div>
        `}}p([n({reflect:!0})],ClearButton.prototype,"variant");
