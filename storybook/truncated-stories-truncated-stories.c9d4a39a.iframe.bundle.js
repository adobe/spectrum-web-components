"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[1082,8701,9294],{"./tools/truncated/stories/truncated.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:function(){return Default},__namedExportsOrder:function(){return __namedExportsOrder},default:function(){return truncated_stories}});var index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js");__webpack_require__("./packages/overlay/sp-overlay.dev.js"),__webpack_require__("./packages/tooltip/sp-tooltip.dev.js");var truncated_css=index_dev.AH`
...
`,d=Object.defineProperty,m=Object.getOwnPropertyDescriptor,s=(l,o,e,r)=>{for(var n,t=r>1?void 0:r?m(o,e):o,a=l.length-1;a>=0;a--)(n=l[a])&&(t=(r?n(o,e,t):n(t))||t);return r&&t&&d(o,e,t),t};class Truncated extends index_dev.wG{constructor(){super(...arguments),this.placement="top-start",this.successMessage="Copied to clipboard",this.hasCopied=!1,this.fullText="",this.overflowing=!1,this.resizeObserver=new ResizeObserver(()=>{this.measureOverflow()}),this.mutationObserver=new MutationObserver(()=>{this.copyText()})}static get styles(){return[truncated_css]}get hasCustomOverflow(){return this.slottedOverflow.length>0}render(){return index_dev.qy`
    ...
    >
      ...
      <sp-truncated>ThisIsAVeryLongWordThatShouldBeTruncated</sp-truncated>
      <sp-truncated>
        We can even
  ...
  `,__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:'() => {\n  return html`\n    <p\n      style="width: 200px; color: #000; border: solid 1px #ccc; overflow: hidden; resize: both;"\n    >\n      <sp-truncated>\n        This is a\n        <strong>very long</strong>\n        🦋 sentence that 🦋 should be truncated\n      </sp-truncated>\n      <sp-truncated>ThisIsAVeryLongWordThatShouldBeTruncated</sp-truncated>\n      <sp-truncated>\n        We can even\n        <img src=${Dog} alt="kitten" />\n        truncate around a picture\n      </sp-truncated>\n      <sp-truncated>\n        Custom overflow content can also be provided for the tooltip\n        <span slot="overflow">\n          <span style="font-size: 24px;">Like this!</span>\n        </span>\n      </sp-truncated>\n      <sp-truncated placement="right">\n        Alternative placements can be specified\n      </sp-truncated>\n      <sp-truncated>Should have no tooltip</sp-truncated>\n    </p>\n  `;\n}',...Default.parameters?.docs?.source}}}},"./packages/overlay/sp-overlay.dev.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__);var _spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/define-element.dev.js"),_src_Overlay_dev_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./packages/overlay/src/Overlay.dev.js");(0,_spectrum_web_components_base_src_define_element_js__WEBPACK_IMPORTED_MODULE_0__.e)("sp-overlay",_src_Overlay_dev_js__WEBPACK_IMPORTED_MODULE_1__.Overlay)}}]);
//# sourceMappingURL=truncated-stories-truncated-stories.c9d4a39a.iframe.bundle.js.map