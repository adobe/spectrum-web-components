...
`,c=Object.defineProperty,u=Object.getOwnPropertyDescriptor,i=(n,s,e,o)=>{for(var p,t=o>1?void 0:o?u(s,e):s,a=n.length-1;a>=0;a--)(p=n[a])&&(t=(o?p(s,e,t):p(t))||t);return o&&t&&c(s,e,t),t};const DEFAULT_ARIA_LABELS_help="Help",DEFAULT_ARIA_LABELS_info="Information";class ContextualHelp extends index_dev.wG{constructor(){super(...arguments),this.isMobile=new MatchMedia_dev._9(this,MatchMedia_dev.yS),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[contextual_help_css]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?DEFAULT_ARIA_LABELS_help:DEFAULT_ARIA_LABELS_info}renderOverlayContent(){return this.isMobile.matches?(Promise.all([__webpack_require__.e(8614),__webpack_require__.e(1335)]).then(__webpack_require__.bind(__webpack_require__,"./packages/dialog/sp-dialog-base.dev.js")),__webpack_require__.e(8614).then(__webpack_require__.bind(__webpack_require__,"./packages/dialog/sp-dialog.dev.js")),index_dev.qy`
...
//# sourceMappingURL=contextual-help-stories-contextual-help-stories.d216f745.iframe.bundle.js.map