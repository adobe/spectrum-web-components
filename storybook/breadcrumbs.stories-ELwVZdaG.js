...
import { i, s as s$1 } from './lit-element-BulMEkr1.js';
import { T, x } from './lit-html-COgVUehj.js';
import { o as o$1 } from './if-defined-DDJGFaN4.js';
import { n as n$1, S as SpectrumElement } from './define-element-B3-QvDZd.js';
...
var u=Object.defineProperty;var a=(s,i,e,r)=>{for(var t=void 0,o=s.length-1,l;o>=0;o--)(l=s[o])&&(t=(l(i,e,t))||t);return t&&u(i,e,t),t};class BreadcrumbItem extends LikeAnchor(Focusable){constructor(){super(...arguments);this.value=void 0;this.isLastOfType=!1;}static get styles(){return [e,r]}get focusElement(){return this.shadowRoot.querySelector("#item-link")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","listitem");}announceSelected(e){const r={value:e},t=new CustomEvent("breadcrumb-select",{bubbles:!0,composed:!0,detail:r});this.dispatchEvent(t);}handleClick(e){!this.href&&e&&e.preventDefault(),(!this.href||e!=null&&e.defaultPrevented)&&this.value&&!this.isLastOfType&&this.announceSelected(this.value);}handleKeyDown(e){(e.key==="Enter"||e.keyCode===13)&&this.handleClick(e);}renderLink(){return x`
            <a
                id="item-link"
...
class AddItemsStoryBreadcrumbs extends s$1 {
  constructor() {
    super(...arguments);
    this._counter = 2;
    this._items = [];
...
__decorateClass([
  n$1({ type: Number })
], AddItemsStoryBreadcrumbs.prototype, "maxVisibleItems");
customElements.define("add-items-story-breadcrumbs", AddItemsStoryBreadcrumbs);
const AddItemsDynamic = (args) => {
  return x`
        <add-items-story-breadcrumbs
            maxVisibleItems=${o$1(args["max-visible-items"])}
        ></add-items-story-breadcrumbs>
    `;
};
...
const __namedExportsOrder = ['Default', 'Disabled', 'Compact', 'Links', 'AddItemsDynamic', 'ShowRoot', 'resizableBehavior'];

export { AddItemsDynamic, Compact, Default, Disabled, Links, ShowRoot, __namedExportsOrder, breadcrumbs_stories as default, resizableBehavior };
