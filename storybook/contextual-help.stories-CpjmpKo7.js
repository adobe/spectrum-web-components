...
import { S as SpectrumElement, n } from './define-element-DeMmBNCp.js';
...
var u=Object.defineProperty;var i=(a,s,e,o)=>{for(var t=void 0,n=a.length-1,p;n>=0;n--)(p=a[n])&&(t=(p(s,e,t))||t);return t&&u(s,e,t),t};class ContextualHelp extends SpectrumElement{constructor(){super(...arguments);this.isMobile=new MatchMediaController(this,IS_MOBILE);this.variant="info";this.placement="bottom-start";this.offset=0;this.open=!1;}static get styles(){return [e]}get buttonAriaLabel(){return this.label?this.label:this.variant==="help"?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(import('./sp-dialog-base-Bpf3HUBz.js'),import('./sp-dialog-Dfj7xe5U.js'),x`
            ...
            `):(import('./sp-popover-ZCxd8XTH.js'),x`
