...
`;class Asset extends SpectrumElement{constructor(){super(...arguments);this.label="";}static get styles(){return [e]}render(){return this.variant==="file"?f(this.label):this.variant==="folder"?m(this.label):x`
            <slot></slot>
