...
`;(0,__webpack_require__("./tools/base/src/define-element.dev.js").e)("sp-asset",class Asset extends p{static get styles(){return[asset_css]}render(){return"file"===this.variant?(label=this.label,index_dev.qy`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
//# sourceMappingURL=asset-stories-asset-stories.ba760c5b.iframe.bundle.js.map