...
import { b as b$1 } from './spectrum-icon-chevron.css-i0thkS8X.js';
import { i } from './lit-element-xBOPiTek.js';
import { S as SizedMixin } from './sizedMixin-IBQibr2z.js';
import { a as PickerBase } from './Picker-dv2kmg-i.js';
...
var u=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var o=(r,n,e,i)=>{for(var t=i>1?void 0:i?p(n,e):n,a=r.length-1,l;a>=0;a--)(l=r[a])&&(t=(i?l(n,e,t):l(t))||t);return i&&t&&u(n,e,t),t};const y={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class SplitButton extends SizedMixin(PickerBase){constructor(){super(...arguments);this.left=!1;this.variant="accent";this.type="field";this.listRole="menu";this.itemRole="menuitem";}static get styles(){return [b,b$1]}get focusElement(){return this.open?this.optionsMenu:this.left?this.trigger:this.button}passClick(){const e=this.type==="more"?this.menuItems[0]:this.selectedItem||this.menuItems[0];e&&e.click();}get buttonContent(){var e;return [x`
                <div
                    id="label"
                    role="presentation"
