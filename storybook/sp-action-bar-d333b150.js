...
var u=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var r=(o,i,e,s)=>{for(var t=s>1?void 0:s?c(i,e):i,p=o.length-1,a;p>=0;p--)(a=o[p])&&(t=(s?a(i,e,t):a(t))||t);return s&&t&&u(i,e,t),t};const actionBarVariants=["sticky","fixed"];class ActionBar extends SpectrumElement{constructor(){super(...arguments);this.emphasized=!1;this.flexible=!1;this.open=!1;this._variant="";}static get styles(){return [m]}set variant(e){if(e!==this.variant){if(actionBarVariants.includes(e)){this.setAttribute("variant",e),this._variant=e;return}this.removeAttribute("variant"),this._variant="";}}get variant(){return this._variant}handleClick(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0}))||(this.open=!0);}render(){return x`
        ...
        `}}r([n({type:Boolean,reflect:!0})],ActionBar.prototype,"emphasized",2),r([n({type:Boolean,reflect:!0})],ActionBar.prototype,"flexible",2),r([n({type:Boolean,reflect:!0})],ActionBar.prototype,"open",2),r([n({type:String,reflect:!0})],ActionBar.prototype,"variant",1);
