"use strict";(self.webpackChunk_spectrum_web_components_1st_gen=self.webpackChunk_spectrum_web_components_1st_gen||[]).push([[3902],{"./packages/asset/stories/asset.stories.js":function(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:function(){return Default},File:function(){return File},Folder:function(){return Folder},__namedExportsOrder:function(){return __namedExportsOrder}});var _spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./tools/base/src/index.dev.js"),_card_stories_images__WEBPACK_IMPORTED_MODULE_2__=(__webpack_require__("./packages/asset/sp-asset.dev.js"),__webpack_require__("./packages/card/stories/images.js"));__webpack_exports__.default={title:"Asset",component:"sp-asset"};const Default=()=>_spectrum_web_components_base__WEBPACK_IMPORTED_MODULE_0__.qy`
  ...
  `,__namedExportsOrder=["Default","File","Folder"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:'() => {\n  return html`\n    <sp-asset style="height: 128px">\n      <img src=${portrait} alt="Demo Graphic" />\n    </sp-asset>\n  `;\n}',...Default.parameters?.docs?.source}}},File.parameters={...File.parameters,docs:{...File.parameters?.docs,source:{originalSource:'() => {\n  return html`\n    <sp-asset variant="file"></sp-asset>\n  `;\n}',...File.parameters?.docs?.source}}},Folder.parameters={...Folder.parameters,docs:{...Folder.parameters?.docs,source:{originalSource:'() => {\n  return html`\n    <sp-asset variant="folder"></sp-asset>\n  `;\n}',...Folder.parameters?.docs?.source}}}},"./packages/asset/sp-asset.dev.js":function(__unused_webpack_module,__unused_webpack___webpack_exports__,__webpack_require__){var define_element_dev=__webpack_require__("./tools/base/src/define-element.dev.js"),index_dev=__webpack_require__("./tools/base/src/index.dev.js"),decorators_dev=__webpack_require__("./tools/base/src/decorators.dev.js");var __defProp=Object.defineProperty,__getOwnPropDesc=Object.getOwnPropertyDescriptor,__decorateClass=(decorators,target,key,kind)=>{for(var decorator,result=kind>1?void 0:kind?__getOwnPropDesc(target,key):target,i=decorators.length-1;i>=0;i--)(decorator=decorators[i])&&(result=(kind?decorator(target,key,result):decorator(result))||result);return kind&&result&&__defProp(target,key,result),result};class AssetBase extends index_dev.wG{constructor(){super(...arguments),this.label=""}updated(changes){super.updated(changes);{const constructor=this.constructor;void 0===this.variant||constructor.VARIANTS.includes(this.variant)||window.__swc.warn(this,`<${this.localName}> element expects the "variant" attribute to be one of the following:`,"https://opensource.adobe.com/spectrum-web-components/components/asset/",{issues:[...constructor.VARIANTS]})}}}AssetBase.VARIANTS=["file","folder"],__decorateClass([(0,decorators_dev.MZ)({type:String,reflect:!0})],AssetBase.prototype,"variant",2),__decorateClass([(0,decorators_dev.MZ)()],AssetBase.prototype,"label",2);var asset_css=index_dev.AH`
...
`;(0,define_element_dev.e)("sp-asset",class Asset extends AssetBase{static get styles(){return[asset_css]}render(){return"file"===this.variant?(label=this.label,index_dev.qy`
  <svg
    class="file"
    role="img"
    viewBox="0 0 128 128"
...
`)(this.label):index_dev.qy`
      <slot></slot>
    `;var label}})}}]);
//# sourceMappingURL=asset-stories-asset-stories.3f22d9a3.iframe.bundle.js.map