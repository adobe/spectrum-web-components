...
*/
import { html, CSSResultArray, TemplateResult } from '@future-ui/base';
...
import '@future-ui/icons-workflow/icons/sp-icon-star.js';
import '@future-ui/icons-workflow/icons/sp-icon-chevron-down.js';
import '@future-ui/icons-workflow/icons/sp-icon-close.js';
import '@future-ui/icons-workflow/icons/sp-icon-info.js';
...
import '@future-ui/icons-workflow/icons/sp-icon-save-floppy.js';
import '@future-ui/icons-workflow/icons/sp-icon-stopwatch.js';
import '@future-ui/icons-workflow/icons/sp-icon-user-activity.js';
...
import { Tabs } from '@future-ui/tabs';
