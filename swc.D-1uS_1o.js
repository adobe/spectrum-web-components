import{t as e,s as l}from"./swc.Chuw36y7.js";import{I as i}from"./swc.Bea_DqvJ.js";import{x as r}from"./swc.DWYvVEd1.js";import{d as t}from"./swc.JlveB6nj.js";t("sp-icon-checkmark-circle",class extends i{render(){return l(r),2===this.spectrumVersion?(({width:l=24,height:i=24,hidden:r=!1,title:t="Checkmark Circle"}={})=>e`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:l=24,height:i=24,hidden:r=!1,title:t="Checkmark Circle"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${l}"
    height="${i}"
    viewBox="0 0 36 36"
...
//# sourceMappingURL=swc.Cq-w7V_d.js.map
