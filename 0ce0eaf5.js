import{i as t}from"./112b2095.js";import{n as e,S as o,x as s,d as i,A as a}from"./dd8018c7.js";import{a as r,O as c,l,i as n,F as d,L as m}from"./41f420ad.js";import{O as b}from"./617fa4cb.js";import{s as h}from"./ff8e484a.js";import{R as u}from"./a37f886d.js";import{o as p}from"./ee166bc2.js";import{S as v}from"./cd538c17.js";import"./20aeaa6a.js";import"./e580ab3f.js";import"./7c165e09.js";import"./6435deef.js";import"./a6c69bec.js";import"./7e4daee2.js";import"./16ab2288.js";import"./4a4b0658.js";import"./a32b3899.js";import"./d6d0b127.js";import"./93b7e594.js";import"./9ddc847e.js";import"./cd496c6f.js";var g=t`
...
`,D=Object.defineProperty,X=Object.getOwnPropertyDescriptor,_=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?X(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&D(e,o,a),a};class M extends(m(d)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[z,R]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${l(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}_([n("a")],M.prototype,"anchor",2),_([e({type:Boolean,reflect:!0})],M.prototype,"selected",2),i("sp-top-nav-item",M),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:o}=e,{pathname:s}=location,i=s.search("api")>-1;switch(o){case"api":{if(i)return;const t=(s+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!i)return;const t=s.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./1d813332.js"),import("./7a5ffa03.js")})):requestAnimationFrame((()=>{import("./1d813332.js"),import("./7a5ffa03.js")}));var Y=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",Y),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{j as g};
//# sourceMappingURL=0ce0eaf5.js.map
