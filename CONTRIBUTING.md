...
- Branch names should follow the format: `<username>/<type>-<description>-<issue-number>`
  ...
  - `description`: A brief, hyphen-separated description of the change
  - `issue-number`: If your work references a known issue, you should also incorporate the issue number (e.g., `alex/fix-accordion-bug-swc-123`).

Examples:

- `johndoe/feat-add-new-button-swc-456`
- `janedoe/fix-dropdown-bug-swc-789`
- `alex/docs-update-readme`
- `sarah/chore-update-dependencies-swc-101`

Note: When using Cursor IDE, this branch naming convention will be automatically enforced.
