...
- [Headings and landmarks](/docs/guides-accessibility-headings-and-landmarks--docs): a logical **`h1`-`h6` outline** and **landmark** regions (`main`, `nav`, `header`, and similar), including Spectrum Web Components notes (`heading-level`, slots)
- [Semantic HTML and ARIA](/docs/guides-accessibility-semantic-html-and-aria--docs): when native HTML is enough, when to use ARIA, and **cross-root** limitations in custom elements
- [ElementInternals and axe-core](/docs/guides-accessibility-elementinternals-and-axe-core--docs): what browsers and assistive technology expose versus what axe-core can see, and how to scope CI failures for form-associated custom elements
- [WAVE toolbar testing](/docs/guides-accessibility-wave-toolbar-testing--docs): free browser extension for reviewing the rendered page via the **Structure**, **Order**, **Details**, and **Contrast** tabs
- [Keyboard testing](/docs/guides-accessibility-keyboard-testing--docs): <kbd>Tab</kbd> order, focus, and component keyboard models
- [Screen reader testing](/docs/guides-accessibility-screen-reader-testing--docs): browse and focus modes, and shortcuts to move by **heading** and **landmark**
- [Accessible pattern libraries](/docs/guides-accessibility-accessible-pattern-libraries--docs): pattern collection for accessible UI
- [Accessibility resources](/docs/guides-accessibility-accessibility-resources--docs): external references and checklists
