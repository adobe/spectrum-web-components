...
See [Headings and landmarks](/docs/guides-accessibility-headings-and-landmarks--docs) for guidance on structuring **landmarks** and **headings** in markup. You can **inspect** that structure in the browser with WAVE — see [WAVE toolbar testing](/docs/guides-accessibility-wave-toolbar-testing--docs#structure-tab).

### Relationship to keyboard accessibility

Screen reader testing builds on [keyboard testing](/docs/guides-accessibility-keyboard-testing--docs). Before testing with a screen reader:
...
[Headings and landmarks](/docs/guides-accessibility-headings-and-landmarks--docs) explains which native **landmark** regions to use, when too many `region` landmarks add noise, and how landmarks work with a heading outline.
...
3. **Navigate to the component**: Use heading or landmark navigation (shape that structure in your app per [Headings and landmarks](/docs/guides-accessibility-headings-and-landmarks--docs))
...
For quick, on-page **outline** feedback before or during screen reader tests, use [WAVE toolbar testing](/docs/guides-accessibility-wave-toolbar-testing--docs). For more testing resources and tools, see [Accessibility resources](/docs/guides-accessibility-accessibility-resources--docs).
