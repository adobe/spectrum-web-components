...
- **Colored dot indicator**: visual representation of a status or category
...
> **Note**: The `pink`, `turquoise`, `brown`, `cinnamon`, and `silver` variants are new in gen2 and not available in 1st-gen.
