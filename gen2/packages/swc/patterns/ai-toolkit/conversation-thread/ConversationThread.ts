...
/**
 * Thread-level layout wrapper for AI turns with vertical keyboard navigation.
 *
 ...
 *
 * @cssprop --swc-conversation-thread-gap - Gap between turns. Defaults to spacing-400.
 *
 * @since 2.0.0-beta.3
 */
