...
test.describe('ConversationThread - ARIA Snapshots', () => {
  test('should expose conversation turns in reading order', async ({
    ...
    const root = await gotoStory(
      page,
      'patterns-ai-toolkit-conversation-thread--accessibility',
    ...
    await expect(root).toMatchAriaSnapshot(`
      ...
      - group "System message":
        - button "I interpreted your request as an executive narrative task and prioritized a concise, audience-ready structure."
