...
import * as UploadAttachmentStories from './upload-attachment/stories/upload-attachment.stories';
...
<Meta title="AI Toolkit/Conversational pattern overview" />

# AI Toolkit

A composable set of web components for building AI interfaces with Spectrum. The pattern covers the full experience lifecycle — prompt entry, generation status, response output, source attribution, feedback, and follow-up suggestions.

---

## Full example

An end-to-end conversation with streaming generation, file upload, feedback, and follow-up suggestions. This example illustrates interactions like sending prompts, attaching files (via the upload button or by dropping them directly onto the field), and selecting suggestions.
...
The **`+`** button should open a menu with, at minimum, **Add from Adobe cloud storage** and **Attach files**. See [Upload action menu](/docs/patterns-ai-toolkit-prompt-field--docs#upload-action-menu) for the full guidance.
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-prompt-field--docs'
          ),
    },
  ]}
/>
...
<Canvas
  of={UploadAttachmentStories.MediaWithBadge}
  additionalActions={[
    {
      title: 'Component docs',
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-upload-attachment--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-conversation-thread--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-conversation-turn--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-user-message--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-system-message--docs'
          ),
    },
  ]}
/>
...
A status indicator while the response is generating and an optional collapsible execution trace when steps are provided.

<Canvas
  of={ResponseStatusStories.Overview}
  additionalActions={[
    {
      title: 'Component docs',
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-response-status--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-message-feedback--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-message-sources--docs'
          ),
    },
  ]}
/>
...
After a reply, offer the user a curated list of next prompts. The pattern has no built-in sense of conversation history, so it's up to the product to slot a `swc-suggestion-group` only into the latest system turn, clearing or omitting the `suggestions` slot from earlier ones as the conversation moves forward.
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-suggestion-group--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-toolkit-suggestion-group-suggestion-item--docs'
          ),
    },
  ]}
/>
