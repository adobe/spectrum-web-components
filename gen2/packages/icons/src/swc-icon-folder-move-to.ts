...
import { Icon_FolderMoveTo } from './FolderMoveTo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The FolderMoveTo workflow icon as a custom element.
 *
 * @element swc-icon-folder-move-to
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconFolderMoveTo extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-folder-move-to': IconFolderMoveTo;
  }
}

defineElement('swc-icon-folder-move-to', IconFolderMoveTo);
