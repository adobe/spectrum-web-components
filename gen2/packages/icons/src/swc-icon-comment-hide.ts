...
import { Icon_CommentHide } from './CommentHide.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CommentHide workflow icon as a custom element.
 *
 * @element swc-icon-comment-hide
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconCommentHide extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-comment-hide': IconCommentHide;
  }
}

defineElement('swc-icon-comment-hide', IconCommentHide);
