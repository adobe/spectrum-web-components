...
import { Icon_Mention } from './Mention.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Mention workflow icon as a custom element.
 *
 * @element swc-icon-mention
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-mention': IconMention;
  }
}

defineElement('swc-icon-mention', IconMention);
