...
import { Icon_TextItalic } from './TextItalic.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextItalic workflow icon as a custom element.
 *
 * @element swc-icon-text-italic
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-italic': IconTextItalic;
  }
}

defineElement('swc-icon-text-italic', IconTextItalic);
