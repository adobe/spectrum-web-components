...
import { Icon_Comment } from './Comment.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Comment workflow icon as a custom element.
 *
 * @element swc-icon-comment
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-comment': IconComment;
  }
}

defineElement('swc-icon-comment', IconComment);
