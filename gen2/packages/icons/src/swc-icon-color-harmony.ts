...
import { Icon_ColorHarmony } from './ColorHarmony.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ColorHarmony workflow icon as a custom element.
 *
 * @element swc-icon-color-harmony
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconColorHarmony extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-color-harmony': IconColorHarmony;
  }
}

defineElement('swc-icon-color-harmony', IconColorHarmony);
