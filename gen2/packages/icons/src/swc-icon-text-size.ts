...
import { Icon_TextSize } from './TextSize.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextSize workflow icon as a custom element.
 *
 * @element swc-icon-text-size
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-size': IconTextSize;
  }
}

defineElement('swc-icon-text-size', IconTextSize);
