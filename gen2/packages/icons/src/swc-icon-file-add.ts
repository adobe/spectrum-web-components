...
import { Icon_FileAdd } from './FileAdd.js';

import styles from './stylesheets/icon-base.css';

/**
 * The FileAdd workflow icon as a custom element.
 *
 * @element swc-icon-file-add
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-file-add': IconFileAdd;
  }
}

defineElement('swc-icon-file-add', IconFileAdd);
