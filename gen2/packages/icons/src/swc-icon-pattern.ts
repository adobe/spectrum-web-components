...
import { Icon_Pattern } from './Pattern.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Pattern workflow icon as a custom element.
 *
 * @element swc-icon-pattern
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-pattern': IconPattern;
  }
}

defineElement('swc-icon-pattern', IconPattern);
