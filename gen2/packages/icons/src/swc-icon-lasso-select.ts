...
import { Icon_LassoSelect } from './LassoSelect.js';

import styles from './stylesheets/icon-base.css';

/**
 * The LassoSelect workflow icon as a custom element.
 *
 * @element swc-icon-lasso-select
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-lasso-select': IconLassoSelect;
  }
}

defineElement('swc-icon-lasso-select', IconLassoSelect);
