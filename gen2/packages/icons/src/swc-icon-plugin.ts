...
import { Icon_Plugin } from './Plugin.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Plugin workflow icon as a custom element.
 *
 * @element swc-icon-plugin
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-plugin': IconPlugin;
  }
}

defineElement('swc-icon-plugin', IconPlugin);
