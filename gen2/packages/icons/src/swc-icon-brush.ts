...
import { Icon_Brush } from './Brush.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Brush workflow icon as a custom element.
 *
 * @element swc-icon-brush
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-brush': IconBrush;
  }
}

defineElement('swc-icon-brush', IconBrush);
