...
import { Icon_Properties } from './Properties.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Properties workflow icon as a custom element.
 *
 * @element swc-icon-properties
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-properties': IconProperties;
  }
}

defineElement('swc-icon-properties', IconProperties);
