...
import { Icon_DeviceDesktop } from './DeviceDesktop.js';

import styles from './stylesheets/icon-base.css';

/**
 * The DeviceDesktop workflow icon as a custom element.
 *
 * @element swc-icon-device-desktop
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-device-desktop': IconDeviceDesktop;
  }
}

defineElement('swc-icon-device-desktop', IconDeviceDesktop);
