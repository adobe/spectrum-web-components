...
import { Icon_Filter } from './Filter.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Filter workflow icon as a custom element.
 *
 * @element swc-icon-filter
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-filter': IconFilter;
  }
}

defineElement('swc-icon-filter', IconFilter);
