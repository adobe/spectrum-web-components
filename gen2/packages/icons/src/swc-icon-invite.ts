...
import { Icon_Invite } from './Invite.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Invite workflow icon as a custom element.
 *
 * @element swc-icon-invite
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-invite': IconInvite;
  }
}

defineElement('swc-icon-invite', IconInvite);
