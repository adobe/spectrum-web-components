...
import { Icon_LineHeight } from './LineHeight.js';

import styles from './stylesheets/icon-base.css';

/**
 * The LineHeight workflow icon as a custom element.
 *
 * @element swc-icon-line-height
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-line-height': IconLineHeight;
  }
}

defineElement('swc-icon-line-height', IconLineHeight);
