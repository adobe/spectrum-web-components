...
import { Icon_Duplicate } from './Duplicate.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Duplicate workflow icon as a custom element.
 *
 * @element swc-icon-duplicate
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-duplicate': IconDuplicate;
  }
}

defineElement('swc-icon-duplicate', IconDuplicate);
