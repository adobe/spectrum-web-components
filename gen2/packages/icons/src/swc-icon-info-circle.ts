...
import { Icon_InfoCircle } from './InfoCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The InfoCircle workflow icon as a custom element.
 *
 * @element swc-icon-info-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-info-circle': IconInfoCircle;
  }
}

defineElement('swc-icon-info-circle', IconInfoCircle);
