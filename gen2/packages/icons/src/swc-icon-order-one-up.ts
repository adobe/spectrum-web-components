...
import { Icon_OrderOneUp } from './OrderOneUp.js';

import styles from './stylesheets/icon-base.css';

/**
 * The OrderOneUp workflow icon as a custom element.
 *
 * @element swc-icon-order-one-up
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-order-one-up': IconOrderOneUp;
  }
}

defineElement('swc-icon-order-one-up', IconOrderOneUp);
