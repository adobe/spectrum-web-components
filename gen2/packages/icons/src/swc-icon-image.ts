...
import { Icon_Image } from './Image.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Image workflow icon as a custom element.
 *
 * @element swc-icon-image
 * @since 2.0.0-beta.2
 *
...
export class IconImage extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Image())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-image': IconImage;
  }
}

defineElement('swc-icon-image', IconImage);
