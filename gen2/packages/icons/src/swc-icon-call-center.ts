...
import { Icon_CallCenter } from './CallCenter.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CallCenter workflow icon as a custom element.
 *
 * @element swc-icon-call-center
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-call-center': IconCallCenter;
  }
}

defineElement('swc-icon-call-center', IconCallCenter);
