...
import { Icon_Exposure } from './Exposure.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Exposure workflow icon as a custom element.
 *
 * @element swc-icon-exposure
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-exposure': IconExposure;
  }
}

defineElement('swc-icon-exposure', IconExposure);
