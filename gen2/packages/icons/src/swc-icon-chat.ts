...
import { Icon_Chat } from './Chat.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Chat workflow icon as a custom element.
 *
 * @element swc-icon-chat
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-chat': IconChat;
  }
}

defineElement('swc-icon-chat', IconChat);
