...
import { Icon_SelectNo } from './SelectNo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The SelectNo workflow icon as a custom element.
 *
 * @element swc-icon-select-no
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconSelectNo extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-select-no': IconSelectNo;
  }
}

defineElement('swc-icon-select-no', IconSelectNo);
