...
import { Icon_UserSettings } from './UserSettings.js';

import styles from './stylesheets/icon-base.css';

/**
 * The UserSettings workflow icon as a custom element.
 *
 * @element swc-icon-user-settings
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconUserSettings extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-user-settings': IconUserSettings;
  }
}

defineElement('swc-icon-user-settings', IconUserSettings);
