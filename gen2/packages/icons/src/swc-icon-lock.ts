...
import { Icon_Lock } from './Lock.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Lock workflow icon as a custom element.
 *
 * @element swc-icon-lock
 * @since 2.0.0-beta.2
 *
...
export class IconLock extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Lock())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-lock': IconLock;
  }
}

defineElement('swc-icon-lock', IconLock);
