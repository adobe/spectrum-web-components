...
import { Icon_Text } from './Text.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Text workflow icon as a custom element.
 *
 * @element swc-icon-text
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text': IconText;
  }
}

defineElement('swc-icon-text', IconText);
