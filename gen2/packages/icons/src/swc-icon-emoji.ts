...
import { Icon_Emoji } from './Emoji.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Emoji workflow icon as a custom element.
 *
 * @element swc-icon-emoji
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-emoji': IconEmoji;
  }
}

defineElement('swc-icon-emoji', IconEmoji);
