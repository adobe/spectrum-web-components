...
import { Icon_Line } from './Line.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Line workflow icon as a custom element.
 *
 * @element swc-icon-line
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-line': IconLine;
  }
}

defineElement('swc-icon-line', IconLine);
