...
import { Icon_PremiumIcon } from './PremiumIcon.js';

import styles from './stylesheets/icon-base.css';

/**
 * The PremiumIcon workflow icon as a custom element.
 *
 * @element swc-icon-premium-icon
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconPremiumIcon extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-premium-icon': IconPremiumIcon;
  }
}

defineElement('swc-icon-premium-icon', IconPremiumIcon);
