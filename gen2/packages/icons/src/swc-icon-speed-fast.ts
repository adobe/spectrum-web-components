...
import { Icon_SpeedFast } from './SpeedFast.js';

import styles from './stylesheets/icon-base.css';

/**
 * The SpeedFast workflow icon as a custom element.
 *
 * @element swc-icon-speed-fast
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconSpeedFast extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-speed-fast': IconSpeedFast;
  }
}

defineElement('swc-icon-speed-fast', IconSpeedFast);
