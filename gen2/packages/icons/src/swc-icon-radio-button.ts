...
import { Icon_RadioButton } from './RadioButton.js';

import styles from './stylesheets/icon-base.css';

/**
 * The RadioButton workflow icon as a custom element.
 *
 * @element swc-icon-radio-button
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-radio-button': IconRadioButton;
  }
}

defineElement('swc-icon-radio-button', IconRadioButton);
