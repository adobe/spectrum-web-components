...
import { Icon_GlobeGrid } from './GlobeGrid.js';

import styles from './stylesheets/icon-base.css';

/**
 * The GlobeGrid workflow icon as a custom element.
 *
 * @element swc-icon-globe-grid
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-globe-grid': IconGlobeGrid;
  }
}

defineElement('swc-icon-globe-grid', IconGlobeGrid);
