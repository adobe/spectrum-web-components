...
import { Icon_Data } from './Data.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Data workflow icon as a custom element.
 *
 * @element swc-icon-data
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-data': IconData;
  }
}

defineElement('swc-icon-data', IconData);
