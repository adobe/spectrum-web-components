...
import { Icon_RemoveCircle } from './RemoveCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The RemoveCircle workflow icon as a custom element.
 *
 * @element swc-icon-remove-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-remove-circle': IconRemoveCircle;
  }
}

defineElement('swc-icon-remove-circle', IconRemoveCircle);
