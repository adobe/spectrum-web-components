...
import { Icon_Channel } from './Channel.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Channel workflow icon as a custom element.
 *
 * @element swc-icon-channel
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-channel': IconChannel;
  }
}

defineElement('swc-icon-channel', IconChannel);
