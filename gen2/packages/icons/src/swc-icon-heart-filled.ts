...
import { Icon_HeartFilled } from './HeartFilled.js';

import styles from './stylesheets/icon-base.css';

/**
 * The HeartFilled workflow icon as a custom element.
 *
 * @element swc-icon-heart-filled
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-heart-filled': IconHeartFilled;
  }
}

defineElement('swc-icon-heart-filled', IconHeartFilled);
