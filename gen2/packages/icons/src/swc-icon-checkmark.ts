...
import { Icon_Checkmark } from './Checkmark.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Checkmark workflow icon as a custom element.
 *
 * @element swc-icon-checkmark
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-checkmark': IconCheckmark;
  }
}

defineElement('swc-icon-checkmark', IconCheckmark);
