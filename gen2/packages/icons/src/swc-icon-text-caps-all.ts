...
import { Icon_TextCapsAll } from './TextCapsAll.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextCapsAll workflow icon as a custom element.
 *
 * @element swc-icon-text-caps-all
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconTextCapsAll extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-caps-all': IconTextCapsAll;
  }
}

defineElement('swc-icon-text-caps-all', IconTextCapsAll);
