...
import { Icon_Collection } from './Collection.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Collection workflow icon as a custom element.
 *
 * @element swc-icon-collection
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-collection': IconCollection;
  }
}

defineElement('swc-icon-collection', IconCollection);
