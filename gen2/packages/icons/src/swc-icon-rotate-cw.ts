...
import { Icon_RotateCW } from './RotateCW.js';

import styles from './stylesheets/icon-base.css';

/**
 * The RotateCW workflow icon as a custom element.
 *
 * @element swc-icon-rotate-cw
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-rotate-cw': IconRotateCW;
  }
}

defineElement('swc-icon-rotate-cw', IconRotateCW);
