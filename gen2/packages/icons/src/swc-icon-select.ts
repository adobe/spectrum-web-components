...
import { Icon_Select } from './Select.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Select workflow icon as a custom element.
 *
 * @element swc-icon-select
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-select': IconSelect;
  }
}

defineElement('swc-icon-select', IconSelect);
