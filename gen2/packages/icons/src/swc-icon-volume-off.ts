...
import { Icon_VolumeOff } from './VolumeOff.js';

import styles from './stylesheets/icon-base.css';

/**
 * The VolumeOff workflow icon as a custom element.
 *
 * @element swc-icon-volume-off
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-volume-off': IconVolumeOff;
  }
}

defineElement('swc-icon-volume-off', IconVolumeOff);
