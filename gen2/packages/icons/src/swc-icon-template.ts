...
import { Icon_Template } from './Template.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Template workflow icon as a custom element.
 *
 * @element swc-icon-template
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-template': IconTemplate;
  }
}

defineElement('swc-icon-template', IconTemplate);
