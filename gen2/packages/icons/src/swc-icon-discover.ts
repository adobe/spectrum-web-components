...
import { Icon_Discover } from './Discover.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Discover workflow icon as a custom element.
 *
 * @element swc-icon-discover
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-discover': IconDiscover;
  }
}

defineElement('swc-icon-discover', IconDiscover);
