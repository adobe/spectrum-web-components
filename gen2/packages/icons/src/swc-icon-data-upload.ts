...
import { Icon_DataUpload } from './DataUpload.js';

import styles from './stylesheets/icon-base.css';

/**
 * The DataUpload workflow icon as a custom element.
 *
 * @element swc-icon-data-upload
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-data-upload': IconDataUpload;
  }
}

defineElement('swc-icon-data-upload', IconDataUpload);
