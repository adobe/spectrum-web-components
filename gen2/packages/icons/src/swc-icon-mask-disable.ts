...
import { Icon_MaskDisable } from './MaskDisable.js';

import styles from './stylesheets/icon-base.css';

/**
 * The MaskDisable workflow icon as a custom element.
 *
 * @element swc-icon-mask-disable
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconMaskDisable extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-mask-disable': IconMaskDisable;
  }
}

defineElement('swc-icon-mask-disable', IconMaskDisable);
