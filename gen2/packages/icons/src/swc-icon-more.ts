...
import { Icon_More } from './More.js';

import styles from './stylesheets/icon-base.css';

/**
 * The More workflow icon as a custom element.
 *
 * @element swc-icon-more
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-more': IconMore;
  }
}

defineElement('swc-icon-more', IconMore);
