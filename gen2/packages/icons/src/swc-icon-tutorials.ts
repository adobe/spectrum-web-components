...
import { Icon_Tutorials } from './Tutorials.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Tutorials workflow icon as a custom element.
 *
 * @element swc-icon-tutorials
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconTutorials extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-tutorials': IconTutorials;
  }
}

defineElement('swc-icon-tutorials', IconTutorials);
