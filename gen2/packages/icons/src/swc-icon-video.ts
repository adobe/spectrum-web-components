...
import { Icon_Video } from './Video.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Video workflow icon as a custom element.
 *
 * @element swc-icon-video
 * @since 2.0.0-beta.2
 *
...
export class IconVideo extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Video())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-video': IconVideo;
  }
}

defineElement('swc-icon-video', IconVideo);
