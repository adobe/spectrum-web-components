...
import { Icon_Redo } from './Redo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Redo workflow icon as a custom element.
 *
 * @element swc-icon-redo
 * @since 2.0.0-beta.2
 *
...
export class IconRedo extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Redo())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-redo': IconRedo;
  }
}

defineElement('swc-icon-redo', IconRedo);
