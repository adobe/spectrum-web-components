...
import { Icon_Revert } from './Revert.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Revert workflow icon as a custom element.
 *
 * @element swc-icon-revert
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-revert': IconRevert;
  }
}

defineElement('swc-icon-revert', IconRevert);
