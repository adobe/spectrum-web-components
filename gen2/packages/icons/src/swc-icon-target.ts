...
import { Icon_Target } from './Target.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Target workflow icon as a custom element.
 *
 * @element swc-icon-target
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-target': IconTarget;
  }
}

defineElement('swc-icon-target', IconTarget);
