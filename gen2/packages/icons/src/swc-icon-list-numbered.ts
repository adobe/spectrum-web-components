...
import { Icon_ListNumbered } from './ListNumbered.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ListNumbered workflow icon as a custom element.
 *
 * @element swc-icon-list-numbered
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-list-numbered': IconListNumbered;
  }
}

defineElement('swc-icon-list-numbered', IconListNumbered);
