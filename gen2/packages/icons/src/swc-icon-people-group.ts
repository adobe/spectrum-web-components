...
import { Icon_PeopleGroup } from './PeopleGroup.js';

import styles from './stylesheets/icon-base.css';

/**
 * The PeopleGroup workflow icon as a custom element.
 *
 * @element swc-icon-people-group
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-people-group': IconPeopleGroup;
  }
}

defineElement('swc-icon-people-group', IconPeopleGroup);
