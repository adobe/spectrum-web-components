...
import { Icon_Temperature } from './Temperature.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Temperature workflow icon as a custom element.
 *
 * @element swc-icon-temperature
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-temperature': IconTemperature;
  }
}

defineElement('swc-icon-temperature', IconTemperature);
