...
import { Icon_New } from './New.js';

import styles from './stylesheets/icon-base.css';

/**
 * The New workflow icon as a custom element.
 *
 * @element swc-icon-new
 * @since 2.0.0-beta.2
 *
...
export class IconNew extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_New())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-new': IconNew;
  }
}

defineElement('swc-icon-new', IconNew);
