...
import { Icon_Ribbon } from './Ribbon.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Ribbon workflow icon as a custom element.
 *
 * @element swc-icon-ribbon
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-ribbon': IconRibbon;
  }
}

defineElement('swc-icon-ribbon', IconRibbon);
