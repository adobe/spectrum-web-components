...
import { Icon_TextAlignLeft } from './TextAlignLeft.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextAlignLeft workflow icon as a custom element.
 *
 * @element swc-icon-text-align-left
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-align-left': IconTextAlignLeft;
  }
}

defineElement('swc-icon-text-align-left', IconTextAlignLeft);
