...
import { Icon_Close } from './Close.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Close workflow icon as a custom element.
 *
 * @element swc-icon-close
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-close': IconClose;
  }
}

defineElement('swc-icon-close', IconClose);
