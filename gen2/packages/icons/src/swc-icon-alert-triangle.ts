...
import { Icon_AlertTriangle } from './AlertTriangle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AlertTriangle workflow icon as a custom element.
 *
 * @element swc-icon-alert-triangle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-alert-triangle': IconAlertTriangle;
  }
}

defineElement('swc-icon-alert-triangle', IconAlertTriangle);
