...
import { Icon_Layout } from './Layout.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Layout workflow icon as a custom element.
 *
 * @element swc-icon-layout
 * @since 2.0.0-beta.2
 *
...
export class IconLayout extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Layout())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-layout': IconLayout;
  }
}

defineElement('swc-icon-layout', IconLayout);
