...
import { Icon_Project } from './Project.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Project workflow icon as a custom element.
 *
 * @element swc-icon-project
 * @since 2.0.0-beta.2
 *
...
export class IconProject extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Project())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-project': IconProject;
  }
}

defineElement('swc-icon-project', IconProject);
