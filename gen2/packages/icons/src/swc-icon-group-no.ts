...
import { Icon_GroupNo } from './GroupNo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The GroupNo workflow icon as a custom element.
 *
 * @element swc-icon-group-no
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconGroupNo extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-group-no': IconGroupNo;
  }
}

defineElement('swc-icon-group-no', IconGroupNo);
