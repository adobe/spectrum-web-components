...
import { Icon_Polygon5 } from './Polygon5.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Polygon5 workflow icon as a custom element.
 *
 * @element swc-icon-polygon5
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-polygon5': IconPolygon5;
  }
}

defineElement('swc-icon-polygon5', IconPolygon5);
