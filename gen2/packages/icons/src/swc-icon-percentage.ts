...
import { Icon_Percentage } from './Percentage.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Percentage workflow icon as a custom element.
 *
 * @element swc-icon-percentage
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-percentage': IconPercentage;
  }
}

defineElement('swc-icon-percentage', IconPercentage);
