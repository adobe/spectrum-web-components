...
import { Icon_3DAsset } from './3DAsset.js';

import styles from './stylesheets/icon-base.css';

/**
 * The 3DAsset workflow icon as a custom element.
 *
 * @element swc-icon-3d-asset
 * @since 2.0.0-beta.2
 *
 ...
 */
export class Icon3DAsset extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-3d-asset': Icon3DAsset;
  }
}

defineElement('swc-icon-3d-asset', Icon3DAsset);
