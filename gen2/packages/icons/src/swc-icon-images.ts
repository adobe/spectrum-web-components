...
import { Icon_Images } from './Images.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Images workflow icon as a custom element.
 *
 * @element swc-icon-images
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-images': IconImages;
  }
}

defineElement('swc-icon-images', IconImages);
