...
import { Icon_Share } from './Share.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Share workflow icon as a custom element.
 *
 * @element swc-icon-share
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-share': IconShare;
  }
}

defineElement('swc-icon-share', IconShare);
