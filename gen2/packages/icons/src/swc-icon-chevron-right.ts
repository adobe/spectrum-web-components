...
import { Icon_ChevronRight } from './ChevronRight.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ChevronRight workflow icon as a custom element.
 *
 * @element swc-icon-chevron-right
 * @since 2.0.0-beta.2
 *
...
export class IconChevronRight extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_ChevronRight())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-chevron-right': IconChevronRight;
  }
}

defineElement('swc-icon-chevron-right', IconChevronRight);
