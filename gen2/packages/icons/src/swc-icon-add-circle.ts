...
import { Icon_AddCircle } from './AddCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AddCircle workflow icon as a custom element.
 *
 * @element swc-icon-add-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-add-circle': IconAddCircle;
  }
}

defineElement('swc-icon-add-circle', IconAddCircle);
