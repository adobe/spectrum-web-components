...
import { Icon_CommentShow } from './CommentShow.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CommentShow workflow icon as a custom element.
 *
 * @element swc-icon-comment-show
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconCommentShow extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-comment-show': IconCommentShow;
  }
}

defineElement('swc-icon-comment-show', IconCommentShow);
