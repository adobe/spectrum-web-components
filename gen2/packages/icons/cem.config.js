...
/**
 * CEM plugin that extracts `@status` and `@since` JSDoc tags from class declarations and
 * attaches them to the corresponding CEM declaration. Mirrors swc's cem.config.js.
 */
...
export default {
  globs: ['src/**/*.ts', '../core/components/icon/**/*.ts'],
  exclude: [
    '**/*.stories.ts',
    '**/*.test.ts',
    '**/*.spec.ts',
