...
**feat(core):** Added `TriggerPressController`, a Lit reactive controller for click-to-toggle triggers on light-dismissible surfaces (`popover="auto"`, a non-modal `<dialog>`).
