...
skeletons for gen2 components: the component itself, and the **test** and
...
- **Guard first.** If `gen2/packages/swc/components/<name>/` is missing, the
...
`gen2/packages/core/package.json` afterward.
