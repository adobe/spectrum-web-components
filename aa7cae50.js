import{d as e,E as t,N as r,C as a,P as i,A as s,S as n,h as o,_ as l,p as c,M as m,f as p,e as u,u as d,n as g,i as h,q as v,D as x,t as f,I as b,s as y,v as z}from"./ad69f0f9.js";import{c as w}from"./2cc2acb0.js";const k=e((e=>n=>{let o;if(n instanceof t||n instanceof r)throw new Error("The `live` directive is not allowed on text or event bindings");if(n instanceof a)L(n.strings),o=n.element.hasAttribute(n.name),n.value=o;else{const{element:t,name:r,strings:a}=n.committer;if(L(a),n instanceof i){if(o=t[r],o===e)return}else n instanceof s&&(o=t.getAttribute(r));if(o===String(e))return}n.setValue(e)})),L=e=>{if(2!==e.length||""!==e[0]||""!==e[1])throw new Error("`live` bindings can only contain a single expression")},X=e=>e.getRootNode().activeElement;var H=w`.spectrum{color:var(--spectrum-body-m-text-color,var(--spectrum-alias-text-color));font-family:var(
...
//# sourceMappingURL=aa7cae50.js.map
