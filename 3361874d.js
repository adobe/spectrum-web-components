import{f as e,S as t}from"./f128eb4f.js";import{i as r}from"./112b2095.js";import"./1880ba0f.js";import{S as o}from"./d4190391.js";import{T as i,A as c,x as a,n as s,d as l}from"./1a13da4f.js";import"./d039d003.js";import{c as n,t as d}from"./eb03f57e.js";import{l as u,F as p,i as h}from"./bd99a3f7.js";import"./0ea34b92.js";import"./20e08d65.js";import{S as m}from"./9ddc847e.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./6215f5e7.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,R=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?U(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&R(t,r,c),c};const A=e=>e.stopPropagation();class P extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,O]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}_([s()],P.prototype,"action",2),_([s()],P.prototype,"label",2),_([s()],P.prototype,"method",2),_([s()],P.prototype,"placeholder",2),_([h("#form")],P.prototype,"form",2),l("sp-search",P);export{I as M,L as T,F as a};
//# sourceMappingURL=3361874d.js.map
