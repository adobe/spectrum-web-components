import{y as e,S as t}from"./02872037.js";import{i as r}from"./67a87733.js";import"./a28affa6.js";import{S as o}from"./549963e9.js";import{T as i,A as c,x as a,e as l,d as s}from"./395924ad.js";import"./c28c6d6c.js";import{c as n,t as d}from"./a010124b.js";import{l as u,S as p,a as m,i as h}from"./604e2ea3.js";import"./8b2965c7.js";import"./5223f72b.js";import{e as f,i as v,t as b}from"./16ab2288.js";import{e as x,s as g}from"./3a81fc81.js";const k=f(class extends v{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
//# sourceMappingURL=21947d25.js.map
