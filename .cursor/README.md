...
- Provides: Operator workflow (run script, verify, fix links), Maintainer workflow (when to update script). Full instructions in `.cursor/skills/contributor-docs-nav/references/ai-agent-instructions.md` (human-oriented authoring context: `CONTRIBUTOR-DOCS/01_contributor-guides/07_authoring-contributor-docs/README.md`)
