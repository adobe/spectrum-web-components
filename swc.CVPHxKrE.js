import{t as l,s as e}from"./swc.Chuw36y7.js";import{I as i}from"./swc.BDRArAaS.js";import{x as r}from"./swc.CF5vcC17.js";import{d as t}from"./swc.JlveB6nj.js";t("sp-icon-checkmark-circle",class extends i{render(){return e(r),2===this.spectrumVersion?(({width:e=24,height:i=24,hidden:r=!1,title:t="Checkmark Circle"}={})=>l`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:e=24,height:i=24,hidden:r=!1,title:t="Checkmark Circle"}={})=>l`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${i}"
    viewBox="0 0 36 36"
