...
- [#5204](https://github.com/adobe/spectrum-web-components/pull/5204) [`c1669d2`](https://github.com/adobe/spectrum-web-components/commit/c1669d2dc5e1ceeb84486ce49a428f86a3173caa) Thanks [@Rajdeepc](https://github.com/Rajdeepc)! - - **Fixed** : Action buttons with href attributes now properly detects modifier keys and skips the proxy click, allowing only native browser behavior to proceed.
