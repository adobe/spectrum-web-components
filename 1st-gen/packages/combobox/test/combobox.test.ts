...
describe('Combobox', () => {
  ...
  describe('item selection', () => {
    it('sets the value when descendent is active and `enter` is pressed', async () => {
      ...
      expect(
        el.shadowRoot.querySelector('sp-menu-item[aria-selected="true"]')?.id,
        'aria-selected'
      ).to.equal('apple');
    ...
    it('sets the value when an item is clicked', async () => {
      ...
      expect(el.activeDescendant, 'activeDescendant after item click').to.be
        .undefined;
    });
    it('reflects the selected value in menu on reopening', async () => {
      ...
      const item = el.shadowRoot.querySelector('[value="banana"]') as MenuItem;
      await elementUpdated(item);
      ...
      expect(
        el.shadowRoot.querySelector('sp-menu')?.querySelector('[selected]')
          ?.textContent
    ...
    it('sets the value when an item is clicked programmatically', async () => {
      ...
      const item = el.shadowRoot.querySelector('[value="cherry"]') as MenuItem;
      await elementUpdated(item);
