...
- Updated dependencies []:
  ...
  - @spectrum-web-components/opacity-checkerboard@1.12.3-test.20260827122947
...
- Updated dependencies []:
  ...
  - @spectrum-web-components/opacity-checkerboard@1.12.2
...
- [#6048](https://github.com/adobe/spectrum-web-components/pull/6048) [`8a5997e`](https://github.com/adobe/spectrum-web-components/commit/8a5997ebb39121217b292af040572f58ca5a5ff2) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **Fixed**: Corrected an issue where the brightness axis in `ColorArea` was inverted on the Y-axis, causing the handle position to not match the expected brightness value. Dragging the handle now correctly maps to the HSV brightness scale.
