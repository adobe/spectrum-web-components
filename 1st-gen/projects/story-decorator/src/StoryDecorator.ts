...
export class StoryDecorator extends SpectrumElement {
  ...
  public system: SystemVariant = window.__swc_hack_knobs__.defaultSystemVariant;
  ...
  public direction: 'ltr' | 'rtl' = window.__swc_hack_knobs__.defaultDirection;
  ...
  private updateTheme({ target }: Event & { target: Picker | Switch }): void {
    ...
    switch (id) {
      ...
      case 'reduceMotion':
        ...
        break;
      case 'locale':
        this.lang = window.__swc_hack_knobs__.defaultLocale = value as Locale;
        break;
    }
  }
