...
**This is the past.** 1st-gen is being actively migrated to gen2 and will be deprecated once that migration is complete. Do not add new features. Bug fixes and migration work only.

If a change belongs in both generations, make it in `gen2/packages/core/` so both benefit.
