import{R as e}from"./a37f886d.js";import{i as t}from"./112b2095.js";import{x as s,A as n,n as r,S as a,d as i}from"./1a13da4f.js";import{L as o,l as c,F as d}from"./bd99a3f7.js";var l=t`
...
`,b=Object.defineProperty,k=Object.getOwnPropertyDescriptor;class y extends a{constructor(){super(...arguments),this.label=""}static get styles(){return[v,f]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return s`
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}z([r({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],S.prototype,"manageTabIndex",2),z([r({reflect:!0})],S.prototype,"value",2),z([r({reflect:!0})],S.prototype,"variant",2),z([r({reflect:!0})],S.prototype,"label",2),i("sp-sidenav",S),i("sp-sidenav-item",g);export{y as S};
//# sourceMappingURL=d21696c5.js.map
