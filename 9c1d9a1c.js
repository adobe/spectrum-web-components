import{f as e,S as t}from"./c081d6d1.js";import{i as r}from"./112b2095.js";import"./7bb595b8.js";import{S as o}from"./07f496e7.js";import{T as i,A as c,x as a,n as s,d as l}from"./dadc5b83.js";import"./22dc0810.js";import{c as n,t as d}from"./1bc3d47a.js";import{l as u,F as p,i as h}from"./c994b807.js";import"./b72a5d19.js";import"./dd8512a0.js";import{E as m}from"./7c327fb6.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./a538839f.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
//# sourceMappingURL=9c1d9a1c.js.map
