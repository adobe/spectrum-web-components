import{t as e,s as l}from"./swc.CJygKO7k.js";import{I as t}from"./swc.CWiIYv0p.js";import{x as i}from"./swc.BkWj9Vim.js";import{d as h}from"./swc.JlveB6nj.js";import{D as r}from"./swc.DViuqNrc.js";import{M as a,S as s}from"./swc.Chur2OTv.js";h("sp-icon-add",class extends t{render(){return l(i),2===this.spectrumVersion?(({width:l=24,height:t=24,hidden:i=!1,title:h="Add"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`;h("sp-icon-star",class extends t{render(){return l(i),2===this.spectrumVersion?n({hidden:!this.label,title:this.label}):o({hidden:!this.label,title:this.label})}});h("sp-icon-chevron-down",class extends t{render(){return l(i),1===this.spectrumVersion?(({width:l=24,height:t=24,hidden:i=!1,title:h="Chevron Down"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${l}"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label}):r({hidden:!this.label,title:this.label})}});h("sp-icon-checkmark",class extends t{render(){return l(i),1===this.spectrumVersion?(({width:l=24,height:t=24,hidden:i=!1,title:h="Checkmark"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${l}"
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label}):r({hidden:!this.label,title:this.label})}});h("sp-icon-save-floppy",class extends t{render(){return l(i),1===this.spectrumVersion?(({width:l=24,height:t=24,hidden:i=!1,title:h="Save Floppy"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${l}"
...
//# sourceMappingURL=swc.BObiQDwD.js.map
