 ...
 *   yarn lint:ai
 *
 * See `.ai/rules/stories-documentation.md` (constraints) and
 * `.ai/skills/stories-documentation/SKILL.md` (full procedure) for the per-unit
 * MDX authoring standards this check enforces.
 */
