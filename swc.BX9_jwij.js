import{r as e}from"./swc.Dxq4Ur_T.js";import{a as t}from"./swc.BaBOCi9d.js";import{L as s}from"./swc.DkFZeRLe.js";import"./swc.CbqxxBCN.js";import{i as r}from"./swc.CZZTz5mk.js";import{o as i}from"./swc.CtJaUxUA.js";import{E as a,x as o,S as n}from"./swc.DPhAUhmd.js";import{n as c}from"./swc.BtQhPOgI.js";import"./swc.Ccbjgp5t.js";import{S as l}from"./swc.mUX8iMJZ.js";import"./swc.CY3kb6-3.js";import"./swc.ZRnZNfEm.js";import{b as u}from"./swc.BcYwgDMJ.js";import{N as d}from"./swc.BhdHcucV.js";import{E as m,D as b}from"./swc.D6e53KN_.js";import{d as p}from"./swc.DDtjAoXV.js";import{o as h}from"./swc.DlYNsxG-.js";import{r as v}from"./swc.U1m7APr9.js";import{o as g}from"./swc.Cxa0JK8L.js";import"./swc.DFg0UMNx.js";import{f}from"./swc.hDiCrj8T.js";import{e as y}from"./swc.CjPt0-_4.js";import{o as k}from"./swc.DB8lrnSl.js";import{e as w}from"./swc.CmcGy_P4.js";class x{}const $=new WeakMap,E=y(class extends f{render(e){return a}update(e,[t]){const s=t!==this.G;return s&&void 0!==this.G&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),a}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let s=$.get(t);void 0===s&&(s=new WeakMap,$.set(t,s)),void 0!==s.get(this.G)&&this.G.call(this.ht,void 0),s.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?$.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),I=r`
...
`;var C=Object.defineProperty,S=(e,t,s,r)=>{for(var i,a=void 0,o=e.length-1;o>=0;o--)(i=e[o])&&(a=i(t,s,a)||a);return a&&C(t,s,a),a};class z extends(s(t)){constructor(){super(...arguments),this.value=void 0,this.isLastOfType=!1}static get styles(){return[I,e]}get focusElement(){return this.shadowRoot.querySelector("#item-link")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","listitem")}announceSelected(e){const t=new CustomEvent("breadcrumb-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}handleClick(e){!this.href&&e&&e.preventDefault(),(!this.href||null!=e&&e.defaultPrevented)&&this.value&&!this.isLastOfType&&this.announceSelected(this.value)}handleKeyDown(e){("Enter"===e.key||13===e.keyCode)&&this.handleClick(e)}renderLink(){return o`
      <a
        id="item-link"
        href=${i(this.isLastOfType?void 0:this.href)}
        tabindex="0"
        aria-current=${i(this.isLastOfType?"page":void 0)}
        @keydown=${this.handleKeyDown}
        @click=${this.handleClick}
      >
        <slot></slot>
      </a>
    `}renderSeparator(){return o`
      <sp-icon-chevron100
        id="separator"
        size="xs"
    ...
    `}updated(e){e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}S([c()],z.prototype,"value"),S([c({type:Boolean})],z.prototype,"isLastOfType"),customElements.define("sp-breadcrumb-item",z);const M=r`
...
`;var j=Object.defineProperty,O=Object.getOwnPropertyDescriptor,L=(e,t,s,r)=>{for(var i,a=r>1?void 0:r?O(t,s):t,o=e.length-1;o>=0;o--)(i=e[o])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&j(t,s,a),a};class A extends(u(d(p(m,{noDefaultSize:!0}),"label"),'[slot="label-only"]')){constructor(){super(...arguments),this.selects=void 0,this.deprecatedMenu=null,this.invalid=!1,this.pendingLabel="Pending",this.quiet=!1,this.value="",this.listRole="menu",this.itemRole="menuitem",this.handleEscape=e=>{"Escape"===e.key&&this.open&&(e.stopPropagation(),e.preventDefault(),this.toggle(!1))},this.handleKeydown=e=>{if(this.focused=!0,["ArrowUp","ArrowDown","Enter"," ","Escape"].includes(e.key)){if("Escape"===e.key)return void this.handleEscape(e);e.stopPropagation(),e.preventDefault(),this.keyboardOpen()}},this.applyFocusElementLabel=(e,t)=>{this.appliedLabel=e,this.labelAlignment=t.sideAligned?"inline":void 0},this.hasRenderedOverlay=!1,this.willManageSelection=!1,this.selectionPromise=Promise.resolve(),this.recentlyConnected=!1,this.enterKeydownOn=null,this.handleEnterKeydown=e=>{if("Enter"!==e.key)return;const t=null==e?void 0:e.target;t.open||!t.hasSubmenu?this.enterKeydownOn?e.preventDefault():(this.enterKeydownOn=e.target,this.addEventListener("keyup",async e=>{"Enter"===e.key&&(this.enterKeydownOn=null)},{once:!0})):e.preventDefault()},this.handleSlottableRequest=e=>{this.dispatchEvent(new l(e.name,e.data))}}static get styles(){return[M]}get menuItems(){return this.optionsMenu.childItems}get selfManageFocusElement(){return!0}get selectedItem(){return this._selectedItem}forceFocusVisible(){this.disabled||(this.focused=!0)}click(){this.toggle()}handleButtonClick(){this.disabled||this.toggle()}handleButtonBlur(){this.focused=!1}handleHelperFocus(){this.focused=!0,this.button.focus()}handleFocus(){!this.disabled&&this.focusElement&&(this.focused=this.hasVisibleFocusInTree())}handleChange(e){this.strategy&&(this.strategy.preventNextToggle="no");const t=e.target,[s]=t.selectedItems;e.stopPropagation(),e.cancelable?this.setValueFromItem(s,e):(this.open=!1,this.strategy&&(this.strategy.open=!1))}handleButtonFocus(e){var t;null==(t=this.strategy)||t.handleButtonFocus(e)}async keyboardOpen(){var e;this.open&&this.strategy.open?null==(e=this.optionsMenu)||e.focusOnFirstSelectedItem():(this.addEventListener("sp-opened",()=>{var e;return null==(e=this.optionsMenu)?void 0:e.focusOnFirstSelectedItem()},{once:!0}),this.toggle(!0))}async setValueFromItem(e,t){var s;this.open=!1;const r=this.selectedItem,i=this.value;return this.selectedItem=e,this.value=null!=(s=null==e?void 0:e.value)?s:"",await this.updateComplete,!this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))&&this.selects?(t&&t.preventDefault(),this.setMenuItemSelected(this.selectedItem,!1),r&&this.setMenuItemSelected(r,!0),this.selectedItem=r,this.value=i,this.open=!0,void(this.strategy&&(this.strategy.open=!0))):this.selects?(r&&this.setMenuItemSelected(r,!1),void this.setMenuItemSelected(e,!!this.selects)):(this.selectedItem=r,void(this.value=i))}setMenuItemSelected(e,t){null!=this.selects&&(e.selected=t)}get containerStyles(){return this.isMobile.matches?{"--swc-menu-width":"100%"}:{}}get selectedItemContent(){return this._selectedItemContent||{icon:[],content:[]}}set selectedItemContent(e){if(e===this.selectedItemContent)return;const t=this.selectedItemContent;this._selectedItemContent=e,this.requestUpdate("selectedItemContent",t)}handleTooltipSlotchange(e){var t;this.tooltipEl=e.target.assignedElements()[0],null!=(t=this.tooltipEl)&&t.selfManaged&&this.updateComplete.then(()=>{var e;null!=(e=this.tooltipEl)&&e.overlayElement&&this.button&&(this.tooltipEl.overlayElement.triggerElement=this.button)})}renderLabelContent(e){return this.value&&this.selectedItem?e:o`
    ...
    `}get buttonContent(){return[o`
      ...
      `]}hasAccessibleLabel(){return!!this.label||!!this.getAttribute("aria-label")||!!this.getAttribute("aria-labelledby")||!!this.appliedLabel||this.hasLabel||this.labelOnly}warnNoLabel(){}renderOverlay(e){var t;const s=this.renderContainer(e);return this.dependencyManager.add("sp-overlay"),import("./swc.CqMVfCAg.js"),o`
      <sp-overlay
    ...
    `}get renderDescriptionSlot(){return o`
      <div id=${b}>
    ...
    `}render(){return this.tooltipEl&&(this.tooltipEl.disabled=this.open),o`
      <sp-action-button
        ...
        ?quiet=${this.quiet}
        ?selected=${this.open}
        static-color=${i(this.staticColor)}
        aria-haspopup="true"
    ...
    `;return this.isMobile.matches&&!this.forcePopover?(this.dependencyManager.add("sp-tray"),import("./swc.Dr2vEt0W.js"),o`
        <sp-tray
          id="popover"
          role="presentation"
      ...
      `):(this.dependencyManager.add("sp-popover"),import("./swc.CmdfDAov.js").then(function(e){return e.s}),o`
      <sp-popover
        id="popover"
        role="presentation"
        style=${h(this.containerStyles)}
    ...
    `)}onScroll(){this.dispatchEvent(new Event("scroll",{cancelable:!0,composed:!0}))}get renderMenu(){const e=o`
      <sp-menu
...
`;var R=Object.defineProperty,T=(e,t,s,r)=>{for(var i,a=void 0,o=e.length-1;o>=0;o--)(i=e[o])&&(a=i(t,s,a)||a);return a&&R(t,s,a),a};class B extends n{constructor(){super(...arguments),this.maxVisibleItems=4,this.label="",this.menuLabel="More items",this.compact=!1,this.items=[],this.visibleItems=0,this.firstRender=!0,this.menuRef=new x}static get styles(){return[P]}get hasMenu(){var e,t;return this.visibleItems<(null!=(t=null==(e=this.breadcrumbsElements)?void 0:e.length)?t:0)}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","navigation"),this.resizeObserver=new ResizeObserver(()=>{this.firstRender?this.firstRender=!1:this.adjustOverflow()}),this.resizeObserver.observe(this)}disconnectedCallback(){var e;null==(e=this.resizeObserver)||e.unobserve(this),super.disconnectedCallback()}updated(e){super.updated(e),e.has("label")&&this.setAttribute("aria-label",this.label||"Breadcrumbs"),(e.has("maxVisibleItems")||e.has("compact"))&&(this.calculateBreadcrumbItemsWidth(),this.adjustOverflow()),e.has("visibleItems")&&this.items.forEach((e,t)=>{this.breadcrumbsElements[t].isLastOfType=t===this.breadcrumbsElements.length-1,this.breadcrumbsElements[t].toggleAttribute("hidden",!e.isVisible)})}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let s=e.offsetWidth;return e.hasAttribute("hidden")&&(e.removeAttribute("hidden"),s=e.offsetWidth,e.setAttribute("hidden","")),{label:e.innerText,href:e.href,value:e.value||t.toString(),offsetWidth:s,isVisible:!0}})}adjustOverflow(){let e=0,t=0;const s=this.list.clientWidth;this.hasMenu&&this.menuRef.value&&(e+=this.menuRef.value.offsetWidth||0),this.rootElement.length>0&&(e+=this.rootElement[0].offsetWidth);for(let r=this.items.length-1;r>=0;r--){if(e+=this.items[r].offsetWidth,!(e<s&&t<Math.max(this.maxVisibleItems,1))){for(let e=r;e>=0;e--)this.items[e].isVisible=!1;break}this.items[r].isVisible=!0,t++}0===t&&(this.items[this.items.length-1].isVisible=!0,t++),t!==this.visibleItems&&(this.visibleItems=t)}announceChange(e){const t=new CustomEvent("change",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}handleSelect(e){e.stopPropagation(),this.announceChange(e.detail.value)}handleMenuChange(e){e.stopPropagation(),this.announceChange(e.target.value)}renderMenu(){return o`
      <sp-breadcrumb-item role="listitem" class="is-menu">
        ...
        >
          ...
          ${this.items.map(e=>o`
              <sp-menu-item href=${i(e.href)} value=${e.value}>
                ${e.label}
              </sp-menu-item>
            `)}
        </sp-action-menu>
      </sp-breadcrumb-item>
    `}async slotChangeHandler(){if(0===this.breadcrumbsElements.length)return this.items=[],void(this.visibleItems=0);await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}render(){return o`
      <ul @breadcrumb-select=${this.handleSelect} id="list">
        <slot name="root"></slot>
        ${this.hasMenu?this.renderMenu():""}
        <slot @slotchange=${this.slotChangeHandler}></slot>
      </ul>
    `}}T([c({type:Number,attribute:"max-visible-items"})],B.prototype,"maxVisibleItems"),T([c({type:String})],B.prototype,"label"),T([c({type:String,attribute:"menu-label"})],B.prototype,"menuLabel"),T([c({type:Boolean})],B.prototype,"compact"),T([k({selector:"sp-breadcrumb-item"})],B.prototype,"breadcrumbsElements"),T([k({slot:"root",selector:"sp-breadcrumb-item"})],B.prototype,"rootElement"),T([w("#list")],B.prototype,"list"),T([v()],B.prototype,"items"),T([v()],B.prototype,"visibleItems"),customElements.define("sp-breadcrumbs",B);
//# sourceMappingURL=swc.BAWFek-U.js.map
