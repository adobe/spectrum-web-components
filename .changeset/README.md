...
> **1st-gen only.** This folder holds changesets for `@spectrum-web-components/*` packages, released from `main`. For `@adobe/spectrum-wc` / `@adobe/spectrum-wc-core` (2nd-gen) changes, use [`.changeset-2nd-gen/`](../.changeset-2nd-gen/README.md) (`yarn changeset:2nd-gen`) instead.
