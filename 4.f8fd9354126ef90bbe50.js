...
`));r(30),r(80),r(22),r(88);let E,U,F,H,Z,R=t=>t;const T=matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",W=window.localStorage&&localStorage.getItem("swc-docs:theme:color")||T,N=window.localStorage&&localStorage.getItem("swc-docs:theme:scale")||"medium",D=window.localStorage&&localStorage.getItem("swc-docs:theme:dir")||"ltr",Q=matchMedia("screen and (max-width: 960px)");class M extends i.a{constructor(){super(...arguments),this.alerts=new Map,this.color=W,this.dir=D,this.open=!1,this.isNarrow=Q.matches,this.scale=N,this._themeTrackers=new Map,this.handleMatchMediaChange=t=>{this.isNarrow=t.matches}}static get styles(){return[G]}toggleNav(){this.open=!this.open}closeNav(){this.open=!1}updateColor(t){this.color=t.target.value,this._themeTrackers.forEach(t=>t(this.color))}updateScale(t){this.scale=t.target.value}updateDirection(t){const e=t.target.value;this.dir="rtl"===e?e:"ltr"}handleTrackTheme(t){const e=t.composedPath()[0];if(this._themeTrackers.has(e))this._themeTrackers.delete(e);else{this._themeTrackers.set(e,t.detail.callback);const r=this._themeTrackers.get(e);r&&r(this.color)}}addAlert(t){const e=t.composedPath()[0];if(!this.alerts.has(e)){const t=()=>{this.alerts.delete(e),e.focus(),this.requestUpdate()};this.alerts.set(e,{count:0,message:"",element:(e,r)=>Object(o.d)(E||(E=R`
                    <sp-toast
                        .timeout=${0}
                        variant="info"
                        @close=${0}
                ...
                `),e,t,r,e>1?`(${e} alerts)`:"")})}const r=this.alerts.get(e);this.alerts.set(e,{element:r.element,count:r.count+1,message:t.detail.message}),this.requestUpdate()}renderContent(){return Object(o.d)(U||(U=R`
            <div></div>
        `))}render(){return Object(o.d)(F||(F=R`
            <sp-theme
                color=${0}
                scale=${0}
                dir=${0}
        ...
        `),this.color,this.scale,this.dir,this.handleTrackTheme,this.toggleNav,this.isNarrow&&!this.open,this.open,this.closeNav,this.isNarrow&&this.open,this.addAlert,this.color,this.updateColor,this.scale,this.updateScale,this.dir,this.updateDirection,this.renderContent(),this.alerts.size?Object(o.d)(H||(H=R`
                          <div class="alerts" role="region">
                              ${0}
                          </div>
                      `),[...this.alerts.values()].map(t=>t.element(t.count,t.message))):Object(o.d)(Z||(Z=R``)))}updated(t){t.has("color")&&window.localStorage&&localStorage.setItem("swc-docs:theme:color",this.color),t.has("scale")&&window.localStorage&&localStorage.setItem("swc-docs:theme:scale",this.scale),t.has("dir")&&window.localStorage&&localStorage.setItem("swc-docs:theme:dir",this.dir)}connectedCallback(){super.connectedCallback(),Promise.all([r.e(10),r.e(9)]).then(r.bind(null,219)),Q.addEventListener("change",this.handleMatchMediaChange)}disconnectedCallback(){Q.removeEventListener("change",this.handleMatchMediaChange)}}Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"alerts",void 0),Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"color",void 0),Object(s.a)([Object(o.e)({reflect:!0})],M.prototype,"dir",void 0),Object(s.a)([Object(o.e)({type:Boolean})],M.prototype,"open",void 0),Object(s.a)([Object(o.e)({type:Boolean,attribute:!1})],M.prototype,"isNarrow",void 0),Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"scale",void 0)},function(t,e,r){"use strict";var s=r(6);let i;var o=Object(s.b)(i||(i=(t=>t)`
...
`));let n,u,m,p=t=>t;const d=t=>t.stopPropagation();class h extends a.a{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,l]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}render(){return Object(i.d)(n||(n=p`
        ...
        `),this.action,Object(o.a)(this.method),this.handleSubmit,this.reset,this.handleKeydown,super.render(),this.value?Object(i.d)(u||(u=p`
                          <sp-clear-button
                              id="button"
                              label="Reset"
                              tabindex="-1"
...
//# sourceMappingURL=4.f8fd9354126ef90bbe50.js.map