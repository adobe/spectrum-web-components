import{B as t}from"./b87a96fb.js";import{i as o}from"./112b2095.js";import{S as r}from"./01b2daba.js";import{n as e}from"./879dbe89.js";import{x as c}from"./e6d35ea0.js";import{n}from"./c34bcf8e.js";import{d as u}from"./25a3ae37.js";var s=o`
...
`,a=Object.defineProperty,b=Object.getOwnPropertyDescriptor,d=(t,o,r,e)=>{for(var c,n=e>1?void 0:e?b(o,r):o,u=t.length-1;u>=0;u--)(c=t[u])&&(n=(e?c(o,r,n):c(n))||n);return e&&n&&a(o,r,n),n};const l=["accent","primary","secondary","negative","white","black"];class i extends(r(t,{noDefaultSize:!0})){constructor(){super(...arguments),this.pendingLabel="Pending",this.pending=!1,this.cachedAriaLabel=null,this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,s]}click(){this.pending||super.click()}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:l.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}get quiet(){return"outline"===this.treatment}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}updated(t){super.updated(t),t.has("pending")&&(this.pending&&this.pendingLabel!==this.getAttribute("aria-label")?this.disabled||(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)):!this.pending&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):!this.pending&&""===this.cachedAriaLabel&&this.removeAttribute("aria-label")),t.has("disabled")&&(this.disabled||this.pendingLabel===this.getAttribute("aria-label")?this.disabled&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):this.disabled&&""==this.cachedAriaLabel&&this.removeAttribute("aria-label"):this.pending&&(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)))}renderButton(){return c`
            ...
            ${e(this.pending,(()=>(import("./7a82e402.js").then((function(t){return t.s})),c`
                    ...
                    ></sp-progress-circle>
                `)))}
        `}}d([n({type:String,attribute:"pending-label"})],i.prototype,"pendingLabel",2),d([n({type:Boolean,reflect:!0,attribute:!0})],i.prototype,"pending",2),d([n()],i.prototype,"variant",1),d([n({type:String,reflect:!0})],i.prototype,"static",2),d([n({reflect:!0})],i.prototype,"treatment",2),d([n({type:Boolean})],i.prototype,"quiet",1),u("sp-button",i);
//# sourceMappingURL=46d12039.js.map
