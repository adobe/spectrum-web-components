...
`));const a=["medium","large"],c=["light","lightest","dark","darkest"];class l extends HTMLElement{constructor(){super(),this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const t=document.importNode(l.template.content,!0);this.shadowRoot.appendChild(t),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","lang"]}attributeChangedCallback(t,e,r){e!==r&&("color"===t?this.color=r:"scale"===t?this.scale=r:"lang"===t&&r&&(this.lang=r,this._provideContext()))}requestUpdate(){void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?this.shouldAdoptStyles():window.ShadyCSS.styleElement(this)}get color(){const t=l.themeFragmentsByKind.get("color"),{name:e}=t&&t.get("default")||{};return this._color||e||""}set color(t){if(t===this._color)return;const e=t&&c.includes(t)?t:this.color;e!==this._color&&(this._color=e,this.requestUpdate()),e?this.setAttribute("color",e):this.removeAttribute("color")}get scale(){const t=l.themeFragmentsByKind.get("scale"),{name:e}=t&&t.get("default")||{};return this._scale||e||""}set scale(t){if(t===this._scale)return;const e=t&&a.includes(t)?t:this.scale;e!==this._scale&&(this._scale=e,this.requestUpdate()),e?this.setAttribute("scale",e):this.removeAttribute("scale")}get styles(){return[...[...l.themeFragmentsByKind.keys()].reduce((t,e)=>{const r=l.themeFragmentsByKind.get(e),s=(e,s)=>{const i=r.get(e);!i||s&&!this.hasAttribute(s)||t.push(i.styles)};if("app"===e||"core"===e)s(e);else{const{[e]:t}=this;s(t,e)}return t},[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise(t=>{this.__resolve=t})}onQueryTheme(t){if(t.defaultPrevented)return;t.preventDefault();const{detail:e}=t;e.color=this.color||void 0,e.scale=this.scale||void 0,e.lang=this.lang||document.documentElement.lang||navigator.language}connectedCallback(){this.shouldAdoptStyles(),void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this),l.instances.add(this);const t=()=>{const{dir:t}=this;this.trackedChildren.forEach(e=>{e.setAttribute("dir","rtl"===t?t:"ltr")})};if(this.observer||(this.observer=new MutationObserver(t)),this.observer.observe(this,{attributes:!0,attributeFilter:["dir"]}),!this.hasAttribute("dir")){let t=this.assignedSlot||this.parentNode;for(;t!==document.documentElement&&!(t instanceof l);)t=t.assignedSlot||t.parentNode||t.host;this.dir="rtl"===t.dir?t.dir:"ltr"}requestAnimationFrame(()=>t())}disconnectedCallback(){l.instances.delete(this),this.observer.disconnect()}startManagingContentDirection(t){this.trackedChildren.add(t)}stopManagingContentDirection(t){this.trackedChildren.delete(t)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const t=this.styles;if(void 0!==window.ShadyCSS&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const t=[];for(const[e,r]of l.themeFragmentsByKind)for(const[s,{styles:i}]of r){if("default"===s)continue;let r=i.cssText;l.defaultFragments.has(s)||(r=r.replace(":host",`:host([${e}='${s}'])`)),t.push(r)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t,this.localName),window.ShadyCSS.prepareTemplate(l.template,this.localName)}else if(s.h){const e=[];for(const r of t)e.push(r.styleSheet);this.shadowRoot.adoptedStyleSheets=e}else{this.shadowRoot.querySelectorAll("style").forEach(t=>t.remove()),t.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.shadowRoot.appendChild(e)})}}static registerThemeFragment(t,e,r){const s=l.themeFragmentsByKind.get(e)||new Map;0===s.size&&(l.themeFragmentsByKind.set(e,s),s.set("default",{name:t,styles:r}),l.defaultFragments.add(t)),s.set(t,{name:t,styles:r}),l.instances.forEach(t=>t.shouldAdoptStyles())}_provideContext(){this._contextConsumers.forEach(t=>t(this.lang))}_handleContextPresence(t){const e=t.composedPath()[0];if(this._contextConsumers.has(e))this._contextConsumers.delete(e);else{this._contextConsumers.set(e,t.detail.callback);const r=this._contextConsumers.get(e);r&&r(this.lang||document.documentElement.lang||navigator.language)}}}l.themeFragmentsByKind=new Map,l.defaultFragments=new Set(["core"]),l.instances=new Set,l.registerThemeFragment("core","core",o)},,function(t,e,r){"use strict";var s=r(2),i=r(213),o=r(6),a=r(107);let c;var l=Object(o.b)(c||(c=(t=>t)`
...
`));let n;var u=Object(o.b)(n||(n=(t=>t)`
...
`)),m=r(201),p=r(4);let d,h=t=>t;class g extends m.a{render(){return Object(p.a)(o.d),Object(p.b)(d||(d=h`<svg
  ...
  >
    ...
    />
  </svg>`))}}customElements.define("sp-icon-corner-triangle300",g);let b,v=t=>t;const x={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let f;class z extends(Object(i.a)(a.a)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[l,u]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),f=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},300)}onPointerup(){clearTimeout(f),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:r}=t;("Space"===e||r&&"ArrowDown"===e)&&(t.preventDefault(),"ArrowDown"===e&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:r}=t;("Space"===e||r&&"ArrowDown"===e)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(Object(o.d)(b||(b=v`
                <sp-icon-corner-triangle300
                    id="hold-affordance"
                    class="${0}"
                ></sp-icon-corner-triangle300>
            `),x[this.size])),t}updated(t){super.updated(t),this.toggles&&t.has("selected")&&this.focusElement.setAttribute("aria-pressed",this.selected?"true":"false")}}Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],z.prototype,"emphasized",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0,attribute:"hold-affordance"})],z.prototype,"holdAffordance",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],z.prototype,"quiet",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],z.prototype,"selected",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],z.prototype,"toggles",void 0),Object(s.a)([Object(o.e)({type:String})],z.prototype,"value",null),customElements.define("sp-action-button",z)},,,function(t,e,r){"use strict";r.d(e,"a",(function(){return i}));r(68);let s=!0;try{document.body.querySelector(":focus-visible")}catch(t){s=!1}const i=t=>{var e;const r=Symbol("endPolyfillCoordination");return e=r,class extends t{constructor(){super(...arguments),this[e]=null}connectedCallback(){super.connectedCallback&&super.connectedCallback(),s||requestAnimationFrame(()=>{null==this[r]&&(this[r]=(t=>{if(null==t.shadowRoot||t.hasAttribute("data-js-focus-visible"))return()=>{};if(!self.applyFocusVisiblePolyfill){const e=()=>{self.applyFocusVisiblePolyfill&&t.shadowRoot&&self.applyFocusVisiblePolyfill(t.shadowRoot),t.manageAutoFocus&&t.manageAutoFocus()};return self.addEventListener("focus-visible-polyfill-ready",e,{once:!0}),()=>{self.removeEventListener("focus-visible-polyfill-ready",e)}}return self.applyFocusVisiblePolyfill(t.shadowRoot),t.manageAutoFocus&&t.manageAutoFocus(),()=>{}})(this))})}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),s||requestAnimationFrame(()=>{null!=this[r]&&(this[r](),this[r]=null)})}}}},,,,,function(t,e,r){"use strict";var s=r(2),i=r(213),o=r(208),a=r(6),c=r(201),l=r(4);let n,u=t=>t;class m extends c.a{render(){return Object(l.a)(a.d),Object(l.b)(n||(n=u`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`))}}customElements.define("sp-icon-asterisk100",m);let p;var d=Object(a.b)(p||(p=(t=>t)`
...
`));let h;var g=Object(a.b)(h||(h=(t=>t)`
...
`));let b,v,x,f=t=>t;class z extends(Object(i.a)(o.a)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[g,d]}handleClick(t){if(!this.target||this.disabled||t.defaultPrevented)return;this.target.focus();const e=this.getRootNode(),r=this.target,s=r.getRootNode(),i=s.host;s===e&&r.forceFocusVisible?r.forceFocusVisible():i&&i.forceFocusVisible&&i.forceFocusVisible()}async manageFor(){if(!this.for)return;const t=this.getRootNode(),e=t.querySelector("#"+this.for);if(e){if(e.localName.search("-")>0&&await customElements.whenDefined(e.localName),void 0!==e.updateComplete&&await e.updateComplete,this.target=e.focusElement||e,this.target){this.target.getRootNode()===t?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",this.labelText)}return Promise.resolve()}}get labelText(){const t=this.slotEl.assignedNodes({flatten:!0});if(!t.length)return"";return t.map(t=>(t.textContent||"").trim()).join(" ")}render(){return Object(a.d)(b||(b=f`
            <label>
                <slot @slotchange=${0}></slot>
                ${0}
            </label>
        `),this.manageFor,this.required?Object(a.d)(v||(v=f`
                          <sp-icon-asterisk100
                              class="requiredIcon spectrum-UIIcon-Asterisk100"
                          ></sp-icon-asterisk100>
                      `)):Object(a.d)(x||(x=f``)))}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${z.instanceCount++}`),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),(t.has("for")||t.has("id"))&&this.manageFor()}}z.instanceCount=0,Object(s.a)([Object(a.e)({type:Boolean,reflect:!0})],z.prototype,"disabled",void 0),Object(s.a)([Object(a.e)({type:String})],z.prototype,"id",void 0),Object(s.a)([Object(a.e)({type:String})],z.prototype,"for",void 0),Object(s.a)([Object(a.e)({type:Boolean,reflect:!0})],z.prototype,"required",void 0),Object(s.a)([Object(a.f)("slot")],z.prototype,"slotEl",void 0),Object(s.a)([Object(a.e)({type:String,reflect:!0,attribute:"side-aligned"})],z.prototype,"sideAligned",void 0),customElements.define("sp-field-label",z)},,function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(3);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),(({width:t=24,height:e=24,hidden:r=!1,title:s="Alert"}={})=>Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${0}"
    viewBox="0 0 36 36"
    width="${0}"
  ...
  >
    ...
    />
  </svg>`),e,t,r?"true":"false",s))({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-alert",l)},,function(t,e,r){"use strict";var s=r(2),i=r(208),o=r(6),a=r(7);let c;var l=Object(o.b)(c||(c=(t=>t)`
...
`));let n,u,m=t=>t;class p extends i.a{constructor(){super(...arguments),this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[l]}renderTip(){return Object(o.d)(n||(n=m`
            <div id="tip">
                <svg
        ...
        `))}connectedCallback(){super.connectedCallback(),this.addEventListener("sp-overlay-query",this.onOverlayQuery)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("sp-overlay-query",this.onOverlayQuery)}onOverlayQuery(t){if(!t.target)return;if(t.target!==this)return;const e=this.shadowRoot.querySelector("#tip");e&&(t.detail.overlayContentTipElement=e)}render(){return Object(o.d)(u||(u=m`
            <slot></slot>
            ${0}
        `),this.tip?this.renderTip():a.i)}}Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],p.prototype,"open",void 0),Object(s.a)([Object(o.e)({reflect:!0})],p.prototype,"placement",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],p.prototype,"tip",void 0),customElements.define("sp-popover",p)},,,,,,function(t,e,r){"use strict";r.d(e,"a",(function(){return n}));var s=r(2),i=r(6),o=r(210);let a,c,l=t=>t;function n(t){class e extends t{renderAnchor({id:t,className:e,ariaHidden:r,anchorContent:s=Object(i.d)(a||(a=l`<slot></slot>`))}){return Object(i.d)(c||(c=l`<a
                    id=${0}
                    class=${0}
                    href=${0}
                    download=${0}
                    ...
                    aria-hidden=${0}
                    rel=${0}
                >${0}</a>`),t,Object(o.a)(e),Object(o.a)(this.href),Object(o.a)(this.download),Object(o.a)(this.target),Object(o.a)(this.label),Object(o.a)(r?"true":void 0),Object(o.a)(this.rel),s)}}return Object(s.a)([Object(i.e)({reflect:!0})],e.prototype,"download",void 0),Object(s.a)([Object(i.e)()],e.prototype,"label",void 0),Object(s.a)([Object(i.e)({reflect:!0})],e.prototype,"href",void 0),Object(s.a)([Object(i.e)({reflect:!0})],e.prototype,"target",void 0),Object(s.a)([Object(i.e)({reflect:!0})],e.prototype,"rel",void 0),e}},function(t,e,r){"use strict";r.d(e,"a",(function(){return a}));var s=r(106);const i="opensource.adobe.com"===document.location.hostname?"https://opensource.adobe.com/spectrum-web-components/":void 0;class o extends s.a{constructor(t,e){super(t,e)}go(t){return document.querySelector("docs-page").resetScroll(),s.a.go(t)}changeParams(t){if(!this.location||!this.location.route)return!1;const e=this.urlForPath(this.location.route.path,t);return this.go(e)}}const a=new o(document.querySelector("docs-page"),{baseUrl:i});a.setRoutes([{path:"/",component:"docs-home",action:async()=>{await Promise.all([r.e(0),r.e(8)]).then(r.bind(null,198))}},{path:"/components/:component/:tab?",component:"docs-component",action:async()=>{await Promise.all([r.e(7),r.e(0),r.e(6)]).then(r.bind(null,192))}},{path:"/guides/:guide",component:"docs-guide",action:async()=>{await Promise.all([r.e(0),r.e(1)]).then(r.bind(null,93))}},{path:"/getting-started",component:"docs-guide",action:async()=>{await Promise.all([r.e(0),r.e(1)]).then(r.bind(null,93))}}])},,,function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
`));e.a=o},function(t,e,r){"use strict";var s=r(2),i=r(6),o=r(99);let a;var c=Object(i.b)(a||(a=(t=>t)`
...
`)),l=r(201),n=r(4);let u,m=t=>t;class p extends l.a{render(){return Object(n.a)(i.d),Object(n.b)(u||(u=m`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`))}}customElements.define("sp-icon-cross75",p);var d=r(72);let h,g=t=>t;class b extends o.a{constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,c,d.a]}get buttonContent(){return[Object(i.d)(h||(h=g`
                <sp-icon-cross75
                    slot="icon"
                    class="icon spectrum-UIIcon-Cross75"
                ></sp-icon-cross75>
            `))]}}Object(s.a)([Object(i.e)({reflect:!0})],b.prototype,"variant",void 0),customElements.define("sp-clear-button",b)},,,function(t,e,r){"use strict";var s=r(2),i=r(208),o=r(6);let a;var c=Object(o.b)(a||(a=(t=>t)`
...
`));let l,n=t=>t;class u extends i.a{constructor(){super(...arguments),this.open=!1}static get styles(){return[c]}render(){return Object(o.d)(l||(l=n``))}}Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],u.prototype,"open",void 0),customElements.define("sp-underlay",u)},function(t,e,r){"use strict";r.d(e,"a",(function(){return l}));var s=r(2),i=r(6);const o=Symbol("slotElementObserver"),a=Symbol("assignedNodes"),c=Symbol("startObserving");function l(t,e){var r;class l extends t{constructor(){super(...arguments),this.slotHasContent=!1}manageTextObservedSlot(){if(!this[a])return;const t=[...this[a]].filter(t=>!!t.tagName||!!t.textContent&&t.textContent.trim());this.slotHasContent=t.length>0}firstUpdated(t){super.firstUpdated(t),this.manageTextObservedSlot()}[(r=a,c)](){if(!this[o]){const t=t=>{for(const e of t)"characterData"===e.type&&this.manageTextObservedSlot()};this[o]=new MutationObserver(t)}this[o].observe(this,{characterData:!0,subtree:!0})}connectedCallback(){super.connectedCallback(),this[c]()}disconnectedCallback(){this[o]&&this[o].disconnect(),super.disconnectedCallback()}}return Object(s.a)([Object(i.e)({type:Boolean,attribute:!1})],l.prototype,"slotHasContent",void 0),Object(s.a)([Object(i.g)(e,!0)],l.prototype,r,void 0),l}},function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
`));e.a=o},function(t,e,r){"use strict";var s=r(97);customElements.define("sp-menu-item",s.a)},function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
`));e.a=o},function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
`));e.a=o},,,,,,,,function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(3);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),(({width:t=24,height:e=24,hidden:r=!1,title:s="Info"}={})=>Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${0}"
    viewBox="0 0 36 36"
    width="${0}"
  ...
  >
    ...
    />
  </svg>`),e,t,r?"true":"false",s))({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-info",l)},,function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(4);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`))}}customElements.define("sp-icon-checkmark100",l)},function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(4);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    fill="currentColor"
  >
    ...
    />
  </svg>`))}}customElements.define("sp-icon-chevron100",l)},,,function(t,e,r){"use strict";var s=r(20);customElements.define("sp-theme",s.a)},,function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
);position:relative;text-decoration:none;transition:background-color var(--spectrum-global-animation-duration-100,.13s) ease-out,color var(--spectrum-global-animation-duration-100,.13s) ease-out;width:100%;word-break:break-word}#itemLink:focus{outline:none}:host([dir=ltr]) #itemLink.focus-visible:before{left:0}:host([dir=ltr]) #itemLink:focus-visible:before{left:0}:host([dir=rtl]) #itemLink.focus-visible:before{right:0}:host([dir=rtl]) #itemLink:focus-visible:before{right:0}:host([dir=ltr]) #itemLink.focus-visible:before{right:0}:host([dir=ltr]) #itemLink:focus-visible:before{right:0}:host([dir=rtl]) #itemLink.focus-visible:before{left:0}:host([dir=rtl]) #itemLink:focus-visible:before{left:0}#itemLink.focus-visible:before{border-bottom:var(
...
--spectrum-sidenav-icon-gap,var(--spectrum-global-dimension-size-100)
)}#itemLink ::slotted([slot=icon]){flex-shrink:0}:host([dir=ltr]) .spectrum-SideNav-heading{margin-right:0}:host([dir=rtl]) .spectrum-SideNav-heading{margin-left:0}:host([dir=ltr]) .spectrum-SideNav-heading{margin-left:0}:host([dir=rtl]) .spectrum-SideNav-heading{margin-right:0}:host([dir=ltr]) .spectrum-SideNav--multiLevel #list #itemLink{padding-left:calc(var(
--spectrum-sidenav-multilevel-item-indentation,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=rtl]) .spectrum-SideNav--multiLevel #list #itemLink{padding-right:calc(var(
--spectrum-sidenav-multilevel-item-indentation,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=ltr]) .spectrum-SideNav--multiLevel #list #list #itemLink{padding-left:calc(var(
--spectrum-sidenav-multilevel-item-indentation,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=rtl]) .spectrum-SideNav--multiLevel #list #list #itemLink{padding-right:calc(var(
--spectrum-sidenav-multilevel-item-indentation,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([selected])>#itemLink{background-color:var(
...
)}#itemLink{font-weight:var(--spectrum-web-component-sidenav-font-weight);justify-content:start}:host([dir=ltr]) #itemLink[data-level="1"]{padding-left:calc(var(
--spectrum-sidenav-multilevel-item-indentation-level1,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=ltr]) #itemLink[data-level="2"]{padding-left:calc(var(
--spectrum-sidenav-multilevel-item-indentation-level2,
var(--spectrum-global-dimension-size-300)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=rtl]) #itemLink[data-level="1"]{padding-right:calc(var(
--spectrum-sidenav-multilevel-item-indentation-level1,
var(--spectrum-global-dimension-size-150)
) + var(
--spectrum-sidenav-item-padding-x,
var(--spectrum-global-dimension-size-150)
))}:host([dir=rtl]) #itemLink[data-level="2"]{padding-right:calc(var(
--spectrum-sidenav-multilevel-item-indentation-level2,
var(--spectrum-global-dimension-size-300)
) + var(
--spectrum-sidenav-item-padding-x,
...
`));e.a=o},function(t,e,r){"use strict";r.d(e,"a",(function(){return d}));var s=r(2),i=r(6),o=r(210),a=r(40),c=r(11),l=r(69);let n,u,m,p=t=>t;class d extends(Object(a.a)(c.a)){constructor(){super(...arguments),this.value=void 0,this.manageTabIndex=!1,this.selected=!1,this.expanded=!1}static get styles(){return[l.a]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,e=this.parentElement;for(;e instanceof d;)t++,e=e.parentElement;return t}handleSideNavSelect(t){this.selected=t.target===this}handleClick(t){!this.href&&t&&t.preventDefault(),this.disabled||(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(t){const e=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:t}});this.dispatchEvent(e)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#itemLink")}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return Object(i.d)(n||(n=p`
            <a
                href=${0}
                target=${0}
                download=${0}
            ...
            ${0}
        `),this.href||"#",Object(o.a)(this.target),Object(o.a)(this.download),Object(o.a)(this.rel),this.depth,this.handleClick,Object(o.a)(this.selected&&this.href?"page":void 0),this.label,this.expanded?Object(i.d)(u||(u=p`
                      <slot name="descendant"></slot>
                  `)):Object(i.d)(m||(m=p``)))}updated(t){if(t.has("selected")||t.has("manageTabIndex")){const t=this.selected?0:-1;this.tabIndex=this.manageTabIndex?t:0}super.updated(t)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const t=this.parentSideNav;t&&(await t.updateComplete,this.manageTabIndex=t.manageTabIndex,t.startTrackingSelectionForItem(this),this.selected=null!=this.value&&this.value===t.value)}stopTrackingSelection(){const t=this.parentSideNav;t&&t.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}}Object(s.a)([Object(i.e)()],d.prototype,"value",void 0),Object(s.a)([Object(i.e)({type:Boolean,attribute:!1})],d.prototype,"manageTabIndex",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],d.prototype,"selected",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],d.prototype,"expanded",void 0)},function(t,e,r){"use strict";var s=r(70);customElements.define("sp-sidenav-item",s.a)},function(t,e,r){"use strict";var s=r(6);let i;const o=Object(s.b)(i||(i=(t=>t)`
...
`));e.a=o},function(t,e,r){"use strict";var s=r(86);customElements.define("active-overlay",s.a)},,,,,,,function(t,e,r){"use strict";var s=r(199);customElements.define("sp-picker",s.a)},,function(t,e,r){"use strict";r.d(e,"a",(function(){return M}));var s=r(2),i=r(208),o=r(6),a=(r(67),r(83),r(48),r(90),r(71),r(41));let c;var l=Object(o.b)(c||(c=(t=>t)`
:host{display:block;margin-top:24px}#search-field{display:block}#search-container sp-popover{display:none}
/*# sourceURL=webpack://./documentation/src/components/side-nav-search.css */
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
`)),n=r(197),u=(r(91),r(34),r(18),r(92),r(51),r(85),r(108)),m=r.n(u);let p;function d(t){return t.replace(/(?:^|-)\w/g,t=>t.toUpperCase().replace("-"," "))}async function h(t){if(!p){const t=await r.e(11).then(r.t.bind(null,217,3));p=m.a.Index.load(t.default)}const e=new Map,s=p.search(t);for(const t of s){const r=/^\/([^/]+)\/([^/]+)/.exec(t.ref);if(!r)continue;const[,s,i]=r;e.has(s)||e.set(s,{maxScore:0,results:[]});const o=e.get(s);o&&(o.maxScore=Math.max(o.maxScore,t.score),o.results.push({name:i,label:d(i),url:t.ref}))}const i=[];for(const[t,{results:r,maxScore:s}]of e)i.push({name:t,results:r,maxScore:s});return i.sort((t,e)=>t.maxScore<e.maxScore?1:t.maxScore>e.maxScore?-1:0),i}let g,b,v,x,f,z=t=>t;window.Overlay=n.Overlay;class y extends o.a{constructor(){super(...arguments),this.searchResultsPopover=null,this.results=[]}static get styles(){return[l]}focus(){this.searchField.focus()}handleSearchInput(t){if(t.target){const e=t.target;this.updateSearchResults(e.value)}}handleKeydown(t){const{code:e}=t;if("Tab"!==e&&this.handleSearchInput(t),"ArrowDown"!==e||!this.searchResultsPopover)return;this.searchResultsPopover.querySelector("sp-menu").focus()}async openPopover(){this.popover&&(this.searchResultsPopover=this.popover,this.closeOverlay=await n.Overlay.open(this,"inline",this.popover,{offset:0,placement:"bottom"}))}closePopover(){this.closeOverlay&&(this.closeOverlay(),delete this.closeOverlay)}async updateSearchResults(t){if(t.length<3)return void this.closePopover();const e=t.trim()+"*";this.results=await h(e),this.openPopover()}renderResults(){return this.results.length>0?Object(o.d)(g||(g=z` <sp-menu> ${0} </sp-menu> `),this.results.map(t=>Object(o.d)(b||(b=z` <sp-menu-group> <span slot="header">${0}</span> ${0} </sp-menu-group> `),t.name,t.results.map(t=>Object(o.d)(v||(v=z` <sp-menu-item @click="${0}"> ${0} </sp-menu-item> `),()=>{a.a.go(t.url),this.closePopover()},t.label))))):Object(o.d)(x||(x=z` <sp-illustrated-message heading="No results found" description="Try another search term."></sp-illustrated-message> `))}render(){return Object(o.d)(f||(f=z` <div id="search-container"> <div id="search-field"> <sp-search @input="${0}" @change="${0}" @keydown="${0}" autocomplete="off"></sp-search> </div> <sp-popover id="search-results-menu" open> <style>#search-results-menu{width:368px;max-height:calc(100vh - 200px);margin-left:24px;display:flex;flex-direction:column}sp-illustrated-message{flex:1 1;margin-bottom:2em}</style> ${0} </sp-popover> </div> `),this.handleSearchInput,this.handleSearchInput,this.handleKeydown,this.renderResults())}}Object(s.a)([Object(o.f)("sp-popover")],y.prototype,"popover",void 0),Object(s.a)([Object(o.f)("sp-search")],y.prototype,"searchField",void 0),Object(s.a)([Object(o.e)({type:Array})],y.prototype,"results",void 0),customElements.define("docs-search",y);let k;var w=Object(o.b)(k||(k=(t=>t)`
:host{background-color:var(--spectrum-global-color-gray-100)}aside{display:flex;flex-direction:column;max-height:100vh;overflow:auto}@media screen and (max-width:960px){aside{background:inherit;left:0;min-height:100vh;position:fixed;top:0;transform:translateX(-100%);transition:transform var(
--spectrum-dialog-confirm-background-entry-animation-duration,var(--spectrum-global-animation-duration-600)
) cubic-bezier(0,0,.4,1);z-index:10}:host([open]) aside{transform:translateX(0)}.scrim{z-index:10}}#nav-header{padding:30px 24px 24px}#nav-header a,#nav-header a:visited{color:var(--spectrum-global-color-gray-800);text-decoration:none}#nav-header docs-spectrum-logo{margin-bottom:11px}#navigation{flex:1;flex-grow:1;overflow:auto;overflow-x:hidden;overflow-y:auto;padding:0 24px 24px;width:var(--spectrum-global-dimension-size-2400)}docs-spectrum-logo{display:block;height:32px;padding-top:7px;width:36px}:host([dir=ltr]) docs-spectrum-logo{margin-right:16px}:host([dir=rtl]) docs-spectrum-logo{margin-left:16px}#logo-container{border-radius:4px;margin-top:-2px;outline:none;padding:1px 2px 2px}#logo-container a{align-items:center;display:flex;flex-direction:row}#header-title{align-items:center;font-size:18px;font-style:normal;font-weight:700;letter-spacing:0;line-height:1.3;margin:0}sp-sidenav{width:100%}.spectrum-web{display:block;margin-top:80px}
/*# sourceURL=webpack://./documentation/src/components/side-nav.css */
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
`));let I;var q=Object(o.b)(I||(I=(t=>t)`
:host{display:inline-flex}
/*# sourceURL=webpack://./documentation/src/components/adobe-logo.css */
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
`));let C,B=t=>t;class j extends o.a{constructor(){super(...arguments),this.size="36px"}static get styles(){return[q]}render(){return Object(o.d)(C||(C=B` <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 30 26" width="${0}" xml:space="preserve"> <path fill="#e1251b" d="M19 0h11v26zM11.1 0H0v26zM15 9.6L22.1 26h-4.6l-2.1-5.2h-5.2z"/> </svg> `),this.size)}}Object(s.a)([Object(o.e)({type:String})],j.prototype,"size",void 0),customElements.define("docs-spectrum-logo",j);let O,L,S=t=>t;class X extends i.a{constructor(){super(...arguments),this.open=!1,this.components=[]}static get styles(){return[w]}handleSelect(t,e){const r=a.a.urlForPath(`/${e}/${t.detail.value}`);a.a.go(r)}handleComponentSelect(t){this.handleSelect(t,"components")}handleGuideSelect(t){this.handleSelect(t,"guides")}handleGettingStartedSelect(){const t=a.a.urlForPath("/getting-started");a.a.go(t)}close(){this.open=!1}toggle(){this.open=!this.open}async firstUpdated(){const t=this.shadowRoot.querySelector('sp-sidenav-item[label="Playground"]');t.updateComplete.then(()=>t.focusElement.setAttribute("router-ignore",""));const e=(await h("*")).find(t=>"components"===t.name);e&&(this.components=e.results,e.results.sort((t,e)=>t.name<e.name?-1:1))}render(){return Object(o.d)(O||(O=S`
            <sp-underlay
                class="scrim"
                @click=${0}
                ?open=${0}
        ...
        `),this.close,this.open,this.handleGettingStartedSelect,this.handleComponentSelect,this.components.map(t=>Object(o.d)(L||(L=S`
                                        <sp-sidenav-item
                                            value="${0}"
                                            label="${0}"
                                        ></sp-sidenav-item>
                                    `),t.name,t.label)),this.handleGuideSelect)}updated(t){t.has("open")&&!this.open&&t.get("open")&&this.dispatchEvent(new Event("close"))}}Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],X.prototype,"open",void 0),Object(s.a)([Object(o.e)({type:Array})],X.prototype,"components",void 0),customElements.define("docs-side-nav",X);let A;var G=Object(o.b)(A||(A=(t=>t)`
:host{bottom:0;height:100vh;left:0;position:absolute;right:0;top:0}sp-theme{--swc-header-height:var(--spectrum-global-dimension-size-600)}#app{display:flex;flex-direction:column;height:100%;width:100%}#side-nav{box-sizing:border-box;display:flex;flex:0 0 auto}#body{color:var(--spectrum-global-color-gray-800);display:flex;flex:1 1 auto;flex-direction:row;height:calc(100% - var(--spectrum-global-dimension-size-600) - 1px);position:relative}#body #layout-content{background-color:var(--spectrum-global-color-gray-50);max-height:calc(100vh - var(--swc-header-height) - 1px);overflow:auto;position:relative;width:100%}#body #layout-content #page{margin-left:auto;margin-right:auto;max-width:960px;padding:40px 52px 24px}@media screen and (max-width:768px){#body #layout-content #page{padding:40px 16px 24px}}header{--spectrum-actionbutton-height:var(--spectrum-global-dimension-size-500);--spectrum-actionbutton-min-width:var(
--spectrum-global-dimension-size-500
);--spectrum-alias-workflow-icon-size:22px;align-items:center;background-color:var(--spectrum-global-color-gray-50);border-bottom:1px solid var(--spectrum-global-color-gray-200);display:flex;flex-direction:row;left:0;min-height:var(--swc-header-height);padding-left:8px;right:0;top:0;z-index:10}header svg{stroke:transparent;height:100%}.manage-theme{display:flex;flex-direction:row;justify-content:flex-end}:host([dir=ltr]) .manage-theme sp-field-label{margin-left:var(--spectrum-global-dimension-size-400)}:host([dir=rtl]) .manage-theme sp-field-label{margin-right:var(--spectrum-global-dimension-size-400)}@media screen and (min-width:961px){sp-theme{--swc-header-height:0}header{display:none}}.alerts{bottom:0;display:flex;flex-direction:column;position:absolute;text-align:center;width:100vw}.alerts sp-toast{margin:0 auto var(--spectrum-global-dimension-size-300)}
/*# sourceURL=webpack://./documentation/src/components/layout.css */
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
`));r(30),r(80),r(22),r(88);let E,U,F,H,Z,T=t=>t;const W=matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",R=window.localStorage&&localStorage.getItem("swc-docs:theme:color")||W,N=window.localStorage&&localStorage.getItem("swc-docs:theme:scale")||"medium",D=window.localStorage&&localStorage.getItem("swc-docs:theme:dir")||"ltr",Q=matchMedia("screen and (max-width: 960px)");class M extends i.a{constructor(){super(...arguments),this.alerts=new Map,this.color=R,this.dir=D,this.open=!1,this.isNarrow=Q.matches,this.scale=N,this._themeTrackers=new Map,this.handleMatchMediaChange=t=>{this.isNarrow=t.matches}}static get styles(){return[G]}toggleNav(){this.open=!this.open}closeNav(){this.open=!1}updateColor(t){this.color=t.target.value,this._themeTrackers.forEach(t=>t(this.color))}updateScale(t){this.scale=t.target.value}updateDirection(t){const e=t.target.value;this.dir="rtl"===e?e:"ltr"}handleTrackTheme(t){const e=t.composedPath()[0];if(this._themeTrackers.has(e))this._themeTrackers.delete(e);else{this._themeTrackers.set(e,t.detail.callback);const r=this._themeTrackers.get(e);r&&r(this.color)}}addAlert(t){const e=t.composedPath()[0];if(!this.alerts.has(e)){const t=()=>{this.alerts.delete(e),e.focus(),this.requestUpdate()};this.alerts.set(e,{count:0,message:"",element:(e,r)=>Object(o.d)(E||(E=T`
                    <sp-toast
                        .timeout=${0}
                        variant="info"
                        @close=${0}
                ...
                `),e,t,r,e>1?`(${e} alerts)`:"")})}const r=this.alerts.get(e);this.alerts.set(e,{element:r.element,count:r.count+1,message:t.detail.message}),this.requestUpdate()}renderContent(){return Object(o.d)(U||(U=T`
            <div></div>
        `))}render(){return Object(o.d)(F||(F=T`
            <sp-theme
                color=${0}
                scale=${0}
                dir=${0}
        ...
        `),this.color,this.scale,this.dir,this.handleTrackTheme,this.toggleNav,this.isNarrow&&!this.open,this.open,this.closeNav,this.isNarrow&&this.open,this.addAlert,this.color,this.updateColor,this.scale,this.updateScale,this.dir,this.updateDirection,this.renderContent(),this.alerts.size?Object(o.d)(H||(H=T`
                          <div class="alerts" role="region">
                              ${0}
                          </div>
                      `),[...this.alerts.values()].map(t=>t.element(t.count,t.message))):Object(o.d)(Z||(Z=T``)))}updated(t){t.has("color")&&window.localStorage&&localStorage.setItem("swc-docs:theme:color",this.color),t.has("scale")&&window.localStorage&&localStorage.setItem("swc-docs:theme:scale",this.scale),t.has("dir")&&window.localStorage&&localStorage.setItem("swc-docs:theme:dir",this.dir)}connectedCallback(){super.connectedCallback(),Promise.all([r.e(10),r.e(9)]).then(r.bind(null,219)),Q.addEventListener("change",this.handleMatchMediaChange)}disconnectedCallback(){Q.removeEventListener("change",this.handleMatchMediaChange)}}Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"alerts",void 0),Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"color",void 0),Object(s.a)([Object(o.e)({reflect:!0})],M.prototype,"dir",void 0),Object(s.a)([Object(o.e)({type:Boolean})],M.prototype,"open",void 0),Object(s.a)([Object(o.e)({type:Boolean,attribute:!1})],M.prototype,"isNarrow",void 0),Object(s.a)([Object(o.e)({attribute:!1})],M.prototype,"scale",void 0)},function(t,e,r){"use strict";var s=r(6);let i;var o=Object(s.b)(i||(i=(t=>t)`
...
--spectrum-global-color-gray-50
);--spectrum-alias-background-color-modal-overlay:rgba(0,0,0,0.6);--spectrum-alias-dropshadow-color:rgba(0,0,0,0.8);--spectrum-alias-background-color-hover-overlay:hsla(0,0%,94%,0.08);--spectrum-alias-highlight-hover:hsla(0,0%,94%,0.08);--spectrum-alias-highlight-active:hsla(0,0%,94%,0.15);--spectrum-alias-highlight-selected:rgba(38,128,235,0.2);--spectrum-alias-highlight-selected-hover:rgba(38,128,235,0.3);--spectrum-alias-text-highlight-color:rgba(38,128,235,0.3);--spectrum-alias-background-color-quickactions:rgba(30,30,30,0.9);--spectrum-alias-border-color-selected:var(
--spectrum-global-color-blue-600
);--spectrum-alias-radial-reaction-color-default:hsla(0,0%,78%,0.6);--spectrum-alias-pasteboard-background-color:var(
--spectrum-global-color-gray-50
);--spectrum-alias-appframe-border-color:var(
--spectrum-global-color-gray-50
);--spectrum-alias-appframe-separator-color:var(
--spectrum-global-color-gray-50
);--spectrum-colorarea-border-color:hsla(0,0%,94%,0.1);--spectrum-colorarea-border-color-hover:hsla(0,0%,94%,0.1);--spectrum-colorarea-border-color-down:hsla(0,0%,94%,0.1);--spectrum-colorarea-border-color-key-focus:hsla(0,0%,94%,0.1);--spectrum-colorslider-border-color:hsla(0,0%,94%,0.1);--spectrum-colorslider-border-color-hover:hsla(0,0%,94%,0.1);--spectrum-colorslider-border-color-down:hsla(0,0%,94%,0.1);--spectrum-colorslider-border-color-key-focus:hsla(0,0%,94%,0.1);--spectrum-colorslider-vertical-border-color:hsla(0,0%,94%,0.1);--spectrum-colorslider-vertical-border-color-hover:hsla(0,0%,94%,0.1);--spectrum-colorslider-vertical-border-color-down:hsla(0,0%,94%,0.1);--spectrum-colorslider-vertical-border-color-key-focus:hsla(0,0%,94%,0.1);--spectrum-colorwheel-border-color:hsla(0,0%,94%,0.1);--spectrum-colorwheel-border-color-hover:hsla(0,0%,94%,0.1);--spectrum-colorwheel-border-color-down:hsla(0,0%,94%,0.1);--spectrum-colorwheel-border-color-key-focus:hsla(0,0%,94%,0.1);--spectrum-miller-column-item-background-color-selected:rgba(38,128,235,0.1);--spectrum-miller-column-item-background-color-selected-hover:rgba(38,128,235,0.2);--spectrum-well-background-color:hsla(0,0%,78%,0.02);--spectrum-well-border-color:hsla(0,0%,94%,0.05)}
`));a.a.registerThemeFragment("darkest","color",u);r(95);let m;var p=Object(s.b)(m||(m=(t=>t)`
...
--spectrum-global-dimension-static-size-150
);--spectrum-alias-item-rounded-workflow-padding-left-m:17px;--spectrum-alias-item-rounded-workflow-padding-left-xl:27px;--spectrum-alias-item-mark-padding-left-m:var(
--spectrum-global-dimension-static-size-150
...
--spectrum-global-dimension-static-size-150
);--spectrum-alias-avatar-size-100:26px;--spectrum-alias-avatar-size-400:36px;--spectrum-alias-avatar-size-600:46px;--spectrum-actionbutton-l-emphasized-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-cta-m-min-width:90px;--spectrum-button-cta-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-cta-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-cta-m-textonly-min-width:90px;--spectrum-button-cta-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-over-background-m-min-width:90px;--spectrum-button-over-background-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-over-background-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-over-background-m-textonly-min-width:90px;--spectrum-button-over-background-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-over-background-m-min-width:90px;--spectrum-button-quiet-over-background-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-over-background-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-over-background-m-textonly-min-width:90px;--spectrum-button-quiet-over-background-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-primary-m-min-width:90px;--spectrum-button-primary-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-primary-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-primary-m-textonly-min-width:90px;--spectrum-button-primary-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-primary-m-min-width:90px;--spectrum-button-quiet-primary-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-primary-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-primary-m-textonly-min-width:90px;--spectrum-button-quiet-primary-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-secondary-m-min-width:90px;--spectrum-button-quiet-secondary-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-secondary-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-secondary-m-textonly-min-width:90px;--spectrum-button-quiet-secondary-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-secondary-m-min-width:90px;--spectrum-button-secondary-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-secondary-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-secondary-m-textonly-min-width:90px;--spectrum-button-secondary-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-warning-m-min-width:90px;--spectrum-button-quiet-warning-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-warning-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-quiet-warning-m-textonly-min-width:90px;--spectrum-button-quiet-warning-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-button-warning-m-min-width:90px;--spectrum-button-warning-m-textonly-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-warning-m-textonly-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-button-warning-m-textonly-min-width:90px;--spectrum-button-warning-s-touch-hit-x:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-500
);--spectrum-icon-arrow-down-small-height:12px;--spectrum-icon-arrow-left-medium-height:12px;--spectrum-icon-checkmark-medium-width:16px;--spectrum-icon-checkmark-medium-height:16px;--spectrum-icon-checkmark-small-width:12px;--spectrum-icon-checkmark-small-height:12px;--spectrum-icon-chevron-down-medium-width:12px;--spectrum-icon-chevron-left-large-width:16px;--spectrum-icon-chevron-left-medium-height:12px;--spectrum-icon-chevron-right-large-width:16px;--spectrum-icon-chevron-right-medium-height:12px;--spectrum-icon-cross-large-width:16px;--spectrum-icon-cross-large-height:16px;--spectrum-icon-dash-small-width:12px;--spectrum-icon-dash-small-height:12px;--spectrum-icon-skip-left-width:10px;--spectrum-icon-skip-left-height:12px;--spectrum-icon-skip-right-width:10px;--spectrum-icon-skip-right-height:12px;--spectrum-icon-triplegripper-width:12px;--spectrum-meter-negative-m-border-radius:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-75
);--spectrum-pagination-page-button-line-height:32px;--spectrum-panel-l-header-height:var(--spectrum-global-dimension-size-550);--spectrum-panel-l-collapsible-header-height:var(
--spectrum-global-dimension-size-550
);--spectrum-panel-s-header-height:var(--spectrum-global-dimension-size-550);--spectrum-panel-s-collapsible-header-height:var(
--spectrum-global-dimension-size-550
...
--spectrum-global-dimension-static-size-75
);--spectrum-progresscircle-medium-border-size:var(
--spectrum-global-dimension-static-size-50
);--spectrum-progresscircle-medium-over-background-border-size:var(
--spectrum-global-dimension-static-size-50
);--spectrum-progresscircle-small-border-size:3px;--spectrum-progresscircle-small-indeterminate-border-size:3px;--spectrum-progresscircle-small-over-background-border-size:3px;--spectrum-progresscircle-medium-indeterminate-border-size:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-rating-icon-width:30px;--spectrum-rating-indicator-width:20px;--spectrum-rating-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
);--spectrum-rating-emphasized-icon-width:30px;--spectrum-rating-emphasized-indicator-width:20px;--spectrum-rating-emphasized-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-50
);--spectrum-sidenav-item-touch-hit-bottom:3px;--spectrum-sidenav-multilevel-item-touch-hit-bottom:3px;--spectrum-slider-l-track-touch-hit-y:var(
--spectrum-global-dimension-static-size-50
...
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-l-emphasized-handle-border-radius:9px;--spectrum-switch-m-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-m-emphasized-handle-border-radius:9px;--spectrum-switch-s-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-s-emphasized-handle-border-radius:9px;--spectrum-switch-xl-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-xl-emphasized-handle-border-radius:9px;--spectrum-switch-l-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-l-handle-border-radius:9px;--spectrum-switch-m-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-m-handle-border-radius:9px;--spectrum-switch-s-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-switch-s-handle-border-radius:9px;--spectrum-switch-xl-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-160
...
--spectrum-global-dimension-static-size-50
);--spectrum-tooltip-info-padding-bottom:6px;--spectrum-tooltip-negative-padding-bottom:6px;--spectrum-tooltip-padding-bottom:6px;--spectrum-tooltip-positive-padding-bottom:6px}
`));a.a.registerThemeFragment("large","scale",p)},,function(t,e,r){"use strict";var s=r(2),i=r(208),o=r(6);let a;var c=Object(o.b)(a||(a=(t=>t)`
...
`)),l=r(100),n=r(52),u=r(53);let m;var p=Object(o.b)(m||(m=(t=>t)`
...
`)),d=[n.a,u.a,p];let h,g=t=>t;class b extends i.a{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[l.a,d,c]}render(){return Object(o.d)(h||(h=g`
            <div id="illustration"><slot></slot></div>
            <h2
                id="heading"
                class="spectrum-Heading spectrum-Heading--sizeL spectrum-Heading--light"
            >
                <slot name="heading">${0}</slot>
            </h2>
            <div id="description" class="spectrum-Body spectrum-Body--sizeS">
                <slot name="description">${0}</slot>
            </div>
        `),this.heading,this.description)}}b.is="sp-illustrated-message",Object(s.a)([Object(o.e)()],b.prototype,"heading",void 0),Object(s.a)([Object(o.e)()],b.prototype,"description",void 0),customElements.define("sp-illustrated-message",b)},function(t,e,r){"use strict";r.d(e,"a",(function(){return q}));var s=r(2),i=r(208),o=r(6),a=r(210),c=r(111);let l;var n=Object(o.b)(l||(l=(t=>t)`
...
`)),u=r(109),m=r(196),p=r(110),d=r(202),h=r(84),g=r(195),b=r(81);const v=Object(h.a)({defaultModifiers:[...g.a,m.a,d.a,u.a,p.a]}),x=new WeakMap,f={name:"applyMaxSize",enabled:!0,phase:"beforeWrite",requires:["maxSize"],fn({state:t}){const{height:e}=t.modifiersData.maxSize;x.has(t.elements.popper)||x.set(t.elements.popper,t.rects.popper.height);const r=e<x.get(t.elements.popper)?e+"px":"";t.styles.popper.maxHeight=r,t.styles.popper.height=r}};let z,y,k=t=>t;const w={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{visible:"visible",hiding:"hiding",idle:"idle"}},visible:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},I=(t,e)=>t?e&&w.states[t].on[e]||t:w.initial;class q extends i.a{constructor(){super(),this._state=I(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.handleInlineTriggerKeydown=t=>{const{code:e,shiftKey:r}=t;if("Tab"===e){if(r)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));t.stopPropagation(),t.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise(t=>this.stealOverlayContentResolver=t)}get state(){return this._state}set state(t){const e=I(this.state,t);e!==this.state&&(this._state=e,"active"===this.state||"visible"===this.state||"hiding"===this.state?this.setAttribute("state",this.state):this.removeAttribute("state"))}focus(){const t=this.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), [focusable]');t?t.focus():super.focus(),this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[n]}get hasModalRoot(){return!!this._modalRoot}feature(){this.tabIndex=-1;const t=this.trigger.closest("active-overlay"),e=t&&"open"===t.slot;("modal"===this.interaction||e||this._modalRoot)&&(this.slot="open",this._modalRoot&&(null==t||t.feature()))}obscure(t){if(this.slot&&"modal"===t){if(this.removeAttribute("slot"),"modal"!==this.interaction){const e=this.trigger.closest("active-overlay");return this._modalRoot=null==e?void 0:e.obscure(t),this._modalRoot}return this}}firstUpdated(t){super.firstUpdated(t),this.overlayContent&&(this.stealOverlayContent(this.overlayContent),this.overlayContent&&this.trigger&&(this.placement&&"none"!==this.placement&&(this.popper=v(this.virtualTrigger||this.trigger,this,{placement:this.placement,modifiers:[b.a,f,{name:"arrow",options:{element:this.overlayContentTip}},{name:"offset",options:{offset:[0,this.offset]}}]})),this.state="active",document.addEventListener("sp-update-overlays",()=>{this.updateOverlayPosition(),this.state="visible"}),this.feature(),this.updateOverlayPosition().then(()=>this.applyContentAnimation("spOverlayFadeIn")).then(()=>{this.receivesFocus&&this.focus(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))})))}updateOverlayPopperPlacement(){this.overlayContent&&(this.dataPopperPlacement?this.overlayContent.setAttribute("placement",this.dataPopperPlacement):this.originalPlacement?this.overlayContent.setAttribute("placement",this.originalPlacement):this.overlayContent.removeAttribute("placement"))}updated(t){t.has("dataPopperPlacement")&&this.updateOverlayPopperPlacement()}open(t){this.extractDetail(t)}extractDetail(t){this.overlayContent=t.content,this.overlayContentTip=t.contentTip,this.trigger=t.trigger,this.virtualTrigger=t.virtualTrigger,this.placement=t.placement,this.offset=t.offset,this.interaction=t.interaction,this.theme=t.theme,this.receivesFocus=t.receivesFocus}dispose(){"dispose"===this.state&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.popper&&(this.popper.destroy(),this.popper=void 0),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1))}stealOverlayContent(t){this.originalPlacement=t.getAttribute("placement"),this.restoreContent=Object(c.a)([t],this,t=>{const e=t.slot;return t.removeAttribute("slot"),t=>{t.slot=e}}),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[t]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(t.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async updateOverlayPosition(){await(document.fonts?document.fonts.ready:Promise.resolve()),this.popper&&await this.popper.update()}async hide(t=!0){this.state="hiding",t&&await this.applyContentAnimation("spOverlayFadeOut"),this.state="dispose"}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame(()=>this.updateOverlayPosition())}onSlotChange(){this.schedulePositionUpdate()}connectedCallback(){super.connectedCallback(),this.schedulePositionUpdate()}applyContentAnimation(t){return new Promise(e=>{const r=this.shadowRoot.querySelector("#contents"),s=i=>{t===i.animationName&&(r.removeEventListener("animationend",s),r.removeEventListener("animationcancel",s),this.animating=!1,e("animationcancel"===i.type))};r.addEventListener("animationend",s),r.addEventListener("animationcancel",s),r.style.animationName=t,this.animating=!0})}renderTheme(t){const{color:e,scale:r,lang:s}=this.theme;return Object(o.d)(z||(z=k`
        ...
        `),Object(a.a)(e),Object(a.a)(r),Object(a.a)(s),t)}render(){const t=Object(o.d)(y||(y=k`
            <div id="contents">
                <slot @slotchange=${0}></slot>
            </div>
        `),this.onSlotChange);return this.hasTheme?this.renderTheme(t):t}static create(t){const e=new q;return t.content&&e.open(t),e}async _getUpdateComplete(){const t=await super._getUpdateComplete();return await this.stealOverlayContentPromise,t}}Object(s.a)([Object(o.e)()],q.prototype,"_state",void 0),Object(s.a)([Object(o.e)({reflect:!0,type:Boolean})],q.prototype,"animating",void 0),Object(s.a)([Object(o.e)({reflect:!0})],q.prototype,"placement",void 0),Object(s.a)([Object(o.e)({attribute:!1})],q.prototype,"theme",void 0),Object(s.a)([Object(o.e)({attribute:!1})],q.prototype,"receivesFocus",void 0),Object(s.a)([Object(o.e)({attribute:"data-popper-placement"})],q.prototype,"dataPopperPlacement",void 0)},function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(3);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),(({width:t=24,height:e=24,hidden:r=!1,title:s="Magnify"}={})=>Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${0}"
    viewBox="0 0 36 36"
    width="${0}"
  ...
  >
    ...
    />
  </svg>`),e,t,r?"true":"false",s))({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-magnify",l)},function(t,e,r){"use strict";var s=r(2),i=r(208),o=r(6);r(45),r(32),r(61),r(89);let a;var c=Object(o.b)(a||(a=(t=>t)`
...
`));let l,n,u,m,p,d=t=>t;const h=["negative","positive","info","error","warning"];class g extends i.a{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.open=!1,this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[c]}set timeout(t){const e=null!==typeof t&&t>0?Math.max(6e3,t):null,r=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;h.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return Object(o.d)(l||(l=d`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
                `));case"negative":case"error":case"warning":return Object(o.d)(n||(n=d`
                    <sp-icon-alert label="Error" class="type"></sp-icon-alert>
                `));case"positive":case"success":return Object(o.d)(u||(u=d`
                    <sp-icon-checkmark-circle
                        label="Success"
                        class="type"
                    ></sp-icon-checkmark-circle>
                `));default:return Object(o.d)(m||(m=d``))}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}close(){this.open=!1}render(){return Object(o.d)(p||(p=d`
            ${0}
        ...
        `),this.renderIcon(this.variant),this.close)}updated(t){if(super.updated(t),t.has("open"))if(this.open)this.timeout&&this.startCountdown();else{this.timeout&&this.stopCountdown();this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))||(this.open=!0)}t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],g.prototype,"open",void 0),Object(s.a)([Object(o.e)({type:Number})],g.prototype,"timeout",null),Object(s.a)([Object(o.e)({type:String})],g.prototype,"variant",null),customElements.define("sp-toast",g)},function(t,e,r){"use strict";var s=r(6),i=r(201),o=r(3);let a,c=t=>t;class l extends i.a{render(){return Object(o.a)(s.d),(({width:t=24,height:e=24,hidden:r=!1,title:s="Checkmark Circle"}={})=>Object(o.b)(a||(a=c`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${0}"
    viewBox="0 0 36 36"
    width="${0}"
  ...
  >
    ...
    />
  </svg>`),e,t,r?"true":"false",s))({hidden:!this.label,title:this.label})}}customElements.define("sp-icon-checkmark-circle",l)},function(t,e,r){"use strict";var s=r(2),i=r(6);let o;var a=Object(i.b)(o||(o=(t=>t)`
...
`)),c=r(11),l=r(209),n=r(70),u=r(98);let m,p=t=>t;class d extends c.a{constructor(){super(),this.items=new Set,this.manageTabIndex=!1,this.value=void 0,this.addEventListener("focusin",this.startListeningToKeyboard)}static get styles(){return[a]}startTrackingSelectionForItem(t){this.items.add(t)}stopTrackingSelectionForItem(t){this.items.delete(t)}handleSelect(t){if(t.stopPropagation(),this.value===t.detail.value)return;const e=this.value;this.value=t.detail.value;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach(e=>e.handleSideNavSelect(t)):(this.value=e,t.target.selected=!1,t.preventDefault())}focus(){this.focusElement!==this&&super.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){const t=this.querySelector("[selected]");if(t&&!this.isDisabledChild(t))return t;const e=[...this.querySelectorAll("sp-sidenav-item")];let r=0;for(;r<e.length&&e[r]&&this.isDisabledChild(e[r]);)r+=1;return e[r]?e[r]:this}startListeningToKeyboard(){if(this.addEventListener("keydown",this.handleKeydown),this.addEventListener("focusout",this.stopListeningToKeyboard),this.value&&this.manageTabIndex){const t=this.querySelector(`[value="${this.value}"]`);t&&(t.tabIndex=-1)}}stopListeningToKeyboard(){if(this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.stopListeningToKeyboard),this.value&&this.manageTabIndex){const t=this.querySelector(`[value="${this.value}"]`);t&&(t.tabIndex=0)}}handleKeydown(t){const{code:e}=t;if("ArrowDown"!==e&&"ArrowUp"!==e)return;t.preventDefault();const r="ArrowDown"===e?1:-1;this.focusItemByOffset(r)}focusItemByOffset(t){const e=[...this.querySelectorAll("sp-sidenav-item")];let r=e.indexOf(Object(l.a)(this));r=(e.length+r+t)%e.length;let s=e[r];for(;s&&this.isDisabledChild(s);)r=(e.length+r+t)%e.length,s=e[r];s&&!this.isDisabledChild(s)&&s.focus()}isDisabledChild(t){if(t.disabled)return!0;let e=t.parentElement;for(;e instanceof u.a||!e.disabled&&e instanceof n.a&&e.expanded;)e=e.parentElement;return e!==this}handleSlotchange(){this.manageTabIndexes()}async manageTabIndexes(){if(!this.value&&this.manageTabIndex){const t=this.querySelector("sp-sidenav-item:not([tabindex])");t&&(t.tabIndex=-1);const e=this.querySelector("sp-sidenav-item");e&&(await e.updateComplete,e.tabIndex=0)}}render(){return Object(i.d)(m||(m=p`
            <nav @sidenav-select=${0}>
                <slot
                    name="descendant"
                    @slotchange=${0}
                ></slot>
            </nav>
        `),this.handleSelect,this.handleSlotchange)}firstUpdated(t){super.firstUpdated(t);const e=this.querySelector("[selected]");e?this.value=e.value:this.manageTabIndexes()}updated(t){if(super.updated(t),t.has("manageTabIndex")){[...this.querySelectorAll("sp-sidenav-item")].map(t=>t.manageTabIndex=this.manageTabIndex)}}}Object(s.a)([Object(i.e)({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],d.prototype,"manageTabIndex",void 0),Object(s.a)([Object(i.e)({reflect:!0})],d.prototype,"value",void 0),customElements.define("sp-sidenav",d)},function(t,e,r){"use strict";var s=r(2),i=r(6),o=r(210),a=r(200);r(45),r(87);let c;var l=Object(i.b)(c||(c=(t=>t)`
...
`));let n,u,m,p=t=>t;const d=t=>t.stopPropagation();class h extends a.a{constructor(){super(...arguments),this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,l]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}render(){return Object(i.d)(n||(n=p`
            <form
                action=${0}
                id="form"
                method=${0}
        ...
        `),Object(o.a)(this.action),Object(o.a)(this.method),this.handleSubmit,this.reset,this.handleKeydown,super.render(),this.value?Object(i.d)(u||(u=p`
                          <sp-clear-button
                              id="button"
                              label="Reset"
                              tabindex="-1"
                              ...
                              @keydown=${0}
                          ></sp-clear-button>
                      `),d):Object(i.d)(m||(m=p``)))}updated(t){super.updated(t),this.multiline=!1}}Object(s.a)([Object(i.e)()],h.prototype,"action",void 0),Object(s.a)([Object(i.e)()],h.prototype,"label",void 0),Object(s.a)([Object(i.e)()],h.prototype,"method",void 0),Object(s.a)([Object(i.e)()],h.prototype,"placeholder",void 0),Object(s.a)([Object(i.f)("#form")],h.prototype,"form",void 0),customElements.define("sp-search",h)},function(t,e,r){"use strict";var s=r(2),i=r(6),o=r(96);r(18);let a;var c=Object(i.b)(a||(a=(t=>t)`
.header{color:var(--spectrum-listheading-text-color);display:block;font-size:var(--spectrum-listitem-heading-text-size);font-weight:var(--spectrum-listitem-heading-text-font-weight);letter-spacing:var(
...
`));let l,n=t=>t;class u extends o.a{constructor(){super(),u.instances+=1,this.headerId="sp-menu-group-label-"+u.instances}static get styles(){return[...super.styles,c]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const t=this.headerElements.length?this.headerElements[0]:void 0;if(t!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),t){const e=t.id||this.headerId;t.id||(t.id=e),this.setAttribute("aria-labelledby",e)}else this.removeAttribute("aria-labelledby");this.headerElement=t}render(){return Object(i.d)(l||(l=n`
        ...
        `),this.updateLabel)}}u.instances=0,Object(s.a)([Object(i.g)("header",!0)],u.prototype,"headerElements",void 0),customElements.define("sp-menu-group",u)},,function(t,e,r){"use strict";var s=r(6);let i;var o=Object(s.b)(i||(i=(t=>t)`
...
`));r(20).a.registerThemeFragment("lightest","color",o)},function(t,e,r){"use strict";var s=r(6);let i;var o=Object(s.b)(i||(i=(t=>t)`
...
--spectrum-global-dimension-size-175
);--spectrum-alias-item-rounded-workflow-padding-left-xl:21px;--spectrum-alias-item-mark-padding-left-m:var(
--spectrum-global-dimension-size-125
);--spectrum-alias-item-control-1-size-l:var(
--spectrum-global-dimension-size-125
);--spectrum-alias-item-control-1-size-xl:var(
...
--spectrum-global-dimension-static-size-125
);--spectrum-alias-avatar-size-100:var(--spectrum-global-dimension-size-250);--spectrum-alias-avatar-size-400:var(--spectrum-global-dimension-size-350);--spectrum-alias-avatar-size-600:var(--spectrum-global-dimension-size-450);--spectrum-actionbutton-l-emphasized-touch-hit-x:var(
--spectrum-global-dimension-static-size-100
);--spectrum-actionbutton-l-emphasized-touch-hit-y:var(
--spectrum-global-dimension-static-size-100
);--spectrum-actionbutton-l-emphasized-icononly-touch-hit-x:var(
...
--spectrum-global-dimension-size-150
);--spectrum-icon-dash-small-width:var(--spectrum-global-dimension-size-125);--spectrum-icon-dash-small-height:var(
--spectrum-global-dimension-size-125
);--spectrum-icon-skip-left-width:9px;--spectrum-icon-skip-left-height:var(--spectrum-global-dimension-size-125);--spectrum-icon-skip-right-width:9px;--spectrum-icon-skip-right-height:var(
--spectrum-global-dimension-size-125
...
--spectrum-global-dimension-static-size-65
);--spectrum-pagination-page-button-line-height:26px;--spectrum-panel-l-header-height:var(--spectrum-global-dimension-size-600);--spectrum-panel-l-collapsible-header-height:var(
--spectrum-global-dimension-size-600
);--spectrum-panel-s-header-height:var(--spectrum-global-dimension-size-600);--spectrum-panel-s-collapsible-header-height:var(
--spectrum-global-dimension-size-600
);--spectrum-picker-quiet-l-touch-hit-y:var(
--spectrum-global-dimension-static-size-400
);--spectrum-picker-quiet-l-min-width:var(
...
--spectrum-global-dimension-static-size-65
);--spectrum-progresscircle-medium-border-size:3px;--spectrum-progresscircle-medium-over-background-border-size:3px;--spectrum-progresscircle-small-border-size:var(
--spectrum-global-dimension-static-size-25
);--spectrum-progresscircle-small-indeterminate-border-size:var(
--spectrum-global-dimension-static-size-25
);--spectrum-progresscircle-small-over-background-border-size:var(
--spectrum-global-dimension-static-size-25
);--spectrum-progresscircle-medium-indeterminate-border-size:3px;--spectrum-radio-l-emphasized-touch-hit-y:var(
--spectrum-global-dimension-static-size-100
);--spectrum-radio-m-emphasized-touch-hit-y:var(
--spectrum-global-dimension-static-size-100
);--spectrum-radio-s-emphasized-touch-hit-y:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-rating-icon-width:24px;--spectrum-rating-indicator-width:16px;--spectrum-rating-touch-hit-y:var(
--spectrum-global-dimension-static-size-100
);--spectrum-rating-emphasized-icon-width:24px;--spectrum-rating-emphasized-indicator-width:16px;--spectrum-rating-emphasized-touch-hit-y:var(
--spectrum-global-dimension-static-size-100
);--spectrum-search-quiet-l-touch-hit-x:var(
--spectrum-global-dimension-static-size-100
);--spectrum-search-quiet-l-touch-hit-y:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-l-emphasized-handle-border-radius:7px;--spectrum-switch-m-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-m-emphasized-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-m-emphasized-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-m-emphasized-handle-border-radius:7px;--spectrum-switch-s-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-s-emphasized-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-s-emphasized-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-s-emphasized-handle-border-radius:7px;--spectrum-switch-xl-emphasized-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-xl-emphasized-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-xl-emphasized-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-xl-emphasized-handle-border-radius:7px;--spectrum-switch-l-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-l-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-l-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-l-handle-border-radius:7px;--spectrum-switch-m-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-m-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-m-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-m-handle-border-radius:7px;--spectrum-switch-s-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-s-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-s-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-switch-s-handle-border-radius:7px;--spectrum-switch-xl-focus-ring-border-radius-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-xl-focus-ring-border-radius-selected-key-focus:var(
--spectrum-global-dimension-static-size-130
);--spectrum-switch-xl-focus-ring-border-radius-error-key-focus:var(
...
--spectrum-global-dimension-static-size-100
);--spectrum-tooltip-info-padding-bottom:5px;--spectrum-tooltip-negative-padding-bottom:5px;--spectrum-tooltip-padding-bottom:5px;--spectrum-tooltip-positive-padding-bottom:5px}
`));r(20).a.registerThemeFragment("medium","scale",o)},function(t,e,r){"use strict";r.d(e,"a",(function(){return p}));var s=r(2),i=r(208),o=r(6),a=r(97);let c;var l=Object(o.b)(c||(c=(t=>t)`
...
`)),n=r(50);let u,m,p,d,h=t=>t;class g extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0})}get item(){return this._item||(this._item=this.composedPath()[0]),this._item}reset(){this._item=void 0}}class b extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item||(this._item=this.composedPath()[0]),this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=void 0,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const v=new b,x=new g;class f extends(Object(o.a)(a.a)){constructor(){super(),this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.noWrap=!1,this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[l,n.a]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}get focusElement(){return this}get itemChildren(){const t=this.shadowRoot.querySelector('slot[name="icon"]'),e=t?t.assignedElements().map(t=>{const e=t.cloneNode(!0);return e.removeAttribute("slot"),e.classList.toggle("icon"),e}):[],r=this.shadowRoot.querySelector("slot:not([name])");return{icon:e,content:r?r.assignedNodes().map(t=>t.cloneNode(!0)):[]}}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(t){if(this.disabled)return t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let t=!1;return this.anchorElement&&(this.anchorElement.click(),t=!0),t}render(){return Object(i.d)(u||(u=h`
            <slot name="icon"></slot>
            <div id="label">
                <slot id="slot"></slot>
            </div>
            ...
            ${0}
            ${0}
        `),this.selected?Object(i.d)(m||(m=h`
                      <sp-icon-checkmark100
                          id="selected"
                          class="spectrum-UIIcon-Checkmark100 icon checkmark"
                      ></sp-icon-checkmark100>
                  `)):Object(i.d)(p||(p=h``)),this.href&&this.href.length>0?super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"}):Object(i.d)(d||(d=h``)))}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}firstUpdated(t){super.firstUpdated(t),this.setAttribute("tabindex","-1"),this.addEventListener("pointerdown",this.handlePointerdown),this.hasAttribute("id")||(this.id="sp-menu-item-"+f.instanceCount++)}updateAriaSelected(){const t=this.getAttribute("role");"option"===t?this.setAttribute("aria-selected",this.selected?"true":"false"):"menuitemcheckbox"!==t&&"menuitemradio"!==t||this.setAttribute("aria-checked",this.selected?"true":"false")}setRole(t){this.setAttribute("role",t),this.updateAriaSelected()}updated(t){super.updated(t),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1),t.has("selected")&&this.updateAriaSelected()}connectedCallback(){super.connectedCallback(),v.reset(this),this.dispatchEvent(v)}disconnectedCallback(){super.disconnectedCallback(),x.reset(),this.dispatchEvent(x)}async triggerUpdate(){await new Promise(t=>requestAnimationFrame(t)),v.reset(this),this.dispatchEvent(v)}}f.instanceCount=0,Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"active",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"focused",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"selected",void 0),Object(s.a)([Object(i.e)({type:String})],f.prototype,"value",null),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],f.prototype,"noWrap",void 0),Object(s.a)([Object(i.f)(".anchor")],f.prototype,"anchorElement",void 0)},function(t,e,r){"use strict";r.d(e,"a",(function(){return m}));var s=r(2),i=r(208),o=r(6),a=r(69);let c;var l=Object(o.b)(c||(c=(t=>t)`
#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
`));let n,u=t=>t;class m extends i.a{constructor(){super(...arguments),this.label=""}static get styles(){return[a.a,l]}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return Object(o.d)(n||(n=u`
            <h2 id="heading">${0}</h2>
            <div id="list" aria-labelledby="heading">
                <slot name="descendant"></slot>
            </div>
        `),this.label)}}Object(s.a)([Object(o.e)({reflect:!0})],m.prototype,"label",void 0)},function(t,e,r){"use strict";r.d(e,"a",(function(){return c}));var s=r(107),i=r(6);let o;var a=Object(i.b)(o||(o=(t=>t)`
...
`));class c extends s.a{static get styles(){return[a]}}},function(t,e,r){"use strict";var s=r(52),i=r(53),o=r(6);let a;var c=Object(o.b)(a||(a=(t=>t)`
...
`));e.a=[s.a,i.a,c]},,,,,,,function(t,e,r){"use strict";r.d(e,"a",(function(){return h}));var s=r(2),i=r(6),o=r(40),a=r(11),c=r(49),l=r(211);let n,u,m,p,d=t=>t;class h extends(Object(o.a)(Object(c.a)(Object(l.a)(a.a,'[slot="icon"]')))){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return this.slotHasContent}get focusElement(){return this}get buttonContent(){const t=[Object(i.d)(n||(n=d`
            ...
            `),!this.hasLabel,this.manageTextObservedSlot)];return this.hasIcon&&t.unshift(Object(i.d)(u||(u=d`
                <slot name="icon" ?icon-only=${0}></slot>
            `),!this.hasLabel)),t}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(t){if(this.disabled)return t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let t=!1;if(this.anchorElement)this.anchorElement.click(),t=!0;else if("button"!==this.type){const e=document.createElement("button");e.type=this.type,this.insertAdjacentElement("afterend",e),e.click(),e.remove(),t=!0}return t}renderAnchor(){return Object(i.d)(m||(m=d`
            ${0}
            ${0}
        `),this.buttonContent,super.renderAnchor({id:"button",ariaHidden:!0,className:"button anchor hidden"}))}renderButton(){return Object(i.d)(p||(p=d`
            ${0}
        `),this.buttonContent)}render(){return this.href&&this.href.length>0?this.renderAnchor():this.renderButton()}handleKeydown(t){const{code:e}=t;switch(e){case"Space":t.preventDefault(),void 0===this.href&&(this.addEventListener("keyup",this.handleKeyup),this.active=!0)}}handleKeypress(t){const{code:e}=t;switch(e){case"Enter":this.click()}}handleKeyup(t){const{code:e}=t;switch(e){case"Space":this.removeEventListener("keyup",this.handleKeyup),this.active=!1,this.click()}}handleRemoveActive(){this.active=!1}handlePointerdown(){this.active=!0}manageAnchor(){this.href&&this.href.length>0?("button"===this.getAttribute("role")&&this.setAttribute("role","link"),this.removeEventListener("click",this.shouldProxyClick)):(this.hasAttribute("role")&&"link"!==this.getAttribute("role")||this.setAttribute("role","button"),this.addEventListener("click",this.shouldProxyClick))}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAnchor(),this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keypress",this.handleKeypress),this.addEventListener("pointerdown",this.handlePointerdown)}updated(t){super.updated(t),t.has("href")&&this.manageAnchor(),t.has("label")&&this.setAttribute("aria-label",this.label||""),t.has("active")&&(this.active?(this.addEventListener("focusout",this.handleRemoveActive),this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive)):(this.removeEventListener("focusout",this.handleRemoveActive),this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1)}}Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],h.prototype,"active",void 0),Object(s.a)([Object(i.e)({type:String})],h.prototype,"type",void 0),Object(s.a)([Object(i.f)(".anchor")],h.prototype,"anchorElement",void 0)},,,,function(t,e,r){"use strict";r.d(e,"a",(function(){return s}));const s=(t,e,r)=>{const s=[],i=[];for(let o=0;o<t.length;++o){const a=t[o];r&&i.push(r(a)||(()=>{}));const c=document.createComment("placeholder for reparented element");s.push(c);const l=a.parentElement||a.getRootNode();l&&l!==a&&l.replaceChild(c,a),e.append(a)}return function(){return function(t,e,r=[]){for(let s=0;s<e.length;++s){const i=e[s],o=t[s],a=o.parentElement||o.getRootNode();r[s]&&r[s](i),a&&a!==o&&a.replaceChild(i,o),delete t[s]}return e}(s,t,i)}}},function(t,e,r){"use strict";r.d(e,"a",(function(){return s}));const s=async(t,e,s,i)=>{const{Overlay:o}=await Promise.resolve().then(r.bind(null,197));return await o.open(t,e,s,i)}},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,r){"use strict";r.r(e),r.d(e,"Overlay",(function(){return o}));var s=r(86);class i{constructor(t={}){this.warmUpDelay=1e3,this.coolDownDelay=1e3,this.isWarm=!1,this.timeout=0,Object.assign(this,t)}async openTimer(t){if(this.cancelCooldownTimer(),this.component&&t===this.component){if(this.promise)return this.promise;throw new Error("Inconsistent state")}return this.component&&(this.close(this.component),this.cancelCooldownTimer()),this.component=t,!this.isWarm&&(this.promise=new Promise(t=>{this.resolve=t,this.timeout=window.setTimeout(()=>{this.resolve&&(this.resolve(!1),this.isWarm=!0)},this.warmUpDelay)}),this.promise)}close(t){this.component&&this.component===t&&(this.resetCooldownTimer(),this.timeout>0&&(clearTimeout(this.timeout),this.timeout=0),this.resolve&&(this.resolve(!0),delete this.resolve),delete this.promise,delete this.component)}resetCooldownTimer(){this.isWarm&&(this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),this.cooldownTimeout=window.setTimeout(()=>{this.isWarm=!1,delete this.cooldownTimeout},this.coolDownDelay))}cancelCooldownTimer(){this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),delete this.cooldownTimeout}}r(73);class o{constructor(t,e,r){this.isOpen=!1,this.owner=t,this.overlayElement=r,this.interaction=e}static async open(t,e,r,s){const i=new o(t,e,r);return await i.open(s),()=>{i.close()}}static update(){const t=new CustomEvent("sp-update-overlays",{bubbles:!0,composed:!0,cancelable:!0});document.dispatchEvent(t)}async open({abortPromise:t,delayed:e,offset:r=0,placement:s="top",receivesFocus:i,notImmediatelyClosable:a,virtualTrigger:c}){if(this.isOpen)return!0;void 0===e&&(e=this.overlayElement.hasAttribute("delayed"));const l={color:void 0,scale:void 0,lang:void 0},n=new CustomEvent("sp-query-theme",{bubbles:!0,composed:!0,detail:l,cancelable:!0});this.owner.dispatchEvent(n);const u={},m=new CustomEvent("sp-overlay-query",{bubbles:!0,composed:!0,detail:u,cancelable:!0});return this.overlayElement.dispatchEvent(m),await o.overlayStack.openOverlay(Object.assign({abortPromise:t,content:this.overlayElement,contentTip:u.overlayContentTipElement,delayed:e,offset:r,placement:s,trigger:this.owner,interaction:this.interaction,theme:l,receivesFocus:i,notImmediatelyClosable:a,virtualTrigger:c},u)),this.isOpen=!0,!0}close(){o.overlayStack.closeOverlay(this.overlayElement)}}o.overlayStack=new class{constructor(){var t=this;this.overlays=[],this.preventMouseRootClose=!1,this.root=document.body,this.handlingResize=!1,this.overlayTimer=new i,this.canTabTrap=!0,this.trappingInited=!1,this.forwardContextmenuEvent=async function(e){if("modal"!==t.overlays[t.overlays.length-1].interaction)return;e.stopPropagation(),e.preventDefault(),await t.closeTopOverlay();let r=document.elementFromPoint(e.clientX,e.clientY);for(;null==r?void 0:r.shadowRoot;){const t=r.shadowRoot.elementFromPoint(e.clientX,e.clientY);if(!t||t===r)break;r=t}null==r||r.dispatchEvent(new MouseEvent("contextmenu",e))},this.handleMouseCapture=t=>{const e=this.topOverlay;if(t.target&&e&&e.overlayContent&&!function(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}(t)&&function(t){return 0===t.button}(t)){if(t.target instanceof Node){if(t.composedPath().indexOf(e.overlayContent)>=0)return void(this.preventMouseRootClose=!0);this.preventMouseRootClose=!1}}else this.preventMouseRootClose=!0},this._doesNotCloseOnFirstClick=!1,this.handleMouse=t=>{this._doesNotCloseOnFirstClick?this._doesNotCloseOnFirstClick=!1:this.preventMouseRootClose||t.defaultPrevented||this.closeTopOverlay()},this.handleKeyUp=t=>{if("Escape"===t.code){const t=this.topOverlay;this.closeTopOverlay(),t&&t.trigger.focus()}},this.handleResize=()=>{this.handlingResize||(this.handlingResize=!0,requestAnimationFrame((async function(){const e=t.overlays.map(t=>t.updateOverlayPosition());await Promise.all(e),t.handlingResize=!1})))}}initTabTrapping(){if(this.document.body.shadowRoot)return void(this.canTabTrap=!1);if(this.document.body.attachShadow({mode:"open"}),!this.document.body.shadowRoot)return;const t=this.document.body.shadowRoot;t.innerHTML='\n            <div id="actual"><slot></slot></div>\n            <style>\n            #actual {\n                position: relative;\n                height: calc(100% - var(--swc-body-margins-block, 0px));\n                z-index: 0;\n                min-height: calc(100vh - var(--swc-body-margins-block, 0px));\n            }\n            #holder {\n                display: flex;\n                align-items: center;\n                justify-content: center;\n                flex-flow: column;\n                height: 100%;\n                width: 100%;\n                top: 0;\n                left: 0;\n                position: fixed;\n                pointer-events: none;\n            }\n            [name="open"]::slotted(*) {\n                pointer-events: all;\n            }\n            #holder[hidden] {\n                display: none !important;\n            }\n            #actual[tabindex="-1"] ::slotted(*) {\n                pointer-events: none;  /* just in case? */\n            }\n            </style>\n            <div id="holder" hidden><slot name="open"></slot></div>\n        ',this.tabTrapper=t.querySelector("#actual"),this.overlayHolder=t.querySelector("#holder"),this.tabTrapper.attachShadow({mode:"open"}),this.tabTrapper.shadowRoot&&(this.tabTrapper.shadowRoot.innerHTML="<slot></slot>")}startTabTrapping(){this.trappingInited||(this.initTabTrapping(),this.trappingInited=!0),this.canTabTrap&&(this.tabTrapper.tabIndex=-1,this.tabTrapper.addEventListener("contextmenu",this.forwardContextmenuEvent,!0),this.tabTrapper.setAttribute("aria-hidden","true"),this.overlayHolder.hidden=!1,requestAnimationFrame(()=>{const t=getComputedStyle(document.body);this.tabTrapper.style.setProperty("--swc-body-margins-inline",`calc(${t.marginLeft} + ${t.marginRight})`),this.tabTrapper.style.setProperty("--swc-body-margins-block",`calc(${t.marginTop} + ${t.marginBottom})`)}))}stopTabTrapping(){this.canTabTrap&&this.trappingInited&&(this.tabTrapper.removeAttribute("tabindex"),this.tabTrapper.removeEventListener("contextmenu",this.forwardContextmenuEvent,!0),this.tabTrapper.removeAttribute("aria-hidden"),this.overlayHolder.hidden=!0)}get document(){return this.root.ownerDocument||document}get topOverlay(){return this.overlays.slice(-1)[0]}findOverlayForContent(t){for(const e of this.overlays)if(t===e.overlayContent)return e}addEventListeners(){this.document.addEventListener("click",this.handleMouseCapture,!0),this.document.addEventListener("click",this.handleMouse),this.document.addEventListener("keyup",this.handleKeyUp),window.addEventListener("resize",this.handleResize)}removeEventListeners(){this.document.removeEventListener("click",this.handleMouseCapture,!0),this.document.removeEventListener("click",this.handleMouse),this.document.removeEventListener("keyup",this.handleKeyUp),window.removeEventListener("resize",this.handleResize)}isClickOverlayActiveForTrigger(t){return this.overlays.some(e=>t===e.trigger&&"click"===e.interaction)}async openOverlay(t){var e=this;if(this.overlays.length||this.addEventListeners(),this.findOverlayForContent(t.content))return!1;t.notImmediatelyClosable&&(this._doesNotCloseOnFirstClick=!0),"modal"===t.interaction&&this.startTabTrapping();const r=t.content;if(r.overlayWillOpenCallback){const{trigger:e}=t;r.overlayWillOpenCallback({trigger:e})}if(t.delayed){const e=[this.overlayTimer.openTimer(t.content)];t.abortPromise&&e.push(t.abortPromise);const s=await Promise.race(e);if(s){if(r.overlayOpenCancelledCallback){const{trigger:e}=t;r.overlayOpenCancelledCallback({trigger:e})}return s}}if("click"===t.interaction)this.closeAllHoverOverlays();else if("hover"===t.interaction&&this.isClickOverlayActiveForTrigger(t.trigger))return!0;const i=s.a.create(t);if(this.overlays.length){this.overlays[this.overlays.length-1].obscure(i.interaction)}return document.body.appendChild(i),new Promise(t=>requestAnimationFrame(t)).then((async function(){if(e.overlays.push(i),await i.updateComplete,e.addOverlayEventListeners(i),void 0!==r.open&&(r.open=!0),r.overlayOpenCallback){const{trigger:t}=i;r.overlayOpenCallback({trigger:t})}return"auto"===t.receivesFocus&&i.focus(),!1}))}addOverlayEventListeners(t){switch(t.addEventListener("close",()=>{this.hideAndCloseOverlay(t)}),t.interaction){case"replace":this.addReplaceOverlayEventListeners(t);break;case"inline":this.addInlineOverlayEventListeners(t)}}addReplaceOverlayEventListeners(t){t.addEventListener("keydown",e=>{const{code:r}=e;"Tab"===r&&(e.stopPropagation(),this.closeOverlay(t.overlayContent),t.tabbingAway=!0,t.trigger.focus(),t.trigger.dispatchEvent(new KeyboardEvent("keydown",e)))})}addInlineOverlayEventListeners(t){t.trigger.addEventListener("keydown",t.handleInlineTriggerKeydown),t.addEventListener("keydown",e=>{const{code:r,shiftKey:s}=e;if("Tab"!==r)return;if(t.tabbingAway=!0,s){const e=document.createElement("span");return e.tabIndex=-1,t.trigger.hasAttribute("slot")&&(e.slot=t.trigger.slot),t.trigger.insertAdjacentElement("afterend",e),e.focus(),void e.remove()}e.stopPropagation();const i=t.trigger;void 0!==i.open&&(i.open=!1),this.closeOverlay(t.overlayContent),t.trigger.focus()})}closeOverlay(t){this.overlayTimer.close(t),requestAnimationFrame(()=>{const e=this.findOverlayForContent(t);this.hideAndCloseOverlay(e)})}closeAllHoverOverlays(){for(const t of this.overlays)"hover"===t.interaction&&this.hideAndCloseOverlay(t,!1)}async hideAndCloseOverlay(t,e){if(t){await t.hide(e);const r=t.overlayContent;if(void 0!==r.open&&(r.open=!1),r.overlayCloseCallback){const{trigger:e}=t;r.overlayCloseCallback({trigger:e})}if("dispose"!=t.state)return;const s=this.overlays.indexOf(t);if(s>=0&&this.overlays.splice(s,1),this.overlays.length){const t=this.overlays[this.overlays.length-1];t.feature(),"modal"===t.interaction||t.hasModalRoot?t.focus():this.stopTabTrapping()}else{if(this.stopTabTrapping(),"modal"===t.interaction||("replace"===t.interaction||"inline"===t.interaction)&&!t.tabbingAway){const e=t.overlayContent.getRootNode().activeElement,r=t.trigger.getRootNode(),s=r.activeElement;(t.overlayContent.contains(e)||t.trigger.getRootNode().contains(s)||r.host&&r.host===s)&&t.trigger.focus()}t.tabbingAway=!1}t.remove(),t.dispose(),t.trigger.dispatchEvent(new CustomEvent("sp-closed",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:t.interaction}})),this.overlays.length||this.removeEventListeners()}}closeTopOverlay(){return this.hideAndCloseOverlay(this.topOverlay)}}},,function(t,e,r){"use strict";r.d(e,"b",(function(){return k})),r.d(e,"a",(function(){return w}));var s=r(2),i=r(213),o=r(6),a=r(214),c=r(7);let l;var n=Object(o.b)(l||(l=(t=>t)`
...
`)),u=r(44),m=r(11),p=r(111),d=(r(64),r(32),r(18),r(34),r(112));let h,g,b,v,x,f,z=t=>t;const y={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class k extends(Object(i.a)(m.a)){constructor(){super(),this.disabled=!1,this.focused=!1,this.invalid=!1,this.open=!1,this.readonly=!1,this.selects="single",this.menuItems=[],this.placement="bottom-start",this.quiet=!1,this.value="",this.listRole="listbox",this.itemRole="option",this.onKeydown=t=>{"ArrowDown"!==t.code&&"ArrowUp"!==t.code||(t.preventDefault(),this.toggle(!0))},this.menuStatePromise=Promise.resolve(),this.onKeydown=this.onKeydown.bind(this)}get target(){return this.button}get focusElement(){return this.open?this.optionsMenu:this.button}forceFocusVisible(){this.focused=!0}onButtonBlur(){this.focused=!1,this.target.removeEventListener("keydown",this.onKeydown)}onButtonClick(){this.toggle()}onHelperFocus(){this.focused=!0,this.button.focus()}onButtonFocus(){this.target.addEventListener("keydown",this.onKeydown)}handleChange(t){t.stopPropagation();const e=t.target,[r]=e.selectedItems;this.setValueFromItem(r,t)}async setValueFromItem(t,e){const r=this.selectedItem,s=this.value;this.selectedItem=t,this.value=t.value,this.open=!1,await this.updateComplete;if(!this.dispatchEvent(new Event("change",{cancelable:!0})))return e&&e.preventDefault(),this.selectedItem=r,this.value=s,void(this.open=!0);r&&(r.selected=(this.selects,!1)),t.selected=!!this.selects}toggle(t){this.readonly||(this.open=void 0!==t?t:!this.open)}close(){this.readonly||(this.open=!1)}onOverlayClosed(){this.close(),this.restoreChildren&&(this.restoreChildren(),this.restoreChildren=void 0),this.menuStateResolver()}async openMenu(){let t=[];const e=this.querySelector("sp-menu");if(t=e?Array.from(e.children):Array.from(this.children).filter(t=>!t.hasAttribute("slot")),0===t.length)return void this.menuStateResolver();this.restoreChildren=Object(p.a)(t,this.optionsMenu,()=>t=>{void 0!==t.focused&&(t.focused=!1)}),this.sizePopover(this.popover);const{popover:r}=this;this.addEventListener("sp-opened",()=>{this.manageSelection(),this.optionsMenu.updateComplete.then(()=>{this.menuStateResolver()})},{once:!0}),this.closeOverlay=await w.openOverlay(this,"inline",r,{placement:this.placement,receivesFocus:"auto"})}sizePopover(t){const e=!this.quiet&&this.offsetWidth+"px";e&&t.style.setProperty("min-width",e)}closeMenu(){this.closeOverlay&&(this.closeOverlay(),delete this.closeOverlay)}get selectedItemContent(){return!this._selectedItemContent&&this.selectedItem&&(this._selectedItemContent=this.selectedItem.itemChildren),this._selectedItemContent||{icon:[],content:[]}}renderLabelContent(t){return this.value&&this.selectedItem?t:Object(o.d)(h||(h=z`
        ...
        `),this.label)}get buttonContent(){const t={"visually-hidden":"only"===this.icons&&!!this.value,placeholder:!this.value};return[Object(o.d)(g||(g=z`
                ...
                <sp-icon-chevron100
                    class="picker ${0}"
                ></sp-icon-chevron100>
            `),"none"===this.icons,this.selectedItemContent.icon,Object(a.a)(t),this.renderLabelContent(this.selectedItemContent.content),this.invalid?Object(o.d)(b||(b=z`
                          <sp-icon-alert class="validationIcon"></sp-icon-alert>
                      `)):c.i,y[this.size])]}get renderButton(){return Object(o.d)(v||(v=z`
            <span
                id="focus-helper"
                tabindex="${0}"
                @focus=${0}
        ...
        `),this.focused?"-1":"0",this.onHelperFocus,this.open?"true":"false",this.onButtonBlur,this.onButtonClick,this.onButtonFocus,this.disabled,this.buttonContent)}update(t){t.has("selectedItem")&&(this._selectedItemContent=void 0),this.selects&&(this.selects="single"),super.update(t)}render(){return Object(o.d)(x||(x=z`
            ${0} ${0}
        `),this.renderButton,this.renderPopover)}get renderPopover(){return Object(o.d)(f||(f=z`
            <sp-popover id="popover" @sp-overlay-closed=${0}>
                <sp-menu
                    id="menu"
                    role="${0}"
                    selects="single"
        ...
        `),this.onOverlayClosed,this.listRole,this.handleChange)}updateMenuItems(){this.menuItems=[...this.querySelectorAll("sp-menu-item")]}firstUpdated(t){super.firstUpdated(t),this.optionsMenu=this.shadowRoot.querySelector("sp-menu"),this.updateMenuItems();this.querySelector("sp-menu")&&console.warn(`Deprecation Notice: You no longer need to provide an sp-menu child to ${this.tagName.toLowerCase()}. Any styling or attributes on the sp-menu will be ignored.`)}updated(t){super.updated(t),t.has("value")&&!t.has("selectedItem")&&this.manageSelection(),t.has("disabled")&&this.disabled&&(this.open=!1),t.has("open")&&(this.open||void 0!==t.get("open"))&&(this.menuStatePromise=new Promise(t=>this.menuStateResolver=t),this.open?this.openMenu():this.closeMenu())}manageSelection(){if(this.open||this.updateMenuItems(),this.menuItems.length>0){let t;return this.menuItems.forEach(e=>{this.value!==e.value||e.disabled?e.selected=(this.selects,!1):t=e}),t?(t.selected=!!this.selects,this.selectedItem=t):(this.value="",this.selectedItem=void 0),void(this.open&&this.optionsMenu.updateComplete.then(()=>{this.optionsMenu.updateSelectedItemIndex()}))}}async _getUpdateComplete(){const t=await super._getUpdateComplete();return await this.menuStatePromise,t}connectedCallback(){this.open||this.updateMenuItems(),super.connectedCallback()}disconnectedCallback(){this.open=!1,super.disconnectedCallback()}}k.openOverlay=async(t,e,r,s)=>await Object(d.a)(t,e,r,s),Object(s.a)([Object(o.f)("#button")],k.prototype,"button",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"disabled",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"focused",void 0),Object(s.a)([Object(o.e)({type:String,reflect:!0})],k.prototype,"icons",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"invalid",void 0),Object(s.a)([Object(o.e)()],k.prototype,"label",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"open",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"readonly",void 0),Object(s.a)([Object(o.e)()],k.prototype,"placement",void 0),Object(s.a)([Object(o.e)({type:Boolean,reflect:!0})],k.prototype,"quiet",void 0),Object(s.a)([Object(o.e)({type:String})],k.prototype,"value",void 0),Object(s.a)([Object(o.e)({attribute:!1})],k.prototype,"selectedItem",void 0),Object(s.a)([Object(o.f)("sp-popover")],k.prototype,"popover",void 0);class w extends k{constructor(){super(...arguments),this.onKeydown=t=>{const{code:e}=t;if(!e.startsWith("Arrow")||this.readonly)return;if(t.preventDefault(),"ArrowUp"===e||"ArrowDown"===e)return void this.toggle(!0);const r=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,s=this.value&&"ArrowRight"!==e?-1:1;let i=r+s;for(;this.menuItems[i]&&this.menuItems[i].disabled;)i+=s;this.menuItems[i]&&!this.menuItems[i].disabled&&(this.value&&i===r||this.setValueFromItem(this.menuItems[i]))}}static get styles(){return[n,u.a]}}},function(t,e,r){"use strict";r.d(e,"b",(function(){return f})),r.d(e,"a",(function(){return z}));var s=r(2),i=r(6),o=r(7),a=r(210),c=r(212),l=r(11);r(63),r(32);let n;var u=Object(i.b)(n||(n=(t=>t)`
:host{--spectrum-textfield-border-size:var(
...
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-error-icon-margin-left))}:host([dir=rtl][invalid]) .input{padding-left:calc(var(--spectrum-textfield-padding-right) + var(
--spectrum-icon-alert-medium-width,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-error-icon-margin-left))}:host([multiline]) .input{height:var(
...
);border-right-width:0;border-top-width:0;overflow-y:hidden;resize:none}:host([dir=ltr][invalid][quiet]) .input{padding-right:calc(var(
--spectrum-icon-alert-medium-width,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-quiet-error-icon-margin-left))}:host([dir=rtl][invalid][quiet]) .input{padding-left:calc(var(
--spectrum-icon-alert-medium-width,
var(--spectrum-global-dimension-size-225)
...
--spectrum-alias-workflow-icon-size-m,var(--spectrum-global-dimension-size-225)
);position:absolute;top:calc(var(--spectrum-textfield-height)/2 - var(
--spectrum-alias-workflow-icon-size-m,
var(--spectrum-global-dimension-size-225)
)/2);width:var(
--spectrum-alias-workflow-icon-size-m,var(--spectrum-global-dimension-size-225)
...
--spectrum-alias-workflow-icon-size-m,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-quiet-icon-gap))}:host([dir=rtl][quiet]) .icon-workflow~.input{padding-right:calc(var(
--spectrum-alias-workflow-icon-size-m,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-quiet-icon-gap))}:host([dir=ltr]) .icon-workflow+.input{padding-left:calc(var(--spectrum-textfield-error-icon-margin-left) + var(
--spectrum-alias-workflow-icon-size-m,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-icon-gap))}:host([dir=rtl]) .icon-workflow+.input{padding-right:calc(var(--spectrum-textfield-error-icon-margin-left) + var(
--spectrum-alias-workflow-icon-size-m,
var(--spectrum-global-dimension-size-225)
) + var(--spectrum-textfield-icon-gap))}:host([multiline]) .icon-workflow~.input{height:var(
--spectrum-textfield-height
...
)}:host([grows]) .input{height:100%;left:0;position:absolute;resize:none;top:0}:host([grows]) #sizer{border:var(
...
`)),m=r(50);let p,d,h,g,b,v,x=t=>t;class f extends l.a{constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[u,m.a]}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}onInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}}this.value=this.inputElement.value;const t=this.inputElement.selectionStart;this.updateComplete.then(()=>{this.inputElement.setSelectionRange(t,t)})}onChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!0}onBlur(){this.focused=!1}renderStateIcons(){return this.invalid?Object(i.d)(p||(p=x`
            ...
            <textarea
                ...
                autocomplete=${0}
            ></textarea>
        `),this.grows&&!this.quiet?Object(i.d)(g||(g=x`
                      <div id="sizer">${0}</div>
                  `),this.value):o.i,this.label||this.placeholder,Object(a.a)(this.invalid||void 0),Object(a.a)(this.maxlength>-1?this.maxlength:void 0),Object(a.a)(this.minlength>-1?this.minlength:void 0),Object(a.a)(this.pattern),this.placeholder,this.displayValue,this.onChange,this.onInput,this.onFocus,this.onBlur,this.disabled,this.required,this.readonly,Object(a.a)(this.autocomplete))}get renderInput(){return Object(i.d)(b||(b=x`
            <!-- @ts-ignore -->
            <input
                type="text"
                aria-label=${0}
                ...
                autocomplete=${0}
            />
        `),this.label||this.placeholder,Object(a.a)(this.invalid||void 0),Object(a.a)(this.maxlength>-1?this.maxlength:void 0),Object(a.a)(this.minlength>-1?this.minlength:void 0),Object(a.a)(this.pattern),this.placeholder,Object(c.a)(this.displayValue),this.onChange,this.onInput,this.onFocus,this.onBlur,this.disabled,this.required,this.readonly,Object(a.a)(this.autocomplete))}render(){return Object(i.d)(v||(v=x`
            ${0}
            ${0}
        `),this.renderStateIcons(),this.multiline?this.renderMultiline:this.renderInput)}updated(t){(t.has("value")||t.has("required")&&this.required)&&this.checkValidity()}checkValidity(){let t=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t}return t}}Object(s.a)([Object(i.e)({attribute:"allowed-keys"})],f.prototype,"allowedKeys",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"focused",void 0),Object(s.a)([Object(i.f)(".input")],f.prototype,"inputElement",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"invalid",void 0),Object(s.a)([Object(i.e)()],f.prototype,"label",void 0),Object(s.a)([Object(i.e)()],f.prototype,"placeholder",void 0),Object(s.a)([Object(i.e)()],f.prototype,"pattern",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"grows",void 0),Object(s.a)([Object(i.e)({type:Number})],f.prototype,"maxlength",void 0),Object(s.a)([Object(i.e)({type:Number})],f.prototype,"minlength",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"multiline",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"readonly",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"valid",void 0),Object(s.a)([Object(i.e)({type:String})],f.prototype,"value",null),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"quiet",void 0),Object(s.a)([Object(i.e)({type:Boolean,reflect:!0})],f.prototype,"required",void 0),Object(s.a)([Object(i.e)({type:String,reflect:!0})],f.prototype,"autocomplete",void 0);class z extends f{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}Object(s.a)([Object(i.e)({type:String})],z.prototype,"value",null)},function(t,e,r){"use strict";r.d(e,"a",(function(){return u}));var s=r(2),i=r(208),o=r(6);let a;var c=Object(o.b)(a||(a=(t=>t)`
...
`));let l,n=t=>t;class u extends i.a{static get styles(){return[c]}render(){return Object(o.d)(l||(l=n`
            <slot></slot>
        `))}}Object(s.a)([Object(o.e)()],u.prototype,"label",void 0),Object(s.a)([Object(o.e)({reflect:!0})],u.prototype,"size",void 0)},,,,,,,function(t,e,r){"use strict";r.d(e,"a",(function(){return a}));var s=r(2),i=r(6);const o=new Set;new MutationObserver(()=>{const t="rtl"===document.documentElement.dir?document.documentElement.dir:"ltr";o.forEach(e=>{e.setAttribute("dir",t)})}).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});class a extends(function(t){class e extends t{constructor(){super(...arguments),this.dir="ltr"}get isLTR(){return"ltr"===this.dir}connectedCallback(){if(!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&(void 0===(t=e).startManagingContentDirection&&"SP-THEME"!==t.tagName);)e=e.assignedSlot||e.parentNode||e.host;if(this.dir="rtl"===e.dir?e.dir:this.dir||"ltr",e===document.documentElement)o.add(this);else{const{localName:t}=e;t.search("-")>-1&&!customElements.get(t)?customElements.whenDefined(t).then(()=>{e.startManagingContentDirection(this)}):e.startManagingContentDirection(this)}this._dirParent=e}var t;super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._dirParent&&(this._dirParent===document.documentElement?o.delete(this):this._dirParent.stopManagingContentDirection(this),this.removeAttribute("dir"))}}return Object(s.a)([Object(i.e)({reflect:!0})],e.prototype,"dir",void 0),e}(i.a)){}},function(t,e,r){"use strict";r.d(e,"a",(function(){return s}));const s=t=>t.getRootNode().activeElement},,function(t,e,r){"use strict";r.d(e,"a",(function(){return a}));const s=Symbol("slotElementObserver"),i=Symbol("startObserving"),o=Symbol("slotContentIsPresent");function a(t,e){var r;const a=Array.isArray(e)?e:[e];class c extends t{constructor(){super(...arguments),this[r]=new Map,this.managePresenceObservedSlot=()=>{a.forEach(t=>{this[o].set(t,!!this.querySelector(t))}),this.requestUpdate()}}get slotContentIsPresent(){if(1===a.length)return this[o].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(t){if(this[o].has(t))return this[o].get(t)||!1;throw new Error("The provided selector `` is not being observed.")}[(r=o,i)](){this[s]||(this[s]=new MutationObserver(this.managePresenceObservedSlot)),this[s].observe(this,{childList:!0,subtree:!0}),this.managePresenceObservedSlot()}connectedCallback(){super.connectedCallback(),this[i]()}disconnectedCallback(){this[s].disconnect(),super.disconnectedCallback()}}return c}},,function(t,e,r){"use strict";r.d(e,"a",(function(){return o}));var s=r(2),i=r(6);function o(t,{validSizes:e=["s","m","l","xl"],noDefaultSize:r}={}){class o extends t{constructor(){super(...arguments),this._size="m"}get size(){return this._size||"m"}set size(t){const s=r?null:"m",i=t?t.toLocaleLowerCase():t,o=e.includes(i)?i:s;if(o&&this.setAttribute("size",o),this._size===o)return;const a=this._size;this._size=o,this.requestUpdate("size",a)}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("size")||r||this.setAttribute("size",this.size)}}return Object(s.a)([Object(i.e)({type:String,reflect:!0})],o.prototype,"size",null),o}},,,,,,,,function(t,e,r){"use strict";r.r(e);var s=r(6);let i;Object(s.b)(i||(i=(t=>t)`
:root,body{-webkit-font-smoothing:antialiased;height:100vh;margin:0;overflow:hidden;width:100%}
/*# sourceURL=webpack://./documentation/src/main.css */
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */
`));var o=r(2),a=r(82);let c,l=t=>t;class n extends a.a{renderContent(){return Object(s.d)(c||(c=l` <slot></slot> `))}firstUpdated(){const t=document.createElement("link");t.rel="stylesheet",t.href="https://use.typekit.net/evk7lzt.css",document.head.append(t)}resetScroll(){this.contentElement&&(this.contentElement.scrollTop=0,this.open=!1)}}Object(o.a)([Object(s.f)("#layout-content")],n.prototype,"contentElement",void 0),customElements.define("docs-page",n);r(41);window.spAlert=(t,e)=>{t.dispatchEvent(new CustomEvent("alert",{composed:!0,bubbles:!0,detail:{message:e}}))}}]]);
//# sourceMappingURL=4.6c3202b4837cb9e5cb30.js.map