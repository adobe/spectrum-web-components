import{S as t,y as e,_ as a,e as r,M as s,d as n}from"./fe774044.js";import{r as i}from"./1a00b51e.js";var l=i`.spectrum{color:var(--spectrum-body-m-text-color,var(--spectrum-alias-text-color));font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
);font-size:var(
--spectrum-alias-font-size-default,var(--spectrum-global-dimension-font-size-100)
)}`;var o=i`.spectrum:lang(ar){font-family:var(
...
)}`;var m=[l,o,i`.spectrum-Heading--sizeXXXL{font-size:var(
...
)}::slotted(svg[viewBox]){width:100%}`;var g=[l,o,i`.spectrum-Body--sizeXXXL{font-size:var(
...
--spectrum-body-m-text-color,var(--spectrum-alias-text-color)
)}`];class p extends t{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[m,g,c]}render(){return e`<div id="illustration"><slot></slot></div><h2 id="heading" class="spectrum-Heading spectrum-Heading--sizeL spectrum-Heading--light"><slot name="heading">${this.heading}</slot></h2><div id="description" class="spectrum-Body spectrum-Body--sizeS"><slot name="description">${this.description}</slot></div>`}}p.is="sp-illustrated-message",a([r()],p.prototype,"heading",void 0),a([r()],p.prototype,"description",void 0),customElements.define("sp-illustrated-message",p);var u=i`.header{color:var(--spectrum-listheading-text-color);display:block;font-size:var(--spectrum-listitem-texticon-heading-text-size);font-weight:var(--spectrum-listitem-texticon-heading-text-font-weight);letter-spacing:var(
--spectrum-listitem-texticon-heading-letter-spacing
);line-height:var(--spectrum-listitem-texticon-heading-line-height);margin:var(--spectrum-listitem-texticon-heading-margin);padding:var(--spectrum-listitem-texticon-heading-padding);text-transform:var(--spectrum-listitem-texticon-heading-text-transform)}:host{display:inline;margin:0;overflow:visible}:host([dir=ltr]) .header{padding:0 var(--spectrum-global-dimension-size-450) 0 var(--spectrum-global-dimension-size-150)}:host([dir=rtl]) .header{padding:0 var(--spectrum-global-dimension-size-150) 0 var(--spectrum-global-dimension-size-450)}sp-menu{display:block}`;class h extends s{constructor(){super(),h.instances+=1,this.headerId=`sp-menu-group-label-${h.instances}`}static get styles(){return[...super.styles,u]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const t=this.headerElements.length?this.headerElements[0]:void 0;if(t!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),t){const e=t.id||this.headerId;t.id||(t.id=e),this.setAttribute("aria-labelledby",e)}else this.removeAttribute("aria-labelledby");this.headerElement=t}render(){return e`<span class="header" aria-hidden="true"><slot name="header" @slotchange="${this.updateLabel}"></slot></span><sp-menu role="none"><slot></slot></sp-menu>`}}h.instances=0,a([n("header",!0)],h.prototype,"headerElements",void 0),customElements.define("sp-menu-group",h);export{l as b,m as h,o as l};
//# sourceMappingURL=83507f4d.js.map
