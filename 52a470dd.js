import{f as e,S as t}from"./d8f4b232.js";import{i as r}from"./112b2095.js";import"./01bc5c68.js";import{S as o}from"./6df85535.js";import{T as i,A as c,x as a,n as s,d as l}from"./6e6fc264.js";import"./88d1b662.js";import{c as n,t as d}from"./5e6ac894.js";import{l as u,F as p,i as h}from"./1d529499.js";import"./bd7d820b.js";import"./ca266fd7.js";import{E as m}from"./7c327fb6.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./ebe27ef2.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,O=Object.defineProperty,U=Object.getOwnPropertyDescriptor,R=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?U(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&O(t,r,c),c};const A=e=>e.stopPropagation();class P extends _{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,F]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}R([s()],P.prototype,"action",2),R([s()],P.prototype,"label",2),R([s()],P.prototype,"method",2),R([s()],P.prototype,"placeholder",2),R([h("#form")],P.prototype,"form",2),l("sp-search",P);export{I as M,L as T,_ as a};
//# sourceMappingURL=52a470dd.js.map
