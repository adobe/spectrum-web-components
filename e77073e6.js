import{S as t,I as e,c as o,u as r}from"./97119b6f.js";import{r as i}from"./e50c5e8d.js";import"./4878d6c7.js";import{S as l,l as c,a,i as n}from"./5a184a55.js";import{b as s,w as u,$ as d,e as p}from"./03cd2f8f.js";import"./f447cac7.js";import"./77d4c924.js";import{e as m,i as h,t as v}from"./89c02dc9.js";import{r as f,s as b,t as x}from"./5b45ad00.js";const g=m(class extends h{constructor(t){if(super(t),t.type!==v.PROPERTY&&t.type!==v.ATTRIBUTE&&t.type!==v.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!f(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===s||e===u)return e;const o=t.element,r=t.name;if(t.type===v.PROPERTY){if(e===o[r])return s}else if(t.type===v.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(r))return s}else if(t.type===v.ATTRIBUTE&&o.getAttribute(r)===e+"")return s;return b(t),e}});var w=i`
...
`,k=Object.defineProperty,y=Object.getOwnPropertyDescriptor;const q={s:()=>d`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>d`
        ...
        ></sp-icon-cross300>
    `};class z extends(l(t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,w,e]}get buttonContent(){return[q[this.size]()]}render(){return d`
            <div class="fill">${super.render()}</div>
        `}}((t,e,o,r)=>{for(var i,l=r>1?void 0:r?y(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);r&&l&&k(e,o,l)})([p({reflect:!0})],z.prototype,"variant",2);const $=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return d`
...
`,I=Object.defineProperty,H=Object.getOwnPropertyDescriptor,j=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?H(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&I(e,o,l),l};const S=["text","url","tel","email","password"];class L extends(B(a)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[E,r]}get type(){var t;return null!=(t=S.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?d`
            ...
            `:this.valid?d`
                ...
                ></sp-icon-checkmark100>
            `:u}get displayValue(){return this.value.toString()}get renderMultiline(){return d`
...
`,O=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&O(e,o,l),l};const R=t=>t.stopPropagation();class A extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,C]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return d`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}_([p()],A.prototype,"action",2),_([p()],A.prototype,"label",2),_([p()],A.prototype,"method",2),_([p()],A.prototype,"placeholder",2),_([n("#form")],A.prototype,"form",2),customElements.define("sp-search",A);export{B as M,L as T,F as a};
//# sourceMappingURL=e77073e6.js.map
