import{T as t}from"./e00c8409.js";import{T as e,y as o,_ as r,e as i,S as c,x as s}from"./62b05a9e.js";import{r as a}from"./e50c5e8d.js";import{e as n,a as l,t as u,L as d,b as m,c as p,i as b,S as v,d as h,B as g}from"./a41a5416.js";import"./4e3d38a5.js";import"./c24d2ae8.js";import"./b86f55ac.js";import"./4acefc0c.js";customElements.define("sp-theme",t);const x=n(class extends l{constructor(t){var e;if(super(t),t.type!==u.ATTRIBUTE||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[o]){var r,i;if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.et=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in o)o[t]&&!(null===(r=this.et)||void 0===r?void 0:r.has(t))&&this.st.add(t);return this.render(o)}const c=t.element.classList;this.st.forEach((t=>{t in o||(c.remove(t),this.st.delete(t))}));for(const t in o){const e=!!o[t];e===this.st.has(t)||(null===(i=this.et)||void 0===i?void 0:i.has(t))||(e?(c.add(t),this.st.add(t)):(c.remove(t),this.st.delete(t)))}return e}});var y=a`#button{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-appearance:button;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;class T extends(v(h)){constructor(){super(...arguments),this.variant="cta",this.warning=!1,this.quiet=!1}static get styles(){return[...super.styles,P]}}r([i({reflect:!0})],T.prototype,"variant",void 0),r([i({type:Boolean,reflect:!0})],T.prototype,"warning",void 0),r([i({type:Boolean,reflect:!0})],T.prototype,"quiet",void 0),customElements.define("sp-button",T);var F=a`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;font-family:var(
--spectrum-alias-body-text-font-family,var(--spectrum-global-font-family-base)
);justify-content:center;line-height:var(
--spectrum-alias-component-text-line-height,var(--spectrum-global-font-line-height-small)
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;var M=a`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-CornerTriangle75{height:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`;const $={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let O;class K extends(v(g)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[F,M]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),O=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(O),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;("Space"===e||o&&"ArrowDown"===e)&&(t.preventDefault(),"ArrowDown"===e&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;("Space"===e||o&&"ArrowDown"===e)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(o`<sp-icon-corner-triangle300 id="hold-affordance" class="${$[this.size]}"></sp-icon-corner-triangle300>`),t}updated(t){super.updated(t),this.toggles&&t.has("selected")&&this.focusElement.setAttribute("aria-pressed",this.selected?"true":"false")}}r([i({type:Boolean,reflect:!0})],K.prototype,"emphasized",void 0),r([i({type:Boolean,reflect:!0,attribute:"hold-affordance"})],K.prototype,"holdAffordance",void 0),r([i({type:Boolean,reflect:!0})],K.prototype,"quiet",void 0),r([i({type:Boolean,reflect:!0})],K.prototype,"selected",void 0),r([i({type:Boolean,reflect:!0})],K.prototype,"toggles",void 0),r([i({type:String})],K.prototype,"value",null),customElements.define("sp-action-button",K),customElements.define("sp-menu-item",U);var H=a`:host([size=s]){--spectrum-link-primary-text-size:var(
...
)}@media (forced-colors:active){:host([variant=secondary]) a{color:linktext}:host([variant=secondary]) a:hover{color:linktext}:host([variant=secondary]) a:active{color:linktext}:host([variant=secondary]) a:focus{color:linktext}}:host{display:inline}:host(:focus){outline:0}:host([href]) a.focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}:host([href]) a:focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}`;class N extends(v(d(m),{noDefaultSize:!0})){static get styles(){return[H]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}r([b("#anchor")],N.prototype,"anchorElement",void 0),r([i({type:String,reflect:!0})],N.prototype,"variant",void 0),customElements.define("sp-link",N);var V=a`:host([size=s]){--spectrum-divider-height:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class W extends(v(c,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return o``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}W.styles=[V],r([i({type:Boolean,reflect:!0})],W.prototype,"vertical",void 0),customElements.define("sp-divider",W);var Y=a`:host{--spectrum-toast-icon-padding-y:var(
--spectrum-global-dimension-size-85
...
--spectrum-toast-positive-background-color,var(--spectrum-semantic-positive-background-color)
)}.content{line-height:1.5}:host(:not([open])){display:none}`;const Q=["negative","positive","info","error","warning"];class X extends c{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.open=!1,this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[Y]}set timeout(t){const e=null!==typeof t&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Q.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return o`<sp-icon-info label="Information" class="type"></sp-icon-info>`;case"negative":case"error":case"warning":return o`<sp-icon-alert label="Error" class="type"></sp-icon-alert>`;case"positive":case"success":return o`<sp-icon-checkmark-circle label="Success" class="type"></sp-icon-checkmark-circle>`;default:return o``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}close(){this.open=!1}render(){return o`${this.renderIcon(this.variant)}<div class="body" role="alert"><div class="content"><slot></slot></div><slot name="action"></slot></div><div class="buttons"><sp-clear-button label="Close" variant="overBackground" @click="${this.close}"></sp-clear-button></div>`}updated(t){if(super.updated(t),t.has("open"))if(this.open)this.timeout&&this.startCountdown();else{this.timeout&&this.stopCountdown();this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))||(this.open=!0)}t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}r([i({type:Boolean,reflect:!0})],X.prototype,"open",void 0),r([i({type:Number})],X.prototype,"timeout",null),r([i({type:String})],X.prototype,"variant",null),customElements.define("sp-toast",X);export{A as M,D as P,x as a,f as c,L as o,k as r};
//# sourceMappingURL=ab784ecf.js.map
