...
)}:host,:root{font-family:var(--spectrum-alias-body-text-font-family);font-size:var(--spectrum-alias-font-size-default)}:host:lang(ar),:root:lang(ar){font-family:var(--spectrum-alias-font-family-ar)}:host:lang(he),:root:lang(he){font-family:var(--spectrum-alias-font-family-he)}:host:lang(zh-Hans),:root:lang(zh-Hans){font-family:var(--spectrum-alias-font-family-zhhans)}:host:lang(zh-Hant),:root:lang(zh-Hant){font-family:var(--spectrum-alias-font-family-zh)}:host:lang(zh),:root:lang(zh){font-family:var(--spectrum-alias-font-family-zh)}:host:lang(ko),:root:lang(ko){font-family:var(--spectrum-alias-font-family-ko)}:host:lang(ja),:root:lang(ja){font-family:var(--spectrum-alias-font-family-ja)}:host{display:block}#scale,#theme{height:100%;width:100%}`;const o=["medium","large"],t=["light","lightest","dark","darkest"];class s extends HTMLElement{constructor(){super(),this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const e=document.importNode(s.template.content,!0);this.shadowRoot.appendChild(e),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","lang"]}attributeChangedCallback(e,a,r){a!==r&&("color"===e?this.color=r:"scale"===e?this.scale=r:"lang"===e&&r&&(this.lang=r,this._provideContext()))}requestUpdate(){void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?this.shouldAdoptStyles():window.ShadyCSS.styleElement(this)}get color(){const e=s.themeFragmentsByKind.get("color"),{name:a}=e&&e.get("default")||{};return this._color||a||""}set color(e){if(e===this._color)return;const a=e&&t.includes(e)?e:this.color;a!==this._color&&(this._color=a,this.requestUpdate()),a?this.setAttribute("color",a):this.removeAttribute("color")}get scale(){const e=s.themeFragmentsByKind.get("scale"),{name:a}=e&&e.get("default")||{};return this._scale||a||""}set scale(e){if(e===this._scale)return;const a=e&&o.includes(e)?e:this.scale;a!==this._scale&&(this._scale=a,this.requestUpdate()),a?this.setAttribute("scale",a):this.removeAttribute("scale")}get styles(){return[...[...s.themeFragmentsByKind.keys()].reduce(((e,a)=>{const r=s.themeFragmentsByKind.get(a),o=(a,o)=>{const t=r.get(a);!t||o&&!this.hasAttribute(o)||e.push(t.styles)};if("app"===a||"core"===a)o(a);else{const{[a]:e}=this;o(e,a)}return e}),[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise((e=>{this.__resolve=e}))}onQueryTheme(e){if(e.defaultPrevented)return;e.preventDefault();const{detail:a}=e;a.color=this.color||void 0,a.scale=this.scale||void 0,a.lang=this.lang||document.documentElement.lang||navigator.language}connectedCallback(){this.shouldAdoptStyles(),void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this),s.instances.add(this);const e=()=>{const{dir:e}=this;this.trackedChildren.forEach((a=>{a.setAttribute("dir","rtl"===e?e:"ltr")}))};if(this.observer||(this.observer=new MutationObserver(e)),this.observer.observe(this,{attributes:!0,attributeFilter:["dir"]}),!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!(e instanceof s);)e=e.assignedSlot||e.parentNode||e.host;this.dir="rtl"===e.dir?e.dir:"ltr"}requestAnimationFrame((()=>e()))}disconnectedCallback(){s.instances.delete(this),this.observer.disconnect()}startManagingContentDirection(e){this.trackedChildren.add(e)}stopManagingContentDirection(e){this.trackedChildren.delete(e)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const e=this.styles;if(void 0!==window.ShadyCSS&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const e=[];for(const[a,r]of s.themeFragmentsByKind)for(const[o,{styles:t}]of r){if("default"===o)continue;let r=t.cssText;s.defaultFragments.has(o)||(r=r.replace(":host",`:host([${a}='${o}'])`)),e.push(r)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e,this.localName),window.ShadyCSS.prepareTemplate(s.template,this.localName)}else if(a){const a=[];for(const r of e)a.push(r.styleSheet);this.shadowRoot.adoptedStyleSheets=a}else{this.shadowRoot.querySelectorAll("style").forEach((e=>e.remove())),e.forEach((e=>{const a=document.createElement("style");a.textContent=e.cssText,this.shadowRoot.appendChild(a)}))}}static registerThemeFragment(e,a,r){const o=s.themeFragmentsByKind.get(a)||new Map;0===o.size&&(s.themeFragmentsByKind.set(a,o),o.set("default",{name:e,styles:r}),s.defaultFragments.add(e)),o.set(e,{name:e,styles:r}),s.instances.forEach((e=>e.shouldAdoptStyles()))}_provideContext(){this._contextConsumers.forEach((e=>e(this.lang)))}_handleContextPresence(e){const a=e.composedPath()[0];if(this._contextConsumers.has(a))this._contextConsumers.delete(a);else{this._contextConsumers.set(a,e.detail.callback);const r=this._contextConsumers.get(a);r&&r(this.lang||document.documentElement.lang||navigator.language)}}}s.themeFragmentsByKind=new Map,s.defaultFragments=new Set(["core"]),s.instances=new Set,s.registerThemeFragment("core","core",r);export{s as T};
//# sourceMappingURL=9fcbce9a.js.map
