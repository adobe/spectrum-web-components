import"./9cdb9ada.js";import{L as t,t as e,$ as o,i as r,a as i}from"./0c1af6fc.js";import"./46ba864d.js";import{i as s}from"./67a87733.js";import{r as c}from"./590196c7.js";import{x as n,e as a,d as l}from"./cd228091.js";var h=s`
...
`;const u=async(t,e,o,r)=>{const{Overlay:i}=await import("./760df7e6.js");return i.open(t,e,o,r)};class d extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var m=s`
...
`,C=Object.defineProperty,U=Object.getOwnPropertyDescriptor,L=(t,e,o,r)=>{for(var i,s=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(s=(r?i(e,o,s):i(s))||s);return r&&s&&C(e,o,s),s};class E extends(t(i)){constructor(){super(...arguments),this.quiet=!1}static get styles(){return[w]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}L([r("#anchor")],E.prototype,"anchorElement",2),L([a({type:String,reflect:!0})],E.prototype,"variant",2),L([a({type:String,reflect:!0})],E.prototype,"static",2),L([a({type:Boolean,reflect:!0,attribute:"quiet"})],E.prototype,"quiet",2),l("sp-link",E);const S="(prefers-color-scheme: dark)",T="(max-width: 700px) and (hover: none) and (pointer: coarse), (max-height: 700px) and (hover: none) and (pointer: coarse)";class R{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;null==(t=this.media)||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;null==(t=this.media)||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}export{S as D,T as I,R as M,I as a,h as b,u as o};
//# sourceMappingURL=8588818e.js.map
