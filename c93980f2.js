import{i as e}from"./d230bd74.js";import"./a3268a6a.js";import{S as t,i}from"./01bc7f71.js";import{S as s,y as r,e as a}from"./99636b0a.js";var l=e`
...
`,u=Object.defineProperty,h=Object.getOwnPropertyDescriptor,b=(e,t,i,s)=>{for(var r,a=s>1?void 0:s?h(t,i):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(s?r(t,i,a):r(a))||a);return s&&a&&u(t,i,a),a};const g=class extends(t(s)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new m(this)}static get styles(){return[p,o]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),r=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():r&&r.forceFocusVisible&&r.forceFocusVisible()}addTarget(e){this.target=e.focusElement||e,this.target.getRootNode()===this.getRootNode()?n(this.target,"aria-labelledby",[this.id]):this.target.setAttribute("aria-label",this.labelText)}removeTarget(){this.target&&(this.target.getRootNode()===this.getRootNode()?c(this.target,"aria-labelledby",[this.id]):this.target.removeAttribute("aria-label"))}async manageTarget(){this.removeTarget();const e=this.resolvedElement.element;e?(e.localName.search("-")>0&&await customElements.whenDefined(e.localName),void 0!==e.updateComplete&&await e.updateComplete,this.addTarget(e)):this.target=e}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});return e.length?e.map((e=>(e.textContent||"").trim())).join(" "):""}render(){return r`
            <label>
                <slot></slot>
                ${this.required?r`
                          <sp-icon-asterisk100
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}willUpdate(e){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${g.instanceCount++}`),e.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(e.has("id")||e.has(d))&&this.manageTarget()}};let f=g;f.instanceCount=0,b([a({type:Boolean,reflect:!0})],f.prototype,"disabled",2),b([a({type:String})],f.prototype,"id",2),b([a({type:String})],f.prototype,"for",2),b([a({type:Boolean,reflect:!0})],f.prototype,"required",2),b([i("slot")],f.prototype,"slotEl",2),b([a({type:String,reflect:!0,attribute:"side-aligned"})],f.prototype,"sideAligned",2),customElements.define("sp-field-label",f);export{n as c,l as u};
//# sourceMappingURL=c93980f2.js.map
