import{t as e,s as a}from"./e3d6b3c7.js";import{I as i,y as t}from"./99636b0a.js";customElements.define("sp-icon-info",class extends i{render(){return a(t),(({width:a=24,height:i=24,hidden:t=!1,title:l="Info"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});customElements.define("sp-icon-checkmark-circle",class extends i{render(){return a(t),(({width:a=24,height:i=24,hidden:t=!1,title:l="Checkmark Circle"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    width=${a}
    height=${i}
    viewBox="0 0 36 36"
...
//# sourceMappingURL=3af3c7eb.js.map
