import{S as t,I as e}from"./21db0c76.js";import{i as o}from"./d230bd74.js";import"./070309fa.js";import{e as r,b as i,c as l,S as c,l as a,a as n,i as s}from"./01bc7f71.js";import{x as u,b as d,y as p,e as m}from"./99636b0a.js";import"./11e1ea16.js";import{c as v,u as h}from"./c93980f2.js";import"./a3268a6a.js";import"./e3d6b3c7.js";import{e as f,s as b}from"./039b08f0.js";import{t as x}from"./44514a60.js";const g=r(class extends i{constructor(t){if(super(t),t.type!==l.PROPERTY&&t.type!==l.ATTRIBUTE&&t.type!==l.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!f(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===u||e===d)return e;const o=t.element,r=t.name;if(t.type===l.PROPERTY){if(e===o[r])return u}else if(t.type===l.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(r))return u}else if(t.type===l.ATTRIBUTE&&o.getAttribute(r)===e+"")return u;return b(t),e}});var w=o`
...
`,k=Object.defineProperty,y=Object.getOwnPropertyDescriptor;const q={s:()=>p`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>p`
        ...
        ></sp-icon-cross300>
    `};class z extends(c(t)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,w,e]}get buttonContent(){return[q[this.size]()]}render(){return p`
            <div class="fill">${super.render()}</div>
        `}}((t,e,o,r)=>{for(var i,l=r>1?void 0:r?y(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);r&&l&&k(e,o,l)})([m({reflect:!0})],z.prototype,"variant",2);const $=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return p`
...
`,I=Object.defineProperty,j=Object.getOwnPropertyDescriptor,H=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?j(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&I(e,o,l),l};const S=["text","url","tel","email","password"];class L extends(B(n)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[E,h]}get type(){var t;return null!=(t=S.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?p`
            ...
            `:this.valid?p`
                ...
                ></sp-icon-checkmark100>
            `:d}get displayValue(){return this.value.toString()}get renderMultiline(){return p`
            ${this.grows&&!this.quiet?p`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t),t}}H([m({attribute:"allowed-keys"})],L.prototype,"allowedKeys",2),H([m({type:Boolean,reflect:!0})],L.prototype,"focused",2),H([s(".input")],L.prototype,"inputElement",2),H([m({type:Boolean,reflect:!0})],L.prototype,"invalid",2),H([m()],L.prototype,"label",2),H([m()],L.prototype,"placeholder",2),H([m({attribute:"type",reflect:!0})],L.prototype,"_type",2),H([x()],L.prototype,"type",1),H([m()],L.prototype,"pattern",2),H([m({type:Boolean,reflect:!0})],L.prototype,"grows",2),H([m({type:Number})],L.prototype,"maxlength",2),H([m({type:Number})],L.prototype,"minlength",2),H([m({type:Boolean,reflect:!0})],L.prototype,"multiline",2),H([m({type:Boolean,reflect:!0})],L.prototype,"readonly",2),H([m({type:Boolean,reflect:!0})],L.prototype,"valid",2),H([m({type:String})],L.prototype,"value",1),H([m({type:Boolean,reflect:!0})],L.prototype,"quiet",2),H([m({type:Boolean,reflect:!0})],L.prototype,"required",2),H([m({type:String,reflect:!0})],L.prototype,"autocomplete",2);class F extends L{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}H([m({type:String})],F.prototype,"value",1),customElements.define("sp-clear-button",z);var C=o`
...
`,O=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&O(e,o,l),l};const R=t=>t.stopPropagation();class A extends F{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,C]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return p`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}_([m()],A.prototype,"action",2),_([m()],A.prototype,"label",2),_([m()],A.prototype,"method",2),_([m()],A.prototype,"placeholder",2),_([s("#form")],A.prototype,"form",2),customElements.define("sp-search",A);export{B as M,L as T,F as a};
//# sourceMappingURL=2b7a1ff1.js.map
