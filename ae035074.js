...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const P=e=>e.stopPropagation();class D extends U{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,R]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;this.value&&"Escape"===t&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`<form action="${this.action}" id="form" method="${l(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?a`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${P}"></sp-clear-button>`:a``}</form>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}updated(e){super.updated(e),this.multiline=!1}}u([e()],D.prototype,"action",void 0),u([e()],D.prototype,"label",void 0),u([e()],D.prototype,"method",void 0),u([e()],D.prototype,"placeholder",void 0),u([p("#form")],D.prototype,"form",void 0),customElements.define("sp-search",D);var H=g`:host{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}`;var M=g`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}:host{display:block}`;class O extends x{constructor(){super(...arguments),this.label=""}static get styles(){return[M,K]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`<h2 id="heading">${this.label}</h2><div id="list" aria-labelledby="heading"><slot name="descendant"></slot></div>`}}u([e({reflect:!0})],O.prototype,"label",void 0);class V extends d{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new A(this,{focusInIndex:e=>e.findIndex((e=>this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e))),direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)}),this.manageTabIndex=!1,this.value=void 0}static get styles(){return[H]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache()}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof O||!t.disabled&&t instanceof j&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return a`<nav @sidenav-select="${this.handleSelect}"><slot name="descendant" @slotchange="${this.handleSlotchange}"></slot></nav>`}firstUpdated(e){super.firstUpdated(e);const t=this.querySelector("[selected]");t&&(this.value=t.value)}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}u([e({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],V.prototype,"manageTabIndex",void 0),u([e({reflect:!0})],V.prototype,"value",void 0),customElements.define("sp-sidenav",V),customElements.define("sp-sidenav-item",j);export{L as M,A as R,O as S,B as T,$ as a,_ as b,q as c,U as d,S as m,y as r,I as s,b as t,z as u};
//# sourceMappingURL=ae035074.js.map
