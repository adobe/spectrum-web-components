...
)}`;class c extends e{constructor(){super(...arguments),this.open=!1}static get styles(){return[d]}render(){return t``}}i([a({type:Boolean,reflect:!0})],c.prototype,"open",void 0),customElements.define("sp-underlay",c);var m=s`:host{--spectrum-sidenav-item-padding-y:var(
...
)}`;var u=s`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
