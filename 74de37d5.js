import{e as t,i as e,t as o,S as r,I as i,c as l,u as c}from"./d46b3d78.js";import{r as a}from"./e50c5e8d.js";import"./4878d6c7.js";import{S as n,l as s,a as u,i as d}from"./5a184a55.js";import{e as p,R as m,b as v,w as h,$ as f}from"./03cd2f8f.js";import"./f447cac7.js";import"./77d4c924.js";function b(t){return p({...t,state:!0})}const{H:x}=m,g=t=>void 0===t.strings,w=()=>document.createComment(""),k=(t,e,o)=>{var r;const i=t._$AA.parentNode,l=void 0===e?t._$AB:e._$AA;if(void 0===o){const e=i.insertBefore(w(),l),r=i.insertBefore(w(),l);o=new x(e,r,t,t.options)}else{const e=o._$AB.nextSibling,c=o._$AM,a=c!==t;if(a){let e;null===(r=o._$AQ)||void 0===r||r.call(o,t),o._$AM=t,void 0!==o._$AP&&(e=t._$AU)!==c._$AU&&o._$AP(e)}if(e!==l||a){let t=o._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,l),t=e}}}return o},y=(t,e,o=t)=>(t._$AI(e,o),t),q={},z=(t,e=q)=>t._$AH=e,$=t=>t._$AH,B=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let o=t._$AA;const r=t._$AB.nextSibling;for(;o!==r;){const t=o.nextSibling;o.remove(),o=t}},T=t(class extends e{constructor(t){if(super(t),t.type!==o.PROPERTY&&t.type!==o.ATTRIBUTE&&t.type!==o.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!g(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===v||e===h)return e;const r=t.element,i=t.name;if(t.type===o.PROPERTY){if(e===r[i])return v}else if(t.type===o.BOOLEAN_ATTRIBUTE){if(!!e===r.hasAttribute(i))return v}else if(t.type===o.ATTRIBUTE&&r.getAttribute(i)===e+"")return v;return z(t),e}});var E=a`
...
`,I=Object.defineProperty,A=Object.getOwnPropertyDescriptor;const _={s:()=>f`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>f`
        ...
        ></sp-icon-cross300>
    `};class H extends(n(r)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,E,i]}get buttonContent(){return[_[this.size]()]}render(){return f`
            <div class="fill">${super.render()}</div>
        `}}((t,e,o,r)=>{for(var i,l=r>1?void 0:r?A(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);r&&l&&I(e,o,l)})([p({reflect:!0})],H.prototype,"variant",2);const S=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=S.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return f`
...
`,F=Object.defineProperty,U=Object.getOwnPropertyDescriptor,O=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&F(e,o,l),l};const P=["text","url","tel","email","password"];class R extends(L(u)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[C,c]}get type(){var t;return null!=(t=P.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?f`
            ...
            `:this.valid?f`
                ...
                ></sp-icon-checkmark100>
            `:h}get displayValue(){return this.value.toString()}get renderMultiline(){return f`
            ${this.grows&&!this.quiet?f`
            ...
            <textarea
                ...
                aria-invalid=${s(this.invalid||void 0)}
                class="input"
                maxlength=${s(this.maxlength>-1?this.maxlength:void 0)}
                minlength=${s(this.minlength>-1?this.minlength:void 0)}
        ...
        `}get renderInput(){return f`
            ...
            <input
                ...
                autocomplete=${s(this.autocomplete)}
            />
        `}renderField(){return f`
            ${this.renderStateIcons()}
            ${this.multiline?this.renderMultiline:this.renderInput}
        `}render(){return f`
            <div id="textfield">${this.renderField()}</div>
            ${this.renderHelpText(this.invalid)}
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t),t}}O([p({attribute:"allowed-keys"})],R.prototype,"allowedKeys",2),O([p({type:Boolean,reflect:!0})],R.prototype,"focused",2),O([d(".input")],R.prototype,"inputElement",2),O([p({type:Boolean,reflect:!0})],R.prototype,"invalid",2),O([p()],R.prototype,"label",2),O([p()],R.prototype,"placeholder",2),O([p({attribute:"type",reflect:!0})],R.prototype,"_type",2),O([b()],R.prototype,"type",1),O([p()],R.prototype,"pattern",2),O([p({type:Boolean,reflect:!0})],R.prototype,"grows",2),O([p({type:Number})],R.prototype,"maxlength",2),O([p({type:Number})],R.prototype,"minlength",2),O([p({type:Boolean,reflect:!0})],R.prototype,"multiline",2),O([p({type:Boolean,reflect:!0})],R.prototype,"readonly",2),O([p({type:Boolean,reflect:!0})],R.prototype,"valid",2),O([p({type:String})],R.prototype,"value",1),O([p({type:Boolean,reflect:!0})],R.prototype,"quiet",2),O([p({type:Boolean,reflect:!0})],R.prototype,"required",2),O([p({type:String,reflect:!0})],R.prototype,"autocomplete",2);class G extends R{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}O([p({type:String})],G.prototype,"value",1),customElements.define("sp-clear-button",H);var M=a`
...
`,N=Object.defineProperty,K=Object.getOwnPropertyDescriptor,V=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?K(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&N(e,o,l),l};const D=t=>t.stopPropagation();class Y extends G{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,M]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return f`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}V([p()],Y.prototype,"action",2),V([p()],Y.prototype,"label",2),V([p()],Y.prototype,"method",2),V([p()],Y.prototype,"placeholder",2),V([d("#form")],Y.prototype,"form",2),customElements.define("sp-search",Y);export{L as M,R as T,$ as a,G as b,y as c,B as m,g as r,z as s,b as t,k as u};
//# sourceMappingURL=74de37d5.js.map
