...
| ------------------ | --------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `emphasized`       | `boolean`                         | -          |                                                                                                                                                                                              |
| `hold-affordance`  | `boolean`                         | `false`    | Hold affordance is not included in the initial gen2 `swc-action-button` release. It is planned for a future phase. See the action-button migration plan for consumer options in the interim. |
| `quiet`            | `boolean`                         | `false`    |                                                                                                                                                                                              |
| `role`             | `string`                          | `'button'` |                                                                                                                                                                                              |
