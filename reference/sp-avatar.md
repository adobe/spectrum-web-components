...
An sp-avatar is a thumbnail representation of an entity, such as a user or an organization.
...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `src`            | `string`                                                                                                                                                                                                                            | `''`    |                                                                                                                                           |
| `is-decorative`  | `boolean`                                                                                                                                                                                                                           | `false` | When true, marks the avatar as decorative and hides it from screen readers. The underlying img will have an empty alt attribute (alt=""). |
| `size`           | `AvatarSize`                                                                                                                                                                                                                        | -       |                                                                                                                                           |
