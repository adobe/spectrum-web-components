import"./467876ed.js";import{R as t}from"./39665332.js";import{t as r}from"./e71a182c.js";import{i as e}from"./112b2095.js";import{S as o}from"./01b2daba.js";import{x as a}from"./e6d35ea0.js";import{n as i,S as s}from"./c34bcf8e.js";import{i as c}from"./17348440.js";import{d as n}from"./25a3ae37.js";import"./c1c64fc8.js";import"./7b83ff35.js";import{l as p}from"./660f0d27.js";var u=e`
...
)}:host:lang(ja),:host:lang(ko),:host:lang(zh){--spectrum-actionbar-item-counter-line-height-cjk:var(
--spectrum-cjk-line-height-100
)}:host{--spectrum-actionbar-popover-background-color:var(--spectrum-gray-50);--spectrum-actionbar-popover-border-color:var(--spectrum-gray-400);--spectrum-actionbar-emphasized-background-color:var(
...
);--spectrum-actionbar-spacing-item-counter-end:var(--spectrum-spacing-400);--spectrum-actionbar-spacing-action-group-top:var(--spectrum-spacing-100);--spectrum-actionbar-spacing-action-group-end:var(--spectrum-spacing-100);--spectrum-actionbar-shadow-horizontal:var(--spectrum-drop-shadow-x);--spectrum-actionbar-shadow-vertical:var(--spectrum-drop-shadow-y);--spectrum-actionbar-shadow-blur:var(--spectrum-drop-shadow-blur);--spectrum-actionbar-shadow-color:var(--spectrum-drop-shadow-color)}@media (forced-colors:active){:host,:host([emphasized]) #popover{--highcontrast-actionbar-popover-border-color:CanvasText}}:host{block-size:0;box-sizing:border-box;inset-block-end:0;opacity:0;padding:0 var(
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,z=(t,r,e,o)=>{for(var a,i=o>1?void 0:o?f(r,e):r,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(r,e,i):a(i))||i);return o&&i&&v(r,e,i),i};const x=["sticky","fixed"];class k extends s{constructor(){super(...arguments),this.emphasized=!1,this.flexible=!1,this.open=!1,this._variant=""}static get styles(){return[g]}set variant(t){if(t!==this.variant){if(x.includes(t))return this.setAttribute("variant",t),void(this._variant=t);this.removeAttribute("variant"),this._variant=""}}get variant(){return this._variant}handleClick(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0,composed:!0,cancelable:!0}))||(this.open=!0)}render(){return a`
        ...
        `}}z([i({type:Boolean,reflect:!0})],k.prototype,"emphasized",2),z([i({type:Boolean,reflect:!0})],k.prototype,"flexible",2),z([i({type:Boolean,reflect:!0})],k.prototype,"open",2),z([i({type:String})],k.prototype,"variant",1),n("sp-action-bar",k);
//# sourceMappingURL=386e5d2e.js.map
