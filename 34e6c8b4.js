...
`;const C=async(t,o,e,r)=>{const{Overlay:i}=await import("./93526eee.js");return i.open(t,o,e,r)};class T extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var q=o`
...
`,xt=Object.defineProperty,yt=Object.getOwnPropertyDescriptor;const wt={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class zt extends(c(k)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,kt,x]}get buttonContent(){return[wt[this.size]()]}}((t,o,e,r)=>{for(var i,a=r>1?void 0:r?yt(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);r&&a&&xt(o,e,a)})([d({reflect:!0})],zt.prototype,"variant",2);var It=o`
...
`,Ft=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,Pt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?jt(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&Ft(o,e,a),a};class Lt extends(e(r)){static get styles(){return[Bt]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}Pt([a("#anchor")],Lt.prototype,"anchorElement",2),Pt([d({type:String,reflect:!0})],Lt.prototype,"variant",2),Pt([d({type:String,reflect:!0})],Lt.prototype,"static",2),customElements.define("sp-link",Lt);var Rt=o`
...
`,Ot=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor;class Mt extends(c(m,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Mt.styles=[Rt],((t,o,e,r)=>{for(var i,a=r>1?void 0:r?Dt(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);r&&a&&Ot(o,e,a)})([d({type:Boolean,reflect:!0})],Mt.prototype,"vertical",2),customElements.define("sp-divider",Mt),customElements.define("sp-close-button",zt);var _t=o`
...
`,Ht=Object.defineProperty,$t=Object.getOwnPropertyDescriptor,Gt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?$t(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&Ht(o,e,a),a};const Kt=["negative","positive","info","error","warning"];class Wt extends m{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[_t]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;Kt.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}Gt([d({type:Boolean,reflect:!0})],Wt.prototype,"open",2),Gt([d({type:Number})],Wt.prototype,"timeout",1),Gt([d({type:String})],Wt.prototype,"variant",1),customElements.define("sp-toast",Wt);export{V as D,Y as I,H as M,dt as P,w as a,I as f,Q as h,C as o,Rt as r};
//# sourceMappingURL=34e6c8b4.js.map
