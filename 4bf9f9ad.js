import"./0a79beae.js";import{i as e}from"./112b2095.js";import{c as t,a as i}from"./eb03f57e.js";import{E as s,e as l}from"./d11544d8.js";import{S as a}from"./d611ff6d.js";import{x as r,A as o,n,S as d,d as c}from"./1a13da4f.js";import{i as p}from"./357ae97e.js";var m=e`
...
`,h=Object.defineProperty,b=Object.getOwnPropertyDescriptor,g=(e,t,i,s)=>{for(var l,a=s>1?void 0:s?b(t,i):t,r=e.length-1;r>=0;r--)(l=e[r])&&(a=(s?l(t,i,a):l(a))||a);return s&&a&&h(t,i,a),a};const f=class e extends(a(d,{noDefaultSize:!0})){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new s(this)}static get styles(){return[u,m]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),l=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():l&&l.forceFocusVisible&&l.forceFocusVisible()}applyTargetLabel(e){if(this.target=e||this.target,this.target){const s=this.target.applyFocusElementLabel,l=this.target.focusElement||this.target,a=l.getRootNode();void 0!==s?s(this.labelText):a===this.getRootNode()?(e?t:i)(l,"aria-labelledby",[this.id]):e?l.setAttribute("aria-label",this.labelText):l.removeAttribute("aria-label")}}async manageTarget(){this.applyTargetLabel();const e=this.resolvedElement.element;e?(e.localName.search("-")>0&&await customElements.whenDefined(e.localName),void 0!==e.updateComplete&&await e.updateComplete,this.applyTargetLabel(e)):this.target=e}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});return e.length?e.map((e=>(e.textContent||"").trim())).join(" "):""}render(){return r`
            <label>
                <slot></slot>
                ${this.required?r`
                          <sp-icon-asterisk100
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}willUpdate(t){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${e.instanceCount++}`),t.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(t.has("id")||t.has(l))&&this.manageTarget()}};f.instanceCount=0,g([n({type:Boolean,reflect:!0})],f.prototype,"disabled",2),g([n({type:String})],f.prototype,"id",2),g([n({type:String})],f.prototype,"for",2),g([n({type:Boolean,reflect:!0})],f.prototype,"required",2),g([p("slot")],f.prototype,"slotEl",2),g([n({type:String,reflect:!0,attribute:"side-aligned"})],f.prototype,"sideAligned",2),c("sp-field-label",f);
//# sourceMappingURL=4bf9f9ad.js.map
