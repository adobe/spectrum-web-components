import{r as e}from"./swc.f7oE2UwA.js";import{a as t}from"./swc.haa-xH29.js";import{L as s}from"./swc.BGdYMncg.js";import"./swc.BQ54snsm.js";import{i as r}from"./swc.B2saYisL.js";import{o as i}from"./swc.CdTegbbx.js";import{E as a,x as o,S as n}from"./swc.DSXIulaT.js";import{n as c}from"./swc.CR9wLW4f.js";import"./swc.CbvVXNf8.js";import{d as l}from"./swc.JlveB6nj.js";import{S as u}from"./swc.mUX8iMJZ.js";import{O as d}from"./swc.D7uR5Amg.js";import{O as m}from"./swc.qS9jsU8x.js";import"./swc.B0DL9dgI.js";import"./swc.GDDU0x82.js";import{E as b,D as p}from"./swc.xq6yEfiO.js";import{S as h}from"./swc.Csv0MQ_2.js";import{o as v}from"./swc.CCsQlnyV.js";import{r as g}from"./swc.q_JBUTha.js";import"./swc.ClnDu1qc.js";import{f}from"./swc.CzjL5hPf.js";import{e as y}from"./swc.CjPt0-_4.js";import{o as k}from"./swc.DB8lrnSl.js";import{e as w}from"./swc.CmcGy_P4.js";class x{}const $=new WeakMap,I=y(class extends f{render(e){return a}update(e,[t]){const s=t!==this.G;return s&&void 0!==this.G&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),a}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){const t=this.ht??globalThis;let s=$.get(t);void 0===s&&(s=new WeakMap,$.set(t,s)),void 0!==s.get(this.G)&&this.G.call(this.ht,void 0),s.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?$.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),C=r`
...
`;var E=Object.defineProperty,S=(e,t,s,r)=>{for(var i,a=void 0,o=e.length-1;o>=0;o--)(i=e[o])&&(a=i(t,s,a)||a);return a&&E(t,s,a),a};class z extends(s(t)){constructor(){super(...arguments),this.value=void 0,this.isLastOfType=!1}static get styles(){return[C,e]}get focusElement(){return this.shadowRoot.querySelector("#item-link")}connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","listitem")}announceSelected(e){const t=new CustomEvent("breadcrumb-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}handleClick(e){!this.href&&e&&e.preventDefault(),(!this.href||null!=e&&e.defaultPrevented)&&this.value&&!this.isLastOfType&&this.announceSelected(this.value)}handleKeyDown(e){("Enter"===e.key||13===e.keyCode)&&this.handleClick(e)}renderLink(){return o`
      <a
        id="item-link"
...
`;var j=Object.defineProperty,O=Object.getOwnPropertyDescriptor,L=(e,t,s,r)=>{for(var i,a=r>1?void 0:r?O(t,s):t,o=e.length-1;o>=0;o--)(i=e[o])&&(a=(r?i(t,s,a):i(a))||a);return r&&a&&j(t,s,a),a};class A extends(d(m(h(b,{noDefaultSize:!0}),"label"),'[slot="label-only"]')){constructor(){super(...arguments),this.selects=void 0,this.deprecatedMenu=null,this.invalid=!1,this.pendingLabel="Pending",this.quiet=!1,this.value="",this.listRole="menu",this.itemRole="menuitem",this.handleEscape=e=>{"Escape"===e.key&&this.open&&(e.stopPropagation(),e.preventDefault(),this.toggle(!1))},this.handleKeydown=e=>{if(this.focused=!0,["ArrowUp","ArrowDown","Enter"," ","Escape"].includes(e.key)){if("Escape"===e.key)return void this.handleEscape(e);e.stopPropagation(),e.preventDefault(),this.keyboardOpen()}},this.applyFocusElementLabel=(e,t)=>{this.appliedLabel=e,this.labelAlignment=t.sideAligned?"inline":void 0},this.hasRenderedOverlay=!1,this.willManageSelection=!1,this.selectionPromise=Promise.resolve(),this.recentlyConnected=!1,this.enterKeydownOn=null,this.handleEnterKeydown=e=>{if("Enter"!==e.key)return;const t=null==e?void 0:e.target;t.open||!t.hasSubmenu?this.enterKeydownOn?e.preventDefault():(this.enterKeydownOn=e.target,this.addEventListener("keyup",async e=>{"Enter"===e.key&&(this.enterKeydownOn=null)},{once:!0})):e.preventDefault()},this.handleSlottableRequest=e=>{this.dispatchEvent(new u(e.name,e.data))}}static get styles(){return[M]}get menuItems(){return this.optionsMenu.childItems}get selfManageFocusElement(){return!0}get selectedItem(){return this._selectedItem}forceFocusVisible(){this.disabled||(this.focused=!0)}click(){this.toggle()}handleButtonClick(){this.disabled||this.toggle()}handleButtonBlur(){this.focused=!1}handleHelperFocus(){this.focused=!0,this.button.focus()}handleFocus(){!this.disabled&&this.focusElement&&(this.focused=this.hasVisibleFocusInTree())}handleChange(e){this.strategy&&(this.strategy.preventNextToggle="no");const t=e.target,[s]=t.selectedItems;e.stopPropagation(),e.cancelable?this.setValueFromItem(s,e):(this.open=!1,this.strategy&&(this.strategy.open=!1))}handleButtonFocus(e){var t;null==(t=this.strategy)||t.handleButtonFocus(e)}async keyboardOpen(){var e;this.open&&this.strategy.open?null==(e=this.optionsMenu)||e.focusOnFirstSelectedItem():(this.addEventListener("sp-opened",()=>{var e;return null==(e=this.optionsMenu)?void 0:e.focusOnFirstSelectedItem()},{once:!0}),this.toggle(!0))}async setValueFromItem(e,t){var s;this.open=!1;const r=this.selectedItem,i=this.value;return this.selectedItem=e,this.value=null!=(s=null==e?void 0:e.value)?s:"",await this.updateComplete,!this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))&&this.selects?(t&&t.preventDefault(),this.setMenuItemSelected(this.selectedItem,!1),r&&this.setMenuItemSelected(r,!0),this.selectedItem=r,this.value=i,this.open=!0,void(this.strategy&&(this.strategy.open=!0))):this.selects?(r&&this.setMenuItemSelected(r,!1),void this.setMenuItemSelected(e,!!this.selects)):(this.selectedItem=r,void(this.value=i))}setMenuItemSelected(e,t){null!=this.selects&&(e.selected=t)}get containerStyles(){return this.isMobile.matches?{"--swc-menu-width":"100%"}:{}}get selectedItemContent(){return this._selectedItemContent||{icon:[],content:[]}}set selectedItemContent(e){if(e===this.selectedItemContent)return;const t=this.selectedItemContent;this._selectedItemContent=e,this.requestUpdate("selectedItemContent",t)}handleTooltipSlotchange(e){const t=e.target.assignedElements()[0];this.tooltipEl=t,null!=t&&t.selfManaged&&(this.button&&(t.triggerElement=this.button),this.updateComplete.then(()=>{t.selfManaged&&this.button&&(t.triggerElement=this.button)}))}renderLabelContent(e){return this.value&&this.selectedItem?e:o`
    ...
    `}get buttonContent(){return[o`
      ...
      `]}hasAccessibleLabel(){return!!this.label||!!this.getAttribute("aria-label")||!!this.getAttribute("aria-labelledby")||!!this.appliedLabel||this.hasLabel||this.labelOnly}warnNoLabel(){}renderOverlay(e){var t;const s=this.renderContainer(e);return this.dependencyManager.add("sp-overlay"),import("./swc.COD0Mgfm.js"),o`
      <sp-overlay
    ...
    `;return this.isMobile.matches&&!this.forcePopover?(this.dependencyManager.add("sp-tray"),import("./swc.Kt_TeCOY.js"),o`
        <sp-tray
          id="popover"
          role="presentation"
      ...
      `):(this.dependencyManager.add("sp-popover"),import("./swc.eGkLtExC.js").then(function(e){return e.s}),o`
      <sp-popover
        id="popover"
        role="presentation"
        style=${v(this.containerStyles)}
