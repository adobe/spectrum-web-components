...
[CONTRIBUTOR-DOCS](../README.md) / [Get started](README.md) / Customization cheatsheet
...
For a gentler introduction, start with [Get started (for consumers)](for-consumers.md). Deep-dive topics link out from each section below.
