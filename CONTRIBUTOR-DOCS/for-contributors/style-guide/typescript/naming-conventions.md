...
[CONTRIBUTOR-DOCS](../../../README.md) / [Contributor guides](../../README.md) / [Style guide](../README.md) / [2nd-gen TypeScript](README.md) / Naming conventions
...
The one exception for underscores is backing fields that pair with a custom getter/setter (see [Property patterns](./property-patterns.md#backing-fields)).
...
See [Component types](./component-types.md#type-names) for detailed naming and suffixing rules.
...
See [Component types](./component-types.md#constant-prefixes) for the full prefix rules.
...
If existing code uses merged prefixes, rename to the underscore-separated form (see [Component types](./component-types.md#constant-prefixes)).
