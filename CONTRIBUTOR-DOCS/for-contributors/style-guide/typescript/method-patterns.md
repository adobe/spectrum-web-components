...
Within the [IMPLEMENTATION section](class-structure.md#section-implementation) of a base class, or the [RENDERING & STYLING section](class-structure.md#section-rendering-and-styling) of a concrete class, order methods by access level:
