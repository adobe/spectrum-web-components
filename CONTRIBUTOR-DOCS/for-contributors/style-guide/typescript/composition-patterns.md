...
[CONTRIBUTOR-DOCS](../../../README.md) / [Contributor guides](../../README.md) / [Style guide](../README.md) / [2nd-gen TypeScript](README.md) / Composition patterns
...
Components should have a maximum mixin depth of 2. If more behavior is needed, use controllers instead of additional mixins. See [Mixin composition](mixin-composition.md#mixin-depth-limit) for the rationale.
...
- **[Mixin composition](mixin-composition.md)** — How to compose mixins, ordering, options, and patterns
- **[Controller composition](controller-composition.md)** — How to create and attach controllers
- **[Directive composition](directive-composition.md)** — How to use built-in directives and author custom ones
- **[Interface composition](interface-composition.md)** — When to use interfaces and how to define them
