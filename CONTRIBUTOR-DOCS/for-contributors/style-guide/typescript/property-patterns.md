...
[CONTRIBUTOR-DOCS](../../../README.md) / [Contributor guides](../../README.md) / [Style guide](../README.md) / [2nd-gen TypeScript](README.md) / Property patterns
...
Within each [class section](class-structure.md), order properties by access level:
...
Use the `@property()` decorator for properties that are part of the component's public API. See [Lit decorators](lit-decorators.md) for full decorator options.
