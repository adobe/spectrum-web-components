...
[CONTRIBUTOR-DOCS](../../../README.md) / [Contributor guides](../../README.md) / [Style guide](../README.md) / [Testing guide](README.md) / Testing overview
...
Every `'!test'` story is a blind spot across all three test layers. Add a comment explaining the reason when you apply the tag, and add a corresponding test story with a custom render (see [Testing static color variants](./storybook-testing.md#testing-static-color-variants)) to restore behavioral coverage.
