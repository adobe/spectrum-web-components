...
[CONTRIBUTOR-DOCS](../../../README.md) / [Contributor guides](../../README.md) / [Style guide](../README.md) / [Testing guide](README.md) / Visual regression testing
...
Stories tagged with `'!test'` are excluded from VRT runs. See [Excluding stories from tests](./testing-overview.md#excluding-stories-from-tests) for when and why to use this tag.
