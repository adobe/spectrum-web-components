...
For the full technical rationale, see the [Focus Management Strategy RFC](../project-planning/05_strategies/focus-management-strategy-rfc.md).
...
- [Focus Management Strategy RFC](../project-planning/05_strategies/focus-management-strategy-rfc.md) — Full technical rationale
...
- [Accessibility Testing Guide](./running-accessibility-tests.md) — Automated and manual a11y testing
