...
[CONTRIBUTOR-DOCS](../../README.md) / [Project planning](../README.md) / [Research](README.md) / Full pattern research: 1st-gen vs 2nd-gen
...
- [Full pattern research: 1st-gen vs 2nd-gen](#full-pattern-research-1st-gen-vs-2nd-gen)
...
| Aspect | 1st-gen | 2nd-gen |
|--------|---------|---------|
| Role assignment | Mixed (some unconditional, some check existing) | Evolving toward conditional check-before-set |
...
7. **Role assignment** — always check for existing role before setting
