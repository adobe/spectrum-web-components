...
This file is a **placeholder** for **`swc-tabs`**, **`swc-tab`**, **`swc-tab-panel`**, and related **2nd-gen** rendering, CSS, and DOM migration planning. Until it is expanded, treat **`gen1/packages/tabs`** (`<sp-tabs>`, `<sp-tab>`, `<sp-tab-panel>`) as the reference.
