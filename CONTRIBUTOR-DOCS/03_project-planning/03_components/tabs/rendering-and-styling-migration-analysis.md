...
This file is a **placeholder** for **`swc-tabs`**, **`swc-tab`**, **`swc-tab-panel`**, and related **gen2** rendering, CSS, and DOM migration planning. Until it is expanded, treat **`1st-gen/packages/tabs`** (`<sp-tabs>`, `<sp-tab>`, `<sp-tab-panel>`) as the reference.
