...
[CONTRIBUTOR-DOCS](../../../README.md) / [Project planning](../../README.md) / [Components](../README.md) / Action Button / Action button migration roadmap
...
- [gen2 planning (API and consumer docs)](#gen2-planning-api-and-consumer-docs)
...
| ------------- | -------------- | --------------------------------------------- |
| `toggles`     | N/A            | 1st-gen only; gen2 uses **`swc-toggle-button`** / **`swc-toggle-button-group`** ([React Spectrum: ToggleButton](https://react-spectrum.adobe.com/ToggleButton), [ToggleButtonGroup](https://react-spectrum.adobe.com/ToggleButtonGroup)) |
