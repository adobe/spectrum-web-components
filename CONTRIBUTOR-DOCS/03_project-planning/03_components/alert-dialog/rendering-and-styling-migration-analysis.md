...
[CONTRIBUTOR-DOCS](../../../README.md) / [Project planning](../../README.md) / [Components](../README.md) / Alert Dialog / Alert Dialog migration roadmap
...
- [Key Structural Changes](#key-structural-changes)
    ...
    - [Action Items for Web Component Maintainers](#action-items-for-web-component-maintainers)
