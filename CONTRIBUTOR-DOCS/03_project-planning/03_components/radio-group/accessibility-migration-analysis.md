...
- [Forms Strategy: gen2 Proposal](../../05_strategies/forms-strategy-rfc.md), specifically the "grouped selection" row of its [naming table](../../05_strategies/forms-strategy-rfc.md#4-naming-table) and its [open questions](../../05_strategies/forms-strategy-rfc.md#6-open-questions) on the `RadioGroupController` decision.
...
Use [`FocusgroupNavigationController`](../../../../gen2/packages/core/controllers/focusgroup-navigation-controller/focusgroup-navigation-controller.mdx) (`direction: 'both'`, `wrap: true`, `skipDisabled: true`) for the movement mechanics, and confirm (per the note in [First-gen keyboard model](#first-gen-sp-radio-group-keyboard-model)) that the select-on-arrow-move vs. no-select-on-Tab-entry split is preserved when wiring it up. When read-only, keep all of the above focus/Tab behavior; suppress only the "also checks it" half of `Space`, arrow movement, Home, and End.
...
- [Forms Strategy: gen2 Proposal (this repo)](../../05_strategies/forms-strategy-rfc.md), specifically the [naming table](../../05_strategies/forms-strategy-rfc.md#4-naming-table) and [open questions](../../05_strategies/forms-strategy-rfc.md#6-open-questions).
...
- [`LiveSelectionController` (this repo)](../../../../gen2/packages/core/controllers/live-selection-controller/live-selection-controller.mdx): documents why it is the wrong fit for radio groups
- [`FocusgroupNavigationController` (this repo)](../../../../gen2/packages/core/controllers/focusgroup-navigation-controller/focusgroup-navigation-controller.mdx)
- [`SlotAttributePropagationController` (this repo)](../../../../gen2/packages/core/controllers/slot-attribute-propagation-controller/slot-attribute-propagation-controller.mdx)
