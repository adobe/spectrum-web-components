...
- The [`LiveSelectionController`](../../../../2nd-gen/packages/core/controllers/live-selection-controller/live-selection-controller.mdx) — driven by the *parent* listbox/combobox over a set of `swc-option` children, not by the option itself. A roving-`tabindex` standalone listbox may additionally use the [`FocusgroupNavigationController`](../../../../2nd-gen/packages/core/controllers/focusgroup-navigation-controller/focusgroup-navigation-controller.mdx), but the active-descendant combobox does **not** — it manages the active option without moving DOM focus.
