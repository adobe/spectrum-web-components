...
```326:344:../../../../gen1/packages/tooltip/src/Tooltip.ts
    if (this.selfManaged) {
...
| --- | --- |
| Headings, static text strips, grouped fields the user taps “help” beside, richer copy or links inside the panel | [Spectrum Contextual help](https://spectrum.adobe.com/page/contextual-help/), [`sp-contextual-help`](../../../../gen1/packages/contextual-help/README.md), [React Spectrum ContextualHelp](https://react-spectrum.adobe.com/ContextualHelp) vs [Tooltip](https://react-spectrum.adobe.com/Tooltip) (non-interactive layouts) |
