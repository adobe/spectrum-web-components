...
- [Menu separator accessibility migration analysis](../menu-separator/accessibility-migration-analysis.md) for **`swc-menu-separator`** (**`separator`** between rows—not a **`menuitem`**).
