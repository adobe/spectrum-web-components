...
- gen1: [`sp-menu`](../../../../gen1/packages/menu/README.md) — list or listbox container used inside overlay, **`sp-popover`**, picker, or **`<sp-action-menu>`**, with **varying** wiring per host; 2nd-gen **`swc-menu`** and **`swc-action-menu`** each ship a cohesive [menu-button](https://www.w3.org/WAI/ARIA/apg/patterns/menu-button/) on the import (see the a11y doc).
