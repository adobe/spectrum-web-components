...
- [Recommendations: `<swc-avatar href="…">` (linked variant)](#recommendations-swc-avatar-href-linked-variant)
    - [ARIA roles, states, and properties](#aria-roles-states-and-properties-1)
    - [Accessibility tree expectations](#accessibility-tree-expectations-1)
    - [Keyboard and focus](#keyboard-and-focus-1)
