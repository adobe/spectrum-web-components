...
| `SizedMixin` from `@spectrum-web-components/base`          | `@spectrum-web-components/core/mixins/index.js`                                                            | Available (applied inside `ProgressBarBase` exactly as in `MeterBase`)                                                                       |
| `LanguageResolutionController` from `reactive-controllers` | `@spectrum-web-components/core/controllers/language-resolution.js`                                         | Available — already wired inside `LinearProgressMixin`                                                                                       |
