...
| `size` | `'s' \| 'm' \| 'l'` | `'m'` | `size` | **New.**  `m` is the implicit base style `s` and `l` override via `:host([size="s"])` / `:host([size="l"])` attribute selectors per [selector conventions](../../../for-contributors/style-guide/css/custom-properties.md#selector-conventions). |
...
> Follow the [CSS style guide](../../../for-contributors/style-guide/css) as the source of truth for all styling work. Key references: [migration steps](../../../for-contributors/style-guide/css/spectrum-swc-migration.md), [custom properties](../../../for-contributors/style-guide/css/custom-properties.md), [anti-patterns](../../../for-contributors/style-guide/css/anti-patterns.md).
...
- [ ] Update class and custom property prefixes from `.spectrum-` to `.swc-`; remove all `--mod-*` and `--spectrum-*` chains per [Component Custom Property Exposure](../../../for-contributors/style-guide/css/custom-properties.md#component-custom-property-exposure)
...
- [ ] Check all styling decisions against the [CSS style guide](../../../for-contributors/style-guide/css) before opening PR
...
- [CSS style guide — Component Custom Property Exposure](../../../for-contributors/style-guide/css/custom-properties.md#component-custom-property-exposure)
- [CSS style guide — Selector conventions](../../../for-contributors/style-guide/css/custom-properties.md#selector-conventions)
