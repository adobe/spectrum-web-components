...
| # | What is added | Notes |
|---|---|---|
| **A1** | Documented `--swc-accordion-*` (if justified) | Per [component custom property exposure](../../../../CONTRIBUTOR-DOCS/for-contributors/style-guide/css/custom-properties.md#component-custom-property-exposure); do not recreate full `--mod-*` matrix. |
