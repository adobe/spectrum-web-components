...
[CONTRIBUTOR-DOCS](../../../README.md) / [Project planning](../../README.md) / [Components](../README.md) / Color Field / Color field migration roadmap
...
- [DOM structure](#dom-structure)
    - [SWC DOM structure](#swc-dom-structure)
- [Summary of changes](#summary-of-changes)
    - [Inherited from TextfieldBase](#inherited-from-textfieldbase)
- [Resources](#resources)
