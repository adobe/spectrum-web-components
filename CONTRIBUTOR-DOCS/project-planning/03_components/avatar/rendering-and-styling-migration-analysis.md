...
**Linked** avatars (hyperlink affordance) use a **separate** **component**: **`swc-avatar-link`** (see [Avatar — linked variant (`swc-avatar-link`)](./accessibility-migration-analysis.md#the-linked-variant-avatar-link)).
...
- [Avatar — linked variant (`swc-avatar-link`)](./accessibility-migration-analysis.md#the-linked-variant-avatar-link) for **`href`**, keyboard, and link naming.
...
- [ ] **`swc-avatar-link`** owns linked cases; cross-link [Avatar — linked variant (`swc-avatar-link`)](./accessibility-migration-analysis.md#the-linked-variant-avatar-link) from Storybook.
...
- [Avatar — linked variant (`swc-avatar-link`)](./accessibility-migration-analysis.md#the-linked-variant-avatar-link)
