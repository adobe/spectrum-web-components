...
2. **Use tokens** — Replace hard-coded values with `token(...)`. Follow [component CSS](../../../../for-contributors/style-guide/css/component-css.md) and [custom properties](../../../../for-contributors/style-guide/css/custom-properties.md).
...
1. **Follow the [Accessibility testing](https://github.com/adobe/spectrum-web-components/blob/main/CONTRIBUTOR-DOCS/for-contributors/accessibility-testing.md) guide** and the PR template checklist.
...
Follow the two-file layout (`test/<component>.test.ts`, `test/<component>.a11y.spec.ts`). See the [2nd gen testing conventions](../../../../for-contributors/2ndgen-testing.md) and reference implementations in `link/test/`, `checkbox/test/`, `badge/test/`, etc.
...
- [ ] Tests follow the project [testing conventions](../../../../for-contributors/2ndgen-testing.md) (Ticket 10).
...
- **Testing:** [2nd gen testing conventions](../../../../for-contributors/2ndgen-testing.md)
