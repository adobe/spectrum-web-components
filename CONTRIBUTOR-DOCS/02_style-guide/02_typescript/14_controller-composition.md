...
2. Handles Arrow keys, Home, and End for horizontal, vertical, or grid layouts; in **grid** mode, Ctrl+Home / Ctrl+End jump to the first cell of the first row or the last cell of the last row.
