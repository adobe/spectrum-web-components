...
2. Handles Arrow keys, Home, and End for horizontal, vertical, or grid layouts.
...
**Docs:** See `core/controllers/focus-group-navigation-controller.md` and Storybook **Controllers / Focus group navigation controller**.
