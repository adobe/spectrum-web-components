import{F as t,R as e}from"./a37f886d.js";import{i as r}from"./112b2095.js";import{S as o,l as a}from"./f14b85e2.js";import{x as i,n as s,S as c,d as n,A as l,s as d,b as u}from"./83ab71e7.js";import{o as p,F as h,t as m,i as b,l as v,O as g,L as f,a as k}from"./2f4b5165.js";import"./b52ffe16.js";import{b as w}from"./1259c022.js";import{n as y,b as z}from"./d2a64f97.js";import"./618c3e06.js";import"./3e4e49b2.js";import"./eb7ebe8b.js";import"./32f7823b.js";import{O as x}from"./79fab450.js";import"./3de4b085.js";import{D as C,P as $}from"./d6169aa5.js";import{t as S}from"./8f04a507.js";import{A as P}from"./260c22a0.js";import{M as B,T as D,a as L}from"./912413f1.js";import{c as j,e as E,C as M}from"./65422167.js";import{s as A}from"./fd1e6220.js";import{h as H}from"./c8cbc19e.js";import{o as F,t as T}from"./830f4e22.js";import{e as I}from"./16ab2288.js";import{i as q,a as O,b as _}from"./8a240776.js";import"./02711918.js";import{v as R}from"./d11dda6b.js";import{f as N}from"./27e6a3fc.js";import{I as U}from"./4ac6c9a3.js";import"./b9ffab03.js";import"./2b152716.js";import{B as V}from"./7d701b0a.js";import{o as G}from"./9078dc5c.js";import{S as K}from"./568a3260.js";import{o as X}from"./b54d57d0.js";import{g as W}from"./0d4ca45b.js";import{s as Y}from"./ff8e484a.js";import"./a69cf5f7.js";import"./54559c29.js";import"./7cb0eb18.js";import"./9b11dd4f.js";import"./44ed3efc.js";import"./b7cfd405.js";import"./d6d0b127.js";import"./9d72e6d1.js";import"./9ddc847e.js";import"./50d0e983.js";import"./2465ac4c.js";import"./cebcf45e.js";import"./d11544d8.js";import"./c14ac009.js";import"./c15eb8ed.js";import"./7d97cb09.js";import"./4a4b0658.js";import"./60c32f15.js";import"./9f9c5c08.js";import"./2ab79dcb.js";import"./c2d947e7.js";import"./a14c7ee0.js";import"./6c2bcac1.js";const Z=(t,e)=>{if(t)return null;const r=e.assignedNodes().reduce(((t,e)=>e.textContent?t+e.textContent:t),"");return r?r.trim():null};var J=r`
...
`,fa=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,wa=(t,e,r,o)=>{for(var a,i=o>1?void 0:o?ka(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);return o&&i&&fa(e,r,i),i};class ya extends(o(c,{noDefaultSize:!0})){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[ga]}render(){return i`
            <slot></slot>
        `}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}wa([s({type:Boolean,reflect:!0})],ya.prototype,"disabled",2),wa([s({reflect:!0})],ya.prototype,"variant",2),n("sp-status-light",ya);class za extends(M(h)){get focusElement(){return this.inputElement}}var xa=r`
...
`,$a=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor;class Pa extends(o(za)){constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[xa,Ca]:[xa]}render(){return i`
            ${super.render()}
            <span id="switch"></span>
            <label id="label" for="input"><slot></slot></label>
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("role","switch")}updated(t){t.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}((t,e,r,o)=>{for(var a,i=o>1?void 0:o?Sa(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);o&&i&&$a(e,r,i)})([s({type:Boolean,reflect:!0})],Pa.prototype,"emphasized",2),n("sp-switch",Pa);var Ba=r`
...
`,Da=Object.defineProperty,La=Object.getOwnPropertyDescriptor,ja=(t,e,r,o)=>{for(var a,i=o>1?void 0:o?La(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);return o&&i&&Da(e,r,i),i};class Ea extends(o(c)){constructor(){super(),this.compact=!1,this.overflowState={canScrollLeft:!1,canScrollRight:!1},this.resizeController=new Y(this,{target:this,callback:()=>{this._updateScrollState()}})}static get styles(){return[w,Ba,W]}firstUpdated(t){super.firstUpdated(t);const[e]=this.scrollContent;e&&(e.enableTabsScroll=!0),this.resizeController.observe(this.overflowContainer)}async _handleSlotChange(){const[t]=this.scrollContent;await(null==t?void 0:t.updateComplete),this._updateScrollState()}_updateScrollState(){const{scrollContent:t,overflowState:e}=this;if(t){const[t]=this.scrollContent,{canScrollLeft:r,canScrollRight:o}=(null==t?void 0:t.scrollState)||{canScrollLeft:!1,canScrollRight:!1};this.overflowState={...e,canScrollLeft:r,canScrollRight:o}}}_handleScrollClick(t){const e=t.currentTarget,[r]=this.scrollContent,o=.5*r.clientWidth,a=e.classList.contains("left-scroll")?-o:o;r.scrollTabs(a,"smooth")}updated(t){super.updated(t),t.has("dir")&&this._updateScrollState()}render(){const{canScrollRight:t,canScrollLeft:e}=this.overflowState;return i`
        ...
        `}}ja([s({type:Boolean,reflect:!0})],Ea.prototype,"compact",2),ja([s({reflect:!0})],Ea.prototype,"dir",2),ja([S()],Ea.prototype,"overflowState",2),ja([a({selector:"sp-tabs",flatten:!0})],Ea.prototype,"scrollContent",2),ja([b(".tabs-overflow-container")],Ea.prototype,"overflowContainer",2),n("sp-tabs-overflow",Ea);var Ma=r`
...
`,Aa=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,Fa=(t,e,r,o)=>{for(var a,i=o>1?void 0:o?Ha(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);return o&&i&&Aa(e,r,i),i};class Ta extends(o(c,{validSizes:["s","m","l"],noDefaultSize:!0})){constructor(){super(),this.deletable=!1,this.disabled=!1,this.readonly=!1,this.handleFocusin=()=>{this.addEventListener("focusout",this.handleFocusout),this.addEventListener("keydown",this.handleKeydown)},this.handleFocusout=()=>{this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.handleFocusout)},this.handleKeydown=t=>{if(!this.deletable||this.disabled)return;const{code:e}=t;switch(e){case"Backspace":case"Space":case"Delete":this.delete();default:return}},this.addEventListener("focusin",this.handleFocusin)}static get styles(){return[Ma]}delete(){this.readonly||!this.dispatchEvent(new Event("delete",{bubbles:!0,cancelable:!0,composed:!0}))||this.remove()}render(){return i`
            ...
            ${this.deletable?i`
                      ...
                      ></sp-clear-button>
                  `:l}
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","listitem"),this.deletable&&this.setAttribute("tabindex","0")}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}Fa([s({type:Boolean,reflect:!0})],Ta.prototype,"deletable",2),Fa([s({type:Boolean,reflect:!0})],Ta.prototype,"disabled",2),Fa([s({type:Boolean,reflect:!0})],Ta.prototype,"readonly",2),n("sp-tag",Ta);var Ia=r`
...
`,qa=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor;class _a extends(k(c)){constructor(){super(),this.rovingTabindexController=new e(this,{focusInIndex:t=>t.findIndex((t=>!t.disabled&&t.deletable)),elements:()=>this.tags,isFocusableElement:t=>!t.disabled&&t.deletable}),this.handleFocusin=()=>{this.addEventListener("focusout",this.handleFocusout),this.addEventListener("keydown",this.handleKeydown)},this.handleKeydown=t=>{const{code:e}=t;if("PageUp"!==e&&"PageDown"!==e)return;const r=(t,e)=>t[(t.length+e)%t.length],o=[...this.getRootNode().querySelectorAll("sp-tags")];if(o.length<2)return;t.preventDefault();const a="PageUp"===e?-1:1;let i=o.indexOf(this)+a,s=r(o,i);for(;!s.tags.length;)i+=a,s=r(o,i);s.focus()},this.handleFocusout=()=>{this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.handleFocusout)},this.addEventListener("focusin",this.handleFocusin)}static get styles(){return[Ia]}get tags(){return this.defaultNodes.filter((t=>t instanceof Ta))}focus(){this.rovingTabindexController.focus()}handleSlotchange(){this.rovingTabindexController.clearElementCache()}render(){return i`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}firstUpdated(){this.hasAttribute("role")||this.setAttribute("role","list"),this.hasAttribute("aria-label")||this.setAttribute("aria-label","Tags")}}((t,e,r,o)=>{for(var a,i=o>1?void 0:o?Oa(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);o&&i&&qa(e,r,i)})([p()],_a.prototype,"defaultNodes",2),n("sp-tags",_a),n("sp-textfield",L);var Ra=r`
...
`,Na=Object.defineProperty,Ua=Object.getOwnPropertyDescriptor,Va=(t,e,r,o)=>{for(var a,i=o>1?void 0:o?Ua(e,r):e,s=t.length-1;s>=0;s--)(a=t[s])&&(i=(o?a(e,r,i):a(i))||i);return o&&i&&Na(e,r,i),i};const Ga=["50","75","100","200","300","400","500","600","700","800","900","1000"],Ka=Ga[6];class Xa extends c{constructor(){super(...arguments),this.cover=!1,this.layer=!1,this._size=Ka}static get styles(){return[z,Ra]}get size(){return this._size}set size(t){["xxs","xs","s","m","l"].includes(t)&&(t={xxs:"100",xs:"300",s:"500",m:"700",l:"900"}[t]);const e=Ga.includes(t)?t:Ka;if(e&&this.setAttribute("size",`${e}`),this._size===e)return;const r=this._size;this._size=e,this.requestUpdate("size",r)}update(t){this.hasAttribute("size")||this.setAttribute("size",this.size),super.update(t)}render(){return this.background?i`
                <div
            ...
            `}}Va([s({type:String,reflect:!0})],Xa.prototype,"background",2),Va([s({type:Boolean,reflect:!0})],Xa.prototype,"cover",2),Va([s({type:Boolean,reflect:!0})],Xa.prototype,"layer",2),Va([s({type:String,reflect:!0})],Xa.prototype,"size",1),n("sp-thumbnail",Xa);
//# sourceMappingURL=ce9bd4ab.js.map
