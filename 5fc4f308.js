import{T as t}from"./a8f9f537.js";import{i as e}from"./112b2095.js";var r=e`
...
);--spectrum-alias-track-color-default:var(--spectrum-global-color-gray-300);--spectrum-alias-tabitem-text-color-default:var(
...
--spectrum-gray-300
)}:host,:root{--system-spectrum-combobox-border-color-default:var(--spectrum-gray-400);--system-spectrum-combobox-border-color-hover:var(--spectrum-gray-500);--system-spectrum-combobox-border-color-focus:var(--spectrum-gray-900);--system-spectrum-combobox-border-color-focus-hover:var(
--spectrum-gray-800
);--system-spectrum-combobox-border-color-key-focus:var(--spectrum-gray-900)}:host,:root{--system-spectrum-infieldbutton-spectrum-infield-button-border-width:0;--system-spectrum-infieldbutton-spectrum-infield-button-border-color:transparent;--system-spectrum-infieldbutton-spectrum-infield-button-border-radius:var(
...
--spectrum-gray-300
);--system-spectrum-picker-border-color-default:transparent;--system-spectrum-picker-border-color-default-open:transparent;--system-spectrum-picker-border-color-hover:transparent;--system-spectrum-picker-border-color-hover-open:transparent;--system-spectrum-picker-border-color-active:transparent;--system-spectrum-picker-border-color-key-focus:transparent;--system-spectrum-picker-border-width:0px}:host,:root{--system-spectrum-pickerbutton-spectrum-picker-button-background-color:var(
--spectrum-gray-200
...
--spectrum-gray-300
);--system-spectrum-pickerbutton-spectrum-picker-button-border-color:none;--system-spectrum-pickerbutton-spectrum-picker-button-border-radius:var(
--spectrum-corner-radius-75
...
--spectrum-corner-radius-75
);--system-spectrum-pickerbutton-spectrum-picker-button-border-width:0px}:host,:root{--system-spectrum-popover-border-width:0}:host,:root{--system-spectrum-radio-button-border-color-default:var(
--spectrum-gray-800
);--system-spectrum-radio-button-border-color-hover:var(--spectrum-gray-900);--system-spectrum-radio-button-border-color-down:var(--spectrum-gray-900);--system-spectrum-radio-button-border-color-focus:var(--spectrum-gray-900);--system-spectrum-radio-emphasized-button-checked-border-color-default:var(
--spectrum-accent-color-900
...
--spectrum-accent-color-1000
)}:host,:root{--system-spectrum-search-border-radius:calc(var(--spectrum-component-height-100)/2);--system-spectrum-search-edge-to-visual:var(
...
)}:host,:root{--system-spectrum-stepper-border-width:var(--spectrum-border-width-200);--system-spectrum-stepper-buttons-border-style:solid;--system-spectrum-stepper-buttons-border-width:var(
--spectrum-border-width-200
);--system-spectrum-stepper-buttons-border-color:transparent;--system-spectrum-stepper-buttons-background-color:var(--spectrum-gray-50);--system-spectrum-stepper-buttons-border-color-hover:transparent;--system-spectrum-stepper-buttons-border-color-focus:transparent;--system-spectrum-stepper-buttons-border-color-keyboard-focus:transparent;--system-spectrum-stepper-button-border-radius-reset:var(
--spectrum-in-field-button-fill-stacked-inner-border-rounding
);--system-spectrum-stepper-button-border-width:0;--system-spectrum-stepper-border-color:var(--spectrum-gray-400);--system-spectrum-stepper-border-color-hover:var(--spectrum-gray-500);--system-spectrum-stepper-border-color-focus:var(--spectrum-gray-800);--system-spectrum-stepper-border-color-focus-hover:var(
--spectrum-gray-900
);--system-spectrum-stepper-border-color-keyboard-focus:var(
--spectrum-gray-900
);--system-spectrum-stepper-border-color-invalid:transparent;--system-spectrum-stepper-border-color-focus-invalid:transparent;--system-spectrum-stepper-border-color-focus-hover-invalid:transparent;--system-spectrum-stepper-border-color-keyboard-focus-invalid:transparent;--system-spectrum-stepper-button-background-color-focus:var(
--spectrum-gray-400
...
--spectrum-disabled-background-color
);--system-spectrum-stepper-disabled-buttons-border-width:0}:host,:root{--system-spectrum-switch-handle-border-color-default:var(
--spectrum-gray-800
...
--spectrum-gray-900
);--system-spectrum-textfield-border-width:var(--spectrum-border-width-200)}:host,:root{--system-spectrum-toast-background-color-default:var(
--spectrum-neutral-background-color-default
...
`;t.registerThemeFragment("express","theme",r);
//# sourceMappingURL=5fc4f308.js.map
