import{T as t}from"./d69ebf03.js";import{B as o,y as r,S as c}from"./e19a2e5f.js";import{i as e}from"./67a87733.js";import{S as n}from"./549963e9.js";import{e as s,d as a,x as u,S as i}from"./395924ad.js";import"./28cbf4e4.js";import"./a28affa6.js";import"./5223f72b.js";import"./9676adf6.js";import{F as l}from"./2b513fe4.js";customElements.define("sp-theme",t);var d=e`
...
`,b=Object.defineProperty,m=Object.getOwnPropertyDescriptor,p=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?m(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&b(o,r,n),n};const v=["accent","primary","secondary","negative","white","black"];class h extends(n(o)){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,d]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:v.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}p([s()],h.prototype,"variant",1),p([s({type:String,reflect:!0})],h.prototype,"static",2),p([s({reflect:!0})],h.prototype,"treatment",2),p([s({type:Boolean})],h.prototype,"quiet",1),a("sp-button",h);var g=e`
...
`,f=Object.defineProperty,k=Object.getOwnPropertyDescriptor,y=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?k(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&f(o,r,n),n};const w={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class x extends(n(c)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,g,r]}get buttonContent(){return[w[this.size]()]}}y([s({reflect:!0})],x.prototype,"variant",2),y([s({type:String,reflect:!0})],x.prototype,"static",2);var z=e`
...
`,C=Object.defineProperty,B=Object.getOwnPropertyDescriptor,T=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?B(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&C(o,r,n),n};const j={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let I;class A extends(n(o,{validSizes:["xs","s","m","l","xl"]})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,z,q]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){0===t.button&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),I=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}onPointerup(){clearTimeout(I),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${j[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o="button"===this.role,r=o&&(this.selected||this.toggles)&&!(this.hasAttribute("aria-haspopup")&&this.hasAttribute("aria-expanded"));(t.has("selected")||t.has("role"))&&(r?this.setAttribute("aria-pressed",this.selected?"true":"false"):(this.removeAttribute("aria-pressed"),o&&this.toggles&&this.hasAttribute("aria-expanded")&&this.setAttribute("aria-expanded",this.selected?"true":"false"))),t.has("variant")&&(this.variant||(t.get("variant"),1))&&(this.static=this.variant)}}T([s({type:Boolean,reflect:!0})],A.prototype,"emphasized",2),T([s({type:Boolean,reflect:!0,attribute:"hold-affordance"})],A.prototype,"holdAffordance",2),T([s({type:Boolean,reflect:!0})],A.prototype,"quiet",2),T([s({reflect:!0})],A.prototype,"role",2),T([s({type:Boolean,reflect:!0})],A.prototype,"selected",2),T([s({type:Boolean,reflect:!0})],A.prototype,"toggles",2),T([s({reflect:!0})],A.prototype,"static",2),T([s({reflect:!0})],A.prototype,"variant",2),T([s({type:String})],A.prototype,"value",1),a("sp-action-button",A),a("sp-close-button",x);var H=e`
...
`,E=Object.defineProperty,S=Object.getOwnPropertyDescriptor,_=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?S(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&E(o,r,n),n};const U=["negative","positive","info","error","warning"];class P extends(l(i)){constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[H]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,r=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;U.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}_([s({type:Boolean,reflect:!0})],P.prototype,"open",2),_([s({type:Number})],P.prototype,"timeout",1),_([s({type:String})],P.prototype,"variant",1),a("sp-toast",P);
//# sourceMappingURL=c27aee30.js.map
