import"./swc.Bmxv3cuQ.js";import"./swc.DiFoxXuW.js";import"./swc.ClLCdH-C.js";import{r as t}from"./swc.mUX8iMJZ.js";import{M as e,I as o}from"./swc.Dofmtdop.js";import{i as s}from"./swc.Cl2X6-fK.js";import{S as n}from"./swc.DOcb4zpm.js";import{x as a,j as r}from"./swc.BkWj9Vim.js";import{o as i}from"./swc.CF8fRO5N.js";import{n as l}from"./swc.Cbbf2bfB.js";const p=s`
...
`;var c=Object.defineProperty,u=(t,e,o,s)=>{for(var n,a=void 0,r=t.length-1;r>=0;r--)(n=t[r])&&(a=n(e,o,a)||a);return a&&c(e,o,a),a};class h extends n{constructor(){super(...arguments),this.isMobile=new e(this,o),this.variant="info",this.placement="bottom-start",this.offset=0,this.open=!1}static get styles(){return[p]}get buttonAriaLabel(){return this.label?this.label:"help"===this.variant?"Help":"Informations"}renderOverlayContent(){return this.isMobile.matches?(import("./swc.DyCVhPTz.js").then((function(t){return t.s})),import("./swc.CwNyI2Xk.js").then((function(t){return t.s})),a`
            ...
            `):(import("./swc.Cz-nHlD5.js").then((function(t){return t.s})),a`
            ...
            <sp-overlay
                ...
                ?open=${this.open}
            ></sp-overlay>
        `}}u([l()],h.prototype,"label"),u([l()],h.prototype,"variant"),u([l({reflect:!0})],h.prototype,"placement"),u([l({type:Number})],h.prototype,"offset"),u([l({type:Boolean})],h.prototype,"open"),customElements.define("sp-contextual-help",h);
//# sourceMappingURL=swc.f-ZqkMQI.js.map
