import{B as t,S as o,f as r}from"./75b21873.js";import{i as e}from"./112b2095.js";import{S as c}from"./cd538c17.js";import{n as s}from"./879dbe89.js";import{x as n,n as u,d as a}from"./dd8018c7.js";import"./54ff42c4.js";var l=e`
...
`,b=Object.defineProperty,i=Object.getOwnPropertyDescriptor,d=(t,o,r,e)=>{for(var c,s=e>1?void 0:e?i(o,r):o,n=t.length-1;n>=0;n--)(c=t[n])&&(s=(e?c(o,r,s):c(s))||s);return e&&s&&b(o,r,s),s};const m=["accent","primary","secondary","negative","white","black"];class p extends(c(t,{noDefaultSize:!0})){constructor(){super(...arguments),this.pendingLabel="Pending",this.pending=!1,this.cachedAriaLabel=null,this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,l]}click(){this.pending||super.click()}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:m.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}get quiet(){return"outline"===this.treatment}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}updated(t){super.updated(t),t.has("pending")&&(this.pending&&this.pendingLabel!==this.getAttribute("aria-label")?this.disabled||(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)):!this.pending&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):!this.pending&&""===this.cachedAriaLabel&&this.removeAttribute("aria-label")),t.has("disabled")&&(this.disabled||this.pendingLabel===this.getAttribute("aria-label")?this.disabled&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):this.disabled&&""==this.cachedAriaLabel&&this.removeAttribute("aria-label"):this.pending&&(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)))}renderButton(){return n`
            ${this.buttonContent}
            ${s(this.pending,(()=>(import("./46dadcca.js").then((function(t){return t.s})),n`
                    <sp-progress-circle
                        indeterminate
                        static="white"
                        aria-hidden="true"
...
//# sourceMappingURL=7aca7b02.js.map
