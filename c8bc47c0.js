import{e as t,i as e,t as o,S as r,I as i,u as l}from"./7872ac74.js";import{r as c}from"./e50c5e8d.js";import"./bfe4071e.js";import{S as a,l as n,a as s,i as u}from"./a07dea85.js";import{e as d,R as p,b as m,w as v,$ as h}from"./2310c663.js";import"./d17b22da.js";import"./2fca06e6.js";function f(t){return d({...t,state:!0})}const{H:b}=p,x=t=>void 0===t.strings,g=()=>document.createComment(""),w=(t,e,o)=>{var r;const i=t._$AA.parentNode,l=void 0===e?t._$AB:e._$AA;if(void 0===o){const e=i.insertBefore(g(),l),r=i.insertBefore(g(),l);o=new b(e,r,t,t.options)}else{const e=o._$AB.nextSibling,c=o._$AM,a=c!==t;if(a){let e;null===(r=o._$AQ)||void 0===r||r.call(o,t),o._$AM=t,void 0!==o._$AP&&(e=t._$AU)!==c._$AU&&o._$AP(e)}if(e!==l||a){let t=o._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,l),t=e}}}return o},k=(t,e,o=t)=>(t._$AI(e,o),t),y={},q=(t,e=y)=>t._$AH=e,z=t=>t._$AH,$=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let o=t._$AA;const r=t._$AB.nextSibling;for(;o!==r;){const t=o.nextSibling;o.remove(),o=t}},B=t(class extends e{constructor(t){if(super(t),t.type!==o.PROPERTY&&t.type!==o.ATTRIBUTE&&t.type!==o.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===m||e===v)return e;const r=t.element,i=t.name;if(t.type===o.PROPERTY){if(e===r[i])return m}else if(t.type===o.BOOLEAN_ATTRIBUTE){if(!!e===r.hasAttribute(i))return m}else if(t.type===o.ATTRIBUTE&&r.getAttribute(i)===e+"")return m;return q(t),e}});var T=c`
...
`,E=Object.defineProperty,A=Object.getOwnPropertyDescriptor;const I={s:()=>h`
        <sp-icon-cross75
            slot="icon"
    ...
    `};class _ extends(a(r)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,T,i]}get buttonContent(){return[I[this.size]()]}render(){return h`
        ...
        `}addId(){const t=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=H(this.host,"aria-describedby",t),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(t){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const e=t.assignedElements()[0];this.helpTextElement=e,e&&(e.id||(e.id=this.id),this.addId())}handleNegativeHelpText(t){"negative-help-text"===t.name&&t.assignedElements().forEach((t=>t.variant="negative"))}};let j=S;function L(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new j(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(t){return this.helpTextManager.render(t)}}}j.instanceCount=0;var C=c`
...
`,F=Object.defineProperty,U=Object.getOwnPropertyDescriptor,O=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&F(e,o,l),l};const P=["text","url","tel","email","password"];class R extends(L(s)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[C,l]}get type(){var t;return null!=(t=P.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?h`
            ...
            `:this.valid?h`
                ...
                ></sp-icon-checkmark100>
            `:v}get displayValue(){return this.value.toString()}get renderMultiline(){return h`
            ${this.grows&&!this.quiet?h`
...
`,N=Object.defineProperty,K=Object.getOwnPropertyDescriptor,V=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?K(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&N(e,o,l),l};const D=t=>t.stopPropagation();class Y extends G{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,M]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return h`
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}V([d()],Y.prototype,"action",2),V([d()],Y.prototype,"label",2),V([d()],Y.prototype,"method",2),V([d()],Y.prototype,"placeholder",2),V([u("#form")],Y.prototype,"form",2),customElements.define("sp-search",Y);export{L as M,R as T,z as a,H as b,k as c,G as d,$ as m,x as r,q as s,f as t,w as u};
//# sourceMappingURL=c8bc47c0.js.map
