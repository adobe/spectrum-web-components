import{i as t}from"./d230bd74.js";import{S as e,y as s,e as i}from"./d036ac45.js";import{O as o}from"./fe0aa793.js";import{t as a,F as r,S as c,a as l,b as n,i as d,L as m}from"./b2e4ef96.js";import{R as b}from"./464e15ff.js";import{o as u}from"./49f5bb7b.js";import"./0e0b257c.js";import"./ab4b1778.js";import"./c558c2ce.js";import"./ca0cc342.js";import"./ef0b9850.js";import"./c74ab29c.js";import{Overlay as p}from"./e13c5e3e.js";import"./89c02dc9.js";import"./a90b2ffb.js";import"./b0cf06e8.js";import"./4a1e4df7.js";import"./de819e8a.js";import"./bd23b6e3.js";const h=Symbol("slotContentIsPresent");function v(t,e){var s;const i=Array.isArray(e)?e:[e];return s=h,class extends t{constructor(...t){super(t),this[s]=new Map,this.managePresenceObservedSlot=()=>{let t=!1;i.forEach((e=>{const s=!!this.querySelector(e),i=this[h].get(e)||!1;t=t||i!==s,this[h].set(e,!!this.querySelector(e))})),t&&this.updateComplete.then((()=>{this.requestUpdate()}))},new a(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(1===i.length)return this[h].get(i[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(t){if(this[h].has(t))return this[h].get(t)||!1;throw new Error(`The provided selector \`${t}\` is not being observed.`)}}}var x=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,g=Object.defineProperty,y=Object.getOwnPropertyDescriptor,f=(t,e,s,i)=>{for(var o,a=i>1?void 0:i?y(e,s):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&g(e,s,a),a};const z=class extends e{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return s`
            <slot></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+z.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};let k=z;k.styles=[x],k.instanceCount=0,f([i({type:Boolean,reflect:!0})],k.prototype,"selected",2),f([i({type:String,reflect:!0})],k.prototype,"value",2),customElements.define("sp-tab-panel",k);var q=t`
...
`,w=Object.defineProperty,S=Object.getOwnPropertyDescriptor,C=(t,e,s,i)=>{for(var o,a=i>1?void 0:i?S(e,s):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&w(e,s,a),a};const I=class extends(r(o(v(e,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[q]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`
            ${this.hasIcon?s`
                      <slot name="icon"></slot>
                  `:s``}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+I.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};let E=I;E.instanceCount=0,C([i({type:Boolean,reflect:!0})],E.prototype,"disabled",2),C([i({reflect:!0})],E.prototype,"label",2),C([i({type:Boolean,reflect:!0})],E.prototype,"selected",2),C([i({type:Boolean,reflect:!0})],E.prototype,"vertical",2),C([i({type:String,reflect:!0})],E.prototype,"value",2),customElements.define("sp-tab",E);class A{constructor(t,{target:e,config:s,callback:i,skipInitial:o}){this.t=new Set,this.o=!1,this.i=!1,this.h=t,null!==e&&this.t.add(null!=e?e:t),this.o=null!=o?o:this.o,this.callback=i,window.IntersectionObserver?(this.u=new IntersectionObserver((t=>{const e=this.i;this.i=!1,this.o&&e||(this.handleChanges(t),this.h.requestUpdate())}),s),t.addController(this)):console.warn("IntersectionController error: browser does not support IntersectionObserver.")}handleChanges(t){var e;this.value=null===(e=this.callback)||void 0===e?void 0:e.call(this,t,this.u)}hostConnected(){for(const t of this.t)this.observe(t)}hostDisconnected(){this.disconnect()}async hostUpdated(){const t=this.u.takeRecords();t.length&&this.handleChanges(t)}observe(t){this.t.add(t),this.u.observe(t),this.i=!0}unobserve(t){this.t.delete(t),this.u.unobserve(t)}disconnect(){this.u.disconnect()}}class T{constructor(t,{target:e,config:s,callback:i,skipInitial:o}){this.t=new Set,this.o=!1,this.i=!1,this.h=t,null!==e&&this.t.add(null!=e?e:t),this.l=s,this.o=null!=o?o:this.o,this.callback=i,window.ResizeObserver?(this.u=new ResizeObserver((t=>{this.handleChanges(t),this.h.requestUpdate()})),t.addController(this)):console.warn("ResizeController error: browser does not support ResizeObserver.")}handleChanges(t){var e;this.value=null===(e=this.callback)||void 0===e?void 0:e.call(this,t,this.u)}hostConnected(){for(const t of this.t)this.observe(t)}hostDisconnected(){this.disconnect()}async hostUpdated(){!this.o&&this.i&&this.handleChanges([]),this.i=!1}observe(t){this.t.add(t),this.u.observe(t,this.l),this.i=!0,this.h.requestUpdate()}unobserve(t){this.t.delete(t),this.u.unobserve(t)}disconnect(){this.u.disconnect()}}var j=t`
...
`,P=Object.defineProperty,O=Object.getOwnPropertyDescriptor,L=(t,e,s,i)=>{for(var o,a=i>1?void 0:i?O(e,s):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&P(e,s,a),a};const H={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
        ...
        `}};class B extends(c(l)){constructor(){super(),this.auto=!1,this.compact=!1,this.direction="horizontal",this.emphasized=!1,this.label="",this.enableTabsScroll=!1,this.quiet=!1,this.selectionIndicatorStyle=H.noSelectionStyle,this.shouldAnimate=!1,this.selected="",this._tabs=[],this.resizeController=new T(this,{callback:()=>{this.updateSelectionIndicator()}}),this.rovingTabindexController=new b(this,{focusInIndex:t=>{let e=0;return t.find(((t,s)=>{const i=this.selected?!t.disabled&&t.value===this.selected:!t.disabled;return e=s,i}))?e:-1},direction:()=>"horizontal"===this.direction?"horizontal":"vertical",elementEnterAction:t=>{this.auto&&(this.shouldAnimate=!0,this.selectTarget(t))},elements:()=>this.tabs,isFocusableElement:t=>!t.disabled,listenerScope:()=>this.tabList}),this.onTabsScroll=()=>{this.dispatchEvent(new Event("sp-tabs-scroll",{bubbles:!0,composed:!0}))},this.onClick=t=>{if(this.disabled)return;const e=t.composedPath().find((t=>t.parentElement===this));!e||e.disabled||(this.shouldAnimate=!0,this.selectTarget(e))},this.onKeyDown=t=>{if("Enter"===t.code||"Space"===t.code){t.preventDefault();const e=t.target;e&&this.selectTarget(e)}},this.updateCheckedState=()=>{if(this.tabs.forEach((t=>{t.removeAttribute("selected")})),this.selected){const t=this.tabs.find((t=>t.value===this.selected));t?t.selected=!0:this.selected=""}else{const t=this.tabs[0];t&&t.setAttribute("tabindex","0")}this.updateSelectionIndicator()},this.updateSelectionIndicator=async()=>{const t=this.tabs.find((t=>t.selected));if(!t)return void(this.selectionIndicatorStyle=H.noSelectionStyle);await Promise.all([t.updateComplete,document.fonts?document.fonts.ready:Promise.resolve()]);const{width:e,height:s}=t.getBoundingClientRect();this.selectionIndicatorStyle="horizontal"===this.direction?H.transformX(t.offsetLeft,e):H.transformY(t.offsetTop,s)},new A(this,{config:{root:null,rootMargin:"0px",threshold:[0,1]},callback:()=>{this.updateSelectionIndicator()}})}static get styles(){return[$,j,H.baseStyles()]}set tabs(t){t!==this.tabs&&(this._tabs.forEach((t=>{this.resizeController.unobserve(t)})),t.forEach((t=>{this.resizeController.observe(t)})),this._tabs=t,this.rovingTabindexController.clearElementCache())}get tabs(){return this._tabs}get focusElement(){return this.rovingTabindexController.focusInElement||this}scrollTabs(t,e="smooth"){var s;null==(s=this.tabList)||s.scrollBy({left:t,top:0,behavior:e})}get scrollState(){if(this.tabList){const{scrollLeft:t,clientWidth:e,scrollWidth:s}=this.tabList,i=Math.abs(t)>0,o=Math.ceil(Math.abs(t))<s-e;return{canScrollLeft:"ltr"===this.dir?i:o,canScrollRight:"ltr"===this.dir?o:i}}return{}}manageAutoFocus(){const t=[...this.children].map((t=>void 0!==t.updateComplete?t.updateComplete:Promise.resolve(!0)));Promise.all(t).then((()=>super.manageAutoFocus()))}managePanels({target:t}){t.assignedElements().map((t=>{const{value:e,id:s}=t,i=this.querySelector(`[role="tab"][value="${e}"]`);i&&(i.setAttribute("aria-controls",s),t.setAttribute("aria-labelledby",i.id)),t.selected=e===this.selected}))}render(){return s`
            <div
                class=${u({scroll:this.enableTabsScroll})}
                aria-label=${n(this.label?this.label:void 0)}
                @click=${this.onClick}
...
`,M=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,G=(t,e,s,i)=>{for(var o,a=i>1?void 0:i?Y(e,s):e,r=t.length-1;r>=0;r--)(o=t[r])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&M(e,s,a),a};class K extends(m(l)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[q,X]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${n(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}G([d("a")],K.prototype,"anchor",2),G([i({type:Boolean,reflect:!0})],K.prototype,"selected",2),customElements.define("sp-top-nav-item",K),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:s}=e,{pathname:i}=location,o=i.search("api")>-1;switch(s){case"api":{if(o)return;const t=(i+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!o)return;const t=i.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./e6e84173.js"),import("./a1ae9d86.js")})):requestAnimationFrame((()=>{import("./e6e84173.js"),import("./a1ae9d86.js")})),window.Overlay=p;var N=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",N),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"sp-table-row"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));export{v as O,$ as g,T as s};
//# sourceMappingURL=13c3f0b3.js.map
