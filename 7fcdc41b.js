import{T as t}from"./1e267a98.js";import{S as o,I as r,B as c}from"./21db0c76.js";import{i as e}from"./d230bd74.js";import{S as n}from"./01bc7f71.js";import{e as s,y as a,S as u}from"./99636b0a.js";import"./5d9665ce.js";import"./070309fa.js";import"./e3d6b3c7.js";import"./3af3c7eb.js";customElements.define("sp-theme",t);var i=e`
...
`,h=Object.defineProperty,g=Object.getOwnPropertyDescriptor;const f={s:()=>a`
    ...
    `,xl:()=>a`
        ...
        ></sp-icon-cross300>
    `};class k extends(n(o)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,v,r]}get buttonContent(){return[f[this.size]()]}}((t,o,r,c)=>{for(var e,n=c>1?void 0:c?g(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&h(o,r,n)})([s({reflect:!0})],k.prototype,"variant",2);var y=e`
...
`,I=Object.defineProperty,E=Object.getOwnPropertyDescriptor;class A extends(n(u,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return a``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}A.styles=[B],((t,o,r,c)=>{for(var e,n=c>1?void 0:c?E(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&I(o,r,n)})([s({type:Boolean,reflect:!0})],A.prototype,"vertical",2),customElements.define("sp-divider",A),customElements.define("sp-close-button",k);var H=e`
...
`,U=Object.defineProperty,P=Object.getOwnPropertyDescriptor,S=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?P(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&U(o,r,n),n};const _=["negative","positive","info","error","warning"];class D extends u{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[H]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,r=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;_.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return a`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}S([s({type:Boolean,reflect:!0})],D.prototype,"open",2),S([s({type:Number})],D.prototype,"timeout",1),S([s({type:String})],D.prototype,"variant",1),customElements.define("sp-toast",D);export{B as s};
//# sourceMappingURL=7fcdc41b.js.map
