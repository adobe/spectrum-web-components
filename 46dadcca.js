import{i as r}from"./112b2095.js";import{S as t}from"./cd538c17.js";import{x as e,n as o,S as s,d as a}from"./dd8018c7.js";import{l as i,i as c}from"./41f420ad.js";const n=(r,t)=>{if(r)return null;const e=t.assignedNodes().reduce(((r,t)=>t.textContent?r+t.textContent:r),"");return e?e.trim():null};var l=r`
...
`,m=Object.defineProperty,d=Object.getOwnPropertyDescriptor,g=(r,t,e,o)=>{for(var s,a=o>1?void 0:o?d(t,e):t,i=r.length-1;i>=0;i--)(s=r[i])&&(a=(o?s(t,e,a):s(a))||a);return o&&a&&m(t,e,a),a};class f extends(t(s,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[l]}makeRotation(r){return this.indeterminate?void 0:`transform: rotate(${r}deg);`}willUpdate(r){r.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const r=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return e`
            <slot @slotchange=${this.handleSlotchange}></slot>
            <div class="track"></div>
            <div class="fills">
                ${["Mask1","Mask2"].map(((t,o)=>e`
                        <div class="fill${t}">
                            <div
                                class="fillSub${t}"
                                style=${i(r[o])}
        ...
        `}handleSlotchange(){const r=n(this.label,this.slotEl);r&&(this.label=r)}firstUpdated(r){super.firstUpdated(r),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(r){super.updated(r),!this.indeterminate&&r.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),r.has("label")&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}}g([o({type:Boolean,reflect:!0})],f.prototype,"indeterminate",2),g([o({type:String})],f.prototype,"label",2),g([o({type:Boolean,reflect:!0,attribute:"over-background"})],f.prototype,"overBackground",2),g([o({reflect:!0})],f.prototype,"static",2),g([o({type:Number})],f.prototype,"progress",2),g([c("slot")],f.prototype,"slotEl",2),a("sp-progress-circle",f);var p=Object.freeze({__proto__:null});export{n as g,p as s};
//# sourceMappingURL=46dadcca.js.map
