import{t,s as e}from"./swc.Chuw36y7.js";import{I as r}from"./swc.Bea_DqvJ.js";import{x as i}from"./swc.DWYvVEd1.js";import{d as l}from"./swc.JlveB6nj.js";const s=({width:e=24,height:r=24,hidden:i=!1,title:l="Alert"}={})=>t`<svg
  ...
  >
    ...
    />
  </svg>`,a=({width:e=24,height:r=24,hidden:i=!1,title:l="Alert Triangle"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${r}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;l("sp-icon-alert",class extends r{render(){return e(i),1===this.spectrumVersion?s({hidden:!this.label,title:this.label}):a({hidden:!this.label,title:this.label})}});export{a as A,s as a};
//# sourceMappingURL=swc.6dkAWagI.js.map
