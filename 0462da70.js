import{f as e,S as t}from"./8921ffff.js";import{i as r}from"./1ab7ceed.js";import"./1f3cc327.js";import"./95cea33f.js";import{S as o}from"./41af188d.js";import{T as i,A as c,x as a,n as s,d as l}from"./637c92da.js";import"./9eece4f7.js";import{c as n,t as d}from"./e6813b8c.js";import{l as u,F as p,i as m}from"./0fd5475c.js";import"./3b101b71.js";import"./a974e940.js";import{E as h}from"./1bc378e4.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./be246949.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,w=Object.defineProperty,z=Object.getOwnPropertyDescriptor;const q={s:()=>a`
    ...
    `,xl:()=>a`
        ...
        ></sp-icon-cross300>
    `};class T extends(o(t,{noDefaultSize:!0})){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,y,e]}get buttonContent(){return[q[this.size]()]}render(){return a`
            <div class="fill">${super.render()}</div>
        `}}((e,t,r,o)=>{for(var i,c=o>1?void 0:o?z(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);o&&c&&w(t,r,c)})([s({reflect:!0})],T.prototype,"variant",2);const $=class e{constructor(t,{mode:r}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=t,this.instanceCount=e.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=r}get isInternal(){return"internal"===this.mode}render(e){return a`
...
)}.input:disabled,:host([disabled]) #textfield .input{-webkit-text-fill-color:var(
...
);opacity:1;resize:none}.input:disabled::placeholder,:host([disabled]) #textfield .input::placeholder{color:var(
--highcontrast-textfield-text-color-disabled,var(
--mod-textfield-text-color-disabled,var(--spectrum-textfield-text-color-disabled)
)
...
)}:host([disabled]) #textfield:hover .input{-webkit-text-fill-color:var(
--highcontrast-textfield-text-color-disabled,var(
--mod-textfield-text-color-disabled,var(--spectrum-textfield-text-color-disabled)
)
);background-color:var(
...
);opacity:1;resize:none}:host([quiet][disabled]:hover) .input{background-color:#0000;border-color:var(
--mod-textfield-border-color-disabled,var(--spectrum-textfield-border-color-disabled)
);color:var(
--highcontrast-textfield-text-color-disabled,var(
--mod-textfield-text-color-disabled,var(--spectrum-textfield-text-color-disabled)
...
`,j=Object.defineProperty,S=Object.getOwnPropertyDescriptor,B=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?S(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&j(t,r,c),c};const H=["text","url","tel","email","password"];class L extends(I(o(p,{noDefaultSize:!0}))){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.rows=-1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[C,h]}set type(e){const t=this._type;this._type=e,this.requestUpdate("type",t)}get type(){var e;return null!=(e=H.find((e=>e===this._type)))?e:"text"}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,t,r="none"){this.inputElement.setSelectionRange(e,t,r)}select(){this.inputElement.select()}handleInput(e){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const e=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(e,e)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(e){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?a`
        ...
        `}update(e){(e.has("value")||e.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(e)}checkValidity(){let e=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(e=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(e=e&&this.value.toString().length>=this.minlength),this.valid=e,this.invalid=!e),e}}B([d()],L.prototype,"appliedLabel",2),B([s({attribute:"allowed-keys"})],L.prototype,"allowedKeys",2),B([s({type:Boolean,reflect:!0})],L.prototype,"focused",2),B([m(".input:not(#sizer)")],L.prototype,"inputElement",2),B([s({type:Boolean,reflect:!0})],L.prototype,"invalid",2),B([s()],L.prototype,"label",2),B([s({type:String,reflect:!0})],L.prototype,"name",2),B([s()],L.prototype,"placeholder",2),B([d()],L.prototype,"type",1),B([s({attribute:"type",reflect:!0})],L.prototype,"_type",2),B([s()],L.prototype,"pattern",2),B([s({type:Boolean,reflect:!0})],L.prototype,"grows",2),B([s({type:Number})],L.prototype,"maxlength",2),B([s({type:Number})],L.prototype,"minlength",2),B([s({type:Boolean,reflect:!0})],L.prototype,"multiline",2),B([s({type:Boolean,reflect:!0})],L.prototype,"readonly",2),B([s({type:Number})],L.prototype,"rows",2),B([s({type:Boolean,reflect:!0})],L.prototype,"valid",2),B([s({type:String})],L.prototype,"value",1),B([s({type:Boolean,reflect:!0})],L.prototype,"quiet",2),B([s({type:Boolean,reflect:!0})],L.prototype,"required",2),B([s({type:String,reflect:!0})],L.prototype,"autocomplete",2);class O extends L{constructor(){super(...arguments),this._value=""}set value(e){if(e===this.value)return;const t=this._value;this._value=e,this.requestUpdate("value",t)}get value(){return this._value}}B([s({type:String})],O.prototype,"value",1),l("sp-clear-button",T);var U=r`
...
`,_=Object.defineProperty,A=Object.getOwnPropertyDescriptor,F=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?A(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&_(t,r,c),c};const R=e=>e.stopPropagation();class P extends O{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,U]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}F([s()],P.prototype,"action",2),F([s()],P.prototype,"label",2),F([s()],P.prototype,"method",2),F([s()],P.prototype,"placeholder",2),F([m("#form")],P.prototype,"form",2),l("sp-search",P);export{I as M,O as T,L as a,k as l};
//# sourceMappingURL=0462da70.js.map
