import{R as e}from"./0e68698d.js";import{i as t}from"./67a87733.js";import{x as s,e as n,S as r,d as a}from"./395924ad.js";import{L as i,l as o,a as c}from"./2b513fe4.js";var d=t`
...
`,v=Object.defineProperty,u=Object.getOwnPropertyDescriptor,m=(e,t,s,n)=>{for(var r,a=n>1?void 0:n?u(t,s):t,i=e.length-1;i>=0;i--)(r=e[i])&&(a=(n?r(t,s,a):r(a))||a);return n&&a&&v(t,s,a),a};const p=class e extends(i(c)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[l]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,s=this.parentElement;for(;s instanceof e;)t++,s=s.parentElement;return t}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||null!=e&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return s`
            <a
                href=${this.href||"#"}
...
`,f=Object.defineProperty,b=Object.getOwnPropertyDescriptor;class k extends r{constructor(){super(...arguments),this.label=""}static get styles(){return[l,g]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return s`
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}x([n({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],z.prototype,"manageTabIndex",2),x([n({reflect:!0})],z.prototype,"value",2),x([n({reflect:!0})],z.prototype,"variant",2),x([n({reflect:!0})],z.prototype,"label",2),a("sp-sidenav",z),a("sp-sidenav-item",h);export{k as S};
//# sourceMappingURL=71038969.js.map
