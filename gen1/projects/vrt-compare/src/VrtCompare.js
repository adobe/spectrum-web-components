"use strict";var h=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var l=(c,a,i,s)=>{for(var t=s>1?void 0:s?u(a,i):a,r=c.length-1,o;r>=0;r--)(o=c[r])&&(t=(s?o(a,i,t):o(t))||t);return s&&t&&h(a,i,t),t};import{css as m,html as e,nothing as n,SpectrumElement as g}from"@spectrum-web-components/base";import{property as d}from"@spectrum-web-components/base/src/decorators.js";import{ObserveSlotPresence as f}from"@spectrum-web-components/shared";import b from"@spectrum-web-components/styles/body.js";import"@spectrum-web-components/action-button/sp-action-button.js";import"@spectrum-web-components/action-group/sp-action-group.js";import"@spectrum-web-components/split-view/sp-split-view.js";import"@spectrum-web-components/icons-workflow/icons/sp-icon-alert.js";import"@spectrum-web-components/icons-workflow/icons/sp-icon-zoom-in.js";import"@spectrum-web-components/icons-workflow/icons/sp-icon-zoom-out.js";import"@spectrum-web-components/icons-workflow/icons/sp-icon-refresh.js";import"@spectrum-web-components/action-bar/sp-action-bar.js";import"@spectrum-web-components/progress-circle/sp-progress-circle.js";import"../onion-skinner.js";export class VrtCompare extends f(g,['[slot="actual"]','[slot="baseline"]','[slot="diff"]']){constructor(){super(...arguments);this.view="scrubber";this.zoom=1;this.imagesLoaded=!1;this._loadingImages=!1}get hasActual(){return this.getSlotContentPresence('[slot="actual"]')}get hasBaseline(){return this.getSlotContentPresence('[slot="baseline"]')}get hasDiff(){return this.getSlotContentPresence('[slot="diff"]')}get canCompare(){return this.hasActual&&this.hasBaseline}handleChange(i){const s=i.target.selected[0];s&&(this.view=s)}handleZoomIn(){this.zoom+=.1}handleZoomClear(){this.zoom=1}handleZoomOut(){this.zoom-=.1}get error(){return e`
    ...
    `}get renderView(){switch(this.view){case"error":return this.error;case"actual":return this.actual;case"baseline":return this.baseline;case"diff":return this.diff;case"onion":return this.onion;case"sidebyside":return this.sidebyside;case"scrubber":default:return this.scrubber}}get viewFallback(){return this.canCompare?"scrubber":this.hasActual?"actual":this.hasBaseline?"baseline":this.hasDiff?"diff":"error"}async prepImages(i){const s=i.target;if(this._loadingImages||!s.assignedNodes().length)return;this._loadingImages=!0,this.imagesLoaded=!1;const t=[...this.querySelectorAll("img")];if(!t.length){this.imagesLoaded=!0,this._loadingImages=!1;return}const r=t.map(o=>o.naturalWidth?(this.style.setProperty("--image-width",`${o.naturalWidth}px`),Promise.resolve()):new Promise(p=>{o.addEventListener("load",()=>{this.style.setProperty("--image-width",`${o.naturalWidth}px`),p(!0)})}));await Promise.all(r),this.imagesLoaded=!0,this._loadingImages=!1}shouldUpdate(){return(this.view==="error"||this.view==="actual"&&!this.hasActual||this.view==="baseline"&&!this.hasBaseline||this.view==="diff"&&!this.hasDiff||(this.view==="onion"||this.view==="sidebyside"||this.view==="scrubber")&&!this.canCompare)&&(this.view=this.viewFallback),!0}render(){return this._loadingImages?e`
        <sp-progress-circle indeterminate></sp-progress-circle>
        <slot name="actual" @slotchange=${this.prepImages} hidden></slot>
        <slot name="baseline" @slotchange=${this.prepImages} hidden></slot>
      ...
      >
        ${this.view!=="error"?n:e`
              <sp-action-button value="error" disabled>Error</sp-action-button>
            `}
        ${this.canCompare?e`
              <sp-action-button
                value="scrubber"
            ...
            `:n}
        ${this.hasDiff?e`
              <sp-action-button value="diff" ?selected=${this.view==="diff"}>
                Diff
              </sp-action-button>
            `:n}
        ${this.hasActual?e`
    ...
    `:e`
        ...
        <slot name="baseline" @slotchange=${this.prepImages} hidden></slot>
        <slot name="diff" @slotchange=${this.prepImages} hidden></slot>
      `}updated(i){i.has("zoom")&&this.style.setProperty("--zoom-level",`${this.zoom}`)}}VrtCompare.styles=[m`
      :host {
        display: grid;
        max-width: 100%;
        overflow: auto;
