"use strict";var b=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var l=(a,r,e,t)=>{for(var i=t>1?void 0:t?p(r,e):r,n=a.length-1,d;n>=0;n--)(d=a[n])&&(i=(t?d(r,e,i):d(i))||i);return t&&i&&b(r,e,i),i};import{ResizeController as u}from"@lit-labs/observers/resize-controller.js";import{html as s,SpectrumElement as m}from"@spectrum-web-components/base";import{conditionAttributeWithId as c}from"@spectrum-web-components/base/src/condition-attribute-with-id.js";import{property as g,query as v}from"@spectrum-web-components/base/src/decorators.js";import{FocusVisiblePolyfillMixin as y}from"@spectrum-web-components/shared/src/focus-visible.js";import{randomID as f}from"@spectrum-web-components/shared/src/random-id.js";import"@spectrum-web-components/button/sp-button.js";import"@spectrum-web-components/button-group/sp-button-group.js";import"@spectrum-web-components/icons-workflow/icons/sp-icon-alert.js";import"@spectrum-web-components/divider/sp-divider.js";import E from"./alert-dialog.css.js";export const alertDialogVariants=["confirmation","information","warning","error","destructive","secondary"];function h(a,r){const e=a.assignedElements(),t=[];return e.forEach(i=>{if(i.id)t.push(i.id);else{const n=r+`-${f()}`;i.id=n,t.push(n)}}),t}const o=class o extends y(m){constructor(){super(...arguments);this.resizeController=new u(this,{callback:()=>{this.shouldManageTabOrderForScrolling()}});this._variant="";this.labelledbyId=`sp-dialog-label-${o.instanceCount++}`;this.shouldManageTabOrderForScrolling=()=>{if(!this.contentElement)return;const{offsetHeight:e,scrollHeight:t}=this.contentElement;e<t?this.contentElement.tabIndex=0:this.contentElement.removeAttribute("tabindex")};this.describedbyId=`sp-dialog-description-${o.instanceCount++}`}static get styles(){return[E]}set variant(e){if(e===this.variant)return;const t=this.variant;alertDialogVariants.includes(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",t)}get variant(){return this._variant}renderIcon(){switch(this.variant){case"warning":case"error":return s`
    ...
    `}render(){return s`
      <div class="grid">
        <div class="header">${this.renderHeading()} ${this.renderIcon()}</div>
        <sp-divider size="m" class="divider"></sp-divider>
        ${this.renderContent()} ${this.renderButtons()}
      </div>
    `}};o.instanceCount=0,l([v(".content")],o.prototype,"contentElement",2),l([g({type:String,reflect:!0})],o.prototype,"variant",1);export let AlertDialog=o;
