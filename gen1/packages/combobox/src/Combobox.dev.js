...
export class Combobox extends Textfield {
  ...
  shouldUpdate(changed) {
    ...
    if (changed.has("value")) {
      ...
      this.itemValue = (_b = (_a = this.availableOptions.find((option) => option.itemText === this.value)) == null ? void 0 : _a.value) != null ? _b : "";
    }
  ...
  renderField() {
    return html`
      ...
      this.activeDescendant ? `${this.activeDescendant.value}` : void 0
        ...
        aria-autocomplete=${ifDefined(this.autocomplete)}
        aria-controls=${ifDefined(this.open ? "listbox-menu" : void 0)}
