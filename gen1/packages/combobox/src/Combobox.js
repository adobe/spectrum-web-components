"use strict";var u=Object.defineProperty;var v=Object.getOwnPropertyDescriptor;var a=(h,o,e,t)=>{for(var i=t>1?void 0:t?v(o,e):o,s=h.length-1,r;s>=0;s--)(r=h[s])&&(i=(t?r(o,e,i):r(i))||i);return t&&i&&u(o,e,i),i};import{html as l,nothing as b}from"@spectrum-web-components/base";import{property as d,query as c,state as p}from"@spectrum-web-components/base/src/decorators.js";import{ifDefined as n,live as f,repeat as m}from"@spectrum-web-components/base/src/directives.js";import g from"@spectrum-web-components/icon/src/spectrum-icon-chevron.css.js";import{Textfield as $}from"@spectrum-web-components/textfield";import"@spectrum-web-components/icons-ui/icons/sp-icon-chevron100.js";import"@spectrum-web-components/menu/sp-menu-item.js";import"@spectrum-web-components/menu/sp-menu.js";import"@spectrum-web-components/overlay/sp-overlay.js";import"@spectrum-web-components/picker-button/sp-picker-button.js";import"@spectrum-web-components/progress-circle/sp-progress-circle.js";import"@spectrum-web-components/popover/sp-popover.js";import y from"./combobox.css.js";export class Combobox extends ${constructor(){super(...arguments);this.autocomplete="none";this.availableOptions=[];this.open=!1;this.pending=!1;this.pendingLabel="Pending";this.overlayOpen=!1;this.itemValue="";this.optionEls=[];this.fieldWidth=0;this.applyFocusElementLabel=e=>{this.appliedLabel=e};this._returnItems=()=>{}}static get styles(){return[...super.styles,y,g]}focus(){this.focusElement.focus()}click(){this.focus(),this.focusElement.click()}scrollToActiveDescendant(){if(!this.activeDescendant)return;const e=this.shadowRoot.getElementById(this.activeDescendant.value);e&&e.scrollIntoView({block:"nearest"})}handleComboboxKeydown(e){if(!(this.readonly||this.pending))if(e.altKey&&e.code==="ArrowDown")this.open=!0;else if(e.code==="ArrowDown")e.preventDefault(),this.open=!0,this.activateNextDescendant(),this.scrollToActiveDescendant();else if(e.code==="ArrowUp")e.preventDefault(),this.open=!0,this.activatePreviousDescendant(),this.scrollToActiveDescendant();else if(e.code==="Escape")this.open||(this.value=""),this.open=!1;else if(e.code==="Enter")this.selectDescendant(),this.open=!1;else if(e.code==="Home")this.focusElement.setSelectionRange(0,0),this.activeDescendant=void 0;else if(e.code==="End"){const{length:t}=this.value;this.focusElement.setSelectionRange(t,t),this.activeDescendant=void 0}else e.code==="ArrowLeft"?this.activeDescendant=void 0:e.code==="ArrowRight"&&(this.activeDescendant=void 0)}handleSlotchange(){this.setOptionsFromSlottedItems(),this.itemObserver.disconnect(),this.optionEls.map(e=>{this.itemObserver.observe(e,{attributes:!0,attributeFilter:["id"],childList:!0})})}handleTooltipSlotchange(e){this.tooltipEl=e.target.assignedElements()[0]}setOptionsFromSlottedItems(){const e=this.optionSlot.assignedElements({flatten:!0});this.optionEls=e}activateNextDescendant(){const e=this.activeDescendant?this.availableOptions.indexOf(this.activeDescendant):-1;let t=e;do if(t=(this.availableOptions.length+t+1)%this.availableOptions.length,t===e)break;while(this.availableOptions[t].disabled);this.availableOptions[t].disabled||(this.activeDescendant=this.availableOptions[t]),this.optionEls.forEach(i=>{var s;return i.setAttribute("aria-selected",i.value===((s=this.activeDescendant)==null?void 0:s.value)?"true":"false")})}activatePreviousDescendant(){const e=this.activeDescendant?this.availableOptions.indexOf(this.activeDescendant):0;let t=e;do if(t=(this.availableOptions.length+t-1)%this.availableOptions.length,t===e)break;while(this.availableOptions[t].disabled);this.availableOptions[t].disabled||(this.activeDescendant=this.availableOptions[t]),this.optionEls.forEach(i=>{var s;return i.setAttribute("aria-selected",i.value===((s=this.activeDescendant)==null?void 0:s.value)?"true":"false")})}selectDescendant(){if(!this.activeDescendant)return;const e=this.shadowRoot.getElementById(this.activeDescendant.value);e&&e.click()}filterAvailableOptions(){if(this.autocomplete==="none"||this.pending)return;const e=this.value.toLowerCase();this.availableOptions=(this.options||this.optionEls).filter(t=>t.itemText.toLowerCase().startsWith(e))}handleInput(e){super.handleInput(e),this.pending||(this.activeDescendant=void 0,this.open=!0)}handleMenuChange(e){const{target:t}=e,i=(this.options||this.optionEls).find(s=>s.value===(t==null?void 0:t.value));this.value=(i==null?void 0:i.itemText)||"",e.preventDefault(),this.open=!1,this._returnItems(),this.focus()}handleClosed(){this.open=!1,this.overlayOpen=!1}handleOpened(){}toggleOpen(){if(this.readonly||this.pending){this.open=!1;return}this.open=!this.open,this.inputElement.focus()}shouldUpdate(e){var t,i;return e.has("open")&&(this.open?this.overlayOpen=!0:this.activeDescendant=void 0),e.has("value")&&(this.filterAvailableOptions(),this.itemValue=(i=(t=this.availableOptions.find(s=>s.itemText===this.value))==null?void 0:t.value)!=null?i:""),super.shouldUpdate(e)}onBlur(e){e.relatedTarget&&(this.contains(e.relatedTarget)||this.shadowRoot.contains(e.relatedTarget))||super.onBlur(e)}renderVisuallyHiddenLabels(){const e=this.label||this.appliedLabel;return l`
      ${this.pending?l`
          ...
          `:b}
      ${this.value?l`
            <span aria-hidden="true" class="visually-hidden" id="applied-label">
              ${e}
            </span>
    ...
    `}render(){return this.tooltipEl&&(this.tooltipEl.disabled=this.open),l`
      ...
      ></slot>
    `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("focusout",t=>{const i=t.relatedTarget&&this.contains(t.relatedTarget);t.target===this&&!i&&(this.focused=!1)}),this.resizeObserver=new ResizeObserver(t=>{this.fieldWidth=t[0].borderBoxSize[0].inlineSize}),this.resizeObserver.observe(this)}async manageListOverlay(){this.open&&(this.focused=!0,this.focus())}updated(e){var s;e.has("open")&&!this.pending&&this.manageListOverlay(),!this.focused&&this.open&&(this.open=!1),e.has("pending")&&this.pending&&(this.open=!1),this.activeDescendant!==this._previousActiveDescendant&&(this._previousActiveDescendant&&typeof this._previousActiveDescendant.focused!="undefined"&&(this._previousActiveDescendant.focused=!1),this.activeDescendant&&typeof this.activeDescendant.focused!="undefined"&&(this.activeDescendant.focused=!0),this._previousActiveDescendant=this.activeDescendant);const t=e.has("options"),i=this.optionEls!==this._previousOptionEls;(t||i)&&((s=this.options)!=null&&s.every(r=>r.disabled)&&(this.disabled=!0),this.availableOptions=this.options||this.optionEls,i&&(this._previousOptionEls=this.optionEls))}async getUpdateComplete(){const e=await super.getUpdateComplete(),t=this.shadowRoot.querySelector("#listbox");if(t){const i=[...t.children];await Promise.all(i.map(s=>s.updateComplete))}return e}connectedCallback(){super.connectedCallback(),this.itemObserver||(this.itemObserver=new MutationObserver(this.setOptionsFromSlottedItems.bind(this)))}disconnectedCallback(){var e;this.itemObserver.disconnect(),this.open=!1,(e=this.resizeObserver)==null||e.disconnect(),this.resizeObserver=void 0,super.disconnectedCallback()}}a([p()],Combobox.prototype,"activeDescendant",2),a([d({type:String})],Combobox.prototype,"autocomplete",2),a([p()],Combobox.prototype,"availableOptions",2),a([d({type:Boolean,reflect:!0})],Combobox.prototype,"open",2),a([d({type:Boolean,reflect:!0})],Combobox.prototype,"pending",2),a([d({type:String,attribute:"pending-label"})],Combobox.prototype,"pendingLabel",2),a([c("slot:not([name])")],Combobox.prototype,"optionSlot",2),a([p()],Combobox.prototype,"overlayOpen",2),a([c("#input")],Combobox.prototype,"input",2),a([d({type:Array})],Combobox.prototype,"options",2),a([p()],Combobox.prototype,"optionEls",2),a([p()],Combobox.prototype,"fieldWidth",2);
