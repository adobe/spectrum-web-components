 ...
 */
export declare function calculateScrollTargetForRightSide(index: number, direction: CSSStyleDeclaration['direction'], tabs: Tab[], container: HTMLDivElement): number;
/**
