"use strict";var v=Object.defineProperty;var b=Object.getOwnPropertyDescriptor;var r=(c,l,n,e)=>{for(var i=e>1?void 0:e?b(l,n):l,o=c.length-1,a;o>=0;o--)(a=c[o])&&(i=(e?a(l,n,i):a(i))||i);return e&&i&&v(l,n,i),i};import{html as t,nothing as u}from"@spectrum-web-components/base";import{property as s}from"@spectrum-web-components/base/src/decorators.js";import{when as p}from"@spectrum-web-components/base/src/directives.js";import{join as T}from"@spectrum-web-components/base/src/directives.js";import{ifDefined as y}from"@spectrum-web-components/base/src/directives.js";import f from"@spectrum-web-components/icon/src/spectrum-icon-chevron.css.js";import{Popover as g}from"@spectrum-web-components/popover";import"@spectrum-web-components/icons-ui/icons/sp-icon-chevron200.js";import"@spectrum-web-components/asset/sp-asset.js";import"@spectrum-web-components/button/sp-button.js";import"@spectrum-web-components/button-group/sp-button-group.js";import $ from"./coachmark.css.js";import{MediaType as A}from"./CoachmarkItem.js";export class Coachmark extends g{constructor(){super(...arguments);this.placement="right";this.modifierKeys=[];this.hasAsset=!1;this.renderSecondaryButton=()=>t`
      <sp-button
        treatment="outline"
        variant="secondary"
    ...
    `}static get styles(){return[...super.styles,$,f]}renderMedia(){var e;return this.mediaType===A.IMAGE?t`
    ...
    `}renderHeader(){var o,a,d,m;const n=this.modifierKeys&&((o=this.modifierKeys)==null?void 0:o.length)>0,e=!!this.shortcutKey,i=!!((a=this.content)!=null&&a.title);return!i&&!n&&!e?t`
      ...
      ${n||e?t`
            <kbd class="keys spectrum-Body spectrum-Body--sizeS">
              ${n?T((m=this.modifierKeys)==null?void 0:m.map(h=>this.renderModifier(h)),this.renderJoiner()):u}
    ...
    `}handlePrimaryCTA(){this.dispatchEvent(new Event("primary",{bubbles:!0,composed:!0}))}handleSecondaryCTA(){this.dispatchEvent(new Event("secondary",{bubbles:!0,composed:!0}))}renderButtons(){return t`
      ...
      <sp-button-group class="spectrum-ButtonGroup buttongroup-mobile" size="s">
