"use strict";var u=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var i=(d,a,e,t)=>{for(var r=t>1?void 0:t?p(a,e):a,o=d.length-1,n;o>=0;o--)(n=d[o])&&(r=(t?n(a,e,r):n(r))||r);return t&&r&&u(a,e,r),r};import{html as l,SizedMixin as h}from"@spectrum-web-components/base";import{property as s}from"@spectrum-web-components/base/src/decorators.js";import{ifDefined as b,when as c}from"@spectrum-web-components/base/src/directives.js";import m from"@spectrum-web-components/icon/src/spectrum-icon-dash.css.js";import v from"@spectrum-web-components/opacity-checkerboard/src/opacity-checkerboard.css.js";import{Focusable as f}from"@spectrum-web-components/shared/src/focusable.js";import"@spectrum-web-components/icons-ui/icons/sp-icon-dash75.js";import"@spectrum-web-components/icons-ui/icons/sp-icon-dash100.js";import"@spectrum-web-components/icons-ui/icons/sp-icon-dash200.js";import"@spectrum-web-components/icons-ui/icons/sp-icon-dash300.js";import y from"./swatch.css.js";const C={xs:()=>l`
    <sp-icon-dash75
      slot="icon"
  ...
  `,l:()=>l`
    ...
    ></sp-icon-dash300>
  `};export class Swatch extends h(f,{validSizes:["xs","s","m","l"],noDefaultSize:!0}){constructor(){super(...arguments);this.color="";this.label="";this.mixedValue=!1;this.nothing=!1;this.role="button";this.selected=!1;this.renderDisabled=()=>l`
      <svg
