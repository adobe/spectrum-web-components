      ...
      <div class="wrapper" role=${u(e)}>
        ...
        ${this.toggles?t`
              ...
              >
                ...
                >
                  <span class="sr-only">${this.label||this.heading}</span>
                </sp-checkbox>
              </sp-popover>
            `:r}
        ${this.variant==="quiet"&&this.size==="s"?t`
