"use strict";var a=Object.defineProperty;var p=Object.getOwnPropertyDescriptor;var o=(s,r,e,i)=>{for(var t=i>1?void 0:i?p(r,e):r,l=s.length-1,d;l>=0;l--)(d=s[l])&&(t=(i?d(r,e,t):d(t))||t);return i&&t&&a(r,e,t),t};import{html as u,SpectrumElement as m}from"@spectrum-web-components/base";import{property as n}from"@spectrum-web-components/base/src/decorators.js";import c from"./sidenav-heading.css.js";import h from"./sidenav-item.css.js";export class SideNavHeading extends m{constructor(){super(...arguments);this.label=""}static get styles(){return[h,c]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return u`
