"use strict";var n=Object.defineProperty;var u=Object.getOwnPropertyDescriptor;var r=(a,s,e,i)=>{for(var t=i>1?void 0:i?u(s,e):s,o=a.length-1,p;o>=0;o--)(p=a[o])&&(t=(i?p(s,e,t):p(t))||t);return i&&t&&n(s,e,t),t};import{html as b,nothing as d,SizedMixin as h,SpectrumElement as c}from"@spectrum-web-components/base";import{property as l,query as m}from"@spectrum-web-components/base/src/decorators.js";import{LanguageResolutionController as v}from"@spectrum-web-components/reactive-controllers/src/LanguageResolution.js";import{getLabelFromSlot as f}from"@spectrum-web-components/shared/src/get-label-from-slot.js";import{ObserveSlotText as g}from"@spectrum-web-components/shared/src/observe-slot-text.js";import"@spectrum-web-components/field-label/sp-field-label.js";import y from"./meter.css.js";export const meterVariants=["positive","notice","negative"];export class Meter extends h(g(c,""),{noDefaultSize:!0}){constructor(){super(...arguments);this.progress=0;this._variant="";this.label="";this.languageResolver=new v(this);this.sideLabel=!1}static get styles(){return[y]}set variant(e){if(e===this.variant)return;const i=this.variant;meterVariants.includes(e)?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",i)}get variant(){return this._variant}render(){return b`
