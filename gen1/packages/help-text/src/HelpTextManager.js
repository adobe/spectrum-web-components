"use strict";import{html as s}from"@spectrum-web-components/base";import{conditionAttributeWithId as l}from"@spectrum-web-components/base/src/condition-attribute-with-id.js";import{ifDefined as a}from"@spectrum-web-components/base/src/directives.js";import{randomID as n}from"@spectrum-web-components/shared/src/random-id.js";export class HelpTextManager{constructor(e,{mode:i}={mode:"internal"}){this.mode="internal";this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)};this.host=e,this.id=`sp-help-text-${n()}`,this.mode=i}get isInternal(){return this.mode==="internal"}render(e){return s`
      <div
        id=${a(this.isInternal?this.id:void 0)}
        aria-live="assertive"
      >
        <slot
