  ...
  render() {
    return html`
      ...
      this.quickActionsEnabled = !this.quickActionsEnabled;
        ...
        ${cache(
      this.quickActionsEnabled ? this.renderQuickActionsButton() : html``
    )}
      </div>
    `;
  }
...
__decorateClass([
  state()
], ManagedOverlayTrigger.prototype, "quickActionsEnabled", 2);
__decorateClass([
  state()
], ManagedOverlayTrigger.prototype, "isMenuOpen", 2);
