...
class ScrollForcer extends HTMLElement {
  constructor() {
    ...
    this.doScroll = async () => {
      var _a2;
      (_a2 = this.previousElementSibling) == null ? void 0 : _a2.addEventListener("sp-opened", this.doScroll);
      await nextFrame();
      await nextFrame();
      await nextFrame();
      await nextFrame();
...
export const virtualElementV1 = (args) => {
  const contextMenuTemplate = (kind = "") => html`
    ...
    if (event.target.localName === "sp-menu-item") {
      (_a2 = event.target) == null ? void 0 : _a2.dispatchEvent(new Event("close", { bubbles: true }));
    }
  }}
    >
      <sp-menu>
...
export const hoverWithInteractiveContent = () => {
  return html`
    <div
