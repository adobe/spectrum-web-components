...
const _Overlay = class _Overlay extends ComputedOverlayBase {
  constructor() {
    ...
    this.closeOnFocusOut = (event) => {
      ...
      event.relatedTarget.addEventListener(relationEvent.type, (event2) => {
  ...
  returnFocus() {
    ...
    if (this.receivesFocus !== "false" && !!((_a = this.triggerElement) == null ? void 0 : _a.focus) && (this.contains(this.getRootNode().activeElement) || getAncestors().includes(this) || // eslint-disable-next-line swc/document-active-element
