...
describe("sp-overlay", () => {
  ...
  describe('[type="modal"]', () => {
    ...
    describe("interaction with other non-ancestor overlays", function() {
      beforeEach(async function() {
        ...
        `);
        this.modal = this.fixture.querySelector('[type="modal"]');
        this.page = this.fixture.querySelector('[type="page"]');
        this.hint = this.fixture.querySelector('[type="hint"]');
        this.auto = this.fixture.querySelector('[type="auto"]');
        this.manual = this.fixture.querySelector('[type="manual"]');
    ...
    describe("stacked sibling modal overlays", function() {
      it("keeps first modal visible when second sibling modal opens", async function() {
        const fixture2 = await styledFixture(html`
          <div>
        ...
        `);
        const modal1 = fixture2.querySelector(".modal-1");
        const modal2 = fixture2.querySelector(".modal-2");
  ...
  describe('[type="hint"]', () => {
    ...
    it("stays open when pointer enters overlay from trigger element", async () => {
      ...
      const overlay = test.querySelector("sp-overlay");
