...
export class NumberField extends TextfieldBase {
  ...
  handleInput(event) {
    ...
    if (this.numberParser.isValidPartialNumber(value)) {
      ...
      const justBecameTruncated = this.truncatedValueTooltipController.refresh();
      if (justBecameTruncated) {
        this.updateComplete.then(() => {
          var _a2, _b2;
          this.truncatedValueTooltipController.syncTooltipText(
            (_b2 = (_a2 = this.inputElement) == null ? void 0 : _a2.value) != null ? _b2 : this.displayValue
          );
        });
      } else {
        this.truncatedValueTooltipController.syncTooltipText(
          (_c = (_b = this.inputElement) == null ? void 0 : _b.value) != null ? _c : this.displayValue
        );
      }
      return;
    } else {
