...
describe("ColorArea", () => {
  ...
  it("provides separate aria-labels for X and Y inputs", async () => {
    ...
    expect(inputX == null ? void 0 : inputX.getAttribute("aria-roledescription")).to.equal("2d slider");
    expect(inputY == null ? void 0 : inputY.getAttribute("aria-roledescription")).to.equal("2d slider");
