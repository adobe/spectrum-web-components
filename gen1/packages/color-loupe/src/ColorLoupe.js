"use strict";var u=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var i=(l,r,t,o)=>{for(var e=o>1?void 0:o?c(r,t):r,s=l.length-1,p;s>=0;s--)(p=l[s])&&(e=(o?p(r,t,e):p(e))||e);return o&&e&&u(r,t,e),e};import{html as d,SpectrumElement as m}from"@spectrum-web-components/base";import{property as a}from"@spectrum-web-components/base/src/decorators.js";import n from"@spectrum-web-components/opacity-checkerboard/src/opacity-checkerboard.css.js";import C from"./color-loupe.css.js";export class ColorLoupe extends m{constructor(){super(...arguments);this.open=!1;this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[n,C]}render(){return d`
