...
describe("LanguageResolutionController", () => {
  ...
  it("cleans up observer when all controllers disconnect", async () => {
    ...
    `);
    const elA = wrapper.querySelector("#a");
    const elB = wrapper.querySelector("#b");
    elA.remove();
    elB.remove();
  ...
  it("ignores <html lang> when a provider is active", async () => {
    ...
    `);
    const el = wrapper.querySelector("test-lang-host");
...
//# sourceMappingURL=language-resolution.test.js.map
