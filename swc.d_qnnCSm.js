import{t as e,s as t}from"./swc.Chuw36y7.js";import{D as i}from"./swc.BECgeGB4.js";import{I as s}from"./swc.Bea_DqvJ.js";import{x as l}from"./swc.DWYvVEd1.js";import{d as r}from"./swc.JlveB6nj.js";import{I as a}from"./swc.DTMcg2PZ.js";r("sp-icon-help-outline",class extends s{render(){return t(l),1===this.spectrumVersion?(({width:t=24,height:i=24,hidden:s=!1,title:l="Help Outline"}={})=>e`<svg
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label}):i({hidden:!this.label,title:this.label})}});const h=({width:t=24,height:i=24,hidden:s=!1,title:l="Info Outline"}={})=>e`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${i}"
    viewBox="0 0 36 36"
  ...
  >
    ...
    />
  </svg>`;r("sp-icon-info-outline",class extends s{render(){return t(l),1===this.spectrumVersion?h({hidden:!this.label,title:this.label}):a({hidden:!this.label,title:this.label})}});export{h as I};
//# sourceMappingURL=swc.BCph568v.js.map
