import{i as e}from"./d230bd74.js";import{o as t,t as r,b as a}from"./26d112e5.js";import{S as i,y as s,e as n}from"./d036ac45.js";import{M as o}from"./c26bb63f.js";import{o as g}from"./6d656805.js";import{t as l}from"./cfcd457b.js";var m=[t,r,e`
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?f(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&v(t,r,s),s};const b=class extends o{constructor(){super(),b.instances+=1,this.headerId=`sp-menu-group-label-${b.instances}`}static get styles(){return[...super.styles,x]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return s`
        ...
        `}};let z=b;z.instances=0,y([g("header",!0)],z.prototype,"headerElements",2),y([l()],z.prototype,"headerElement",2),customElements.define("sp-menu-group",z);export{m as h};
//# sourceMappingURL=478526cf.js.map
