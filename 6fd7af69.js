import{t,s as h}from"./7b3008bb.js";import{I as r,x as e,d as i}from"./cd228091.js";i("sp-icon-show-menu",class extends r{render(){return h(e),(({width:h=24,height:r=24,hidden:e=!1,title:i="Show Menu"}={})=>t`<svg
  ...
  </svg>`)({hidden:!this.label,title:this.label})}});i("sp-icon-copy",class extends r{render(){return h(e),(({width:h=24,height:r=24,hidden:e=!1,title:i="Copy"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${r}
    viewBox="0 0 36 36"
    width=${h}
...
//# sourceMappingURL=6fd7af69.js.map
