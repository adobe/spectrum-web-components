import{i as e}from"./112b2095.js";import{o as t,t as s,b as a}from"./830f4e22.js";import{S as i,x as n,n as r,d as g}from"./b46b846d.js";import{M as d}from"./e041fd5a.js";import{o}from"./47d38ea1.js";import{t as m}from"./915dab83.js";var h=[t,s,e`
...
);pointer-events:var(--mod-illustrated-message-description-pointer-events);position:var(--mod-illustrated-message-description-position);z-index:var(--mod-illustrated-message-description-z-index)}::slotted(svg[viewBox]){width:100%}
`,c=Object.defineProperty,p=Object.getOwnPropertyDescriptor,u=(e,t,s,a)=>{for(var i,n=a>1?void 0:a?p(t,s):t,r=e.length-1;r>=0;r--)(i=e[r])&&(n=(a?i(t,s,n):i(n))||n);return a&&n&&c(t,s,n),n};class f extends i{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[h,a,l]}render(){return n`
        ...
        `}}f.is="sp-illustrated-message",u([r()],f.prototype,"heading",2),u([r()],f.prototype,"description",2),g("sp-illustrated-message",f);var v=e`
.header{color:var(
...
`,y=Object.defineProperty,H=Object.getOwnPropertyDescriptor,z=(e,t,s,a)=>{for(var i,n=a>1?void 0:a?H(t,s):t,r=e.length-1;r>=0;r--)(i=e[r])&&(n=(a?i(t,s,n):i(n))||n);return a&&n&&y(t,s,n),n};class w extends d{constructor(){super(...arguments),this.headerId=""}static get styles(){return[...super.styles,v]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){this.headerId=this.headerId||`sp-menu-group-label-${crypto.randomUUID().slice(0,8)}`;const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return n`
            <span class="header" ?hidden=${!this.headerElement}>
                <slot name="header" @slotchange=${this.updateLabel}></slot>
            </span>
            <sp-menu ignore>${this.renderMenuItemSlot()}</sp-menu>
        `}}z([o({slot:"header",flatten:!0})],w.prototype,"headerElements",2),z([m()],w.prototype,"headerElement",2),g("sp-menu-group",w);export{h};
//# sourceMappingURL=5750d2eb.js.map
