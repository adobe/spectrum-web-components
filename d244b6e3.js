import"./053a2895.js";import{r as t}from"./e50c5e8d.js";import{l as e,i as o,S as r}from"./d07a663a.js";import{I as c,$ as n,e as s,S as l,w as p}from"./8dfa8611.js";class a{constructor(){this.iconsetMap=new Map}static getInstance(){return a.instance||(a.instance=new a),a.instance}addIconset(t,e){this.iconsetMap.set(t,e);const o=new CustomEvent("sp-iconset-added",{bubbles:!0,composed:!0,detail:{name:t,iconset:e}});setTimeout((()=>window.dispatchEvent(o)),0)}removeIconset(t){this.iconsetMap.delete(t);const e=new CustomEvent("sp-iconset-removed",{bubbles:!0,composed:!0,detail:{name:t}});setTimeout((()=>window.dispatchEvent(e)),0)}getIconset(t){return this.iconsetMap.get(t)}}var i=Object.defineProperty,h=Object.getOwnPropertyDescriptor,u=(t,e,o,r)=>{for(var c,n=r>1?void 0:r?h(e,o):e,s=t.length-1;s>=0;s--)(c=t[s])&&(n=(r?c(e,o,n):c(n))||n);return r&&n&&i(e,o,n),n};class m extends c{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?n`<div id="container"></div>`:this.src?n`<img src="${this.src}" alt="${e(this.label)}">`:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=a.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",r=t;return e.length>1&&(o=e[0],r=e[1]),{iconset:o,icon:r}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}u([s()],m.prototype,"src",2),u([s()],m.prototype,"name",2),u([o("#container")],m.prototype,"iconContainer",2);var d=t`:host{--spectrum-helptext-line-height:var(
...
)}`,x=Object.defineProperty,v=Object.getOwnPropertyDescriptor,f=(t,e,o,r)=>{for(var c,n=r>1?void 0:r?v(e,o):e,s=t.length-1;s>=0;s--)(c=t[s])&&(n=(r?c(e,o,n):c(n))||n);return r&&n&&x(e,o,n),n};class g extends(r(l)){constructor(){super(...arguments),this.icon=!1,this.variant="neutral"}static get styles(){return[d]}render(){return n`${"negative"===this.variant&&this.icon?n`<sp-icon-alert class="icon"></sp-icon-alert>`:p}<div class="text"><slot></slot></div>`}}f([s({type:Boolean,reflect:!0})],g.prototype,"icon",2),f([s({reflect:!0})],g.prototype,"variant",2),customElements.define("sp-help-text",g),customElements.define("sp-icon",m);export{a as I};
//# sourceMappingURL=d244b6e3.js.map
