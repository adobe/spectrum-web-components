import{t,s as i}from"./swc.CJygKO7k.js";import{I as e}from"./swc.DuRNRohl.js";import{x as l}from"./swc.BkWj9Vim.js";import{d as s}from"./swc.JlveB6nj.js";s("sp-icon-edit",class extends e{render(){return i(l),2===this.spectrumVersion?(({width:i=24,height:e=24,hidden:l=!1,title:s="Edit"}={})=>t`<svg
    data-name="ICONS"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:i=24,height:e=24,hidden:l=!1,title:s="Edit"}={})=>t`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${i}"
...
//# sourceMappingURL=swc.2VlCjBSS.js.map
