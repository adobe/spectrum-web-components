import{f as e,S as t}from"./476ad418.js";import{i as r}from"./112b2095.js";import"./1880ba0f.js";import{S as o}from"./d611ff6d.js";import{T as i,A as c,x as a,n as s,d as l}from"./1a13da4f.js";import"./d039d003.js";import{c as n,t as d}from"./eb03f57e.js";import{l as u,F as p,i as m}from"./357ae97e.js";import"./0ea34b92.js";import"./20e08d65.js";import{S as h}from"./9ddc847e.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./6215f5e7.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
//# sourceMappingURL=5f8cb838.js.map
