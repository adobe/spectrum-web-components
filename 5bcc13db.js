import"./364bf8e2.js";import{f as a}from"./27e6a3fc.js";import{M as t}from"./10665a67.js";import{i as r}from"./112b2095.js";import{S as i,x as e,n as o,d as n}from"./1a13da4f.js";import{i as s}from"./bd99a3f7.js";var m=r`
...
`,c=Object.defineProperty,l=Object.getOwnPropertyDescriptor,u=(a,t,r,i)=>{for(var e,o=i>1?void 0:i?l(t,r):t,n=a.length-1;n>=0;n--)(e=a[n])&&(o=(i?e(t,r,o):e(o))||o);return i&&o&&c(t,r,o),o};class p extends i{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new t(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[m,d]}focus(){const t=a(this);t?t.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(a){a.has("open")&&void 0!==a.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise((a=>{this.resolveTransitionPromise=()=>{this.animating=!1,a()}}))),super.update(a)}render(){return e`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
...
//# sourceMappingURL=5bcc13db.js.map
