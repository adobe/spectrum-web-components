import{i as t,a as e}from"./6a9914b1.js";import{i as r}from"./112b2095.js";import{n as o,S as a}from"./c34bcf8e.js";import{x as s,A as i}from"./e6d35ea0.js";import{d as c}from"./25a3ae37.js";import{O as n}from"./e71a182c.js";import{O as l}from"./8a41e3f5.js";import{F as d,a as m,L as p}from"./928f07c5.js";import{s as u}from"./ff8e484a.js";import{R as h}from"./39665332.js";import{o as v}from"./35c49a55.js";import{S as b}from"./01b2daba.js";import{l as g}from"./660f0d27.js";import{i as f}from"./17348440.js";import"./7095775e.js";import"./70b34bd5.js";import"./bbf26e9d.js";import"./7a32f6e0.js";import"./11e95bba.js";import"./788df416.js";import"./6110b674.js";import{M as y}from"./4ad9c6d1.js";import"./7b83ff35.js";import"./8d471f7b.js";import{h as w}from"./41596aba.js";import{o as k,t as z}from"./f2f417a1.js";import"./2e19a3e5.js";import{e as x}from"./c796803b.js";import"./5de01d28.js";import"./7923bf55.js";import"./25383a57.js";import"./16ab2288.js";import"./4a4b0658.js";import"./162d17ac.js";import"./0f7ffad2.js";import"./d6d0b127.js";import"./41a5d618.js";import"./a14259bb.js";import"./e65ed193.js";import"./e0584556.js";import"./bdc657fb.js";import"./892cde6d.js";import"./d11544d8.js";var D=r`
...
`,E=Object.defineProperty,I=Object.getOwnPropertyDescriptor,A=(t,e,r,o)=>{for(var a,s=o>1?void 0:o?I(e,r):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(o?a(e,r,s):a(s))||s);return o&&s&&E(e,r,s),s};const P=class t extends(d(n(l(a,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[$]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return s`
            ${this.hasIcon?s`
                      <slot name="icon"></slot>
                  `:i}
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+t.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};P.instanceCount=0,A([o({type:Boolean,reflect:!0})],P.prototype,"disabled",2),A([o({reflect:!0})],P.prototype,"label",2),A([o({type:Boolean,reflect:!0})],P.prototype,"selected",2),A([o({type:Boolean,reflect:!0})],P.prototype,"vertical",2),A([o({type:String,reflect:!0})],P.prototype,"value",2),c("sp-tab",P);var O=r`
...
`,Y=Object.defineProperty,G=Object.getOwnPropertyDescriptor,N=(t,e,r,o)=>{for(var a,s=o>1?void 0:o?G(e,r):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(o?a(e,r,s):a(s))||s);return o&&s&&Y(e,r,s),s};class Q extends(p(m)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[$,K]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return s`
            <a
                id="item-label"
                href=${g(this.href)}
        ...
        `}updated(t){super.updated(t),this.value=this.anchor.href}}N([f("a")],Q.prototype,"anchor",2),N([o({type:Boolean,reflect:!0})],Q.prototype,"selected",2),c("sp-top-nav-item",Q);var W=r`
...
`,J=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,tt=(t,e,r,o)=>{for(var a,s=o>1?void 0:o?Z(e,r):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(o?a(e,r,s):a(s))||s);return o&&s&&J(e,r,s),s};class et extends(y(a,{mode:"external"})){constructor(){super(...arguments),this.horizontal=!1,this.invalid=!1,this.label="",this.vertical=!1}static get styles(){return[W]}handleSlotchange(){}render(){return s`
...
`,nt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,dt=(t,e,r,o)=>{for(var a,s=o>1?void 0:o?lt(e,r):e,i=t.length-1;i>=0;i--)(a=t[i])&&(s=(o?a(e,r,s):a(s))||s);return o&&s&&nt(e,r,s),s};class mt extends a{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[ct]}render(){return s`
            <slot></slot>
        `}}dt([o({type:Boolean,reflect:!0})],mt.prototype,"opened",2),dt([o({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],mt.prototype,"textOnly",2),c("sp-quick-actions",mt);var pt=r`
