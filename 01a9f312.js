import{r as t}from"./e50c5e8d.js";import{S as e,$ as i,e as o}from"./2310c663.js";import{F as a,O as r,b as s,S as c,a as l,l as n,i as d,L as m}from"./a07dea85.js";import{R as b}from"./e2955272.js";import"./d17b22da.js";import"./b5709ed3.js";import"./a7ac3464.js";import"./2fca06e6.js";import{Overlay as u}from"./0542fa8e.js";import"./44d73288.js";document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:i}=e,{pathname:o}=location,a=o.search("api")>-1;switch(i){case"api":{if(a)return;const t=(o+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!a)return;const t=o.split("/api")[0]+"/";history.pushState({},document.title,t);break}}}));var p=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,h=Object.defineProperty,v=Object.getOwnPropertyDescriptor,x=(t,e,i,o)=>{for(var a,r=o>1?void 0:o?v(e,i):e,s=t.length-1;s>=0;s--)(a=t[s])&&(r=(o?a(e,i,r):a(r))||r);return o&&r&&h(e,i,r),r};const g=class extends e{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return i`
            <slot></slot>
...
`,k=Object.defineProperty,z=Object.getOwnPropertyDescriptor,q=(t,e,i,o)=>{for(var a,r=o>1?void 0:o?z(e,i):e,s=t.length-1;s>=0;s--)(a=t[s])&&(r=(o?a(e,i,r):a(r))||r);return o&&r&&k(e,i,r),r};const w=class extends(a(r(s(e,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[f]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}handleContentChange(){this.dispatchEvent(new Event("sp-tab-contentchange",{bubbles:!0,composed:!0}))}render(){return i`
            ${this.hasIcon?i`
                      <slot name="icon"></slot>
                  `:i``}
...
`,D=Object.defineProperty,F=Object.getOwnPropertyDescriptor,X=(t,e,i,o)=>{for(var a,r=o>1?void 0:o?F(e,i):e,s=t.length-1;s>=0;s--)(a=t[s])&&(r=(o?a(e,i,r):a(r))||r);return o&&r&&D(e,i,r),r};class _ extends(m(l)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[f,R]}handleContentChange(){this.dispatchEvent(new Event("sp-top-nav-item-contentchange",{bubbles:!0,composed:!0}))}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return i`
            <a
                id="item-label"
                href=${n(this.href)}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.shadowRoot.addEventListener("slotchange",this.handleContentChange)}updated(t){super.updated(t),t.has("label")&&void 0!==t.get("label")&&this.handleContentChange(),this.value=this.anchor.href}}X([d("a")],_.prototype,"anchor",2),X([o({type:Boolean,reflect:!0})],_.prototype,"selected",2),customElements.define("sp-top-nav-item",_),"requestIdleCallback"in window?requestIdleCallback((()=>import("./d781aa71.js"))):requestAnimationFrame((()=>import("./d781aa71.js"))),window.Overlay=u;class Y extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}}customElements.define("styled-element",Y),null===(U=document.querySelector('sp-tab-panel[value="api"]'))||void 0===U||U.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"tr"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));
//# sourceMappingURL=01a9f312.js.map
