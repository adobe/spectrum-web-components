...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var Et=D`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Dash50{height:var(--spectrum-alias-ui-icon-dash-size-50);width:var(
...
--spectrum-quickactions-height,var(--spectrum-global-dimension-size-500)
);position:absolute;top:var(--spectrum-card-actions-margin);visibility:hidden}:host([dir=ltr]) .quickActions{left:var(
...
)}@media (forced-colors:active){:host{--spectrum-colorloupe-outer-border-color:CanvasText}}svg{height:inherit;width:inherit}`;class Gt extends f{constructor(){super(...arguments),this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[Kt]}render(){return c`<svg><g transform="translate(1 1)"><path class="inner" d="M24,0A24,24,0,0,1,48,24c0,16.255-24,40-24,40S0,40.255,0,24A24,24,0,0,1,24,0Z" fill="${this.color}"/><path class="outer" d="M24,2A21.98,21.98,0,0,0,2,24c0,6.2,4,14.794,11.568,24.853A144.233,144.233,0,0,0,24,61.132,144.085,144.085,0,0,0,34.4,48.893C41.99,38.816,46,30.209,46,24A21.98,21.98,0,0,0,24,2m0-2A24,24,0,0,1,48,24c0,16.255-24,40-24,40S0,40.255,0,24A24,24,0,0,1,24,0Z"/></g></svg>`}}d([u({type:Boolean,reflect:!0})],Gt.prototype,"open",void 0),d([u({type:String})],Gt.prototype,"color",void 0),customElements.define("sp-color-loupe",Gt);var Xt=D`:host{--spectrum-colorhandle-animation-duration:var(
--spectrum-global-animation-duration-100,130ms
...
)}:host{height:calc(100vh - var(--swc-body-margins-block,0 * 1px));width:calc(100vw - var(--swc-body-margins-inline,0 * 1px))}`;class Le extends(E(f)){constructor(){super(...arguments),this.error=!1,this.cancelLabel="",this.confirmLabel="",this.dismissable=!1,this.footer="",this.hero="",this.heroLabel="",this.noDivider=!1,this.open=!1,this.secondaryLabel="",this.headline="",this.responsive=!1,this.underlay=!1}static get styles(){return[Se]}focus(){if(this.shadowRoot){const t=j(this.shadowRoot);t?(t.updateComplete?t.updateComplete.then((()=>t.focus())):t.focus(),this.removeAttribute("tabindex")):this.dialog.focus()}else super.focus()}dismiss(){this.dismissable&&this.close()}clickSecondary(){this.dispatchEvent(new Event("secondary",{bubbles:!0}))}clickCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}clickConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}close(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0}))}render(){return c`${this.underlay?c`<sp-underlay ?open="${this.open}" @click="${this.dismiss}"></sp-underlay>`:c``}<div class="modal ${this.mode}"><sp-dialog ?dismissable="${this.dismissable}" ?no-divider="${this.noDivider}" ?error="${this.error}" mode="${n(this.mode?this.mode:void 0)}" size="${n(this.size?this.size:void 0)}" @close="${this.close}">${this.hero?c`<img src="${this.hero}" slot="hero" aria-hidden="${n(this.heroLabel?void 0:"true")}" alt="${n(this.heroLabel?this.heroLabel:void 0)}">`:c``} ${this.headline?c`<h2 slot="heading">${this.headline}</h2>`:c``}<slot></slot>${this.footer?c`<div slot="footer">${this.footer}</div>`:c``} ${this.secondaryLabel?c`<sp-button variant="primary" slot="button" @click="${this.clickSecondary}">${this.secondaryLabel}</sp-button>`:c``} ${this.cancelLabel?c`<sp-button variant="secondary" slot="button" @click="${this.clickCancel}">${this.cancelLabel}</sp-button>`:c``} ${this.confirmLabel?c`<sp-button variant="cta" slot="button" @click="${this.clickConfirm}">${this.confirmLabel}</sp-button>`:c``}</sp-dialog></div>`}updated(t){t.has("open")&&this.open&&this.dialog.updateComplete.then((()=>{this.dialog.shouldManageTabOrderForScrolling()}))}}d([u({type:Boolean,reflect:!0})],Le.prototype,"error",void 0),d([u({attribute:"cancel-label"})],Le.prototype,"cancelLabel",void 0),d([u({attribute:"confirm-label"})],Le.prototype,"confirmLabel",void 0),d([u({type:Boolean,reflect:!0})],Le.prototype,"dismissable",void 0),d([u()],Le.prototype,"footer",void 0),d([u()],Le.prototype,"hero",void 0),d([u({attribute:"hero-label"})],Le.prototype,"heroLabel",void 0),d([u({type:Boolean,reflect:!0,attribute:"no-divider"})],Le.prototype,"noDivider",void 0),d([u({type:Boolean,reflect:!0})],Le.prototype,"open",void 0),d([u({type:String,reflect:!0})],Le.prototype,"mode",void 0),d([u({type:String,reflect:!0})],Le.prototype,"size",void 0),d([u({attribute:"secondary-label"})],Le.prototype,"secondaryLabel",void 0),d([u()],Le.prototype,"headline",void 0),d([u({type:Boolean})],Le.prototype,"responsive",void 0),d([u({type:Boolean})],Le.prototype,"underlay",void 0),d([p("sp-dialog")],Le.prototype,"dialog",void 0),customElements.define("sp-dialog-wrapper",Le);var Ae=D`:host{border-radius:var(
...
)}`;class Lr extends($(f)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Sr]}render(){return c`<slot></slot>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}d([u({type:Boolean,reflect:!0})],Lr.prototype,"disabled",void 0),d([u({reflect:!0})],Lr.prototype,"variant",void 0),customElements.define("sp-status-light",Lr);var Ar=D`:host{--spectrum-switch-handle-size:var(
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var Er=D`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class qr extends Lt{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[Ar,Er]:[Ar]}render(){return c`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("role","switch")}updated(t){t.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}d([u({type:Boolean,reflect:!0})],qr.prototype,"emphasized",void 0),customElements.define("sp-switch",qr);var Mr=D`:host{box-sizing:border-box;cursor:pointer;height:var(--spectrum-tabs-item-height);line-height:var(--spectrum-tabs-item-height);outline:0;position:relative;text-decoration:none;transition:color var(--spectrum-global-animation-duration-100,.13s) ease-out;white-space:nowrap;z-index:1}:host([disabled]){cursor:default}:host([disabled]) #itemLabel{cursor:default}:host(:not([vertical])) ::slotted([slot=icon]){height:var(
...
))/2);align-items:center;display:flex;flex-direction:column;height:auto!important;justify-content:center}:host([vertical]):before{bottom:0;height:auto;left:calc(-1*var(--spectrum-tabs-focus-ring-size,var(--spectrum-alias-border-size-thick)));margin-top:0!important;right:calc(-1*var(--spectrum-tabs-focus-ring-size,var(--spectrum-alias-border-size-thick)));top:0}:host([vertical]) ::slotted([slot=icon]){flex-shrink:0;margin-top:var(--sp-tab-vertial-margin-y)}:host(:not([vertical])) ::slotted([slot=icon]){height:100%}:host([dir][vertical]) slot[name=icon]+#itemLabel{font-size:var(
...
)}:host{--spectrum-tabs-compact-item-height:calc(var(--spectrum-tabs-compact-quiet-height) - var(--spectrum-tabs-divider-size))}#list{display:flex;margin:0;padding-bottom:0;padding-top:0;position:relative;vertical-align:top;z-index:0}:host([dir=ltr]) ::slotted(:not([slot])):before{left:calc(-1*var(--spectrum-tabs-focus-ring-padding-x))}:host([dir=rtl]) ::slotted(:not([slot])):before{right:calc(-1*var(--spectrum-tabs-focus-ring-padding-x))}:host([dir=ltr]) ::slotted(:not([slot])):before{right:calc(-1*var(--spectrum-tabs-focus-ring-padding-x))}:host([dir=rtl]) ::slotted(:not([slot])):before{left:calc(-1*var(--spectrum-tabs-focus-ring-padding-x))}:host([dir=ltr]) #selectionIndicator{left:0}:host([dir=rtl]) #selectionIndicator{right:0}#selectionIndicator{border-radius:var(--spectrum-tabs-divider-border-radius);position:absolute;transform-origin:top left;transition:transform var(--spectrum-tabs-selection-indicator-animation-duration) ease-in-out;z-index:0}:host([compact]) ::slotted(:not([slot])){height:var(
...
);line-height:var(--spectrum-tabs-compact-vertical-item-height);margin-bottom:var(--spectrum-tabs-compact-vertical-item-gap)}:host([dir=ltr][direction^=vertical]) #selectionIndicator{left:0}:host([dir=rtl][direction^=vertical]) #selectionIndicator{right:0}:host([dir=ltr][direction^=vertical]) #selectionIndicator{left:calc(-1*var(--spectrum-tabs-vertical-divider-size))}:host([dir=rtl][direction^=vertical]) #selectionIndicator{right:calc(-1*var(--spectrum-tabs-vertical-divider-size))}:host([direction^=vertical]) #selectionIndicator{position:absolute;width:var(--spectrum-tabs-vertical-divider-size)}#list{border-bottom-color:var(
...
)}:host([dir][direction=horizontal]) #selectionIndicator{width:1px}:host([dir=ltr][direction=vertical-right]) #list{border-left:0;border-right:var(
...
//# sourceMappingURL=b3a80d11.js.map
