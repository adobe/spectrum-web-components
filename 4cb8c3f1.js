import{e as t,R as e,T as i,x as r,y as o,_ as s}from"./62b05a9e.js";import{e as a,a as n,t as l,l as c,b as d,c as u,i as p}from"./60899823.js";import"./08bec287.js";import{r as m}from"./e50c5e8d.js";import"./b86f55ac.js";import"./c24d2ae8.js";const{H:h}=e,x=t=>void 0===t.strings,v=()=>document.createComment(""),f=(t,e,i)=>{var r;const o=t._$AA.parentNode,s=void 0===e?t._$AB:e._$AA;if(void 0===i){const e=o.insertBefore(v(),s),r=o.insertBefore(v(),s);i=new h(e,r,t,t.options)}else{const e=i._$AB.nextSibling,a=i._$AM,n=a!==t;if(n){let e;null===(r=i._$AQ)||void 0===r||r.call(i,t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==a._$AU&&i._$AP(e)}if(e!==s||n){let t=i._$AA;for(;t!==e;){const e=t.nextSibling;o.insertBefore(t,s),t=e}}}return i},b=(t,e,i=t)=>(t._$AI(e,i),t),g={},w=(t,e=g)=>t._$AH=e,y=t=>t._$AH,q=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let i=t._$AA;const r=t._$AB.nextSibling;for(;i!==r;){const t=i.nextSibling;i.remove(),i=t}},k=a(class extends n{constructor(t){if(super(t),t.type!==l.PROPERTY&&t.type!==l.ATTRIBUTE&&t.type!==l.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===i||e===r)return e;const o=t.element,s=t.name;if(t.type===l.PROPERTY){if(e===o[s])return i}else if(t.type===l.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(s))return i}else if(t.type===l.ATTRIBUTE&&o.getAttribute(s)===e+"")return i;return w(t),e}});class z{constructor(t,{mode:e}={mode:"internal"}){this.hadId=!1,this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=z.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return o`<div id="${c(this.isInternal?this.id:void 0)}"><slot name="${t?"negative-help-text":`pass-through-help-text-${this.instanceCount}`}" @slotchange="${this.handleSlotchange}"><slot name="help-text"></slot></slot></div>`}addId(){const t=this.helpTextElement?this.helpTextElement.id:this.id,e=this.host.getAttribute("aria-describedby"),i=e?e.split(/\s+/):[];this.hadId=i.indexOf(t)>-1,this.hadId||(i.push(t),this.host.setAttribute("aria-describedby",i.join(" ")),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0)}removeId(){const t=this.host.getAttribute("aria-describedby");let e=t?t.split(/\s+/):[];if(!this.hadId){const t=this.helpTextElement?this.helpTextElement.id:this.id;e=e.filter((e=>e!==t))}e.length?this.host.setAttribute("aria-describedby",e.join(" ")):this.host.removeAttribute("aria-describedby"),this.helpTextElement||(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(t){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const e=t.assignedElements()[0];this.helpTextElement=e,e&&(e.id||(e.id=this.id),this.addId())}handleNegativeHelpText(t){if("negative-help-text"!==t.name)return;t.assignedElements().forEach((t=>t.variant="negative"))}}function $(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new z(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(t){return this.helpTextManager.render(t)}}}z.instanceCount=0;var E=m`:host{--spectrum-textfield-texticon-padding-left:var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const B=t=>t.stopPropagation();class S extends _{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,I]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return o`<form action="${this.action}" id="form" method="${c(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?o`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${B}"></sp-clear-button>`:o``}</form>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}updated(t){super.updated(t),this.multiline=!1}}s([t()],S.prototype,"action",void 0),s([t()],S.prototype,"label",void 0),s([t()],S.prototype,"method",void 0),s([t()],S.prototype,"placeholder",void 0),s([p("#form")],S.prototype,"form",void 0),customElements.define("sp-search",S);export{$ as M,T,y as a,_ as b,b as c,q as m,x as r,w as s,f as u};
//# sourceMappingURL=4cb8c3f1.js.map
