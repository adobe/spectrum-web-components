import{i as e}from"./67a87733.js";import{o as t,t as s,b as a}from"./47029b77.js";import{S as i,x as n,e as r,d as g}from"./395924ad.js";import{M as d}from"./e9f66d85.js";import{o}from"./2b513fe4.js";import{t as m}from"./a010124b.js";var h=[t,s,e`
...
`,y=Object.defineProperty,H=Object.getOwnPropertyDescriptor,z=(e,t,s,a)=>{for(var i,n=a>1?void 0:a?H(t,s):t,r=e.length-1;r>=0;r--)(i=e[r])&&(n=(a?i(t,s,n):i(n))||n);return a&&n&&y(t,s,n),n};const w=class e extends d{constructor(){super(),e.instances+=1,this.headerId=`sp-menu-group-label-${e.instances}`}static get styles(){return[...super.styles,v]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return n`
        ...
        `}};w.instances=0,z([o({slot:"header",flatten:!0})],w.prototype,"headerElements",2),z([m()],w.prototype,"headerElement",2),g("sp-menu-group",w);export{h};
//# sourceMappingURL=c503a8ea.js.map
