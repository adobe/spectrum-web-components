...
)}@media (-ms-high-contrast:none),screen and (-ms-high-contrast:active){:host>.icon{margin:0}}@media (forced-colors:active){:host{forced-color-adjust:none}}`;var S=e`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Cross75{height:var(--spectrum-alias-ui-icon-cross-size-75);width:var(
...
)}`;class $ extends(c(U)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,N,S]}get buttonContent(){return[s`<sp-icon-cross75 slot="icon" class="icon spectrum-UIIcon-Cross75"></sp-icon-cross75>`]}render(){return s`<div class="fill">${super.render()}</div>`}}t([o({reflect:!0})],$.prototype,"variant",void 0);var P=e`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Asterisk75{height:var(--spectrum-alias-ui-icon-asterisk-size-300);width:var(
...
)}:host([side-aligned=start]) .required-icon{margin-top:0}`;class O extends(c(i)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[F,P]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),o=this.target,r=o.getRootNode(),i=r.host;r===t&&o.forceFocusVisible?o.forceFocusVisible():i&&i.forceFocusVisible&&i.forceFocusVisible()}async manageFor(){if(!this.for)return;const e=this.getRootNode(),t=e.querySelector(`#${this.for}`);if(t){if(t.localName.search("-")>0&&await customElements.whenDefined(t.localName),void 0!==t.updateComplete&&await t.updateComplete,this.target=t.focusElement||t,this.target){this.target.getRootNode()===e?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",this.labelText)}return Promise.resolve()}}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});if(!e.length)return"";return e.map((e=>(e.textContent||"").trim())).join(" ")}render(){return s`<label><slot @slotchange="${this.manageFor}"></slot>${this.required?s`<sp-icon-asterisk100 class="required-icon spectrum-UIIcon-Asterisk100"></sp-icon-asterisk100>`:s``}</label>`}firstUpdated(e){super.firstUpdated(e),this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${O.instanceCount++}`),this.addEventListener("click",this.handleClick)}updated(e){super.updated(e),(e.has("for")||e.has("id"))&&this.manageFor()}}O.instanceCount=0,t([o({type:Boolean,reflect:!0})],O.prototype,"disabled",void 0),t([o({type:String})],O.prototype,"id",void 0),t([o({type:String})],O.prototype,"for",void 0),t([o({type:Boolean,reflect:!0})],O.prototype,"required",void 0),t([l("slot")],O.prototype,"slotEl",void 0),t([o({type:String,reflect:!0,attribute:"side-aligned"})],O.prototype,"sideAligned",void 0),customElements.define("sp-field-label",O),customElements.define("sp-clear-button",$);export{I as B,v as F,g as L,C as O,c as S,p as a,f as b,k as c,U as d,m as e,E as f,S as g,l as i,u as l,n as o,d as t};
//# sourceMappingURL=8504e747.js.map
