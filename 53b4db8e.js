import{i as e}from"./67a87733.js";import{o as t,t as s,b as i}from"./47029b77.js";import{S as a,x as r,e as n,d as g}from"./cd228091.js";import{M as d}from"./56d56bc4.js";import{o as m}from"./da80776c.js";import{t as o}from"./0d9e6cef.js";var h=[t,s,e`
...
`,y=Object.defineProperty,H=Object.getOwnPropertyDescriptor,z=(e,t,s,i)=>{for(var a,r=i>1?void 0:i?H(t,s):t,n=e.length-1;n>=0;n--)(a=e[n])&&(r=(i?a(t,s,r):a(r))||r);return i&&r&&y(t,s,r),r};const w=class extends d{constructor(){super(),w.instances+=1,this.headerId=`sp-menu-group-label-${w.instances}`}static get styles(){return[...super.styles,v]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return r`
        ...
        `}};let k=w;k.instances=0,z([m("header",!0)],k.prototype,"headerElements",2),z([o()],k.prototype,"headerElement",2),g("sp-menu-group",k);export{h};
//# sourceMappingURL=53b4db8e.js.map
