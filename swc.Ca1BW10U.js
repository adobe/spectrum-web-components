import{t as l,s}from"./swc.CJygKO7k.js";import{I as e}from"./swc.D5Cg2mc4.js";import{x as i}from"./swc.BkWj9Vim.js";import{d as t}from"./swc.JlveB6nj.js";t("sp-icon-close",class extends e{render(){return s(i),2===this.spectrumVersion?(({width:s=24,height:e=24,hidden:i=!1,title:t="Close"}={})=>l`<svg
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`)({hidden:!this.label,title:this.label}):(({width:s=24,height:e=24,hidden:i=!1,title:t="Close"}={})=>l`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${s}"
    height="${e}"
    viewBox="0 0 36 36"
...
//# sourceMappingURL=swc.BfBcCdSB.js.map
