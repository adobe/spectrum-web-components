import"./67314095.js";import{i as e}from"./112b2095.js";import{c as t,a as i}from"./915dab83.js";import{E as s,e as l}from"./d11544d8.js";import{S as a}from"./20b07124.js";import{x as r,A as o,n as d,S as p,d as n}from"./b46b846d.js";import{i as c}from"./47d38ea1.js";var m=e`
...
`,b=Object.defineProperty,h=Object.getOwnPropertyDescriptor,f=(e,t,i,s)=>{for(var l,a=s>1?void 0:s?h(t,i):t,r=e.length-1;r>=0;r--)(l=e[r])&&(a=(s?l(t,i,a):l(a))||a);return s&&a&&b(t,i,a),a};const g=class e extends(a(p,{noDefaultSize:!0})){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new s(this)}static get styles(){return[u,m]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),l=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():l&&l.forceFocusVisible&&l.forceFocusVisible()}applyTargetLabel(e){if(this.target=e||this.target,this.target){const s=this.target.applyFocusElementLabel,l=this.target.focusElement||this.target,a=l.getRootNode();void 0!==s?s(this.labelText):a===this.getRootNode()?(e?t:i)(l,"aria-labelledby",[this.id]):e?l.setAttribute("aria-label",this.labelText):l.removeAttribute("aria-label")}}async manageTarget(){this.applyTargetLabel();const e=this.resolvedElement.element;e?(e.localName.search("-")>0&&await customElements.whenDefined(e.localName),void 0!==e.updateComplete&&await e.updateComplete,this.applyTargetLabel(e)):this.target=e}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});return e.length?e.map((e=>(e.textContent||"").trim())).join(" "):""}render(){return r`
            <label>
                <slot></slot>
                ${this.required?r`
                          <sp-icon-asterisk100
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}willUpdate(t){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${e.instanceCount++}`),t.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(t.has("id")||t.has(l))&&this.manageTarget()}};g.instanceCount=0,f([d({type:Boolean,reflect:!0})],g.prototype,"disabled",2),f([d({type:String})],g.prototype,"id",2),f([d({type:String})],g.prototype,"for",2),f([d({type:Boolean,reflect:!0})],g.prototype,"required",2),f([c("slot")],g.prototype,"slotEl",2),f([d({type:String,reflect:!0,attribute:"side-aligned"})],g.prototype,"sideAligned",2),n("sp-field-label",g);
//# sourceMappingURL=771eefc9.js.map
