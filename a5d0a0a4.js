import{i as e}from"./d230bd74.js";import{o as t,t as s,b as i}from"./53a33ad1.js";import{S as a,y as n,e as r}from"./d036ac45.js";import{M as g}from"./1075f713.js";import{o as d}from"./fe0aa793.js";import{t as m}from"./cfcd457b.js";var o=[t,s,e`
...
`,l=Object.defineProperty,c=Object.getOwnPropertyDescriptor,p=(e,t,s,i)=>{for(var a,n=i>1?void 0:i?c(t,s):t,r=e.length-1;r>=0;r--)(a=e[r])&&(n=(i?a(t,s,n):a(n))||n);return i&&n&&l(t,s,n),n};class u extends a{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[o,i,h]}render(){return n`
        ...
        `}}u.is="sp-illustrated-message",p([r()],u.prototype,"heading",2),p([r()],u.prototype,"description",2),customElements.define("sp-illustrated-message",u);var f=e`
...
`,v=Object.defineProperty,y=Object.getOwnPropertyDescriptor,H=(e,t,s,i)=>{for(var a,n=i>1?void 0:i?y(t,s):t,r=e.length-1;r>=0;r--)(a=e[r])&&(n=(i?a(t,s,n):a(n))||n);return i&&n&&v(t,s,n),n};const z=class extends g{constructor(){super(),z.instances+=1,this.headerId=`sp-menu-group-label-${z.instances}`}static get styles(){return[...super.styles,f]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return n`
        ...
        `}};let w=z;w.instances=0,H([d("header",!0)],w.prototype,"headerElements",2),H([m()],w.prototype,"headerElement",2),customElements.define("sp-menu-group",w);export{o as h};
//# sourceMappingURL=a5d0a0a4.js.map
