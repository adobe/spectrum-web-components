import{r as e}from"./e50c5e8d.js";import{b as t,l as r,a}from"./b5f34f36.js";import{S as i,$ as s,e as n}from"./8dfa8611.js";import{M as l}from"./8c245a16.js";import{o}from"./d07a663a.js";import{t as g}from"./dc848e0a.js";var m=[t,r,e`.spectrum-Heading--sizeXXXL{font-size:var(
...
)}::slotted(svg[viewBox]){width:100%}`,h=Object.defineProperty,p=Object.getOwnPropertyDescriptor,d=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?p(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&h(t,r,s),s};class u extends i{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[m,a,c]}render(){return s`<div id="illustration"><slot></slot></div><h2 id="heading" class="spectrum-Heading spectrum-Heading--sizeL spectrum-Heading--light"><slot name="heading">${this.heading}</slot></h2><div id="description" class="spectrum-Body spectrum-Body--sizeS"><slot name="description">${this.description}</slot></div>`}}u.is="sp-illustrated-message",d([n()],u.prototype,"heading",2),d([n()],u.prototype,"description",2),customElements.define("sp-illustrated-message",u);var x=e`.header{color:var(--spectrum-listheading-text-color);display:block;font-size:var(--spectrum-listitem-texticon-heading-text-size);font-weight:var(--spectrum-listitem-texticon-heading-text-font-weight);letter-spacing:var(
--spectrum-listitem-texticon-heading-letter-spacing
);line-height:var(--spectrum-listitem-texticon-heading-line-height);margin:var(--spectrum-listitem-texticon-heading-margin);padding:var(--spectrum-listitem-texticon-heading-padding);text-transform:var(--spectrum-listitem-texticon-heading-text-transform)}:host{display:inline-flex;flex-direction:column;margin:0;overflow:visible}:host([dir=ltr]) .header{padding:0 var(--spectrum-global-dimension-size-450) 0 var(--spectrum-global-dimension-size-150)}:host([dir=rtl]) .header{padding:0 var(--spectrum-global-dimension-size-150) 0 var(--spectrum-global-dimension-size-450)}sp-menu{--swc-menu-width:100%}:host(:last-child) sp-menu{margin-bottom:0}:host(:first-child) .header[hidden]+sp-menu{margin-top:0}[hidden]{display:none!important}`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?f(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&v(t,r,s),s};const z=class extends l{static get styles(){return[...super.styles,x]}constructor(){super(),z.instances+=1,this.headerId=`sp-menu-group-label-${z.instances}`}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return s`<span class="header" aria-hidden="true" ?hidden="${!this.headerElement}"><slot name="header" @slotchange="${this.updateLabel}"></slot></span><sp-menu role="none"><slot></slot></sp-menu>`}};let w=z;w.instances=0,y([o("header",!0)],w.prototype,"headerElements",2),y([g()],w.prototype,"headerElement",2),customElements.define("sp-menu-group",w);export{m as h};
//# sourceMappingURL=e5d458c6.js.map
