import{T as t}from"./ba111d66.js";import{B as o,I as r,S as c}from"./07ec8f11.js";import{i as e}from"./d230bd74.js";import{S as n}from"./7bbd9edb.js";import{e as s,y as a,S as u}from"./d036ac45.js";import"./c8cecfa1.js";import"./7279415d.js";import"./ef0b9850.js";import"./c558c2ce.js";customElements.define("sp-theme",t);var i=e`
...
`,h=Object.defineProperty,g=Object.getOwnPropertyDescriptor;const f={s:()=>a`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>a`
        ...
        ></sp-icon-cross300>
    `};class k extends(n(c)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,v,r]}get buttonContent(){return[f[this.size]()]}}((t,o,r,c)=>{for(var e,n=c>1?void 0:c?g(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&h(o,r,n)})([s({reflect:!0})],k.prototype,"variant",2);var y=e`
...
`,x=Object.defineProperty,z=Object.getOwnPropertyDescriptor,q=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?z(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&x(o,r,n),n};const C={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let T;class j extends(n(o,{validSizes:["xs","s","m","l","xl"]})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,y,w]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){0===t.button&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),T=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}onPointerup(){clearTimeout(T),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:r}=t;("Space"===o||r&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(a`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${C[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}q([s({type:Boolean,reflect:!0})],j.prototype,"emphasized",2),q([s({type:Boolean,reflect:!0,attribute:"hold-affordance"})],j.prototype,"holdAffordance",2),q([s({type:Boolean,reflect:!0})],j.prototype,"quiet",2),q([s({reflect:!0})],j.prototype,"role",2),q([s({type:Boolean,reflect:!0})],j.prototype,"selected",2),q([s({type:Boolean,reflect:!0})],j.prototype,"toggles",2),q([s({reflect:!0})],j.prototype,"variant",2),q([s({type:String})],j.prototype,"value",1),customElements.define("sp-action-button",j);var B=e`
...
`,I=Object.defineProperty,A=Object.getOwnPropertyDescriptor;class E extends(n(u,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return a``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}E.styles=[B],((t,o,r,c)=>{for(var e,n=c>1?void 0:c?A(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);c&&n&&I(o,r,n)})([s({type:Boolean,reflect:!0})],E.prototype,"vertical",2),customElements.define("sp-divider",E),customElements.define("sp-close-button",k);var H=e`
...
`,P=Object.defineProperty,U=Object.getOwnPropertyDescriptor,S=(t,o,r,c)=>{for(var e,n=c>1?void 0:c?U(o,r):o,s=t.length-1;s>=0;s--)(e=t[s])&&(n=(c?e(o,r,n):e(n))||n);return c&&n&&P(o,r,n),n};const _=["negative","positive","info","error","warning"];class O extends u{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[H]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,r=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",r)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;_.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return a`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
                `;case"negative":case"error":case"warning":return a`
                    <sp-icon-alert label="Error" class="type"></sp-icon-alert>
                `;case"positive":case"success":return a`
                    <sp-icon-checkmark-circle
                        label="Success"
                        class="type"
                    ></sp-icon-checkmark-circle>
                `;default:return a``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}shouldClose(){this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))&&this.close()}close(){this.open=!1}render(){return a`
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}S([s({type:Boolean,reflect:!0})],O.prototype,"open",2),S([s({type:Number})],O.prototype,"timeout",1),S([s({type:String})],O.prototype,"variant",1),customElements.define("sp-toast",O);export{B as s};
//# sourceMappingURL=8a385f50.js.map
