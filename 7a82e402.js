import{i as r}from"./112b2095.js";import{S as e}from"./01b2daba.js";import{x as t}from"./e6d35ea0.js";import{l as s}from"./660f0d27.js";import{n as o,S as a}from"./c34bcf8e.js";import{i}from"./17348440.js";import{d as c}from"./25a3ae37.js";const l=(r,e)=>{if(r)return null;const t=e.assignedNodes().reduce(((r,e)=>e.textContent?r+e.textContent:r),"");return t?t.trim():null};var n=r`
...
`,m=Object.defineProperty,d=Object.getOwnPropertyDescriptor,g=(r,e,t,s)=>{for(var o,a=s>1?void 0:s?d(e,t):e,i=r.length-1;i>=0;i--)(o=r[i])&&(a=(s?o(e,t,a):o(a))||a);return s&&a&&m(e,t,a),a};class f extends(e(a,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[n]}makeRotation(r){return this.indeterminate?void 0:`transform: rotate(${r}deg);`}willUpdate(r){r.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const r=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return t`
            <slot @slotchange=${this.handleSlotchange}></slot>
            <div class="track"></div>
            <div class="fills">
                ${["Mask1","Mask2"].map(((e,o)=>t`
                        <div class="fill${e}">
                            <div
                                class="fillSub${e}"
                                style=${s(r[o])}
        ...
        `}handleSlotchange(){const r=l(this.label,this.slotEl);r&&(this.label=r)}firstUpdated(r){super.firstUpdated(r),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(r){super.updated(r),!this.indeterminate&&r.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),r.has("label")&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}}g([o({type:Boolean,reflect:!0})],f.prototype,"indeterminate",2),g([o({type:String})],f.prototype,"label",2),g([o({type:Boolean,reflect:!0,attribute:"over-background"})],f.prototype,"overBackground",2),g([o({reflect:!0})],f.prototype,"static",2),g([o({type:Number})],f.prototype,"progress",2),g([i("slot")],f.prototype,"slotEl",2),c("sp-progress-circle",f);var p=Object.freeze({__proto__:null});export{l as g,p as s};
//# sourceMappingURL=7a82e402.js.map
