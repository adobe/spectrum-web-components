...
)}:host{overflow:hidden}img{vertical-align:top}`;const St=[50,75,100,200,300,400,500,600,700],$t=St[2];class At extends e{constructor(){super(...arguments),this.label="",this.src="",this._size=$t}static get styles(){return[qt]}get size(){return this._size}set size(t){const e=t,r=St.includes(e)?e:$t;if(r&&this.setAttribute("size",`${r}`),this._size===r)return;const o=this._size;this._size=r,this.requestUpdate("size",o)}render(){return r`<img class="image" alt="${f(this.label||void 0)}" src="${this.src}">`}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("size")||this.setAttribute("size",`${this.size}`)}}o([i()],At.prototype,"label",void 0),o([i()],At.prototype,"src",void 0),o([i({type:Number,reflect:!0})],At.prototype,"size",null),customElements.define("sp-avatar",At);var Et=u`:host{border-radius:var(
...
)}`;class Lt extends e{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[Et]}render(){return r`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}o([i({reflect:!0,type:String})],Lt.prototype,"type",void 0),o([i({reflect:!0,type:Boolean})],Lt.prototype,"corner",void 0),customElements.define("sp-banner",Lt);var _t=u`:host{--spectrum-buttongroup-button-gap-reset:0}:host{display:flex}::slotted(*){flex-shrink:0}:host([dir=ltr]) ::slotted(:not(:first-of-type)){margin-left:var(
...
)}:host([vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-flex-grow:1}:host([dir=ltr][vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-text-align:left}:host([dir=rtl][vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-text-align:right}`;class Mt extends e{constructor(){super(...arguments),this.vertical=!1}static get styles(){return[_t]}render(){return r`<slot></slot>`}}o([i({type:Boolean,reflect:!0})],Mt.prototype,"vertical",void 0),customElements.define("sp-button-group",Mt);class Bt extends g{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(t){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const e=new CustomEvent("change",{detail:{sourceEvent:t},bubbles:t.bubbles,cancelable:t.cancelable});this.dispatchEvent(e)}render(){return r`<input id="input" aria-labelledby="label" type="checkbox" .checked="${this.checked}" @change="${this.handleChange}">`}}o([i({type:Boolean,reflect:!0})],Bt.prototype,"checked",void 0),o([i({type:Boolean,reflect:!0})],Bt.prototype,"readonly",void 0),o([x("#input")],Bt.prototype,"inputElement",void 0);var Pt=u`:host{align-items:flex-start;max-width:100%;min-height:var(--spectrum-checkbox-height);position:relative}#input{box-sizing:border-box;cursor:pointer;font-family:inherit;font-size:100%;height:100%;line-height:1.15;margin:0;opacity:.0001;overflow:visible;padding:0;position:absolute;width:100%;z-index:1}#input:disabled{cursor:default}#input:checked+#box:before{border-width:calc(var(--spectrum-checkbox-box-size)/2)}#input:checked+#box #checkmark{opacity:1;transform:scale(1)}#input.focus-visible+#box:after{margin:calc(var(
...
--spectrum-checkbox-m-box-border-color-error,var(--spectrum-global-color-red-500)
)}}:host{display:inline-flex;vertical-align:top}:host(:focus){outline:0}:host([disabled]){pointer-events:none}:host(:empty) label{display:none}`;var It=u`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-Dash50{height:var(--spectrum-alias-ui-icon-dash-size-50);width:var(
...
)}`;const Dt={s:r`<sp-icon-checkmark75 id="checkmark" class="spectrum-UIIcon-Checkmark75"></sp-icon-checkmark75>`,m:r`<sp-icon-checkmark100 id="checkmark" class="spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`,l:r`<sp-icon-checkmark200 id="checkmark" class="spectrum-UIIcon-Checkmark200"></sp-icon-checkmark200>`,xl:r`<sp-icon-checkmark300 id="checkmark" class="spectrum-UIIcon-Checkmark300"></sp-icon-checkmark300>`},Ht={s:r`<sp-icon-dash75 id="partialCheckmark" class="spectrum-UIIcon-Dash75"></sp-icon-dash75>`,m:r`<sp-icon-dash100 id="partialCheckmark" class="spectrum-UIIcon-Dash100"></sp-icon-dash100>`,l:r`<sp-icon-dash200 id="partialCheckmark" class="spectrum-UIIcon-Dash200"></sp-icon-dash200>`,xl:r`<sp-icon-dash300 id="partialCheckmark" class="spectrum-UIIcon-Dash300"></sp-icon-dash300>`};class Tt extends(y(Bt)){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[Pt,k,It]}render(){return r`${super.render()} <span id="box">${Dt[this.size]} ${Ht[this.size]} </span><label id="label"><slot></slot></label>`}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}o([i({type:Boolean,reflect:!0})],Tt.prototype,"indeterminate",void 0),o([i({type:Boolean,reflect:!0})],Tt.prototype,"invalid",void 0),o([i({type:Boolean,reflect:!0})],Tt.prototype,"emphasized",void 0),customElements.define("sp-checkbox",Tt);var Ft=u`:host{--spectrum-overlay-animation-distance:var(
...
)}`;class Ut extends e{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Ft]}render(){return r`<slot></slot>`}}o([i({type:Boolean,reflect:!0})],Ut.prototype,"opened",void 0),o([i({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Ut.prototype,"textOnly",void 0),customElements.define("sp-quick-actions",Ut);var Ot=u`:host([size=s]){--spectrum-card-quiet-body-header-margin-top:var(
...
)}@media (forced-colors:active){:host{--spectrum-colorhandle-inner-border-color-disabled:GrayText;--spectrum-colorhandle-fill-color-disabled:Canvas;--spectrum-colorhandle-inner-border-color:CanvasText}:host([disabled]){forced-color-adjust:none}}:host{touch-action:none}:host(:focus){outline:0}`;const Zt=/^hs[v|l]a?\s?\((\d{1,3}\.?\d*?),?\s?(\d{1,3})/,Qt=/(^hs[v|l]a?\s?\()\d{1,3}\.?\d*?(,?\s?)\d{1,3}/,Jt=/(^hs[v|l]a?\()\d{1,3}/;class te extends e{constructor(){super(...arguments),this.disabled=!1,this.focused=!1,this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[Wt]}handlePointerdown(t){"touch"===t.pointerType&&(this.open=!0),this.setPointerCapture(t.pointerId)}handlePointerup(t){this.open=!1,this.releasePointerCapture(t.pointerId)}render(){return r`<div class="color" style="background-color:${this.color}"></div><sp-color-loupe color="${this.color}" ?open="${this.open&&!this.disabled}"></sp-color-loupe>`}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("pointerup",this.handlePointerup),this.addEventListener("pointercancel",this.handlePointerup)}}function ee(t,e){(function(t){return"string"==typeof t&&-1!==t.indexOf(".")&&1===parseFloat(t)})(t)&&(t="100%");var r=function(t){return"string"==typeof t&&-1!==t.indexOf("%")}(t);return t=360===e?t:Math.min(e,Math.max(0,parseFloat(t))),r&&(t=parseInt(String(t*e),10)/100),Math.abs(t-e)<1e-6?1:t=360===e?(t<0?t%e+e:t%e)/parseFloat(String(e)):t%e/parseFloat(String(e))}function re(t){return Math.min(1,Math.max(0,t))}function oe(t){return t=parseFloat(t),(isNaN(t)||t<0||t>1)&&(t=1),t}function ie(t){return t<=1?100*Number(t)+"%":t}function se(t){return 1===t.length?"0"+t:String(t)}function ae(t,e,r){t=ee(t,255),e=ee(e,255),r=ee(r,255);var o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,a=0,l=(o+i)/2;if(o===i)a=0,s=0;else{var c=o-i;switch(a=l>.5?c/(2-o-i):c/(o+i),o){case t:s=(e-r)/c+(e<r?6:0);break;case e:s=(r-t)/c+2;break;case r:s=(t-e)/c+4}s/=6}return{h:s,s:a,l:l}}function le(t,e,r){return r<0&&(r+=1),r>1&&(r-=1),r<1/6?t+6*r*(e-t):r<.5?e:r<2/3?t+(e-t)*(2/3-r)*6:t}function ce(t,e,r){t=ee(t,255),e=ee(e,255),r=ee(r,255);var o=Math.max(t,e,r),i=Math.min(t,e,r),s=0,a=o,l=o-i,c=0===o?0:l/o;if(o===i)s=0;else{switch(o){case t:s=(e-r)/l+(e<r?6:0);break;case e:s=(r-t)/l+2;break;case r:s=(t-e)/l+4}s/=6}return{h:s,s:c,v:a}}function ne(t,e,r,o){var i=[se(Math.round(t).toString(16)),se(Math.round(e).toString(16)),se(Math.round(r).toString(16))];return o&&i[0].startsWith(i[0].charAt(1))&&i[1].startsWith(i[1].charAt(1))&&i[2].startsWith(i[2].charAt(1))?i[0].charAt(0)+i[1].charAt(0)+i[2].charAt(0):i.join("")}function de(t){return Math.round(255*parseFloat(t)).toString(16)}function ue(t){return pe(t)/255}function pe(t){return parseInt(t,16)}o([i({type:Boolean,reflect:!0})],te.prototype,"disabled",void 0),o([i({type:Boolean,reflect:!0})],te.prototype,"focused",void 0),o([i({type:Boolean,reflect:!0})],te.prototype,"open",void 0),o([i({type:String})],te.prototype,"color",void 0),customElements.define("sp-color-handle",te);var me={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgreen:"#006400",darkgrey:"#a9a9a9",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",goldenrod:"#daa520",gold:"#ffd700",gray:"#808080",green:"#008000",greenyellow:"#adff2f",grey:"#808080",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavenderblush:"#fff0f5",lavender:"#e6e6fa",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgreen:"#90ee90",lightgrey:"#d3d3d3",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370db",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#db7093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",rebeccapurple:"#663399",red:"#ff0000",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};function he(t){var e={r:0,g:0,b:0},r=1,o=null,i=null,s=null,a=!1,l=!1;return"string"==typeof t&&(t=function(t){if(0===(t=t.trim().toLowerCase()).length)return!1;var e=!1;if(me[t])t=me[t],e=!0;else if("transparent"===t)return{r:0,g:0,b:0,a:0,format:"name"};var r=fe.rgb.exec(t);if(r)return{r:r[1],g:r[2],b:r[3]};if(r=fe.rgba.exec(t))return{r:r[1],g:r[2],b:r[3],a:r[4]};if(r=fe.hsl.exec(t))return{h:r[1],s:r[2],l:r[3]};if(r=fe.hsla.exec(t))return{h:r[1],s:r[2],l:r[3],a:r[4]};if(r=fe.hsv.exec(t))return{h:r[1],s:r[2],v:r[3]};if(r=fe.hsva.exec(t))return{h:r[1],s:r[2],v:r[3],a:r[4]};if(r=fe.hex8.exec(t))return{r:pe(r[1]),g:pe(r[2]),b:pe(r[3]),a:ue(r[4]),format:e?"name":"hex8"};if(r=fe.hex6.exec(t))return{r:pe(r[1]),g:pe(r[2]),b:pe(r[3]),format:e?"name":"hex"};if(r=fe.hex4.exec(t))return{r:pe(r[1]+r[1]),g:pe(r[2]+r[2]),b:pe(r[3]+r[3]),a:ue(r[4]+r[4]),format:e?"name":"hex8"};if(r=fe.hex3.exec(t))return{r:pe(r[1]+r[1]),g:pe(r[2]+r[2]),b:pe(r[3]+r[3]),format:e?"name":"hex"};return!1}(t)),"object"==typeof t&&(xe(t.r)&&xe(t.g)&&xe(t.b)?(e=function(t,e,r){return{r:255*ee(t,255),g:255*ee(e,255),b:255*ee(r,255)}}(t.r,t.g,t.b),a=!0,l="%"===String(t.r).substr(-1)?"prgb":"rgb"):xe(t.h)&&xe(t.s)&&xe(t.v)?(o=ie(t.s),i=ie(t.v),e=function(t,e,r){t=6*ee(t,360),e=ee(e,100),r=ee(r,100);var o=Math.floor(t),i=t-o,s=r*(1-e),a=r*(1-i*e),l=r*(1-(1-i)*e),c=o%6;return{r:255*[r,a,s,s,l,r][c],g:255*[l,r,r,a,s,s][c],b:255*[s,s,l,r,r,a][c]}}(t.h,o,i),a=!0,l="hsv"):xe(t.h)&&xe(t.s)&&xe(t.l)&&(o=ie(t.s),s=ie(t.l),e=function(t,e,r){var o,i,s;if(t=ee(t,360),e=ee(e,100),r=ee(r,100),0===e)i=r,s=r,o=r;else{var a=r<.5?r*(1+e):r+e-r*e,l=2*r-a;o=le(l,a,t+1/3),i=le(l,a,t),s=le(l,a,t-1/3)}return{r:255*o,g:255*i,b:255*s}}(t.h,o,s),a=!0,l="hsl"),Object.prototype.hasOwnProperty.call(t,"a")&&(r=t.a)),r=oe(r),{ok:a,format:t.format||l,r:Math.min(255,Math.max(e.r,0)),g:Math.min(255,Math.max(e.g,0)),b:Math.min(255,Math.max(e.b,0)),a:r}}var be="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",ge="[\\s|\\(]+("+be+")[,|\\s]+("+be+")[,|\\s]+("+be+")\\s*\\)?",ve="[\\s|\\(]+("+be+")[,|\\s]+("+be+")[,|\\s]+("+be+")[,|\\s]+("+be+")\\s*\\)?",fe={CSS_UNIT:new RegExp(be),rgb:new RegExp("rgb"+ge),rgba:new RegExp("rgba"+ve),hsl:new RegExp("hsl"+ge),hsla:new RegExp("hsla"+ve),hsv:new RegExp("hsv"+ge),hsva:new RegExp("hsva"+ve),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};function xe(t){return Boolean(fe.CSS_UNIT.exec(String(t)))}var ye=function(){function t(e,r){var o;if(void 0===e&&(e=""),void 0===r&&(r={}),e instanceof t)return e;"number"==typeof e&&(e=function(t){return{r:t>>16,g:(65280&t)>>8,b:255&t}}(e)),this.originalInput=e;var i=he(e);this.originalInput=e,this.r=i.r,this.g=i.g,this.b=i.b,this.a=i.a,this.roundA=Math.round(100*this.a)/100,this.format=null!==(o=r.format)&&void 0!==o?o:i.format,this.gradientType=r.gradientType,this.r<1&&(this.r=Math.round(this.r)),this.g<1&&(this.g=Math.round(this.g)),this.b<1&&(this.b=Math.round(this.b)),this.isValid=i.ok}return t.prototype.isDark=function(){return this.getBrightness()<128},t.prototype.isLight=function(){return!this.isDark()},t.prototype.getBrightness=function(){var t=this.toRgb();return(299*t.r+587*t.g+114*t.b)/1e3},t.prototype.getLuminance=function(){var t=this.toRgb(),e=t.r/255,r=t.g/255,o=t.b/255;return.2126*(e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4))+.7152*(r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4))+.0722*(o<=.03928?o/12.92:Math.pow((o+.055)/1.055,2.4))},t.prototype.getAlpha=function(){return this.a},t.prototype.setAlpha=function(t){return this.a=oe(t),this.roundA=Math.round(100*this.a)/100,this},t.prototype.toHsv=function(){var t=ce(this.r,this.g,this.b);return{h:360*t.h,s:t.s,v:t.v,a:this.a}},t.prototype.toHsvString=function(){var t=ce(this.r,this.g,this.b),e=Math.round(360*t.h),r=Math.round(100*t.s),o=Math.round(100*t.v);return 1===this.a?"hsv("+e+", "+r+"%, "+o+"%)":"hsva("+e+", "+r+"%, "+o+"%, "+this.roundA+")"},t.prototype.toHsl=function(){var t=ae(this.r,this.g,this.b);return{h:360*t.h,s:t.s,l:t.l,a:this.a}},t.prototype.toHslString=function(){var t=ae(this.r,this.g,this.b),e=Math.round(360*t.h),r=Math.round(100*t.s),o=Math.round(100*t.l);return 1===this.a?"hsl("+e+", "+r+"%, "+o+"%)":"hsla("+e+", "+r+"%, "+o+"%, "+this.roundA+")"},t.prototype.toHex=function(t){return void 0===t&&(t=!1),ne(this.r,this.g,this.b,t)},t.prototype.toHexString=function(t){return void 0===t&&(t=!1),"#"+this.toHex(t)},t.prototype.toHex8=function(t){return void 0===t&&(t=!1),function(t,e,r,o,i){var s=[se(Math.round(t).toString(16)),se(Math.round(e).toString(16)),se(Math.round(r).toString(16)),se(de(o))];return i&&s[0].startsWith(s[0].charAt(1))&&s[1].startsWith(s[1].charAt(1))&&s[2].startsWith(s[2].charAt(1))&&s[3].startsWith(s[3].charAt(1))?s[0].charAt(0)+s[1].charAt(0)+s[2].charAt(0)+s[3].charAt(0):s.join("")}(this.r,this.g,this.b,this.a,t)},t.prototype.toHex8String=function(t){return void 0===t&&(t=!1),"#"+this.toHex8(t)},t.prototype.toRgb=function(){return{r:Math.round(this.r),g:Math.round(this.g),b:Math.round(this.b),a:this.a}},t.prototype.toRgbString=function(){var t=Math.round(this.r),e=Math.round(this.g),r=Math.round(this.b);return 1===this.a?"rgb("+t+", "+e+", "+r+")":"rgba("+t+", "+e+", "+r+", "+this.roundA+")"},t.prototype.toPercentageRgb=function(){var t=function(t){return Math.round(100*ee(t,255))+"%"};return{r:t(this.r),g:t(this.g),b:t(this.b),a:this.a}},t.prototype.toPercentageRgbString=function(){var t=function(t){return Math.round(100*ee(t,255))};return 1===this.a?"rgb("+t(this.r)+"%, "+t(this.g)+"%, "+t(this.b)+"%)":"rgba("+t(this.r)+"%, "+t(this.g)+"%, "+t(this.b)+"%, "+this.roundA+")"},t.prototype.toName=function(){if(0===this.a)return"transparent";if(this.a<1)return!1;for(var t="#"+ne(this.r,this.g,this.b,!1),e=0,r=Object.entries(me);e<r.length;e++){var o=r[e],i=o[0];if(t===o[1])return i}return!1},t.prototype.toString=function(t){var e=Boolean(t);t=null!=t?t:this.format;var r=!1,o=this.a<1&&this.a>=0;return e||!o||!t.startsWith("hex")&&"name"!==t?("rgb"===t&&(r=this.toRgbString()),"prgb"===t&&(r=this.toPercentageRgbString()),"hex"!==t&&"hex6"!==t||(r=this.toHexString()),"hex3"===t&&(r=this.toHexString(!0)),"hex4"===t&&(r=this.toHex8String(!0)),"hex8"===t&&(r=this.toHex8String()),"name"===t&&(r=this.toName()),"hsl"===t&&(r=this.toHslString()),"hsv"===t&&(r=this.toHsvString()),r||this.toHexString()):"name"===t&&0===this.a?this.toName():this.toRgbString()},t.prototype.toNumber=function(){return(Math.round(this.r)<<16)+(Math.round(this.g)<<8)+Math.round(this.b)},t.prototype.clone=function(){return new t(this.toString())},t.prototype.lighten=function(e){void 0===e&&(e=10);var r=this.toHsl();return r.l+=e/100,r.l=re(r.l),new t(r)},t.prototype.brighten=function(e){void 0===e&&(e=10);var r=this.toRgb();return r.r=Math.max(0,Math.min(255,r.r-Math.round(-e/100*255))),r.g=Math.max(0,Math.min(255,r.g-Math.round(-e/100*255))),r.b=Math.max(0,Math.min(255,r.b-Math.round(-e/100*255))),new t(r)},t.prototype.darken=function(e){void 0===e&&(e=10);var r=this.toHsl();return r.l-=e/100,r.l=re(r.l),new t(r)},t.prototype.tint=function(t){return void 0===t&&(t=10),this.mix("white",t)},t.prototype.shade=function(t){return void 0===t&&(t=10),this.mix("black",t)},t.prototype.desaturate=function(e){void 0===e&&(e=10);var r=this.toHsl();return r.s-=e/100,r.s=re(r.s),new t(r)},t.prototype.saturate=function(e){void 0===e&&(e=10);var r=this.toHsl();return r.s+=e/100,r.s=re(r.s),new t(r)},t.prototype.greyscale=function(){return this.desaturate(100)},t.prototype.spin=function(e){var r=this.toHsl(),o=(r.h+e)%360;return r.h=o<0?360+o:o,new t(r)},t.prototype.mix=function(e,r){void 0===r&&(r=50);var o=this.toRgb(),i=new t(e).toRgb(),s=r/100;return new t({r:(i.r-o.r)*s+o.r,g:(i.g-o.g)*s+o.g,b:(i.b-o.b)*s+o.b,a:(i.a-o.a)*s+o.a})},t.prototype.analogous=function(e,r){void 0===e&&(e=6),void 0===r&&(r=30);var o=this.toHsl(),i=360/r,s=[this];for(o.h=(o.h-(i*e>>1)+720)%360;--e;)o.h=(o.h+i)%360,s.push(new t(o));return s},t.prototype.complement=function(){var e=this.toHsl();return e.h=(e.h+180)%360,new t(e)},t.prototype.monochromatic=function(e){void 0===e&&(e=6);for(var r=this.toHsv(),o=r.h,i=r.s,s=r.v,a=[],l=1/e;e--;)a.push(new t({h:o,s:i,v:s})),s=(s+l)%1;return a},t.prototype.splitcomplement=function(){var e=this.toHsl(),r=e.h;return[this,new t({h:(r+72)%360,s:e.s,l:e.l}),new t({h:(r+216)%360,s:e.s,l:e.l})]},t.prototype.onBackground=function(e){var r=this.toRgb(),o=new t(e).toRgb();return new t({r:o.r+(r.r-o.r)*r.a,g:o.g+(r.g-o.g)*r.a,b:o.b+(r.b-o.b)*r.a})},t.prototype.triad=function(){return this.polyad(3)},t.prototype.tetrad=function(){return this.polyad(4)},t.prototype.polyad=function(e){for(var r=this.toHsl(),o=r.h,i=[this],s=360/e,a=1;a<e;a++)i.push(new t({h:(o+a*s)%360,s:r.s,l:r.l}));return i},t.prototype.equals=function(e){return this.toRgbString()===new t(e).toRgbString()},t}();var ke=u`.slider{height:100%;left:0;margin:0;opacity:0;pointer-events:none;position:absolute;top:0;width:100%;z-index:0}:host([focused]) .handle{height:calc(var(
--spectrum-colorhandle-size,
var(--spectrum-global-dimension-size-200)
)*2);margin-left:calc(var(
--spectrum-colorhandle-size,
...
)}:host([disabled]) .gradient{display:none}@media (forced-colors:active){:host{--spectrum-colorslider-border-color-disabled:GrayText;--spectrum-colorslider-fill-color-disabled:Canvas}:host{forced-color-adjust:none}}:host{--sp-color-slider-gradient-fallback:red 0%,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%;touch-action:none}:host(:focus){outline:0}.gradient{overflow:hidden}::slotted(*){height:100%;width:100%}`;class Ce extends g{constructor(){super(...arguments),this.disabled=!1,this.focused=!1,this.label="hue",this.vertical=!1,this._value=0,this.sliderHandlePosition=0,this._color=new ye({h:0,s:1,v:1}),this._previousColor=new ye({h:0,s:1,v:1}),this._format={format:"",isString:!1},this.step=1,this._altered=0,this._pointerDown=!1}static get styles(){return[ze]}get value(){return this._value}set value(t){const e=Math.min(360,Math.max(0,t));if(e===this.value)return;const r=this.value,{s:o,v:i}=this._color.toHsv();this._color=new ye({h:e,s:o,v:i}),this._value=e,e!==this.sliderHandlePosition&&(this.sliderHandlePosition=e/360*100),this.requestUpdate("value",r)}get color(){switch(this._format.format){case"rgb":return this._format.isString?this._color.toRgbString():this._color.toRgb();case"prgb":return this._format.isString?this._color.toPercentageRgbString():this._color.toPercentageRgb();case"hex":case"hex3":case"hex4":case"hex6":return this._format.isString?this._color.toHexString():this._color.toHex();case"hex8":return this._format.isString?this._color.toHex8String():this._color.toHex8();case"name":return this._color.toName()||this._color.toRgbString();case"hsl":if(this._format.isString){return this._color.toHslString().replace(Qt,`$1${this.value}$2${this._saturation}`)}{const{s:t,l:e,a:r}=this._color.toHsl();return{h:this.value,s:t,l:e,a:r}}case"hsv":if(this._format.isString){return this._color.toHsvString().replace(Qt,`$1${this.value}$2${this._saturation}`)}{const{s:t,v:e,a:r}=this._color.toHsv();return{h:this.value,s:t,v:e,a:r}}default:return"No color format applied."}}set color(t){if(t===this.color)return;const e=this._color;this._color=new ye(t);const r=this._color.format;let o="string"==typeof t||t instanceof String;if(r.startsWith("hex")&&(o=t.startsWith("#")),this._format={format:r,isString:o},o&&r.startsWith("hs")){const e=Zt.exec(t);if(null!==e){const[,t,r]=e;this.value=Number(t),this._saturation=Number(r)}}else if(!o&&r.startsWith("hs")){const t=this._color.originalInput,e=Object.values(t);this.value=e[0],this._saturation=e[1]}else{const{h:t}=this._color.toHsv();this.value=t}this._previousColor=e,this.requestUpdate("color",e)}get altered(){return this._altered}set altered(t){this._altered=t,this.step=Math.max(1,10*this.altered)}get focusElement(){return this.input}handleKeydown(t){const{key:e}=t;this.focused=!0,this.altered=[t.shiftKey,t.ctrlKey,t.altKey].filter((t=>!!t)).length;let r=0;switch(e){case"ArrowUp":r=this.step;break;case"ArrowDown":r=-this.step;break;case"ArrowLeft":r=this.step*(this.isLTR?-1:1);break;case"ArrowRight":r=this.step*(this.isLTR?1:-1);break;default:return}t.preventDefault(),this.sliderHandlePosition=Math.min(100,Math.max(0,this.sliderHandlePosition+r)),this.value=this.sliderHandlePosition/100*360,this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value})),0!=r&&(this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}handleInput(t){const{valueAsNumber:e}=t.target;this.value=e,this.sliderHandlePosition=this.value/360*100,this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value}))}handleChange(t){this.handleInput(t),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}focus(t={}){super.focus(t),this.forwardFocus()}forwardFocus(){this.focused=this.hasVisibleFocusInTree(),this.input.focus()}handleFocusin(){this.focused=!0}handleFocusout(){this._pointerDown||(this.altered=0,this.focused=!1)}handlePointerdown(t){0===t.button?(this._pointerDown=!0,this._previousColor=this._color.clone(),this.boundingClientRect=this.getBoundingClientRect(),t.target.setPointerCapture(t.pointerId),"mouse"===t.pointerType&&(this.focused=!0)):t.preventDefault()}handlePointermove(t){this.sliderHandlePosition=this.calculateHandlePosition(t),this.value=this.sliderHandlePosition/100*360,this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0,cancelable:!0}))}handlePointerup(t){this._pointerDown=!1,t.target.releasePointerCapture(t.pointerId);this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this._color=this._previousColor),this.focus(),"mouse"===t.pointerType&&(this.focused=!1)}calculateHandlePosition(t){if(!this.boundingClientRect)return this.sliderHandlePosition;const e=this.boundingClientRect,r=this.vertical?e.top:e.left,o=this.vertical?t.clientY:t.clientX,i=this.vertical?e.height:e.width;return 100*Math.max(0,Math.min(1,(o-r)/i))}handleGradientPointerdown(t){0===t.button&&(t.stopPropagation(),t.preventDefault(),this.handle.dispatchEvent(new PointerEvent("pointerdown",t)),this.handlePointermove(t))}get handlePositionStyles(){return`${this.vertical?"top":"left"}: ${this.sliderHandlePosition}%`}render(){return r`<div class="checkerboard" role="presentation" @pointerdown="${this.handleGradientPointerdown}"><div class="gradient" role="presentation" style="background:linear-gradient(to ${this.vertical?"bottom":"right"},var(--sp-color-slider-gradient,var(--sp-color-slider-gradient-fallback)))"><slot name="gradient"></slot></div></div><sp-color-handle tabindex="${f(this.focused?void 0:"0")}" @focus="${this.forwardFocus}" ?focused="${this.focused}" class="handle" color="hsl(${this.value}, 100%, 50%)" ?disabled="${this.disabled}" style="${this.handlePositionStyles}" ${Xt({start:["pointerdown",this.handlePointerdown],streamInside:["pointermove",this.handlePointermove],end:[["pointerup","pointercancel"],this.handlePointerup]})}></sp-color-handle><input type="range" class="slider" min="0" max="360" step="${this.step}" aria-label="${this.label}" .value="${String(this.value)}" @input="${this.handleInput}" @change="${this.handleChange}" @keydown="${this.handleKeydown}">`}firstUpdated(t){super.firstUpdated(t),this.boundingClientRect=this.getBoundingClientRect(),this.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}o([i({type:Boolean,reflect:!0})],Ce.prototype,"disabled",void 0),o([i({type:Boolean,reflect:!0})],Ce.prototype,"focused",void 0),o([x(".handle")],Ce.prototype,"handle",void 0),o([i({type:String})],Ce.prototype,"label",void 0),o([i({type:Boolean,reflect:!0})],Ce.prototype,"vertical",void 0),o([i({type:Number})],Ce.prototype,"value",null),o([i({type:Number,reflect:!0})],Ce.prototype,"sliderHandlePosition",void 0),o([i({type:String})],Ce.prototype,"color",null),o([i({type:Number})],Ce.prototype,"step",void 0),o([x("input")],Ce.prototype,"input",void 0),customElements.define("sp-color-slider",Ce);var qe=u`:host{--spectrum-colorwheel-border-radius:100%;--spectrum-colorwheel-width:calc(var(--spectrum-global-dimension-size-125)*16);--spectrum-colorwheel-height:var(
...
)}`;class Se extends g{constructor(){super(...arguments),this.disabled=!1,this.focused=!1,this.label="hue",this.step=1,this._value=0,this._color=new ye({h:0,s:1,v:1}),this._previousColor=new ye({h:0,s:1,v:1}),this._format={format:"",isString:!1},this._altered=0,this._pointerDown=!1}static get styles(){return[qe]}get value(){return this._value}set value(t){const e=Math.min(360,Math.max(0,t));if(e===this.value)return;const r=this.value,{s:o,v:i}=this._color.toHsv();this._color=new ye({h:e,s:o,v:i}),this._value=e,this.requestUpdate("value",r)}get color(){switch(this._format.format){case"rgb":return this._format.isString?this._color.toRgbString():this._color.toRgb();case"prgb":return this._format.isString?this._color.toPercentageRgbString():this._color.toPercentageRgb();case"hex":case"hex3":case"hex4":case"hex6":return this._format.isString?this._color.toHexString():this._color.toHex();case"hex8":return this._format.isString?this._color.toHex8String():this._color.toHex8();case"name":return this._color.toName()||this._color.toRgbString();case"hsl":if(this._format.isString){return this._color.toHslString().replace(Qt,`$1${this.value}$2${this._saturation}`)}{const{s:t,l:e,a:r}=this._color.toHsl();return{h:this.value,s:t,l:e,a:r}}case"hsv":if(this._format.isString){return this._color.toHsvString().replace(Qt,`$1${this.value}$2${this._saturation}`)}{const{s:t,v:e,a:r}=this._color.toHsv();return{h:this.value,s:t,v:e,a:r}}default:return"No color format applied."}}set color(t){if(t===this.color)return;const e=this._color;this._color=new ye(t);const r=this._color.format;let o="string"==typeof t||t instanceof String;if(r.startsWith("hex")&&(o=t.startsWith("#")),this._format={format:r,isString:o},o&&r.startsWith("hs")){const e=Zt.exec(t);if(null!==e){const[,t,r]=e;this.value=Number(t),this._saturation=Number(r)}}else if(!o&&r.startsWith("hs")){const t=this._color.originalInput,e=Object.values(t);this.value=e[0],this._saturation=e[1]}else{const{h:t}=this._color.toHsv();this.value=t}this.requestUpdate("color",e)}get altered(){return this._altered}set altered(t){this._altered=t,this.step=Math.max(1,10*this.altered)}get focusElement(){return this.input}handleKeydown(t){const{key:e}=t;this.focused=!0,this.altered=[t.shiftKey,t.ctrlKey,t.altKey].filter((t=>!!t)).length;let r=0;switch(e){case"ArrowUp":r=this.step;break;case"ArrowDown":r=-this.step;break;case"ArrowLeft":r=this.step*(this.isLTR?-1:1);break;case"ArrowRight":r=this.step*(this.isLTR?1:-1);break;default:return}t.preventDefault(),this.value=(360+this.value+r)%360,this._previousColor=this._color.clone(),this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}));this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this._color=this._previousColor)}handleInput(t){const{valueAsNumber:e}=t.target;this.value=e,this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value}))}handleChange(t){this.handleInput(t),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}focus(t={}){super.focus(t),this.forwardFocus()}forwardFocus(){this.focused=this.hasVisibleFocusInTree(),this.input.focus()}handleFocusin(){this.focused=!0}handleFocusout(){this._pointerDown||(this.altered=0,this.focused=!1)}handlePointerdown(t){0===t.button?(this._pointerDown=!0,this._previousColor=this._color.clone(),this.boundingClientRect=this.getBoundingClientRect(),t.target.setPointerCapture(t.pointerId),"mouse"===t.pointerType&&(this.focused=!0)):t.preventDefault()}handlePointermove(t){this.value=this.calculateHandlePosition(t),this._color=new ye(Object.assign(Object.assign({},this._color.toHsl()),{h:this.value})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0,cancelable:!0}))}handlePointerup(t){this._pointerDown=!1,t.target.releasePointerCapture(t.pointerId);this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this._color=this._previousColor),this.focus(),"mouse"===t.pointerType&&(this.focused=!1)}calculateHandlePosition(t){if(!this.boundingClientRect)return this.value;const e=this.boundingClientRect,{width:r,height:o,left:i,top:s}=e,a=i+r/2,l=s+o/2,c=t.clientX-a,n=t.clientY-l;return(360+(360+180*Math.atan2(n,c)/Math.PI))%360}handleGradientPointerdown(t){0!==t.button||t.target.classList.contains("innerCircle")||(t.stopPropagation(),t.preventDefault(),this.handle.dispatchEvent(new PointerEvent("pointerdown",t)),this.handlePointermove(t))}render(){const{width:t=160}=this.boundingClientRect||{},e=t/2,o=e-24,i=2*o,s=`path(evenodd, "M ${e} ${e} m -${e} 0 a ${e} ${e} 0 1 0 ${t} 0 a ${e} ${e} 0 1 0 -${t} 0 M ${e} ${e} m -${o} 0 a ${o} ${o} 0 1 0 ${i} 0 a ${o} ${o} 0 1 0 -${i} 0")`,a=`transform: translate(${(e-12.5)*Math.cos(this.value*Math.PI/180)}px, ${(e-12.5)*Math.sin(this.value*Math.PI/180)}px);`;return r`<slot name="gradient" @pointerdown="${this.handleGradientPointerdown}"><div class="wheel" style="clip-path:${s}"></div></slot><sp-color-handle tabindex="${f(this.focused?void 0:"0")}" @focus="${this.forwardFocus}" ?focused="${this.focused}" class="handle" color="hsl(${this.value}, 100%, 50%)" ?disabled="${this.disabled}" style="${a}" ${Xt({start:["pointerdown",this.handlePointerdown],streamInside:["pointermove",this.handlePointermove],end:[["pointerup","pointercancel"],this.handlePointerup]})}></sp-color-handle><input type="range" class="slider" aria-label="${this.label}" min="0" max="360" step="${this.step}" .value="${String(this.value)}" @input="${this.handleInput}" @change="${this.handleChange}" @keydown="${this.handleKeydown}">`}firstUpdated(t){super.firstUpdated(t),this.boundingClientRect=this.getBoundingClientRect(),this.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}connectedCallback(){var t;super.connectedCallback(),!this.observer&&window.ResizeObserver&&(this.observer=new window.ResizeObserver((t=>{for(const e of t)this.boundingClientRect=e.contentRect;this.requestUpdate()}))),null===(t=this.observer)||void 0===t||t.observe(this)}disconnectedCallback(){var t;null===(t=this.observer)||void 0===t||t.unobserve(this),super.disconnectedCallback()}}o([i({type:Boolean,reflect:!0})],Se.prototype,"disabled",void 0),o([i({type:Boolean,reflect:!0})],Se.prototype,"focused",void 0),o([x(".handle")],Se.prototype,"handle",void 0),o([i({type:String})],Se.prototype,"label",void 0),o([i({type:Number})],Se.prototype,"step",void 0),o([i({type:Number})],Se.prototype,"value",null),o([i({type:String})],Se.prototype,"color",null),o([x("input")],Se.prototype,"input",void 0),customElements.define("sp-color-wheel",Se);var $e=u`:host{--spectrum-dialog-fullscreen-header-text-size:28px;--spectrum-dialog-confirm-small-width:400px;--spectrum-dialog-confirm-medium-width:480px;--spectrum-dialog-confirm-large-width:640px;--spectrum-dialog-error-width:var(--spectrum-dialog-confirm-medium-width);--spectrum-dialog-confirm-hero-height:var(
...
--spectrum-dialog-confirm-description-text-color,var(--spectrum-global-color-gray-800)
)}.content[tabindex]{overflow:auto}::slotted(img[slot=hero]){height:auto;width:100%}`;function Ae(t,e){const r=t.assignedElements(),o=[];return r.forEach(((t,r)=>{if(t.id)o.push(t.id);else{const i=e+`-${r}`;t.id=i,o.push(i)}})),o}class Ee extends(C(z(e,['[slot="hero"]','[slot="footer"]','[slot="button"]']))){constructor(){super(...arguments),this.error=!1,this.dismissable=!1,this.noDivider=!1,this.shouldManageTabOrderForScrolling=()=>{const{offsetHeight:t,scrollHeight:e}=this.contentElement;t<e?this.contentElement.tabIndex=0:this.contentElement.removeAttribute("tabindex")},this.labelledbyId="sp-dialog-label-"+Ee.instanceCount++,this.describedbyId="sp-dialog-description-"+Ee.instanceCount++}static get styles(){return[$e,q]}get hasFooter(){return this.getSlotContentPresence('[slot="footer"]')}get hasButtons(){return this.getSlotContentPresence('[slot="button"]')}get hasHero(){return this.getSlotContentPresence('[slot="hero"]')}close(){this.dispatchEvent(new Event("close",{bubbles:!0,composed:!0,cancelable:!0}))}render(){return r`<div class="grid"><slot name="hero"></slot><slot name="heading" class="${f(this.hasHero?this.hasHero:void 0)}" @slotchange="${this.onHeadingSlotchange}"></slot>${this.error?r`<sp-icon-alert class="type-icon"></sp-icon-alert>`:r``} ${this.noDivider?r``:r`<sp-divider size="m" class="divider"></sp-divider>`}<div class="content"><slot @slotchange="${this.onContentSlotChange}"></slot></div>${this.hasFooter?r`<div class="footer"><slot name="footer"></slot></div>`:r``} ${this.hasButtons?r`<sp-button-group class="button-group ${this.hasFooter?"":"button-group--noFooter"}"><slot name="button"></slot></sp-button-group>`:r``} ${this.dismissable?r`<sp-action-button class="close-button" label="Close" quiet size="m" @click="${this.close}"><sp-icon-cross500 class="spectrum-UIIcon-Cross500" slot="icon"></sp-icon-cross500></sp-action-button>`:r``}</div>`}shouldUpdate(t){return t.has("mode")&&this.mode&&(this.dismissable=!1),t.has("dismissable")&&this.dismissable&&(this.dismissable=!this.mode),super.shouldUpdate(t)}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","dialog")}onHeadingSlotchange({target:t}){this.conditionLabelledby&&(this.conditionLabelledby(),delete this.conditionLabelledby);const e=Ae(t,this.labelledbyId);e.length&&(this.conditionLabelledby=F(this,"aria-labelledby",e))}onContentSlotChange({target:t}){this.conditionDescribedby&&(this.conditionDescribedby(),delete this.conditionDescribedby);const e=Ae(t,this.describedbyId);if(e.length&&e.length<4)this.conditionDescribedby=F(this,"aria-describedby",e);else if(!e.length){const t=!!this.id;t||(this.id=this.describedbyId);const e=F(this,"aria-describedby",this.id);this.conditionDescribedby=()=>{e(),t||this.removeAttribute("id")}}}connectedCallback(){super.connectedCallback(),this.tabIndex=0,window.addEventListener("resize",this.shouldManageTabOrderForScrolling)}disconnectedCallback(){window.removeEventListener("resize",this.shouldManageTabOrderForScrolling),super.disconnectedCallback()}}Ee.instanceCount=0,o([x(".close-button")],Ee.prototype,"closeButton",void 0),o([x(".content")],Ee.prototype,"contentElement",void 0),o([i({type:Boolean,reflect:!0})],Ee.prototype,"error",void 0),o([i({type:Boolean,reflect:!0})],Ee.prototype,"dismissable",void 0),o([i({type:Boolean,reflect:!0,attribute:"no-divider"})],Ee.prototype,"noDivider",void 0),o([i({type:String,reflect:!0})],Ee.prototype,"mode",void 0),o([i({type:String,reflect:!0})],Ee.prototype,"size",void 0),customElements.define("sp-dialog",Ee);var Le=u`:host{align-items:center;box-sizing:border-box;display:flex;height:100vh;height:-webkit-fill-available;height:fill-available;justify-content:center;left:0;pointer-events:none;position:fixed;top:0;transition:visibility 0s linear var(--spectrum-global-animation-duration-100,.13s);visibility:hidden;width:100vw;z-index:2}:host([open]){visibility:visible}@media only screen and (max-device-height:350px),only screen and (max-device-width:400px){:host([responsive]){border-radius:0;height:100%;max-height:100%;max-width:100%;width:100%}:host([responsive]){margin-top:0}}`;class _e extends(C(e)){constructor(){super(...arguments),this.error=!1,this.cancelLabel="",this.confirmLabel="",this.dismissable=!1,this.footer="",this.hero="",this.heroLabel="",this.noDivider=!1,this.open=!1,this.secondaryLabel="",this.headline="",this.responsive=!1,this.transitionPromise=Promise.resolve(),this.underlay=!1}static get styles(){return[Le,L]}focus(){if(this.shadowRoot){const t=S(this.dialog);t?(t.updateComplete?t.updateComplete.then((()=>t.focus())):t.focus(),this.removeAttribute("tabindex")):this.dialog.focus()}else super.focus()}overlayWillCloseCallback(){return!!this.open&&(this.close(),!0)}dismiss(){this.dismissable&&this.close()}clickSecondary(){this.dispatchEvent(new Event("secondary",{bubbles:!0}))}clickCancel(){this.dispatchEvent(new Event("cancel",{bubbles:!0}))}clickConfirm(){this.dispatchEvent(new Event("confirm",{bubbles:!0}))}handleClose(t){t.stopPropagation(),this.close()}close(){this.open=!1}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.dispatchClosed(),this.resolveTransitionPromise())}handleModalTransitionend(){!this.open&&this.underlay||(this.resolveTransitionPromise(),this.open||this.dispatchClosed())}update(t){t.has("open")&&void 0!==t.get("open")&&(this.transitionPromise=new Promise((t=>this.resolveTransitionPromise=t))),super.update(t)}render(){return r`${this.underlay?r`<sp-underlay ?open="${this.open}" @click="${this.dismiss}" @transitionend="${this.handleUnderlayTransitionend}"></sp-underlay>`:r``}<div class="modal ${this.mode}" @transitionend="${this.handleModalTransitionend}"><sp-dialog ?dismissable="${this.dismissable}" ?no-divider="${this.noDivider}" ?error="${this.error}" mode="${f(this.mode?this.mode:void 0)}" size="${f(this.size?this.size:void 0)}" @close="${this.handleClose}">${this.hero?r`<img src="${this.hero}" slot="hero" aria-hidden="${f(this.heroLabel?void 0:"true")}" alt="${f(this.heroLabel?this.heroLabel:void 0)}">`:r``} ${this.headline?r`<h2 slot="heading">${this.headline}</h2>`:r``}<slot></slot>${this.footer?r`<div slot="footer">${this.footer}</div>`:r``} ${this.secondaryLabel?r`<sp-button variant="primary" treatment="outline" slot="button" @click="${this.clickSecondary}">${this.secondaryLabel}</sp-button>`:r``} ${this.cancelLabel?r`<sp-button variant="secondary" treatment="outline" slot="button" @click="${this.clickCancel}">${this.cancelLabel}</sp-button>`:r``} ${this.confirmLabel?r`<sp-button variant="accent" slot="button" @click="${this.clickConfirm}">${this.confirmLabel}</sp-button>`:r``}</sp-dialog></div>`}updated(t){t.has("open")&&(this.open?this.dialog.updateComplete.then((()=>{this.dialog.shouldManageTabOrderForScrolling()})):this.tabIndex=0)}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}o([i({type:Boolean,reflect:!0})],_e.prototype,"error",void 0),o([i({attribute:"cancel-label"})],_e.prototype,"cancelLabel",void 0),o([i({attribute:"confirm-label"})],_e.prototype,"confirmLabel",void 0),o([i({type:Boolean,reflect:!0})],_e.prototype,"dismissable",void 0),o([i()],_e.prototype,"footer",void 0),o([i()],_e.prototype,"hero",void 0),o([i({attribute:"hero-label"})],_e.prototype,"heroLabel",void 0),o([i({type:Boolean,reflect:!0,attribute:"no-divider"})],_e.prototype,"noDivider",void 0),o([i({type:Boolean,reflect:!0})],_e.prototype,"open",void 0),o([i({type:String,reflect:!0})],_e.prototype,"mode",void 0),o([i({type:String,reflect:!0})],_e.prototype,"size",void 0),o([i({attribute:"secondary-label"})],_e.prototype,"secondaryLabel",void 0),o([i()],_e.prototype,"headline",void 0),o([i({type:Boolean})],_e.prototype,"responsive",void 0),o([i({type:Boolean})],_e.prototype,"underlay",void 0),o([x("sp-dialog")],_e.prototype,"dialog",void 0),customElements.define("sp-dialog-wrapper",_e);var Me=u`:host{border-radius:var(
...
)}.fill{transform-origin:left}:host([dir=rtl]) .fill{transform-origin:right}`;class Ne extends(y(v(e,""))){constructor(){super(...arguments),this.progress=0,this.overBackground=!1,this.notice=!1,this.negative=!1,this.positive=!1,this.label="",this.sideLabel=!1}static get styles(){return[Oe]}render(){return r`<sp-field-label size="${this.size}" class="label">${this.slotHasContent?r``:this.label}<slot>${this.label}</slot></sp-field-label><sp-field-label size="${this.size}" class="percentage">${this.progress}%</sp-field-label><div class="track"><div class="fill" style="transform:scaleX(calc(${this.progress} / 100))"></div></div>`}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","progressbar")}updated(t){super.updated(t),t.has("progress")&&this.setAttribute("aria-valuenow",""+this.progress),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}function Re(){return(Re=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t}).apply(this,arguments)}o([i({type:Number})],Ne.prototype,"progress",void 0),o([i({type:Boolean,reflect:!0,attribute:"over-background"})],Ne.prototype,"overBackground",void 0),o([i({type:Boolean,reflect:!0})],Ne.prototype,"notice",void 0),o([i({type:Boolean,reflect:!0})],Ne.prototype,"negative",void 0),o([i({type:Boolean,reflect:!0})],Ne.prototype,"positive",void 0),o([i({type:String,reflect:!0})],Ne.prototype,"label",void 0),o([i({type:Boolean,reflect:!0,attribute:"side-label"})],Ne.prototype,"sideLabel",void 0),customElements.define("sp-meter",Ne);let je=new Map,Ve=!1;try{Ve="exceptZero"===new Intl.NumberFormat("de-DE",{signDisplay:"exceptZero"}).resolvedOptions().signDisplay}catch(Z){}let Ke=!1;try{Ke="unit"===new Intl.NumberFormat("de-DE",{style:"unit",unit:"degree"}).resolvedOptions().style}catch(Z){}const Xe={degree:{narrow:{default:"°","ja-JP":" 度","zh-TW":"度","sl-SI":" °"}}};class Ge{constructor(t,e){void 0===e&&(e={}),this.numberFormatter=void 0,this.options=void 0,this.numberFormatter=function(t,e){void 0===e&&(e={});let{numberingSystem:r}=e;r&&-1===t.indexOf("-u-nu-")&&(t=t+"-u-nu-"+r);if("unit"===e.style&&!Ke){var o;let{unit:t,unitDisplay:r="short"}=e;if(!t)throw new Error('unit option must be provided with style: "unit"');if(null==(o=Xe[t])||!o[r])throw new Error("Unsupported unit "+t+" with unitDisplay = "+r);e=Re({},e,{style:"decimal"})}let i=t+(e?Object.entries(e).sort(((t,e)=>t[0]<e[0]?-1:1)).join():"");if(je.has(i))return je.get(i);let s=new Intl.NumberFormat(t,e);return je.set(i,s),s}(t,e),this.options=e}format(t){let e="";if(e=Ve||null==this.options.signDisplay?this.numberFormatter.format(t):function(t,e,r){if("auto"===e)return t.format(r);if("never"===e)return t.format(Math.abs(r));{let o=!1;if("always"===e?o=r>0||Object.is(r,0):"exceptZero"===e&&(Object.is(r,-0)||Object.is(r,0)?r=Math.abs(r):o=r>0),o){let e=t.format(-r),o=t.format(r),i=e.replace(o,"").replace(/\u200e|\u061C/,"");return 1!==[...i].length&&console.warn("@react-aria/i18n polyfill for NumberFormat signDisplay: Unsupported case"),e.replace(o,"!!!").replace(i,"+").replace("!!!",o)}return t.format(r)}}(this.numberFormatter,this.options.signDisplay,t),"unit"===this.options.style&&!Ke){var r;let{unit:t,unitDisplay:o="short",locale:i}=this.resolvedOptions(),s=null==(r=Xe[t])?void 0:r[o];e+=s[i]||s.default}return e}formatToParts(t){return this.numberFormatter.formatToParts(t)}resolvedOptions(){let t=this.numberFormatter.resolvedOptions();return Ve||null==this.options.signDisplay||(t=Re({},t,{signDisplay:this.options.signDisplay})),Ke||"unit"!==this.options.style||(t=Re({},t,{style:"unit",unit:this.options.unit,unitDisplay:this.options.unitDisplay})),t}}const Ye=new RegExp("^.*\\(.*\\).*$"),We=["latn","arab","hanidec"];class Ze{constructor(t,e){void 0===e&&(e={}),this.locale=void 0,this.options=void 0,this.locale=t,this.options=e}parse(t){return Je(this.locale,this.options,t).parse(t)}isValidPartialNumber(t,e,r){return Je(this.locale,this.options,t).isValidPartialNumber(t,e,r)}getNumberingSystem(t){return Je(this.locale,this.options,t).options.numberingSystem}}const Qe=new Map;function Je(t,e,r){let o=tr(t,e);if(!t.includes("-nu-")&&!o.isValidPartialNumber(r))for(let i of We)if(i!==o.options.numberingSystem){let o=tr(t+(t.includes("-u-")?"-nu-":"-u-nu-")+i,e);if(o.isValidPartialNumber(r))return o}return o}function tr(t,e){let r=t+(e?Object.entries(e).sort(((t,e)=>t[0]<e[0]?-1:1)).join():""),o=Qe.get(r);return o||(o=new er(t,e),Qe.set(r,o)),o}class er{constructor(t,e){void 0===e&&(e={}),this.formatter=void 0,this.options=void 0,this.symbols=void 0,this.formatter=new Intl.NumberFormat(t,e),this.options=this.formatter.resolvedOptions(),this.symbols=function(t,e,r){var o,i,s,a,l;let c=t.formatToParts(-10000.111),n=t.formatToParts(10000.111),d=t.formatToParts(1),u=null!=(o=null==(i=c.find((t=>"minusSign"===t.type)))?void 0:i.value)?o:"-",p=null==(s=n.find((t=>"plusSign"===t.type)))?void 0:s.value;p||"exceptZero"!==(null==r?void 0:r.signDisplay)&&"always"!==(null==r?void 0:r.signDisplay)||(p="+");let m=null==(a=c.find((t=>"decimal"===t.type)))?void 0:a.value,h=null==(l=c.find((t=>"group"===t.type)))?void 0:l.value,b=c.filter((t=>!rr.has(t.type))).map((t=>ir(t.value))),g=d.filter((t=>!rr.has(t.type))).map((t=>ir(t.value))),v=[...new Set([...g,...b])].sort(((t,e)=>e.length-t.length)),f=new RegExp(v.join("|")+"|[\\p{White_Space}]","gu"),x=[...new Intl.NumberFormat(e.locale,{useGrouping:!1}).format(9876543210)].reverse(),y=new Map(x.map(((t,e)=>[t,e]))),k=new RegExp("["+x.join("")+"]","g");return{minusSign:u,plusSign:p,decimal:m,group:h,literals:f,numeral:k,index:t=>String(y.get(t))}}(this.formatter,this.options,e)}parse(t){let e=this.sanitize(t);e=or(e,this.symbols.group,"").replace(this.symbols.decimal,".").replace(this.symbols.minusSign,"-").replace(this.symbols.numeral,this.symbols.index);let r=e?+e:NaN;if(isNaN(r))return NaN;var o;("accounting"===this.options.currencySign&&Ye.test(t)&&(r*=-1),"percent"===this.options.style)&&(r/=100,r=+r.toFixed((null!=(o=this.options.maximumFractionDigits)?o:0)+2));return r}sanitize(t){return t=(t=t.replace(this.symbols.literals,"")).replace("-",this.symbols.minusSign),"arab"===this.options.numberingSystem&&(t=or(t=(t=t.replace(",",this.symbols.decimal)).replace(String.fromCharCode(1548),this.symbols.decimal),".",this.symbols.group)),"fr-FR"===this.options.locale&&(t=or(t,".",String.fromCharCode(8239))),t}isValidPartialNumber(t,e,r){return void 0===e&&(e=-1/0),void 0===r&&(r=1/0),(t=this.sanitize(t)).startsWith(this.symbols.minusSign)&&e<0?t=t.slice(this.symbols.minusSign.length):this.symbols.plusSign&&t.startsWith(this.symbols.plusSign)&&r>0&&(t=t.slice(this.symbols.plusSign.length)),!t.startsWith(this.symbols.group)&&0===(t=or(t,this.symbols.group,"").replace(this.symbols.numeral,"").replace(this.symbols.decimal,"")).length}}const rr=new Set(["decimal","fraction","integer","minusSign","plusSign","group"]);function or(t,e,r){return t.replaceAll?t.replaceAll(e,r):t.split(e).join(r)}function ir(t){return t.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")}var sr=u`:host{--spectrum-stepper-width:var(
...
)}`;class pr extends(y(e,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[ur]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return r`<div class="track"></div><div class="fills">${["Mask1","Mask2"].map(((e,o)=>r`<div class="fill${e}"><div class="fillSub${e}" style="${f(t[o])}"><div class="fill"></div></div></div>`))}</div>`}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}o([i({type:Boolean,reflect:!0})],pr.prototype,"indeterminate",void 0),o([i({type:String})],pr.prototype,"label",void 0),o([i({type:Boolean,reflect:!0,attribute:"over-background"})],pr.prototype,"overBackground",void 0),o([i({type:Number})],pr.prototype,"progress",void 0),customElements.define("sp-progress-circle",pr);var mr=u`:host{--spectrum-radio-circle-dot-size:var(
...
)}:host(:focus){outline:0}:host([disabled]){pointer-events:none}`;class hr extends(C(e)){constructor(){super(...arguments),this.autofocus=!1,this.value="",this.checked=!1,this.disabled=!1,this.emphasized=!1,this.invalid=!1,this.readonly=!1}static get styles(){return[mr]}click(){this.disabled||this.activate()}manageAutoFocus(){this.autofocus&&(this.dispatchEvent(new KeyboardEvent("keydown",{code:"Tab"})),this.focus())}activate(){this.checked||(this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}handleKeyup(t){"Space"===t.code&&this.activate()}render(){return r`<div id="input"></div><span id="button"></span> <span id="label" role="presentation"><slot></slot></span>`}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","radio"),this.hasAttribute("tabindex")||(this.tabIndex=0),this.manageAutoFocus(),this.addEventListener("click",this.activate),this.addEventListener("keyup",this.handleKeyup)}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")),t.has("checked")&&(this.checked?this.setAttribute("aria-checked","true"):this.setAttribute("aria-checked","false")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabeld"))}}o([i({type:Boolean})],hr.prototype,"autofocus",void 0),o([i({type:String,reflect:!0})],hr.prototype,"value",void 0),o([i({type:Boolean,reflect:!0})],hr.prototype,"checked",void 0),o([i({type:Boolean,reflect:!0})],hr.prototype,"disabled",void 0),o([i({type:Boolean,reflect:!0})],hr.prototype,"emphasized",void 0),o([i({type:Boolean,reflect:!0})],hr.prototype,"invalid",void 0),o([i({type:Boolean,reflect:!0})],hr.prototype,"readonly",void 0),customElements.define("sp-radio",hr);class br extends(C(Ie)){constructor(){super(...arguments),this.name="",this.rovingTabindexController=new n(this,{focusInIndex:t=>t.findIndex((t=>this.selected?!t.disabled&&t.value===this.selected:!t.disabled)),elementEnterAction:t=>{this.selected=t.value},elements:()=>this.buttons,isFocusableElement:t=>!t.disabled}),this.selected=""}get buttons(){return this.defaultNodes.filter((t=>t instanceof hr))}focus(){this.rovingTabindexController.focus()}_setSelected(t){if(t===this.selected)return;const e=this.selected,r=t?this.querySelector(`sp-radio[value="${t}"]`):void 0;this.selected=r?t:"";this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))?this.validateRadios():this.selected=e}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","radiogroup");const e=this.querySelector("sp-radio[checked]"),r=e?e.value:"";if(this.selected=r||this.selected,this.selected&&this.selected!==r){const t=this.querySelector(`sp-radio[value="${this.selected}"]`);t?t.checked=!0:this.selected=""}this.shadowRoot.addEventListener("change",(t=>{t.stopPropagation();const e=t.target;this._setSelected(e.value)}))}updated(t){super.updated(t),t.has("selected")&&this.validateRadios()}validateRadios(){let t=!1;this.buttons.map((e=>{e.checked=this.selected===e.value,t=t||e.checked})),t||(this.selected="")}handleSlotchange(){this.rovingTabindexController.clearElementCache()}}o([i({type:String})],br.prototype,"name",void 0),o([b("")],br.prototype,"defaultNodes",void 0),o([i({reflect:!0})],br.prototype,"selected",void 0),customElements.define("sp-radio-group",br),customElements.define("sp-sidenav-heading",d);const gr={toNormalized:(t,e,r)=>(t-e)/(r-e),fromNormalized:(t,e,r)=>t*(r-e)+e},vr={fromAttribute:t=>"previous"===t?t:parseFloat(t),toAttribute:t=>t.toString()},fr={fromAttribute:t=>"next"===t?t:parseFloat(t),toAttribute:t=>t.toString()};class xr extends g{constructor(){super(...arguments),this._forcedUnit="",this.value=10,this.dragging=!1,this.highlight=!1,this.name="",this.resolvedLanguage=document.documentElement.lang||navigator.language,this.label="",this.getAriaHandleText=(t,e)=>e.format(t),this.normalization=gr}get handleName(){return this.name}get focusElement(){var t,e;return null!==(e=null===(t=this.handleController)||void 0===t?void 0:t.inputForHandle(this))&&void 0!==e?e:this}update(t){(t.has("formatOptions")||t.has("resolvedLanguage"))&&delete this._numberFormatCache,super.update(t)}updated(t){var e,r;if(t.has("value")){null!=t.get("value")&&(null===(e=this.handleController)||void 0===e||e.setValueFromHandle(this))}null===(r=this.handleController)||void 0===r||r.handleHasChanged(this),super.updated(t)}firstUpdated(t){super.firstUpdated(t),this.dispatchEvent(new CustomEvent("sp-slider-handle-ready"))}dispatchInputEvent(){const t=new Event("input",{bubbles:!0,composed:!0});this.dispatchEvent(t)}getNumberFormat(){var t;if(!this._numberFormatCache||this.resolvedLanguage!==this._numberFormatCache.language){let t;try{t=new Ge(this.resolvedLanguage,this.formatOptions),this._forcedUnit=""}catch(e){const r=this.formatOptions||{},{style:o,unit:i,unitDisplay:s}=r,a=c(r,["style","unit","unitDisplay"]);"unit"===o&&(this._forcedUnit=i),t=new Ge(this.resolvedLanguage,a)}this._numberFormatCache={language:this.resolvedLanguage,numberFormat:t}}return null===(t=this._numberFormatCache)||void 0===t?void 0:t.numberFormat}get numberFormat(){if(this.formatOptions)return this.getNumberFormat()}connectedCallback(){super.connectedCallback(),this.resolveLanguage()}disconnectedCallback(){this.resolveLanguage(),super.disconnectedCallback()}resolveLanguage(){const t=new CustomEvent("sp-language-context",{bubbles:!0,composed:!0,detail:{callback:t=>{this.resolvedLanguage=t}},cancelable:!0});this.dispatchEvent(t)}}o([i({type:Number})],xr.prototype,"value",void 0),o([i({type:Boolean,reflect:!0})],xr.prototype,"dragging",void 0),o([i({type:Boolean})],xr.prototype,"highlight",void 0),o([i({type:String})],xr.prototype,"name",void 0),o([i({reflect:!0,converter:vr})],xr.prototype,"min",void 0),o([i({reflect:!0,converter:fr})],xr.prototype,"max",void 0),o([i({attribute:!1})],xr.prototype,"resolvedLanguage",void 0),o([i({type:Number,reflect:!0})],xr.prototype,"step",void 0),o([i({type:Object,attribute:"format-options"})],xr.prototype,"formatOptions",void 0),o([i({type:String})],xr.prototype,"label",void 0),o([i({attribute:!1})],xr.prototype,"getAriaHandleText",void 0),o([i({attribute:!1})],xr.prototype,"normalization",void 0),customElements.define("sp-slider-handle",xr);var yr=u`:host{--spectrum-slider-tick-mark-width:var(
...
)}`;class Lr extends(y(e)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Er]}render(){return r`<slot></slot>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}o([i({type:Boolean,reflect:!0})],Lr.prototype,"disabled",void 0),o([i({reflect:!0})],Lr.prototype,"variant",void 0),customElements.define("sp-status-light",Lr);var _r=u`:host{--spectrum-switch-handle-size:var(
...
);--spectrum-switch-track-width:var(--spectrum-global-dimension-size-325);--spectrum-switch-handle-border-radius:50%}:host([disabled]){pointer-events:none}:host([dir=ltr][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-track-width) - var(--spectrum-switch-handle-size)))}:host([dir=rtl][checked]) #input+#switch:before{transform:translateX(calc(var(--spectrum-switch-handle-size) - var(--spectrum-switch-track-width)))}`;var Mr=u`#switch:before{transition:background var(--spectrum-global-animation-duration-100,.13s) ease-in-out,border var(--spectrum-global-animation-duration-100,.13s) ease-in-out,box-shadow var(--spectrum-global-animation-duration-100,.13s) ease-in-out}`;class Br extends Bt{constructor(){super(...arguments),this.emphasized=!1}static get styles(){return window.hasOwnProperty("ShadyDOM")?[_r,Mr]:[_r]}render(){return r`${super.render()} <span id="switch"></span> <label id="label" for="input"><slot></slot></label>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("role","switch")}updated(t){t.has("checked")&&this.inputElement.setAttribute("aria-checked",this.checked?"true":"false")}}o([i({type:Boolean,reflect:!0})],Br.prototype,"emphasized",void 0),customElements.define("sp-switch",Br);var Pr=u`:host{box-sizing:border-box;cursor:pointer;height:var(--spectrum-tabs-quiet-textonly-tabitem-height);line-height:var(--spectrum-tabs-quiet-textonly-tabitem-height);outline:0;position:relative;text-decoration:none;transition:color var(
...
--spectrum-alias-focus-ring-gap,
var(--spectrum-global-dimension-static-size-25)
)*-1);position:absolute;right:0;top:0}::slotted(:not(img)){display:none}`;class Vr extends(y(e,{validSizes:["xxs","xs","s","m","l"],defaultSize:"s"})){constructor(){super(...arguments),this.cover=!1}static get styles(){return[jr]}render(){return r`${this.background?r`<div class="background" style="background:${this.background}"></div>`:r``}<slot></slot>`}}o([i({type:String,reflect:!0})],Vr.prototype,"background",void 0),o([i({type:Boolean,reflect:!0})],Vr.prototype,"cover",void 0),customElements.define("sp-thumbnail",Vr);var Kr=u`:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
)}`;class Qr extends(w(g)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[Pr,Zr]}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return r`<a id="item-label" href="${f(this.href)}" download="${f(this.download)}" target="${f(this.target)}" aria-label="${f(this.label)}" aria-current="${f(this.selected&&this.href?"page":void 0)}" rel="${f(this.rel)}"><slot></slot></a>`}firstUpdated(t){super.firstUpdated(t)}updated(t){super.updated(t),this.value=this.anchor.href}}o([x("a")],Qr.prototype,"anchor",void 0),o([i({type:Boolean,reflect:!0})],Qr.prototype,"selected",void 0),customElements.define("sp-top-nav-item",Qr),window.Overlay=X;class Jr extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}}customElements.define("styled-element",Jr),null===(Wr=document.querySelector('sp-tab-panel[value="api"]'))||void 0===Wr||Wr.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"tr"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));
//# sourceMappingURL=0a576cf3.js.map
