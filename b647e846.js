...
)}`;class Et extends e{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[qt]}render(){return r`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}o([i({reflect:!0,type:String})],Et.prototype,"type",void 0),o([i({reflect:!0,type:Boolean})],Et.prototype,"corner",void 0),customElements.define("sp-banner",Et);var Lt=u`:host{--spectrum-buttongroup-button-gap-reset:0}:host{display:flex}::slotted(*){flex-shrink:0}:host([dir=ltr]) ::slotted(:not(:first-of-type)){margin-left:var(
...
)}`;class Er extends(y(e)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[qr]}render(){return r`<slot></slot>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}o([i({type:Boolean,reflect:!0})],Er.prototype,"disabled",void 0),o([i({reflect:!0})],Er.prototype,"variant",void 0),customElements.define("sp-status-light",Er);var Lr=u`:host{--spectrum-switch-handle-size:var(
...
//# sourceMappingURL=b647e846.js.map
