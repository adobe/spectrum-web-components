import{i as t}from"./d230bd74.js";import{S as e,y as i,e as o}from"./95f60e39.js";import{F as s,O as a,b as r,S as c,a as l,l as n,i as d,L as m}from"./5f508a3c.js";import{R as b}from"./02250eff.js";import"./c831624f.js";import"./d30b4cb2.js";import"./8441056a.js";import{Overlay as u}from"./5c54a18c.js";var p=t`
:host{display:inline-flex}:host(:not([selected])){display:none}
`,h=Object.defineProperty,v=Object.getOwnPropertyDescriptor,x=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?v(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&h(e,i,a),a};const g=class extends e{constructor(){super(...arguments),this.selected=!1,this.value=""}render(){return i`
            <slot></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+g.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};let y=g;y.styles=[p],y.instanceCount=0,x([o({type:Boolean,reflect:!0})],y.prototype,"selected",2),x([o({type:String,reflect:!0})],y.prototype,"value",2),customElements.define("sp-tab-panel",y);var f=t`
...
`,z=Object.defineProperty,k=Object.getOwnPropertyDescriptor,q=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?k(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&z(e,i,a),a};const w=class extends(s(a(r(e,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[f]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}handleContentChange(){this.dispatchEvent(new Event("sp-tab-contentchange",{bubbles:!0,composed:!0}))}render(){return i`
            ${this.hasIcon?i`
                      <slot name="icon"></slot>
                  `:i``}
...
`,A=Object.defineProperty,E=Object.getOwnPropertyDescriptor,T=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?E(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&A(e,i,a),a};const $={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`,R=Object.defineProperty,D=Object.getOwnPropertyDescriptor,F=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?D(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&R(e,i,a),a};class X extends(m(l)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[f,U]}handleContentChange(){this.dispatchEvent(new Event("sp-top-nav-item-contentchange",{bubbles:!0,composed:!0}))}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return i`
            <a
                id="item-label"
                href=${n(this.href)}
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.shadowRoot.addEventListener("slotchange",this.handleContentChange)}updated(t){super.updated(t),t.has("label")&&void 0!==t.get("label")&&this.handleContentChange(),this.value=this.anchor.href}}F([d("a")],X.prototype,"anchor",2),F([o({type:Boolean,reflect:!0})],X.prototype,"selected",2),customElements.define("sp-top-nav-item",X),document.querySelector("sp-tabs").addEventListener("change",(t=>{const e=t.target,{selected:i}=e,{pathname:o}=location,s=o.search("api")>-1;switch(i){case"api":{if(s)return;const t=(o+"/api/").replace("//a","/a");history.pushState({},document.title,t);break}case"examples":{if(!s)return;const t=o.split("/api")[0]+"/";history.pushState({},document.title,t);break}}})),"requestIdleCallback"in window?requestIdleCallback((()=>{import("./7db2f415.js"),import("./a4a5714c.js")})):requestAnimationFrame((()=>{import("./7db2f415.js"),import("./a4a5714c.js")})),window.Overlay=u;var _=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}};customElements.define("styled-element",_),document.querySelector('sp-tab-panel[value="api"]')?.addEventListener("click",(t=>{const e=t.composedPath().find((t=>"tr"===t.localName&&t.id));e&&(location.hash=e.id,t.target.dispatchEvent(new CustomEvent("copy-text",{bubbles:!0,composed:!0,detail:{text:e.dataset.value,message:`${e.dataset.name} copied to clipboard!`}})))}));
//# sourceMappingURL=4edc32ed.js.map
