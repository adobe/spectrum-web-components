import{i as r}from"./67a87733.js";import{M as e,I as o,o as t,b as i}from"./8588818e.js";import{i as c,S as a,a as s}from"./0c1af6fc.js";import{r as n}from"./590196c7.js";import"./46ba864d.js";import"./7b3008bb.js";import"./56d56bc4.js";import"./5d7d13ac.js";import{f as l}from"./045d5864.js";import{S as p,x as u,e as d,d as m,B as h,A as v}from"./cd228091.js";import{o as k}from"./e81a6d1a.js";var b=r`
...
`,y=Object.defineProperty,x=Object.getOwnPropertyDescriptor,w=(r,e,o,t)=>{for(var i,c=t>1?void 0:t?x(e,o):e,a=r.length-1;a>=0;a--)(i=r[a])&&(c=(t?i(e,o,c):i(c))||c);return t&&c&&y(e,o,c),c};class z extends p{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new e(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[f,g]}focus(){const r=l(this);r?r.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(r){r.has("open")&&void 0!==r.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise((r=>{this.resolveTransitionPromise=()=>{this.animating=!1,r()}}))),super.update(r)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
