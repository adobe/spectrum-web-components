...
`,s=Object.defineProperty,o=Object.getOwnPropertyDescriptor;class u extends(e(c,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return i``}firstUpdated(r){super.firstUpdated(r),this.setAttribute("role","separator")}updated(r){super.updated(r),r.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}u.styles=[d],((r,e,i,t)=>{for(var c,a=t>1?void 0:t?o(e,i):e,d=r.length-1;d>=0;d--)(c=r[d])&&(a=(t?c(e,i,a):c(a))||a);t&&a&&s(e,i,a)})([t({type:Boolean,reflect:!0})],u.prototype,"vertical",2),a("sp-divider",u);export{d as s};
//# sourceMappingURL=44c30927.js.map
