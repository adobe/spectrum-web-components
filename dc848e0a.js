import{e as t,i as e,t as o,S as r,a as i,c as l}from"./6aa90d34.js";import{r as c}from"./e50c5e8d.js";import"./82cefaa7.js";import{S as a,l as n,a as s,i as u}from"./d07a663a.js";import{e as d,R as p,b as m,w as v,$ as h}from"./8dfa8611.js";import"./d83790ec.js";import"./053a2895.js";function f(t){return d({...t,state:!0})}const{H:b}=p,x=t=>void 0===t.strings,g=()=>document.createComment(""),w=(t,e,o)=>{var r;const i=t._$AA.parentNode,l=void 0===e?t._$AB:e._$AA;if(void 0===o){const e=i.insertBefore(g(),l),r=i.insertBefore(g(),l);o=new b(e,r,t,t.options)}else{const e=o._$AB.nextSibling,c=o._$AM,a=c!==t;if(a){let e;null===(r=o._$AQ)||void 0===r||r.call(o,t),o._$AM=t,void 0!==o._$AP&&(e=t._$AU)!==c._$AU&&o._$AP(e)}if(e!==l||a){let t=o._$AA;for(;t!==e;){const e=t.nextSibling;i.insertBefore(t,l),t=e}}}return o},k=(t,e,o=t)=>(t._$AI(e,o),t),y={},q=(t,e=y)=>t._$AH=e,z=t=>t._$AH,$=t=>{var e;null===(e=t._$AP)||void 0===e||e.call(t,!1,!0);let o=t._$AA;const r=t._$AB.nextSibling;for(;o!==r;){const t=o.nextSibling;o.remove(),o=t}},T=t(class extends e{constructor(t){if(super(t),t.type!==o.PROPERTY&&t.type!==o.ATTRIBUTE&&t.type!==o.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===m||e===v)return e;const r=t.element,i=t.name;if(t.type===o.PROPERTY){if(e===r[i])return m}else if(t.type===o.BOOLEAN_ATTRIBUTE){if(!!e===r.hasAttribute(i))return m}else if(t.type===o.ATTRIBUTE&&r.getAttribute(i)===e+"")return m;return q(t),e}});var B=c`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
--spectrum-textfield-m-textonly-focus-ring-border-color-key-focus,var(--spectrum-alias-focus-ring-color)
)!important}:host([multiline]:not([quiet])) #textfield:after{box-shadow:none}`,F=Object.defineProperty,U=Object.getOwnPropertyDescriptor,O=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?U(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&F(e,o,l),l};const P=["text","url","tel","email","password"];class R extends(L(s)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[C,l]}get type(){var t;return null!=(t=P.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value){if(!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?h`<sp-icon-alert id="invalid" class="icon"></sp-icon-alert>`:this.valid?h`<sp-icon-checkmark100 id="valid" class="icon spectrum-UIIcon-Checkmark100"></sp-icon-checkmark100>`:v}get displayValue(){return this.value.toString()}get renderMultiline(){return h`${this.grows&&!this.quiet?h`<div id="sizer">${this.value}​</div>`:v} <textarea aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${n(this.invalid||void 0)}" class="input" maxlength="${n(this.maxlength>-1?this.maxlength:void 0)}" minlength="${n(this.minlength>-1?this.minlength:void 0)}" pattern="${n(this.pattern)}" placeholder="${this.placeholder}" .value="${this.displayValue}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${n(this.autocomplete)}"></textarea>`}get renderInput(){return h`<input type="${this.type}" aria-describedby="${this.helpTextId}" aria-label="${this.label||this.placeholder}" aria-invalid="${n(this.invalid||void 0)}" class="input" maxlength="${n(this.maxlength>-1?this.maxlength:void 0)}" minlength="${n(this.minlength>-1?this.minlength:void 0)}" pattern="${n(this.pattern)}" placeholder="${this.placeholder}" .value="${T(this.displayValue)}" @change="${this.handleChange}" @input="${this.handleInput}" @focus="${this.onFocus}" @blur="${this.onBlur}" ?disabled="${this.disabled}" ?required="${this.required}" ?readonly="${this.readonly}" autocomplete="${n(this.autocomplete)}">`}renderField(){return h`${this.renderStateIcons()} ${this.multiline?this.renderMultiline:this.renderInput}`}render(){return h`<div id="textfield">${this.renderField()}</div>${this.renderHelpText(this.invalid)}`}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();if(this.required||this.value&&this.pattern){if((this.disabled||this.multiline)&&this.pattern){t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())}void 0!==this.minlength&&(t=t&&this.value.toString().length>this.minlength),this.valid=t,this.invalid=!t}return t}}O([d({attribute:"allowed-keys"})],R.prototype,"allowedKeys",2),O([d({type:Boolean,reflect:!0})],R.prototype,"focused",2),O([u(".input")],R.prototype,"inputElement",2),O([d({type:Boolean,reflect:!0})],R.prototype,"invalid",2),O([d()],R.prototype,"label",2),O([d()],R.prototype,"placeholder",2),O([d({attribute:"type",reflect:!0})],R.prototype,"_type",2),O([f()],R.prototype,"type",1),O([d()],R.prototype,"pattern",2),O([d({type:Boolean,reflect:!0})],R.prototype,"grows",2),O([d({type:Number})],R.prototype,"maxlength",2),O([d({type:Number})],R.prototype,"minlength",2),O([d({type:Boolean,reflect:!0})],R.prototype,"multiline",2),O([d({type:Boolean,reflect:!0})],R.prototype,"readonly",2),O([d({type:Boolean,reflect:!0})],R.prototype,"valid",2),O([d({type:String})],R.prototype,"value",1),O([d({type:Boolean,reflect:!0})],R.prototype,"quiet",2),O([d({type:Boolean,reflect:!0})],R.prototype,"required",2),O([d({type:String,reflect:!0})],R.prototype,"autocomplete",2);class G extends R{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}O([d({type:String})],G.prototype,"value",1),customElements.define("sp-clear-button",_);var M=c`:host{--spectrum-search-quiet-button-offset:calc(var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`,N=Object.defineProperty,K=Object.getOwnPropertyDescriptor,V=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?K(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&N(e,o,l),l};const D=t=>t.stopPropagation();class Y extends G{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,M]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;this.value&&"Escape"===e&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return h`<form action="${this.action}" id="form" method="${n(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.renderField()} ${this.value?h`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${D}"></sp-clear-button>`:h``}</form>`}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}V([d()],Y.prototype,"action",2),V([d()],Y.prototype,"label",2),V([d()],Y.prototype,"method",2),V([d()],Y.prototype,"placeholder",2),V([u("#form")],Y.prototype,"form",2),customElements.define("sp-search",Y);export{L as M,R as T,z as a,H as b,k as c,G as d,$ as m,x as r,q as s,f as t,w as u};
//# sourceMappingURL=dc848e0a.js.map
