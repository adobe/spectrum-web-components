import{d as e,E as t,N as r,C as a,P as i,A as s,S as n,h as o,_ as l,p as c,M as m,f as p,e as u,u as d,n as g,i as h,q as v,D as x,t as f,I as b,s as y,v as z}from"./6937ee0c.js";import{c as w}from"./590b58a0.js";const k=e((e=>n=>{let o;if(n instanceof t||n instanceof r)throw new Error("The `live` directive is not allowed on text or event bindings");if(n instanceof a)X(n.strings),o=n.element.hasAttribute(n.name),n.value=o;else{const{element:t,name:r,strings:a}=n.committer;if(X(a),n instanceof i){if(o=t[r],o===e)return}else n instanceof s&&(o=t.getAttribute(r));if(o===String(e))return}n.setValue(e)})),X=e=>{if(2!==e.length||""!==e[0]||""!==e[1])throw new Error("`live` bindings can only contain a single expression")},L=e=>e.getRootNode().activeElement;var H=w`.spectrum{color:var(--spectrum-body-m-text-color,var(--spectrum-alias-text-color));font-family:var(
...
)}`;class B extends n{constructor(){super(...arguments),this.open=!1}static get styles(){return[j]}render(){return o``}}l([c({type:Boolean,reflect:!0})],B.prototype,"open",void 0),customElements.define("sp-underlay",B);var D=w`:host{--spectrum-illustrated-message-description-max-width:500px;--spectrum-illustrated-message-heading-max-width:500px;--spectrum-illustrated-message-illustration-margin-bottom:24px;--spectrum-illustrated-message-heading-margin:0;--spectrum-illustrated-message-description-margin:4px 0 0 0}:host{align-items:center;display:flex;flex-direction:column;height:100%;justify-content:center;text-align:center}#illustration{margin-bottom:var(
...
)}::slotted(svg[viewBox]){width:100%}`;var $=[H,S,w`.spectrum-Body--sizeXXXL{font-size:var(
...
--spectrum-body-m-text-color,var(--spectrum-alias-text-color)
)}`];class E extends n{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[q,$,D]}render(){return o`<div id="illustration"><slot></slot></div><h2 id="heading" class="spectrum-Heading spectrum-Heading--sizeL spectrum-Heading--light"><slot name="heading">${this.heading}</slot></h2><div id="description" class="spectrum-Body spectrum-Body--sizeS"><slot name="description">${this.description}</slot></div>`}}E.is="sp-illustrated-message",l([c()],E.prototype,"heading",void 0),l([c()],E.prototype,"description",void 0),customElements.define("sp-illustrated-message",E);var C=w`.header{color:var(--spectrum-listheading-text-color);display:block;font-size:var(--spectrum-listitem-texticon-heading-text-size);font-weight:var(--spectrum-listitem-texticon-heading-text-font-weight);letter-spacing:var(
--spectrum-listitem-texticon-heading-letter-spacing
);line-height:var(--spectrum-listitem-texticon-heading-line-height);margin:var(--spectrum-listitem-texticon-heading-margin);padding:var(--spectrum-listitem-texticon-heading-padding);text-transform:var(--spectrum-listitem-texticon-heading-text-transform)}:host{display:inline;margin:0;overflow:visible}:host([dir=ltr]) .header{padding:0 var(--spectrum-global-dimension-size-450) 0 var(--spectrum-global-dimension-size-150)}:host([dir=rtl]) .header{padding:0 var(--spectrum-global-dimension-size-150) 0 var(--spectrum-global-dimension-size-450)}sp-menu{display:block}`;class I extends m{constructor(){super(),I.instances+=1,this.headerId=`sp-menu-group-label-${I.instances}`}static get styles(){return[...super.styles,C]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return o`<span class="header" aria-hidden="true"><slot name="header" @slotchange="${this.updateLabel}"></slot></span><sp-menu role="none"><slot></slot></sp-menu>`}}I.instances=0,l([p("header",!0)],I.prototype,"headerElements",void 0),customElements.define("sp-menu-group",I);var M=w`:host{--spectrum-textfield-texticon-padding-left:var(
...
--spectrum-textfield-m-texticon-text-color-disabled,var(--spectrum-alias-component-text-color-disabled)
)}input::-webkit-search-cancel-button{display:none}`;const K=e=>e.stopPropagation();class U extends _{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,A]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;this.value&&"Escape"===t&&this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}render(){return o`<form action="${this.action}" id="form" method="${h(this.method)}" @submit="${this.handleSubmit}" @reset="${this.reset}" @keydown="${this.handleKeydown}"><sp-icon-magnify class="icon magnifier icon-workflow"></sp-icon-magnify>${super.render()} ${this.value?o`<sp-clear-button id="button" label="Reset" tabindex="-1" type="reset" @keydown="${K}"></sp-clear-button>`:o``}</form>`}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}updated(e){super.updated(e),this.multiline=!1}}l([c()],U.prototype,"action",void 0),l([c()],U.prototype,"label",void 0),l([c()],U.prototype,"method",void 0),l([c()],U.prototype,"placeholder",void 0),l([v("#form")],U.prototype,"form",void 0),customElements.define("sp-search",U);var R=w`:host{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}`;var F=w`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
--spectrum-sidenav-icon-gap,var(--spectrum-global-dimension-size-100)
)}#itemLink ::slotted([slot=icon]){flex-shrink:0}:host([dir=ltr]) .spectrum-SideNav-heading{margin-right:0}:host([dir=rtl]) .spectrum-SideNav-heading{margin-left:0}:host([dir=ltr]) .spectrum-SideNav-heading{margin-left:0}:host([dir=rtl]) .spectrum-SideNav-heading{margin-right:0}:host([dir=ltr]) .spectrum-SideNav--multiLevel #list #itemLink{padding-left:calc(var(--spectrum-sidenav-multilevel-item-margin-left,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=rtl]) .spectrum-SideNav--multiLevel #list #itemLink{padding-right:calc(var(--spectrum-sidenav-multilevel-item-margin-left,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=ltr]) .spectrum-SideNav--multiLevel #list #list #itemLink{padding-left:calc(var(--spectrum-sidenav-multilevel-item-margin-left,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([dir=rtl]) .spectrum-SideNav--multiLevel #list #list #itemLink{padding-right:calc(var(--spectrum-sidenav-multilevel-item-margin-left,var(--spectrum-global-dimension-size-150)) + var(--spectrum-sidenav-item-padding-x,var(--spectrum-global-dimension-size-150)))}:host([selected])>#itemLink{background-color:var(
...
)}:host{display:block}`;class P extends n{constructor(){super(...arguments),this.label=""}static get styles(){return[F,O]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return o`<h2 id="heading">${this.label}</h2><div id="list" aria-labelledby="heading"><slot name="descendant"></slot></div>`}}l([c({reflect:!0})],P.prototype,"label",void 0);class G extends u{constructor(){super(),this.items=new Set,this.manageTabIndex=!1,this.value=void 0,this.addEventListener("focusin",this.startListeningToKeyboard)}static get styles(){return[R]}startTrackingSelectionForItem(e){this.items.add(e)}stopTrackingSelectionForItem(e){this.items.delete(e)}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.focusElement!==this&&super.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){const e=this.querySelector("[selected]");if(e&&!this.isDisabledChild(e))return e;const t=[...this.querySelectorAll("sp-sidenav-item")];let r=0;for(;r<t.length&&t[r]&&this.isDisabledChild(t[r]);)r+=1;return t[r]?t[r]:this}startListeningToKeyboard(){if(this.addEventListener("keydown",this.handleKeydown),this.addEventListener("focusout",this.stopListeningToKeyboard),this.value&&this.manageTabIndex){const e=this.querySelector(`[value="${this.value}"]`);e&&(e.tabIndex=-1)}}stopListeningToKeyboard(){if(this.removeEventListener("keydown",this.handleKeydown),this.removeEventListener("focusout",this.stopListeningToKeyboard),this.value&&this.manageTabIndex){const e=this.querySelector(`[value="${this.value}"]`);e&&(e.tabIndex=0)}}handleKeydown(e){const{code:t}=e;if("ArrowDown"!==t&&"ArrowUp"!==t)return;e.preventDefault();const r="ArrowDown"===t?1:-1;this.focusItemByOffset(r)}focusItemByOffset(e){const t=[...this.querySelectorAll("sp-sidenav-item")];let r=t.indexOf(L(this));r=(t.length+r+e)%t.length;let a=t[r];for(;a&&this.isDisabledChild(a);)r=(t.length+r+e)%t.length,a=t[r];a&&!this.isDisabledChild(a)&&a.focus()}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof P||!t.disabled&&t instanceof V&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndexes()}async manageTabIndexes(){if(!this.value&&this.manageTabIndex){const e=this.querySelector("sp-sidenav-item:not([tabindex])");e&&(e.tabIndex=-1);const t=this.querySelector("sp-sidenav-item");t&&(await t.updateComplete,t.tabIndex=0)}}render(){return o`<nav @sidenav-select="${this.handleSelect}"><slot name="descendant" @slotchange="${this.handleSlotchange}"></slot></nav>`}firstUpdated(e){super.firstUpdated(e);const t=this.querySelector("[selected]");t?this.value=t.value:this.manageTabIndexes()}updated(e){if(super.updated(e),e.has("manageTabIndex")){[...this.querySelectorAll("sp-sidenav-item")].map((e=>e.manageTabIndex=this.manageTabIndex))}}}l([c({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],G.prototype,"manageTabIndex",void 0),l([c({reflect:!0})],G.prototype,"value",void 0),customElements.define("sp-sidenav",G),customElements.define("sp-sidenav-item",V);export{P as S,T,_ as a,H as b,L as g,q as h,S as l};
//# sourceMappingURL=b3900264.js.map
