import{T as t}from"./6eaca00d.js";import{r as o}from"./e50c5e8d.js";import{L as e,a as r,t as i,i as a,S as c}from"./d07a663a.js";import{r as n,f as s}from"./f284f63f.js";import"./6f8c1f49.js";import"./053a2895.js";import{b as l,$ as u,e as d,S as m,w as p,x as b}from"./8dfa8611.js";import{e as v,i as h,t as g,c as f,S as k,a as y,B as x}from"./6aa90d34.js";import"./82cefaa7.js";import"./da619438.js";customElements.define("sp-theme",t);const w=v(class extends h{constructor(t){var o;if(super(t),t.type!==g.ATTRIBUTE||"class"!==t.name||(null===(o=t.strings)||void 0===o?void 0:o.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((o=>t[o])).join(" ")+" "}update(t,[o]){var e,r;if(void 0===this.et){this.et=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in o)o[t]&&!(null===(e=this.st)||void 0===e?void 0:e.has(t))&&this.et.add(t);return this.render(o)}const i=t.element.classList;this.et.forEach((t=>{t in o||(i.remove(t),this.et.delete(t))}));for(const t in o){const e=!!o[t];e===this.et.has(t)||(null===(r=this.st)||void 0===r?void 0:r.has(t))||(e?(i.add(t),this.et.add(t)):(i.remove(t),this.et.delete(t)))}return l}});var z=o`#button{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-appearance:button;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
...
)}`;const C=async(t,o,e,r)=>{const{Overlay:i}=await import("./09e1dd18.js");return i.open(t,o,e,r)};class q extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var U=o`.checkmark{align-self:flex-start;display:none;opacity:1;transform:scale(1)}:host([dir=ltr]) .checkmark{padding-left:var(
...
--spectrum-dialog-confirm-entry-animation-delay,var(--spectrum-global-animation-duration-200)
)}@media (max-width:375px){.tray{border-radius:var(--spectrum-tray-border-radius,0)}}:host{align-items:flex-end;max-height:var(--swc-visual-viewport-height);position:fixed!important}sp-underlay{touch-action:none}.tray{display:inline-flex;overscroll-behavior:contain;padding:var(--spectrum-tray-padding-y,0) var(--spectrum-tray-padding-x,0)}::slotted(.visually-hidden){clip:rect(0,0,0,0);border:0;clip-path:inset(50%);height:1px;margin:0 -1px -1px 0;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`,J=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,tt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?Z(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&J(o,e,a),a};class ot extends m{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new N(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve()}static get styles(){return[X,Q]}focus(){const t=s(this);t?t.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return!!this.open&&(this.close(),!0)}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.dispatchClosed(),this.resolveTransitionPromise())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&void 0!==t.get("open")&&this.prefersMotion.matches&&(this.transitionPromise=new Promise((t=>this.resolveTransitionPromise=t))),super.update(t)}render(){return u`<sp-underlay ?open="${this.open}" @click="${this.close}" @transitionend="${this.handleUnderlayTransitionend}"></sp-underlay><div class="tray modal" tabindex="-1" @transitionend="${this.handleTrayTransitionend}"><slot></slot></div>`}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}tt([d({type:Boolean,reflect:!0})],ot.prototype,"open",2),tt([a(".tray")],ot.prototype,"tray",2),customElements.define("sp-tray",ot);var et=o`:host{--spectrum-overlay-animation-distance:var(
...
--mod-closebutton-animation-duration,var(--spectrum-closebutton-animation-duration)
) ease-in-out;width:var(--mod-closebutton-width,var(--spectrum-closebutton-width))}:host:after{border-radius:calc(var(--mod-closebutton-size,var(--spectrum-closebutton-size)) + var(--mod-closebutton-focus-ring-gap,var(--spectrum-closebutton-focus-ring-gap)));bottom:0;content:"";left:0;margin:calc(var(
...
)}`,yt=Object.defineProperty,xt=Object.getOwnPropertyDescriptor;const wt={s:()=>u`<sp-icon-cross75 slot="icon" class="icon spectrum-UIIcon-Cross75"></sp-icon-cross75>`,m:()=>u`<sp-icon-cross100 slot="icon" class="icon spectrum-UIIcon-Cross100"></sp-icon-cross100>`,l:()=>u`<sp-icon-cross200 slot="icon" class="icon spectrum-UIIcon-Cross200"></sp-icon-cross200>`,xl:()=>u`<sp-icon-cross300 slot="icon" class="icon spectrum-UIIcon-Cross300"></sp-icon-cross300>`};class zt extends(c(k)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,kt,y]}get buttonContent(){return[wt[this.size]()]}}((t,o,e,r)=>{for(var i,a=r>1?void 0:r?xt(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);r&&a&&yt(o,e,a)})([d({reflect:!0})],zt.prototype,"variant",2);var It=o`:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;font-family:var(--spectrum-font-family-base);justify-content:center;line-height:var(--spectrum-line-height-small);margin:0;overflow:visible;text-decoration:none;text-transform:none;transition:background var(--spectrum-animation-duration-100) ease-out,border-color var(--spectrum-animation-duration-100) ease-out,color var(--spectrum-animation-duration-100) ease-out,box-shadow var(--spectrum-animation-duration-100) ease-out;user-select:none;-webkit-user-select:none;vertical-align:top}:host(:focus){outline:0}:host(::-moz-focus-inner){border:0;border-style:none;margin-block-end:-2px;margin-block-start:-2px;padding:0}:host([disabled]){cursor:default}::slotted([slot=icon]){max-block-size:100%}#label{align-self:center;justify-self:center;text-align:center}#label:empty{display:none}:host{--spectrum-actionbutton-animation-duration:var(
--spectrum-animation-duration-100
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}@media (forced-colors:active){:host{--highcontrast-actionbutton-border-color-disabled:GrayText;--highcontrast-actionbutton-content-color-disabled:GrayText}}`;var Ct=o`@media (forced-colors:active){.spectrum-Icon,.spectrum-UIIcon{forced-color-adjust:auto}}.spectrum-UIIcon-CornerTriangle75{height:var(
...
--spectrum-alias-ui-icon-cornertriangle-size-300
)}`,qt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,Tt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?Ut(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&qt(o,e,a),a};const St={s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let Et;class Bt extends(c(x)){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{if(!this.toggles)return;this.selected=!this.selected;this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected)},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[It,Ct]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(){this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Et=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300)}onPointerup(){clearTimeout(Et),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:e}=t;("Space"===o||e&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`<sp-icon-corner-triangle300 class="hold-affordance ${St[this.size]}"></sp-icon-corner-triangle300>`),t}updated(t){super.updated(t);const o="button"===this.role&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(o?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}Tt([d({type:Boolean,reflect:!0})],Bt.prototype,"emphasized",2),Tt([d({type:Boolean,reflect:!0,attribute:"hold-affordance"})],Bt.prototype,"holdAffordance",2),Tt([d({type:Boolean,reflect:!0})],Bt.prototype,"quiet",2),Tt([d({reflect:!0})],Bt.prototype,"role",2),Tt([d({type:Boolean,reflect:!0})],Bt.prototype,"selected",2),Tt([d({type:Boolean,reflect:!0})],Bt.prototype,"toggles",2),Tt([d({reflect:!0})],Bt.prototype,"variant",2),Tt([d({type:String})],Bt.prototype,"value",1),customElements.define("sp-action-button",Bt),customElements.define("sp-menu-item",R);var At=o`:host([size=s]){--spectrum-link-primary-text-size:var(
...
)}@media (forced-colors:active){:host([variant=secondary]) a{color:linktext}:host([variant=secondary]) a:hover{color:linktext}:host([variant=secondary]) a:active{color:linktext}:host([variant=secondary]) a:focus{color:linktext}}:host{display:inline}:host(:focus){outline:0}:host([href]) a.focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}:host([href]) a:focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}`,Ft=Object.defineProperty,Pt=Object.getOwnPropertyDescriptor,jt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?Pt(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&Ft(o,e,a),a};class Rt extends(c(e(r),{noDefaultSize:!0})){static get styles(){return[At]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}jt([a("#anchor")],Rt.prototype,"anchorElement",2),jt([d({type:String,reflect:!0})],Rt.prototype,"variant",2),customElements.define("sp-link",Rt);var Lt=o`:host([size=s]){--spectrum-divider-height:var(
...
--spectrum-toast-positive-background-color,var(--spectrum-semantic-positive-background-color)
)}@media (forced-colors:active){:host{border:1px solid transparent}}.content{line-height:1.5}:host(:not([open])){display:none}`,Ht=Object.defineProperty,$t=Object.getOwnPropertyDescriptor,Gt=(t,o,e,r)=>{for(var i,a=r>1?void 0:r?$t(o,e):o,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(o,e,a):i(a))||a);return r&&a&&Ht(o,e,a),a};const Kt=["negative","positive","info","error","warning"];class Wt extends m{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[_t]}set timeout(t){const o=null!==typeof t&&t>0?Math.max(6e3,t):null,e=this.timeout;o&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=o,this.requestUpdate("timeout",e)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const o=this.variant;Kt.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`<sp-icon-info label="Information" class="type"></sp-icon-info>`;case"negative":case"error":case"warning":return u`<sp-icon-alert label="Error" class="type"></sp-icon-alert>`;case"positive":case"success":return u`<sp-icon-checkmark-circle label="Success" class="type"></sp-icon-checkmark-circle>`;default:return u``}}startCountdown(){this.countdown(),this.addEventListener("focusin",this.holdCountdown)}stopCountdown(){cancelAnimationFrame(this.nextCount),this.countdownStart=0}shouldClose(){this.dispatchEvent(new CustomEvent("close",{composed:!0,bubbles:!0,cancelable:!0}))&&this.close()}close(){this.open=!1}render(){return u`${this.renderIcon(this.variant)}<div class="body" role="alert"><div class="content"><slot></slot></div><slot name="action"></slot></div><div class="buttons"><sp-close-button @click="${this.shouldClose}" label="Close" variant="white"></sp-close-button></div>`}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}Gt([d({type:Boolean,reflect:!0})],Wt.prototype,"open",2),Gt([d({type:Number})],Wt.prototype,"timeout",1),Gt([d({type:String})],Wt.prototype,"variant",1),customElements.define("sp-toast",Wt);export{V as D,Y as I,H as M,dt as P,w as a,I as c,Lt as d,X as m,C as o};
//# sourceMappingURL=8c245a16.js.map
