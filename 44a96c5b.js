...
)}:host{--spectrum-accordion-item-header-height:46px}#indicator{top:calc(50% - var(--spectrum-accordion-icon-height,var(--spectrum-global-dimension-size-125))/ 2)}#heading{height:auto;position:relative}#header{min-height:calc(100% - var(--spectrum-accordion-item-border-size,var(--spectrum-alias-border-size-thin)))}:host([open])>#header:after{height:calc(100% - var(--spectrum-accordion-item-border-size,var(--spectrum-alias-border-size-thin)))}`;class mt extends v{constructor(){super(),this.open=!1,this.label="",this.disabled=!1,this.addEventListener("keydown",this.onKeyDown)}static get styles(){return[ht,E]}get focusElement(){return this.shadowRoot.querySelector("#header")}onKeyDown(t){this.disabled||"Enter"!==t.code&&"Space"!==t.code||(t.preventDefault(),this.toggle())}onClick(){this.disabled||this.toggle()}toggle(){this.open=!this.open;this.dispatchEvent(new CustomEvent("sp-accordion-item-toggle",{bubbles:!0,composed:!0,cancelable:!0}))||(this.open=!this.open)}render(){return r`<h3 id="heading"><button id="header" @click="${this.onClick}" aria-expanded="${this.open}" aria-controls="content">${this.label}</button><sp-icon-chevron100 id="indicator" class="spectrum-UIIcon-ChevronRight100"></sp-icon-chevron100></h3><div id="content" role="region" aria-labelledby="header"><slot></slot></div>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}o([i({type:Boolean,reflect:!0})],mt.prototype,"open",void 0),o([i({type:String,reflect:!0})],mt.prototype,"label",void 0),o([i({type:Boolean,reflect:!0})],mt.prototype,"disabled",void 0),customElements.define("sp-accordion-item",mt);var bt=u`:host{--spectrum-actionbar-height:var(
...
);pointer-events:auto;position:relative;width:100%}`;const vt=["sticky","fixed"];class gt extends e{constructor(){super(...arguments),this.flexible=!1,this.open=!1,this._variant=""}static get styles(){return[bt]}set variant(t){if(t!==this.variant){if(vt.includes(t))return this.setAttribute("variant",t),void(this._variant=t);this.removeAttribute("variant"),this._variant=""}}get variant(){return this._variant}render(){return r`<sp-popover ?open="${this.open}" id="popover"><slot></slot></sp-popover>`}}o([i({type:Boolean,reflect:!0})],gt.prototype,"flexible",void 0),o([i({type:Boolean,reflect:!0})],gt.prototype,"open",void 0),o([i({type:String,reflect:!0})],gt.prototype,"variant",null),customElements.define("sp-action-bar",gt);var ft=u`:host{--spectrum-actiongroup-button-gap-reset:0;--spectrum-actiongroup-quiet-compact-button-gap:var(
...
)}`;class qt extends e{constructor(){super(...arguments),this.type="info",this.corner=!1}static get styles(){return[Et]}render(){return r`<div id="header"><slot name="header"></slot></div><div id="content"><slot name="content"></slot></div>`}}o([i({reflect:!0,type:String})],qt.prototype,"type",void 0),o([i({reflect:!0,type:Boolean})],qt.prototype,"corner",void 0),customElements.define("sp-banner",qt);var Lt=u`:host{--spectrum-buttongroup-button-gap-reset:0}:host{display:flex}::slotted(*){flex-shrink:0}:host([dir=ltr]) ::slotted(:not(:first-of-type)){margin-left:var(
...
)}:host([vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-flex-grow:1}:host([dir=ltr][vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-text-align:left}:host([dir=rtl][vertical]) ::slotted(sp-action-button){--spectrum-actionbutton-label-text-align:right}`;class _t extends e{constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Lt]}render(){return r`<slot></slot>`}}o([i({type:Boolean,reflect:!0})],_t.prototype,"vertical",void 0),customElements.define("sp-button-group",_t);class Mt extends v{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(t){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const e=new CustomEvent("change",{detail:{sourceEvent:t},bubbles:t.bubbles,cancelable:t.cancelable});this.dispatchEvent(e)}render(){return r`<input id="input" aria-labelledby="label" type="checkbox" .checked="${this.checked}" @change="${this.handleChange}">`}}o([i({type:Boolean,reflect:!0})],Mt.prototype,"checked",void 0),o([i({type:Boolean,reflect:!0})],Mt.prototype,"readonly",void 0),o([x("#input")],Mt.prototype,"inputElement",void 0);var Pt=u`:host{align-items:flex-start;max-width:100%;min-height:var(--spectrum-checkbox-height);position:relative}#input{box-sizing:border-box;cursor:pointer;font-family:inherit;font-size:100%;height:100%;line-height:1.15;margin:0;opacity:.0001;overflow:visible;padding:0;position:absolute;width:100%;z-index:1}#input:disabled{cursor:default}#input:checked+#box:before{border-width:calc(var(--spectrum-checkbox-box-size)/2)}#input:checked+#box #checkmark{opacity:1;transform:scale(1)}#input.focus-visible+#box:after{margin:calc(var(
...
)}@media (forced-colors:active){:host{--spectrum-colorloupe-outer-border-color:CanvasText}}svg{height:inherit;width:inherit}`;class Gt extends e{constructor(){super(...arguments),this.open=!1,this.color="rgba(255, 0, 0, 0.5)"}static get styles(){return[Xt]}render(){return r`<svg><g transform="translate(1 1)"><path class="inner" d="M24,0A24,24,0,0,1,48,24c0,16.255-24,40-24,40S0,40.255,0,24A24,24,0,0,1,24,0Z" fill="${this.color}"/><path class="outer" d="M24,2A21.98,21.98,0,0,0,2,24c0,6.2,4,14.794,11.568,24.853A144.233,144.233,0,0,0,24,61.132,144.085,144.085,0,0,0,34.4,48.893C41.99,38.816,46,30.209,46,24A21.98,21.98,0,0,0,24,2m0-2A24,24,0,0,1,48,24c0,16.255-24,40-24,40S0,40.255,0,24A24,24,0,0,1,24,0Z"/></g></svg>`}}o([i({type:Boolean,reflect:!0})],Gt.prototype,"open",void 0),o([i({type:String})],Gt.prototype,"color",void 0),customElements.define("sp-color-loupe",Gt);var Yt=u`:host{--spectrum-colorhandle-animation-duration:var(
--spectrum-global-animation-duration-100,130ms
...
--spectrum-button-m-primary-texticon-border-radius,var(--spectrum-global-dimension-size-200)
)}sp-button{--spectrum-button-m-primary-texticon-border-radius:calc(var(--spectrum-button-primary-texticon-text-size)*var(--spectrum-button-primary-texticon-text-line-height) + var(--spectrum-icon-tshirt-size-height)/2 + var(--spectrum-alias-border-size-thick))}sp-popover{display:none}::slotted(sp-menu){display:none}.more-medium{height:18px;margin:1px -4px 0;width:18px}`;const Cr={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"};class Sr extends(y(q)){constructor(){super(...arguments),this.left=!1,this.variant="cta",this.type="field",this.listRole="menu",this.itemRole="menuitem"}static get styles(){return[wr,E]}get target(){return this}get focusElement(){return this.open?this.optionsMenu:this.left?this.trigger:this.button}sizePopover(t){t.style.setProperty("min-width",`${this.offsetWidth}px`)}passClick(){const t="more"===this.type?this.menuItems[0]:this.selectedItem||this.menuItems[0];t&&t.click()}get buttonContent(){var t;return[r`<div id="label" role="presentation" class="${f(this.value?void 0:"placeholder")}">${(null===(t=this.selectedItem)||void 0===t?void 0:t.itemText)||""}</div>`]}update(t){t.has("type")&&("more"===this.type?this.selects=void 0:this.selects="single"),super.update(t)}render(){const t=[r`<sp-button aria-label="${f(this.label||void 0)}" id="button" class="button ${this.variant}" @click="${this.passClick}" ?disabled="${this.disabled}" variant="${this.variant}" size="${this.size}">${this.buttonContent}</sp-button>`,r`<sp-button aria-haspopup="true" aria-expanded="${this.open?"true":"false"}" class="button trigger ${this.variant}" @blur="${this.onButtonBlur}" @click="${this.onButtonClick}" @focus="${this.onButtonFocus}" ?disabled="${this.disabled}" aria-label="More" variant="${this.variant}" size="${this.size}">${"field"===this.type?r`<sp-icon-chevron100 class="icon ${Cr[this.size]}"></sp-icon-chevron100>`:r`<sp-icon-more class="icon"></sp-icon-more>`}</sp-button>`];return this.left&&t.reverse(),r`${t}`}updated(t){super.updated(t),t.has("value")&&this.manageSplitButtonItems()}manageSelection(){super.manageSelection(),this.manageSplitButtonItems()}async manageSplitButtonItems(){if(this.menuItems.length)return"more"===this.type?(this.menuItems[0].hidden=!0,this.menuItems.forEach((t=>t.selected=!1)),this.selectedItem=this.menuItems[0]):this.selectedItem=this.selectedItem||this.menuItems[0],void(this.value=this.selectedItem.value);await this.updateComplete,this.menuItems.length&&this.manageSplitButtonItems()}}o([i({type:Boolean,reflect:!0})],Sr.prototype,"left",void 0),o([i({reflect:!0})],Sr.prototype,"variant",void 0),o([i({type:String})],Sr.prototype,"type",void 0),o([x(".trigger")],Sr.prototype,"trigger",void 0),customElements.define("sp-split-button",Sr);var $r=u`:host{--spectrum-splitview-vertical-width:100%;--spectrum-splitview-vertical-gripper-width:50%;--spectrum-splitview-vertical-gripper-outer-width:100%;--spectrum-splitview-vertical-gripper-reset:0}:host{display:flex;overflow:hidden}::slotted(*){height:100%}:host([dir=ltr]) #gripper{left:calc((var(--spectrum-dragbar-gripper-width,var(--spectrum-global-dimension-static-size-50)) + 2*var(--spectrum-dragbar-gripper-border-width-horizontal,3px) - var(--spectrum-dragbar-handle-width,var(--spectrum-global-dimension-static-size-25)))/ 2*-1)}:host([dir=rtl]) #gripper{right:calc((var(--spectrum-dragbar-gripper-width,var(--spectrum-global-dimension-static-size-50)) + 2*var(--spectrum-dragbar-gripper-border-width-horizontal,3px) - var(--spectrum-dragbar-handle-width,var(--spectrum-global-dimension-static-size-25)))/ 2*-1)}#gripper{border-radius:var(
...
)}`;class qr extends(y(e)){constructor(){super(...arguments),this.disabled=!1,this.variant="info"}static get styles(){return[Er]}render(){return r`<slot></slot>`}updated(t){super.updated(t),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}}o([i({type:Boolean,reflect:!0})],qr.prototype,"disabled",void 0),o([i({reflect:!0})],qr.prototype,"variant",void 0),customElements.define("sp-status-light",qr);var Lr=u`:host{--spectrum-switch-handle-size:var(
