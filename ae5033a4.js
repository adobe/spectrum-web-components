...
)}:host([side-aligned=start]) .required-icon{margin-top:0}`;class P extends(d(o)){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1}static get styles(){return[F,$]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),a=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():a&&a.forceFocusVisible&&a.forceFocusVisible()}async manageFor(){if(!this.for)return;const e=this.getRootNode(),t=e.querySelector(`#${this.for}`);if(t){if(t.localName.search("-")>0&&await customElements.whenDefined(t.localName),void 0!==t.updateComplete&&await t.updateComplete,this.target=t.focusElement||t,this.target){this.target.getRootNode()===e?this.target.setAttribute("aria-labelledby",this.id):this.target.setAttribute("aria-label",this.labelText)}return Promise.resolve()}}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});if(!e.length)return"";return e.map((e=>(e.textContent||"").trim())).join(" ")}render(){return l`<label><slot @slotchange="${this.manageFor}"></slot>${this.required?l`<sp-icon-asterisk100 class="required-icon spectrum-UIIcon-Asterisk100"></sp-icon-asterisk100>`:l``}</label>`}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}willUpdate(e){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${P.instanceCount++}`),(e.has("for")||e.has("id"))&&this.manageFor()}}P.instanceCount=0,s([a({type:Boolean,reflect:!0})],P.prototype,"disabled",void 0),s([a({type:String})],P.prototype,"id",void 0),s([a({type:String})],P.prototype,"for",void 0),s([a({type:Boolean,reflect:!0})],P.prototype,"required",void 0),s([n("slot")],P.prototype,"slotEl",void 0),s([a({type:String,reflect:!0,attribute:"side-aligned"})],P.prototype,"sideAligned",void 0),customElements.define("sp-field-label",P);export{S as B,g as F,f as L,I as O,d as S,m as a,v as b,k as c,L as d,p as e,T as f,w as g,n as i,u as l,c as o,h as t};
//# sourceMappingURL=ae5033a4.js.map
