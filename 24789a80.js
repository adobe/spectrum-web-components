import{F as e,t}from"./fa586bc2.js";import{i as s}from"./112b2095.js";import"./9a55f877.js";import{f as r}from"./5ac99161.js";import{S as c}from"./4a858608.js";import{x as o,n as a,d as i,S as l}from"./e5ca13ca.js";import{n}from"./879dbe89.js";import{R as d}from"./a37f886d.js";var h=s`
...
);content:"";inset:0;position:absolute;z-index:0}:host([border=none]) .fill:before{background-color:var(--spectrum-picked-color,transparent);box-shadow:none}.mixedValueIcon{color:var(--spectrum-picked-color,transparent)}.disabledIcon,.mixedValueIcon{display:none;pointer-events:none}.disabledIcon{stroke:var(
...
`,p=Object.defineProperty,m=Object.getOwnPropertyDescriptor,b=(e,t,s,r)=>{for(var c,o=r>1?void 0:r?m(t,s):t,a=e.length-1;a>=0;a--)(c=e[a])&&(o=(r?c(t,s,o):c(o))||o);return r&&o&&p(t,s,o),o};const v={xs:()=>o`
        <sp-icon-dash75
            slot="icon"
    ...
    `,l:()=>o`
        ...
        ></sp-icon-dash300>
    `};class g extends(c(e,{validSizes:["xs","s","m","l"],noDefaultSize:!0})){constructor(){super(...arguments),this.color="",this.label="",this.mixedValue=!1,this.nothing=!1,this.role="button",this.selected=!1,this.renderDisabled=()=>o`
            <svg
