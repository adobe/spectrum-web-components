import{I as t,S as e}from"./2eca6ebd.js";import{i as o}from"./67a87733.js";import"./ff67cab2.js";import{S as r,l as i,$ as l,i as c,a}from"./7dd6c208.js";import{T as n,A as s,x as u,e as d,d as p}from"./cd228091.js";import"./b6dda3ba.js";import{c as m}from"./bdc657fb.js";import"./9cdb9ada.js";import"./7b3008bb.js";import{e as v,i as h,t as f}from"./16ab2288.js";import{e as b,s as x}from"./7dca79b5.js";import{t as g}from"./0d9e6cef.js";const w=v(class extends h{constructor(t){if(super(t),t.type!==f.PROPERTY&&t.type!==f.ATTRIBUTE&&t.type!==f.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!b(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===n||e===s)return e;const o=t.element,r=t.name;if(t.type===f.PROPERTY){if(e===o[r])return n}else if(t.type===f.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(r))return n}else if(t.type===f.ATTRIBUTE&&o.getAttribute(r)===e+"")return n;return x(t),e}});var k=o`
...
`,y=Object.defineProperty,q=Object.getOwnPropertyDescriptor;const z={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class T extends(r(e)){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,k,t]}get buttonContent(){return[z[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((t,e,o,r)=>{for(var i,l=r>1?void 0:r?q(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);r&&l&&y(e,o,l)})([d({reflect:!0})],T.prototype,"variant",2);const $=class{constructor(t,{mode:e}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:t})=>{this.handleHelpText(t),this.handleNegativeHelpText(t)},this.host=t,this.instanceCount=$.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=e}get isInternal(){return"internal"===this.mode}render(t){return u`
        ...
        `}addId(){const t=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=m(this.host,"aria-describedby",t),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(t){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const e=t.assignedElements()[0];this.helpTextElement=e,e&&(e.id||(e.id=this.id),this.addId())}handleNegativeHelpText(t){"negative-help-text"===t.name&&t.assignedElements().forEach((t=>t.variant="negative"))}};let B=$;function E(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new B(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(t){return this.helpTextManager.render(t)}}}B.instanceCount=0;var I=o`
...
`,j=Object.defineProperty,H=Object.getOwnPropertyDescriptor,S=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?H(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&j(e,o,l),l};const L=["text","url","tel","email","password"];class F extends(E(a)){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[I,l]}get type(){var t;return null!=(t=L.find((t=>t===this._type)))?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then((()=>{this.checkValidity()})),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),void 0!==this.minlength&&(t=t&&this.value.toString().length>=this.minlength),this.valid=t,this.invalid=!t),t}}S([d({attribute:"allowed-keys"})],F.prototype,"allowedKeys",2),S([d({type:Boolean,reflect:!0})],F.prototype,"focused",2),S([c(".input")],F.prototype,"inputElement",2),S([d({type:Boolean,reflect:!0})],F.prototype,"invalid",2),S([d()],F.prototype,"label",2),S([d()],F.prototype,"placeholder",2),S([d({attribute:"type",reflect:!0})],F.prototype,"_type",2),S([g()],F.prototype,"type",1),S([d()],F.prototype,"pattern",2),S([d({type:Boolean,reflect:!0})],F.prototype,"grows",2),S([d({type:Number})],F.prototype,"maxlength",2),S([d({type:Number})],F.prototype,"minlength",2),S([d({type:Boolean,reflect:!0})],F.prototype,"multiline",2),S([d({type:Boolean,reflect:!0})],F.prototype,"readonly",2),S([d({type:Boolean,reflect:!0})],F.prototype,"valid",2),S([d({type:String})],F.prototype,"value",1),S([d({type:Boolean,reflect:!0})],F.prototype,"quiet",2),S([d({type:Boolean,reflect:!0})],F.prototype,"required",2),S([d({type:String,reflect:!0})],F.prototype,"autocomplete",2);class C extends F{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}S([d({type:String})],C.prototype,"value",1),p("sp-clear-button",T);var U=o`
...
`,O=Object.defineProperty,_=Object.getOwnPropertyDescriptor,R=(t,e,o,r)=>{for(var i,l=r>1?void 0:r?_(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(l=(r?i(e,o,l):i(l))||l);return r&&l&&O(e,o,l),l};const A=t=>t.stopPropagation();class P extends C{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,U]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||"Escape"!==e||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}R([d()],P.prototype,"action",2),R([d()],P.prototype,"label",2),R([d()],P.prototype,"method",2),R([d()],P.prototype,"placeholder",2),R([c("#form")],P.prototype,"form",2),p("sp-search",P);export{E as M,F as T,C as a};
//# sourceMappingURL=9b9c973b.js.map
