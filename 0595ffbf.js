...
)}@media (forced-colors:active){:host([variant=secondary]) a{color:linktext}:host([variant=secondary]) a:hover{color:linktext}:host([variant=secondary]) a:active{color:linktext}:host([variant=secondary]) a:focus{color:linktext}}:host{display:inline}:host(:focus){outline:0}:host([href]) a.focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}:host([href]) a:focus-visible{text-decoration:underline;-webkit-text-decoration-style:double;text-decoration-style:double}`;class W extends(b(d(m),{noDefaultSize:!0})){static get styles(){return[H]}get focusElement(){return this.anchorElement}render(){return this.renderAnchor({id:"anchor"})}}c([a("#anchor")],W.prototype,"anchorElement",void 0),c([s({type:String,reflect:!0})],W.prototype,"variant",void 0),customElements.define("sp-link",W);var V=u`:host([size=s]){--spectrum-divider-height:var(
...
)}:host{display:block}hr{border:none;margin:0}`;class Y extends(b(n,{validSizes:["s","m","l"]})){constructor(){super(...arguments),this.vertical=!1}render(){return i``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}Y.styles=[V],c([s({type:Boolean,reflect:!0})],Y.prototype,"vertical",void 0),customElements.define("sp-divider",Y);var Q=u`:host{--spectrum-toast-icon-padding-y:var(
--spectrum-global-dimension-size-85
...
//# sourceMappingURL=0595ffbf.js.map
