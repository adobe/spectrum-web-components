import{R as e}from"./464e15ff.js";import{i as t}from"./d230bd74.js";import{y as i,e as r,S as a}from"./05d6b8f8.js";import{L as s,a as n,l as o}from"./cda676e5.js";var l=t`
...
`,c=Object.defineProperty,m=Object.getOwnPropertyDescriptor,u=(e,t,i,r)=>{for(var a,s=r>1?void 0:r?m(t,i):t,n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r?a(t,i,s):a(s))||s);return r&&s&&c(t,i,s),s};const v=class extends(s(n)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[d]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let e=0,t=this.parentElement;for(;t instanceof v;)e++,t=t.parentElement;return e}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||null!=e&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return i`
            <a
                href=${this.href||"#"}
            ...
            ${this.expanded?i`
                  ...
                  `:i``}
        `}updated(e){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(e)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const e=this.parentSideNav;if(e&&(await e.updateComplete,e.startTrackingSelectionForItem(this),this.selected=null!=this.value&&this.value===e.value,!0===this.selected&&"multilevel"===e.variant)){let e=this.parentElement;for(;e instanceof v;)e.expanded=!0,e=e.parentElement}}stopTrackingSelection(){const e=this.parentSideNav;e&&e.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}};let p=v;u([r()],p.prototype,"value",2),u([r({type:Boolean,reflect:!0})],p.prototype,"selected",2),u([r({type:Boolean,reflect:!0})],p.prototype,"expanded",2);var h=t`
