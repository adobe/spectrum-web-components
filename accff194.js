import"./f5690f04.js";import{i as e}from"./1ab7ceed.js";import{c as t,a as i}from"./e6813b8c.js";import{E as s,e as l}from"./d11544d8.js";import{S as r}from"./41af188d.js";import{x as a,A as o,n as d,S as c,d as n}from"./637c92da.js";import{i as p}from"./0fd5475c.js";var m=e`
...
`,h=Object.defineProperty,b=Object.getOwnPropertyDescriptor,f=(e,t,i,s)=>{for(var l,r=s>1?void 0:s?b(t,i):t,a=e.length-1;a>=0;a--)(l=e[a])&&(r=(s?l(t,i,r):l(r))||r);return s&&r&&h(t,i,r),r};const g=class e extends(r(c,{noDefaultSize:!0})){constructor(){super(...arguments),this.disabled=!1,this.id="",this.for="",this.required=!1,this.resolvedElement=new s(this)}static get styles(){return[u,m]}handleClick(e){if(!this.target||this.disabled||e.defaultPrevented)return;this.target.focus();const t=this.getRootNode(),i=this.target,s=i.getRootNode(),l=s.host;s===t&&i.forceFocusVisible?i.forceFocusVisible():l&&l.forceFocusVisible&&l.forceFocusVisible()}applyTargetLabel(e){if(this.target=e||this.target,this.target){const s=this.target.applyFocusElementLabel,l=this.target.focusElement||this.target,r=l.getRootNode();void 0!==s?s(this.labelText):r===this.getRootNode()?(e?t:i)(l,"aria-labelledby",[this.id]):e?l.setAttribute("aria-label",this.labelText):l.removeAttribute("aria-label")}}async manageTarget(){this.applyTargetLabel();const e=this.resolvedElement.element;e?(e.localName.search("-")>0&&await customElements.whenDefined(e.localName),void 0!==e.updateComplete&&await e.updateComplete,this.applyTargetLabel(e)):this.target=e}get labelText(){const e=this.slotEl.assignedNodes({flatten:!0});return e.length?e.map((e=>(e.textContent||"").trim())).join(" "):""}render(){return a`
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.addEventListener("click",this.handleClick)}willUpdate(t){this.hasAttribute("id")||this.setAttribute("id",`${this.tagName.toLowerCase()}-${e.instanceCount++}`),t.has("for")&&(this.resolvedElement.selector=this.for?`#${this.for}`:""),(t.has("id")||t.has(l))&&this.manageTarget()}};g.instanceCount=0,f([d({type:Boolean,reflect:!0})],g.prototype,"disabled",2),f([d({type:String})],g.prototype,"id",2),f([d({type:String})],g.prototype,"for",2),f([d({type:Boolean,reflect:!0})],g.prototype,"required",2),f([p("slot")],g.prototype,"slotEl",2),f([d({type:String,reflect:!0,attribute:"side-aligned"})],g.prototype,"sideAligned",2),n("sp-field-label",g);
//# sourceMappingURL=accff194.js.map
