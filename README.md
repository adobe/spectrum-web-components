...
The call to `yarn` will install all the resources you need for developing and running the packages in this library.

To build the Typescript and import and process the CSS assets, run `yarn build`. This is no longer running as part of the postinstall process and should be run manually when setting up the repository.
