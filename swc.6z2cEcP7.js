import"./swc.M6p6Q3pN.js";import"./swc.DjpMy6E1.js";import"./swc.CSlbWjdv.js";import{i as t}from"./swc.Cl2X6-fK.js";import{i}from"./swc.BlyXCoGX.js";import{f as e}from"./swc.CVQruJaD.js";import{F as s}from"./swc.BBPqdk4g.js";import{x as o,T as n}from"./swc.CfKxAKYm.js";import{n as r}from"./swc.DGYjDgvc.js";import{S as a}from"./swc.eJQEZSgS.js";import{d as l}from"./swc.JlveB6nj.js";const d=t`
...
`;var h=Object.defineProperty,p=(t,i,e,s)=>{for(var o,n=void 0,r=t.length-1;r>=0;r--)(o=t[r])&&(n=o(i,e,n)||n);return n&&h(i,e,n),n};class c extends(s(a)){constructor(){super(...arguments),this.dismissable=!1,this.open=!1,this.responsive=!1,this.transitionPromise=Promise.resolve(),this.resolveTransitionPromise=()=>{},this.underlay=!1,this.animating=!1}static get styles(){return[d,i]}get dialog(){return this.shadowRoot.querySelector("slot").assignedElements()[0]||this}async focus(){if(this.shadowRoot){const t=e(this.dialog);t?(t.updateComplete&&await t.updateComplete,t.focus()):this.dialog.focus()}else super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}dismiss(){this.dismissable&&this.close()}handleClose(t){t.stopPropagation(),this.close()}close(){this.open=!1}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleTransitionEvent(t){this.dispatchEvent(new TransitionEvent(t.type,{bubbles:!0,composed:!0,propertyName:t.propertyName}))}handleUnderlayTransitionend(t){!this.open&&"visibility"===t.propertyName&&this.resolveTransitionPromise(),this.handleTransitionEvent(t)}handleModalTransitionend(t){(this.open||!this.underlay)&&this.resolveTransitionPromise(),this.handleTransitionEvent(t)}get hasTransitionDuration(){const t=this.shadowRoot.querySelector(".modal"),i=window.getComputedStyle(t).transitionDuration;for(const t of i.split(","))if(parseFloat(t)>0)return!0;const e=this.shadowRoot.querySelector("sp-underlay");if(e){const t=window.getComputedStyle(e).transitionDuration;for(const i of t.split(","))if(parseFloat(i)>0)return!0}return!1}update(t){if(t.has("open")&&void 0!==t.get("open")){const t=this.hasTransitionDuration;this.animating=!0,this.transitionPromise=new Promise((i=>{this.resolveTransitionPromise=()=>{this.animating=!1,!this.open&&t&&this.dispatchClosed(),i()}})),!this.open&&!t&&this.dispatchClosed()}super.update(t)}renderDialog(){return o`
        ...
        `}updated(t){t.has("open")&&this.open&&"updateComplete"in this.dialog&&"shouldManageTabOrderForScrolling"in this.dialog&&this.dialog.updateComplete.then((()=>{this.dialog.shouldManageTabOrderForScrolling()}))}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}p([r({type:Boolean,reflect:!0})],c.prototype,"dismissable"),p([r({type:Boolean,reflect:!0})],c.prototype,"open"),p([r({type:String,reflect:!0})],c.prototype,"mode"),p([r({type:Boolean})],c.prototype,"responsive"),p([r({type:Boolean})],c.prototype,"underlay"),l("sp-dialog-base",c);var m=Object.freeze({__proto__:null});export{c as D,m as s};
//# sourceMappingURL=swc.D0mQU7_D.js.map
