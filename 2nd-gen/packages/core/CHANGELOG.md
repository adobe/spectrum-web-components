...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the 2nd-gen `<swc-action-group>` file structure, API, accessibility semantics, and Spectrum 2 styling, migrated from the Spectrum 1 `<sp-action-group>`.
...
- [#6739](https://github.com/adobe/spectrum-web-components/pull/6739) [`d505036`](https://github.com/adobe/spectrum-web-components/commit/d505036c47c9e60fdebe5b8ce8b4501aa328e240) Thanks [@5t3ph](https://github.com/5t3ph)! - **feat(asset):** Expanded `<swc-asset>` from a minimal file/folder-icon-or-slot component into a general image/media primitive, and promoted it from the internal genre to public.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **feat(prompt-field):** Accept file drops anywhere over `swc-prompt-field` with a high-intensity solid-fill drop target and blue focus ring. The new `DragAndDropController` is exported for reuse by other components.

- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the 2nd-gen `<swc-card>`, the Spectrum 2 successor to `<sp-card>`.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the 2nd-gen `<swc-close-button>`, migrated from the Spectrum 1 `<sp-close-button>`.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **feat(color-handle):** Added `<swc-color-handle>`, the Spectrum 2 migration of `sp-color-handle`.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **feat(dev-validation):** Added reusable dev-mode validation helpers (`validateEnum`, `warnIf`, `validateRequiredSlot`, `validateAllowedChildren`) in `@adobe/spectrum-wc-core/utils`, and fixed `window.__swc.warn`'s dedup key so two distinct warnings on the same component no longer suppress each other.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the 2nd-gen `<swc-dropzone>`, migrated from the Spectrum 1 `<sp-dropzone>`.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the 2nd-gen `<swc-infield-button>`, the Spectrum 2 net-new icon button for form fields.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Extract the pending (busy) state into reusable, decoupled 2nd-gen core primitives so any pending-capable component can adopt it.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **refactor(core):** Replace the `ObserveSlotPresence` and `ObserveSlotText` mixins with reactive controllers, following the mixin-composition guidance to prefer controllers over deep mixin chains.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **refactor(core):** Leaned out `SpectrumElement`.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Add the internal 2nd-gen UI icon system: the `<swc-ui-icon>` element plus a build-time generator for the S2 UI icon set.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **refactor(tabs):** Migrate `<swc-tabs>` keyboard navigation to `FocusgroupNavigationController`.
...
- [#6735](https://github.com/adobe/spectrum-web-components/pull/6735) [`c4b0b45`](https://github.com/adobe/spectrum-web-components/commit/c4b0b457651a820729700ec93299c1fb9254a48b) Thanks [@blunteshwar](https://github.com/blunteshwar)! - Fix inaccurate API reference tables for several 2nd-gen components by documenting CSS custom properties and JSDoc property descriptions that were missing from the generated Custom Elements Manifest.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **fix(color-loupe):** Added an adaptive white-first inner border to `<swc-color-loupe>` so its chrome meets WCAG 1.4.11 non-text contrast (≥3:1) across the color spectrum.
...
- [#6736](https://github.com/adobe/spectrum-web-components/pull/6736) [`08eec0c`](https://github.com/adobe/spectrum-web-components/commit/08eec0c862994b4e51d5b2a33b1cf87623a04db8) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **fix(color-loupe):** Added the missing `./components/color-loupe` subpath export (and `typesVersions` entry) to `@adobe/spectrum-wc-core`'s `package.json`.
...
- [#6638](https://github.com/adobe/spectrum-web-components/pull/6638) [`bef2c80`](https://github.com/adobe/spectrum-web-components/commit/bef2c80335f77c770f8154b9a9a75ddefe28a2c4) Thanks [@blunteshwar](https://github.com/blunteshwar)! - **fix(popover):** Fixed `swc-popover` staying dismissed on the next unrelated outside click after a trigger press was dragged off and released elsewhere.
