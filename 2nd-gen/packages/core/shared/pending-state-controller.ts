 ...
 *
 * Currently this is used by Button only since the host element is the interactive element
 * that needs pending state. This pattern does not work for components where the interactive
 * element that needs pending state is in the shadow DOM (e.g., Combobox and Picker).
 *
 * @todo For Spectrum 2, this should use InfieldProgressCircle instead of ProgressCircle.
 * Currently using swc-progress-circle as a placeholder until InfieldProgressCircle is available.
 */
    ...
    implements ReactiveController
{
     ...
     *
     * @todo [SWC-1119, SWC-1255, SWC-459] Confirm the accessibility warning and a11y
     * dom tree are accurate for the pending state in button, combobox, and picker components.
     * @todo Update to use swc-infield-progress-circle for Spectrum 2 when available.
     */
