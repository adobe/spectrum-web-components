...
/**
 * Abstract base class for all button-like components. Owns only shared
 * semantic concerns: interaction state, accessible-name resolution,
 * and host-to-internal-button attribute forwarding.
 *
 * Visual API (variant, fill-style, size, static-color) and rendering are
