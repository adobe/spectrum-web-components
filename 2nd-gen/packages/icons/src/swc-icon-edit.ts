...
import { Icon_Edit } from './Edit.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Edit workflow icon as a custom element.
 *
 * @element swc-icon-edit
 * @since 2.0.0-beta.2
 *
...
export class IconEdit extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Edit())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-edit': IconEdit;
  }
}

defineElement('swc-icon-edit', IconEdit);
