...
import { Icon_Keyboard } from './Keyboard.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Keyboard workflow icon as a custom element.
 *
 * @element swc-icon-keyboard
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-keyboard': IconKeyboard;
  }
}

defineElement('swc-icon-keyboard', IconKeyboard);
