...
import { Icon_StepBackward } from './StepBackward.js';

import styles from './stylesheets/icon-base.css';

/**
 * The StepBackward workflow icon as a custom element.
 *
 * @element swc-icon-step-backward
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-step-backward': IconStepBackward;
  }
}

defineElement('swc-icon-step-backward', IconStepBackward);
