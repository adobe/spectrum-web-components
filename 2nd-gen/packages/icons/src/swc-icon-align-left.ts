...
import { Icon_AlignLeft } from './AlignLeft.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AlignLeft workflow icon as a custom element.
 *
 * @element swc-icon-align-left
 * @since 2.0.0-beta.2
 *
...
export class IconAlignLeft extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_AlignLeft())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-align-left': IconAlignLeft;
  }
}

defineElement('swc-icon-align-left', IconAlignLeft);
