...
import { Icon_Invert } from './Invert.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Invert workflow icon as a custom element.
 *
 * @element swc-icon-invert
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconInvert extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-invert': IconInvert;
  }
}

defineElement('swc-icon-invert', IconInvert);
