...
import { Icon_TextUnderline } from './TextUnderline.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextUnderline workflow icon as a custom element.
 *
 * @element swc-icon-text-underline
 * @since 2.0.0-beta.2
 *
...
export class IconTextUnderline extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_TextUnderline())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-underline': IconTextUnderline;
  }
}

defineElement('swc-icon-text-underline', IconTextUnderline);
