...
import { Icon_BadgeVerified } from './BadgeVerified.js';

import styles from './stylesheets/icon-base.css';

/**
 * The BadgeVerified workflow icon as a custom element.
 *
 * @element swc-icon-badge-verified
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconBadgeVerified extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-badge-verified': IconBadgeVerified;
  }
}

defineElement('swc-icon-badge-verified', IconBadgeVerified);
