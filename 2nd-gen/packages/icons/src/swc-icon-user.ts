...
import { Icon_User } from './User.js';

import styles from './stylesheets/icon-base.css';

/**
 * The User workflow icon as a custom element.
 *
 * @element swc-icon-user
 * @since 2.0.0-beta.2
 *
...
export class IconUser extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_User())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-user': IconUser;
  }
}

defineElement('swc-icon-user', IconUser);
