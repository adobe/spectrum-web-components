...
import { Icon_Delete } from './Delete.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Delete workflow icon as a custom element.
 *
 * @element swc-icon-delete
 * @since 2.0.0-beta.2
 *
...
export class IconDelete extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Delete())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-delete': IconDelete;
  }
}

defineElement('swc-icon-delete', IconDelete);
