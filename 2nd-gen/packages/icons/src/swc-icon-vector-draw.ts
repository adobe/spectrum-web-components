...
import { Icon_VectorDraw } from './VectorDraw.js';

import styles from './stylesheets/icon-base.css';

/**
 * The VectorDraw workflow icon as a custom element.
 *
 * @element swc-icon-vector-draw
 * @since 2.0.0-beta.2
 *
...
export class IconVectorDraw extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_VectorDraw())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-vector-draw': IconVectorDraw;
  }
}

defineElement('swc-icon-vector-draw', IconVectorDraw);
