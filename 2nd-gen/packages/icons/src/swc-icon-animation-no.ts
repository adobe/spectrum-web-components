...
import { Icon_AnimationNo } from './AnimationNo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AnimationNo workflow icon as a custom element.
 *
 * @element swc-icon-animation-no
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-animation-no': IconAnimationNo;
  }
}

defineElement('swc-icon-animation-no', IconAnimationNo);
