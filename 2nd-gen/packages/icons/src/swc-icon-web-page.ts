...
import { Icon_WebPage } from './WebPage.js';

import styles from './stylesheets/icon-base.css';

/**
 * The WebPage workflow icon as a custom element.
 *
 * @element swc-icon-web-page
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-web-page': IconWebPage;
  }
}

defineElement('swc-icon-web-page', IconWebPage);
