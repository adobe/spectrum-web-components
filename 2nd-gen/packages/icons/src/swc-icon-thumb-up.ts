...
import { Icon_ThumbUp } from './ThumbUp.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ThumbUp workflow icon as a custom element.
 *
 * @element swc-icon-thumb-up
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-thumb-up': IconThumbUp;
  }
}

defineElement('swc-icon-thumb-up', IconThumbUp);
