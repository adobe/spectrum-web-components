...
import { Icon_DataRefresh } from './DataRefresh.js';

import styles from './stylesheets/icon-base.css';

/**
 * The DataRefresh workflow icon as a custom element.
 *
 * @element swc-icon-data-refresh
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-data-refresh': IconDataRefresh;
  }
}

defineElement('swc-icon-data-refresh', IconDataRefresh);
