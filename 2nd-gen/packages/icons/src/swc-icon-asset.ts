...
import { Icon_Asset } from './Asset.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Asset workflow icon as a custom element.
 *
 * @element swc-icon-asset
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-asset': IconAsset;
  }
}

defineElement('swc-icon-asset', IconAsset);
