...
import { Icon_ThumbDown } from './ThumbDown.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ThumbDown workflow icon as a custom element.
 *
 * @element swc-icon-thumb-down
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-thumb-down': IconThumbDown;
  }
}

defineElement('swc-icon-thumb-down', IconThumbDown);
