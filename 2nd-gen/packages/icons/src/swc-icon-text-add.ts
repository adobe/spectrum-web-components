...
import { Icon_TextAdd } from './TextAdd.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextAdd workflow icon as a custom element.
 *
 * @element swc-icon-text-add
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-add': IconTextAdd;
  }
}

defineElement('swc-icon-text-add', IconTextAdd);
