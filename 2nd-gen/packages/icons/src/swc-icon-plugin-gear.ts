...
import { Icon_PluginGear } from './PluginGear.js';

import styles from './stylesheets/icon-base.css';

/**
 * The PluginGear workflow icon as a custom element.
 *
 * @element swc-icon-plugin-gear
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-plugin-gear': IconPluginGear;
  }
}

defineElement('swc-icon-plugin-gear', IconPluginGear);
