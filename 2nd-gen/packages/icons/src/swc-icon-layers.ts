...
import { Icon_Layers } from './Layers.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Layers workflow icon as a custom element.
 *
 * @element swc-icon-layers
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-layers': IconLayers;
  }
}

defineElement('swc-icon-layers', IconLayers);
