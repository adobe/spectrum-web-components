...
import { Icon_StarFilled } from './StarFilled.js';

import styles from './stylesheets/icon-base.css';

/**
 * The StarFilled workflow icon as a custom element.
 *
 * @element swc-icon-star-filled
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-star-filled': IconStarFilled;
  }
}

defineElement('swc-icon-star-filled', IconStarFilled);
