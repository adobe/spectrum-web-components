...
import { Icon_ChevronLeft } from './ChevronLeft.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ChevronLeft workflow icon as a custom element.
 *
 * @element swc-icon-chevron-left
 * @since 2.0.0-beta.2
 *
...
export class IconChevronLeft extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_ChevronLeft())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-chevron-left': IconChevronLeft;
  }
}

defineElement('swc-icon-chevron-left', IconChevronLeft);
