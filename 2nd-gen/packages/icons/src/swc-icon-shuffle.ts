...
import { Icon_Shuffle } from './Shuffle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Shuffle workflow icon as a custom element.
 *
 * @element swc-icon-shuffle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-shuffle': IconShuffle;
  }
}

defineElement('swc-icon-shuffle', IconShuffle);
