...
import { Icon_ViewGridFluid } from './ViewGridFluid.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ViewGridFluid workflow icon as a custom element.
 *
 * @element swc-icon-view-grid-fluid
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconViewGridFluid extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-view-grid-fluid': IconViewGridFluid;
  }
}

defineElement('swc-icon-view-grid-fluid', IconViewGridFluid);
