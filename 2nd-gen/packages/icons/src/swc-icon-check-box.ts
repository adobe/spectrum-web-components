...
import { Icon_CheckBox } from './CheckBox.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CheckBox workflow icon as a custom element.
 *
 * @element swc-icon-check-box
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-check-box': IconCheckBox;
  }
}

defineElement('swc-icon-check-box', IconCheckBox);
