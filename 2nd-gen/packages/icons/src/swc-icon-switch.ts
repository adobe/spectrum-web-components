...
import { Icon_Switch } from './Switch.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Switch workflow icon as a custom element.
 *
 * @element swc-icon-switch
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-switch': IconSwitch;
  }
}

defineElement('swc-icon-switch', IconSwitch);
