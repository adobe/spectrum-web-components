...
import { Icon_DeviceLaptop } from './DeviceLaptop.js';

import styles from './stylesheets/icon-base.css';

/**
 * The DeviceLaptop workflow icon as a custom element.
 *
 * @element swc-icon-device-laptop
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-device-laptop': IconDeviceLaptop;
  }
}

defineElement('swc-icon-device-laptop', IconDeviceLaptop);
