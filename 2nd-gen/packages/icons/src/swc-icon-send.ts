...
import { Icon_Send } from './Send.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Send workflow icon as a custom element.
 *
 * @element swc-icon-send
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-send': IconSend;
  }
}

defineElement('swc-icon-send', IconSend);
