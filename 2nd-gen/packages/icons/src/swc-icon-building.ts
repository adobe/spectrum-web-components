...
import { Icon_Building } from './Building.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Building workflow icon as a custom element.
 *
 * @element swc-icon-building
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-building': IconBuilding;
  }
}

defineElement('swc-icon-building', IconBuilding);
