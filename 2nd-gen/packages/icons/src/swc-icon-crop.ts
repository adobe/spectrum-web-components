...
import { Icon_Crop } from './Crop.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Crop workflow icon as a custom element.
 *
 * @element swc-icon-crop
 * @since 2.0.0-beta.2
 *
...
export class IconCrop extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Crop())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-crop': IconCrop;
  }
}

defineElement('swc-icon-crop', IconCrop);
