...
import { Icon_GradientRadial } from './GradientRadial.js';

import styles from './stylesheets/icon-base.css';

/**
 * The GradientRadial workflow icon as a custom element.
 *
 * @element swc-icon-gradient-radial
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconGradientRadial extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-gradient-radial': IconGradientRadial;
  }
}

defineElement('swc-icon-gradient-radial', IconGradientRadial);
