...
import { Icon_MagicWand } from './MagicWand.js';

import styles from './stylesheets/icon-base.css';

/**
 * The MagicWand workflow icon as a custom element.
 *
 * @element swc-icon-magic-wand
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-magic-wand': IconMagicWand;
  }
}

defineElement('swc-icon-magic-wand', IconMagicWand);
