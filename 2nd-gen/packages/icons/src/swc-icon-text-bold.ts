...
import { Icon_TextBold } from './TextBold.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextBold workflow icon as a custom element.
 *
 * @element swc-icon-text-bold
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-bold': IconTextBold;
  }
}

defineElement('swc-icon-text-bold', IconTextBold);
