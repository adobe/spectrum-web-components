...
import { Icon_StopProcessing } from './StopProcessing.js';

import styles from './stylesheets/icon-base.css';

/**
 * The StopProcessing workflow icon as a custom element.
 *
 * @element swc-icon-stop-processing
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconStopProcessing extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-stop-processing': IconStopProcessing;
  }
}

defineElement('swc-icon-stop-processing', IconStopProcessing);
