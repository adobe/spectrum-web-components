...
import { Icon_Effects } from './Effects.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Effects workflow icon as a custom element.
 *
 * @element swc-icon-effects
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-effects': IconEffects;
  }
}

defineElement('swc-icon-effects', IconEffects);
