...
import { Icon_PauseCircle } from './PauseCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The PauseCircle workflow icon as a custom element.
 *
 * @element swc-icon-pause-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-pause-circle': IconPauseCircle;
  }
}

defineElement('swc-icon-pause-circle', IconPauseCircle);
