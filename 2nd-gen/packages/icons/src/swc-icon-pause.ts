...
import { Icon_Pause } from './Pause.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Pause workflow icon as a custom element.
 *
 * @element swc-icon-pause
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-pause': IconPause;
  }
}

defineElement('swc-icon-pause', IconPause);
