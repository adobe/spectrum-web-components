...
import { Icon_Animation } from './Animation.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Animation workflow icon as a custom element.
 *
 * @element swc-icon-animation
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-animation': IconAnimation;
  }
}

defineElement('swc-icon-animation', IconAnimation);
