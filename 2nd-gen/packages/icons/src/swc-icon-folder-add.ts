...
import { Icon_FolderAdd } from './FolderAdd.js';

import styles from './stylesheets/icon-base.css';

/**
 * The FolderAdd workflow icon as a custom element.
 *
 * @element swc-icon-folder-add
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-folder-add': IconFolderAdd;
  }
}

defineElement('swc-icon-folder-add', IconFolderAdd);
