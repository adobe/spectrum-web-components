...
import { Icon_FullScreenExit } from './FullScreenExit.js';

import styles from './stylesheets/icon-base.css';

/**
 * The FullScreenExit workflow icon as a custom element.
 *
 * @element swc-icon-full-screen-exit
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-full-screen-exit': IconFullScreenExit;
  }
}

defineElement('swc-icon-full-screen-exit', IconFullScreenExit);
