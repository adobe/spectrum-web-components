...
import { Icon_Saturation } from './Saturation.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Saturation workflow icon as a custom element.
 *
 * @element swc-icon-saturation
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconSaturation extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-saturation': IconSaturation;
  }
}

defineElement('swc-icon-saturation', IconSaturation);
