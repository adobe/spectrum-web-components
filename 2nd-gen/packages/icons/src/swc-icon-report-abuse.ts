...
import { Icon_ReportAbuse } from './ReportAbuse.js';

import styles from './stylesheets/icon-base.css';

/**
 * The ReportAbuse workflow icon as a custom element.
 *
 * @element swc-icon-report-abuse
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-report-abuse': IconReportAbuse;
  }
}

defineElement('swc-icon-report-abuse', IconReportAbuse);
