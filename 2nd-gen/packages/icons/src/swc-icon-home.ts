...
import { Icon_Home } from './Home.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Home workflow icon as a custom element.
 *
 * @element swc-icon-home
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-home': IconHome;
  }
}

defineElement('swc-icon-home', IconHome);
