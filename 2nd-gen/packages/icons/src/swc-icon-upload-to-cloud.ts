...
import { Icon_UploadToCloud } from './UploadToCloud.js';

import styles from './stylesheets/icon-base.css';

/**
 * The UploadToCloud workflow icon as a custom element.
 *
 * @element swc-icon-upload-to-cloud
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-upload-to-cloud': IconUploadToCloud;
  }
}

defineElement('swc-icon-upload-to-cloud', IconUploadToCloud);
