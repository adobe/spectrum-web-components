...
import { Icon_GridTypeDots } from './GridTypeDots.js';

import styles from './stylesheets/icon-base.css';

/**
 * The GridTypeDots workflow icon as a custom element.
 *
 * @element swc-icon-grid-type-dots
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconGridTypeDots extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-grid-type-dots': IconGridTypeDots;
  }
}

defineElement('swc-icon-grid-type-dots', IconGridTypeDots);
