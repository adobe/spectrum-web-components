...
import { Icon_CloseCircle } from './CloseCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CloseCircle workflow icon as a custom element.
 *
 * @element swc-icon-close-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-close-circle': IconCloseCircle;
  }
}

defineElement('swc-icon-close-circle', IconCloseCircle);
