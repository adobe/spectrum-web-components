...
import { Icon_BellRotated } from './BellRotated.js';

import styles from './stylesheets/icon-base.css';

/**
 * The BellRotated workflow icon as a custom element.
 *
 * @element swc-icon-bell-rotated
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-bell-rotated': IconBellRotated;
  }
}

defineElement('swc-icon-bell-rotated', IconBellRotated);
