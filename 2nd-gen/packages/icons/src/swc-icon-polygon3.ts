...
import { Icon_Polygon3 } from './Polygon3.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Polygon3 workflow icon as a custom element.
 *
 * @element swc-icon-polygon3
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-polygon3': IconPolygon3;
  }
}

defineElement('swc-icon-polygon3', IconPolygon3);
