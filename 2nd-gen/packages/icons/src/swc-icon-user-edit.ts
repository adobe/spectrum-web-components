...
import { Icon_UserEdit } from './UserEdit.js';

import styles from './stylesheets/icon-base.css';

/**
 * The UserEdit workflow icon as a custom element.
 *
 * @element swc-icon-user-edit
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-user-edit': IconUserEdit;
  }
}

defineElement('swc-icon-user-edit', IconUserEdit);
