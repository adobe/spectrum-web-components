...
import { Icon_Interaction } from './Interaction.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Interaction workflow icon as a custom element.
 *
 * @element swc-icon-interaction
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-interaction': IconInteraction;
  }
}

defineElement('swc-icon-interaction', IconInteraction);
