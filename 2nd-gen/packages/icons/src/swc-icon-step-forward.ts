...
import { Icon_StepForward } from './StepForward.js';

import styles from './stylesheets/icon-base.css';

/**
 * The StepForward workflow icon as a custom element.
 *
 * @element swc-icon-step-forward
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-step-forward': IconStepForward;
  }
}

defineElement('swc-icon-step-forward', IconStepForward);
