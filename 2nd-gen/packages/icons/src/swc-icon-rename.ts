...
import { Icon_Rename } from './Rename.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Rename workflow icon as a custom element.
 *
 * @element swc-icon-rename
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-rename': IconRename;
  }
}

defineElement('swc-icon-rename', IconRename);
