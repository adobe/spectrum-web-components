...
import { Icon_Circle } from './Circle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Circle workflow icon as a custom element.
 *
 * @element swc-icon-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-circle': IconCircle;
  }
}

defineElement('swc-icon-circle', IconCircle);
