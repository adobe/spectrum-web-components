...
import { Icon_UserAdd } from './UserAdd.js';

import styles from './stylesheets/icon-base.css';

/**
 * The UserAdd workflow icon as a custom element.
 *
 * @element swc-icon-user-add
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-user-add': IconUserAdd;
  }
}

defineElement('swc-icon-user-add', IconUserAdd);
