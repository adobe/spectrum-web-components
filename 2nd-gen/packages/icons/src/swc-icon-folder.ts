...
/**
 * The Folder workflow icon as a custom element.
 *
 * @element swc-icon-folder
 * @since 2.0.0-beta.2
 *
...
export class IconFolder extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Folder())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-folder': IconFolder;
  }
}

defineElement('swc-icon-folder', IconFolder);
