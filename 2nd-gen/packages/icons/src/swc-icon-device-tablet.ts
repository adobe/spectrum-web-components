...
import { Icon_DeviceTablet } from './DeviceTablet.js';

import styles from './stylesheets/icon-base.css';

/**
 * The DeviceTablet workflow icon as a custom element.
 *
 * @element swc-icon-device-tablet
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-device-tablet': IconDeviceTablet;
  }
}

defineElement('swc-icon-device-tablet', IconDeviceTablet);
