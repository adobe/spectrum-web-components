...
import { Icon_Settings } from './Settings.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Settings workflow icon as a custom element.
 *
 * @element swc-icon-settings
 * @since 2.0.0-beta.2
 *
...
export class IconSettings extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Settings())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-settings': IconSettings;
  }
}

defineElement('swc-icon-settings', IconSettings);
