...
import { Icon_FileText } from './FileText.js';

import styles from './stylesheets/icon-base.css';

/**
 * The FileText workflow icon as a custom element.
 *
 * @element swc-icon-file-text
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-file-text': IconFileText;
  }
}

defineElement('swc-icon-file-text', IconFileText);
