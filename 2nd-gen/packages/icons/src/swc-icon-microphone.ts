...
import { Icon_Microphone } from './Microphone.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Microphone workflow icon as a custom element.
 *
 * @element swc-icon-microphone
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-microphone': IconMicrophone;
  }
}

defineElement('swc-icon-microphone', IconMicrophone);
