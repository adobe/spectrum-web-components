...
import { Icon_TextIncrease } from './TextIncrease.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TextIncrease workflow icon as a custom element.
 *
 * @element swc-icon-text-increase
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-text-increase': IconTextIncrease;
  }
}

defineElement('swc-icon-text-increase', IconTextIncrease);
