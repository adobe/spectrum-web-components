...
import { Icon_EditNo } from './EditNo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The EditNo workflow icon as a custom element.
 *
 * @element swc-icon-edit-no
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconEditNo extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-edit-no': IconEditNo;
  }
}

defineElement('swc-icon-edit-no', IconEditNo);
