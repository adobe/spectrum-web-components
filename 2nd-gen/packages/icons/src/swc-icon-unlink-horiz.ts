...
import { Icon_UnlinkHoriz } from './UnlinkHoriz.js';

import styles from './stylesheets/icon-base.css';

/**
 * The UnlinkHoriz workflow icon as a custom element.
 *
 * @element swc-icon-unlink-horiz
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-unlink-horiz': IconUnlinkHoriz;
  }
}

defineElement('swc-icon-unlink-horiz', IconUnlinkHoriz);
