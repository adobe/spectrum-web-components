...
import { Icon_Undo } from './Undo.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Undo workflow icon as a custom element.
 *
 * @element swc-icon-undo
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-undo': IconUndo;
  }
}

defineElement('swc-icon-undo', IconUndo);
