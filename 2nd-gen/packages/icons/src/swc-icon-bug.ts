...
import { Icon_Bug } from './Bug.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Bug workflow icon as a custom element.
 *
 * @element swc-icon-bug
 * @since 2.0.0-beta.2
 *
...
export class IconBug extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Bug())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-bug': IconBug;
  }
}

defineElement('swc-icon-bug', IconBug);
