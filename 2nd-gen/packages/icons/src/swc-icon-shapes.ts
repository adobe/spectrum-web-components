...
/**
 * The Shapes workflow icon as a custom element.
 *
 * @element swc-icon-shapes
 * @since 2.0.0-beta.2
 *
...
export class IconShapes extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Shapes())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-shapes': IconShapes;
  }
}

defineElement('swc-icon-shapes', IconShapes);
