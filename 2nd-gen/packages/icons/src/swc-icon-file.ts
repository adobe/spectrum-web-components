...
import { Icon_File } from './File.js';

import styles from './stylesheets/icon-base.css';

/**
 * The File workflow icon as a custom element.
 *
 * @element swc-icon-file
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-file': IconFile;
  }
}

defineElement('swc-icon-file', IconFile);
