...
import { Icon_Ruler } from './Ruler.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Ruler workflow icon as a custom element.
 *
 * @element swc-icon-ruler
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconRuler extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-ruler': IconRuler;
  }
}

defineElement('swc-icon-ruler', IconRuler);
