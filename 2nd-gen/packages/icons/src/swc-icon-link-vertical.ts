...
import { Icon_LinkVertical } from './LinkVertical.js';

import styles from './stylesheets/icon-base.css';

/**
 * The LinkVertical workflow icon as a custom element.
 *
 * @element swc-icon-link-vertical
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-link-vertical': IconLinkVertical;
  }
}

defineElement('swc-icon-link-vertical', IconLinkVertical);
