...
import { Icon_OpenIn } from './OpenIn.js';

import styles from './stylesheets/icon-base.css';

/**
 * The OpenIn workflow icon as a custom element.
 *
 * @element swc-icon-open-in
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-open-in': IconOpenIn;
  }
}

defineElement('swc-icon-open-in', IconOpenIn);
