...
import { Icon_Polygon6 } from './Polygon6.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Polygon6 workflow icon as a custom element.
 *
 * @element swc-icon-polygon6
 * @since 2.0.0-beta.2
 *
...
export class IconPolygon6 extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_Polygon6())}</span>
    `;
  }
}
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-polygon6': IconPolygon6;
  }
}

defineElement('swc-icon-polygon6', IconPolygon6);
