...
import { Icon_SelectAndMove } from './SelectAndMove.js';

import styles from './stylesheets/icon-base.css';

/**
 * The SelectAndMove workflow icon as a custom element.
 *
 * @element swc-icon-select-and-move
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-select-and-move': IconSelectAndMove;
  }
}

defineElement('swc-icon-select-and-move', IconSelectAndMove);
