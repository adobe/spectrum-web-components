...
import { Icon_Leave } from './Leave.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Leave workflow icon as a custom element.
 *
 * @element swc-icon-leave
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconLeave extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-leave': IconLeave;
  }
}

defineElement('swc-icon-leave', IconLeave);
