...
import { Icon_AlertDiamond } from './AlertDiamond.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AlertDiamond workflow icon as a custom element.
 *
 * @element swc-icon-alert-diamond
 * @since 2.0.0-beta.2
 *
 ...
 */
export class IconAlertDiamond extends IconBase {
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-alert-diamond': IconAlertDiamond;
  }
}

defineElement('swc-icon-alert-diamond', IconAlertDiamond);
