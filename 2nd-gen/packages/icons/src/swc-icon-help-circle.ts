...
import { Icon_HelpCircle } from './HelpCircle.js';

import styles from './stylesheets/icon-base.css';

/**
 * The HelpCircle workflow icon as a custom element.
 *
 * @element swc-icon-help-circle
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-help-circle': IconHelpCircle;
  }
}

defineElement('swc-icon-help-circle', IconHelpCircle);
