...
import { Icon_CalendarEdit } from './CalendarEdit.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CalendarEdit workflow icon as a custom element.
 *
 * @element swc-icon-calendar-edit
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-calendar-edit': IconCalendarEdit;
  }
}

defineElement('swc-icon-calendar-edit', IconCalendarEdit);
