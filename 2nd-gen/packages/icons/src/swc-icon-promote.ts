...
import { Icon_Promote } from './Promote.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Promote workflow icon as a custom element.
 *
 * @element swc-icon-promote
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-promote': IconPromote;
  }
}

defineElement('swc-icon-promote', IconPromote);
