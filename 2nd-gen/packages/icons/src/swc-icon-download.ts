...
import { Icon_Download } from './Download.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Download workflow icon as a custom element.
 *
 * @element swc-icon-download
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-download': IconDownload;
  }
}

defineElement('swc-icon-download', IconDownload);
