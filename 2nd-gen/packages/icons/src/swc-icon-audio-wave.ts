...
import { Icon_AudioWave } from './AudioWave.js';

import styles from './stylesheets/icon-base.css';

/**
 * The AudioWave workflow icon as a custom element.
 *
 * @element swc-icon-audio-wave
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-audio-wave': IconAudioWave;
  }
}

defineElement('swc-icon-audio-wave', IconAudioWave);
