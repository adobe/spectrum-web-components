...
import { Icon_Preview } from './Preview.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Preview workflow icon as a custom element.
 *
 * @element swc-icon-preview
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-preview': IconPreview;
  }
}

defineElement('swc-icon-preview', IconPreview);
