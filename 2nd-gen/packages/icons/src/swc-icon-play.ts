...
import { Icon_Play } from './Play.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Play workflow icon as a custom element.
 *
 * @element swc-icon-play
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-play': IconPlay;
  }
}

defineElement('swc-icon-play', IconPlay);
