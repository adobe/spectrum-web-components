...
import { Icon_Import } from './Import.js';

import styles from './stylesheets/icon-base.css';

/**
 * The Import workflow icon as a custom element.
 *
 * @element swc-icon-import
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-import': IconImport;
  }
}

defineElement('swc-icon-import', IconImport);
