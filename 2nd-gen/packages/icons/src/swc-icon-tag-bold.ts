...
import { Icon_TagBold } from './TagBold.js';

import styles from './stylesheets/icon-base.css';

/**
 * The TagBold workflow icon as a custom element.
 *
 * @element swc-icon-tag-bold
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-tag-bold': IconTagBold;
  }
}

defineElement('swc-icon-tag-bold', IconTagBold);
