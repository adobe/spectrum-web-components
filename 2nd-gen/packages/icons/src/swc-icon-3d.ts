...
import { Icon_3D } from './3D.js';

import styles from './stylesheets/icon-base.css';

/**
 * The 3D workflow icon as a custom element.
 *
 * @element swc-icon-3d
 * @since 2.0.0-beta.2
 *
 ...
 */
export class Icon3D extends IconBase {
  ...
  protected override render(): TemplateResult {
    return html`
      <span class="swc-Icon">${unsafeSVG(Icon_3D())}</span>
    `;
  }
}
...
defineElement('swc-icon-3d', Icon3D);
