...
import { Icon_CornerRadius } from './CornerRadius.js';

import styles from './stylesheets/icon-base.css';

/**
 * The CornerRadius workflow icon as a custom element.
 *
 * @element swc-icon-corner-radius
 * @since 2.0.0-beta.2
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'swc-icon-corner-radius': IconCornerRadius;
  }
}

defineElement('swc-icon-corner-radius', IconCornerRadius);
