...
For how **landmarks** and **headings** should be structured in your markup, see [Headings and landmarks](/docs/learn-accessibility-headings-and-landmarks--docs). You can **inspect** that structure in the browser with WAVE; see [WAVE toolbar testing](/docs/learn-accessibility-wave-toolbar-testing--readme#structure-tab).

### Relationship to keyboard accessibility

Screen reader testing builds on [keyboard testing](/docs/learn-accessibility-keyboard-testing--docs). Before testing with a screen reader:
...
[Headings and landmarks](/docs/learn-accessibility-headings-and-landmarks--docs) explains which native **landmark** regions to use, when too many `region` landmarks add noise, and how landmarks work with a heading outline.
...
3. **Navigate to the component**: Use heading or landmark navigation (shape that structure in your app per [Headings and landmarks](/docs/learn-accessibility-headings-and-landmarks--docs))
...
For quick, on-page **outline** feedback before or during screen reader tests, use [WAVE toolbar testing](/docs/learn-accessibility-wave-toolbar-testing--docs). For more testing resources and tools, see [Accessibility resources](/docs/learn-accessibility-resources--docs).
