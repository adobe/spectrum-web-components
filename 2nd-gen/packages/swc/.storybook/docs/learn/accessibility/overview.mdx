...
- [Headings and landmarks](/docs/learn-accessibility-headings-and-landmarks--docs) — A logical **`h1`–`h6` outline** and **landmark** regions (`main`, `nav`, `header`, and similar), including Spectrum Web Components notes (`heading-level`, slots)
- [Semantic HTML and ARIA](/docs/learn-accessibility-semantic-html-and-aria--docs) — When native HTML is enough, when to use ARIA, and **cross-root** limitations in custom elements
- [WAVE toolbar testing](/docs/learn-accessibility-wave-toolbar-testing--docs) — Free browser extension: **Structure** (headings and regions), **Order**, **Details**, and **Contrast** in the page you are building
- [Keyboard testing](/docs/learn-accessibility-keyboard-testing--docs) — <kbd>Tab</kbd> order, focus, and component keyboard models
- [Screen reader testing](/docs/learn-accessibility-screen-reader-testing--docs) — Browse and focus modes, and shortcuts to move by **heading** and **landmark**
- [Accessible pattern libraries](/docs/learn-accessibility-accessible-pattern-libraries--docs) — Pattern collection for accessible UI
- [Accessibility resources](/docs/learn-accessibility-resources--docs) — External references and checklists
