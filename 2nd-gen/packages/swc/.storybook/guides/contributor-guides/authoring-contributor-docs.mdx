...
- The H1 title (between the breadcrumb marker and the TOC marker)
- All content after the TOC section
...
You can request an update by asking an AI Agent, pointing it to the [AI Agent Instructions](?path=/docs/guides-contributor-guides-ai-agent-instructions--docs).
...
> If you don't have access to an AI Agent or prefer not to use one, you can also run the script manually. See [the AI Agent Instructions](?path=/docs/guides-contributor-guides-ai-agent-instructions--docs) for details.
...
If you encounter any issues, try asking an AI agent to help you troubleshoot, pointing the agent to the [AI Agent Instructions](?path=/docs/guides-contributor-guides-ai-agent-instructions--docs).
