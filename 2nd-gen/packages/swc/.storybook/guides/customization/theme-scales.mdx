...
There are 2 scale contexts available: `medium` (i.e., desktop) and `large` (i.e., mobile). Scales apply to properties such as `font-size` and other spacing-related values.
