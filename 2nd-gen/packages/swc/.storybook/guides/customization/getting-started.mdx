...
For installing the package, adding the base stylesheet, and rendering your first component, see [Get started](/docs/get-started--docs). This page covers customization specifics once that basic setup is in place.
