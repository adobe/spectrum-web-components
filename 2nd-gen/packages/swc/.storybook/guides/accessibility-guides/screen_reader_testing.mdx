...
For how **landmarks** and **headings** should be structured in your markup, see [Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme). You can **inspect** that structure in the browser with WAVE; see [WAVE toolbar testing](/docs/guides-accessibility-guides-wave-toolbar-testing--readme#structure-tab).
...
[Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme) explains which native **landmark** regions to use, when too many `region` landmarks add noise, and how landmarks work with a heading outline.
...
3. **Navigate to the component**: Use heading or landmark navigation (shape that structure in your app per [Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme))
