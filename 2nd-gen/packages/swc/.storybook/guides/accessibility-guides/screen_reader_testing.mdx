...
For how **landmarks** and **headings** should be structured in your markup, see [Headings and landmarks](/docs/guides-accessibility-guides-headings-and-landmarks--readme). You can **inspect** that structure in the browser with WAVE; see [WAVE toolbar testing](/docs/guides-accessibility-guides-wave-toolbar-testing--readme#structure-tab).

### Relationship to keyboard accessibility

Screen reader testing builds on [keyboard testing](/docs/guides-accessibility-guides-keyboard-testing--readme). Before testing with a screen reader:
...
[Headings and landmarks](/docs/guides-accessibility-guides-headings-and-landmarks--readme) explains which native **landmark** regions to use, when too many `region` landmarks add noise, and how landmarks work with a heading outline.
...
3. **Navigate to the component**: Use heading or landmark navigation (shape that structure in your app per [Headings and landmarks](/docs/guides-accessibility-guides-headings-and-landmarks--readme))
...
For quick, on-page **outline** feedback before or during screen reader tests, use [WAVE toolbar testing](/docs/guides-accessibility-guides-wave-toolbar-testing--readme). For more testing resources and tools, see [Accessibility resources](/docs/guides-accessibility-guides-accessibility-resources--readme).
