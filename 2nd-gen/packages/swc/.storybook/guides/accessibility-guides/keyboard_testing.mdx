...
<br />> While buttons use both <kbd>Enter</kbd> and <kbd>Space</kbd> to
activate, **links only use <kbd>Enter</kbd> to activate.**
...
<br />> To experience how keyboard interaction should word, try out this
[demontration site](https://rha11y-tests.netlify.app/keyboard.html). |
