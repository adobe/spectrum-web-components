...
<figure>
  ...
  />
  <figcaption>
    macOS System Settings, Keyboard: the Keyboard navigation option (or, on
    older macOS, All controls under Full Keyboard Access) so Tab reaches all
    focusable controls.
  </figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>
    Safari Settings, Advanced tab: under Accessibility, Press Tab to highlight
    each item on a webpage is enabled so in-page focus moves to every link and
    control.
  </figcaption>
</figure>
...
- [WAVE toolbar testing](/docs/guides-accessibility-guides-wave-toolbar-testing--readme) — **Order** tab: compare **navigable** order and the drawn path to your visual layout (complements **Tab** testing here)
- [Headings and landmarks](/docs/guides-accessibility-guides-headings-and-landmarks--readme) — **Skip** links and a sensible **main** / **nav** structure make keyboard traversal predictable
- [Screen reader testing](/docs/guides-accessibility-guides-screen-reader-testing--readme) — many screen reader users move focus with the same keys you use for quick navigation in browse mode
