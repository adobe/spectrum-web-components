...
<Meta title="Accessibility guides/Overview" />
...
- [Landmarks and headings](?path=/docs/guides-accessibility-guides-landmarks-and-headings--readme) — **Landmarks** (`main`, `nav`, `header`, and similar) and a logical **`h1`–`h6` outline**, including Spectrum Web Components notes (`heading-level`, slots)
- [Semantic HTML and ARIA](?path=/docs/guides-accessibility-guides-semantic-html-aria--readme) — When native HTML is enough, when to use ARIA, and **cross-root** limitations in custom elements
- [WAVE toolbar testing](?path=/docs/guides-accessibility-guides-wave-toolbar-testing--readme) — Free browser extension: **Structure** (headings and regions), **Order**, **Details**, and **Contrast** in the page you are building
- [Keyboard testing](?path=/docs/guides-accessibility-guides-keyboard-testing--readme) — <kbd>Tab</kbd> order, focus, and component keyboard models
- [Screen reader testing](?path=/docs/guides-accessibility-guides-screen-reader-testing--readme) — Browse and focus modes, and shortcuts to move by **heading** and **landmark**
- [Accessible pattern libraries](?path=/docs/guides-accessibility-guides-accessible-pattern-libraries--readme) — Pattern collection for accessible UI
- [Accessibility resources](?path=/docs/guides-accessibility-guides-accessibility-resources--readme) — External references and checklists
