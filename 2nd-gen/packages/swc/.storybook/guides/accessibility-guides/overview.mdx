...
- [Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme) — **Landmarks** (`main`, `nav`, `header`, and similar) and a logical **`h1`–`h6` outline**, including Spectrum Web Components notes (`heading-level`, slots)
