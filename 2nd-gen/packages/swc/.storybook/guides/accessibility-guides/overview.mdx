...
- [Headings and landmarks](/docs/guides-accessibility-guides-headings-and-landmarks--readme) — A logical **`h1`–`h6` outline** and **landmark** regions (`main`, `nav`, `header`, and similar), including Spectrum Web Components notes (`heading-level`, slots)
- [Semantic HTML and ARIA](/docs/guides-accessibility-guides-semantic-html-aria--readme) — When native HTML is enough, when to use ARIA, and **cross-root** limitations in custom elements
- [WAVE toolbar testing](/docs/guides-accessibility-guides-wave-toolbar-testing--readme) — Free browser extension: **Structure** (headings and regions), **Order**, **Details**, and **Contrast** in the page you are building
- [Keyboard testing](/docs/guides-accessibility-guides-keyboard-testing--readme) — <kbd>Tab</kbd> order, focus, and component keyboard models
- [Screen reader testing](/docs/guides-accessibility-guides-screen-reader-testing--readme) — Browse and focus modes, and shortcuts to move by **heading** and **landmark**
- [Accessible pattern libraries](/docs/guides-accessibility-guides-accessible-pattern-libraries--readme) — Pattern collection for accessible UI
- [Accessibility resources](/docs/guides-accessibility-guides-accessibility-resources--readme) — External references and checklists
