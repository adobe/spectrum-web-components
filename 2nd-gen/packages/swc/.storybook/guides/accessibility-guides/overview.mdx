...
- [Accessible landmarks](./accessible_landmarks.mdx) — **Landmarks** (`main`, `nav`, `header`, and similar) and a logical **`h1`–`h6` outline**, including Spectrum Web Components notes (`heading-level`, slots)
- [Semantic HTML and ARIA](./semantic_html_aria.mdx) — When native HTML is enough, when to use ARIA, and **cross-root** limitations in custom elements
- [WAVE toolbar testing](./wave_toolbar_testing.mdx) — Free browser extension: **Structure** (headings and regions), **Order**, **Details**, and **Contrast** in the page you are building
- [Keyboard testing](./keyboard_testing.mdx) — <kbd>Tab</kbd> order, focus, and component keyboard models
- [Screen reader testing](./screen_reader_testing.mdx) — Browse and focus modes, and shortcuts to move by **heading** and **landmark**
- [Accessible pattern libraries](./accessible_pattern_libraries.mdx) — Pattern collection for accessible UI
- [Accessibility resources](./accessibility_resources.mdx) — External references and checklists
