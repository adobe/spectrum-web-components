...
Screen readers and other assistive technologies expose an **accessibility tree** derived from the DOM. Semantic elements map to familiar roles and names (for example, a `button` is announced as a button; a labelled text field exposes its label association). Headings define an **outline** users can navigate by. Landmark regions (`main`, `nav`, `header`, and similar) help users jump to the right part of the page. See [Understanding success criterion 1.3.1: info and relationships](https://www.w3.org/WAI/WCAG22/Understanding/info-and-relationships.html) in WCAG 2.2 for why programmatic relationships and structure matter. Practical guidance: [Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme) (outlines, `aria-labelledby`, and avoiding **too many** generic regions), and in-browser **verification** with [WAVE](/docs/guides-accessibility-guides-wave-toolbar-testing--readme#structure-tab).
...
- [Landmarks and headings](/docs/guides-accessibility-guides-landmarks-and-headings--readme) — page-level landmarks and `h1`–`h6` structure, WCAG table, and WAVE
