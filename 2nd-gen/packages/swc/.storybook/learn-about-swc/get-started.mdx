...
You can open that component's documentation page for the feature overview, accessibility guidance, and the full API. For this example, see [Badge](/docs/components-badge--readme).
...
- **[Support and compatibility](/docs/resources-support-and-compatibility--readme)** — versioning, APIs, and browser support for `@adobe/spectrum-wc`.
- **[Changelog](/docs/resources-changelog--readme)** — release notes for `@adobe/spectrum-wc`.
