...
```ts
import '@adobe/spectrum-wc/patterns/ai/response-status/swc-response-status.js';
```
...
```ts
import type { ResponseStatus } from '@adobe/spectrum-wc/patterns/ai/response-status';
```

See the [AI pattern overview](/docs/patterns-ai-pattern-overview--docs) for the available elements and their registration imports.
