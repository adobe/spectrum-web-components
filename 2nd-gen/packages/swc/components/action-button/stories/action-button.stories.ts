...
const editIconStatic = unsafeStatic(
  editIconSvg.replace('<svg ', '<svg slot="icon" ')
);
...
export const IconOnly: Story = {
  render: () =>
    staticHtml`<swc-action-button accessible-label="Edit">${editIconStatic}</swc-action-button>`,
  tags: ['behaviors'],
};
