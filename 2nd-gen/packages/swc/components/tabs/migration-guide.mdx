...
- [ ] Remove `@spectrum-web-components/tabs` and replace imports of `sp-tabs.js`, `sp-tab.js`, and `sp-tab-panel.js` with `@adobe/spectrum-wc/components/tabs/swc-tabs.js`, `swc-tab.js`, and `swc-tab-panel.js`
