...
| Import                  | `@spectrum-web-components/tabs/sp-tabs.js` (per element) | `@adobe/spectrum-wc/components/tabs/swc-tabs.js` (single import) |
...
- [ ] Remove `@spectrum-web-components/tabs` and import from `@adobe/spectrum-wc/components/tabs/swc-tabs.js` instead
