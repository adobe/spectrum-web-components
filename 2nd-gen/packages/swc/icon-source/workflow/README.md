...
Raw SVG source for the **public** workflow icons goes here (RFC Phases 3–4). Download the S2 Icon Global Set (Open Source) SVGs into this folder, then run the workflow generator; the generated art is what gets committed.
