...
| `swc-conversation-artifact` | Shared artifact primitive with `card` and `media` variants, used in prompt-field and user-message surfaces |
...
| `swc-message-suggestions`   | Row of follow-up suggestion chips generated from slotted text items                                        |
