...
For additional card and media gallery examples, see **[Multi-card](/docs/patterns-conversational-ai-upload-artifact--readme#multi-card)** and **[Multi-media](/docs/patterns-conversational-ai-upload-artifact--readme#multi-media)**.
