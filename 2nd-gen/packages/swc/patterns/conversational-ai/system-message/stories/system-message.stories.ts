...
const slotMessageRich = `<div class="swc-conversationalAi-systemProse"><p class="swc-Body swc-Body--margins">According to the assets, there is a clear journey from beginning to end. Let's start with overarching themes and build from there.</p><h3 class="swc-Heading">Big idea/ core narrative: The warmth of welcome</h3><p class="swc-Body swc-Body--margins">Hospitality begins the moment our customers set foot off their plane. We are more than accommodation, and we service a diverse base. We hope to be the anchor and bounce board for all who stay with us.</p><h4 class="swc-Heading swc-Heading--sizeXS">Belonging happens at Hilton</h4><p class="swc-Body swc-Body--margins">We strive to be familiar but exceed expectations. These assets highlight how belonging is personified.</p><h4 class="swc-Heading swc-Heading--sizeXS">We are more than accommodation</h4><ul class="swc-Body swc-Body--margins"><li>Airport pick up service</li><li>Local recommendations</li><li>Everyday excursions</li><li>Customizable experience</li></ul></div>`;
