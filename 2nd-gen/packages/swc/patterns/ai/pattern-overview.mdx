...
<Meta title="AI/Pattern overview" />
...
The **`+`** button should open a menu with, at minimum, **Add from Adobe cloud storage** and **Attach files**. See [Upload action menu](/docs/patterns-ai-prompt-field--docs#upload-action-menu) for the full guidance.
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          .getChannel()
          .emit('navigateUrl', '/?path=/docs/patterns-ai-prompt-field--docs'),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-upload-attachment--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-conversation-thread--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-conversation-turn--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          .getChannel()
          .emit('navigateUrl', '/?path=/docs/patterns-ai-user-message--docs'),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          .getChannel()
          .emit('navigateUrl', '/?path=/docs/patterns-ai-system-message--docs'),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-response-status--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-message-feedback--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-message-sources--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-suggestion-group--docs'
          ),
    },
  ]}
/>
  ...
  additionalActions={[
    {
      ...
      onClick: () =>
        addons
          ...
          .emit(
            'navigateUrl',
            '/?path=/docs/patterns-ai-suggestion-group-suggestion-item--docs'
          ),
    },
  ]}
/>
