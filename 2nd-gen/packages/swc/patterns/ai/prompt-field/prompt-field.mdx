...
- **Mixed images and documents in one batch** → normalize to all **`type="media"`**: image previews in `thumbnail`, and document tiles with a preview or icon in `thumbnail` plus an optional **`badge`** (for example, "PDF"). See **[Media with badge](/docs/patterns-ai-upload-attachment--docs#media-with-badge)**.
...
For additional card and media gallery examples, see **[Multi-card](/docs/patterns-ai-upload-attachment--docs#multi-card)** and **[Multi-media](/docs/patterns-ai-upload-attachment--docs#multi-media)**.
