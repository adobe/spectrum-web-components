 ...
 * For several attachments at once, see **Multi-card**, **Multi-media**, and **[Prompt field → Attachment](/docs/patterns-ai-prompt-field--docs#attachment)**.
 */
const meta: Meta = {
  title: 'AI/Upload attachment',
  ...
  parameters: {
    docs: {
      packagePath: 'patterns/ai/upload-attachment',
      subtitle:
