...
describe("Menu group", () => {
  ...
  it("manages complex slotted menu items", async function() {
    ...
    items.i1 = group == null ? void 0 : group.renderRoot.querySelector("#i-1");
    items.i4 = group == null ? void 0 : group.renderRoot.querySelector("#i-4");
    items.i10 = group == null ? void 0 : group.renderRoot.querySelector("#i-10");
    items.i11 = group == null ? void 0 : group.renderRoot.querySelector("#i-11");
    items.i12 = group == null ? void 0 : group.renderRoot.querySelector("#i-12");
