import{i as t}from"./d230bd74.js";import{S as e,y as i,e as o}from"./95f60e39.js";import{F as s,O as a,b as r,S as c,a as l,l as n,i as d,L as m}from"./f4a2163c.js";import{R as b}from"./464e15ff.js";import{o as u}from"./f43d2d85.js";import"./c16ce466.js";import"./5a13eab1.js";import"./29f0a507.js";import"./2722a9f7.js";import{Overlay as p}from"./4b1f9fa7.js";var h=t`
...
`,k=Object.defineProperty,q=Object.getOwnPropertyDescriptor,w=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?q(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&k(e,i,a),a};const S=class extends(s(a(r(e,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[z]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}handleContentChange(){this.dispatchEvent(new Event("sp-tab-contentchange",{bubbles:!0,composed:!0}))}render(){return i`
            ${this.hasIcon?i`
                      <slot name="icon"></slot>
                  `:i``}
...
`,T=Object.defineProperty,E=Object.getOwnPropertyDescriptor,$=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?E(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&T(e,i,a),a};const L={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`,D=Object.defineProperty,F=Object.getOwnPropertyDescriptor,X=(t,e,i,o)=>{for(var s,a=o>1?void 0:o?F(e,i):e,r=t.length-1;r>=0;r--)(s=t[r])&&(a=(o?s(e,i,a):s(a))||a);return o&&a&&D(e,i,a),a};class _ extends(m(l)){constructor(){super(...arguments),this.selected=!1,this.value=""}static get styles(){return[z,R]}handleContentChange(){this.dispatchEvent(new Event("sp-top-nav-item-contentchange",{bubbles:!0,composed:!0}))}get focusElement(){return this.anchor}click(){this.anchor.click()}render(){return i`
            <a
                id="item-label"
                href=${n(this.href)}
