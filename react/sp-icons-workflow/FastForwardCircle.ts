...
export const SpIconFastForwardCircle = createComponent({
    react: React,
    tagName: 'sp-icon-fast-forward-circle',
    elementClass: IconFastForwardCircle,
    events: {},
    displayName: 'SpIconFastForwardCircle',
});
