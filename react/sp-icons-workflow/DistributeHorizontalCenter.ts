...
export const SpIconDistributeHorizontalCenter = createComponent({
    react: React,
    tagName: 'sp-icon-distribute-horizontal-center',
    elementClass: IconDistributeHorizontalCenter,
    events: {},
    displayName: 'SpIconDistributeHorizontalCenter',
});
