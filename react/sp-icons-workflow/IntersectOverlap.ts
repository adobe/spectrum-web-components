...
export const SpIconIntersectOverlap = createComponent({
    react: React,
    tagName: 'sp-icon-intersect-overlap',
    elementClass: IconIntersectOverlap,
    events: {},
    displayName: 'SpIconIntersectOverlap',
});
