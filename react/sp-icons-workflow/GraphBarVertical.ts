...
export const SpIconGraphBarVertical = createComponent({
    react: React,
    tagName: 'sp-icon-graph-bar-vertical',
    elementClass: IconGraphBarVertical,
    events: {},
    displayName: 'SpIconGraphBarVertical',
});
