...
export const SpIconAttachmentExclude = createComponent({
    react: React,
    tagName: 'sp-icon-attachment-exclude',
    elementClass: IconAttachmentExclude,
    events: {},
    displayName: 'SpIconAttachmentExclude',
});
