...
export const SpIconUploadToCloudOutline = createComponent({
    react: React,
    tagName: 'sp-icon-upload-to-cloud-outline',
    elementClass: IconUploadToCloudOutline,
    events: {},
    displayName: 'SpIconUploadToCloudOutline',
});
