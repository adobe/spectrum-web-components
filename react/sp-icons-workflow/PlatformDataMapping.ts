...
export const SpIconPlatformDataMapping = createComponent({
    react: React,
    tagName: 'sp-icon-platform-data-mapping',
    elementClass: IconPlatformDataMapping,
    events: {},
    displayName: 'SpIconPlatformDataMapping',
});
