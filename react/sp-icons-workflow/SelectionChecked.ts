...
export const SpIconSelectionChecked = createComponent({
    react: React,
    tagName: 'sp-icon-selection-checked',
    elementClass: IconSelectionChecked,
    events: {},
    displayName: 'SpIconSelectionChecked',
});
