...
export const SpIconLayersSendToBack = createComponent({
    react: React,
    tagName: 'sp-icon-layers-send-to-back',
    elementClass: IconLayersSendToBack,
    events: {},
    displayName: 'SpIconLayersSendToBack',
});
