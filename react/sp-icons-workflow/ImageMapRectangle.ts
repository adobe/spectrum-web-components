...
export const SpIconImageMapRectangle = createComponent({
    react: React,
    tagName: 'sp-icon-image-map-rectangle',
    elementClass: IconImageMapRectangle,
    events: {},
    displayName: 'SpIconImageMapRectangle',
});
