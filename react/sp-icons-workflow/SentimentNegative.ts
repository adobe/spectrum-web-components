...
export const SpIconSentimentNegative = createComponent({
    react: React,
    tagName: 'sp-icon-sentiment-negative',
    elementClass: IconSentimentNegative,
    events: {},
    displayName: 'SpIconSentimentNegative',
});
