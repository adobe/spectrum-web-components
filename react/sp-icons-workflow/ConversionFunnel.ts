...
export const SpIconConversionFunnel = createComponent({
    react: React,
    tagName: 'sp-icon-conversion-funnel',
    elementClass: IconConversionFunnel,
    events: {},
    displayName: 'SpIconConversionFunnel',
});
