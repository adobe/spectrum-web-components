...
export const SpIconTableColumnRemoveCenter = createComponent({
    react: React,
    tagName: 'sp-icon-table-column-remove-center',
    elementClass: IconTableColumnRemoveCenter,
    events: {},
    displayName: 'SpIconTableColumnRemoveCenter',
});
