...
export const SpIconEmailGearOutline = createComponent({
    react: React,
    tagName: 'sp-icon-email-gear-outline',
    elementClass: IconEmailGearOutline,
    events: {},
    displayName: 'SpIconEmailGearOutline',
});
