...
export const SpIconTextBulletedHierarchy = createComponent({
    react: React,
    tagName: 'sp-icon-text-bulleted-hierarchy',
    elementClass: IconTextBulletedHierarchy,
    events: {},
    displayName: 'SpIconTextBulletedHierarchy',
});
