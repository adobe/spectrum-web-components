...
export const SpIconStepForwardCircle = createComponent({
    react: React,
    tagName: 'sp-icon-step-forward-circle',
    elementClass: IconStepForwardCircle,
    events: {},
    displayName: 'SpIconStepForwardCircle',
});
