...
export const SpIconPersonalizationField = createComponent({
    react: React,
    tagName: 'sp-icon-personalization-field',
    elementClass: IconPersonalizationField,
    events: {},
    displayName: 'SpIconPersonalizationField',
});
