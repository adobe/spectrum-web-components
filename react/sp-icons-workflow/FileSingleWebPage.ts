...
export const SpIconFileSingleWebPage = createComponent({
    react: React,
    tagName: 'sp-icon-file-single-web-page',
    elementClass: IconFileSingleWebPage,
    events: {},
    displayName: 'SpIconFileSingleWebPage',
});
