...
export const SpIconTableRowRemoveCenter = createComponent({
    react: React,
    tagName: 'sp-icon-table-row-remove-center',
    elementClass: IconTableRowRemoveCenter,
    events: {},
    displayName: 'SpIconTableRowRemoveCenter',
});
