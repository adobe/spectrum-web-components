...
export const SpIconMarketingActivities = createComponent({
    react: React,
    tagName: 'sp-icon-marketing-activities',
    elementClass: IconMarketingActivities,
    events: {},
    displayName: 'SpIconMarketingActivities',
});
