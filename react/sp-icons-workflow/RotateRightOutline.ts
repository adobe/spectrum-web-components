...
export const SpIconRotateRightOutline = createComponent({
    react: React,
    tagName: 'sp-icon-rotate-right-outline',
    elementClass: IconRotateRightOutline,
    events: {},
    displayName: 'SpIconRotateRightOutline',
});
