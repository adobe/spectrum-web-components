...
export const SpIconTextBaselineShift = createComponent({
    react: React,
    tagName: 'sp-icon-text-baseline-shift',
    elementClass: IconTextBaselineShift,
    events: {},
    displayName: 'SpIconTextBaselineShift',
});
