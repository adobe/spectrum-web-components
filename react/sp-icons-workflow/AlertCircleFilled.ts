...
export const SpIconAlertCircleFilled = createComponent({
    react: React,
    tagName: 'sp-icon-alert-circle-filled',
    elementClass: IconAlertCircleFilled,
    events: {},
    displayName: 'SpIconAlertCircleFilled',
});
