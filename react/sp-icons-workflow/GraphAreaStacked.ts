...
export const SpIconGraphAreaStacked = createComponent({
    react: React,
    tagName: 'sp-icon-graph-area-stacked',
    elementClass: IconGraphAreaStacked,
    events: {},
    displayName: 'SpIconGraphAreaStacked',
});
