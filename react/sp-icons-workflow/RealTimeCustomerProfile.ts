...
export const SpIconRealTimeCustomerProfile = createComponent({
    react: React,
    tagName: 'sp-icon-real-time-customer-profile',
    elementClass: IconRealTimeCustomerProfile,
    events: {},
    displayName: 'SpIconRealTimeCustomerProfile',
});
