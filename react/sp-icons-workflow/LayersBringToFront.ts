...
export const SpIconLayersBringToFront = createComponent({
    react: React,
    tagName: 'sp-icon-layers-bring-to-front',
    elementClass: IconLayersBringToFront,
    events: {},
    displayName: 'SpIconLayersBringToFront',
});
