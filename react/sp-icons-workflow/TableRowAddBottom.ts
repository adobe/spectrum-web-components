...
export const SpIconTableRowAddBottom = createComponent({
    react: React,
    tagName: 'sp-icon-table-row-add-bottom',
    elementClass: IconTableRowAddBottom,
    events: {},
    displayName: 'SpIconTableRowAddBottom',
});
