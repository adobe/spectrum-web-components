...
export const SpIconBookmarkSmallOutline = createComponent({
    react: React,
    tagName: 'sp-icon-bookmark-small-outline',
    elementClass: IconBookmarkSmallOutline,
    events: {},
    displayName: 'SpIconBookmarkSmallOutline',
});
