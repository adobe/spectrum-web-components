...
export const SpIconDistributeHorizontally = createComponent({
    react: React,
    tagName: 'sp-icon-distribute-horizontally',
    elementClass: IconDistributeHorizontally,
    events: {},
    displayName: 'SpIconDistributeHorizontally',
});
