...
export const SpIconEmailExcludeOutline = createComponent({
    react: React,
    tagName: 'sp-icon-email-exclude-outline',
    elementClass: IconEmailExcludeOutline,
    events: {},
    displayName: 'SpIconEmailExcludeOutline',
});
