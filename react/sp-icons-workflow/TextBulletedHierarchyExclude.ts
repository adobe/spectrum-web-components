...
export const SpIconTextBulletedHierarchyExclude = createComponent({
    react: React,
    tagName: 'sp-icon-text-bulleted-hierarchy-exclude',
    elementClass: IconTextBulletedHierarchyExclude,
    events: {},
    displayName: 'SpIconTextBulletedHierarchyExclude',
});
