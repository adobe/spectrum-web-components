...
export const SpIconDistributeVertically = createComponent({
    react: React,
    tagName: 'sp-icon-distribute-vertically',
    elementClass: IconDistributeVertically,
    events: {},
    displayName: 'SpIconDistributeVertically',
});
