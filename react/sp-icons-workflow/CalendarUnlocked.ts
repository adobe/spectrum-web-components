...
export const SpIconCalendarUnlocked = createComponent({
    react: React,
    tagName: 'sp-icon-calendar-unlocked',
    elementClass: IconCalendarUnlocked,
    events: {},
    displayName: 'SpIconCalendarUnlocked',
});
