...
export const SpIconTextLetteredUpperCase = createComponent({
    react: React,
    tagName: 'sp-icon-text-lettered-upper-case',
    elementClass: IconTextLetteredUpperCase,
    events: {},
    displayName: 'SpIconTextLetteredUpperCase',
});
