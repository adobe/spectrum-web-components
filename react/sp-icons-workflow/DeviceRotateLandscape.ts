...
export const SpIconDeviceRotateLandscape = createComponent({
    react: React,
    tagName: 'sp-icon-device-rotate-landscape',
    elementClass: IconDeviceRotateLandscape,
    events: {},
    displayName: 'SpIconDeviceRotateLandscape',
});
