...
export const SpIconTextIndentIncrease = createComponent({
    react: React,
    tagName: 'sp-icon-text-indent-increase',
    elementClass: IconTextIndentIncrease,
    events: {},
    displayName: 'SpIconTextIndentIncrease',
});
