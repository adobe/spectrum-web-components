...
export const SpIconEmailNotification = createComponent({
    react: React,
    tagName: 'sp-icon-email-notification',
    elementClass: IconEmailNotification,
    events: {},
    displayName: 'SpIconEmailNotification',
});
