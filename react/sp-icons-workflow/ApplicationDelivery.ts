...
export const SpIconApplicationDelivery = createComponent({
    react: React,
    tagName: 'sp-icon-application-delivery',
    elementClass: IconApplicationDelivery,
    events: {},
    displayName: 'SpIconApplicationDelivery',
});
