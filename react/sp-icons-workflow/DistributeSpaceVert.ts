...
export const SpIconDistributeSpaceVert = createComponent({
    react: React,
    tagName: 'sp-icon-distribute-space-vert',
    elementClass: IconDistributeSpaceVert,
    events: {},
    displayName: 'SpIconDistributeSpaceVert',
});
