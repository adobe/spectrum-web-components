...
export const SpIconSubtractFromSelection = createComponent({
    react: React,
    tagName: 'sp-icon-subtract-from-selection',
    elementClass: IconSubtractFromSelection,
    events: {},
    displayName: 'SpIconSubtractFromSelection',
});
