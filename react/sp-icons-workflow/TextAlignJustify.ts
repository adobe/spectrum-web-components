...
export const SpIconTextAlignJustify = createComponent({
    react: React,
    tagName: 'sp-icon-text-align-justify',
    elementClass: IconTextAlignJustify,
    events: {},
    displayName: 'SpIconTextAlignJustify',
});
