...
export const SpIconStepBackwardCircle = createComponent({
    react: React,
    tagName: 'sp-icon-step-backward-circle',
    elementClass: IconStepBackwardCircle,
    events: {},
    displayName: 'SpIconStepBackwardCircle',
});
