...
export const SpIconDistributeVerticalCenter = createComponent({
    react: React,
    tagName: 'sp-icon-distribute-vertical-center',
    elementClass: IconDistributeVerticalCenter,
    events: {},
    displayName: 'SpIconDistributeVerticalCenter',
});
