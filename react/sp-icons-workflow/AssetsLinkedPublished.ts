...
export const SpIconAssetsLinkedPublished = createComponent({
    react: React,
    tagName: 'sp-icon-assets-linked-published',
    elementClass: IconAssetsLinkedPublished,
    events: {},
    displayName: 'SpIconAssetsLinkedPublished',
});
