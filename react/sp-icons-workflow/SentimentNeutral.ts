...
export const SpIconSentimentNeutral = createComponent({
    react: React,
    tagName: 'sp-icon-sentiment-neutral',
    elementClass: IconSentimentNeutral,
    events: {},
    displayName: 'SpIconSentimentNeutral',
});
