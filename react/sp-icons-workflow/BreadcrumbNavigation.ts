...
export const SpIconBreadcrumbNavigation = createComponent({
    react: React,
    tagName: 'sp-icon-breadcrumb-navigation',
    elementClass: IconBreadcrumbNavigation,
    events: {},
    displayName: 'SpIconBreadcrumbNavigation',
});
