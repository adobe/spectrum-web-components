...
export const SpIconForPlacementOnly = createComponent({
    react: React,
    tagName: 'sp-icon-for-placement-only',
    elementClass: IconForPlacementOnly,
    events: {},
    displayName: 'SpIconForPlacementOnly',
});
