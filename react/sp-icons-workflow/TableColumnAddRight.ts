...
export const SpIconTableColumnAddRight = createComponent({
    react: React,
    tagName: 'sp-icon-table-column-add-right',
    elementClass: IconTableColumnAddRight,
    events: {},
    displayName: 'SpIconTableColumnAddRight',
});
