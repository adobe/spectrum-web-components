...
export const SpIconCheckmarkCircleOutline = createComponent({
    react: React,
    tagName: 'sp-icon-checkmark-circle-outline',
    elementClass: IconCheckmarkCircleOutline,
    events: {},
    displayName: 'SpIconCheckmarkCircleOutline',
});
