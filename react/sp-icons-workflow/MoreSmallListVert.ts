...
export const SpIconMoreSmallListVert = createComponent({
    react: React,
    tagName: 'sp-icon-more-small-list-vert',
    elementClass: IconMoreSmallListVert,
    events: {},
    displayName: 'SpIconMoreSmallListVert',
});
