...
export const SpIconGraphStreamRankedAdd = createComponent({
    react: React,
    tagName: 'sp-icon-graph-stream-ranked-add',
    elementClass: IconGraphStreamRankedAdd,
    events: {},
    displayName: 'SpIconGraphStreamRankedAdd',
});
