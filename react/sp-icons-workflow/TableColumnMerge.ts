...
export const SpIconTableColumnMerge = createComponent({
    react: React,
    tagName: 'sp-icon-table-column-merge',
    elementClass: IconTableColumnMerge,
    events: {},
    displayName: 'SpIconTableColumnMerge',
});
