...
export const SpIconTextBulletedAttach = createComponent({
    react: React,
    tagName: 'sp-icon-text-bulleted-attach',
    elementClass: IconTextBulletedAttach,
    events: {},
    displayName: 'SpIconTextBulletedAttach',
});
