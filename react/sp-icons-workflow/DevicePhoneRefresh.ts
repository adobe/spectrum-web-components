...
export const SpIconDevicePhoneRefresh = createComponent({
    react: React,
    tagName: 'sp-icon-device-phone-refresh',
    elementClass: IconDevicePhoneRefresh,
    events: {},
    displayName: 'SpIconDevicePhoneRefresh',
});
