**To add a persistent "memory" or lesson:**

Remember that [lesson or observation]
Log this lesson: [lesson or observation]
Save this for next time: [lesson or observation]
Add to memory: [lesson or observation]

**To review and log lessons from the current session:**

Log any lessons learned from this session
