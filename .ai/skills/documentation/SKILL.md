...
- **Per-unit docs page**: authored as a Markdown / MDX file (`<unit>.mdx`) at the unit's root. This is the docs surface for components, internal components, patterns, and controllers. See [`stories-documentation`](../stories-documentation/SKILL.md) for the per-unit MDX authoring template and conventions.
