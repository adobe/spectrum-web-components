...
Usage:
    ...
    python check_staleness.py .ai/handoffs/2024-01-15-143022-auth.md
"""
...
def check_staleness(handoff_path: str) -> dict:
    ...
    if not project_path or not Path(project_path).exists():
        # Fallback: assume handoff is in .ai/handoffs/ within project
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python check_staleness.py .ai/handoffs/2024-01-15-auth.md")
        sys.exit(1)
