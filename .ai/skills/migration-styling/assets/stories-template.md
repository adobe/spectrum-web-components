...
- [ ] **If the migration plan requires VRT:** `stories/[component].template.ts`, `test/[component].vrt.ts`, and `stories/[component].vrt.stories.ts` exist; enable **Testing preview** in Storybook to confirm the matrix renders
