import{R as e}from"./39665332.js";import{i as t}from"./112b2095.js";import{n,S as s}from"./c34bcf8e.js";import{x as a,A as r}from"./e6d35ea0.js";import{L as i,a as o}from"./928f07c5.js";import{l as c}from"./660f0d27.js";import{d}from"./25a3ae37.js";var l=t`
...
`,b=Object.defineProperty,k=Object.getOwnPropertyDescriptor;class y extends s{constructor(){super(...arguments),this.label=""}static get styles(){return[v,f]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return a`
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}z([n({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],S.prototype,"manageTabIndex",2),z([n({reflect:!0})],S.prototype,"value",2),z([n({reflect:!0})],S.prototype,"variant",2),z([n({reflect:!0})],S.prototype,"label",2),d("sp-sidenav",S),d("sp-sidenav-item",g);export{y as S};
//# sourceMappingURL=e695196d.js.map
