...
)}`;class Lt extends p{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[Et]}render(){return c`<slot></slot>`}}n([d({type:Boolean,reflect:!0})],Lt.prototype,"opened",void 0),n([d({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],Lt.prototype,"textOnly",void 0),customElements.define("sp-quick-actions",Lt);var $t=f`:host([size=s]){--spectrum-card-quiet-body-header-margin-top:var(
...
//# sourceMappingURL=7d459578.js.map
