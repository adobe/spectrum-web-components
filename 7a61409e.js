import{f as e,S as t}from"./dc10afa4.js";import{i as r}from"./112b2095.js";import"./3a25d3c7.js";import{S as o}from"./7c269327.js";import{T as i,A as c,x as a,n as s,d as l}from"./f800a65a.js";import"./9d46765f.js";import{c as n,t as d}from"./b07e6cd6.js";import{l as u,a as p,i as h}from"./a253d781.js";import"./91e12b9c.js";import"./0c2722e8.js";import{E as m}from"./7c327fb6.js";import{e as v,i as f,t as b}from"./16ab2288.js";import{e as x,a as g}from"./e62cd3d3.js";const k=v(class extends f{constructor(e){if(super(e),e.type!==b.PROPERTY&&e.type!==b.ATTRIBUTE&&e.type!==b.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!x(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===i||t===c)return t;const r=e.element,o=e.name;if(e.type===b.PROPERTY){if(t===r[o])return i}else if(e.type===b.BOOLEAN_ATTRIBUTE){if(!!t===r.hasAttribute(o))return i}else if(e.type===b.ATTRIBUTE&&r.getAttribute(o)===t+"")return i;return g(e),t}});var y=r`
...
`,_=Object.defineProperty,R=Object.getOwnPropertyDescriptor,A=(e,t,r,o)=>{for(var i,c=o>1?void 0:o?R(t,r):t,a=e.length-1;a>=0;a--)(i=e[a])&&(c=(o?i(t,r,c):i(c))||c);return o&&c&&_(t,r,c),c};const F=e=>e.stopPropagation();class P extends U{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,O]}handleSubmit(e){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||e.preventDefault()}handleKeydown(e){const{code:t}=e;!this.value||"Escape"!==t||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return a`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}A([s()],P.prototype,"action",2),A([s()],P.prototype,"label",2),A([s()],P.prototype,"method",2),A([s()],P.prototype,"placeholder",2),A([h("#form")],P.prototype,"form",2),l("sp-search",P);export{I as M,L as T,U as a};
//# sourceMappingURL=7a61409e.js.map
