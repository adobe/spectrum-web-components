import{r as e}from"./e50c5e8d.js";import{o as t,t as r,b as a}from"./511057b4.js";import{S as i,$ as s,e as n}from"./03cd2f8f.js";import{M as l}from"./e6a681ee.js";import{o}from"./5a184a55.js";import{t as g}from"./01931b64.js";var m=[t,r,e`
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,y=(e,t,r,a)=>{for(var i,s=a>1?void 0:a?f(t,r):t,n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a?i(t,r,s):i(s))||s);return a&&s&&v(t,r,s),s};const z=class extends l{constructor(){super(),z.instances+=1,this.headerId=`sp-menu-group-label-${z.instances}`}static get styles(){return[...super.styles,x]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const e=this.headerElements.length?this.headerElements[0]:void 0;if(e!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),e){const t=e.id||this.headerId;e.id||(e.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=e}render(){return s`
        ...
        `}};let w=z;w.instances=0,y([o("header",!0)],w.prototype,"headerElements",2),y([g()],w.prototype,"headerElement",2),customElements.define("sp-menu-group",w);export{m as h};
//# sourceMappingURL=86c20ccc.js.map
