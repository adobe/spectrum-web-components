import"./c5698aa6.js";import"./61f5d924.js";import{i as t}from"./112b2095.js";import{S as o}from"./6df85535.js";import{x as e,n as i,S as r,d as n,A as a}from"./6e6fc264.js";import"./ca266fd7.js";import{c as s,t as l}from"./5e6ac894.js";import{i as p,a as c,l as d}from"./1d529499.js";import{O as m}from"./05594b9b.js";import{o as u}from"./cee72369.js";import{f as g}from"./9f9c5c08.js";var h=t`
...
`,v=Object.defineProperty,f=Object.getOwnPropertyDescriptor;class b extends(o(r,{noDefaultSize:!0})){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[h]}handleSlotchange({target:t}){t.assignedElements().forEach((t=>{t.size=this.size}))}render(){return e`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((t,o,e,i)=>{for(var r,n=i>1?void 0:i?f(o,e):o,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(i?r(o,e,n):r(n))||n);i&&n&&v(o,e,n)})([i({type:Boolean,reflect:!0})],b.prototype,"vertical",2),n("sp-button-group",b);var y=t`
...
`,T=Object.defineProperty,z=Object.getOwnPropertyDescriptor,w=(t,o,e,i)=>{for(var r,n=i>1?void 0:i?z(o,e):o,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(i?r(o,e,n):r(n))||n);return i&&n&&T(o,e,n),n};const x=["confirmation","information","warning","error","destructive","secondary"];let C=0;function $(t,o){const e=t.assignedElements(),i=[];return e.forEach((t=>{if(t.id)i.push(t.id);else{const e=o+"-"+C++;t.id=e,i.push(e)}})),i}const E=class t extends(c(r)){constructor(){super(...arguments),this._variant="",this.labelledbyId="sp-dialog-label-"+t.instanceCount++,this.shouldManageTabOrderForScrolling=()=>{const{offsetHeight:t,scrollHeight:o}=this.contentElement;t<o?this.contentElement.tabIndex=0:this.contentElement.removeAttribute("tabindex")},this.describedbyId="sp-dialog-description-"+t.instanceCount++}static get styles(){return[k]}set variant(t){if(t===this.variant)return;const o=this.variant;x.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",o)}get variant(){return this._variant}renderIcon(){switch(this.variant){case"warning":case"error":return e`
        ...
        `}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.shouldManageTabOrderForScrolling)}disconnectedCallback(){window.removeEventListener("resize",this.shouldManageTabOrderForScrolling),super.disconnectedCallback()}};E.instanceCount=0,w([p(".content")],E.prototype,"contentElement",2),w([i({type:String,reflect:!0})],E.prototype,"variant",1);let O=E;var j=Object.defineProperty,S=Object.getOwnPropertyDescriptor,B=(t,o,e,i)=>{for(var r,n=i>1?void 0:i?S(o,e):o,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(i?r(o,e,n):r(n))||n);return i&&n&&j(o,e,n),n};class P extends(m(O,['[slot="hero"]','[slot="footer"]','[slot="button"]'])){constructor(){super(...arguments),this.error=!1,this.dismissable=!1,this.noDivider=!1}static get styles(){return[y]}get hasFooter(){return this.getSlotContentPresence('[slot="footer"]')}get hasButtons(){return this.getSlotContentPresence('[slot="button"]')}get hasHero(){return this.getSlotContentPresence('[slot="hero"]')}close(){this.dispatchEvent(new Event("close",{bubbles:!0,composed:!0,cancelable:!0}))}renderHero(){return e`
            <slot name="hero"></slot>
...
`,G=Object.defineProperty,I=Object.getOwnPropertyDescriptor,F=(t,o,e,i)=>{for(var r,n=i>1?void 0:i?I(o,e):o,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(i?r(o,e,n):r(n))||n);return i&&n&&G(o,e,n),n};class D extends r{constructor(){super(...arguments),this.content="click hover longpress",this.offset=6,this.disabled=!1,this.clickContent=[],this.longpressContent=[],this.hoverContent=[],this.targetContent=[]}static get styles(){return[A]}getAssignedElementsFromSlot(t){return t.assignedElements({flatten:!0})}handleTriggerContent(t){this.targetContent=this.getAssignedElementsFromSlot(t.target)}handleSlotContent(t){switch(t.target.name){case"click-content":this.clickContent=this.getAssignedElementsFromSlot(t.target);break;case"longpress-content":this.longpressContent=this.getAssignedElementsFromSlot(t.target);break;case"hover-content":this.hoverContent=this.getAssignedElementsFromSlot(t.target)}}handleBeforetoggle(t){const{target:o}=t;let e;if(o===this.clickOverlayElement)e="click";else if(o===this.longpressOverlayElement)e="longpress";else{if(o!==this.hoverOverlayElement)return;e="hover"}"open"===t.newState?this.open=e:this.open===e&&(this.open=void 0)}update(t){var o,e,i,r,n,a;t.has("clickContent")&&(this.clickPlacement=(null==(o=this.clickContent[0])?void 0:o.getAttribute("placement"))||(null==(e=this.clickContent[0])?void 0:e.getAttribute("direction"))||void 0),t.has("hoverContent")&&(this.hoverPlacement=(null==(i=this.hoverContent[0])?void 0:i.getAttribute("placement"))||(null==(r=this.hoverContent[0])?void 0:r.getAttribute("direction"))||void 0),t.has("longpressContent")&&(this.longpressPlacement=(null==(n=this.longpressContent[0])?void 0:n.getAttribute("placement"))||(null==(a=this.longpressContent[0])?void 0:a.getAttribute("direction"))||void 0),super.update(t)}renderSlot(t){return e`
        ...
        `:t}renderHoverOverlay(){import("./d208ce29.js").then((function(t){return t.s}));const t=this.renderSlot("hover-content");return this.hoverContent.length?e`
            <sp-overlay
                id="hover-overlay"
        ...
        `:t}renderLongpressOverlay(){import("./d208ce29.js").then((function(t){return t.s}));const t=this.renderSlot("longpress-content");return this.longpressContent.length?e`
            <sp-overlay
        ...
        `}updated(t){super.updated(t),this.disabled&&t.has("disabled")&&(this.open=void 0)}async getUpdateComplete(){return await super.getUpdateComplete()}}F([i()],D.prototype,"content",2),F([i({reflect:!0})],D.prototype,"placement",2),F([i()],D.prototype,"type",2),F([i({type:Number})],D.prototype,"offset",2),F([i({reflect:!0})],D.prototype,"open",2),F([i({type:Boolean,reflect:!0})],D.prototype,"disabled",2),F([l()],D.prototype,"clickContent",2),F([l()],D.prototype,"longpressContent",2),F([l()],D.prototype,"hoverContent",2),F([l()],D.prototype,"targetContent",2),F([p("#click-overlay",!0)],D.prototype,"clickOverlayElement",2),F([p("#longpress-overlay",!0)],D.prototype,"longpressOverlayElement",2),F([p("#hover-overlay",!0)],D.prototype,"hoverOverlayElement",2),n("overlay-trigger",D);var _=t`
...
`,H=Object.defineProperty,L=Object.getOwnPropertyDescriptor,M=(t,o,e,i)=>{for(var r,n=i>1?void 0:i?L(o,e):o,a=t.length-1;a>=0;a--)(r=t[a])&&(n=(i?r(o,e,n):r(n))||n);return i&&n&&H(o,e,n),n};class N extends HTMLElement{constructor(){super(),this._open=!1,this._placement="top",this.addEventListener("sp-opened",this.redispatchEvent),this.addEventListener("sp-closed",this.redispatchEvent)}redispatchEvent(t){t.stopPropagation(),this.tooltip.dispatchEvent(new CustomEvent(t.type,{bubbles:t.bubbles,composed:t.composed,detail:t.detail}))}get tooltip(){return this.getRootNode().host}static get observedAttributes(){return["open","placement"]}attributeChangedCallback(t,o,e){switch(t){case"open":this.open=null!==e;break;case"placement":this.placement=e}}set open(t){this._open=t;const{tooltip:o}=this;o&&(o.open=t)}get open(){return this._open}set placement(t){this._placement=t;const{tooltip:o}=this;o&&(o.placement=t)}get placement(){return this._placement}get tipElement(){return this.tooltip.tipElement}}customElements.get("sp-tooltip-openable")||customElements.define("sp-tooltip-openable",N);class q extends r{constructor(){super(...arguments),this.selfManaged=!1,this.offset=0,this.open=!1,this._variant="",this.handleOpenOverlay=()=>{this.open=!0},this.handleCloseOverlay=()=>{this.open=!1}}static get styles(){return[_]}get variant(){return this._variant}set variant(t){if(t!==this.variant){if(["info","positive","negative"].includes(t))return this.setAttribute("variant",t),void(this._variant=t);this.removeAttribute("variant"),this._variant=""}}forwardTransitionEvent(t){this.dispatchEvent(new TransitionEvent(t.type,{bubbles:!0,composed:!0,propertyName:t.propertyName}))}get triggerElement(){var t;let o=this.assignedSlot||this,e=o.getRootNode(),i=o.parentElement||e.host||e;for(;null==(t=null==i?void 0:i.matches)||!t.call(i,g);)o=i.assignedSlot||i,e=o.getRootNode(),i=o.parentElement||e.host||e;return i}render(){const t=e`
        ...
        `;return this.selfManaged?(import("./d208ce29.js").then((function(t){return t.s})),e`
                <sp-overlay
                    ?open=${this.open}
                    offset=${this.offset}
            ...
            `):t}connectedCallback(){super.connectedCallback(),this.updateComplete.then((()=>{if(!this.selfManaged)return;const t=this.overlayElement;if(t){const o=this.triggerElement;t.triggerElement=o}}))}}M([i({type:Boolean,attribute:"self-managed"})],q.prototype,"selfManaged",2),M([i({type:Number})],q.prototype,"offset",2),M([i({type:Boolean,reflect:!0})],q.prototype,"open",2),M([p("sp-overlay")],q.prototype,"overlayElement",2),M([i({reflect:!0})],q.prototype,"placement",2),M([p("#tip")],q.prototype,"tipElement",2),M([i({type:Number})],q.prototype,"tipPadding",2),M([i({type:String})],q.prototype,"variant",1),n("sp-tooltip",q);export{O as A};
//# sourceMappingURL=b9c0e040.js.map
