...
)}`;class c extends e{constructor(){super(...arguments),this.open=!1}static get styles(){return[d]}render(){return t``}}i([s({type:Boolean,reflect:!0})],c.prototype,"open",void 0),customElements.define("sp-underlay",c);var m=n`:host{--spectrum-sidenav-item-padding-y:var(
...
)}`;var u=n`#list{--spectrum-sidenav-item-padding-y:var(
--spectrum-global-dimension-size-65
...
)}:host{display:block}`;class p extends e{constructor(){super(...arguments),this.label=""}static get styles(){return[u,v]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return t`<h2 id="heading">${this.label}</h2><div id="list" aria-labelledby="heading"><slot name="descendant"></slot></div>`}}i([s({reflect:!0})],p.prototype,"label",void 0);class g extends r{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new l(this,{focusInIndex:e=>e.findIndex((e=>this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e))),direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)}),this.manageTabIndex=!1,this.value=void 0}static get styles(){return[m]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache()}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value;this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof p||!t.disabled&&t instanceof h&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return t`<nav @sidenav-select="${this.handleSelect}"><slot name="descendant" @slotchange="${this.handleSlotchange}"></slot></nav>`}firstUpdated(e){super.firstUpdated(e);const t=this.querySelector("[selected]");t&&(this.value=t.value)}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}i([s({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],g.prototype,"manageTabIndex",void 0),i([s({reflect:!0})],g.prototype,"value",void 0),customElements.define("sp-sidenav",g),customElements.define("sp-sidenav-item",h);export{l as R,p as S};
//# sourceMappingURL=e43fc3fa.js.map
