import{i as t}from"./112b2095.js";import"./c54d5b24.js";import{B as o}from"./6b792af6.js";import{S as c}from"./492935df.js";import{x as r}from"./032a7dfd.js";import{n as e}from"./cb80e8ab.js";import{d as n}from"./25a3ae37.js";var a=t`
...
`,u=Object.defineProperty,s=Object.getOwnPropertyDescriptor,d=(t,o,c,r)=>{for(var e,n=r>1?void 0:r?s(o,c):o,a=t.length-1;a>=0;a--)(e=t[a])&&(n=(r?e(o,c,n):e(n))||n);return r&&n&&u(o,c,n),n};const l={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let b;class m extends(c(o,{validSizes:["xs","s","m","l","xl"],noDefaultSize:!0})){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick)}static get styles(){return[...super.styles,a,i]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}handlePointerdownHoldAffordance(t){0===t.button&&(this.addEventListener("pointerup",this.handlePointerupHoldAffordance),this.addEventListener("pointercancel",this.handlePointerupHoldAffordance),b=setTimeout((()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))}),300))}handlePointerupHoldAffordance(){clearTimeout(b),this.removeEventListener("pointerup",this.handlePointerupHoldAffordance),this.removeEventListener("pointercancel",this.handlePointerupHoldAffordance)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:o,altKey:c}=t;("Space"===o||c&&"ArrowDown"===o)&&(t.preventDefault(),"ArrowDown"===o&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:o,altKey:c}=t;("Space"===o||c&&"ArrowDown"===o)&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(r`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${l[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const o="button"===this.role,c=o&&(this.selected||this.toggles)&&!(this.hasAttribute("aria-haspopup")&&this.hasAttribute("aria-expanded"));(t.has("selected")||t.has("role"))&&(c?this.setAttribute("aria-pressed",this.selected?"true":"false"):(this.removeAttribute("aria-pressed"),o&&this.toggles&&this.hasAttribute("aria-expanded")&&this.setAttribute("aria-expanded",this.selected?"true":"false"))),t.has("variant")&&(this.variant||typeof t.get("variant"))&&(this.static=this.variant),t.has("holdAffordance")&&(this.holdAffordance?this.addEventListener("pointerdown",this.handlePointerdownHoldAffordance):(this.removeEventListener("pointerdown",this.handlePointerdownHoldAffordance),this.handlePointerupHoldAffordance()))}}d([e({type:Boolean,reflect:!0})],m.prototype,"emphasized",2),d([e({type:Boolean,reflect:!0,attribute:"hold-affordance"})],m.prototype,"holdAffordance",2),d([e({type:Boolean,reflect:!0})],m.prototype,"quiet",2),d([e({reflect:!0})],m.prototype,"role",2),d([e({type:Boolean,reflect:!0})],m.prototype,"selected",2),d([e({type:Boolean,reflect:!0})],m.prototype,"toggles",2),d([e({reflect:!0})],m.prototype,"static",2),d([e({reflect:!0})],m.prototype,"variant",2),d([e({type:String})],m.prototype,"value",1),n("sp-action-button",m);
//# sourceMappingURL=2c43e86b.js.map
