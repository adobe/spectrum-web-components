...
--spectrum-dialog-confirm-entry-animation-delay,var(--spectrum-global-animation-duration-200)
)}@media (max-width:375px){.tray{border-radius:var(--spectrum-tray-border-radius,0)}}:host{align-items:flex-end}.tray{padding:var(--spectrum-tray-padding-y,0) var(--spectrum-tray-padding-x,0)}`;class jr extends s{constructor(){super(...arguments),this.open=!1}static get styles(){return[ye,Nr]}focus(){const t=R(this);t?t.focus():1===this.children.length?this.tray.focus():super.focus()}close(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0}))}render(){return r`<sp-underlay ?open="${this.open}" @click="${this.close}"></sp-underlay><div class="tray modal" tabindex="-1"><slot></slot></div>`}}o([i({type:Boolean,reflect:!0})],jr.prototype,"open",void 0),o([g(".tray")],jr.prototype,"tray",void 0),customElements.define("sp-tray",jr),window.Overlay=N;class Vr extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML="\n            <style>\n                :host {\n                    display: block;\n                    background-color: var(--spectrum-global-color-gray-50);\n                    color: var(--spectrum-global-color-gray-800);\n                    border: 1px solid;\n                    padding: 2em;\n                }\n            </style>\n            <slot></slot>\n        "}}customElements.define("styled-element",Vr);
//# sourceMappingURL=3a26db54.js.map
