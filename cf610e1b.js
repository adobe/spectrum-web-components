import{R as e}from"./a37f886d.js";import{i as t}from"./112b2095.js";import{x as n,A as s,n as a,S as r,d as i}from"./e5ca13ca.js";import{L as o,l as c,F as d}from"./fa586bc2.js";var l=t`
...
`,u=Object.defineProperty,m=Object.getOwnPropertyDescriptor,p=(e,t,n,s)=>{for(var a,r=s>1?void 0:s?m(t,n):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(s?a(t,n,r):a(r))||r);return s&&r&&u(t,n,r),r};const h=class e extends(o(d)){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[v]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let t=0,n=this.parentElement;for(;n instanceof e;)t++,n=n.parentElement;return t}handleSideNavSelect(e){this.selected=e.target===this}handleClick(e){!this.href&&e&&e.preventDefault(),!this.disabled&&(!this.href||null!=e&&e.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(e){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:e}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return n`
            <a
                href=${this.href||"#"}
...
`,b=Object.defineProperty,k=Object.getOwnPropertyDescriptor;class y extends r{constructor(){super(...arguments),this.label=""}static get styles(){return[v,f]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return n`
            <h2 id="heading">${this.label}</h2>
            <div id="list" aria-labelledby="heading" role="list">
                <slot name="descendant"></slot>
            </div>
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","listitem")}}((e,t,n,s)=>{for(var a,r=s>1?void 0:s?k(t,n):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(s?a(t,n,r):a(r))||r);s&&r&&b(t,n,r)})([a({reflect:!0})],y.prototype,"label",2);var w=Object.defineProperty,x=Object.getOwnPropertyDescriptor,z=(e,t,n,s)=>{for(var a,r=s>1?void 0:s?x(t,n):t,i=e.length-1;i>=0;i--)(a=e[i])&&(r=(s?a(t,n,r):a(r))||r);return s&&r&&w(t,n,r),r};class S extends d{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new e(this,{focusInIndex:e=>{let t,n=e.findIndex((e=>(e.value===this.value&&this.isDisabledChild(e)&&(t=e.closest("sp-sidenav-item:not([expanded])")),this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e))));return-1===n&&t&&(n=e.findIndex((e=>e===t))),n},direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:e=>!e.disabled&&!this.isDisabledChild(e)}),this.manageTabIndex=!1,this.value=void 0,this.variant=void 0,this.label=void 0}static get styles(){return[l]}startTrackingSelectionForItem(e){this.items.add(e),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(e){this.items.delete(e),this.rovingTabindexController.clearElementCache()}handleSelect(e){if(e.stopPropagation(),this.value===e.detail.value)return;const t=this.value;this.value=e.detail.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach((t=>t.handleSideNavSelect(e))):(this.value=t,e.target.selected=!1,e.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(e){if(e.disabled)return!0;let t=e.parentElement;for(;t instanceof y||!t.disabled&&t instanceof g&&t.expanded;)t=t.parentElement;return t!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return n`
            <nav
        ...
        `}willUpdate(){if(!this.hasUpdated){const e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}}z([a({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],S.prototype,"manageTabIndex",2),z([a({reflect:!0})],S.prototype,"value",2),z([a({reflect:!0})],S.prototype,"variant",2),z([a({reflect:!0})],S.prototype,"label",2),i("sp-sidenav",S),i("sp-sidenav-item",g);export{y as S};
//# sourceMappingURL=cf610e1b.js.map
