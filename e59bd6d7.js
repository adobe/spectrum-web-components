import{i as e}from"./112b2095.js";import{b as r}from"./aa2c2e34.js";import{a as t}from"./e636094a.js";import"./a5107b68.js";import"./b16bf061.js";import"./0563b2d5.js";import{M as o,I as c}from"./560f564c.js";import{S as i}from"./492935df.js";import{x as s,A as a}from"./032a7dfd.js";import{l as n}from"./9beeb9da.js";import{o as p}from"./6101097f.js";import{o as l}from"./df91629a.js";import{t as d}from"./f93453f4.js";import{i as u}from"./17348440.js";import{n as m}from"./cb80e8ab.js";import{d as h}from"./25a3ae37.js";var v=e`
...
`,k=Object.defineProperty,b=Object.getOwnPropertyDescriptor,g=(e,r,t,o)=>{for(var c,i=o>1?void 0:o?b(r,t):r,s=e.length-1;s>=0;s--)(c=e[s])&&(i=(o?c(r,t,i):c(i))||i);return o&&i&&k(r,t,i),i};const f={s:"spectrum-UIIcon-ChevronDown75",m:"spectrum-UIIcon-ChevronDown100",l:"spectrum-UIIcon-ChevronDown200",xl:"spectrum-UIIcon-ChevronDown300"},y="option-picker";class w extends(i(t,{noDefaultSize:!0})){constructor(){super(...arguments),this.isMobile=new o(this,c),this.deprecatedMenu=null,this.disabled=!1,this.focused=!1,this.invalid=!1,this.open=!1,this.readonly=!1,this.selects="single",this.placement="bottom-start",this.quiet=!1,this.value="",this.listRole="listbox",this.itemRole="option",this.preventNextToggle="no",this.pointerdownState=!1,this.handleKeydown=e=>{this.focused=!0,("ArrowDown"===e.code||"ArrowUp"===e.code)&&(e.stopPropagation(),e.preventDefault(),this.toggle(!0))},this.applyFocusElementLabel=e=>{this.appliedLabel=e},this.dependenciesLoaded=!1,this.dependenciesToLoad={},this.hasRenderedOverlay=!1,this.willManageSelection=!1,this.selectionPromise=Promise.resolve(),this.recentlyConnected=!1,this.enterKeydownOn=null,this.handleEnterKeydown=e=>{if("Enter"===e.code){if(this.enterKeydownOn)return void e.preventDefault();this.enterKeydownOn=e.target,this.addEventListener("keyup",(async e=>{"Enter"===e.code&&(this.enterKeydownOn=null)}),{once:!0})}}}get menuItems(){return this.optionsMenu.childItems}get selectedItem(){return this._selectedItem}set selectedItem(e){if(this.selectedItemContent=e?e.itemChildren:void 0,e===this.selectedItem)return;const r=this.selectedItem;this._selectedItem=e,this.requestUpdate("selectedItem",r)}get focusElement(){return this.open?this.optionsMenu:this.button}forceFocusVisible(){this.focused=!0}click(){this.disabled||this.toggle()}handleButtonBlur(){this.focused=!1}handleButtonPointerdown(e){if(0!==e.button)return;this.pointerdownState=this.open,this.preventNextToggle="maybe";const r=()=>{document.removeEventListener("pointerup",r),document.removeEventListener("pointercancel",r),requestAnimationFrame((()=>{this.preventNextToggle="no"}))};document.addEventListener("pointerup",r),document.addEventListener("pointercancel",r),this.handleActivate()}handleButtonFocus(e){"maybe"===this.preventNextToggle&&e.relatedTarget===this.optionsMenu&&(this.preventNextToggle="yes")}handleActivate(e){this.enterKeydownOn&&this.enterKeydownOn!==this.button||"yes"!==this.preventNextToggle&&("click"===(null==e?void 0:e.type)&&this.open!==this.pointerdownState||this.toggle())}focus(e){super.focus(e),!this.disabled&&this.focusElement&&(this.focused=this.hasVisibleFocusInTree())}handleHelperFocus(){this.focused=!0,this.button.focus()}handleChange(e){const r=e.target,[t]=r.selectedItems;e.stopPropagation(),e.cancelable?this.setValueFromItem(t,e):this.open=!1}async setValueFromItem(e,r){this.open=!1;const t=this.selectedItem,o=this.value;return this.selectedItem=e,this.value=e.value,await this.updateComplete,!this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!0,composed:!0}))&&this.selects?(r&&r.preventDefault(),this.setMenuItemSelected(this.selectedItem,!1),t&&this.setMenuItemSelected(t,!0),this.selectedItem=t,this.value=o,void(this.open=!0)):this.selects?(t&&this.setMenuItemSelected(t,!1),void this.setMenuItemSelected(e,!!this.selects)):(this.selectedItem=t,void(this.value=o))}setMenuItemSelected(e,r){null!=this.selects&&(e.selected=r)}toggle(e){this.readonly||(this.open=void 0!==e?e:!this.open)}close(){this.readonly||(this.open=!1)}get containerStyles(){return this.isMobile.matches?{"--swc-menu-width":"100%"}:{}}get selectedItemContent(){return this._selectedItemContent||{icon:[],content:[]}}set selectedItemContent(e){if(e===this.selectedItemContent)return;const r=this.selectedItemContent;this._selectedItemContent=e,this.requestUpdate("selectedItemContent",r)}handleTooltipSlotchange(e){this.tooltipEl=e.target.assignedElements()[0]}renderLabelContent(e){return this.value&&this.selectedItem?e:s`
        ...
        `}get buttonContent(){const e={"visually-hidden":"only"===this.icons&&!!this.value,placeholder:!this.value,label:!0},r=this.appliedLabel||this.label;return[s`
                ...
                ></slot>
            `]}renderOverlay(e){const r=this.renderContainer(e);return this.trackDependency("sp-overlay"),import("./4c85b6ff.js"),s`
            <sp-overlay
                .triggerElement=${this}
                .offset=${0}
        ...
        `}render(){return this.tooltipEl&&(this.tooltipEl.disabled=this.open),s`
            ...
            ></span>
            <button
                aria-controls=${n(this.open?"menu":void 0)}
        ...
        `}update(e){var r,t;this.selects&&(this.selects="single"),e.has("disabled")&&this.disabled&&(this.open=!1),e.has("value")&&this.shouldScheduleManageSelection(),this.hasUpdated||(this.deprecatedMenu=this.querySelector(":scope > sp-menu"),null==(r=this.deprecatedMenu)||r.toggleAttribute("ignore",!0),null==(t=this.deprecatedMenu)||t.setAttribute("selects","inherit")),super.update(e)}bindButtonKeydownListener(){this.button.addEventListener("keydown",this.handleKeydown)}firstUpdated(e){super.firstUpdated(e),this.bindButtonKeydownListener()}get dismissHelper(){return s`
        ...
        `}trackDependency(e,r){const t=!!customElements.get(e)||this.dependenciesToLoad[e]||!!r;t||customElements.whenDefined(e).then((()=>{this.trackDependency(e,!0)})),this.dependenciesToLoad={...this.dependenciesToLoad,[e]:t},this.dependenciesLoaded=Object.values(this.dependenciesToLoad).every((e=>e))}renderContainer(e){const r=s`
            ${this.dismissHelper} ${e} ${this.dismissHelper}
        `;return this.isMobile.matches?(this.trackDependency("sp-tray"),import("./7edf24e2.js").then((function(e){return e.s})),s`
                <sp-tray
                    id="popover"
                    role="presentation"
                    style=${l(this.containerStyles)}
                >
                    ${r}
                </sp-tray>
            `):(this.trackDependency("sp-popover"),import("./cf8b94fb.js").then((function(e){return e.s})),s`
            <sp-popover
                id="popover"
                role="presentation"
                style=${l(this.containerStyles)}
        ...
        `;return this.hasRenderedOverlay=this.hasRenderedOverlay||this.focused||this.open||!!this.deprecatedMenu,this.hasRenderedOverlay?this.renderOverlay(e):e}shouldScheduleManageSelection(e){!this.willManageSelection&&(!e||e.target.getRootNode().host===this)&&(this.willManageSelection=!0,requestAnimationFrame((()=>{requestAnimationFrame((()=>{this.manageSelection()}))})))}shouldManageSelection(){this.willManageSelection||(this.willManageSelection=!0,this.manageSelection())}async manageSelection(){if(null==this.selects)return;let e;this.selectionPromise=new Promise((e=>this.selectionResolver=e)),await this.optionsMenu.updateComplete,this.recentlyConnected&&(await new Promise((e=>requestAnimationFrame((()=>e(!0))))),this.recentlyConnected=!1),this.menuItems.forEach((r=>{this.value!==r.value||r.disabled?r.selected=!1:e=r})),e?(e.selected=!!this.selects,this.selectedItem=e):(this.value="",this.selectedItem=void 0),this.open&&(await this.optionsMenu.updateComplete,this.optionsMenu.updateSelectedItemIndex()),this.selectionResolver(),this.willManageSelection=!1}async getUpdateComplete(){const e=await super.getUpdateComplete();return await this.selectionPromise,this.overlayElement&&await this.overlayElement.updateComplete,e}connectedCallback(){super.connectedCallback(),this.recentlyConnected=this.hasUpdated}disconnectedCallback(){this.close(),super.disconnectedCallback()}}g([d()],w.prototype,"appliedLabel",2),g([u("#button")],w.prototype,"button",2),g([m({type:Boolean,reflect:!0})],w.prototype,"disabled",2),g([m({type:Boolean,reflect:!0})],w.prototype,"focused",2),g([m({type:String,reflect:!0})],w.prototype,"icons",2),g([m({type:Boolean,reflect:!0})],w.prototype,"invalid",2),g([m()],w.prototype,"label",2),g([m({type:Boolean,reflect:!0})],w.prototype,"open",2),g([m({type:Boolean,reflect:!0})],w.prototype,"readonly",2),g([u("sp-menu")],w.prototype,"optionsMenu",2),g([u("sp-overlay")],w.prototype,"overlayElement",2),g([m()],w.prototype,"placement",2),g([m({type:Boolean,reflect:!0})],w.prototype,"quiet",2),g([m({type:String})],w.prototype,"value",2),g([m({attribute:!1})],w.prototype,"selectedItem",1),g([m({attribute:!1})],w.prototype,"selectedItemContent",1),g([d()],w.prototype,"dependenciesLoaded",2);h("sp-picker",class extends w{constructor(){super(...arguments),this.handleKeydown=e=>{const{code:r}=e;if(this.focused=!0,!r.startsWith("Arrow")||this.readonly)return;if("ArrowUp"===r||"ArrowDown"===r)return this.toggle(!0),void e.preventDefault();e.preventDefault();const t=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,o=t<0||"ArrowRight"===r?1:-1;let c=t+o;for(;this.menuItems[c]&&this.menuItems[c].disabled;)c+=o;!this.menuItems[c]||this.menuItems[c].disabled||(!this.value||c!==t)&&this.setValueFromItem(this.menuItems[c])}}static get styles(){return[v,r]}get containerStyles(){const e=super.containerStyles;return this.quiet||(e["min-width"]=`${this.offsetWidth}px`),e}});export{y as D,w as P};
//# sourceMappingURL=e59bd6d7.js.map
