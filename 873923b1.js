import{i as t}from"./d230bd74.js";import{L as e,a as o,t as r,i,o as a,l as c,S as n}from"./0907ad62.js";import{u as s,t as l,a as u,e as d,b as m,S as p,I as b,B as v}from"./7f834e08.js";import{S as h,y as g,b as f,e as k,x,Z as y}from"./fcb7dc90.js";import{r as w,R as z,f as I}from"./02250eff.js";import{T as C}from"./dea322e1.js";import"./1d588942.js";import"./e8ff5008.js";import"./604426ca.js";import{e as S,i as T,t as q}from"./4e9e6c96.js";import"./9d74a319.js";var E=t`
...
`;const P=async(t,e,o,r)=>{const{Overlay:i}=await import("./bb2e4953.js");return i.open(t,e,o,r)};class H extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var O=t`
...
`,Ht=Object.defineProperty,Ot=Object.getOwnPropertyDescriptor,Dt=(t,e,o,r)=>{for(var i,a=r>1?void 0:r?Ot(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(e,o,a):i(a))||a);return r&&a&&Ht(e,o,a),a};class Rt extends h{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new Ft(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[At,Pt]}focus(){const t=I(this);t?t.focus():1===this.children.length?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&void 0!==t.get("open")&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise((t=>{this.resolveTransitionPromise=()=>{this.animating=!1,t()}}))),super.update(t)}render(){return g`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
...
`,we=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,Ie=(t,e,o,r)=>{for(var i,a=r>1?void 0:r?ze(e,o):e,c=t.length-1;c>=0;c--)(i=t[c])&&(a=(r?i(e,o,a):i(a))||a);return r&&a&&we(e,o,a),a};const Ce=["negative","positive","info","error","warning"];class Se extends h{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[ye]}set timeout(t){const e=null!==typeof t&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Ce.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return g`
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(null!==this.timeout&&this.open?this.startCountdown():this.stopCountdown())}}Ie([k({type:Boolean,reflect:!0})],Se.prototype,"open",2),Ie([k({type:Number})],Se.prototype,"timeout",1),Ie([k({type:String})],Se.prototype,"variant",1),customElements.define("sp-toast",Se);export{Lt as D,jt as I,Gt as P,wt as S,F as a,A as f,At as h,nt as k,P as o,ge as r};
//# sourceMappingURL=873923b1.js.map
